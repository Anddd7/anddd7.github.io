const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.DHVS_-5S.js","assets/chunks/framework.CdjpmwdR.js","assets/chunks/mermaid.core.DNjtvN0m.js"])))=>i.map(i=>d[i]);
import{d as U,c as w,r as C,n as Q,o as f,a as Ae,t as S,b as G,w as N,T as Oa,e as q,_ as X,u as gn,i as Yr,f as Xr,g as Ra,h as R,j as p,k as m,l as un,m as fa,p as ae,q as De,s as Et,v as Ee,x as za,y as qa,z as Qr,A as Jr,F as Z,B as ie,C as tn,D as Ot,E as j,G as _s,H as ze,I as ws,J as mn,K as en,L as Rt,M as Zr,N as Va,O as va,P as Ba,Q as ks,R as zt,S as el,U as nl,V as xs,W as As,X as Cs,Y as tl,Z as al,$ as Fa,a0 as ol,a1 as il,a2 as sl}from"./framework.CdjpmwdR.js";const rl=U({__name:"VPBadge",props:{text:{},type:{default:"tip"}},setup(e){return(n,t)=>(f(),w("span",{class:Q(["VPBadge",e.type])},[C(n.$slots,"default",{},()=>[Ae(S(e.text),1)])],2))}}),ll={key:0,class:"VPBackdrop"},cl=U({__name:"VPBackdrop",props:{show:{type:Boolean}},setup(e){return(n,t)=>(f(),G(Oa,{name:"fade"},{default:N(()=>[e.show?(f(),w("div",ll)):q("",!0)]),_:1}))}}),ul=X(cl,[["__scopeId","data-v-49e9b6df"]]),ne=gn;function dl(e,n){let t,a=!1;return()=>{t&&clearTimeout(t),a?t=setTimeout(e,n):(e(),(a=!0)&&setTimeout(()=>a=!1,n))}}function ba(e){return e.startsWith("/")?e:`/${e}`}function ja(e){const{pathname:n,search:t,hash:a,protocol:o}=new URL(e,"http://a.com");if(Yr(e)||e.startsWith("#")||!o.startsWith("http")||!Xr(n))return e;const{site:i}=ne(),s=n.endsWith("/")||n.endsWith(".html")?e:e.replace(/(?:(^\.+)\/)?.*$/,`$1${n.replace(/(\.md)?$/,i.value.cleanUrls?"":".html")}${t}${a}`);return Ra(s)}function Yn({correspondingLink:e=!1}={}){const{site:n,localeIndex:t,page:a,theme:o,hash:i}=ne(),s=R(()=>{var l,c;return{label:(l=n.value.locales[t.value])==null?void 0:l.label,link:((c=n.value.locales[t.value])==null?void 0:c.link)||(t.value==="root"?"/":`/${t.value}/`)}});return{localeLinks:R(()=>Object.entries(n.value.locales).flatMap(([l,c])=>s.value.label===c.label?[]:{text:c.label,link:hl(c.link||(l==="root"?"/":`/${l}/`),o.value.i18nRouting!==!1&&e,a.value.relativePath.slice(s.value.link.length-1),!n.value.cleanUrls)+i.value})),currentLang:s}}function hl(e,n,t,a){return n?e.replace(/\/$/,"")+ba(t.replace(/(^|\/)index\.md$/,"$1").replace(/\.md$/,a?".html":"")):e}const pl={class:"NotFound"},gl={class:"code"},ml={class:"title"},fl={class:"quote"},vl={class:"action"},bl=["href","aria-label"],yl=U({__name:"NotFound",setup(e){const{theme:n}=ne(),{currentLang:t}=Yn();return(a,o)=>{var i,s,r,l,c;return f(),w("div",pl,[p("p",gl,S(((i=m(n).notFound)==null?void 0:i.code)??"404"),1),p("h1",ml,S(((s=m(n).notFound)==null?void 0:s.title)??"PAGE NOT FOUND"),1),o[0]||(o[0]=p("div",{class:"divider"},null,-1)),p("blockquote",fl,S(((r=m(n).notFound)==null?void 0:r.quote)??"But if you don't change your direction, and if you keep looking, you may end up where you are heading."),1),p("div",vl,[p("a",{class:"link",href:m(Ra)(m(t).link),"aria-label":((l=m(n).notFound)==null?void 0:l.linkLabel)??"go to home"},S(((c=m(n).notFound)==null?void 0:c.linkText)??"Take me home"),9,bl)])])}}}),_l=X(yl,[["__scopeId","data-v-e6e96a08"]]);function Ts(e,n){if(Array.isArray(e))return st(e);if(e==null)return[];n=ba(n);const t=Object.keys(e).sort((o,i)=>i.split("/").length-o.split("/").length).find(o=>n.startsWith(ba(o))),a=t?e[t]:[];return Array.isArray(a)?st(a):st(a.items,a.base)}function wl(e){const n=[];let t=0;for(const a in e){const o=e[a];if(o.items){t=n.push(o);continue}n[t]||n.push({items:[]}),n[t].items.push(o)}return n}function kl(e){const n=[];function t(a){for(const o of a)o.text&&o.link&&n.push({text:o.text,link:o.link,docFooterText:o.docFooterText}),o.items&&t(o.items)}return t(e),n}function ya(e,n){return Array.isArray(n)?n.some(t=>ya(e,t)):un(e,n.link)?!0:n.items?ya(e,n.items):!1}function st(e,n){return[...e].map(t=>{const a={...t},o=a.base||n;return o&&a.link&&(a.link=o+a.link),a.items&&(a.items=st(a.items,o)),a})}function Qe(){const{frontmatter:e,page:n,theme:t}=ne(),a=fa("(min-width: 960px)"),o=ae(!1),i=R(()=>{const b=t.value.sidebar,_=n.value.relativePath;return b?Ts(b,_):[]}),s=ae(i.value);De(i,(b,_)=>{JSON.stringify(b)!==JSON.stringify(_)&&(s.value=i.value)});const r=R(()=>e.value.sidebar!==!1&&s.value.length>0&&e.value.layout!=="home"),l=R(()=>c?e.value.aside==null?t.value.aside==="left":e.value.aside==="left":!1),c=R(()=>e.value.layout==="home"?!1:e.value.aside!=null?!!e.value.aside:t.value.aside!==!1),d=R(()=>r.value&&a.value),g=R(()=>r.value?wl(s.value):[]);function u(){o.value=!0}function h(){o.value=!1}function v(){o.value?h():u()}return{isOpen:o,sidebar:s,sidebarGroups:g,hasSidebar:r,hasAside:c,leftAside:l,isSidebarEnabled:d,open:u,close:h,toggle:v}}function xl(e,n){let t;Et(()=>{t=e.value?document.activeElement:void 0}),Ee(()=>{window.addEventListener("keyup",a)}),za(()=>{window.removeEventListener("keyup",a)});function a(o){o.key==="Escape"&&e.value&&(n(),t==null||t.focus())}}function Al(e){const{page:n,hash:t}=ne(),a=ae(!1),o=R(()=>e.value.collapsed!=null),i=R(()=>!!e.value.link),s=ae(!1),r=()=>{s.value=un(n.value.relativePath,e.value.link)};De([n,e,t],r),Ee(r);const l=R(()=>s.value?!0:e.value.items?ya(n.value.relativePath,e.value.items):!1),c=R(()=>!!(e.value.items&&e.value.items.length));Et(()=>{a.value=!!(o.value&&e.value.collapsed)}),qa(()=>{(s.value||l.value)&&(a.value=!1)});function d(){o.value&&(a.value=!a.value)}return{collapsed:a,collapsible:o,isLink:i,isActiveLink:s,hasActiveLink:l,hasChildren:c,toggle:d}}function Cl(){const{hasSidebar:e}=Qe(),n=fa("(min-width: 960px)"),t=fa("(min-width: 1280px)");return{isAsideEnabled:R(()=>!t.value&&!n.value?!1:e.value?t.value:n.value)}}const Tl=/\b(?:VPBadge|header-anchor|footnote-ref|ignore-header)\b/,_a=[];function Ss(e){return typeof e.outline=="object"&&!Array.isArray(e.outline)&&e.outline.label||e.outlineTitle||"On this page"}function Ua(e){const n=[...document.querySelectorAll(".VPDoc :where(h1,h2,h3,h4,h5,h6)")].filter(t=>t.id&&t.hasChildNodes()).map(t=>{const a=Number(t.tagName[1]);return{element:t,title:Sl(t),link:"#"+t.id,level:a}});return Il(n,e)}function Sl(e){let n="";for(const t of e.childNodes)if(t.nodeType===1){if(Tl.test(t.className))continue;n+=t.textContent}else t.nodeType===3&&(n+=t.textContent);return n.trim()}function Il(e,n){if(n===!1)return[];const t=(typeof n=="object"&&!Array.isArray(n)?n.level:n)||2,[a,o]=typeof t=="number"?[t,t]:t==="deep"?[2,6]:t;return Dl(e,a,o)}function Pl(e,n){const{isAsideEnabled:t}=Cl(),a=dl(i,100);let o=null;Ee(()=>{requestAnimationFrame(i),window.addEventListener("scroll",a)}),Qr(()=>{s(location.hash)}),za(()=>{window.removeEventListener("scroll",a)});function i(){if(!t.value)return;const r=window.scrollY,l=window.innerHeight,c=document.body.offsetHeight,d=Math.abs(r+l-c)<1,g=_a.map(({element:h,link:v})=>({link:v,top:Ml(h)})).filter(({top:h})=>!Number.isNaN(h)).sort((h,v)=>h.top-v.top);if(!g.length){s(null);return}if(r<1){s(null);return}if(d){s(g[g.length-1].link);return}let u=null;for(const{link:h,top:v}of g){if(v>r+Jr()+4)break;u=h}s(u)}function s(r){o&&o.classList.remove("active"),r==null?o=null:o=e.value.querySelector(`a[href="${decodeURIComponent(r)}"]`);const l=o;l?(l.classList.add("active"),n.value.style.top=l.offsetTop+39+"px",n.value.style.opacity="1"):(n.value.style.top="33px",n.value.style.opacity="0")}}function Ml(e){let n=0;for(;e!==document.body;){if(e===null)return NaN;n+=e.offsetTop,e=e.offsetParent}return n}function Dl(e,n,t){_a.length=0;const a=[],o=[];return e.forEach(i=>{const s={...i,children:[]};let r=o[o.length-1];for(;r&&r.level>=s.level;)o.pop(),r=o[o.length-1];if(s.element.classList.contains("ignore-header")||r&&"shouldIgnore"in r){o.push({level:s.level,shouldIgnore:!0});return}s.level>t||s.level<n||(_a.push({element:s.element,link:s.link}),r?r.children.push(s):a.push(s),o.push(s))}),a}const Ll=["href","title"],$l=U({__name:"VPDocOutlineItem",props:{headers:{},root:{type:Boolean}},setup(e){function n({target:t}){const a=t.href.split("#")[1],o=document.getElementById(decodeURIComponent(a));o==null||o.focus({preventScroll:!0})}return(t,a)=>{const o=tn("VPDocOutlineItem",!0);return f(),w("ul",{class:Q(["VPDocOutlineItem",e.root?"root":"nested"])},[(f(!0),w(Z,null,ie(e.headers,({children:i,link:s,title:r})=>(f(),w("li",null,[p("a",{class:"outline-link",href:s,onClick:n,title:r},S(r),9,Ll),i!=null&&i.length?(f(),G(o,{key:0,headers:i},null,8,["headers"])):q("",!0)]))),256))],2)}}}),Is=X($l,[["__scopeId","data-v-4034b050"]]),Nl={class:"content"},El={"aria-level":"2",class:"outline-title",id:"doc-outline-aria-label",role:"heading"},Ol=U({__name:"VPDocAsideOutline",setup(e){const{frontmatter:n,theme:t}=ne(),a=_s([]);Ot(()=>{a.value=Ua(n.value.outline??t.value.outline)});const o=ae(),i=ae();return Pl(o,i),(s,r)=>(f(),w("nav",{"aria-labelledby":"doc-outline-aria-label",class:Q(["VPDocAsideOutline",{"has-outline":a.value.length>0}]),ref_key:"container",ref:o},[p("div",Nl,[p("div",{class:"outline-marker",ref_key:"marker",ref:i},null,512),p("div",El,S(m(Ss)(m(t))),1),j(Is,{headers:a.value,root:!0},null,8,["headers"])])],2))}}),Rl=X(Ol,[["__scopeId","data-v-cc53f104"]]),zl={class:"VPDocAsideCarbonAds"},ql=U({__name:"VPDocAsideCarbonAds",props:{carbonAds:{}},setup(e){const n=()=>null;return(t,a)=>(f(),w("div",zl,[j(m(n),{"carbon-ads":e.carbonAds},null,8,["carbon-ads"])]))}}),Vl={class:"VPDocAside"},Bl=U({__name:"VPDocAside",setup(e){const{theme:n}=ne();return(t,a)=>(f(),w("div",Vl,[C(t.$slots,"aside-top",{},void 0,!0),C(t.$slots,"aside-outline-before",{},void 0,!0),j(Rl),C(t.$slots,"aside-outline-after",{},void 0,!0),a[0]||(a[0]=p("div",{class:"spacer"},null,-1)),C(t.$slots,"aside-ads-before",{},void 0,!0),m(n).carbonAds?(f(),G(ql,{key:0,"carbon-ads":m(n).carbonAds},null,8,["carbon-ads"])):q("",!0),C(t.$slots,"aside-ads-after",{},void 0,!0),C(t.$slots,"aside-bottom",{},void 0,!0)]))}}),Fl=X(Bl,[["__scopeId","data-v-9516880d"]]);function jl(){const{theme:e,page:n}=ne();return R(()=>{const{text:t="Edit this page",pattern:a=""}=e.value.editLink||{};let o;return typeof a=="function"?o=a(n.value):o=a.replace(/:path/g,n.value.filePath),{url:o,text:t}})}function Ul(){const{page:e,theme:n,frontmatter:t}=ne();return R(()=>{var c,d,g,u,h,v,b,_;const a=Ts(n.value.sidebar,e.value.relativePath),o=kl(a),i=Gl(o,x=>x.link.replace(/[?#].*$/,"")),s=i.findIndex(x=>un(e.value.relativePath,x.link)),r=((c=n.value.docFooter)==null?void 0:c.prev)===!1&&!t.value.prev||t.value.prev===!1,l=((d=n.value.docFooter)==null?void 0:d.next)===!1&&!t.value.next||t.value.next===!1;return{prev:r?void 0:{text:(typeof t.value.prev=="string"?t.value.prev:typeof t.value.prev=="object"?t.value.prev.text:void 0)??((g=i[s-1])==null?void 0:g.docFooterText)??((u=i[s-1])==null?void 0:u.text),link:(typeof t.value.prev=="object"?t.value.prev.link:void 0)??((h=i[s-1])==null?void 0:h.link)},next:l?void 0:{text:(typeof t.value.next=="string"?t.value.next:typeof t.value.next=="object"?t.value.next.text:void 0)??((v=i[s+1])==null?void 0:v.docFooterText)??((b=i[s+1])==null?void 0:b.text),link:(typeof t.value.next=="object"?t.value.next.link:void 0)??((_=i[s+1])==null?void 0:_.link)}}})}function Gl(e,n){const t=new Set;return e.filter(a=>{const o=n(a);return t.has(o)?!1:t.add(o)})}const qe=U({__name:"VPLink",props:{tag:{},href:{},noIcon:{type:Boolean},target:{},rel:{}},setup(e){const n=e,t=R(()=>n.tag??(n.href?"a":"span")),a=R(()=>n.href&&ws.test(n.href)||n.target==="_blank");return(o,i)=>(f(),G(ze(t.value),{class:Q(["VPLink",{link:e.href,"vp-external-link-icon":a.value,"no-icon":e.noIcon}]),href:e.href?m(ja)(e.href):void 0,target:e.target??(a.value?"_blank":void 0),rel:e.rel??(a.value?"noreferrer":void 0)},{default:N(()=>[C(o.$slots,"default")]),_:3},8,["class","href","target","rel"]))}}),Hl={class:"VPLastUpdated"},Wl=["datetime"],Kl=U({__name:"VPDocFooterLastUpdated",setup(e){const{theme:n,page:t,lang:a}=ne(),o=R(()=>new Date(t.value.lastUpdated)),i=R(()=>o.value.toISOString()),s=ae("");return Ee(()=>{Et(()=>{var r,l,c;s.value=new Intl.DateTimeFormat((l=(r=n.value.lastUpdated)==null?void 0:r.formatOptions)!=null&&l.forceLocale?a.value:void 0,((c=n.value.lastUpdated)==null?void 0:c.formatOptions)??{dateStyle:"short",timeStyle:"short"}).format(o.value)})}),(r,l)=>{var c;return f(),w("p",Hl,[Ae(S(((c=m(n).lastUpdated)==null?void 0:c.text)||m(n).lastUpdatedText||"Last updated")+": ",1),p("time",{datetime:i.value},S(s.value),9,Wl)])}}}),Yl=X(Kl,[["__scopeId","data-v-3607c463"]]),Xl={key:0,class:"VPDocFooter"},Ql={key:0,class:"edit-info"},Jl={key:0,class:"edit-link"},Zl={key:1,class:"last-updated"},ec={key:1,class:"prev-next","aria-labelledby":"doc-footer-aria-label"},nc={class:"pager"},tc=["innerHTML"],ac=["innerHTML"],oc={class:"pager"},ic=["innerHTML"],sc=["innerHTML"],rc=U({__name:"VPDocFooter",setup(e){const{theme:n,page:t,frontmatter:a}=ne(),o=jl(),i=Ul(),s=R(()=>n.value.editLink&&a.value.editLink!==!1),r=R(()=>t.value.lastUpdated),l=R(()=>s.value||r.value||i.value.prev||i.value.next);return(c,d)=>{var g,u,h,v;return l.value?(f(),w("footer",Xl,[C(c.$slots,"doc-footer-before",{},void 0,!0),s.value||r.value?(f(),w("div",Ql,[s.value?(f(),w("div",Jl,[j(qe,{class:"edit-link-button",href:m(o).url,"no-icon":!0},{default:N(()=>[d[0]||(d[0]=p("span",{class:"vpi-square-pen edit-link-icon"},null,-1)),Ae(" "+S(m(o).text),1)]),_:1},8,["href"])])):q("",!0),r.value?(f(),w("div",Zl,[j(Yl)])):q("",!0)])):q("",!0),(g=m(i).prev)!=null&&g.link||(u=m(i).next)!=null&&u.link?(f(),w("nav",ec,[d[1]||(d[1]=p("span",{class:"visually-hidden",id:"doc-footer-aria-label"},"Pager",-1)),p("div",nc,[(h=m(i).prev)!=null&&h.link?(f(),G(qe,{key:0,class:"pager-link prev",href:m(i).prev.link},{default:N(()=>{var b;return[p("span",{class:"desc",innerHTML:((b=m(n).docFooter)==null?void 0:b.prev)||"Previous page"},null,8,tc),p("span",{class:"title",innerHTML:m(i).prev.text},null,8,ac)]}),_:1},8,["href"])):q("",!0)]),p("div",oc,[(v=m(i).next)!=null&&v.link?(f(),G(qe,{key:0,class:"pager-link next",href:m(i).next.link},{default:N(()=>{var b;return[p("span",{class:"desc",innerHTML:((b=m(n).docFooter)==null?void 0:b.next)||"Next page"},null,8,ic),p("span",{class:"title",innerHTML:m(i).next.text},null,8,sc)]}),_:1},8,["href"])):q("",!0)])])):q("",!0)])):q("",!0)}}}),lc=X(rc,[["__scopeId","data-v-cd0721dd"]]),cc={class:"container"},uc={class:"aside-container"},dc={class:"aside-content"},hc={class:"content"},pc={class:"content-container"},gc={class:"main"},mc=U({__name:"VPDoc",setup(e){const{theme:n}=ne(),t=mn(),{hasSidebar:a,hasAside:o,leftAside:i}=Qe(),s=R(()=>t.path.replace(/[./]+/g,"_").replace(/_html$/,""));return(r,l)=>{const c=tn("Content");return f(),w("div",{class:Q(["VPDoc",{"has-sidebar":m(a),"has-aside":m(o)}])},[C(r.$slots,"doc-top",{},void 0,!0),p("div",cc,[m(o)?(f(),w("div",{key:0,class:Q(["aside",{"left-aside":m(i)}])},[l[0]||(l[0]=p("div",{class:"aside-curtain"},null,-1)),p("div",uc,[p("div",dc,[j(Fl,null,{"aside-top":N(()=>[C(r.$slots,"aside-top",{},void 0,!0)]),"aside-bottom":N(()=>[C(r.$slots,"aside-bottom",{},void 0,!0)]),"aside-outline-before":N(()=>[C(r.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":N(()=>[C(r.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":N(()=>[C(r.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":N(()=>[C(r.$slots,"aside-ads-after",{},void 0,!0)]),_:3})])])],2)):q("",!0),p("div",hc,[p("div",pc,[C(r.$slots,"doc-before",{},void 0,!0),p("main",gc,[j(c,{class:Q(["vp-doc",[s.value,m(n).externalLinkIcon&&"external-link-icon-enabled"]])},null,8,["class"])]),j(lc,null,{"doc-footer-before":N(()=>[C(r.$slots,"doc-footer-before",{},void 0,!0)]),_:3}),C(r.$slots,"doc-after",{},void 0,!0)])])]),C(r.$slots,"doc-bottom",{},void 0,!0)],2)}}}),fc=X(mc,[["__scopeId","data-v-f640936e"]]),vc=U({__name:"VPButton",props:{tag:{},size:{default:"medium"},theme:{default:"brand"},text:{},href:{},target:{},rel:{}},setup(e){const n=e,t=R(()=>n.href&&ws.test(n.href)),a=R(()=>n.tag||(n.href?"a":"button"));return(o,i)=>(f(),G(ze(a.value),{class:Q(["VPButton",[e.size,e.theme]]),href:e.href?m(ja)(e.href):void 0,target:n.target??(t.value?"_blank":void 0),rel:n.rel??(t.value?"noreferrer":void 0)},{default:N(()=>[Ae(S(e.text),1)]),_:1},8,["class","href","target","rel"]))}}),bc=X(vc,[["__scopeId","data-v-baf7dc9c"]]),yc=["src","alt"],_c=U({inheritAttrs:!1,__name:"VPImage",props:{image:{},alt:{}},setup(e){return(n,t)=>{const a=tn("VPImage",!0);return e.image?(f(),w(Z,{key:0},[typeof e.image=="string"||"src"in e.image?(f(),w("img",en({key:0,class:"VPImage"},typeof e.image=="string"?n.$attrs:{...e.image,...n.$attrs},{src:m(Ra)(typeof e.image=="string"?e.image:e.image.src),alt:e.alt??(typeof e.image=="string"?"":e.image.alt||"")}),null,16,yc)):(f(),w(Z,{key:1},[j(a,en({class:"dark",image:e.image.dark,alt:e.image.alt},n.$attrs),null,16,["image","alt"]),j(a,en({class:"light",image:e.image.light,alt:e.image.alt},n.$attrs),null,16,["image","alt"])],64))],64)):q("",!0)}}}),pt=X(_c,[["__scopeId","data-v-f9c85911"]]),wc={class:"container"},kc={class:"main"},xc={class:"heading"},Ac=["innerHTML"],Cc=["innerHTML"],Tc=["innerHTML"],Sc={key:0,class:"actions"},Ic={key:0,class:"image"},Pc={class:"image-container"},Mc=U({__name:"VPHero",props:{name:{},text:{},tagline:{},image:{},actions:{}},setup(e){const n=Rt("hero-image-slot-exists");return(t,a)=>(f(),w("div",{class:Q(["VPHero",{"has-image":e.image||m(n)}])},[p("div",wc,[p("div",kc,[C(t.$slots,"home-hero-info-before",{},void 0,!0),C(t.$slots,"home-hero-info",{},()=>[p("h1",xc,[e.name?(f(),w("span",{key:0,innerHTML:e.name,class:"name clip"},null,8,Ac)):q("",!0),e.text?(f(),w("span",{key:1,innerHTML:e.text,class:"text"},null,8,Cc)):q("",!0)]),e.tagline?(f(),w("p",{key:0,innerHTML:e.tagline,class:"tagline"},null,8,Tc)):q("",!0)],!0),C(t.$slots,"home-hero-info-after",{},void 0,!0),e.actions?(f(),w("div",Sc,[(f(!0),w(Z,null,ie(e.actions,o=>(f(),w("div",{key:o.link,class:"action"},[j(bc,{tag:"a",size:"medium",theme:o.theme,text:o.text,href:o.link,target:o.target,rel:o.rel},null,8,["theme","text","href","target","rel"])]))),128))])):q("",!0),C(t.$slots,"home-hero-actions-after",{},void 0,!0)]),e.image||m(n)?(f(),w("div",Ic,[p("div",Pc,[a[0]||(a[0]=p("div",{class:"image-bg"},null,-1)),C(t.$slots,"home-hero-image",{},()=>[e.image?(f(),G(pt,{key:0,class:"image-src",image:e.image},null,8,["image"])):q("",!0)],!0)])])):q("",!0)])],2))}}),Dc=X(Mc,[["__scopeId","data-v-09b6ce43"]]),Lc=U({__name:"VPHomeHero",setup(e){const{frontmatter:n}=ne();return(t,a)=>m(n).hero?(f(),G(Dc,{key:0,class:"VPHomeHero",name:m(n).hero.name,text:m(n).hero.text,tagline:m(n).hero.tagline,image:m(n).hero.image,actions:m(n).hero.actions},{"home-hero-info-before":N(()=>[C(t.$slots,"home-hero-info-before")]),"home-hero-info":N(()=>[C(t.$slots,"home-hero-info")]),"home-hero-info-after":N(()=>[C(t.$slots,"home-hero-info-after")]),"home-hero-actions-after":N(()=>[C(t.$slots,"home-hero-actions-after")]),"home-hero-image":N(()=>[C(t.$slots,"home-hero-image")]),_:3},8,["name","text","tagline","image","actions"])):q("",!0)}}),$c={class:"box"},Nc={key:0,class:"icon"},Ec=["innerHTML"],Oc=["innerHTML"],Rc=["innerHTML"],zc={key:4,class:"link-text"},qc={class:"link-text-value"},Vc=U({__name:"VPFeature",props:{icon:{},title:{},details:{},link:{},linkText:{},rel:{},target:{}},setup(e){return(n,t)=>(f(),G(qe,{class:"VPFeature",href:e.link,rel:e.rel,target:e.target,"no-icon":!0,tag:e.link?"a":"div"},{default:N(()=>[p("article",$c,[typeof e.icon=="object"&&e.icon.wrap?(f(),w("div",Nc,[j(pt,{image:e.icon,alt:e.icon.alt,height:e.icon.height||48,width:e.icon.width||48},null,8,["image","alt","height","width"])])):typeof e.icon=="object"?(f(),G(pt,{key:1,image:e.icon,alt:e.icon.alt,height:e.icon.height||48,width:e.icon.width||48},null,8,["image","alt","height","width"])):e.icon?(f(),w("div",{key:2,class:"icon",innerHTML:e.icon},null,8,Ec)):q("",!0),p("h2",{class:"title",innerHTML:e.title},null,8,Oc),e.details?(f(),w("p",{key:3,class:"details",innerHTML:e.details},null,8,Rc)):q("",!0),e.linkText?(f(),w("div",zc,[p("p",qc,[Ae(S(e.linkText)+" ",1),t[0]||(t[0]=p("span",{class:"vpi-arrow-right link-text-icon"},null,-1))])])):q("",!0)])]),_:1},8,["href","rel","target","tag"]))}}),Bc=X(Vc,[["__scopeId","data-v-67e0b8b6"]]),Fc={key:0,class:"VPFeatures"},jc={class:"container"},Uc={class:"items"},Gc=U({__name:"VPFeatures",props:{features:{}},setup(e){const n=e,t=R(()=>{const a=n.features.length;if(a){if(a===2)return"grid-2";if(a===3)return"grid-3";if(a%3===0)return"grid-6";if(a>3)return"grid-4"}else return});return(a,o)=>e.features?(f(),w("div",Fc,[p("div",jc,[p("div",Uc,[(f(!0),w(Z,null,ie(e.features,i=>(f(),w("div",{key:i.title,class:Q(["item",[t.value]])},[j(Bc,{icon:i.icon,title:i.title,details:i.details,link:i.link,"link-text":i.linkText,rel:i.rel,target:i.target},null,8,["icon","title","details","link","link-text","rel","target"])],2))),128))])])])):q("",!0)}}),Hc=X(Gc,[["__scopeId","data-v-f6b1b269"]]),Wc=U({__name:"VPHomeFeatures",setup(e){const{frontmatter:n}=ne();return(t,a)=>m(n).features?(f(),G(Hc,{key:0,class:"VPHomeFeatures",features:m(n).features},null,8,["features"])):q("",!0)}}),Kc=U({__name:"VPHomeContent",setup(e){const{width:n}=Zr({initialWidth:0,includeScrollbar:!1});return(t,a)=>(f(),w("div",{class:"vp-doc container",style:Va(m(n)?{"--vp-offset":`calc(50% - ${m(n)/2}px)`}:{})},[C(t.$slots,"default",{},void 0,!0)],4))}}),Yc=X(Kc,[["__scopeId","data-v-3be093fb"]]),Xc=U({__name:"VPHome",setup(e){const{frontmatter:n,theme:t}=ne();return(a,o)=>{const i=tn("Content");return f(),w("div",{class:Q(["VPHome",{"external-link-icon-enabled":m(t).externalLinkIcon}])},[C(a.$slots,"home-hero-before",{},void 0,!0),j(Lc,null,{"home-hero-info-before":N(()=>[C(a.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":N(()=>[C(a.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":N(()=>[C(a.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":N(()=>[C(a.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":N(()=>[C(a.$slots,"home-hero-image",{},void 0,!0)]),_:3}),C(a.$slots,"home-hero-after",{},void 0,!0),C(a.$slots,"home-features-before",{},void 0,!0),j(Wc),C(a.$slots,"home-features-after",{},void 0,!0),m(n).markdownStyles!==!1?(f(),G(Yc,{key:0},{default:N(()=>[j(i)]),_:1})):(f(),G(i,{key:1}))],2)}}}),Qc=X(Xc,[["__scopeId","data-v-6e6fdb32"]]),Jc={},Zc={class:"VPPage"};function eu(e,n){const t=tn("Content");return f(),w("div",Zc,[C(e.$slots,"page-top"),j(t),C(e.$slots,"page-bottom")])}const nu=X(Jc,[["render",eu]]),tu=U({__name:"VPContent",setup(e){const{page:n,frontmatter:t}=ne(),{hasSidebar:a}=Qe();return(o,i)=>(f(),w("div",{class:Q(["VPContent",{"has-sidebar":m(a),"is-home":m(t).layout==="home"}]),id:"VPContent"},[m(n).isNotFound?C(o.$slots,"not-found",{key:0},()=>[j(_l)],!0):m(t).layout==="page"?(f(),G(nu,{key:1},{"page-top":N(()=>[C(o.$slots,"page-top",{},void 0,!0)]),"page-bottom":N(()=>[C(o.$slots,"page-bottom",{},void 0,!0)]),_:3})):m(t).layout==="home"?(f(),G(Qc,{key:2},{"home-hero-before":N(()=>[C(o.$slots,"home-hero-before",{},void 0,!0)]),"home-hero-info-before":N(()=>[C(o.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":N(()=>[C(o.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":N(()=>[C(o.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":N(()=>[C(o.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":N(()=>[C(o.$slots,"home-hero-image",{},void 0,!0)]),"home-hero-after":N(()=>[C(o.$slots,"home-hero-after",{},void 0,!0)]),"home-features-before":N(()=>[C(o.$slots,"home-features-before",{},void 0,!0)]),"home-features-after":N(()=>[C(o.$slots,"home-features-after",{},void 0,!0)]),_:3})):m(t).layout&&m(t).layout!=="doc"?(f(),G(ze(m(t).layout),{key:3})):(f(),G(fc,{key:4},{"doc-top":N(()=>[C(o.$slots,"doc-top",{},void 0,!0)]),"doc-bottom":N(()=>[C(o.$slots,"doc-bottom",{},void 0,!0)]),"doc-footer-before":N(()=>[C(o.$slots,"doc-footer-before",{},void 0,!0)]),"doc-before":N(()=>[C(o.$slots,"doc-before",{},void 0,!0)]),"doc-after":N(()=>[C(o.$slots,"doc-after",{},void 0,!0)]),"aside-top":N(()=>[C(o.$slots,"aside-top",{},void 0,!0)]),"aside-outline-before":N(()=>[C(o.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":N(()=>[C(o.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":N(()=>[C(o.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":N(()=>[C(o.$slots,"aside-ads-after",{},void 0,!0)]),"aside-bottom":N(()=>[C(o.$slots,"aside-bottom",{},void 0,!0)]),_:3}))],2))}}),au=X(tu,[["__scopeId","data-v-714062c7"]]),ou={class:"container"},iu=["innerHTML"],su=["innerHTML"],ru=U({__name:"VPFooter",setup(e){const{theme:n,frontmatter:t}=ne(),{hasSidebar:a}=Qe();return(o,i)=>m(n).footer&&m(t).footer!==!1?(f(),w("footer",{key:0,class:Q(["VPFooter",{"has-sidebar":m(a)}])},[p("div",ou,[m(n).footer.message?(f(),w("p",{key:0,class:"message",innerHTML:m(n).footer.message},null,8,iu)):q("",!0),m(n).footer.copyright?(f(),w("p",{key:1,class:"copyright",innerHTML:m(n).footer.copyright},null,8,su)):q("",!0)])],2)):q("",!0)}}),lu=X(ru,[["__scopeId","data-v-a0954f24"]]);function cu(){const{theme:e,frontmatter:n}=ne(),t=_s([]),a=R(()=>t.value.length>0);return Ot(()=>{t.value=Ua(n.value.outline??e.value.outline)}),{headers:t,hasLocalNav:a}}const uu={class:"menu-text"},du={class:"header"},hu={class:"outline"},pu=U({__name:"VPLocalNavOutlineDropdown",props:{headers:{},navHeight:{}},setup(e){const n=e,{theme:t}=ne(),a=ae(!1),o=ae(0),i=ae(),s=ae();function r(g){var u;(u=i.value)!=null&&u.contains(g.target)||(a.value=!1)}De(a,g=>{if(g){document.addEventListener("click",r);return}document.removeEventListener("click",r)}),va("Escape",()=>{a.value=!1}),Ot(()=>{a.value=!1});function l(){a.value=!a.value,o.value=window.innerHeight+Math.min(window.scrollY-n.navHeight,0)}function c(g){g.target.classList.contains("outline-link")&&(s.value&&(s.value.style.transition="none"),Ba(()=>{a.value=!1}))}function d(){a.value=!1,window.scrollTo({top:0,left:0,behavior:"smooth"})}return(g,u)=>(f(),w("div",{class:"VPLocalNavOutlineDropdown",style:Va({"--vp-vh":o.value+"px"}),ref_key:"main",ref:i},[e.headers.length>0?(f(),w("button",{key:0,onClick:l,class:Q({open:a.value})},[p("span",uu,S(m(Ss)(m(t))),1),u[0]||(u[0]=p("span",{class:"vpi-chevron-right icon"},null,-1))],2)):(f(),w("button",{key:1,onClick:d},S(m(t).returnToTopLabel||"Return to top"),1)),j(Oa,{name:"flyout"},{default:N(()=>[a.value?(f(),w("div",{key:0,ref_key:"items",ref:s,class:"items",onClick:c},[p("div",du,[p("a",{class:"top-link",href:"#",onClick:d},S(m(t).returnToTopLabel||"Return to top"),1)]),p("div",hu,[j(Is,{headers:e.headers},null,8,["headers"])])],512)):q("",!0)]),_:1})],4))}}),gu=X(pu,[["__scopeId","data-v-f210c2f8"]]),mu={class:"container"},fu=["aria-expanded"],vu={class:"menu-text"},bu=U({__name:"VPLocalNav",props:{open:{type:Boolean}},emits:["open-menu"],setup(e){const{theme:n,frontmatter:t}=ne(),{hasSidebar:a}=Qe(),{headers:o}=cu(),{y:i}=ks(),s=ae(0);Ee(()=>{s.value=parseInt(getComputedStyle(document.documentElement).getPropertyValue("--vp-nav-height"))}),Ot(()=>{o.value=Ua(t.value.outline??n.value.outline)});const r=R(()=>o.value.length===0),l=R(()=>r.value&&!a.value),c=R(()=>({VPLocalNav:!0,"has-sidebar":a.value,empty:r.value,fixed:l.value}));return(d,g)=>m(t).layout!=="home"&&(!l.value||m(i)>=s.value)?(f(),w("div",{key:0,class:Q(c.value)},[p("div",mu,[m(a)?(f(),w("button",{key:0,class:"menu","aria-expanded":e.open,"aria-controls":"VPSidebarNav",onClick:g[0]||(g[0]=u=>d.$emit("open-menu"))},[g[1]||(g[1]=p("span",{class:"vpi-align-left menu-icon"},null,-1)),p("span",vu,S(m(n).sidebarMenuLabel||"Menu"),1)],8,fu)):q("",!0),j(gu,{headers:m(o),navHeight:s.value},null,8,["headers","navHeight"])])],2)):q("",!0)}}),yu=X(bu,[["__scopeId","data-v-f8cca058"]]);function _u(){const e=ae(!1);function n(){e.value=!0,window.addEventListener("resize",o)}function t(){e.value=!1,window.removeEventListener("resize",o)}function a(){e.value?t():n()}function o(){window.outerWidth>=768&&t()}const i=mn();return De(()=>i.path,t),{isScreenOpen:e,openScreen:n,closeScreen:t,toggleScreen:a}}const wu={},ku={class:"VPSwitch",type:"button",role:"switch"},xu={class:"check"},Au={key:0,class:"icon"};function Cu(e,n){return f(),w("button",ku,[p("span",xu,[e.$slots.default?(f(),w("span",Au,[C(e.$slots,"default",{},void 0,!0)])):q("",!0)])])}const Tu=X(wu,[["render",Cu],["__scopeId","data-v-71e7f96a"]]),Su=U({__name:"VPSwitchAppearance",setup(e){const{isDark:n,theme:t}=ne(),a=Rt("toggle-appearance",()=>{n.value=!n.value}),o=ae("");return qa(()=>{o.value=n.value?t.value.lightModeSwitchTitle||"Switch to light theme":t.value.darkModeSwitchTitle||"Switch to dark theme"}),(i,s)=>(f(),G(Tu,{title:o.value,class:"VPSwitchAppearance","aria-checked":m(n),onClick:m(a)},{default:N(()=>[...s[0]||(s[0]=[p("span",{class:"vpi-sun sun"},null,-1),p("span",{class:"vpi-moon moon"},null,-1)])]),_:1},8,["title","aria-checked","onClick"]))}}),Ga=X(Su,[["__scopeId","data-v-40158760"]]),Iu={key:0,class:"VPNavBarAppearance"},Pu=U({__name:"VPNavBarAppearance",setup(e){const{site:n}=ne();return(t,a)=>m(n).appearance&&m(n).appearance!=="force-dark"&&m(n).appearance!=="force-auto"?(f(),w("div",Iu,[j(Ga)])):q("",!0)}}),Mu=X(Pu,[["__scopeId","data-v-e3e8a76b"]]),Ha=ae();let Ps=!1,ea=0;function Du(e){const n=ae(!1);if(zt){!Ps&&Lu(),ea++;const t=De(Ha,a=>{var o,i,s;a===e.el.value||(o=e.el.value)!=null&&o.contains(a)?(n.value=!0,(i=e.onFocus)==null||i.call(e)):(n.value=!1,(s=e.onBlur)==null||s.call(e))});za(()=>{t(),ea--,ea||$u()})}return el(n)}function Lu(){document.addEventListener("focusin",Ms),Ps=!0,Ha.value=document.activeElement}function $u(){document.removeEventListener("focusin",Ms)}function Ms(){Ha.value=document.activeElement}const Nu={class:"VPMenuLink"},Eu=["innerHTML"],Ou=U({__name:"VPMenuLink",props:{item:{}},setup(e){const{page:n}=ne();return(t,a)=>(f(),w("div",Nu,[j(qe,{class:Q({active:m(un)(m(n).relativePath,e.item.activeMatch||e.item.link,!!e.item.activeMatch)}),href:e.item.link,target:e.item.target,rel:e.item.rel,"no-icon":e.item.noIcon},{default:N(()=>[p("span",{innerHTML:e.item.text},null,8,Eu)]),_:1},8,["class","href","target","rel","no-icon"])]))}}),qt=X(Ou,[["__scopeId","data-v-9182bc9d"]]),Ru={class:"VPMenuGroup"},zu={key:0,class:"title"},qu=U({__name:"VPMenuGroup",props:{text:{},items:{}},setup(e){return(n,t)=>(f(),w("div",Ru,[e.text?(f(),w("p",zu,S(e.text),1)):q("",!0),(f(!0),w(Z,null,ie(e.items,a=>(f(),w(Z,null,["link"in a?(f(),G(qt,{key:0,item:a},null,8,["item"])):q("",!0)],64))),256))]))}}),Vu=X(qu,[["__scopeId","data-v-a0052f3d"]]),Bu={class:"VPMenu"},Fu={key:0,class:"items"},ju=U({__name:"VPMenu",props:{items:{}},setup(e){return(n,t)=>(f(),w("div",Bu,[e.items?(f(),w("div",Fu,[(f(!0),w(Z,null,ie(e.items,a=>(f(),w(Z,{key:JSON.stringify(a)},["link"in a?(f(),G(qt,{key:0,item:a},null,8,["item"])):"component"in a?(f(),G(ze(a.component),en({key:1,ref_for:!0},a.props),null,16)):(f(),G(Vu,{key:2,text:a.text,items:a.items},null,8,["text","items"]))],64))),128))])):q("",!0),C(n.$slots,"default",{},void 0,!0)]))}}),Uu=X(ju,[["__scopeId","data-v-6ac81520"]]),Gu=["aria-expanded","aria-label"],Hu={key:0,class:"text"},Wu=["innerHTML"],Ku={key:1,class:"vpi-more-horizontal icon"},Yu={class:"menu"},Xu=U({__name:"VPFlyout",props:{icon:{},button:{},label:{},items:{}},setup(e){const n=ae(!1),t=ae();Du({el:t,onBlur:a});function a(){n.value=!1}return(o,i)=>(f(),w("div",{class:"VPFlyout",ref_key:"el",ref:t,onMouseenter:i[1]||(i[1]=s=>n.value=!0),onMouseleave:i[2]||(i[2]=s=>n.value=!1)},[p("button",{type:"button",class:"button","aria-haspopup":"true","aria-expanded":n.value,"aria-label":e.label,onClick:i[0]||(i[0]=s=>n.value=!n.value)},[e.button||e.icon?(f(),w("span",Hu,[e.icon?(f(),w("span",{key:0,class:Q([e.icon,"option-icon"])},null,2)):q("",!0),e.button?(f(),w("span",{key:1,innerHTML:e.button},null,8,Wu)):q("",!0),i[3]||(i[3]=p("span",{class:"vpi-chevron-down text-icon"},null,-1))])):(f(),w("span",Ku))],8,Gu),p("div",Yu,[j(Uu,{items:e.items},{default:N(()=>[C(o.$slots,"default",{},void 0,!0)]),_:3},8,["items"])])],544))}}),Wa=X(Xu,[["__scopeId","data-v-beb8b8d5"]]),Qu=["href","aria-label","innerHTML"],Ju=U({__name:"VPSocialLink",props:{icon:{},link:{},ariaLabel:{}},setup(e){const n=e,t=ae();Ee(async()=>{var i;await Ba();const o=(i=t.value)==null?void 0:i.children[0];o instanceof HTMLElement&&o.className.startsWith("vpi-social-")&&(getComputedStyle(o).maskImage||getComputedStyle(o).webkitMaskImage)==="none"&&o.style.setProperty("--icon",`url('https://api.iconify.design/simple-icons/${n.icon}.svg')`)});const a=R(()=>typeof n.icon=="object"?n.icon.svg:`<span class="vpi-social-${n.icon}"></span>`);return(o,i)=>(f(),w("a",{ref_key:"el",ref:t,class:"VPSocialLink no-icon",href:e.link,"aria-label":e.ariaLabel??(typeof e.icon=="string"?e.icon:""),target:"_blank",rel:"noopener",innerHTML:a.value},null,8,Qu))}}),Zu=X(Ju,[["__scopeId","data-v-7652e684"]]),ed={class:"VPSocialLinks"},nd=U({__name:"VPSocialLinks",props:{links:{}},setup(e){return(n,t)=>(f(),w("div",ed,[(f(!0),w(Z,null,ie(e.links,({link:a,icon:o,ariaLabel:i})=>(f(),G(Zu,{key:a,icon:o,link:a,ariaLabel:i},null,8,["icon","link","ariaLabel"]))),128))]))}}),Ka=X(nd,[["__scopeId","data-v-54791c74"]]),td={key:0,class:"group translations"},ad={class:"trans-title"},od={key:1,class:"group"},id={class:"item appearance"},sd={class:"label"},rd={class:"appearance-action"},ld={key:2,class:"group"},cd={class:"item social-links"},ud=U({__name:"VPNavBarExtra",setup(e){const{site:n,theme:t}=ne(),{localeLinks:a,currentLang:o}=Yn({correspondingLink:!0}),i=R(()=>a.value.length&&o.value.label||n.value.appearance||t.value.socialLinks);return(s,r)=>i.value?(f(),G(Wa,{key:0,class:"VPNavBarExtra",label:"extra navigation"},{default:N(()=>[m(a).length&&m(o).label?(f(),w("div",td,[p("p",ad,S(m(o).label),1),(f(!0),w(Z,null,ie(m(a),l=>(f(),G(qt,{key:l.link,item:l},null,8,["item"]))),128))])):q("",!0),m(n).appearance&&m(n).appearance!=="force-dark"&&m(n).appearance!=="force-auto"?(f(),w("div",od,[p("div",id,[p("p",sd,S(m(t).darkModeSwitchLabel||"Appearance"),1),p("div",rd,[j(Ga)])])])):q("",!0),m(t).socialLinks?(f(),w("div",ld,[p("div",cd,[j(Ka,{class:"social-links-list",links:m(t).socialLinks},null,8,["links"])])])):q("",!0)]),_:1})):q("",!0)}}),dd=X(ud,[["__scopeId","data-v-ad50955e"]]),hd=["aria-expanded"],pd=U({__name:"VPNavBarHamburger",props:{active:{type:Boolean}},emits:["click"],setup(e){return(n,t)=>(f(),w("button",{type:"button",class:Q(["VPNavBarHamburger",{active:e.active}]),"aria-label":"mobile navigation","aria-expanded":e.active,"aria-controls":"VPNavScreen",onClick:t[0]||(t[0]=a=>n.$emit("click"))},[...t[1]||(t[1]=[p("span",{class:"container"},[p("span",{class:"top"}),p("span",{class:"middle"}),p("span",{class:"bottom"})],-1)])],10,hd))}}),gd=X(pd,[["__scopeId","data-v-5e4fa142"]]),md=["innerHTML"],fd=U({__name:"VPNavBarMenuLink",props:{item:{}},setup(e){const{page:n}=ne();return(t,a)=>(f(),G(qe,{class:Q({VPNavBarMenuLink:!0,active:m(un)(m(n).relativePath,e.item.activeMatch||e.item.link,!!e.item.activeMatch)}),href:e.item.link,target:e.item.target,rel:e.item.rel,"no-icon":e.item.noIcon,tabindex:"0"},{default:N(()=>[p("span",{innerHTML:e.item.text},null,8,md)]),_:1},8,["class","href","target","rel","no-icon"]))}}),vd=X(fd,[["__scopeId","data-v-f75fdd7c"]]),bd=U({__name:"VPNavBarMenuGroup",props:{item:{}},setup(e){const n=e,{page:t}=ne(),a=i=>"component"in i?!1:"link"in i?un(t.value.relativePath,i.link,!!n.item.activeMatch):i.items.some(a),o=R(()=>a(n.item));return(i,s)=>(f(),G(Wa,{class:Q({VPNavBarMenuGroup:!0,active:m(un)(m(t).relativePath,e.item.activeMatch,!!e.item.activeMatch)||o.value}),button:e.item.text,items:e.item.items},null,8,["class","button","items"]))}}),yd={key:0,"aria-labelledby":"main-nav-aria-label",class:"VPNavBarMenu"},_d=U({__name:"VPNavBarMenu",setup(e){const{theme:n}=ne();return(t,a)=>m(n).nav?(f(),w("nav",yd,[a[0]||(a[0]=p("span",{id:"main-nav-aria-label",class:"visually-hidden"}," Main Navigation ",-1)),(f(!0),w(Z,null,ie(m(n).nav,o=>(f(),w(Z,{key:JSON.stringify(o)},["link"in o?(f(),G(vd,{key:0,item:o},null,8,["item"])):"component"in o?(f(),G(ze(o.component),en({key:1,ref_for:!0},o.props),null,16)):(f(),G(bd,{key:2,item:o},null,8,["item"]))],64))),128))])):q("",!0)}}),wd=X(_d,[["__scopeId","data-v-e90f0632"]]);function kd(e){const{localeIndex:n,theme:t}=ne();function a(o){var v,b,_;const i=o.split("."),s=(v=t.value.search)==null?void 0:v.options,r=s&&typeof s=="object",l=r&&((_=(b=s.locales)==null?void 0:b[n.value])==null?void 0:_.translations)||null,c=r&&s.translations||null;let d=l,g=c,u=e;const h=i.pop();for(const x of i){let A=null;const D=u==null?void 0:u[x];D&&(A=u=D);const y=g==null?void 0:g[x];y&&(A=g=y);const T=d==null?void 0:d[x];T&&(A=d=T),D||(u=A),y||(g=A),T||(d=A)}return(d==null?void 0:d[h])??(g==null?void 0:g[h])??(u==null?void 0:u[h])??""}return a}const xd=["aria-label"],Ad={class:"DocSearch-Button-Container"},Cd={class:"DocSearch-Button-Placeholder"},Ai=U({__name:"VPNavBarSearchButton",setup(e){const t=kd({button:{buttonText:"Search",buttonAriaLabel:"Search"}});return(a,o)=>(f(),w("button",{type:"button",class:"DocSearch DocSearch-Button","aria-label":m(t)("button.buttonAriaLabel")},[p("span",Ad,[o[0]||(o[0]=p("span",{class:"vp-icon DocSearch-Search-Icon"},null,-1)),p("span",Cd,S(m(t)("button.buttonText")),1)]),o[1]||(o[1]=p("span",{class:"DocSearch-Button-Keys"},[p("kbd",{class:"DocSearch-Button-Key"}),p("kbd",{class:"DocSearch-Button-Key"},"K")],-1))],8,xd))}}),Td={class:"VPNavBarSearch"},Sd={id:"local-search"},Id={key:1,id:"docsearch"},Ya=U({__name:"VPNavBarSearch",setup(e){const n=nl(()=>xs(()=>import("./VPLocalSearchBox.DHVS_-5S.js"),__vite__mapDeps([0,1]))),t=()=>null,{theme:a}=ne(),o=ae(!1),i=ae(!1);Ee(()=>{});function s(){o.value||(o.value=!0,setTimeout(r,16))}function r(){const g=new Event("keydown");g.key="k",g.metaKey=!0,window.dispatchEvent(g),setTimeout(()=>{document.querySelector(".DocSearch-Modal")||r()},16)}function l(g){const u=g.target,h=u.tagName;return u.isContentEditable||h==="INPUT"||h==="SELECT"||h==="TEXTAREA"}const c=ae(!1);va("k",g=>{(g.ctrlKey||g.metaKey)&&(g.preventDefault(),c.value=!0)}),va("/",g=>{l(g)||(g.preventDefault(),c.value=!0)});const d="local";return(g,u)=>{var h;return f(),w("div",Td,[m(d)==="local"?(f(),w(Z,{key:0},[c.value?(f(),G(m(n),{key:0,onClose:u[0]||(u[0]=v=>c.value=!1)})):q("",!0),p("div",Sd,[j(Ai,{onClick:u[1]||(u[1]=v=>c.value=!0)})])],64)):m(d)==="algolia"?(f(),w(Z,{key:1},[o.value?(f(),G(m(t),{key:0,algolia:((h=m(a).search)==null?void 0:h.options)??m(a).algolia,onVnodeBeforeMount:u[2]||(u[2]=v=>i.value=!0)},null,8,["algolia"])):q("",!0),i.value?q("",!0):(f(),w("div",Id,[j(Ai,{onClick:s})]))],64)):q("",!0)])}}}),Pd=U({__name:"VPNavBarSocialLinks",setup(e){const{theme:n}=ne();return(t,a)=>m(n).socialLinks?(f(),G(Ka,{key:0,class:"VPNavBarSocialLinks",links:m(n).socialLinks},null,8,["links"])):q("",!0)}}),Md=X(Pd,[["__scopeId","data-v-27e2b2b1"]]),Dd=["href","rel","target"],Ld=["innerHTML"],$d={key:2},Nd=U({__name:"VPNavBarTitle",setup(e){const{site:n,theme:t}=ne(),{hasSidebar:a}=Qe(),{currentLang:o}=Yn(),i=R(()=>{var l;return typeof t.value.logoLink=="string"?t.value.logoLink:(l=t.value.logoLink)==null?void 0:l.link}),s=R(()=>{var l;return typeof t.value.logoLink=="string"||(l=t.value.logoLink)==null?void 0:l.rel}),r=R(()=>{var l;return typeof t.value.logoLink=="string"||(l=t.value.logoLink)==null?void 0:l.target});return(l,c)=>(f(),w("div",{class:Q(["VPNavBarTitle",{"has-sidebar":m(a)}])},[p("a",{class:"title",href:i.value??m(ja)(m(o).link),rel:s.value,target:r.value},[C(l.$slots,"nav-bar-title-before",{},void 0,!0),m(t).logo?(f(),G(pt,{key:0,class:"logo",image:m(t).logo},null,8,["image"])):q("",!0),m(t).siteTitle?(f(),w("span",{key:1,innerHTML:m(t).siteTitle},null,8,Ld)):m(t).siteTitle===void 0?(f(),w("span",$d,S(m(n).title),1)):q("",!0),C(l.$slots,"nav-bar-title-after",{},void 0,!0)],8,Dd)],2))}}),Ed=X(Nd,[["__scopeId","data-v-6ec1a2fc"]]),Od={class:"items"},Rd={class:"title"},zd=U({__name:"VPNavBarTranslations",setup(e){const{theme:n}=ne(),{localeLinks:t,currentLang:a}=Yn({correspondingLink:!0});return(o,i)=>m(t).length&&m(a).label?(f(),G(Wa,{key:0,class:"VPNavBarTranslations",icon:"vpi-languages",label:m(n).langMenuLabel||"Change language"},{default:N(()=>[p("div",Od,[p("p",Rd,S(m(a).label),1),(f(!0),w(Z,null,ie(m(t),s=>(f(),G(qt,{key:s.link,item:s},null,8,["item"]))),128))])]),_:1},8,["label"])):q("",!0)}}),Ds=X(zd,[["__scopeId","data-v-40afd59f"]]),qd={class:"wrapper"},Vd={class:"container"},Bd={class:"title"},Fd={class:"content"},jd={class:"content-body"},Ud=U({__name:"VPNavBar",props:{isScreenOpen:{type:Boolean}},emits:["toggle-screen"],setup(e){const n=e,{y:t}=ks(),{hasSidebar:a}=Qe(),{frontmatter:o}=ne(),i=ae({});return qa(()=>{i.value={"has-sidebar":a.value,home:o.value.layout==="home",top:t.value===0,"screen-open":n.isScreenOpen}}),(s,r)=>(f(),w("div",{class:Q(["VPNavBar",i.value])},[p("div",qd,[p("div",Vd,[p("div",Bd,[j(Ed,null,{"nav-bar-title-before":N(()=>[C(s.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":N(()=>[C(s.$slots,"nav-bar-title-after",{},void 0,!0)]),_:3})]),p("div",Fd,[p("div",jd,[C(s.$slots,"nav-bar-content-before",{},void 0,!0),j(Ya,{class:"search"}),j(wd,{class:"menu"}),j(Ds,{class:"translations"}),j(Mu,{class:"appearance"}),j(Md,{class:"social-links"}),j(dd,{class:"extra"}),C(s.$slots,"nav-bar-content-after",{},void 0,!0),j(gd,{class:"hamburger",active:e.isScreenOpen,onClick:r[0]||(r[0]=l=>s.$emit("toggle-screen"))},null,8,["active"])])])])]),r[1]||(r[1]=p("div",{class:"divider"},[p("div",{class:"divider-line"})],-1))],2))}}),Gd=X(Ud,[["__scopeId","data-v-de524931"]]),Hd={key:0,class:"VPNavScreenAppearance"},Wd={class:"text"},Kd=U({__name:"VPNavScreenAppearance",setup(e){const{site:n,theme:t}=ne();return(a,o)=>m(n).appearance&&m(n).appearance!=="force-dark"&&m(n).appearance!=="force-auto"?(f(),w("div",Hd,[p("p",Wd,S(m(t).darkModeSwitchLabel||"Appearance"),1),j(Ga)])):q("",!0)}}),Yd=X(Kd,[["__scopeId","data-v-37559f51"]]),Xd=["innerHTML"],Qd=U({__name:"VPNavScreenMenuLink",props:{item:{}},setup(e){const n=Rt("close-screen");return(t,a)=>(f(),G(qe,{class:"VPNavScreenMenuLink",href:e.item.link,target:e.item.target,rel:e.item.rel,"no-icon":e.item.noIcon,onClick:m(n)},{default:N(()=>[p("span",{innerHTML:e.item.text},null,8,Xd)]),_:1},8,["href","target","rel","no-icon","onClick"]))}}),Jd=X(Qd,[["__scopeId","data-v-80e6e6d6"]]),Zd=["innerHTML"],eh=U({__name:"VPNavScreenMenuGroupLink",props:{item:{}},setup(e){const n=Rt("close-screen");return(t,a)=>(f(),G(qe,{class:"VPNavScreenMenuGroupLink",href:e.item.link,target:e.item.target,rel:e.item.rel,"no-icon":e.item.noIcon,onClick:m(n)},{default:N(()=>[p("span",{innerHTML:e.item.text},null,8,Zd)]),_:1},8,["href","target","rel","no-icon","onClick"]))}}),Ls=X(eh,[["__scopeId","data-v-bd01957f"]]),nh={class:"VPNavScreenMenuGroupSection"},th={key:0,class:"title"},ah=U({__name:"VPNavScreenMenuGroupSection",props:{text:{},items:{}},setup(e){return(n,t)=>(f(),w("div",nh,[e.text?(f(),w("p",th,S(e.text),1)):q("",!0),(f(!0),w(Z,null,ie(e.items,a=>(f(),G(Ls,{key:a.text,item:a},null,8,["item"]))),128))]))}}),oh=X(ah,[["__scopeId","data-v-cd0e7558"]]),ih=["aria-controls","aria-expanded"],sh=["innerHTML"],rh=["id"],lh={key:0,class:"item"},ch={key:1,class:"item"},uh={key:2,class:"group"},dh=U({__name:"VPNavScreenMenuGroup",props:{text:{},items:{}},setup(e){const n=e,t=ae(!1),a=R(()=>`NavScreenGroup-${n.text.replace(" ","-").toLowerCase()}`);function o(){t.value=!t.value}return(i,s)=>(f(),w("div",{class:Q(["VPNavScreenMenuGroup",{open:t.value}])},[p("button",{class:"button","aria-controls":a.value,"aria-expanded":t.value,onClick:o},[p("span",{class:"button-text",innerHTML:e.text},null,8,sh),s[0]||(s[0]=p("span",{class:"vpi-plus button-icon"},null,-1))],8,ih),p("div",{id:a.value,class:"items"},[(f(!0),w(Z,null,ie(e.items,r=>(f(),w(Z,{key:JSON.stringify(r)},["link"in r?(f(),w("div",lh,[j(Ls,{item:r},null,8,["item"])])):"component"in r?(f(),w("div",ch,[(f(),G(ze(r.component),en({ref_for:!0},r.props,{"screen-menu":""}),null,16))])):(f(),w("div",uh,[j(oh,{text:r.text,items:r.items},null,8,["text","items"])]))],64))),128))],8,rh)],2))}}),hh=X(dh,[["__scopeId","data-v-3d415584"]]),ph={key:0,class:"VPNavScreenMenu"},gh=U({__name:"VPNavScreenMenu",setup(e){const{theme:n}=ne();return(t,a)=>m(n).nav?(f(),w("nav",ph,[(f(!0),w(Z,null,ie(m(n).nav,o=>(f(),w(Z,{key:JSON.stringify(o)},["link"in o?(f(),G(Jd,{key:0,item:o},null,8,["item"])):"component"in o?(f(),G(ze(o.component),en({key:1,ref_for:!0},o.props,{"screen-menu":""}),null,16)):(f(),G(hh,{key:2,text:o.text||"",items:o.items},null,8,["text","items"]))],64))),128))])):q("",!0)}}),mh=U({__name:"VPNavScreenSocialLinks",setup(e){const{theme:n}=ne();return(t,a)=>m(n).socialLinks?(f(),G(Ka,{key:0,class:"VPNavScreenSocialLinks",links:m(n).socialLinks},null,8,["links"])):q("",!0)}}),fh={class:"list"},vh=U({__name:"VPNavScreenTranslations",setup(e){const{localeLinks:n,currentLang:t}=Yn({correspondingLink:!0}),a=ae(!1);function o(){a.value=!a.value}return(i,s)=>m(n).length&&m(t).label?(f(),w("div",{key:0,class:Q(["VPNavScreenTranslations",{open:a.value}])},[p("button",{class:"title",onClick:o},[s[0]||(s[0]=p("span",{class:"vpi-languages icon lang"},null,-1)),Ae(" "+S(m(t).label)+" ",1),s[1]||(s[1]=p("span",{class:"vpi-chevron-down icon chevron"},null,-1))]),p("ul",fh,[(f(!0),w(Z,null,ie(m(n),r=>(f(),w("li",{key:r.link,class:"item"},[j(qe,{class:"link",href:r.link},{default:N(()=>[Ae(S(r.text),1)]),_:2},1032,["href"])]))),128))])],2)):q("",!0)}}),bh=X(vh,[["__scopeId","data-v-59d95cf4"]]),yh={class:"container"},_h=U({__name:"VPNavScreen",props:{open:{type:Boolean}},setup(e){const n=ae(null),t=As(zt?document.body:null);return(a,o)=>(f(),G(Oa,{name:"fade",onEnter:o[0]||(o[0]=i=>t.value=!0),onAfterLeave:o[1]||(o[1]=i=>t.value=!1)},{default:N(()=>[e.open?(f(),w("div",{key:0,class:"VPNavScreen",ref_key:"screen",ref:n,id:"VPNavScreen"},[p("div",yh,[C(a.$slots,"nav-screen-content-before",{},void 0,!0),j(gh,{class:"menu"}),j(bh,{class:"translations"}),j(Yd,{class:"appearance"}),j(mh,{class:"social-links"}),C(a.$slots,"nav-screen-content-after",{},void 0,!0)])],512)):q("",!0)]),_:3}))}}),wh=X(_h,[["__scopeId","data-v-07baf27b"]]),kh={key:0,class:"VPNav"},xh=U({__name:"VPNav",setup(e){const{isScreenOpen:n,closeScreen:t,toggleScreen:a}=_u(),{frontmatter:o}=ne(),i=R(()=>o.value.navbar!==!1);return Cs("close-screen",t),Et(()=>{zt&&document.documentElement.classList.toggle("hide-nav",!i.value)}),(s,r)=>i.value?(f(),w("header",kh,[j(Gd,{"is-screen-open":m(n),onToggleScreen:m(a)},{"nav-bar-title-before":N(()=>[C(s.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":N(()=>[C(s.$slots,"nav-bar-title-after",{},void 0,!0)]),"nav-bar-content-before":N(()=>[C(s.$slots,"nav-bar-content-before",{},void 0,!0)]),"nav-bar-content-after":N(()=>[C(s.$slots,"nav-bar-content-after",{},void 0,!0)]),_:3},8,["is-screen-open","onToggleScreen"]),j(wh,{open:m(n)},{"nav-screen-content-before":N(()=>[C(s.$slots,"nav-screen-content-before",{},void 0,!0)]),"nav-screen-content-after":N(()=>[C(s.$slots,"nav-screen-content-after",{},void 0,!0)]),_:3},8,["open"])])):q("",!0)}}),Ah=X(xh,[["__scopeId","data-v-717bd8c6"]]),Ch=["role","tabindex"],Th={key:1,class:"items"},Sh=U({__name:"VPSidebarItem",props:{item:{},depth:{}},setup(e){const n=e,{collapsed:t,collapsible:a,isLink:o,isActiveLink:i,hasActiveLink:s,hasChildren:r,toggle:l}=Al(R(()=>n.item)),c=R(()=>r.value?"section":"div"),d=R(()=>o.value?"a":"div"),g=R(()=>r.value?n.depth+2===7?"p":`h${n.depth+2}`:"p"),u=R(()=>o.value?void 0:"button"),h=R(()=>[[`level-${n.depth}`],{collapsible:a.value},{collapsed:t.value},{"is-link":o.value},{"is-active":i.value},{"has-active":s.value}]);function v(_){"key"in _&&_.key!=="Enter"||!n.item.link&&l()}function b(){n.item.link&&l()}return(_,x)=>{const A=tn("VPSidebarItem",!0);return f(),G(ze(c.value),{class:Q(["VPSidebarItem",h.value])},{default:N(()=>[e.item.text?(f(),w("div",en({key:0,class:"item",role:u.value},tl(e.item.items?{click:v,keydown:v}:{},!0),{tabindex:e.item.items&&0}),[x[1]||(x[1]=p("div",{class:"indicator"},null,-1)),e.item.link?(f(),G(qe,{key:0,tag:d.value,class:"link",href:e.item.link,rel:e.item.rel,target:e.item.target},{default:N(()=>[(f(),G(ze(g.value),{class:"text",innerHTML:e.item.text},null,8,["innerHTML"]))]),_:1},8,["tag","href","rel","target"])):(f(),G(ze(g.value),{key:1,class:"text",innerHTML:e.item.text},null,8,["innerHTML"])),e.item.collapsed!=null&&e.item.items&&e.item.items.length?(f(),w("div",{key:2,class:"caret",role:"button","aria-label":"toggle section",onClick:b,onKeydown:al(b,["enter"]),tabindex:"0"},[...x[0]||(x[0]=[p("span",{class:"vpi-chevron-right caret-icon"},null,-1)])],32)):q("",!0)],16,Ch)):q("",!0),e.item.items&&e.item.items.length?(f(),w("div",Th,[e.depth<5?(f(!0),w(Z,{key:0},ie(e.item.items,D=>(f(),G(A,{key:D.text,item:D,depth:e.depth+1},null,8,["item","depth"]))),128)):q("",!0)])):q("",!0)]),_:1},8,["class"])}}}),Ih=X(Sh,[["__scopeId","data-v-08047252"]]),Ph=U({__name:"VPSidebarGroup",props:{items:{}},setup(e){const n=ae(!0);let t=null;return Ee(()=>{t=setTimeout(()=>{t=null,n.value=!1},300)}),Fa(()=>{t!=null&&(clearTimeout(t),t=null)}),(a,o)=>(f(!0),w(Z,null,ie(e.items,i=>(f(),w("div",{key:i.text,class:Q(["group",{"no-transition":n.value}])},[j(Ih,{item:i,depth:0},null,8,["item"])],2))),128))}}),Mh=X(Ph,[["__scopeId","data-v-ba5ce4ae"]]),Dh={class:"nav",id:"VPSidebarNav","aria-labelledby":"sidebar-aria-label",tabindex:"-1"},Lh=U({__name:"VPSidebar",props:{open:{type:Boolean}},setup(e){const{sidebarGroups:n,hasSidebar:t}=Qe(),a=e,o=ae(null),i=As(zt?document.body:null);De([a,o],()=>{var r;a.open?(i.value=!0,(r=o.value)==null||r.focus()):i.value=!1},{immediate:!0,flush:"post"});const s=ae(0);return De(n,()=>{s.value+=1},{deep:!0}),(r,l)=>m(t)?(f(),w("aside",{key:0,class:Q(["VPSidebar",{open:e.open}]),ref_key:"navEl",ref:o,onClick:l[0]||(l[0]=ol(()=>{},["stop"]))},[l[2]||(l[2]=p("div",{class:"curtain"},null,-1)),p("nav",Dh,[l[1]||(l[1]=p("span",{class:"visually-hidden",id:"sidebar-aria-label"}," Sidebar Navigation ",-1)),C(r.$slots,"sidebar-nav-before",{},void 0,!0),(f(),G(Mh,{items:m(n),key:s.value},null,8,["items"])),C(r.$slots,"sidebar-nav-after",{},void 0,!0)])],2)):q("",!0)}}),$h=X(Lh,[["__scopeId","data-v-9e9a3195"]]),Nh=U({__name:"VPSkipLink",setup(e){const{theme:n}=ne(),t=mn(),a=ae();De(()=>t.path,()=>a.value.focus());function o({target:i}){const s=document.getElementById(decodeURIComponent(i.hash).slice(1));if(s){const r=()=>{s.removeAttribute("tabindex"),s.removeEventListener("blur",r)};s.setAttribute("tabindex","-1"),s.addEventListener("blur",r),s.focus(),window.scrollTo(0,0)}}return(i,s)=>(f(),w(Z,null,[p("span",{ref_key:"backToTop",ref:a,tabindex:"-1"},null,512),p("a",{href:"#VPContent",class:"VPSkipLink visually-hidden",onClick:o},S(m(n).skipToContentLabel||"Skip to content"),1)],64))}}),Eh=X(Nh,[["__scopeId","data-v-2f312717"]]),Oh=U({__name:"Layout",setup(e){const{isOpen:n,open:t,close:a}=Qe(),o=mn();De(()=>o.path,a),xl(n,a);const{frontmatter:i}=ne(),s=il(),r=R(()=>!!s["home-hero-image"]);return Cs("hero-image-slot-exists",r),(l,c)=>{const d=tn("Content");return m(i).layout!==!1?(f(),w("div",{key:0,class:Q(["Layout",m(i).pageClass])},[C(l.$slots,"layout-top",{},void 0,!0),j(Eh),j(ul,{class:"backdrop",show:m(n),onClick:m(a)},null,8,["show","onClick"]),j(Ah,null,{"nav-bar-title-before":N(()=>[C(l.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":N(()=>[C(l.$slots,"nav-bar-title-after",{},void 0,!0)]),"nav-bar-content-before":N(()=>[C(l.$slots,"nav-bar-content-before",{},void 0,!0)]),"nav-bar-content-after":N(()=>[C(l.$slots,"nav-bar-content-after",{},void 0,!0)]),"nav-screen-content-before":N(()=>[C(l.$slots,"nav-screen-content-before",{},void 0,!0)]),"nav-screen-content-after":N(()=>[C(l.$slots,"nav-screen-content-after",{},void 0,!0)]),_:3}),j(yu,{open:m(n),onOpenMenu:m(t)},null,8,["open","onOpenMenu"]),j($h,{open:m(n)},{"sidebar-nav-before":N(()=>[C(l.$slots,"sidebar-nav-before",{},void 0,!0)]),"sidebar-nav-after":N(()=>[C(l.$slots,"sidebar-nav-after",{},void 0,!0)]),_:3},8,["open"]),j(au,null,{"page-top":N(()=>[C(l.$slots,"page-top",{},void 0,!0)]),"page-bottom":N(()=>[C(l.$slots,"page-bottom",{},void 0,!0)]),"not-found":N(()=>[C(l.$slots,"not-found",{},void 0,!0)]),"home-hero-before":N(()=>[C(l.$slots,"home-hero-before",{},void 0,!0)]),"home-hero-info-before":N(()=>[C(l.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":N(()=>[C(l.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":N(()=>[C(l.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":N(()=>[C(l.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":N(()=>[C(l.$slots,"home-hero-image",{},void 0,!0)]),"home-hero-after":N(()=>[C(l.$slots,"home-hero-after",{},void 0,!0)]),"home-features-before":N(()=>[C(l.$slots,"home-features-before",{},void 0,!0)]),"home-features-after":N(()=>[C(l.$slots,"home-features-after",{},void 0,!0)]),"doc-footer-before":N(()=>[C(l.$slots,"doc-footer-before",{},void 0,!0)]),"doc-before":N(()=>[C(l.$slots,"doc-before",{},void 0,!0)]),"doc-after":N(()=>[C(l.$slots,"doc-after",{},void 0,!0)]),"doc-top":N(()=>[C(l.$slots,"doc-top",{},void 0,!0)]),"doc-bottom":N(()=>[C(l.$slots,"doc-bottom",{},void 0,!0)]),"aside-top":N(()=>[C(l.$slots,"aside-top",{},void 0,!0)]),"aside-bottom":N(()=>[C(l.$slots,"aside-bottom",{},void 0,!0)]),"aside-outline-before":N(()=>[C(l.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":N(()=>[C(l.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":N(()=>[C(l.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":N(()=>[C(l.$slots,"aside-ads-after",{},void 0,!0)]),_:3}),j(lu),C(l.$slots,"layout-bottom",{},void 0,!0)],2)):(f(),G(d,{key:1}))}}}),Rh=X(Oh,[["__scopeId","data-v-3fa573af"]]),$s={Layout:Rh,enhanceApp:({app:e})=>{e.component("Badge",rl)}},zh={class:"flex items-center rounded-lg border border-slate-200 dark:border-slate-700 overflow-hidden"},qh={key:1,class:"flex flex-wrap items-center gap-2"},Vh=["href"],Ci=U({__name:"ThemeControls",props:{compact:{type:Boolean,default:!1},showSearch:{type:Boolean,default:!0}},setup(e){const n=ae("light"),t=mn(),{site:a}=gn(),o=R(()=>{const h=a.value.locales||{};return Object.values(h).map(v=>{const b=typeof(v==null?void 0:v.label)=="string"?v.label:"",_=typeof(v==null?void 0:v.link)=="string"?v.link:"";return{label:b,link:_}}).filter(v=>!!(v.label&&v.link))}),i=R(()=>l(t.path)),s=R(()=>o.value.map(h=>l(h.link)).filter(h=>h!=="/").sort((h,v)=>v.length-h.length)),r=R(()=>{const h=i.value;for(const v of s.value)if(h===v||h.startsWith(`${v}/`))return v;return"/"});function l(h){if(!h)return"/";const[v]=h.split(/[?#]/);return v&&v.replace(/\/+$/,"")||"/"}function c(h){return r.value===l(h)}function d(h){for(const v of s.value){if(h===v)return"/";if(h.startsWith(`${v}/`))return h.slice(v.length)||"/"}return h}function g(h){const v=l(h),b=d(i.value);return v==="/"?b:`${v}${b==="/"?"/":b}`.replace(/\/{2,}/g,"/")}function u(h){if(typeof window>"u")return;n.value=h;const v=document.documentElement;v.classList.remove("dark"),h==="dark"&&v.classList.add("dark"),v.setAttribute("data-theme",h),v.style.colorScheme=h,localStorage.setItem("vitepress-theme-appearance",h)}return Ee(()=>{const h=localStorage.getItem("vitepress-theme-appearance"),v=document.documentElement.classList.contains("dark")?"dark":"light",b=h==="dark"||h==="light"?h:v;u(b),requestAnimationFrame(()=>u(b))}),(h,v)=>(f(),w("div",{class:Q(e.compact?"flex flex-col items-start gap-3":"flex items-center gap-3")},[e.showSearch&&!e.compact?(f(),G(Ya,{key:0})):q("",!0),p("div",zh,[p("button",{class:Q(["px-2.5 py-1.5 text-xs font-semibold transition-colors",n.value==="light"?"bg-slate-200 text-slate-900 dark:bg-slate-100":"bg-transparent text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800"]),onClick:v[0]||(v[0]=b=>u("light"))}," Light ",2),p("button",{class:Q(["px-2.5 py-1.5 text-xs font-semibold transition-colors",n.value==="dark"?"bg-slate-900 text-slate-100 dark:bg-slate-700":"bg-transparent text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800"]),onClick:v[1]||(v[1]=b=>u("dark"))}," Dark ",2)]),e.compact?(f(),w("div",qh,[(f(!0),w(Z,null,ie(o.value,b=>(f(),w("a",{key:b.link,class:Q(c(b.link)?"rounded-md border border-slate-300 dark:border-slate-600 bg-slate-100 dark:bg-slate-800 px-2.5 py-1 text-xs font-semibold text-slate-900 dark:text-slate-100":"rounded-md border border-slate-200 dark:border-slate-700 px-2.5 py-1 text-xs font-semibold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"),href:g(b.link)},S(b.label),11,Vh))),128))])):(f(),G(Ds,{key:2}))],2))}}),Bh={class:"fixed top-0 w-full z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200/15 dark:border-slate-800/15 shadow-[0px_24px_48px_rgba(42,52,57,0.06)]"},Fh={class:"flex items-center gap-3"},jh=["href"],Uh={class:"hidden md:flex items-center space-x-8 font-inter tracking-tight"},Gh=["href"],Hh={class:"hidden md:flex items-center gap-4"},Wh={key:0,class:"bg-primary text-on-primary px-5 py-2 rounded-lg font-medium text-sm transition-all active:opacity-80"},Kh={class:"md:hidden flex items-center gap-2"},Yh={class:"mobile-search"},Xh={class:"group relative"},Qh={class:"absolute right-0 mt-3 w-[min(20rem,calc(100vw-2rem))] rounded-xl border border-slate-200 dark:border-slate-700 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl shadow-xl p-4"},Jh={class:"space-y-1"},Zh=["href"],ep={class:"mt-4 border-t border-slate-200 dark:border-slate-700 pt-4"},np={key:0,class:"mt-4 w-full bg-primary text-on-primary px-5 py-2 rounded-lg font-medium text-sm transition-all active:opacity-80"},tp=U({__name:"SiteHeader",props:{siteTitle:{default:"MeshShape"},navLinks:{default:()=>[]},showSubscribe:{type:Boolean,default:!1},subscribeButtonText:{default:"Subscribe"},navHeightClass:{default:"h-20"}},setup(e){const n=mn();function t(i){const s=a(i);return s==="/en"||s.startsWith("/en/")?"/en/":"/"}function a(i){if(!i)return"/";const[s]=i.split(/[?#]/);return s&&s.replace(/\/+$/,"")||"/"}function o(i){if(i.active)return!0;const s=a(i.href),r=a(n.path);return s==="/"?r==="/":s==="/en"?r==="/en":r===s||r.startsWith(`${s}/`)}return(i,s)=>(f(),w("nav",Bh,[p("div",{class:Q(`flex justify-between items-center ${e.navHeightClass} px-8 w-full max-w-7xl mx-auto`)},[p("div",Fh,[p("a",{class:"text-xl font-bold tracking-tighter text-slate-900 dark:text-slate-50 hover:opacity-80 transition-opacity",href:t(m(n).path)},S(e.siteTitle),9,jh)]),p("div",Uh,[(f(!0),w(Z,null,ie(e.navLinks,r=>(f(),w("a",{key:r.text,class:Q(o(r)?"text-slate-900 dark:text-slate-50 font-semibold border-b-2 border-slate-900 dark:border-slate-50 pb-1 transition-all":"text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 transition-colors"),href:r.href||"#"},S(r.text),11,Gh))),128))]),p("div",Hh,[j(Ci),e.showSubscribe?(f(),w("button",Wh,S(e.subscribeButtonText),1)):q("",!0)]),p("div",Kh,[p("div",Yh,[j(Ya)]),p("details",Xh,[s[0]||(s[0]=p("summary",{class:"list-none flex items-center justify-center h-10 w-10 rounded-lg border border-slate-300/60 dark:border-slate-700/60 text-slate-700 dark:text-slate-200 cursor-pointer","aria-label":"Open mobile navigation menu"},[p("span",{class:"text-xl leading-none"},"≡")],-1)),p("div",Qh,[p("div",Jh,[(f(!0),w(Z,null,ie(e.navLinks,r=>(f(),w("a",{key:`mobile-${r.text}`,class:Q(o(r)?"block rounded-lg px-3 py-2 text-slate-900 dark:text-slate-50 font-semibold bg-slate-100 dark:bg-slate-800/80":"block rounded-lg px-3 py-2 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800/80 transition-colors"),href:r.href||"#"},S(r.text),11,Zh))),128))]),p("div",ep,[j(Ci,{compact:!0,"show-search":!1})]),e.showSubscribe?(f(),w("button",np,S(e.subscribeButtonText),1)):q("",!0)])])])],2)]))}}),Vt=X(tp,[["__scopeId","data-v-70c33c8b"]]),ap={class:"w-full border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950"},op={class:"max-w-7xl mx-auto px-8 py-12 flex flex-col md:flex-row justify-between items-center gap-8"},ip=["href"],sp={class:"text-sm font-inter tracking-wide text-slate-600 dark:text-slate-400"},rp={class:"flex flex-wrap justify-center gap-8"},lp=["href"],cp={key:0,class:"flex gap-4"},up={class:"material-symbols-outlined text-slate-600 dark:text-slate-400"},dp={key:0,class:"border-t border-slate-200/80 dark:border-slate-800/80"},hp={class:"max-w-7xl mx-auto px-8 py-4 flex flex-wrap items-center justify-center gap-x-3 gap-y-2 text-xs tracking-[0.08em] uppercase text-slate-500 dark:text-slate-400"},pp=["href"],gp=["href"],Bt=U({__name:"SiteFooter",props:{title:{default:"MeshShape"},description:{default:""},links:{default:()=>[]},filing:{default:null},socialIcons:{default:()=>[]}},setup(e){const n=mn();function t(o){if(!o)return"/";const[i]=o.split(/[?#]/);return i&&i.replace(/\/+$/,"")||"/"}function a(o){const i=t(o);return i==="/en"||i.startsWith("/en/")?"/en/":"/"}return(o,i)=>(f(),w("footer",ap,[p("div",op,[p("div",null,[p("a",{class:"text-lg font-bold text-slate-900 dark:text-slate-50 mb-2 inline-block hover:opacity-80 transition-opacity",href:a(m(n).path)},S(e.title),9,ip),p("p",sp,S(e.description),1)]),p("div",rp,[(f(!0),w(Z,null,ie(e.links,s=>(f(),w("a",{key:s.text,class:"text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors text-sm font-inter tracking-wide",href:s.href||"#"},S(s.text),9,lp))),128))]),e.socialIcons.length?(f(),w("div",cp,[(f(!0),w(Z,null,ie(e.socialIcons,s=>(f(),w("button",{key:s,class:"w-10 h-10 flex items-center justify-center rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:scale-105 transition-transform"},[p("span",up,S(s),1)]))),128))])):q("",!0)]),e.filing?(f(),w("div",dp,[p("div",hp,[p("a",{class:"hover:text-slate-700 dark:hover:text-slate-200 transition-colors",href:e.filing.href,rel:"noreferrer",target:"_blank"},S(e.filing.label),9,pp),i[0]||(i[0]=p("span",{class:"hidden sm:inline text-slate-300 dark:text-slate-700"},"/",-1)),p("a",{class:"font-medium tracking-[0.03em] normal-case hover:text-slate-700 dark:hover:text-slate-200 transition-colors",href:e.filing.href,rel:"noreferrer",target:"_blank"},S(e.filing.number),9,gp)])])):q("",!0)]))}});function Ft(){const{frontmatter:e}=gn(),n=R(()=>e.value);return{frontmatter:e,page:n}}function jt(){const{theme:e}=gn(),n=R(()=>e.value),t=R(()=>n.value.header||{}),a=R(()=>n.value.footer||{}),o=R(()=>n.value.ui||{});return{theme:e,themeConfig:n,headerConfig:t,footerConfig:a,uiConfig:o}}const mp="/assets/mesh-texture.CdcToYau.png",fp="/assets/mesh-architecture.BxOsXjO_.png",vp={class:"bg-surface text-slate-900 dark:text-slate-100 antialiased selection:bg-primary-container selection:text-on-primary-container"},bp={class:"pt-20 bg-surface"},yp={class:"relative overflow-hidden min-h-[870px] flex items-center px-8 max-w-7xl mx-auto"},_p={class:"grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full"},wp={class:"lg:col-span-5 lg:order-2 relative h-[320px] sm:h-[420px] lg:h-[500px] w-full mt-8 lg:mt-0"},kp={class:"absolute inset-0 bg-surface-container-low rounded-[2rem] overflow-hidden mesh-gradient group"},xp={class:"lg:col-span-7 lg:order-1 z-10"},Ap={class:"inline-block label-sm text-[0.6875rem] font-bold tracking-[0.05em] uppercase text-tertiary mb-6"},Cp={class:"text-[2.25rem] sm:text-[2.9rem] lg:text-[3.5rem] font-extrabold leading-[1.18] sm:leading-[1.12] lg:leading-[1.1] tracking-[-0.02em] text-slate-900 dark:text-slate-100 mb-8"},Tp={class:"text-[0.92em] sm:text-[1em] text-primary-dim"},Sp={class:"text-[1.375rem] leading-relaxed text-slate-700 dark:text-slate-400 max-w-2xl font-light"},Ip={class:"mt-12 mb-8 flex flex-col w-full gap-4 sm:flex-row sm:items-center sm:space-x-6 sm:gap-0"},Pp=["href"],Mp={class:"group-hover:underline"},Dp={class:"py-24 bg-surface-container-low dark:bg-slate-900"},Lp={class:"max-w-7xl mx-auto px-8"},$p={class:"mb-16 text-center lg:text-left"},Np={class:"text-[2.25rem] font-bold leading-[1.34] sm:leading-[1.2] tracking-tight text-slate-900 dark:text-slate-100 mb-8"},Ep={class:"text-slate-700 dark:text-slate-400 max-w-xl"},Op={class:"relative h-[350px] lg:h-auto lg:aspect-[21/9] w-full bg-surface-container-lowest rounded-[2rem] lg:rounded-full overflow-hidden outline outline-1 outline-outline-variant/10 group"},Rp=["src"],zp={class:"absolute bottom-6 left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] lg:w-auto lg:max-w-xs lg:left-12 lg:translate-x-0 lg:bottom-12 flex flex-col space-y-2 p-6 bg-white/40 backdrop-blur-md rounded-xl border border-white/20"},qp={class:"text-xs font-bold text-primary uppercase tracking-widest dark:text-tertiary"},Vp={class:"text-sm text-slate-900 dark:text-slate-300"},Bp={id:"insights-section",class:"py-32 bg-surface dark:bg-slate-950"},Fp={class:"max-w-7xl mx-auto px-8"},jp={class:"flex flex-col lg:flex-row gap-24 items-start"},Up={class:"lg:sticky lg:top-32 lg:w-1/3 w-full text-center lg:text-left"},Gp={class:"text-[3rem] font-extrabold tracking-tighter leading-tight mb-6 flex items-baseline justify-center lg:justify-start gap-x-0"},Hp={class:"text-slate-700 dark:text-slate-400"},Wp={class:"lg:w-2/3 space-y-32"},Kp={class:"flex flex-col lg:flex-row lg:items-baseline items-start gap-4 lg:gap-6 mb-8"},Yp={class:"text-[4rem] font-thin text-outline-variant leading-none"},Xp={class:"text-3xl font-bold tracking-tight text-slate-900 dark:text-slate-100 text-left"},Qp={class:"pl-0 lg:pl-20"},Jp={key:0,class:"space-y-5 mb-8 text-lg leading-relaxed text-slate-700 dark:text-slate-400"},Zp={key:1,class:"text-lg leading-relaxed text-slate-700 dark:text-slate-400 mb-8"},eg={key:2,class:"mb-8 space-y-3 text-base leading-relaxed text-slate-700 dark:text-slate-400"},ng={key:3,class:"mt-4 px-6 py-3 bg-surface-container-high text-primary rounded-lg text-sm font-semibold hover:bg-surface-container-highest transition-colors"},tg={class:"py-24 bg-surface-container-low dark:bg-slate-900 px-8"},ag={class:"max-w-7xl mx-auto"},og={class:"bg-primary-dim rounded-full p-16 lg:p-24 relative overflow-hidden group dark:bg-slate-900 dark:border dark:border-slate-800"},ig={class:"relative z-10 text-center lg:text-left"},sg={class:"text-[1.9rem] sm:text-[2.25rem] lg:text-[3.5rem] leading-[1.34] sm:leading-[1.28] lg:leading-[1.25] font-bold text-white mb-8 tracking-tighter"},rg={key:0,class:"flex flex-col sm:flex-row gap-6 justify-center lg:justify-start"},lg={key:0,class:"px-10 py-5 bg-white text-primary font-bold rounded-lg hover:bg-on-primary transition-transform active:scale-95"},cg={key:1,class:"px-10 py-5 bg-primary text-white border border-white/20 font-bold rounded-lg hover:bg-primary/80 transition-transform active:scale-95"},ug=U({__name:"HomeLayout",setup(e){const{page:n}=Ft(),{headerConfig:t,footerConfig:a}=jt();function o(){var i;typeof window>"u"||(i=document.getElementById("insights-section"))==null||i.scrollIntoView({behavior:"smooth",block:"start"})}return(i,s)=>(f(),w("div",vp,[j(Vt,{"site-title":m(t).siteTitle||m(n).siteTitle,"nav-links":m(t).navLinks||m(n).navLinks||[],"show-subscribe":!!m(t).showSubscribe,"subscribe-button-text":m(t).subscribeButtonText,"nav-height-class":"h-20"},null,8,["site-title","nav-links","show-subscribe","subscribe-button-text"]),p("main",bp,[p("section",yp,[p("div",_p,[p("div",wp,[p("div",kp,[p("div",{class:"absolute inset-0 opacity-20","data-alt":"Subtle geometric mesh pattern texture",style:Va({backgroundImage:`url(${m(mp)})`})},null,4),s[0]||(s[0]=sl('<div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] flex items-center justify-center"><div class="relative w-full h-full"><div class="mesh-line mesh-line-h absolute top-[20%] left-[20%] w-[60%] h-[2px] bg-primary/20 dark:bg-slate-300/45 rotate-[-15deg] transition-all duration-1000 ease-out group-hover:top-[40%]"></div><div class="mesh-line mesh-line-h absolute top-[40%] left-[20%] w-[60%] h-[2px] bg-primary/40 dark:bg-slate-300/45 rotate-[-15deg] transition-all duration-1000 ease-out group-hover:top-[60%]"></div><div class="mesh-line mesh-line-v absolute top-[20%] left-[40%] w-[2px] h-[60%] bg-primary/30 dark:bg-slate-300/45 rotate-[10deg] transition-all duration-1000 ease-out"></div><div class="mesh-line mesh-line-v absolute top-[20%] left-[60%] w-[2px] h-[60%] bg-primary/50 dark:bg-slate-300/45 rotate-[10deg] transition-all duration-1000 ease-out"></div></div></div>',1))])]),p("div",xp,[p("span",Ap,S(m(n).heroEyebrow),1),p("h1",Cp,[Ae(S(m(n).heroTitle),1),s[1]||(s[1]=p("br",null,null,-1)),p("span",Tp,S(m(n).heroTitleHighlight),1)]),p("p",Sp,S(m(n).heroDescription),1),p("div",Ip,[m(n).heroPrimaryButton?(f(),w("button",{key:0,class:"w-full sm:w-auto px-8 py-4 bg-primary text-on-primary rounded-lg font-medium hover:bg-primary-dim dark:bg-[#f7f9fb] dark:text-[#0f172a] dark:hover:bg-[#ffffff] transition-all hover:scale-[1.02] active:scale-95",onClick:o},S(m(n).heroPrimaryButton),1)):q("",!0),m(n).heroSecondaryButton?(f(),w("a",{key:1,class:"group w-full sm:w-auto flex items-center justify-center sm:justify-start space-x-2 text-tertiary font-medium px-8 py-4 rounded-lg",href:m(n).heroSecondaryButtonHref||"/blog/"},[p("span",Mp,S(m(n).heroSecondaryButton),1),s[2]||(s[2]=p("span",{class:"material-symbols-outlined text-sm"},"arrow_forward",-1))],8,Pp)):q("",!0)])])])]),p("section",Dp,[p("div",Lp,[p("div",$p,[p("h2",Np,S(m(n).structureTitle),1),p("p",Ep,S(m(n).structureDescription),1)]),p("div",Op,[p("img",{alt:"Architectural Mesh Diagram",class:"w-full h-full object-cover opacity-90 transition-transform duration-700 group-hover:scale-105","data-alt":"Digital blue circuit mesh representing neural network topology",src:m(fp)},null,8,Rp),s[3]||(s[3]=p("div",{class:"absolute inset-0 bg-gradient-to-t from-surface-container-lowest via-transparent to-transparent opacity-60"},null,-1)),p("div",zp,[p("span",qp,S(m(n).structureCardTitle),1),p("p",Vp,S(m(n).structureCardDescription),1)])])])]),p("section",Bp,[p("div",Fp,[p("div",jp,[p("div",Up,[p("h2",Gp,[p("span",null,S(m(n).insightsTitleLine1),1),p("span",null,[Ae(S(m(n).insightsTitleLine2),1),s[4]||(s[4]=p("span",{class:"text-tertiary"},".",-1))])]),p("p",Hp,S(m(n).insightsSubtitle),1)]),p("div",Wp,[(f(!0),w(Z,null,ie(m(n).insights||[],r=>{var l,c;return f(),w("div",{key:r.index,class:"group"},[p("div",Kp,[p("span",Yp,S(r.index),1),p("h3",Xp,S(r.title),1)]),p("div",Qp,[(l=r.paragraphs)!=null&&l.length?(f(),w("div",Jp,[(f(!0),w(Z,null,ie(r.paragraphs,d=>(f(),w("p",{key:d},S(d),1))),128))])):r.description?(f(),w("p",Zp,S(r.description),1)):q("",!0),(c=r.listItems)!=null&&c.length?(f(),w("ul",eg,[(f(!0),w(Z,null,ie(r.listItems,d=>(f(),w("li",{key:d,class:"flex gap-3"},[s[5]||(s[5]=p("span",{class:"mt-2 h-2 w-2 shrink-0 rounded-full bg-tertiary"},null,-1)),p("span",null,S(d),1)]))),128))])):q("",!0),r.buttonText?(f(),w("button",ng,S(r.buttonText),1)):q("",!0)])])}),128))])])])]),p("section",tg,[p("div",ag,[p("div",og,[s[6]||(s[6]=p("div",{class:"absolute top-0 right-0 w-1/2 h-full opacity-10 pointer-events-none"},[p("svg",{class:"w-full h-full scale-150 rotate-45",viewBox:"0 0 200 200",xmlns:"http://www.w3.org/2000/svg"},[p("path",{d:"M44.7,-76.4C58.1,-69.2,70.3,-58.5,78.4,-45.3C86.5,-32.1,90.4,-16,88.4,-0.6C86.5,14.8,78.6,29.6,69.5,42.4C60.4,55.1,50.1,65.8,37.5,72.6C24.9,79.5,10,82.5,-4.1,89.5C-18.1,96.6,-31.2,107.7,-43.3,105.7C-55.3,103.7,-66.2,88.5,-73.4,73.5C-80.6,58.4,-84.1,43.5,-86.3,28.9C-88.5,14.2,-89.4,-0.2,-86.3,-13.7C-83.2,-27.2,-76.1,-39.8,-66.5,-50.2C-56.9,-60.7,-44.8,-69.1,-32.2,-76.7C-19.6,-84.4,-6.5,-91.3,7.6,-104.4C21.7,-117.5,31.3,-83.6,44.7,-76.4Z",fill:"#FFFFFF",transform:"translate(100 100)"})])],-1)),p("div",ig,[p("h2",sg,S(m(n).ctaTitle),1),m(n).ctaPrimaryButton||m(n).ctaSecondaryButton?(f(),w("div",rg,[m(n).ctaPrimaryButton?(f(),w("button",lg,S(m(n).ctaPrimaryButton),1)):q("",!0),m(n).ctaSecondaryButton?(f(),w("button",cg,S(m(n).ctaSecondaryButton),1)):q("",!0)])):q("",!0)])])])])]),j(Bt,{title:m(a).title||m(n).footerTitle,description:m(a).description||m(n).footerDescription,links:m(a).links||m(n).footerLinks||[],filing:m(a).filing||null,"social-icons":m(a).socialIcons||[]},null,8,["title","description","links","filing","social-icons"])]))}}),Xa=`---
layout: about-me
heroEyebrow: 关于我
heroTitle: 技能“网”
...
---
`;function rt(e,n){return e==null||n==null?NaN:e<n?-1:e>n?1:e>=n?0:NaN}function dg(e,n){return e==null||n==null?NaN:n<e?-1:n>e?1:n>=e?0:NaN}function ni(e){let n,t,a;e.length!==2?(n=rt,t=(r,l)=>rt(e(r),l),a=(r,l)=>e(r)-l):(n=e===rt||e===dg?e:hg,t=e,a=e);function o(r,l,c=0,d=r.length){if(c<d){if(n(l,l)!==0)return d;do{const g=c+d>>>1;t(r[g],l)<0?c=g+1:d=g}while(c<d)}return c}function i(r,l,c=0,d=r.length){if(c<d){if(n(l,l)!==0)return d;do{const g=c+d>>>1;t(r[g],l)<=0?c=g+1:d=g}while(c<d)}return c}function s(r,l,c=0,d=r.length){const g=o(r,l,c,d-1);return g>c&&a(r[g-1],l)>-a(r[g],l)?g-1:g}return{left:o,center:s,right:i}}function hg(){return 0}function pg(e){return e===null?NaN:+e}const gg=ni(rt),mg=gg.right;ni(pg).center;class Ti extends Map{constructor(n,t=bg){if(super(),Object.defineProperties(this,{_intern:{value:new Map},_key:{value:t}}),n!=null)for(const[a,o]of n)this.set(a,o)}get(n){return super.get(Si(this,n))}has(n){return super.has(Si(this,n))}set(n,t){return super.set(fg(this,n),t)}delete(n){return super.delete(vg(this,n))}}function Si({_intern:e,_key:n},t){const a=n(t);return e.has(a)?e.get(a):t}function fg({_intern:e,_key:n},t){const a=n(t);return e.has(a)?e.get(a):(e.set(a,t),t)}function vg({_intern:e,_key:n},t){const a=n(t);return e.has(a)&&(t=e.get(a),e.delete(a)),t}function bg(e){return e!==null&&typeof e=="object"?e.valueOf():e}const yg=Math.sqrt(50),_g=Math.sqrt(10),wg=Math.sqrt(2);function gt(e,n,t){const a=(n-e)/Math.max(0,t),o=Math.floor(Math.log10(a)),i=a/Math.pow(10,o),s=i>=yg?10:i>=_g?5:i>=wg?2:1;let r,l,c;return o<0?(c=Math.pow(10,-o)/s,r=Math.round(e*c),l=Math.round(n*c),r/c<e&&++r,l/c>n&&--l,c=-c):(c=Math.pow(10,o)*s,r=Math.round(e/c),l=Math.round(n/c),r*c<e&&++r,l*c>n&&--l),l<r&&.5<=t&&t<2?gt(e,n,t*2):[r,l,c]}function kg(e,n,t){if(n=+n,e=+e,t=+t,!(t>0))return[];if(e===n)return[e];const a=n<e,[o,i,s]=a?gt(n,e,t):gt(e,n,t);if(!(i>=o))return[];const r=i-o+1,l=new Array(r);if(a)if(s<0)for(let c=0;c<r;++c)l[c]=(i-c)/-s;else for(let c=0;c<r;++c)l[c]=(i-c)*s;else if(s<0)for(let c=0;c<r;++c)l[c]=(o+c)/-s;else for(let c=0;c<r;++c)l[c]=(o+c)*s;return l}function wa(e,n,t){return n=+n,e=+e,t=+t,gt(e,n,t)[2]}function ka(e,n,t){n=+n,e=+e,t=+t;const a=n<e,o=a?wa(n,e,t):wa(e,n,t);return(a?-1:1)*(o<0?1/-o:o)}function Yw(e,n){let t;if(n===void 0)for(const a of e)a!=null&&(t<a||t===void 0&&a>=a)&&(t=a);else{let a=-1;for(let o of e)(o=n(o,++a,e))!=null&&(t<o||t===void 0&&o>=o)&&(t=o)}return t}function Xw(e,n){let t;if(n===void 0)for(const a of e)a!=null&&(t>a||t===void 0&&a>=a)&&(t=a);else{let a=-1;for(let o of e)(o=n(o,++a,e))!=null&&(t>o||t===void 0&&o>=o)&&(t=o)}return t}function xg(e,n,t){e=+e,n=+n,t=(o=arguments.length)<2?(n=e,e=0,1):o<3?1:+t;for(var a=-1,o=Math.max(0,Math.ceil((n-e)/t))|0,i=new Array(o);++a<o;)i[a]=e+a*t;return i}function Ag(e){return e}var lt=1,na=2,xa=3,Zn=4,Ii=1e-6;function Cg(e){return"translate("+e+",0)"}function Tg(e){return"translate(0,"+e+")"}function Sg(e){return n=>+e(n)}function Ig(e,n){return n=Math.max(0,e.bandwidth()-n*2)/2,e.round()&&(n=Math.round(n)),t=>+e(t)+n}function Pg(){return!this.__axis}function Ns(e,n){var t=[],a=null,o=null,i=6,s=6,r=3,l=typeof window<"u"&&window.devicePixelRatio>1?0:.5,c=e===lt||e===Zn?-1:1,d=e===Zn||e===na?"x":"y",g=e===lt||e===xa?Cg:Tg;function u(h){var v=a??(n.ticks?n.ticks.apply(n,t):n.domain()),b=o??(n.tickFormat?n.tickFormat.apply(n,t):Ag),_=Math.max(i,0)+r,x=n.range(),A=+x[0]+l,D=+x[x.length-1]+l,y=(n.bandwidth?Ig:Sg)(n.copy(),l),T=h.selection?h.selection():h,k=T.selectAll(".domain").data([null]),E=T.selectAll(".tick").data(v,n).order(),B=E.exit(),W=E.enter().append("g").attr("class","tick"),F=E.select("line"),$=E.select("text");k=k.merge(k.enter().insert("path",".tick").attr("class","domain").attr("stroke","currentColor")),E=E.merge(W),F=F.merge(W.append("line").attr("stroke","currentColor").attr(d+"2",c*i)),$=$.merge(W.append("text").attr("fill","currentColor").attr(d,c*_).attr("dy",e===lt?"0em":e===xa?"0.71em":"0.32em")),h!==T&&(k=k.transition(h),E=E.transition(h),F=F.transition(h),$=$.transition(h),B=B.transition(h).attr("opacity",Ii).attr("transform",function(M){return isFinite(M=y(M))?g(M+l):this.getAttribute("transform")}),W.attr("opacity",Ii).attr("transform",function(M){var L=this.parentNode.__axis;return g((L&&isFinite(L=L(M))?L:y(M))+l)})),B.remove(),k.attr("d",e===Zn||e===na?s?"M"+c*s+","+A+"H"+l+"V"+D+"H"+c*s:"M"+l+","+A+"V"+D:s?"M"+A+","+c*s+"V"+l+"H"+D+"V"+c*s:"M"+A+","+l+"H"+D),E.attr("opacity",1).attr("transform",function(M){return g(y(M)+l)}),F.attr(d+"2",c*i),$.attr(d,c*_).text(b),T.filter(Pg).attr("fill","none").attr("font-size",10).attr("font-family","sans-serif").attr("text-anchor",e===na?"start":e===Zn?"end":"middle"),T.each(function(){this.__axis=y})}return u.scale=function(h){return arguments.length?(n=h,u):n},u.ticks=function(){return t=Array.from(arguments),u},u.tickArguments=function(h){return arguments.length?(t=h==null?[]:Array.from(h),u):t.slice()},u.tickValues=function(h){return arguments.length?(a=h==null?null:Array.from(h),u):a&&a.slice()},u.tickFormat=function(h){return arguments.length?(o=h,u):o},u.tickSize=function(h){return arguments.length?(i=s=+h,u):i},u.tickSizeInner=function(h){return arguments.length?(i=+h,u):i},u.tickSizeOuter=function(h){return arguments.length?(s=+h,u):s},u.tickPadding=function(h){return arguments.length?(r=+h,u):r},u.offset=function(h){return arguments.length?(l=+h,u):l},u}function Qw(e){return Ns(lt,e)}function Jw(e){return Ns(xa,e)}var Mg={value:()=>{}};function Ut(){for(var e=0,n=arguments.length,t={},a;e<n;++e){if(!(a=arguments[e]+"")||a in t||/[\s.]/.test(a))throw new Error("illegal type: "+a);t[a]=[]}return new ct(t)}function ct(e){this._=e}function Dg(e,n){return e.trim().split(/^|\s+/).map(function(t){var a="",o=t.indexOf(".");if(o>=0&&(a=t.slice(o+1),t=t.slice(0,o)),t&&!n.hasOwnProperty(t))throw new Error("unknown type: "+t);return{type:t,name:a}})}ct.prototype=Ut.prototype={constructor:ct,on:function(e,n){var t=this._,a=Dg(e+"",t),o,i=-1,s=a.length;if(arguments.length<2){for(;++i<s;)if((o=(e=a[i]).type)&&(o=Lg(t[o],e.name)))return o;return}if(n!=null&&typeof n!="function")throw new Error("invalid callback: "+n);for(;++i<s;)if(o=(e=a[i]).type)t[o]=Pi(t[o],e.name,n);else if(n==null)for(o in t)t[o]=Pi(t[o],e.name,null);return this},copy:function(){var e={},n=this._;for(var t in n)e[t]=n[t].slice();return new ct(e)},call:function(e,n){if((o=arguments.length-2)>0)for(var t=new Array(o),a=0,o,i;a<o;++a)t[a]=arguments[a+2];if(!this._.hasOwnProperty(e))throw new Error("unknown type: "+e);for(i=this._[e],a=0,o=i.length;a<o;++a)i[a].value.apply(n,t)},apply:function(e,n,t){if(!this._.hasOwnProperty(e))throw new Error("unknown type: "+e);for(var a=this._[e],o=0,i=a.length;o<i;++o)a[o].value.apply(n,t)}};function Lg(e,n){for(var t=0,a=e.length,o;t<a;++t)if((o=e[t]).name===n)return o.value}function Pi(e,n,t){for(var a=0,o=e.length;a<o;++a)if(e[a].name===n){e[a]=Mg,e=e.slice(0,a).concat(e.slice(a+1));break}return t!=null&&e.push({name:n,value:t}),e}var Aa="http://www.w3.org/1999/xhtml";const Mi={svg:"http://www.w3.org/2000/svg",xhtml:Aa,xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"};function Gt(e){var n=e+="",t=n.indexOf(":");return t>=0&&(n=e.slice(0,t))!=="xmlns"&&(e=e.slice(t+1)),Mi.hasOwnProperty(n)?{space:Mi[n],local:e}:e}function $g(e){return function(){var n=this.ownerDocument,t=this.namespaceURI;return t===Aa&&n.documentElement.namespaceURI===Aa?n.createElement(e):n.createElementNS(t,e)}}function Ng(e){return function(){return this.ownerDocument.createElementNS(e.space,e.local)}}function Es(e){var n=Gt(e);return(n.local?Ng:$g)(n)}function Eg(){}function ti(e){return e==null?Eg:function(){return this.querySelector(e)}}function Og(e){typeof e!="function"&&(e=ti(e));for(var n=this._groups,t=n.length,a=new Array(t),o=0;o<t;++o)for(var i=n[o],s=i.length,r=a[o]=new Array(s),l,c,d=0;d<s;++d)(l=i[d])&&(c=e.call(l,l.__data__,d,i))&&("__data__"in l&&(c.__data__=l.__data__),r[d]=c);return new Pe(a,this._parents)}function Rg(e){return e==null?[]:Array.isArray(e)?e:Array.from(e)}function zg(){return[]}function Os(e){return e==null?zg:function(){return this.querySelectorAll(e)}}function qg(e){return function(){return Rg(e.apply(this,arguments))}}function Vg(e){typeof e=="function"?e=qg(e):e=Os(e);for(var n=this._groups,t=n.length,a=[],o=[],i=0;i<t;++i)for(var s=n[i],r=s.length,l,c=0;c<r;++c)(l=s[c])&&(a.push(e.call(l,l.__data__,c,s)),o.push(l));return new Pe(a,o)}function Rs(e){return function(){return this.matches(e)}}function zs(e){return function(n){return n.matches(e)}}var Bg=Array.prototype.find;function Fg(e){return function(){return Bg.call(this.children,e)}}function jg(){return this.firstElementChild}function Ug(e){return this.select(e==null?jg:Fg(typeof e=="function"?e:zs(e)))}var Gg=Array.prototype.filter;function Hg(){return Array.from(this.children)}function Wg(e){return function(){return Gg.call(this.children,e)}}function Kg(e){return this.selectAll(e==null?Hg:Wg(typeof e=="function"?e:zs(e)))}function Yg(e){typeof e!="function"&&(e=Rs(e));for(var n=this._groups,t=n.length,a=new Array(t),o=0;o<t;++o)for(var i=n[o],s=i.length,r=a[o]=[],l,c=0;c<s;++c)(l=i[c])&&e.call(l,l.__data__,c,i)&&r.push(l);return new Pe(a,this._parents)}function qs(e){return new Array(e.length)}function Xg(){return new Pe(this._enter||this._groups.map(qs),this._parents)}function mt(e,n){this.ownerDocument=e.ownerDocument,this.namespaceURI=e.namespaceURI,this._next=null,this._parent=e,this.__data__=n}mt.prototype={constructor:mt,appendChild:function(e){return this._parent.insertBefore(e,this._next)},insertBefore:function(e,n){return this._parent.insertBefore(e,n)},querySelector:function(e){return this._parent.querySelector(e)},querySelectorAll:function(e){return this._parent.querySelectorAll(e)}};function Qg(e){return function(){return e}}function Jg(e,n,t,a,o,i){for(var s=0,r,l=n.length,c=i.length;s<c;++s)(r=n[s])?(r.__data__=i[s],a[s]=r):t[s]=new mt(e,i[s]);for(;s<l;++s)(r=n[s])&&(o[s]=r)}function Zg(e,n,t,a,o,i,s){var r,l,c=new Map,d=n.length,g=i.length,u=new Array(d),h;for(r=0;r<d;++r)(l=n[r])&&(u[r]=h=s.call(l,l.__data__,r,n)+"",c.has(h)?o[r]=l:c.set(h,l));for(r=0;r<g;++r)h=s.call(e,i[r],r,i)+"",(l=c.get(h))?(a[r]=l,l.__data__=i[r],c.delete(h)):t[r]=new mt(e,i[r]);for(r=0;r<d;++r)(l=n[r])&&c.get(u[r])===l&&(o[r]=l)}function em(e){return e.__data__}function nm(e,n){if(!arguments.length)return Array.from(this,em);var t=n?Zg:Jg,a=this._parents,o=this._groups;typeof e!="function"&&(e=Qg(e));for(var i=o.length,s=new Array(i),r=new Array(i),l=new Array(i),c=0;c<i;++c){var d=a[c],g=o[c],u=g.length,h=tm(e.call(d,d&&d.__data__,c,a)),v=h.length,b=r[c]=new Array(v),_=s[c]=new Array(v),x=l[c]=new Array(u);t(d,g,b,_,x,h,n);for(var A=0,D=0,y,T;A<v;++A)if(y=b[A]){for(A>=D&&(D=A+1);!(T=_[D])&&++D<v;);y._next=T||null}}return s=new Pe(s,a),s._enter=r,s._exit=l,s}function tm(e){return typeof e=="object"&&"length"in e?e:Array.from(e)}function am(){return new Pe(this._exit||this._groups.map(qs),this._parents)}function om(e,n,t){var a=this.enter(),o=this,i=this.exit();return typeof e=="function"?(a=e(a),a&&(a=a.selection())):a=a.append(e+""),n!=null&&(o=n(o),o&&(o=o.selection())),t==null?i.remove():t(i),a&&o?a.merge(o).order():o}function im(e){for(var n=e.selection?e.selection():e,t=this._groups,a=n._groups,o=t.length,i=a.length,s=Math.min(o,i),r=new Array(o),l=0;l<s;++l)for(var c=t[l],d=a[l],g=c.length,u=r[l]=new Array(g),h,v=0;v<g;++v)(h=c[v]||d[v])&&(u[v]=h);for(;l<o;++l)r[l]=t[l];return new Pe(r,this._parents)}function sm(){for(var e=this._groups,n=-1,t=e.length;++n<t;)for(var a=e[n],o=a.length-1,i=a[o],s;--o>=0;)(s=a[o])&&(i&&s.compareDocumentPosition(i)^4&&i.parentNode.insertBefore(s,i),i=s);return this}function rm(e){e||(e=lm);function n(g,u){return g&&u?e(g.__data__,u.__data__):!g-!u}for(var t=this._groups,a=t.length,o=new Array(a),i=0;i<a;++i){for(var s=t[i],r=s.length,l=o[i]=new Array(r),c,d=0;d<r;++d)(c=s[d])&&(l[d]=c);l.sort(n)}return new Pe(o,this._parents).order()}function lm(e,n){return e<n?-1:e>n?1:e>=n?0:NaN}function cm(){var e=arguments[0];return arguments[0]=this,e.apply(null,arguments),this}function um(){return Array.from(this)}function dm(){for(var e=this._groups,n=0,t=e.length;n<t;++n)for(var a=e[n],o=0,i=a.length;o<i;++o){var s=a[o];if(s)return s}return null}function hm(){let e=0;for(const n of this)++e;return e}function pm(){return!this.node()}function gm(e){for(var n=this._groups,t=0,a=n.length;t<a;++t)for(var o=n[t],i=0,s=o.length,r;i<s;++i)(r=o[i])&&e.call(r,r.__data__,i,o);return this}function mm(e){return function(){this.removeAttribute(e)}}function fm(e){return function(){this.removeAttributeNS(e.space,e.local)}}function vm(e,n){return function(){this.setAttribute(e,n)}}function bm(e,n){return function(){this.setAttributeNS(e.space,e.local,n)}}function ym(e,n){return function(){var t=n.apply(this,arguments);t==null?this.removeAttribute(e):this.setAttribute(e,t)}}function _m(e,n){return function(){var t=n.apply(this,arguments);t==null?this.removeAttributeNS(e.space,e.local):this.setAttributeNS(e.space,e.local,t)}}function wm(e,n){var t=Gt(e);if(arguments.length<2){var a=this.node();return t.local?a.getAttributeNS(t.space,t.local):a.getAttribute(t)}return this.each((n==null?t.local?fm:mm:typeof n=="function"?t.local?_m:ym:t.local?bm:vm)(t,n))}function Vs(e){return e.ownerDocument&&e.ownerDocument.defaultView||e.document&&e||e.defaultView}function km(e){return function(){this.style.removeProperty(e)}}function xm(e,n,t){return function(){this.style.setProperty(e,n,t)}}function Am(e,n,t){return function(){var a=n.apply(this,arguments);a==null?this.style.removeProperty(e):this.style.setProperty(e,a,t)}}function Cm(e,n,t){return arguments.length>1?this.each((n==null?km:typeof n=="function"?Am:xm)(e,n,t??"")):Tn(this.node(),e)}function Tn(e,n){return e.style.getPropertyValue(n)||Vs(e).getComputedStyle(e,null).getPropertyValue(n)}function Tm(e){return function(){delete this[e]}}function Sm(e,n){return function(){this[e]=n}}function Im(e,n){return function(){var t=n.apply(this,arguments);t==null?delete this[e]:this[e]=t}}function Pm(e,n){return arguments.length>1?this.each((n==null?Tm:typeof n=="function"?Im:Sm)(e,n)):this.node()[e]}function Bs(e){return e.trim().split(/^|\s+/)}function ai(e){return e.classList||new Fs(e)}function Fs(e){this._node=e,this._names=Bs(e.getAttribute("class")||"")}Fs.prototype={add:function(e){var n=this._names.indexOf(e);n<0&&(this._names.push(e),this._node.setAttribute("class",this._names.join(" ")))},remove:function(e){var n=this._names.indexOf(e);n>=0&&(this._names.splice(n,1),this._node.setAttribute("class",this._names.join(" ")))},contains:function(e){return this._names.indexOf(e)>=0}};function js(e,n){for(var t=ai(e),a=-1,o=n.length;++a<o;)t.add(n[a])}function Us(e,n){for(var t=ai(e),a=-1,o=n.length;++a<o;)t.remove(n[a])}function Mm(e){return function(){js(this,e)}}function Dm(e){return function(){Us(this,e)}}function Lm(e,n){return function(){(n.apply(this,arguments)?js:Us)(this,e)}}function $m(e,n){var t=Bs(e+"");if(arguments.length<2){for(var a=ai(this.node()),o=-1,i=t.length;++o<i;)if(!a.contains(t[o]))return!1;return!0}return this.each((typeof n=="function"?Lm:n?Mm:Dm)(t,n))}function Nm(){this.textContent=""}function Em(e){return function(){this.textContent=e}}function Om(e){return function(){var n=e.apply(this,arguments);this.textContent=n??""}}function Rm(e){return arguments.length?this.each(e==null?Nm:(typeof e=="function"?Om:Em)(e)):this.node().textContent}function zm(){this.innerHTML=""}function qm(e){return function(){this.innerHTML=e}}function Vm(e){return function(){var n=e.apply(this,arguments);this.innerHTML=n??""}}function Bm(e){return arguments.length?this.each(e==null?zm:(typeof e=="function"?Vm:qm)(e)):this.node().innerHTML}function Fm(){this.nextSibling&&this.parentNode.appendChild(this)}function jm(){return this.each(Fm)}function Um(){this.previousSibling&&this.parentNode.insertBefore(this,this.parentNode.firstChild)}function Gm(){return this.each(Um)}function Hm(e){var n=typeof e=="function"?e:Es(e);return this.select(function(){return this.appendChild(n.apply(this,arguments))})}function Wm(){return null}function Km(e,n){var t=typeof e=="function"?e:Es(e),a=n==null?Wm:typeof n=="function"?n:ti(n);return this.select(function(){return this.insertBefore(t.apply(this,arguments),a.apply(this,arguments)||null)})}function Ym(){var e=this.parentNode;e&&e.removeChild(this)}function Xm(){return this.each(Ym)}function Qm(){var e=this.cloneNode(!1),n=this.parentNode;return n?n.insertBefore(e,this.nextSibling):e}function Jm(){var e=this.cloneNode(!0),n=this.parentNode;return n?n.insertBefore(e,this.nextSibling):e}function Zm(e){return this.select(e?Jm:Qm)}function ef(e){return arguments.length?this.property("__data__",e):this.node().__data__}function nf(e){return function(n){e.call(this,n,this.__data__)}}function tf(e){return e.trim().split(/^|\s+/).map(function(n){var t="",a=n.indexOf(".");return a>=0&&(t=n.slice(a+1),n=n.slice(0,a)),{type:n,name:t}})}function af(e){return function(){var n=this.__on;if(n){for(var t=0,a=-1,o=n.length,i;t<o;++t)i=n[t],(!e.type||i.type===e.type)&&i.name===e.name?this.removeEventListener(i.type,i.listener,i.options):n[++a]=i;++a?n.length=a:delete this.__on}}}function of(e,n,t){return function(){var a=this.__on,o,i=nf(n);if(a){for(var s=0,r=a.length;s<r;++s)if((o=a[s]).type===e.type&&o.name===e.name){this.removeEventListener(o.type,o.listener,o.options),this.addEventListener(o.type,o.listener=i,o.options=t),o.value=n;return}}this.addEventListener(e.type,i,t),o={type:e.type,name:e.name,value:n,listener:i,options:t},a?a.push(o):this.__on=[o]}}function sf(e,n,t){var a=tf(e+""),o,i=a.length,s;if(arguments.length<2){var r=this.node().__on;if(r){for(var l=0,c=r.length,d;l<c;++l)for(o=0,d=r[l];o<i;++o)if((s=a[o]).type===d.type&&s.name===d.name)return d.value}return}for(r=n?of:af,o=0;o<i;++o)this.each(r(a[o],n,t));return this}function Gs(e,n,t){var a=Vs(e),o=a.CustomEvent;typeof o=="function"?o=new o(n,t):(o=a.document.createEvent("Event"),t?(o.initEvent(n,t.bubbles,t.cancelable),o.detail=t.detail):o.initEvent(n,!1,!1)),e.dispatchEvent(o)}function rf(e,n){return function(){return Gs(this,e,n)}}function lf(e,n){return function(){return Gs(this,e,n.apply(this,arguments))}}function cf(e,n){return this.each((typeof n=="function"?lf:rf)(e,n))}function*uf(){for(var e=this._groups,n=0,t=e.length;n<t;++n)for(var a=e[n],o=0,i=a.length,s;o<i;++o)(s=a[o])&&(yield s)}var Hs=[null];function Pe(e,n){this._groups=e,this._parents=n}function Xn(){return new Pe([[document.documentElement]],Hs)}function df(){return this}Pe.prototype=Xn.prototype={constructor:Pe,select:Og,selectAll:Vg,selectChild:Ug,selectChildren:Kg,filter:Yg,data:nm,enter:Xg,exit:am,join:om,merge:im,selection:df,order:sm,sort:rm,call:cm,nodes:um,node:dm,size:hm,empty:pm,each:gm,attr:wm,style:Cm,property:Pm,classed:$m,text:Rm,html:Bm,raise:jm,lower:Gm,append:Hm,insert:Km,remove:Xm,clone:Zm,datum:ef,on:sf,dispatch:cf,[Symbol.iterator]:uf};function ln(e){return typeof e=="string"?new Pe([[document.querySelector(e)]],[document.documentElement]):new Pe([[e]],Hs)}function hf(e){let n;for(;n=e.sourceEvent;)e=n;return e}function Di(e,n){if(e=hf(e),n===void 0&&(n=e.currentTarget),n){var t=n.ownerSVGElement||n;if(t.createSVGPoint){var a=t.createSVGPoint();return a.x=e.clientX,a.y=e.clientY,a=a.matrixTransform(n.getScreenCTM().inverse()),[a.x,a.y]}if(n.getBoundingClientRect){var o=n.getBoundingClientRect();return[e.clientX-o.left-n.clientLeft,e.clientY-o.top-n.clientTop]}}return[e.pageX,e.pageY]}const pf={passive:!1},jn={capture:!0,passive:!1};function ta(e){e.stopImmediatePropagation()}function xn(e){e.preventDefault(),e.stopImmediatePropagation()}function gf(e){var n=e.document.documentElement,t=ln(e).on("dragstart.drag",xn,jn);"onselectstart"in n?t.on("selectstart.drag",xn,jn):(n.__noselect=n.style.MozUserSelect,n.style.MozUserSelect="none")}function mf(e,n){var t=e.document.documentElement,a=ln(e).on("dragstart.drag",null);n&&(a.on("click.drag",xn,jn),setTimeout(function(){a.on("click.drag",null)},0)),"onselectstart"in t?a.on("selectstart.drag",null):(t.style.MozUserSelect=t.__noselect,delete t.__noselect)}const et=e=>()=>e;function Ca(e,{sourceEvent:n,subject:t,target:a,identifier:o,active:i,x:s,y:r,dx:l,dy:c,dispatch:d}){Object.defineProperties(this,{type:{value:e,enumerable:!0,configurable:!0},sourceEvent:{value:n,enumerable:!0,configurable:!0},subject:{value:t,enumerable:!0,configurable:!0},target:{value:a,enumerable:!0,configurable:!0},identifier:{value:o,enumerable:!0,configurable:!0},active:{value:i,enumerable:!0,configurable:!0},x:{value:s,enumerable:!0,configurable:!0},y:{value:r,enumerable:!0,configurable:!0},dx:{value:l,enumerable:!0,configurable:!0},dy:{value:c,enumerable:!0,configurable:!0},_:{value:d}})}Ca.prototype.on=function(){var e=this._.on.apply(this._,arguments);return e===this._?this:e};function ff(e){return!e.ctrlKey&&!e.button}function vf(){return this.parentNode}function bf(e,n){return n??{x:e.x,y:e.y}}function yf(){return navigator.maxTouchPoints||"ontouchstart"in this}function _f(){var e=ff,n=vf,t=bf,a=yf,o={},i=Ut("start","drag","end"),s=0,r,l,c,d,g=0;function u(y){y.on("mousedown.drag",h).filter(a).on("touchstart.drag",_).on("touchmove.drag",x,pf).on("touchend.drag touchcancel.drag",A).style("touch-action","none").style("-webkit-tap-highlight-color","rgba(0,0,0,0)")}function h(y,T){if(!(d||!e.call(this,y,T))){var k=D(this,n.call(this,y,T),y,T,"mouse");k&&(ln(y.view).on("mousemove.drag",v,jn).on("mouseup.drag",b,jn),gf(y.view),ta(y),c=!1,r=y.clientX,l=y.clientY,k("start",y))}}function v(y){if(xn(y),!c){var T=y.clientX-r,k=y.clientY-l;c=T*T+k*k>g}o.mouse("drag",y)}function b(y){ln(y.view).on("mousemove.drag mouseup.drag",null),mf(y.view,c),xn(y),o.mouse("end",y)}function _(y,T){if(e.call(this,y,T)){var k=y.changedTouches,E=n.call(this,y,T),B=k.length,W,F;for(W=0;W<B;++W)(F=D(this,E,y,T,k[W].identifier,k[W]))&&(ta(y),F("start",y,k[W]))}}function x(y){var T=y.changedTouches,k=T.length,E,B;for(E=0;E<k;++E)(B=o[T[E].identifier])&&(xn(y),B("drag",y,T[E]))}function A(y){var T=y.changedTouches,k=T.length,E,B;for(d&&clearTimeout(d),d=setTimeout(function(){d=null},500),E=0;E<k;++E)(B=o[T[E].identifier])&&(ta(y),B("end",y,T[E]))}function D(y,T,k,E,B,W){var F=i.copy(),$=Di(W||k,T),M,L,z;if((z=t.call(y,new Ca("beforestart",{sourceEvent:k,target:u,identifier:B,active:s,x:$[0],y:$[1],dx:0,dy:0,dispatch:F}),E))!=null)return M=z.x-$[0]||0,L=z.y-$[1]||0,function te(ee,K,re){var de=$,ue;switch(ee){case"start":o[B]=te,ue=s++;break;case"end":delete o[B],--s;case"drag":$=Di(re||K,T),ue=s;break}F.call(ee,y,new Ca(ee,{sourceEvent:K,subject:z,target:u,identifier:B,active:ue,x:$[0]+M,y:$[1]+L,dx:$[0]-de[0],dy:$[1]-de[1],dispatch:F}),E)}}return u.filter=function(y){return arguments.length?(e=typeof y=="function"?y:et(!!y),u):e},u.container=function(y){return arguments.length?(n=typeof y=="function"?y:et(y),u):n},u.subject=function(y){return arguments.length?(t=typeof y=="function"?y:et(y),u):t},u.touchable=function(y){return arguments.length?(a=typeof y=="function"?y:et(!!y),u):a},u.on=function(){var y=i.on.apply(i,arguments);return y===i?u:y},u.clickDistance=function(y){return arguments.length?(g=(y=+y)*y,u):Math.sqrt(g)},u}function Qn(e,n,t){e.prototype=n.prototype=t,t.constructor=e}function Ht(e,n){var t=Object.create(e.prototype);for(var a in n)t[a]=n[a];return t}function fn(){}var Un=.7,ft=1/Un,An="\\s*([+-]?\\d+)\\s*",Gn="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*",Ve="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",wf=/^#([0-9a-f]{3,8})$/,kf=new RegExp(`^rgb\\(${An},${An},${An}\\)$`),xf=new RegExp(`^rgb\\(${Ve},${Ve},${Ve}\\)$`),Af=new RegExp(`^rgba\\(${An},${An},${An},${Gn}\\)$`),Cf=new RegExp(`^rgba\\(${Ve},${Ve},${Ve},${Gn}\\)$`),Tf=new RegExp(`^hsl\\(${Gn},${Ve},${Ve}\\)$`),Sf=new RegExp(`^hsla\\(${Gn},${Ve},${Ve},${Gn}\\)$`),Li={aliceblue:15792383,antiquewhite:16444375,aqua:65535,aquamarine:8388564,azure:15794175,beige:16119260,bisque:16770244,black:0,blanchedalmond:16772045,blue:255,blueviolet:9055202,brown:10824234,burlywood:14596231,cadetblue:6266528,chartreuse:8388352,chocolate:13789470,coral:16744272,cornflowerblue:6591981,cornsilk:16775388,crimson:14423100,cyan:65535,darkblue:139,darkcyan:35723,darkgoldenrod:12092939,darkgray:11119017,darkgreen:25600,darkgrey:11119017,darkkhaki:12433259,darkmagenta:9109643,darkolivegreen:5597999,darkorange:16747520,darkorchid:10040012,darkred:9109504,darksalmon:15308410,darkseagreen:9419919,darkslateblue:4734347,darkslategray:3100495,darkslategrey:3100495,darkturquoise:52945,darkviolet:9699539,deeppink:16716947,deepskyblue:49151,dimgray:6908265,dimgrey:6908265,dodgerblue:2003199,firebrick:11674146,floralwhite:16775920,forestgreen:2263842,fuchsia:16711935,gainsboro:14474460,ghostwhite:16316671,gold:16766720,goldenrod:14329120,gray:8421504,green:32768,greenyellow:11403055,grey:8421504,honeydew:15794160,hotpink:16738740,indianred:13458524,indigo:4915330,ivory:16777200,khaki:15787660,lavender:15132410,lavenderblush:16773365,lawngreen:8190976,lemonchiffon:16775885,lightblue:11393254,lightcoral:15761536,lightcyan:14745599,lightgoldenrodyellow:16448210,lightgray:13882323,lightgreen:9498256,lightgrey:13882323,lightpink:16758465,lightsalmon:16752762,lightseagreen:2142890,lightskyblue:8900346,lightslategray:7833753,lightslategrey:7833753,lightsteelblue:11584734,lightyellow:16777184,lime:65280,limegreen:3329330,linen:16445670,magenta:16711935,maroon:8388608,mediumaquamarine:6737322,mediumblue:205,mediumorchid:12211667,mediumpurple:9662683,mediumseagreen:3978097,mediumslateblue:8087790,mediumspringgreen:64154,mediumturquoise:4772300,mediumvioletred:13047173,midnightblue:1644912,mintcream:16121850,mistyrose:16770273,moccasin:16770229,navajowhite:16768685,navy:128,oldlace:16643558,olive:8421376,olivedrab:7048739,orange:16753920,orangered:16729344,orchid:14315734,palegoldenrod:15657130,palegreen:10025880,paleturquoise:11529966,palevioletred:14381203,papayawhip:16773077,peachpuff:16767673,peru:13468991,pink:16761035,plum:14524637,powderblue:11591910,purple:8388736,rebeccapurple:6697881,red:16711680,rosybrown:12357519,royalblue:4286945,saddlebrown:9127187,salmon:16416882,sandybrown:16032864,seagreen:3050327,seashell:16774638,sienna:10506797,silver:12632256,skyblue:8900331,slateblue:6970061,slategray:7372944,slategrey:7372944,snow:16775930,springgreen:65407,steelblue:4620980,tan:13808780,teal:32896,thistle:14204888,tomato:16737095,turquoise:4251856,violet:15631086,wheat:16113331,white:16777215,whitesmoke:16119285,yellow:16776960,yellowgreen:10145074};Qn(fn,dn,{copy(e){return Object.assign(new this.constructor,this,e)},displayable(){return this.rgb().displayable()},hex:$i,formatHex:$i,formatHex8:If,formatHsl:Pf,formatRgb:Ni,toString:Ni});function $i(){return this.rgb().formatHex()}function If(){return this.rgb().formatHex8()}function Pf(){return Ks(this).formatHsl()}function Ni(){return this.rgb().formatRgb()}function dn(e){var n,t;return e=(e+"").trim().toLowerCase(),(n=wf.exec(e))?(t=n[1].length,n=parseInt(n[1],16),t===6?Ei(n):t===3?new ye(n>>8&15|n>>4&240,n>>4&15|n&240,(n&15)<<4|n&15,1):t===8?nt(n>>24&255,n>>16&255,n>>8&255,(n&255)/255):t===4?nt(n>>12&15|n>>8&240,n>>8&15|n>>4&240,n>>4&15|n&240,((n&15)<<4|n&15)/255):null):(n=kf.exec(e))?new ye(n[1],n[2],n[3],1):(n=xf.exec(e))?new ye(n[1]*255/100,n[2]*255/100,n[3]*255/100,1):(n=Af.exec(e))?nt(n[1],n[2],n[3],n[4]):(n=Cf.exec(e))?nt(n[1]*255/100,n[2]*255/100,n[3]*255/100,n[4]):(n=Tf.exec(e))?zi(n[1],n[2]/100,n[3]/100,1):(n=Sf.exec(e))?zi(n[1],n[2]/100,n[3]/100,n[4]):Li.hasOwnProperty(e)?Ei(Li[e]):e==="transparent"?new ye(NaN,NaN,NaN,0):null}function Ei(e){return new ye(e>>16&255,e>>8&255,e&255,1)}function nt(e,n,t,a){return a<=0&&(e=n=t=NaN),new ye(e,n,t,a)}function Ws(e){return e instanceof fn||(e=dn(e)),e?(e=e.rgb(),new ye(e.r,e.g,e.b,e.opacity)):new ye}function Ta(e,n,t,a){return arguments.length===1?Ws(e):new ye(e,n,t,a??1)}function ye(e,n,t,a){this.r=+e,this.g=+n,this.b=+t,this.opacity=+a}Qn(ye,Ta,Ht(fn,{brighter(e){return e=e==null?ft:Math.pow(ft,e),new ye(this.r*e,this.g*e,this.b*e,this.opacity)},darker(e){return e=e==null?Un:Math.pow(Un,e),new ye(this.r*e,this.g*e,this.b*e,this.opacity)},rgb(){return this},clamp(){return new ye(cn(this.r),cn(this.g),cn(this.b),vt(this.opacity))},displayable(){return-.5<=this.r&&this.r<255.5&&-.5<=this.g&&this.g<255.5&&-.5<=this.b&&this.b<255.5&&0<=this.opacity&&this.opacity<=1},hex:Oi,formatHex:Oi,formatHex8:Mf,formatRgb:Ri,toString:Ri}));function Oi(){return`#${rn(this.r)}${rn(this.g)}${rn(this.b)}`}function Mf(){return`#${rn(this.r)}${rn(this.g)}${rn(this.b)}${rn((isNaN(this.opacity)?1:this.opacity)*255)}`}function Ri(){const e=vt(this.opacity);return`${e===1?"rgb(":"rgba("}${cn(this.r)}, ${cn(this.g)}, ${cn(this.b)}${e===1?")":`, ${e})`}`}function vt(e){return isNaN(e)?1:Math.max(0,Math.min(1,e))}function cn(e){return Math.max(0,Math.min(255,Math.round(e)||0))}function rn(e){return e=cn(e),(e<16?"0":"")+e.toString(16)}function zi(e,n,t,a){return a<=0?e=n=t=NaN:t<=0||t>=1?e=n=NaN:n<=0&&(e=NaN),new Ne(e,n,t,a)}function Ks(e){if(e instanceof Ne)return new Ne(e.h,e.s,e.l,e.opacity);if(e instanceof fn||(e=dn(e)),!e)return new Ne;if(e instanceof Ne)return e;e=e.rgb();var n=e.r/255,t=e.g/255,a=e.b/255,o=Math.min(n,t,a),i=Math.max(n,t,a),s=NaN,r=i-o,l=(i+o)/2;return r?(n===i?s=(t-a)/r+(t<a)*6:t===i?s=(a-n)/r+2:s=(n-t)/r+4,r/=l<.5?i+o:2-i-o,s*=60):r=l>0&&l<1?0:s,new Ne(s,r,l,e.opacity)}function Df(e,n,t,a){return arguments.length===1?Ks(e):new Ne(e,n,t,a??1)}function Ne(e,n,t,a){this.h=+e,this.s=+n,this.l=+t,this.opacity=+a}Qn(Ne,Df,Ht(fn,{brighter(e){return e=e==null?ft:Math.pow(ft,e),new Ne(this.h,this.s,this.l*e,this.opacity)},darker(e){return e=e==null?Un:Math.pow(Un,e),new Ne(this.h,this.s,this.l*e,this.opacity)},rgb(){var e=this.h%360+(this.h<0)*360,n=isNaN(e)||isNaN(this.s)?0:this.s,t=this.l,a=t+(t<.5?t:1-t)*n,o=2*t-a;return new ye(aa(e>=240?e-240:e+120,o,a),aa(e,o,a),aa(e<120?e+240:e-120,o,a),this.opacity)},clamp(){return new Ne(qi(this.h),tt(this.s),tt(this.l),vt(this.opacity))},displayable(){return(0<=this.s&&this.s<=1||isNaN(this.s))&&0<=this.l&&this.l<=1&&0<=this.opacity&&this.opacity<=1},formatHsl(){const e=vt(this.opacity);return`${e===1?"hsl(":"hsla("}${qi(this.h)}, ${tt(this.s)*100}%, ${tt(this.l)*100}%${e===1?")":`, ${e})`}`}}));function qi(e){return e=(e||0)%360,e<0?e+360:e}function tt(e){return Math.max(0,Math.min(1,e||0))}function aa(e,n,t){return(e<60?n+(t-n)*e/60:e<180?t:e<240?n+(t-n)*(240-e)/60:n)*255}const Lf=Math.PI/180,$f=180/Math.PI,bt=18,Ys=.96422,Xs=1,Qs=.82521,Js=4/29,Cn=6/29,Zs=3*Cn*Cn,Nf=Cn*Cn*Cn;function er(e){if(e instanceof Be)return new Be(e.l,e.a,e.b,e.opacity);if(e instanceof Ge)return nr(e);e instanceof ye||(e=Ws(e));var n=ra(e.r),t=ra(e.g),a=ra(e.b),o=oa((.2225045*n+.7168786*t+.0606169*a)/Xs),i,s;return n===t&&t===a?i=s=o:(i=oa((.4360747*n+.3850649*t+.1430804*a)/Ys),s=oa((.0139322*n+.0971045*t+.7141733*a)/Qs)),new Be(116*o-16,500*(i-o),200*(o-s),e.opacity)}function Ef(e,n,t,a){return arguments.length===1?er(e):new Be(e,n,t,a??1)}function Be(e,n,t,a){this.l=+e,this.a=+n,this.b=+t,this.opacity=+a}Qn(Be,Ef,Ht(fn,{brighter(e){return new Be(this.l+bt*(e??1),this.a,this.b,this.opacity)},darker(e){return new Be(this.l-bt*(e??1),this.a,this.b,this.opacity)},rgb(){var e=(this.l+16)/116,n=isNaN(this.a)?e:e+this.a/500,t=isNaN(this.b)?e:e-this.b/200;return n=Ys*ia(n),e=Xs*ia(e),t=Qs*ia(t),new ye(sa(3.1338561*n-1.6168667*e-.4906146*t),sa(-.9787684*n+1.9161415*e+.033454*t),sa(.0719453*n-.2289914*e+1.4052427*t),this.opacity)}}));function oa(e){return e>Nf?Math.pow(e,1/3):e/Zs+Js}function ia(e){return e>Cn?e*e*e:Zs*(e-Js)}function sa(e){return 255*(e<=.0031308?12.92*e:1.055*Math.pow(e,1/2.4)-.055)}function ra(e){return(e/=255)<=.04045?e/12.92:Math.pow((e+.055)/1.055,2.4)}function Of(e){if(e instanceof Ge)return new Ge(e.h,e.c,e.l,e.opacity);if(e instanceof Be||(e=er(e)),e.a===0&&e.b===0)return new Ge(NaN,0<e.l&&e.l<100?0:NaN,e.l,e.opacity);var n=Math.atan2(e.b,e.a)*$f;return new Ge(n<0?n+360:n,Math.sqrt(e.a*e.a+e.b*e.b),e.l,e.opacity)}function Sa(e,n,t,a){return arguments.length===1?Of(e):new Ge(e,n,t,a??1)}function Ge(e,n,t,a){this.h=+e,this.c=+n,this.l=+t,this.opacity=+a}function nr(e){if(isNaN(e.h))return new Be(e.l,0,0,e.opacity);var n=e.h*Lf;return new Be(e.l,Math.cos(n)*e.c,Math.sin(n)*e.c,e.opacity)}Qn(Ge,Sa,Ht(fn,{brighter(e){return new Ge(this.h,this.c,this.l+bt*(e??1),this.opacity)},darker(e){return new Ge(this.h,this.c,this.l-bt*(e??1),this.opacity)},rgb(){return nr(this).rgb()}}));const Wt=e=>()=>e;function tr(e,n){return function(t){return e+t*n}}function Rf(e,n,t){return e=Math.pow(e,t),n=Math.pow(n,t)-e,t=1/t,function(a){return Math.pow(e+a*n,t)}}function zf(e,n){var t=n-e;return t?tr(e,t>180||t<-180?t-360*Math.round(t/360):t):Wt(isNaN(e)?n:e)}function qf(e){return(e=+e)==1?Bn:function(n,t){return t-n?Rf(n,t,e):Wt(isNaN(n)?t:n)}}function Bn(e,n){var t=n-e;return t?tr(e,t):Wt(isNaN(e)?n:e)}const yt=function e(n){var t=qf(n);function a(o,i){var s=t((o=Ta(o)).r,(i=Ta(i)).r),r=t(o.g,i.g),l=t(o.b,i.b),c=Bn(o.opacity,i.opacity);return function(d){return o.r=s(d),o.g=r(d),o.b=l(d),o.opacity=c(d),o+""}}return a.gamma=e,a}(1);function Vf(e,n){n||(n=[]);var t=e?Math.min(n.length,e.length):0,a=n.slice(),o;return function(i){for(o=0;o<t;++o)a[o]=e[o]*(1-i)+n[o]*i;return a}}function Bf(e){return ArrayBuffer.isView(e)&&!(e instanceof DataView)}function Ff(e,n){var t=n?n.length:0,a=e?Math.min(t,e.length):0,o=new Array(a),i=new Array(t),s;for(s=0;s<a;++s)o[s]=oi(e[s],n[s]);for(;s<t;++s)i[s]=n[s];return function(r){for(s=0;s<a;++s)i[s]=o[s](r);return i}}function jf(e,n){var t=new Date;return e=+e,n=+n,function(a){return t.setTime(e*(1-a)+n*a),t}}function $e(e,n){return e=+e,n=+n,function(t){return e*(1-t)+n*t}}function Uf(e,n){var t={},a={},o;(e===null||typeof e!="object")&&(e={}),(n===null||typeof n!="object")&&(n={});for(o in n)o in e?t[o]=oi(e[o],n[o]):a[o]=n[o];return function(i){for(o in t)a[o]=t[o](i);return a}}var Ia=/[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,la=new RegExp(Ia.source,"g");function Gf(e){return function(){return e}}function Hf(e){return function(n){return e(n)+""}}function ar(e,n){var t=Ia.lastIndex=la.lastIndex=0,a,o,i,s=-1,r=[],l=[];for(e=e+"",n=n+"";(a=Ia.exec(e))&&(o=la.exec(n));)(i=o.index)>t&&(i=n.slice(t,i),r[s]?r[s]+=i:r[++s]=i),(a=a[0])===(o=o[0])?r[s]?r[s]+=o:r[++s]=o:(r[++s]=null,l.push({i:s,x:$e(a,o)})),t=la.lastIndex;return t<n.length&&(i=n.slice(t),r[s]?r[s]+=i:r[++s]=i),r.length<2?l[0]?Hf(l[0].x):Gf(n):(n=l.length,function(c){for(var d=0,g;d<n;++d)r[(g=l[d]).i]=g.x(c);return r.join("")})}function oi(e,n){var t=typeof n,a;return n==null||t==="boolean"?Wt(n):(t==="number"?$e:t==="string"?(a=dn(n))?(n=a,yt):ar:n instanceof dn?yt:n instanceof Date?jf:Bf(n)?Vf:Array.isArray(n)?Ff:typeof n.valueOf!="function"&&typeof n.toString!="function"||isNaN(n)?Uf:$e)(e,n)}function Wf(e,n){return e=+e,n=+n,function(t){return Math.round(e*(1-t)+n*t)}}var Vi=180/Math.PI,Pa={translateX:0,translateY:0,rotate:0,skewX:0,scaleX:1,scaleY:1};function or(e,n,t,a,o,i){var s,r,l;return(s=Math.sqrt(e*e+n*n))&&(e/=s,n/=s),(l=e*t+n*a)&&(t-=e*l,a-=n*l),(r=Math.sqrt(t*t+a*a))&&(t/=r,a/=r,l/=r),e*a<n*t&&(e=-e,n=-n,l=-l,s=-s),{translateX:o,translateY:i,rotate:Math.atan2(n,e)*Vi,skewX:Math.atan(l)*Vi,scaleX:s,scaleY:r}}var at;function Kf(e){const n=new(typeof DOMMatrix=="function"?DOMMatrix:WebKitCSSMatrix)(e+"");return n.isIdentity?Pa:or(n.a,n.b,n.c,n.d,n.e,n.f)}function Yf(e){return e==null||(at||(at=document.createElementNS("http://www.w3.org/2000/svg","g")),at.setAttribute("transform",e),!(e=at.transform.baseVal.consolidate()))?Pa:(e=e.matrix,or(e.a,e.b,e.c,e.d,e.e,e.f))}function ir(e,n,t,a){function o(c){return c.length?c.pop()+" ":""}function i(c,d,g,u,h,v){if(c!==g||d!==u){var b=h.push("translate(",null,n,null,t);v.push({i:b-4,x:$e(c,g)},{i:b-2,x:$e(d,u)})}else(g||u)&&h.push("translate("+g+n+u+t)}function s(c,d,g,u){c!==d?(c-d>180?d+=360:d-c>180&&(c+=360),u.push({i:g.push(o(g)+"rotate(",null,a)-2,x:$e(c,d)})):d&&g.push(o(g)+"rotate("+d+a)}function r(c,d,g,u){c!==d?u.push({i:g.push(o(g)+"skewX(",null,a)-2,x:$e(c,d)}):d&&g.push(o(g)+"skewX("+d+a)}function l(c,d,g,u,h,v){if(c!==g||d!==u){var b=h.push(o(h)+"scale(",null,",",null,")");v.push({i:b-4,x:$e(c,g)},{i:b-2,x:$e(d,u)})}else(g!==1||u!==1)&&h.push(o(h)+"scale("+g+","+u+")")}return function(c,d){var g=[],u=[];return c=e(c),d=e(d),i(c.translateX,c.translateY,d.translateX,d.translateY,g,u),s(c.rotate,d.rotate,g,u),r(c.skewX,d.skewX,g,u),l(c.scaleX,c.scaleY,d.scaleX,d.scaleY,g,u),c=d=null,function(h){for(var v=-1,b=u.length,_;++v<b;)g[(_=u[v]).i]=_.x(h);return g.join("")}}}var Xf=ir(Kf,"px, ","px)","deg)"),Qf=ir(Yf,", ",")",")");function Jf(e){return function(n,t){var a=e((n=Sa(n)).h,(t=Sa(t)).h),o=Bn(n.c,t.c),i=Bn(n.l,t.l),s=Bn(n.opacity,t.opacity);return function(r){return n.h=a(r),n.c=o(r),n.l=i(r),n.opacity=s(r),n+""}}}const Zw=Jf(zf);var Sn=0,zn=0,Dn=0,sr=1e3,_t,qn,wt=0,hn=0,Kt=0,Hn=typeof performance=="object"&&performance.now?performance:Date,rr=typeof window=="object"&&window.requestAnimationFrame?window.requestAnimationFrame.bind(window):function(e){setTimeout(e,17)};function ii(){return hn||(rr(Zf),hn=Hn.now()+Kt)}function Zf(){hn=0}function kt(){this._call=this._time=this._next=null}kt.prototype=si.prototype={constructor:kt,restart:function(e,n,t){if(typeof e!="function")throw new TypeError("callback is not a function");t=(t==null?ii():+t)+(n==null?0:+n),!this._next&&qn!==this&&(qn?qn._next=this:_t=this,qn=this),this._call=e,this._time=t,Ma()},stop:function(){this._call&&(this._call=null,this._time=1/0,Ma())}};function si(e,n,t){var a=new kt;return a.restart(e,n,t),a}function e0(){ii(),++Sn;for(var e=_t,n;e;)(n=hn-e._time)>=0&&e._call.call(void 0,n),e=e._next;--Sn}function Bi(){hn=(wt=Hn.now())+Kt,Sn=zn=0;try{e0()}finally{Sn=0,t0(),hn=0}}function n0(){var e=Hn.now(),n=e-wt;n>sr&&(Kt-=n,wt=e)}function t0(){for(var e,n=_t,t,a=1/0;n;)n._call?(a>n._time&&(a=n._time),e=n,n=n._next):(t=n._next,n._next=null,n=e?e._next=t:_t=t);qn=e,Ma(a)}function Ma(e){if(!Sn){zn&&(zn=clearTimeout(zn));var n=e-hn;n>24?(e<1/0&&(zn=setTimeout(Bi,e-Hn.now()-Kt)),Dn&&(Dn=clearInterval(Dn))):(Dn||(wt=Hn.now(),Dn=setInterval(n0,sr)),Sn=1,rr(Bi))}}function Fi(e,n,t){var a=new kt;return n=n==null?0:+n,a.restart(o=>{a.stop(),e(o+n)},n,t),a}var a0=Ut("start","end","cancel","interrupt"),o0=[],lr=0,ji=1,Da=2,ut=3,Ui=4,La=5,dt=6;function Yt(e,n,t,a,o,i){var s=e.__transition;if(!s)e.__transition={};else if(t in s)return;i0(e,t,{name:n,index:a,group:o,on:a0,tween:o0,time:i.time,delay:i.delay,duration:i.duration,ease:i.ease,timer:null,state:lr})}function ri(e,n){var t=Oe(e,n);if(t.state>lr)throw new Error("too late; already scheduled");return t}function Fe(e,n){var t=Oe(e,n);if(t.state>ut)throw new Error("too late; already running");return t}function Oe(e,n){var t=e.__transition;if(!t||!(t=t[n]))throw new Error("transition not found");return t}function i0(e,n,t){var a=e.__transition,o;a[n]=t,t.timer=si(i,0,t.time);function i(c){t.state=ji,t.timer.restart(s,t.delay,t.time),t.delay<=c&&s(c-t.delay)}function s(c){var d,g,u,h;if(t.state!==ji)return l();for(d in a)if(h=a[d],h.name===t.name){if(h.state===ut)return Fi(s);h.state===Ui?(h.state=dt,h.timer.stop(),h.on.call("interrupt",e,e.__data__,h.index,h.group),delete a[d]):+d<n&&(h.state=dt,h.timer.stop(),h.on.call("cancel",e,e.__data__,h.index,h.group),delete a[d])}if(Fi(function(){t.state===ut&&(t.state=Ui,t.timer.restart(r,t.delay,t.time),r(c))}),t.state=Da,t.on.call("start",e,e.__data__,t.index,t.group),t.state===Da){for(t.state=ut,o=new Array(u=t.tween.length),d=0,g=-1;d<u;++d)(h=t.tween[d].value.call(e,e.__data__,t.index,t.group))&&(o[++g]=h);o.length=g+1}}function r(c){for(var d=c<t.duration?t.ease.call(null,c/t.duration):(t.timer.restart(l),t.state=La,1),g=-1,u=o.length;++g<u;)o[g].call(e,d);t.state===La&&(t.on.call("end",e,e.__data__,t.index,t.group),l())}function l(){t.state=dt,t.timer.stop(),delete a[n];for(var c in a)return;delete e.__transition}}function s0(e,n){var t=e.__transition,a,o,i=!0,s;if(t){n=n==null?null:n+"";for(s in t){if((a=t[s]).name!==n){i=!1;continue}o=a.state>Da&&a.state<La,a.state=dt,a.timer.stop(),a.on.call(o?"interrupt":"cancel",e,e.__data__,a.index,a.group),delete t[s]}i&&delete e.__transition}}function r0(e){return this.each(function(){s0(this,e)})}function l0(e,n){var t,a;return function(){var o=Fe(this,e),i=o.tween;if(i!==t){a=t=i;for(var s=0,r=a.length;s<r;++s)if(a[s].name===n){a=a.slice(),a.splice(s,1);break}}o.tween=a}}function c0(e,n,t){var a,o;if(typeof t!="function")throw new Error;return function(){var i=Fe(this,e),s=i.tween;if(s!==a){o=(a=s).slice();for(var r={name:n,value:t},l=0,c=o.length;l<c;++l)if(o[l].name===n){o[l]=r;break}l===c&&o.push(r)}i.tween=o}}function u0(e,n){var t=this._id;if(e+="",arguments.length<2){for(var a=Oe(this.node(),t).tween,o=0,i=a.length,s;o<i;++o)if((s=a[o]).name===e)return s.value;return null}return this.each((n==null?l0:c0)(t,e,n))}function li(e,n,t){var a=e._id;return e.each(function(){var o=Fe(this,a);(o.value||(o.value={}))[n]=t.apply(this,arguments)}),function(o){return Oe(o,a).value[n]}}function cr(e,n){var t;return(typeof n=="number"?$e:n instanceof dn?yt:(t=dn(n))?(n=t,yt):ar)(e,n)}function d0(e){return function(){this.removeAttribute(e)}}function h0(e){return function(){this.removeAttributeNS(e.space,e.local)}}function p0(e,n,t){var a,o=t+"",i;return function(){var s=this.getAttribute(e);return s===o?null:s===a?i:i=n(a=s,t)}}function g0(e,n,t){var a,o=t+"",i;return function(){var s=this.getAttributeNS(e.space,e.local);return s===o?null:s===a?i:i=n(a=s,t)}}function m0(e,n,t){var a,o,i;return function(){var s,r=t(this),l;return r==null?void this.removeAttribute(e):(s=this.getAttribute(e),l=r+"",s===l?null:s===a&&l===o?i:(o=l,i=n(a=s,r)))}}function f0(e,n,t){var a,o,i;return function(){var s,r=t(this),l;return r==null?void this.removeAttributeNS(e.space,e.local):(s=this.getAttributeNS(e.space,e.local),l=r+"",s===l?null:s===a&&l===o?i:(o=l,i=n(a=s,r)))}}function v0(e,n){var t=Gt(e),a=t==="transform"?Qf:cr;return this.attrTween(e,typeof n=="function"?(t.local?f0:m0)(t,a,li(this,"attr."+e,n)):n==null?(t.local?h0:d0)(t):(t.local?g0:p0)(t,a,n))}function b0(e,n){return function(t){this.setAttribute(e,n.call(this,t))}}function y0(e,n){return function(t){this.setAttributeNS(e.space,e.local,n.call(this,t))}}function _0(e,n){var t,a;function o(){var i=n.apply(this,arguments);return i!==a&&(t=(a=i)&&y0(e,i)),t}return o._value=n,o}function w0(e,n){var t,a;function o(){var i=n.apply(this,arguments);return i!==a&&(t=(a=i)&&b0(e,i)),t}return o._value=n,o}function k0(e,n){var t="attr."+e;if(arguments.length<2)return(t=this.tween(t))&&t._value;if(n==null)return this.tween(t,null);if(typeof n!="function")throw new Error;var a=Gt(e);return this.tween(t,(a.local?_0:w0)(a,n))}function x0(e,n){return function(){ri(this,e).delay=+n.apply(this,arguments)}}function A0(e,n){return n=+n,function(){ri(this,e).delay=n}}function C0(e){var n=this._id;return arguments.length?this.each((typeof e=="function"?x0:A0)(n,e)):Oe(this.node(),n).delay}function T0(e,n){return function(){Fe(this,e).duration=+n.apply(this,arguments)}}function S0(e,n){return n=+n,function(){Fe(this,e).duration=n}}function I0(e){var n=this._id;return arguments.length?this.each((typeof e=="function"?T0:S0)(n,e)):Oe(this.node(),n).duration}function P0(e,n){if(typeof n!="function")throw new Error;return function(){Fe(this,e).ease=n}}function M0(e){var n=this._id;return arguments.length?this.each(P0(n,e)):Oe(this.node(),n).ease}function D0(e,n){return function(){var t=n.apply(this,arguments);if(typeof t!="function")throw new Error;Fe(this,e).ease=t}}function L0(e){if(typeof e!="function")throw new Error;return this.each(D0(this._id,e))}function $0(e){typeof e!="function"&&(e=Rs(e));for(var n=this._groups,t=n.length,a=new Array(t),o=0;o<t;++o)for(var i=n[o],s=i.length,r=a[o]=[],l,c=0;c<s;++c)(l=i[c])&&e.call(l,l.__data__,c,i)&&r.push(l);return new Ke(a,this._parents,this._name,this._id)}function N0(e){if(e._id!==this._id)throw new Error;for(var n=this._groups,t=e._groups,a=n.length,o=t.length,i=Math.min(a,o),s=new Array(a),r=0;r<i;++r)for(var l=n[r],c=t[r],d=l.length,g=s[r]=new Array(d),u,h=0;h<d;++h)(u=l[h]||c[h])&&(g[h]=u);for(;r<a;++r)s[r]=n[r];return new Ke(s,this._parents,this._name,this._id)}function E0(e){return(e+"").trim().split(/^|\s+/).every(function(n){var t=n.indexOf(".");return t>=0&&(n=n.slice(0,t)),!n||n==="start"})}function O0(e,n,t){var a,o,i=E0(n)?ri:Fe;return function(){var s=i(this,e),r=s.on;r!==a&&(o=(a=r).copy()).on(n,t),s.on=o}}function R0(e,n){var t=this._id;return arguments.length<2?Oe(this.node(),t).on.on(e):this.each(O0(t,e,n))}function z0(e){return function(){var n=this.parentNode;for(var t in this.__transition)if(+t!==e)return;n&&n.removeChild(this)}}function q0(){return this.on("end.remove",z0(this._id))}function V0(e){var n=this._name,t=this._id;typeof e!="function"&&(e=ti(e));for(var a=this._groups,o=a.length,i=new Array(o),s=0;s<o;++s)for(var r=a[s],l=r.length,c=i[s]=new Array(l),d,g,u=0;u<l;++u)(d=r[u])&&(g=e.call(d,d.__data__,u,r))&&("__data__"in d&&(g.__data__=d.__data__),c[u]=g,Yt(c[u],n,t,u,c,Oe(d,t)));return new Ke(i,this._parents,n,t)}function B0(e){var n=this._name,t=this._id;typeof e!="function"&&(e=Os(e));for(var a=this._groups,o=a.length,i=[],s=[],r=0;r<o;++r)for(var l=a[r],c=l.length,d,g=0;g<c;++g)if(d=l[g]){for(var u=e.call(d,d.__data__,g,l),h,v=Oe(d,t),b=0,_=u.length;b<_;++b)(h=u[b])&&Yt(h,n,t,b,u,v);i.push(u),s.push(d)}return new Ke(i,s,n,t)}var F0=Xn.prototype.constructor;function j0(){return new F0(this._groups,this._parents)}function U0(e,n){var t,a,o;return function(){var i=Tn(this,e),s=(this.style.removeProperty(e),Tn(this,e));return i===s?null:i===t&&s===a?o:o=n(t=i,a=s)}}function ur(e){return function(){this.style.removeProperty(e)}}function G0(e,n,t){var a,o=t+"",i;return function(){var s=Tn(this,e);return s===o?null:s===a?i:i=n(a=s,t)}}function H0(e,n,t){var a,o,i;return function(){var s=Tn(this,e),r=t(this),l=r+"";return r==null&&(l=r=(this.style.removeProperty(e),Tn(this,e))),s===l?null:s===a&&l===o?i:(o=l,i=n(a=s,r))}}function W0(e,n){var t,a,o,i="style."+n,s="end."+i,r;return function(){var l=Fe(this,e),c=l.on,d=l.value[i]==null?r||(r=ur(n)):void 0;(c!==t||o!==d)&&(a=(t=c).copy()).on(s,o=d),l.on=a}}function K0(e,n,t){var a=(e+="")=="transform"?Xf:cr;return n==null?this.styleTween(e,U0(e,a)).on("end.style."+e,ur(e)):typeof n=="function"?this.styleTween(e,H0(e,a,li(this,"style."+e,n))).each(W0(this._id,e)):this.styleTween(e,G0(e,a,n),t).on("end.style."+e,null)}function Y0(e,n,t){return function(a){this.style.setProperty(e,n.call(this,a),t)}}function X0(e,n,t){var a,o;function i(){var s=n.apply(this,arguments);return s!==o&&(a=(o=s)&&Y0(e,s,t)),a}return i._value=n,i}function Q0(e,n,t){var a="style."+(e+="");if(arguments.length<2)return(a=this.tween(a))&&a._value;if(n==null)return this.tween(a,null);if(typeof n!="function")throw new Error;return this.tween(a,X0(e,n,t??""))}function J0(e){return function(){this.textContent=e}}function Z0(e){return function(){var n=e(this);this.textContent=n??""}}function ev(e){return this.tween("text",typeof e=="function"?Z0(li(this,"text",e)):J0(e==null?"":e+""))}function nv(e){return function(n){this.textContent=e.call(this,n)}}function tv(e){var n,t;function a(){var o=e.apply(this,arguments);return o!==t&&(n=(t=o)&&nv(o)),n}return a._value=e,a}function av(e){var n="text";if(arguments.length<1)return(n=this.tween(n))&&n._value;if(e==null)return this.tween(n,null);if(typeof e!="function")throw new Error;return this.tween(n,tv(e))}function ov(){for(var e=this._name,n=this._id,t=dr(),a=this._groups,o=a.length,i=0;i<o;++i)for(var s=a[i],r=s.length,l,c=0;c<r;++c)if(l=s[c]){var d=Oe(l,n);Yt(l,e,t,c,s,{time:d.time+d.delay+d.duration,delay:0,duration:d.duration,ease:d.ease})}return new Ke(a,this._parents,e,t)}function iv(){var e,n,t=this,a=t._id,o=t.size();return new Promise(function(i,s){var r={value:s},l={value:function(){--o===0&&i()}};t.each(function(){var c=Fe(this,a),d=c.on;d!==e&&(n=(e=d).copy(),n._.cancel.push(r),n._.interrupt.push(r),n._.end.push(l)),c.on=n}),o===0&&i()})}var sv=0;function Ke(e,n,t,a){this._groups=e,this._parents=n,this._name=t,this._id=a}function dr(){return++sv}var je=Xn.prototype;Ke.prototype={constructor:Ke,select:V0,selectAll:B0,selectChild:je.selectChild,selectChildren:je.selectChildren,filter:$0,merge:N0,selection:j0,transition:ov,call:je.call,nodes:je.nodes,node:je.node,size:je.size,empty:je.empty,each:je.each,on:R0,attr:v0,attrTween:k0,style:K0,styleTween:Q0,text:ev,textTween:av,remove:q0,tween:u0,delay:C0,duration:I0,ease:M0,easeVarying:L0,end:iv,[Symbol.iterator]:je[Symbol.iterator]};function rv(e){return((e*=2)<=1?e*e*e:(e-=2)*e*e+2)/2}var lv={time:null,delay:0,duration:250,ease:rv};function cv(e,n){for(var t;!(t=e.__transition)||!(t=t[n]);)if(!(e=e.parentNode))throw new Error(`transition ${n} not found`);return t}function uv(e){var n,t;e instanceof Ke?(n=e._id,e=e._name):(n=dr(),(t=lv).time=ii(),e=e==null?null:e+"");for(var a=this._groups,o=a.length,i=0;i<o;++i)for(var s=a[i],r=s.length,l,c=0;c<r;++c)(l=s[c])&&Yt(l,e,n,c,s,t||cv(l,n));return new Ke(a,this._parents,e,n)}Xn.prototype.interrupt=r0;Xn.prototype.transition=uv;const $a=Math.PI,Na=2*$a,sn=1e-6,dv=Na-sn;function hr(e){this._+=e[0];for(let n=1,t=e.length;n<t;++n)this._+=arguments[n]+e[n]}function hv(e){let n=Math.floor(e);if(!(n>=0))throw new Error(`invalid digits: ${e}`);if(n>15)return hr;const t=10**n;return function(a){this._+=a[0];for(let o=1,i=a.length;o<i;++o)this._+=Math.round(arguments[o]*t)/t+a[o]}}class pv{constructor(n){this._x0=this._y0=this._x1=this._y1=null,this._="",this._append=n==null?hr:hv(n)}moveTo(n,t){this._append`M${this._x0=this._x1=+n},${this._y0=this._y1=+t}`}closePath(){this._x1!==null&&(this._x1=this._x0,this._y1=this._y0,this._append`Z`)}lineTo(n,t){this._append`L${this._x1=+n},${this._y1=+t}`}quadraticCurveTo(n,t,a,o){this._append`Q${+n},${+t},${this._x1=+a},${this._y1=+o}`}bezierCurveTo(n,t,a,o,i,s){this._append`C${+n},${+t},${+a},${+o},${this._x1=+i},${this._y1=+s}`}arcTo(n,t,a,o,i){if(n=+n,t=+t,a=+a,o=+o,i=+i,i<0)throw new Error(`negative radius: ${i}`);let s=this._x1,r=this._y1,l=a-n,c=o-t,d=s-n,g=r-t,u=d*d+g*g;if(this._x1===null)this._append`M${this._x1=n},${this._y1=t}`;else if(u>sn)if(!(Math.abs(g*l-c*d)>sn)||!i)this._append`L${this._x1=n},${this._y1=t}`;else{let h=a-s,v=o-r,b=l*l+c*c,_=h*h+v*v,x=Math.sqrt(b),A=Math.sqrt(u),D=i*Math.tan(($a-Math.acos((b+u-_)/(2*x*A)))/2),y=D/A,T=D/x;Math.abs(y-1)>sn&&this._append`L${n+y*d},${t+y*g}`,this._append`A${i},${i},0,0,${+(g*h>d*v)},${this._x1=n+T*l},${this._y1=t+T*c}`}}arc(n,t,a,o,i,s){if(n=+n,t=+t,a=+a,s=!!s,a<0)throw new Error(`negative radius: ${a}`);let r=a*Math.cos(o),l=a*Math.sin(o),c=n+r,d=t+l,g=1^s,u=s?o-i:i-o;this._x1===null?this._append`M${c},${d}`:(Math.abs(this._x1-c)>sn||Math.abs(this._y1-d)>sn)&&this._append`L${c},${d}`,a&&(u<0&&(u=u%Na+Na),u>dv?this._append`A${a},${a},0,1,${g},${n-r},${t-l}A${a},${a},0,1,${g},${this._x1=c},${this._y1=d}`:u>sn&&this._append`A${a},${a},0,${+(u>=$a)},${g},${this._x1=n+a*Math.cos(i)},${this._y1=t+a*Math.sin(i)}`)}rect(n,t,a,o){this._append`M${this._x0=this._x1=+n},${this._y0=this._y1=+t}h${a=+a}v${+o}h${-a}Z`}toString(){return this._}}function gv(e,n){var t,a=1;e==null&&(e=0),n==null&&(n=0);function o(){var i,s=t.length,r,l=0,c=0;for(i=0;i<s;++i)r=t[i],l+=r.x,c+=r.y;for(l=(l/s-e)*a,c=(c/s-n)*a,i=0;i<s;++i)r=t[i],r.x-=l,r.y-=c}return o.initialize=function(i){t=i},o.x=function(i){return arguments.length?(e=+i,o):e},o.y=function(i){return arguments.length?(n=+i,o):n},o.strength=function(i){return arguments.length?(a=+i,o):a},o}function mv(e){const n=+this._x.call(null,e),t=+this._y.call(null,e);return pr(this.cover(n,t),n,t,e)}function pr(e,n,t,a){if(isNaN(n)||isNaN(t))return e;var o,i=e._root,s={data:a},r=e._x0,l=e._y0,c=e._x1,d=e._y1,g,u,h,v,b,_,x,A;if(!i)return e._root=s,e;for(;i.length;)if((b=n>=(g=(r+c)/2))?r=g:c=g,(_=t>=(u=(l+d)/2))?l=u:d=u,o=i,!(i=i[x=_<<1|b]))return o[x]=s,e;if(h=+e._x.call(null,i.data),v=+e._y.call(null,i.data),n===h&&t===v)return s.next=i,o?o[x]=s:e._root=s,e;do o=o?o[x]=new Array(4):e._root=new Array(4),(b=n>=(g=(r+c)/2))?r=g:c=g,(_=t>=(u=(l+d)/2))?l=u:d=u;while((x=_<<1|b)===(A=(v>=u)<<1|h>=g));return o[A]=i,o[x]=s,e}function fv(e){var n,t,a=e.length,o,i,s=new Array(a),r=new Array(a),l=1/0,c=1/0,d=-1/0,g=-1/0;for(t=0;t<a;++t)isNaN(o=+this._x.call(null,n=e[t]))||isNaN(i=+this._y.call(null,n))||(s[t]=o,r[t]=i,o<l&&(l=o),o>d&&(d=o),i<c&&(c=i),i>g&&(g=i));if(l>d||c>g)return this;for(this.cover(l,c).cover(d,g),t=0;t<a;++t)pr(this,s[t],r[t],e[t]);return this}function vv(e,n){if(isNaN(e=+e)||isNaN(n=+n))return this;var t=this._x0,a=this._y0,o=this._x1,i=this._y1;if(isNaN(t))o=(t=Math.floor(e))+1,i=(a=Math.floor(n))+1;else{for(var s=o-t||1,r=this._root,l,c;t>e||e>=o||a>n||n>=i;)switch(c=(n<a)<<1|e<t,l=new Array(4),l[c]=r,r=l,s*=2,c){case 0:o=t+s,i=a+s;break;case 1:t=o-s,i=a+s;break;case 2:o=t+s,a=i-s;break;case 3:t=o-s,a=i-s;break}this._root&&this._root.length&&(this._root=r)}return this._x0=t,this._y0=a,this._x1=o,this._y1=i,this}function bv(){var e=[];return this.visit(function(n){if(!n.length)do e.push(n.data);while(n=n.next)}),e}function yv(e){return arguments.length?this.cover(+e[0][0],+e[0][1]).cover(+e[1][0],+e[1][1]):isNaN(this._x0)?void 0:[[this._x0,this._y0],[this._x1,this._y1]]}function we(e,n,t,a,o){this.node=e,this.x0=n,this.y0=t,this.x1=a,this.y1=o}function _v(e,n,t){var a,o=this._x0,i=this._y0,s,r,l,c,d=this._x1,g=this._y1,u=[],h=this._root,v,b;for(h&&u.push(new we(h,o,i,d,g)),t==null?t=1/0:(o=e-t,i=n-t,d=e+t,g=n+t,t*=t);v=u.pop();)if(!(!(h=v.node)||(s=v.x0)>d||(r=v.y0)>g||(l=v.x1)<o||(c=v.y1)<i))if(h.length){var _=(s+l)/2,x=(r+c)/2;u.push(new we(h[3],_,x,l,c),new we(h[2],s,x,_,c),new we(h[1],_,r,l,x),new we(h[0],s,r,_,x)),(b=(n>=x)<<1|e>=_)&&(v=u[u.length-1],u[u.length-1]=u[u.length-1-b],u[u.length-1-b]=v)}else{var A=e-+this._x.call(null,h.data),D=n-+this._y.call(null,h.data),y=A*A+D*D;if(y<t){var T=Math.sqrt(t=y);o=e-T,i=n-T,d=e+T,g=n+T,a=h.data}}return a}function wv(e){if(isNaN(d=+this._x.call(null,e))||isNaN(g=+this._y.call(null,e)))return this;var n,t=this._root,a,o,i,s=this._x0,r=this._y0,l=this._x1,c=this._y1,d,g,u,h,v,b,_,x;if(!t)return this;if(t.length)for(;;){if((v=d>=(u=(s+l)/2))?s=u:l=u,(b=g>=(h=(r+c)/2))?r=h:c=h,n=t,!(t=t[_=b<<1|v]))return this;if(!t.length)break;(n[_+1&3]||n[_+2&3]||n[_+3&3])&&(a=n,x=_)}for(;t.data!==e;)if(o=t,!(t=t.next))return this;return(i=t.next)&&delete t.next,o?(i?o.next=i:delete o.next,this):n?(i?n[_]=i:delete n[_],(t=n[0]||n[1]||n[2]||n[3])&&t===(n[3]||n[2]||n[1]||n[0])&&!t.length&&(a?a[x]=t:this._root=t),this):(this._root=i,this)}function kv(e){for(var n=0,t=e.length;n<t;++n)this.remove(e[n]);return this}function xv(){return this._root}function Av(){var e=0;return this.visit(function(n){if(!n.length)do++e;while(n=n.next)}),e}function Cv(e){var n=[],t,a=this._root,o,i,s,r,l;for(a&&n.push(new we(a,this._x0,this._y0,this._x1,this._y1));t=n.pop();)if(!e(a=t.node,i=t.x0,s=t.y0,r=t.x1,l=t.y1)&&a.length){var c=(i+r)/2,d=(s+l)/2;(o=a[3])&&n.push(new we(o,c,d,r,l)),(o=a[2])&&n.push(new we(o,i,d,c,l)),(o=a[1])&&n.push(new we(o,c,s,r,d)),(o=a[0])&&n.push(new we(o,i,s,c,d))}return this}function Tv(e){var n=[],t=[],a;for(this._root&&n.push(new we(this._root,this._x0,this._y0,this._x1,this._y1));a=n.pop();){var o=a.node;if(o.length){var i,s=a.x0,r=a.y0,l=a.x1,c=a.y1,d=(s+l)/2,g=(r+c)/2;(i=o[0])&&n.push(new we(i,s,r,d,g)),(i=o[1])&&n.push(new we(i,d,r,l,g)),(i=o[2])&&n.push(new we(i,s,g,d,c)),(i=o[3])&&n.push(new we(i,d,g,l,c))}t.push(a)}for(;a=t.pop();)e(a.node,a.x0,a.y0,a.x1,a.y1);return this}function Sv(e){return e[0]}function Iv(e){return arguments.length?(this._x=e,this):this._x}function Pv(e){return e[1]}function Mv(e){return arguments.length?(this._y=e,this):this._y}function ci(e,n,t){var a=new ui(n??Sv,t??Pv,NaN,NaN,NaN,NaN);return e==null?a:a.addAll(e)}function ui(e,n,t,a,o,i){this._x=e,this._y=n,this._x0=t,this._y0=a,this._x1=o,this._y1=i,this._root=void 0}function Gi(e){for(var n={data:e.data},t=n;e=e.next;)t=t.next={data:e.data};return n}var xe=ci.prototype=ui.prototype;xe.copy=function(){var e=new ui(this._x,this._y,this._x0,this._y0,this._x1,this._y1),n=this._root,t,a;if(!n)return e;if(!n.length)return e._root=Gi(n),e;for(t=[{source:n,target:e._root=new Array(4)}];n=t.pop();)for(var o=0;o<4;++o)(a=n.source[o])&&(a.length?t.push({source:a,target:n.target[o]=new Array(4)}):n.target[o]=Gi(a));return e};xe.add=mv;xe.addAll=fv;xe.cover=vv;xe.data=bv;xe.extent=yv;xe.find=_v;xe.remove=wv;xe.removeAll=kv;xe.root=xv;xe.size=Av;xe.visit=Cv;xe.visitAfter=Tv;xe.x=Iv;xe.y=Mv;function ke(e){return function(){return e}}function Ze(e){return(e()-.5)*1e-6}function Dv(e){return e.x+e.vx}function Lv(e){return e.y+e.vy}function $v(e){var n,t,a,o=1,i=1;typeof e!="function"&&(e=ke(e==null?1:+e));function s(){for(var c,d=n.length,g,u,h,v,b,_,x=0;x<i;++x)for(g=ci(n,Dv,Lv).visitAfter(r),c=0;c<d;++c)u=n[c],b=t[u.index],_=b*b,h=u.x+u.vx,v=u.y+u.vy,g.visit(A);function A(D,y,T,k,E){var B=D.data,W=D.r,F=b+W;if(B){if(B.index>u.index){var $=h-B.x-B.vx,M=v-B.y-B.vy,L=$*$+M*M;L<F*F&&($===0&&($=Ze(a),L+=$*$),M===0&&(M=Ze(a),L+=M*M),L=(F-(L=Math.sqrt(L)))/L*o,u.vx+=($*=L)*(F=(W*=W)/(_+W)),u.vy+=(M*=L)*F,B.vx-=$*(F=1-F),B.vy-=M*F)}return}return y>h+F||k<h-F||T>v+F||E<v-F}}function r(c){if(c.data)return c.r=t[c.data.index];for(var d=c.r=0;d<4;++d)c[d]&&c[d].r>c.r&&(c.r=c[d].r)}function l(){if(n){var c,d=n.length,g;for(t=new Array(d),c=0;c<d;++c)g=n[c],t[g.index]=+e(g,c,n)}}return s.initialize=function(c,d){n=c,a=d,l()},s.iterations=function(c){return arguments.length?(i=+c,s):i},s.strength=function(c){return arguments.length?(o=+c,s):o},s.radius=function(c){return arguments.length?(e=typeof c=="function"?c:ke(+c),l(),s):e},s}function Nv(e){return e.index}function Hi(e,n){var t=e.get(n);if(!t)throw new Error("node not found: "+n);return t}function Ev(e){var n=Nv,t=g,a,o=ke(30),i,s,r,l,c,d=1;e==null&&(e=[]);function g(_){return 1/Math.min(r[_.source.index],r[_.target.index])}function u(_){for(var x=0,A=e.length;x<d;++x)for(var D=0,y,T,k,E,B,W,F;D<A;++D)y=e[D],T=y.source,k=y.target,E=k.x+k.vx-T.x-T.vx||Ze(c),B=k.y+k.vy-T.y-T.vy||Ze(c),W=Math.sqrt(E*E+B*B),W=(W-i[D])/W*_*a[D],E*=W,B*=W,k.vx-=E*(F=l[D]),k.vy-=B*F,T.vx+=E*(F=1-F),T.vy+=B*F}function h(){if(s){var _,x=s.length,A=e.length,D=new Map(s.map((T,k)=>[n(T,k,s),T])),y;for(_=0,r=new Array(x);_<A;++_)y=e[_],y.index=_,typeof y.source!="object"&&(y.source=Hi(D,y.source)),typeof y.target!="object"&&(y.target=Hi(D,y.target)),r[y.source.index]=(r[y.source.index]||0)+1,r[y.target.index]=(r[y.target.index]||0)+1;for(_=0,l=new Array(A);_<A;++_)y=e[_],l[_]=r[y.source.index]/(r[y.source.index]+r[y.target.index]);a=new Array(A),v(),i=new Array(A),b()}}function v(){if(s)for(var _=0,x=e.length;_<x;++_)a[_]=+t(e[_],_,e)}function b(){if(s)for(var _=0,x=e.length;_<x;++_)i[_]=+o(e[_],_,e)}return u.initialize=function(_,x){s=_,c=x,h()},u.links=function(_){return arguments.length?(e=_,h(),u):e},u.id=function(_){return arguments.length?(n=_,u):n},u.iterations=function(_){return arguments.length?(d=+_,u):d},u.strength=function(_){return arguments.length?(t=typeof _=="function"?_:ke(+_),v(),u):t},u.distance=function(_){return arguments.length?(o=typeof _=="function"?_:ke(+_),b(),u):o},u}const Ov=1664525,Rv=1013904223,Wi=4294967296;function zv(){let e=1;return()=>(e=(Ov*e+Rv)%Wi)/Wi}function qv(e){return e.x}function Vv(e){return e.y}var Bv=10,Fv=Math.PI*(3-Math.sqrt(5));function jv(e){var n,t=1,a=.001,o=1-Math.pow(a,1/300),i=0,s=.6,r=new Map,l=si(g),c=Ut("tick","end"),d=zv();e==null&&(e=[]);function g(){u(),c.call("tick",n),t<a&&(l.stop(),c.call("end",n))}function u(b){var _,x=e.length,A;b===void 0&&(b=1);for(var D=0;D<b;++D)for(t+=(i-t)*o,r.forEach(function(y){y(t)}),_=0;_<x;++_)A=e[_],A.fx==null?A.x+=A.vx*=s:(A.x=A.fx,A.vx=0),A.fy==null?A.y+=A.vy*=s:(A.y=A.fy,A.vy=0);return n}function h(){for(var b=0,_=e.length,x;b<_;++b){if(x=e[b],x.index=b,x.fx!=null&&(x.x=x.fx),x.fy!=null&&(x.y=x.fy),isNaN(x.x)||isNaN(x.y)){var A=Bv*Math.sqrt(.5+b),D=b*Fv;x.x=A*Math.cos(D),x.y=A*Math.sin(D)}(isNaN(x.vx)||isNaN(x.vy))&&(x.vx=x.vy=0)}}function v(b){return b.initialize&&b.initialize(e,d),b}return h(),n={tick:u,restart:function(){return l.restart(g),n},stop:function(){return l.stop(),n},nodes:function(b){return arguments.length?(e=b,h(),r.forEach(v),n):e},alpha:function(b){return arguments.length?(t=+b,n):t},alphaMin:function(b){return arguments.length?(a=+b,n):a},alphaDecay:function(b){return arguments.length?(o=+b,n):+o},alphaTarget:function(b){return arguments.length?(i=+b,n):i},velocityDecay:function(b){return arguments.length?(s=1-b,n):1-s},randomSource:function(b){return arguments.length?(d=b,r.forEach(v),n):d},force:function(b,_){return arguments.length>1?(_==null?r.delete(b):r.set(b,v(_)),n):r.get(b)},find:function(b,_,x){var A=0,D=e.length,y,T,k,E,B;for(x==null?x=1/0:x*=x,A=0;A<D;++A)E=e[A],y=b-E.x,T=_-E.y,k=y*y+T*T,k<x&&(B=E,x=k);return B},on:function(b,_){return arguments.length>1?(c.on(b,_),n):c.on(b)}}}function Uv(){var e,n,t,a,o=ke(-30),i,s=1,r=1/0,l=.81;function c(h){var v,b=e.length,_=ci(e,qv,Vv).visitAfter(g);for(a=h,v=0;v<b;++v)n=e[v],_.visit(u)}function d(){if(e){var h,v=e.length,b;for(i=new Array(v),h=0;h<v;++h)b=e[h],i[b.index]=+o(b,h,e)}}function g(h){var v=0,b,_,x=0,A,D,y;if(h.length){for(A=D=y=0;y<4;++y)(b=h[y])&&(_=Math.abs(b.value))&&(v+=b.value,x+=_,A+=_*b.x,D+=_*b.y);h.x=A/x,h.y=D/x}else{b=h,b.x=b.data.x,b.y=b.data.y;do v+=i[b.data.index];while(b=b.next)}h.value=v}function u(h,v,b,_){if(!h.value)return!0;var x=h.x-n.x,A=h.y-n.y,D=_-v,y=x*x+A*A;if(D*D/l<y)return y<r&&(x===0&&(x=Ze(t),y+=x*x),A===0&&(A=Ze(t),y+=A*A),y<s&&(y=Math.sqrt(s*y)),n.vx+=x*h.value*a/y,n.vy+=A*h.value*a/y),!0;if(h.length||y>=r)return;(h.data!==n||h.next)&&(x===0&&(x=Ze(t),y+=x*x),A===0&&(A=Ze(t),y+=A*A),y<s&&(y=Math.sqrt(s*y)));do h.data!==n&&(D=i[h.data.index]*a/y,n.vx+=x*D,n.vy+=A*D);while(h=h.next)}return c.initialize=function(h,v){e=h,t=v,d()},c.strength=function(h){return arguments.length?(o=typeof h=="function"?h:ke(+h),d(),c):o},c.distanceMin=function(h){return arguments.length?(s=h*h,c):Math.sqrt(s)},c.distanceMax=function(h){return arguments.length?(r=h*h,c):Math.sqrt(r)},c.theta=function(h){return arguments.length?(l=h*h,c):Math.sqrt(l)},c}function Gv(e){var n=ke(.1),t,a,o;typeof e!="function"&&(e=ke(e==null?0:+e));function i(r){for(var l=0,c=t.length,d;l<c;++l)d=t[l],d.vx+=(o[l]-d.x)*a[l]*r}function s(){if(t){var r,l=t.length;for(a=new Array(l),o=new Array(l),r=0;r<l;++r)a[r]=isNaN(o[r]=+e(t[r],r,t))?0:+n(t[r],r,t)}}return i.initialize=function(r){t=r,s()},i.strength=function(r){return arguments.length?(n=typeof r=="function"?r:ke(+r),s(),i):n},i.x=function(r){return arguments.length?(e=typeof r=="function"?r:ke(+r),s(),i):e},i}function Hv(e){var n=ke(.1),t,a,o;typeof e!="function"&&(e=ke(e==null?0:+e));function i(r){for(var l=0,c=t.length,d;l<c;++l)d=t[l],d.vy+=(o[l]-d.y)*a[l]*r}function s(){if(t){var r,l=t.length;for(a=new Array(l),o=new Array(l),r=0;r<l;++r)a[r]=isNaN(o[r]=+e(t[r],r,t))?0:+n(t[r],r,t)}}return i.initialize=function(r){t=r,s()},i.strength=function(r){return arguments.length?(n=typeof r=="function"?r:ke(+r),s(),i):n},i.y=function(r){return arguments.length?(e=typeof r=="function"?r:ke(+r),s(),i):e},i}function Wv(e){return Math.abs(e=Math.round(e))>=1e21?e.toLocaleString("en").replace(/,/g,""):e.toString(10)}function xt(e,n){if(!isFinite(e)||e===0)return null;var t=(e=n?e.toExponential(n-1):e.toExponential()).indexOf("e"),a=e.slice(0,t);return[a.length>1?a[0]+a.slice(2):a,+e.slice(t+1)]}function In(e){return e=xt(Math.abs(e)),e?e[1]:NaN}function Kv(e,n){return function(t,a){for(var o=t.length,i=[],s=0,r=e[0],l=0;o>0&&r>0&&(l+r+1>a&&(r=Math.max(1,a-l)),i.push(t.substring(o-=r,o+r)),!((l+=r+1)>a));)r=e[s=(s+1)%e.length];return i.reverse().join(n)}}function Yv(e){return function(n){return n.replace(/[0-9]/g,function(t){return e[+t]})}}var Xv=/^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;function At(e){if(!(n=Xv.exec(e)))throw new Error("invalid format: "+e);var n;return new di({fill:n[1],align:n[2],sign:n[3],symbol:n[4],zero:n[5],width:n[6],comma:n[7],precision:n[8]&&n[8].slice(1),trim:n[9],type:n[10]})}At.prototype=di.prototype;function di(e){this.fill=e.fill===void 0?" ":e.fill+"",this.align=e.align===void 0?">":e.align+"",this.sign=e.sign===void 0?"-":e.sign+"",this.symbol=e.symbol===void 0?"":e.symbol+"",this.zero=!!e.zero,this.width=e.width===void 0?void 0:+e.width,this.comma=!!e.comma,this.precision=e.precision===void 0?void 0:+e.precision,this.trim=!!e.trim,this.type=e.type===void 0?"":e.type+""}di.prototype.toString=function(){return this.fill+this.align+this.sign+this.symbol+(this.zero?"0":"")+(this.width===void 0?"":Math.max(1,this.width|0))+(this.comma?",":"")+(this.precision===void 0?"":"."+Math.max(0,this.precision|0))+(this.trim?"~":"")+this.type};function Qv(e){e:for(var n=e.length,t=1,a=-1,o;t<n;++t)switch(e[t]){case".":a=o=t;break;case"0":a===0&&(a=t),o=t;break;default:if(!+e[t])break e;a>0&&(a=0);break}return a>0?e.slice(0,a)+e.slice(o+1):e}var Ct;function Jv(e,n){var t=xt(e,n);if(!t)return Ct=void 0,e.toPrecision(n);var a=t[0],o=t[1],i=o-(Ct=Math.max(-8,Math.min(8,Math.floor(o/3)))*3)+1,s=a.length;return i===s?a:i>s?a+new Array(i-s+1).join("0"):i>0?a.slice(0,i)+"."+a.slice(i):"0."+new Array(1-i).join("0")+xt(e,Math.max(0,n+i-1))[0]}function Ki(e,n){var t=xt(e,n);if(!t)return e+"";var a=t[0],o=t[1];return o<0?"0."+new Array(-o).join("0")+a:a.length>o+1?a.slice(0,o+1)+"."+a.slice(o+1):a+new Array(o-a.length+2).join("0")}const Yi={"%":(e,n)=>(e*100).toFixed(n),b:e=>Math.round(e).toString(2),c:e=>e+"",d:Wv,e:(e,n)=>e.toExponential(n),f:(e,n)=>e.toFixed(n),g:(e,n)=>e.toPrecision(n),o:e=>Math.round(e).toString(8),p:(e,n)=>Ki(e*100,n),r:Ki,s:Jv,X:e=>Math.round(e).toString(16).toUpperCase(),x:e=>Math.round(e).toString(16)};function Xi(e){return e}var Qi=Array.prototype.map,Ji=["y","z","a","f","p","n","µ","m","","k","M","G","T","P","E","Z","Y"];function Zv(e){var n=e.grouping===void 0||e.thousands===void 0?Xi:Kv(Qi.call(e.grouping,Number),e.thousands+""),t=e.currency===void 0?"":e.currency[0]+"",a=e.currency===void 0?"":e.currency[1]+"",o=e.decimal===void 0?".":e.decimal+"",i=e.numerals===void 0?Xi:Yv(Qi.call(e.numerals,String)),s=e.percent===void 0?"%":e.percent+"",r=e.minus===void 0?"−":e.minus+"",l=e.nan===void 0?"NaN":e.nan+"";function c(g,u){g=At(g);var h=g.fill,v=g.align,b=g.sign,_=g.symbol,x=g.zero,A=g.width,D=g.comma,y=g.precision,T=g.trim,k=g.type;k==="n"?(D=!0,k="g"):Yi[k]||(y===void 0&&(y=12),T=!0,k="g"),(x||h==="0"&&v==="=")&&(x=!0,h="0",v="=");var E=(u&&u.prefix!==void 0?u.prefix:"")+(_==="$"?t:_==="#"&&/[boxX]/.test(k)?"0"+k.toLowerCase():""),B=(_==="$"?a:/[%p]/.test(k)?s:"")+(u&&u.suffix!==void 0?u.suffix:""),W=Yi[k],F=/[defgprs%]/.test(k);y=y===void 0?6:/[gprs]/.test(k)?Math.max(1,Math.min(21,y)):Math.max(0,Math.min(20,y));function $(M){var L=E,z=B,te,ee,K;if(k==="c")z=W(M)+z,M="";else{M=+M;var re=M<0||1/M<0;if(M=isNaN(M)?l:W(Math.abs(M),y),T&&(M=Qv(M)),re&&+M==0&&b!=="+"&&(re=!1),L=(re?b==="("?b:r:b==="-"||b==="("?"":b)+L,z=(k==="s"&&!isNaN(M)&&Ct!==void 0?Ji[8+Ct/3]:"")+z+(re&&b==="("?")":""),F){for(te=-1,ee=M.length;++te<ee;)if(K=M.charCodeAt(te),48>K||K>57){z=(K===46?o+M.slice(te+1):M.slice(te))+z,M=M.slice(0,te);break}}}D&&!x&&(M=n(M,1/0));var de=L.length+M.length+z.length,ue=de<A?new Array(A-de+1).join(h):"";switch(D&&x&&(M=n(ue+M,ue.length?A-z.length:1/0),ue=""),v){case"<":M=L+M+z+ue;break;case"=":M=L+ue+M+z;break;case"^":M=ue.slice(0,de=ue.length>>1)+L+M+z+ue.slice(de);break;default:M=ue+L+M+z;break}return i(M)}return $.toString=function(){return g+""},$}function d(g,u){var h=Math.max(-8,Math.min(8,Math.floor(In(u)/3)))*3,v=Math.pow(10,-h),b=c((g=At(g),g.type="f",g),{suffix:Ji[8+h/3]});return function(_){return b(v*_)}}return{format:c,formatPrefix:d}}var ot,gr,mr;eb({thousands:",",grouping:[3],currency:["$",""]});function eb(e){return ot=Zv(e),gr=ot.format,mr=ot.formatPrefix,ot}function nb(e){return Math.max(0,-In(Math.abs(e)))}function tb(e,n){return Math.max(0,Math.max(-8,Math.min(8,Math.floor(In(n)/3)))*3-In(Math.abs(e)))}function ab(e,n){return e=Math.abs(e),n=Math.abs(n)-e,Math.max(0,In(n)-In(e))+1}function ob(e){var n=0,t=e.children,a=t&&t.length;if(!a)n=1;else for(;--a>=0;)n+=t[a].value;e.value=n}function ib(){return this.eachAfter(ob)}function sb(e,n){let t=-1;for(const a of this)e.call(n,a,++t,this);return this}function rb(e,n){for(var t=this,a=[t],o,i,s=-1;t=a.pop();)if(e.call(n,t,++s,this),o=t.children)for(i=o.length-1;i>=0;--i)a.push(o[i]);return this}function lb(e,n){for(var t=this,a=[t],o=[],i,s,r,l=-1;t=a.pop();)if(o.push(t),i=t.children)for(s=0,r=i.length;s<r;++s)a.push(i[s]);for(;t=o.pop();)e.call(n,t,++l,this);return this}function cb(e,n){let t=-1;for(const a of this)if(e.call(n,a,++t,this))return a}function ub(e){return this.eachAfter(function(n){for(var t=+e(n.data)||0,a=n.children,o=a&&a.length;--o>=0;)t+=a[o].value;n.value=t})}function db(e){return this.eachBefore(function(n){n.children&&n.children.sort(e)})}function hb(e){for(var n=this,t=pb(n,e),a=[n];n!==t;)n=n.parent,a.push(n);for(var o=a.length;e!==t;)a.splice(o,0,e),e=e.parent;return a}function pb(e,n){if(e===n)return e;var t=e.ancestors(),a=n.ancestors(),o=null;for(e=t.pop(),n=a.pop();e===n;)o=e,e=t.pop(),n=a.pop();return o}function gb(){for(var e=this,n=[e];e=e.parent;)n.push(e);return n}function mb(){return Array.from(this)}function fb(){var e=[];return this.eachBefore(function(n){n.children||e.push(n)}),e}function vb(){var e=this,n=[];return e.each(function(t){t!==e&&n.push({source:t.parent,target:t})}),n}function*bb(){var e=this,n,t=[e],a,o,i;do for(n=t.reverse(),t=[];e=n.pop();)if(yield e,a=e.children)for(o=0,i=a.length;o<i;++o)t.push(a[o]);while(t.length)}function fr(e,n){e instanceof Map?(e=[void 0,e],n===void 0&&(n=wb)):n===void 0&&(n=_b);for(var t=new Tt(e),a,o=[t],i,s,r,l;a=o.pop();)if((s=n(a.data))&&(l=(s=Array.from(s)).length))for(a.children=s,r=l-1;r>=0;--r)o.push(i=s[r]=new Tt(s[r])),i.parent=a,i.depth=a.depth+1;return t.eachBefore(xb)}function yb(){return fr(this).eachBefore(kb)}function _b(e){return e.children}function wb(e){return Array.isArray(e)?e[1]:null}function kb(e){e.data.value!==void 0&&(e.value=e.data.value),e.data=e.data.data}function xb(e){var n=0;do e.height=n;while((e=e.parent)&&e.height<++n)}function Tt(e){this.data=e,this.depth=this.height=0,this.parent=null}Tt.prototype=fr.prototype={constructor:Tt,count:ib,each:sb,eachAfter:lb,eachBefore:rb,find:cb,sum:ub,sort:db,path:hb,ancestors:gb,descendants:mb,leaves:fb,links:vb,copy:yb,[Symbol.iterator]:bb};function Ab(e){if(typeof e!="function")throw new Error;return e}function Ln(){return 0}function $n(e){return function(){return e}}function Cb(e){e.x0=Math.round(e.x0),e.y0=Math.round(e.y0),e.x1=Math.round(e.x1),e.y1=Math.round(e.y1)}function Tb(e,n,t,a,o){for(var i=e.children,s,r=-1,l=i.length,c=e.value&&(a-n)/e.value;++r<l;)s=i[r],s.y0=t,s.y1=o,s.x0=n,s.x1=n+=s.value*c}function Sb(e,n,t,a,o){for(var i=e.children,s,r=-1,l=i.length,c=e.value&&(o-t)/e.value;++r<l;)s=i[r],s.x0=n,s.x1=a,s.y0=t,s.y1=t+=s.value*c}var Ib=(1+Math.sqrt(5))/2;function Pb(e,n,t,a,o,i){for(var s=[],r=n.children,l,c,d=0,g=0,u=r.length,h,v,b=n.value,_,x,A,D,y,T,k;d<u;){h=o-t,v=i-a;do _=r[g++].value;while(!_&&g<u);for(x=A=_,T=Math.max(v/h,h/v)/(b*e),k=_*_*T,y=Math.max(A/k,k/x);g<u;++g){if(_+=c=r[g].value,c<x&&(x=c),c>A&&(A=c),k=_*_*T,D=Math.max(A/k,k/x),D>y){_-=c;break}y=D}s.push(l={value:_,dice:h<v,children:r.slice(d,g)}),l.dice?Tb(l,t,a,o,b?a+=v*_/b:i):Sb(l,t,a,b?t+=h*_/b:o,i),b-=_,d=g}return s}const Mb=function e(n){function t(a,o,i,s,r){Pb(n,a,o,i,s,r)}return t.ratio=function(a){return e((a=+a)>1?a:1)},t}(Ib);function ek(){var e=Mb,n=!1,t=1,a=1,o=[0],i=Ln,s=Ln,r=Ln,l=Ln,c=Ln;function d(u){return u.x0=u.y0=0,u.x1=t,u.y1=a,u.eachBefore(g),o=[0],n&&u.eachBefore(Cb),u}function g(u){var h=o[u.depth],v=u.x0+h,b=u.y0+h,_=u.x1-h,x=u.y1-h;_<v&&(v=_=(v+_)/2),x<b&&(b=x=(b+x)/2),u.x0=v,u.y0=b,u.x1=_,u.y1=x,u.children&&(h=o[u.depth+1]=i(u)/2,v+=c(u)-h,b+=s(u)-h,_-=r(u)-h,x-=l(u)-h,_<v&&(v=_=(v+_)/2),x<b&&(b=x=(b+x)/2),e(u,v,b,_,x))}return d.round=function(u){return arguments.length?(n=!!u,d):n},d.size=function(u){return arguments.length?(t=+u[0],a=+u[1],d):[t,a]},d.tile=function(u){return arguments.length?(e=Ab(u),d):e},d.padding=function(u){return arguments.length?d.paddingInner(u).paddingOuter(u):d.paddingInner()},d.paddingInner=function(u){return arguments.length?(i=typeof u=="function"?u:$n(+u),d):i},d.paddingOuter=function(u){return arguments.length?d.paddingTop(u).paddingRight(u).paddingBottom(u).paddingLeft(u):d.paddingTop()},d.paddingTop=function(u){return arguments.length?(s=typeof u=="function"?u:$n(+u),d):s},d.paddingRight=function(u){return arguments.length?(r=typeof u=="function"?u:$n(+u),d):r},d.paddingBottom=function(u){return arguments.length?(l=typeof u=="function"?u:$n(+u),d):l},d.paddingLeft=function(u){return arguments.length?(c=typeof u=="function"?u:$n(+u),d):c},d}function Xt(e,n){switch(arguments.length){case 0:break;case 1:this.range(e);break;default:this.range(n).domain(e);break}return this}const Zi=Symbol("implicit");function vr(){var e=new Ti,n=[],t=[],a=Zi;function o(i){let s=e.get(i);if(s===void 0){if(a!==Zi)return a;e.set(i,s=n.push(i)-1)}return t[s%t.length]}return o.domain=function(i){if(!arguments.length)return n.slice();n=[],e=new Ti;for(const s of i)e.has(s)||e.set(s,n.push(s)-1);return o},o.range=function(i){return arguments.length?(t=Array.from(i),o):t.slice()},o.unknown=function(i){return arguments.length?(a=i,o):a},o.copy=function(){return vr(n,t).unknown(a)},Xt.apply(o,arguments),o}function Db(){var e=vr().unknown(void 0),n=e.domain,t=e.range,a=0,o=1,i,s,r=!1,l=0,c=0,d=.5;delete e.unknown;function g(){var u=n().length,h=o<a,v=h?o:a,b=h?a:o;i=(b-v)/Math.max(1,u-l+c*2),r&&(i=Math.floor(i)),v+=(b-v-i*(u-l))*d,s=i*(1-l),r&&(v=Math.round(v),s=Math.round(s));var _=xg(u).map(function(x){return v+i*x});return t(h?_.reverse():_)}return e.domain=function(u){return arguments.length?(n(u),g()):n()},e.range=function(u){return arguments.length?([a,o]=u,a=+a,o=+o,g()):[a,o]},e.rangeRound=function(u){return[a,o]=u,a=+a,o=+o,r=!0,g()},e.bandwidth=function(){return s},e.step=function(){return i},e.round=function(u){return arguments.length?(r=!!u,g()):r},e.padding=function(u){return arguments.length?(l=Math.min(1,c=+u),g()):l},e.paddingInner=function(u){return arguments.length?(l=Math.min(1,u),g()):l},e.paddingOuter=function(u){return arguments.length?(c=+u,g()):c},e.align=function(u){return arguments.length?(d=Math.max(0,Math.min(1,u)),g()):d},e.copy=function(){return Db(n(),[a,o]).round(r).paddingInner(l).paddingOuter(c).align(d)},Xt.apply(g(),arguments)}function Lb(e){return function(){return e}}function $b(e){return+e}var es=[0,1];function _n(e){return e}function Ea(e,n){return(n-=e=+e)?function(t){return(t-e)/n}:Lb(isNaN(n)?NaN:.5)}function Nb(e,n){var t;return e>n&&(t=e,e=n,n=t),function(a){return Math.max(e,Math.min(n,a))}}function Eb(e,n,t){var a=e[0],o=e[1],i=n[0],s=n[1];return o<a?(a=Ea(o,a),i=t(s,i)):(a=Ea(a,o),i=t(i,s)),function(r){return i(a(r))}}function Ob(e,n,t){var a=Math.min(e.length,n.length)-1,o=new Array(a),i=new Array(a),s=-1;for(e[a]<e[0]&&(e=e.slice().reverse(),n=n.slice().reverse());++s<a;)o[s]=Ea(e[s],e[s+1]),i[s]=t(n[s],n[s+1]);return function(r){var l=mg(e,r,1,a)-1;return i[l](o[l](r))}}function br(e,n){return n.domain(e.domain()).range(e.range()).interpolate(e.interpolate()).clamp(e.clamp()).unknown(e.unknown())}function Rb(){var e=es,n=es,t=oi,a,o,i,s=_n,r,l,c;function d(){var u=Math.min(e.length,n.length);return s!==_n&&(s=Nb(e[0],e[u-1])),r=u>2?Ob:Eb,l=c=null,g}function g(u){return u==null||isNaN(u=+u)?i:(l||(l=r(e.map(a),n,t)))(a(s(u)))}return g.invert=function(u){return s(o((c||(c=r(n,e.map(a),$e)))(u)))},g.domain=function(u){return arguments.length?(e=Array.from(u,$b),d()):e.slice()},g.range=function(u){return arguments.length?(n=Array.from(u),d()):n.slice()},g.rangeRound=function(u){return n=Array.from(u),t=Wf,d()},g.clamp=function(u){return arguments.length?(s=u?!0:_n,d()):s!==_n},g.interpolate=function(u){return arguments.length?(t=u,d()):t},g.unknown=function(u){return arguments.length?(i=u,g):i},function(u,h){return a=u,o=h,d()}}function yr(){return Rb()(_n,_n)}function zb(e,n,t,a){var o=ka(e,n,t),i;switch(a=At(a??",f"),a.type){case"s":{var s=Math.max(Math.abs(e),Math.abs(n));return a.precision==null&&!isNaN(i=tb(o,s))&&(a.precision=i),mr(a,s)}case"":case"e":case"g":case"p":case"r":{a.precision==null&&!isNaN(i=ab(o,Math.max(Math.abs(e),Math.abs(n))))&&(a.precision=i-(a.type==="e"));break}case"f":case"%":{a.precision==null&&!isNaN(i=nb(o))&&(a.precision=i-(a.type==="%")*2);break}}return gr(a)}function qb(e){var n=e.domain;return e.ticks=function(t){var a=n();return kg(a[0],a[a.length-1],t??10)},e.tickFormat=function(t,a){var o=n();return zb(o[0],o[o.length-1],t??10,a)},e.nice=function(t){t==null&&(t=10);var a=n(),o=0,i=a.length-1,s=a[o],r=a[i],l,c,d=10;for(r<s&&(c=s,s=r,r=c,c=o,o=i,i=c);d-- >0;){if(c=wa(s,r,t),c===l)return a[o]=s,a[i]=r,n(a);if(c>0)s=Math.floor(s/c)*c,r=Math.ceil(r/c)*c;else if(c<0)s=Math.ceil(s*c)/c,r=Math.floor(r*c)/c;else break;l=c}return e},e}function Vb(){var e=yr();return e.copy=function(){return br(e,Vb())},Xt.apply(e,arguments),qb(e)}function Bb(e,n){e=e.slice();var t=0,a=e.length-1,o=e[t],i=e[a],s;return i<o&&(s=t,t=a,a=s,s=o,o=i,i=s),e[t]=n.floor(o),e[a]=n.ceil(i),e}const ca=new Date,ua=new Date;function ge(e,n,t,a){function o(i){return e(i=arguments.length===0?new Date:new Date(+i)),i}return o.floor=i=>(e(i=new Date(+i)),i),o.ceil=i=>(e(i=new Date(i-1)),n(i,1),e(i),i),o.round=i=>{const s=o(i),r=o.ceil(i);return i-s<r-i?s:r},o.offset=(i,s)=>(n(i=new Date(+i),s==null?1:Math.floor(s)),i),o.range=(i,s,r)=>{const l=[];if(i=o.ceil(i),r=r==null?1:Math.floor(r),!(i<s)||!(r>0))return l;let c;do l.push(c=new Date(+i)),n(i,r),e(i);while(c<i&&i<s);return l},o.filter=i=>ge(s=>{if(s>=s)for(;e(s),!i(s);)s.setTime(s-1)},(s,r)=>{if(s>=s)if(r<0)for(;++r<=0;)for(;n(s,-1),!i(s););else for(;--r>=0;)for(;n(s,1),!i(s););}),t&&(o.count=(i,s)=>(ca.setTime(+i),ua.setTime(+s),e(ca),e(ua),Math.floor(t(ca,ua))),o.every=i=>(i=Math.floor(i),!isFinite(i)||!(i>0)?null:i>1?o.filter(a?s=>a(s)%i===0:s=>o.count(0,s)%i===0):o)),o}const St=ge(()=>{},(e,n)=>{e.setTime(+e+n)},(e,n)=>n-e);St.every=e=>(e=Math.floor(e),!isFinite(e)||!(e>0)?null:e>1?ge(n=>{n.setTime(Math.floor(n/e)*e)},(n,t)=>{n.setTime(+n+t*e)},(n,t)=>(t-n)/e):St);St.range;const He=1e3,Me=He*60,We=Me*60,Ye=We*24,hi=Ye*7,ns=Ye*30,da=Ye*365,wn=ge(e=>{e.setTime(e-e.getMilliseconds())},(e,n)=>{e.setTime(+e+n*He)},(e,n)=>(n-e)/He,e=>e.getUTCSeconds());wn.range;const pi=ge(e=>{e.setTime(e-e.getMilliseconds()-e.getSeconds()*He)},(e,n)=>{e.setTime(+e+n*Me)},(e,n)=>(n-e)/Me,e=>e.getMinutes());pi.range;const Fb=ge(e=>{e.setUTCSeconds(0,0)},(e,n)=>{e.setTime(+e+n*Me)},(e,n)=>(n-e)/Me,e=>e.getUTCMinutes());Fb.range;const gi=ge(e=>{e.setTime(e-e.getMilliseconds()-e.getSeconds()*He-e.getMinutes()*Me)},(e,n)=>{e.setTime(+e+n*We)},(e,n)=>(n-e)/We,e=>e.getHours());gi.range;const jb=ge(e=>{e.setUTCMinutes(0,0,0)},(e,n)=>{e.setTime(+e+n*We)},(e,n)=>(n-e)/We,e=>e.getUTCHours());jb.range;const Jn=ge(e=>e.setHours(0,0,0,0),(e,n)=>e.setDate(e.getDate()+n),(e,n)=>(n-e-(n.getTimezoneOffset()-e.getTimezoneOffset())*Me)/Ye,e=>e.getDate()-1);Jn.range;const mi=ge(e=>{e.setUTCHours(0,0,0,0)},(e,n)=>{e.setUTCDate(e.getUTCDate()+n)},(e,n)=>(n-e)/Ye,e=>e.getUTCDate()-1);mi.range;const Ub=ge(e=>{e.setUTCHours(0,0,0,0)},(e,n)=>{e.setUTCDate(e.getUTCDate()+n)},(e,n)=>(n-e)/Ye,e=>Math.floor(e/Ye));Ub.range;function vn(e){return ge(n=>{n.setDate(n.getDate()-(n.getDay()+7-e)%7),n.setHours(0,0,0,0)},(n,t)=>{n.setDate(n.getDate()+t*7)},(n,t)=>(t-n-(t.getTimezoneOffset()-n.getTimezoneOffset())*Me)/hi)}const Qt=vn(0),It=vn(1),Gb=vn(2),Hb=vn(3),Pn=vn(4),Wb=vn(5),Kb=vn(6);Qt.range;It.range;Gb.range;Hb.range;Pn.range;Wb.range;Kb.range;function bn(e){return ge(n=>{n.setUTCDate(n.getUTCDate()-(n.getUTCDay()+7-e)%7),n.setUTCHours(0,0,0,0)},(n,t)=>{n.setUTCDate(n.getUTCDate()+t*7)},(n,t)=>(t-n)/hi)}const _r=bn(0),Pt=bn(1),Yb=bn(2),Xb=bn(3),Mn=bn(4),Qb=bn(5),Jb=bn(6);_r.range;Pt.range;Yb.range;Xb.range;Mn.range;Qb.range;Jb.range;const fi=ge(e=>{e.setDate(1),e.setHours(0,0,0,0)},(e,n)=>{e.setMonth(e.getMonth()+n)},(e,n)=>n.getMonth()-e.getMonth()+(n.getFullYear()-e.getFullYear())*12,e=>e.getMonth());fi.range;const Zb=ge(e=>{e.setUTCDate(1),e.setUTCHours(0,0,0,0)},(e,n)=>{e.setUTCMonth(e.getUTCMonth()+n)},(e,n)=>n.getUTCMonth()-e.getUTCMonth()+(n.getUTCFullYear()-e.getUTCFullYear())*12,e=>e.getUTCMonth());Zb.range;const Xe=ge(e=>{e.setMonth(0,1),e.setHours(0,0,0,0)},(e,n)=>{e.setFullYear(e.getFullYear()+n)},(e,n)=>n.getFullYear()-e.getFullYear(),e=>e.getFullYear());Xe.every=e=>!isFinite(e=Math.floor(e))||!(e>0)?null:ge(n=>{n.setFullYear(Math.floor(n.getFullYear()/e)*e),n.setMonth(0,1),n.setHours(0,0,0,0)},(n,t)=>{n.setFullYear(n.getFullYear()+t*e)});Xe.range;const pn=ge(e=>{e.setUTCMonth(0,1),e.setUTCHours(0,0,0,0)},(e,n)=>{e.setUTCFullYear(e.getUTCFullYear()+n)},(e,n)=>n.getUTCFullYear()-e.getUTCFullYear(),e=>e.getUTCFullYear());pn.every=e=>!isFinite(e=Math.floor(e))||!(e>0)?null:ge(n=>{n.setUTCFullYear(Math.floor(n.getUTCFullYear()/e)*e),n.setUTCMonth(0,1),n.setUTCHours(0,0,0,0)},(n,t)=>{n.setUTCFullYear(n.getUTCFullYear()+t*e)});pn.range;function ey(e,n,t,a,o,i){const s=[[wn,1,He],[wn,5,5*He],[wn,15,15*He],[wn,30,30*He],[i,1,Me],[i,5,5*Me],[i,15,15*Me],[i,30,30*Me],[o,1,We],[o,3,3*We],[o,6,6*We],[o,12,12*We],[a,1,Ye],[a,2,2*Ye],[t,1,hi],[n,1,ns],[n,3,3*ns],[e,1,da]];function r(c,d,g){const u=d<c;u&&([c,d]=[d,c]);const h=g&&typeof g.range=="function"?g:l(c,d,g),v=h?h.range(c,+d+1):[];return u?v.reverse():v}function l(c,d,g){const u=Math.abs(d-c)/g,h=ni(([,,_])=>_).right(s,u);if(h===s.length)return e.every(ka(c/da,d/da,g));if(h===0)return St.every(Math.max(ka(c,d,g),1));const[v,b]=s[u/s[h-1][2]<s[h][2]/u?h-1:h];return v.every(b)}return[r,l]}const[ny,ty]=ey(Xe,fi,Qt,Jn,gi,pi);function ha(e){if(0<=e.y&&e.y<100){var n=new Date(-1,e.m,e.d,e.H,e.M,e.S,e.L);return n.setFullYear(e.y),n}return new Date(e.y,e.m,e.d,e.H,e.M,e.S,e.L)}function pa(e){if(0<=e.y&&e.y<100){var n=new Date(Date.UTC(-1,e.m,e.d,e.H,e.M,e.S,e.L));return n.setUTCFullYear(e.y),n}return new Date(Date.UTC(e.y,e.m,e.d,e.H,e.M,e.S,e.L))}function Nn(e,n,t){return{y:e,m:n,d:t,H:0,M:0,S:0,L:0}}function ay(e){var n=e.dateTime,t=e.date,a=e.time,o=e.periods,i=e.days,s=e.shortDays,r=e.months,l=e.shortMonths,c=En(o),d=On(o),g=En(i),u=On(i),h=En(s),v=On(s),b=En(r),_=On(r),x=En(l),A=On(l),D={a:K,A:re,b:de,B:ue,c:null,d:rs,e:rs,f:Ty,g:Oy,G:zy,H:xy,I:Ay,j:Cy,L:wr,m:Sy,M:Iy,p:Ce,q:_e,Q:us,s:ds,S:Py,u:My,U:Dy,V:Ly,w:$y,W:Ny,x:null,X:null,y:Ey,Y:Ry,Z:qy,"%":cs},y={a:le,A:Le,b:Te,B:I,c:null,d:ls,e:ls,f:jy,g:Zy,G:n2,H:Vy,I:By,j:Fy,L:xr,m:Uy,M:Gy,p:V,q:H,Q:us,s:ds,S:Hy,u:Wy,U:Ky,V:Yy,w:Xy,W:Qy,x:null,X:null,y:Jy,Y:e2,Z:t2,"%":cs},T={a:F,A:$,b:M,B:L,c:z,d:is,e:is,f:yy,g:os,G:as,H:ss,I:ss,j:my,L:by,m:gy,M:fy,p:W,q:py,Q:wy,s:ky,S:vy,u:ly,U:cy,V:uy,w:ry,W:dy,x:te,X:ee,y:os,Y:as,Z:hy,"%":_y};D.x=k(t,D),D.X=k(a,D),D.c=k(n,D),y.x=k(t,y),y.X=k(a,y),y.c=k(n,y);function k(O,Y){return function(J){var P=[],oe=-1,ce=0,Se=O.length,Ie,an,xi;for(J instanceof Date||(J=new Date(+J));++oe<Se;)O.charCodeAt(oe)===37&&(P.push(O.slice(ce,oe)),(an=ts[Ie=O.charAt(++oe)])!=null?Ie=O.charAt(++oe):an=Ie==="e"?" ":"0",(xi=Y[Ie])&&(Ie=xi(J,an)),P.push(Ie),ce=oe+1);return P.push(O.slice(ce,oe)),P.join("")}}function E(O,Y){return function(J){var P=Nn(1900,void 0,1),oe=B(P,O,J+="",0),ce,Se;if(oe!=J.length)return null;if("Q"in P)return new Date(P.Q);if("s"in P)return new Date(P.s*1e3+("L"in P?P.L:0));if(Y&&!("Z"in P)&&(P.Z=0),"p"in P&&(P.H=P.H%12+P.p*12),P.m===void 0&&(P.m="q"in P?P.q:0),"V"in P){if(P.V<1||P.V>53)return null;"w"in P||(P.w=1),"Z"in P?(ce=pa(Nn(P.y,0,1)),Se=ce.getUTCDay(),ce=Se>4||Se===0?Pt.ceil(ce):Pt(ce),ce=mi.offset(ce,(P.V-1)*7),P.y=ce.getUTCFullYear(),P.m=ce.getUTCMonth(),P.d=ce.getUTCDate()+(P.w+6)%7):(ce=ha(Nn(P.y,0,1)),Se=ce.getDay(),ce=Se>4||Se===0?It.ceil(ce):It(ce),ce=Jn.offset(ce,(P.V-1)*7),P.y=ce.getFullYear(),P.m=ce.getMonth(),P.d=ce.getDate()+(P.w+6)%7)}else("W"in P||"U"in P)&&("w"in P||(P.w="u"in P?P.u%7:"W"in P?1:0),Se="Z"in P?pa(Nn(P.y,0,1)).getUTCDay():ha(Nn(P.y,0,1)).getDay(),P.m=0,P.d="W"in P?(P.w+6)%7+P.W*7-(Se+5)%7:P.w+P.U*7-(Se+6)%7);return"Z"in P?(P.H+=P.Z/100|0,P.M+=P.Z%100,pa(P)):ha(P)}}function B(O,Y,J,P){for(var oe=0,ce=Y.length,Se=J.length,Ie,an;oe<ce;){if(P>=Se)return-1;if(Ie=Y.charCodeAt(oe++),Ie===37){if(Ie=Y.charAt(oe++),an=T[Ie in ts?Y.charAt(oe++):Ie],!an||(P=an(O,J,P))<0)return-1}else if(Ie!=J.charCodeAt(P++))return-1}return P}function W(O,Y,J){var P=c.exec(Y.slice(J));return P?(O.p=d.get(P[0].toLowerCase()),J+P[0].length):-1}function F(O,Y,J){var P=h.exec(Y.slice(J));return P?(O.w=v.get(P[0].toLowerCase()),J+P[0].length):-1}function $(O,Y,J){var P=g.exec(Y.slice(J));return P?(O.w=u.get(P[0].toLowerCase()),J+P[0].length):-1}function M(O,Y,J){var P=x.exec(Y.slice(J));return P?(O.m=A.get(P[0].toLowerCase()),J+P[0].length):-1}function L(O,Y,J){var P=b.exec(Y.slice(J));return P?(O.m=_.get(P[0].toLowerCase()),J+P[0].length):-1}function z(O,Y,J){return B(O,n,Y,J)}function te(O,Y,J){return B(O,t,Y,J)}function ee(O,Y,J){return B(O,a,Y,J)}function K(O){return s[O.getDay()]}function re(O){return i[O.getDay()]}function de(O){return l[O.getMonth()]}function ue(O){return r[O.getMonth()]}function Ce(O){return o[+(O.getHours()>=12)]}function _e(O){return 1+~~(O.getMonth()/3)}function le(O){return s[O.getUTCDay()]}function Le(O){return i[O.getUTCDay()]}function Te(O){return l[O.getUTCMonth()]}function I(O){return r[O.getUTCMonth()]}function V(O){return o[+(O.getUTCHours()>=12)]}function H(O){return 1+~~(O.getUTCMonth()/3)}return{format:function(O){var Y=k(O+="",D);return Y.toString=function(){return O},Y},parse:function(O){var Y=E(O+="",!1);return Y.toString=function(){return O},Y},utcFormat:function(O){var Y=k(O+="",y);return Y.toString=function(){return O},Y},utcParse:function(O){var Y=E(O+="",!0);return Y.toString=function(){return O},Y}}}var ts={"-":"",_:" ",0:"0"},fe=/^\s*\d+/,oy=/^%/,iy=/[\\^$*+?|[\]().{}]/g;function se(e,n,t){var a=e<0?"-":"",o=(a?-e:e)+"",i=o.length;return a+(i<t?new Array(t-i+1).join(n)+o:o)}function sy(e){return e.replace(iy,"\\$&")}function En(e){return new RegExp("^(?:"+e.map(sy).join("|")+")","i")}function On(e){return new Map(e.map((n,t)=>[n.toLowerCase(),t]))}function ry(e,n,t){var a=fe.exec(n.slice(t,t+1));return a?(e.w=+a[0],t+a[0].length):-1}function ly(e,n,t){var a=fe.exec(n.slice(t,t+1));return a?(e.u=+a[0],t+a[0].length):-1}function cy(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.U=+a[0],t+a[0].length):-1}function uy(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.V=+a[0],t+a[0].length):-1}function dy(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.W=+a[0],t+a[0].length):-1}function as(e,n,t){var a=fe.exec(n.slice(t,t+4));return a?(e.y=+a[0],t+a[0].length):-1}function os(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.y=+a[0]+(+a[0]>68?1900:2e3),t+a[0].length):-1}function hy(e,n,t){var a=/^(Z)|([+-]\d\d)(?::?(\d\d))?/.exec(n.slice(t,t+6));return a?(e.Z=a[1]?0:-(a[2]+(a[3]||"00")),t+a[0].length):-1}function py(e,n,t){var a=fe.exec(n.slice(t,t+1));return a?(e.q=a[0]*3-3,t+a[0].length):-1}function gy(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.m=a[0]-1,t+a[0].length):-1}function is(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.d=+a[0],t+a[0].length):-1}function my(e,n,t){var a=fe.exec(n.slice(t,t+3));return a?(e.m=0,e.d=+a[0],t+a[0].length):-1}function ss(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.H=+a[0],t+a[0].length):-1}function fy(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.M=+a[0],t+a[0].length):-1}function vy(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.S=+a[0],t+a[0].length):-1}function by(e,n,t){var a=fe.exec(n.slice(t,t+3));return a?(e.L=+a[0],t+a[0].length):-1}function yy(e,n,t){var a=fe.exec(n.slice(t,t+6));return a?(e.L=Math.floor(a[0]/1e3),t+a[0].length):-1}function _y(e,n,t){var a=oy.exec(n.slice(t,t+1));return a?t+a[0].length:-1}function wy(e,n,t){var a=fe.exec(n.slice(t));return a?(e.Q=+a[0],t+a[0].length):-1}function ky(e,n,t){var a=fe.exec(n.slice(t));return a?(e.s=+a[0],t+a[0].length):-1}function rs(e,n){return se(e.getDate(),n,2)}function xy(e,n){return se(e.getHours(),n,2)}function Ay(e,n){return se(e.getHours()%12||12,n,2)}function Cy(e,n){return se(1+Jn.count(Xe(e),e),n,3)}function wr(e,n){return se(e.getMilliseconds(),n,3)}function Ty(e,n){return wr(e,n)+"000"}function Sy(e,n){return se(e.getMonth()+1,n,2)}function Iy(e,n){return se(e.getMinutes(),n,2)}function Py(e,n){return se(e.getSeconds(),n,2)}function My(e){var n=e.getDay();return n===0?7:n}function Dy(e,n){return se(Qt.count(Xe(e)-1,e),n,2)}function kr(e){var n=e.getDay();return n>=4||n===0?Pn(e):Pn.ceil(e)}function Ly(e,n){return e=kr(e),se(Pn.count(Xe(e),e)+(Xe(e).getDay()===4),n,2)}function $y(e){return e.getDay()}function Ny(e,n){return se(It.count(Xe(e)-1,e),n,2)}function Ey(e,n){return se(e.getFullYear()%100,n,2)}function Oy(e,n){return e=kr(e),se(e.getFullYear()%100,n,2)}function Ry(e,n){return se(e.getFullYear()%1e4,n,4)}function zy(e,n){var t=e.getDay();return e=t>=4||t===0?Pn(e):Pn.ceil(e),se(e.getFullYear()%1e4,n,4)}function qy(e){var n=e.getTimezoneOffset();return(n>0?"-":(n*=-1,"+"))+se(n/60|0,"0",2)+se(n%60,"0",2)}function ls(e,n){return se(e.getUTCDate(),n,2)}function Vy(e,n){return se(e.getUTCHours(),n,2)}function By(e,n){return se(e.getUTCHours()%12||12,n,2)}function Fy(e,n){return se(1+mi.count(pn(e),e),n,3)}function xr(e,n){return se(e.getUTCMilliseconds(),n,3)}function jy(e,n){return xr(e,n)+"000"}function Uy(e,n){return se(e.getUTCMonth()+1,n,2)}function Gy(e,n){return se(e.getUTCMinutes(),n,2)}function Hy(e,n){return se(e.getUTCSeconds(),n,2)}function Wy(e){var n=e.getUTCDay();return n===0?7:n}function Ky(e,n){return se(_r.count(pn(e)-1,e),n,2)}function Ar(e){var n=e.getUTCDay();return n>=4||n===0?Mn(e):Mn.ceil(e)}function Yy(e,n){return e=Ar(e),se(Mn.count(pn(e),e)+(pn(e).getUTCDay()===4),n,2)}function Xy(e){return e.getUTCDay()}function Qy(e,n){return se(Pt.count(pn(e)-1,e),n,2)}function Jy(e,n){return se(e.getUTCFullYear()%100,n,2)}function Zy(e,n){return e=Ar(e),se(e.getUTCFullYear()%100,n,2)}function e2(e,n){return se(e.getUTCFullYear()%1e4,n,4)}function n2(e,n){var t=e.getUTCDay();return e=t>=4||t===0?Mn(e):Mn.ceil(e),se(e.getUTCFullYear()%1e4,n,4)}function t2(){return"+0000"}function cs(){return"%"}function us(e){return+e}function ds(e){return Math.floor(+e/1e3)}var yn,Cr;a2({dateTime:"%x, %X",date:"%-m/%-d/%Y",time:"%-I:%M:%S %p",periods:["AM","PM"],days:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],shortDays:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],months:["January","February","March","April","May","June","July","August","September","October","November","December"],shortMonths:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"]});function a2(e){return yn=ay(e),Cr=yn.format,yn.parse,yn.utcFormat,yn.utcParse,yn}function o2(e){return new Date(e)}function i2(e){return e instanceof Date?+e:+new Date(+e)}function Tr(e,n,t,a,o,i,s,r,l,c){var d=yr(),g=d.invert,u=d.domain,h=c(".%L"),v=c(":%S"),b=c("%I:%M"),_=c("%I %p"),x=c("%a %d"),A=c("%b %d"),D=c("%B"),y=c("%Y");function T(k){return(l(k)<k?h:r(k)<k?v:s(k)<k?b:i(k)<k?_:a(k)<k?o(k)<k?x:A:t(k)<k?D:y)(k)}return d.invert=function(k){return new Date(g(k))},d.domain=function(k){return arguments.length?u(Array.from(k,i2)):u().map(o2)},d.ticks=function(k){var E=u();return e(E[0],E[E.length-1],k??10)},d.tickFormat=function(k,E){return E==null?T:c(E)},d.nice=function(k){var E=u();return(!k||typeof k.range!="function")&&(k=n(E[0],E[E.length-1],k??10)),k?u(Bb(E,k)):d},d.copy=function(){return br(d,Tr(e,n,t,a,o,i,s,r,l,c))},d}function nk(){return Xt.apply(Tr(ny,ty,Xe,fi,Qt,Jn,gi,pi,wn,Cr).domain([new Date(2e3,0,1),new Date(2e3,0,2)]),arguments)}function s2(e){for(var n=e.length/6|0,t=new Array(n),a=0;a<n;)t[a]="#"+e.slice(a*6,++a*6);return t}const tk=s2("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab");function he(e){return function(){return e}}const hs=Math.abs,ve=Math.atan2,on=Math.cos,r2=Math.max,ga=Math.min,Re=Math.sin,kn=Math.sqrt,be=1e-12,Wn=Math.PI,Mt=Wn/2,ht=2*Wn;function l2(e){return e>1?0:e<-1?Wn:Math.acos(e)}function ps(e){return e>=1?Mt:e<=-1?-Mt:Math.asin(e)}function Sr(e){let n=3;return e.digits=function(t){if(!arguments.length)return n;if(t==null)n=null;else{const a=Math.floor(t);if(!(a>=0))throw new RangeError(`invalid digits: ${t}`);n=a}return e},()=>new pv(n)}function c2(e){return e.innerRadius}function u2(e){return e.outerRadius}function d2(e){return e.startAngle}function h2(e){return e.endAngle}function p2(e){return e&&e.padAngle}function g2(e,n,t,a,o,i,s,r){var l=t-e,c=a-n,d=s-o,g=r-i,u=g*l-d*c;if(!(u*u<be))return u=(d*(n-i)-g*(e-o))/u,[e+u*l,n+u*c]}function it(e,n,t,a,o,i,s){var r=e-t,l=n-a,c=(s?i:-i)/kn(r*r+l*l),d=c*l,g=-c*r,u=e+d,h=n+g,v=t+d,b=a+g,_=(u+v)/2,x=(h+b)/2,A=v-u,D=b-h,y=A*A+D*D,T=o-i,k=u*b-v*h,E=(D<0?-1:1)*kn(r2(0,T*T*y-k*k)),B=(k*D-A*E)/y,W=(-k*A-D*E)/y,F=(k*D+A*E)/y,$=(-k*A+D*E)/y,M=B-_,L=W-x,z=F-_,te=$-x;return M*M+L*L>z*z+te*te&&(B=F,W=$),{cx:B,cy:W,x01:-d,y01:-g,x11:B*(o/T-1),y11:W*(o/T-1)}}function ak(){var e=c2,n=u2,t=he(0),a=null,o=d2,i=h2,s=p2,r=null,l=Sr(c);function c(){var d,g,u=+e.apply(this,arguments),h=+n.apply(this,arguments),v=o.apply(this,arguments)-Mt,b=i.apply(this,arguments)-Mt,_=hs(b-v),x=b>v;if(r||(r=d=l()),h<u&&(g=h,h=u,u=g),!(h>be))r.moveTo(0,0);else if(_>ht-be)r.moveTo(h*on(v),h*Re(v)),r.arc(0,0,h,v,b,!x),u>be&&(r.moveTo(u*on(b),u*Re(b)),r.arc(0,0,u,b,v,x));else{var A=v,D=b,y=v,T=b,k=_,E=_,B=s.apply(this,arguments)/2,W=B>be&&(a?+a.apply(this,arguments):kn(u*u+h*h)),F=ga(hs(h-u)/2,+t.apply(this,arguments)),$=F,M=F,L,z;if(W>be){var te=ps(W/u*Re(B)),ee=ps(W/h*Re(B));(k-=te*2)>be?(te*=x?1:-1,y+=te,T-=te):(k=0,y=T=(v+b)/2),(E-=ee*2)>be?(ee*=x?1:-1,A+=ee,D-=ee):(E=0,A=D=(v+b)/2)}var K=h*on(A),re=h*Re(A),de=u*on(T),ue=u*Re(T);if(F>be){var Ce=h*on(D),_e=h*Re(D),le=u*on(y),Le=u*Re(y),Te;if(_<Wn)if(Te=g2(K,re,le,Le,Ce,_e,de,ue)){var I=K-Te[0],V=re-Te[1],H=Ce-Te[0],O=_e-Te[1],Y=1/Re(l2((I*H+V*O)/(kn(I*I+V*V)*kn(H*H+O*O)))/2),J=kn(Te[0]*Te[0]+Te[1]*Te[1]);$=ga(F,(u-J)/(Y-1)),M=ga(F,(h-J)/(Y+1))}else $=M=0}E>be?M>be?(L=it(le,Le,K,re,h,M,x),z=it(Ce,_e,de,ue,h,M,x),r.moveTo(L.cx+L.x01,L.cy+L.y01),M<F?r.arc(L.cx,L.cy,M,ve(L.y01,L.x01),ve(z.y01,z.x01),!x):(r.arc(L.cx,L.cy,M,ve(L.y01,L.x01),ve(L.y11,L.x11),!x),r.arc(0,0,h,ve(L.cy+L.y11,L.cx+L.x11),ve(z.cy+z.y11,z.cx+z.x11),!x),r.arc(z.cx,z.cy,M,ve(z.y11,z.x11),ve(z.y01,z.x01),!x))):(r.moveTo(K,re),r.arc(0,0,h,A,D,!x)):r.moveTo(K,re),!(u>be)||!(k>be)?r.lineTo(de,ue):$>be?(L=it(de,ue,Ce,_e,u,-$,x),z=it(K,re,le,Le,u,-$,x),r.lineTo(L.cx+L.x01,L.cy+L.y01),$<F?r.arc(L.cx,L.cy,$,ve(L.y01,L.x01),ve(z.y01,z.x01),!x):(r.arc(L.cx,L.cy,$,ve(L.y01,L.x01),ve(L.y11,L.x11),!x),r.arc(0,0,u,ve(L.cy+L.y11,L.cx+L.x11),ve(z.cy+z.y11,z.cx+z.x11),x),r.arc(z.cx,z.cy,$,ve(z.y11,z.x11),ve(z.y01,z.x01),!x))):r.arc(0,0,u,T,y,x)}if(r.closePath(),d)return r=null,d+""||null}return c.centroid=function(){var d=(+e.apply(this,arguments)+ +n.apply(this,arguments))/2,g=(+o.apply(this,arguments)+ +i.apply(this,arguments))/2-Wn/2;return[on(g)*d,Re(g)*d]},c.innerRadius=function(d){return arguments.length?(e=typeof d=="function"?d:he(+d),c):e},c.outerRadius=function(d){return arguments.length?(n=typeof d=="function"?d:he(+d),c):n},c.cornerRadius=function(d){return arguments.length?(t=typeof d=="function"?d:he(+d),c):t},c.padRadius=function(d){return arguments.length?(a=d==null?null:typeof d=="function"?d:he(+d),c):a},c.startAngle=function(d){return arguments.length?(o=typeof d=="function"?d:he(+d),c):o},c.endAngle=function(d){return arguments.length?(i=typeof d=="function"?d:he(+d),c):i},c.padAngle=function(d){return arguments.length?(s=typeof d=="function"?d:he(+d),c):s},c.context=function(d){return arguments.length?(r=d??null,c):r},c}function Ir(e){return typeof e=="object"&&"length"in e?e:Array.from(e)}function Pr(e){this._context=e}Pr.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1,this._line?this._context.lineTo(e,n):this._context.moveTo(e,n);break;case 1:this._point=2;default:this._context.lineTo(e,n);break}}};function m2(e){return new Pr(e)}function f2(e){return e[0]}function v2(e){return e[1]}function ok(e,n){var t=he(!0),a=null,o=m2,i=null,s=Sr(r);e=typeof e=="function"?e:e===void 0?f2:he(e),n=typeof n=="function"?n:n===void 0?v2:he(n);function r(l){var c,d=(l=Ir(l)).length,g,u=!1,h;for(a==null&&(i=o(h=s())),c=0;c<=d;++c)!(c<d&&t(g=l[c],c,l))===u&&((u=!u)?i.lineStart():i.lineEnd()),u&&i.point(+e(g,c,l),+n(g,c,l));if(h)return i=null,h+""||null}return r.x=function(l){return arguments.length?(e=typeof l=="function"?l:he(+l),r):e},r.y=function(l){return arguments.length?(n=typeof l=="function"?l:he(+l),r):n},r.defined=function(l){return arguments.length?(t=typeof l=="function"?l:he(!!l),r):t},r.curve=function(l){return arguments.length?(o=l,a!=null&&(i=o(a)),r):o},r.context=function(l){return arguments.length?(l==null?a=i=null:i=o(a=l),r):a},r}function b2(e,n){return n<e?-1:n>e?1:n>=e?0:NaN}function y2(e){return e}function ik(){var e=y2,n=b2,t=null,a=he(0),o=he(ht),i=he(0);function s(r){var l,c=(r=Ir(r)).length,d,g,u=0,h=new Array(c),v=new Array(c),b=+a.apply(this,arguments),_=Math.min(ht,Math.max(-ht,o.apply(this,arguments)-b)),x,A=Math.min(Math.abs(_)/c,i.apply(this,arguments)),D=A*(_<0?-1:1),y;for(l=0;l<c;++l)(y=v[h[l]=l]=+e(r[l],l,r))>0&&(u+=y);for(n!=null?h.sort(function(T,k){return n(v[T],v[k])}):t!=null&&h.sort(function(T,k){return t(r[T],r[k])}),l=0,g=u?(_-c*D)/u:0;l<c;++l,b=x)d=h[l],y=v[d],x=b+(y>0?y*g:0)+D,v[d]={data:r[d],index:l,value:y,startAngle:b,endAngle:x,padAngle:A};return v}return s.value=function(r){return arguments.length?(e=typeof r=="function"?r:he(+r),s):e},s.sortValues=function(r){return arguments.length?(n=r,t=null,s):n},s.sort=function(r){return arguments.length?(t=r,n=null,s):t},s.startAngle=function(r){return arguments.length?(a=typeof r=="function"?r:he(+r),s):a},s.endAngle=function(r){return arguments.length?(o=typeof r=="function"?r:he(+r),s):o},s.padAngle=function(r){return arguments.length?(i=typeof r=="function"?r:he(+r),s):i},s}class Mr{constructor(n,t){this._context=n,this._x=t}areaStart(){this._line=0}areaEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line}point(n,t){switch(n=+n,t=+t,this._point){case 0:{this._point=1,this._line?this._context.lineTo(n,t):this._context.moveTo(n,t);break}case 1:this._point=2;default:{this._x?this._context.bezierCurveTo(this._x0=(this._x0+n)/2,this._y0,this._x0,t,n,t):this._context.bezierCurveTo(this._x0,this._y0=(this._y0+t)/2,n,this._y0,n,t);break}}this._x0=n,this._y0=t}}function sk(e){return new Mr(e,!0)}function rk(e){return new Mr(e,!1)}function nn(){}function Dt(e,n,t){e._context.bezierCurveTo((2*e._x0+e._x1)/3,(2*e._y0+e._y1)/3,(e._x0+2*e._x1)/3,(e._y0+2*e._y1)/3,(e._x0+4*e._x1+n)/6,(e._y0+4*e._y1+t)/6)}function Jt(e){this._context=e}Jt.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._y0=this._y1=NaN,this._point=0},lineEnd:function(){switch(this._point){case 3:Dt(this,this._x1,this._y1);case 2:this._context.lineTo(this._x1,this._y1);break}(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1,this._line?this._context.lineTo(e,n):this._context.moveTo(e,n);break;case 1:this._point=2;break;case 2:this._point=3,this._context.lineTo((5*this._x0+this._x1)/6,(5*this._y0+this._y1)/6);default:Dt(this,e,n);break}this._x0=this._x1,this._x1=e,this._y0=this._y1,this._y1=n}};function lk(e){return new Jt(e)}function Dr(e){this._context=e}Dr.prototype={areaStart:nn,areaEnd:nn,lineStart:function(){this._x0=this._x1=this._x2=this._x3=this._x4=this._y0=this._y1=this._y2=this._y3=this._y4=NaN,this._point=0},lineEnd:function(){switch(this._point){case 1:{this._context.moveTo(this._x2,this._y2),this._context.closePath();break}case 2:{this._context.moveTo((this._x2+2*this._x3)/3,(this._y2+2*this._y3)/3),this._context.lineTo((this._x3+2*this._x2)/3,(this._y3+2*this._y2)/3),this._context.closePath();break}case 3:{this.point(this._x2,this._y2),this.point(this._x3,this._y3),this.point(this._x4,this._y4);break}}},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1,this._x2=e,this._y2=n;break;case 1:this._point=2,this._x3=e,this._y3=n;break;case 2:this._point=3,this._x4=e,this._y4=n,this._context.moveTo((this._x0+4*this._x1+e)/6,(this._y0+4*this._y1+n)/6);break;default:Dt(this,e,n);break}this._x0=this._x1,this._x1=e,this._y0=this._y1,this._y1=n}};function ck(e){return new Dr(e)}function Lr(e){this._context=e}Lr.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._y0=this._y1=NaN,this._point=0},lineEnd:function(){(this._line||this._line!==0&&this._point===3)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1;break;case 1:this._point=2;break;case 2:this._point=3;var t=(this._x0+4*this._x1+e)/6,a=(this._y0+4*this._y1+n)/6;this._line?this._context.lineTo(t,a):this._context.moveTo(t,a);break;case 3:this._point=4;default:Dt(this,e,n);break}this._x0=this._x1,this._x1=e,this._y0=this._y1,this._y1=n}};function uk(e){return new Lr(e)}function $r(e,n){this._basis=new Jt(e),this._beta=n}$r.prototype={lineStart:function(){this._x=[],this._y=[],this._basis.lineStart()},lineEnd:function(){var e=this._x,n=this._y,t=e.length-1;if(t>0)for(var a=e[0],o=n[0],i=e[t]-a,s=n[t]-o,r=-1,l;++r<=t;)l=r/t,this._basis.point(this._beta*e[r]+(1-this._beta)*(a+l*i),this._beta*n[r]+(1-this._beta)*(o+l*s));this._x=this._y=null,this._basis.lineEnd()},point:function(e,n){this._x.push(+e),this._y.push(+n)}};const dk=function e(n){function t(a){return n===1?new Jt(a):new $r(a,n)}return t.beta=function(a){return e(+a)},t}(.85);function Lt(e,n,t){e._context.bezierCurveTo(e._x1+e._k*(e._x2-e._x0),e._y1+e._k*(e._y2-e._y0),e._x2+e._k*(e._x1-n),e._y2+e._k*(e._y1-t),e._x2,e._y2)}function vi(e,n){this._context=e,this._k=(1-n)/6}vi.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN,this._point=0},lineEnd:function(){switch(this._point){case 2:this._context.lineTo(this._x2,this._y2);break;case 3:Lt(this,this._x1,this._y1);break}(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1,this._line?this._context.lineTo(e,n):this._context.moveTo(e,n);break;case 1:this._point=2,this._x1=e,this._y1=n;break;case 2:this._point=3;default:Lt(this,e,n);break}this._x0=this._x1,this._x1=this._x2,this._x2=e,this._y0=this._y1,this._y1=this._y2,this._y2=n}};const hk=function e(n){function t(a){return new vi(a,n)}return t.tension=function(a){return e(+a)},t}(0);function bi(e,n){this._context=e,this._k=(1-n)/6}bi.prototype={areaStart:nn,areaEnd:nn,lineStart:function(){this._x0=this._x1=this._x2=this._x3=this._x4=this._x5=this._y0=this._y1=this._y2=this._y3=this._y4=this._y5=NaN,this._point=0},lineEnd:function(){switch(this._point){case 1:{this._context.moveTo(this._x3,this._y3),this._context.closePath();break}case 2:{this._context.lineTo(this._x3,this._y3),this._context.closePath();break}case 3:{this.point(this._x3,this._y3),this.point(this._x4,this._y4),this.point(this._x5,this._y5);break}}},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1,this._x3=e,this._y3=n;break;case 1:this._point=2,this._context.moveTo(this._x4=e,this._y4=n);break;case 2:this._point=3,this._x5=e,this._y5=n;break;default:Lt(this,e,n);break}this._x0=this._x1,this._x1=this._x2,this._x2=e,this._y0=this._y1,this._y1=this._y2,this._y2=n}};const pk=function e(n){function t(a){return new bi(a,n)}return t.tension=function(a){return e(+a)},t}(0);function yi(e,n){this._context=e,this._k=(1-n)/6}yi.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN,this._point=0},lineEnd:function(){(this._line||this._line!==0&&this._point===3)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1;break;case 1:this._point=2;break;case 2:this._point=3,this._line?this._context.lineTo(this._x2,this._y2):this._context.moveTo(this._x2,this._y2);break;case 3:this._point=4;default:Lt(this,e,n);break}this._x0=this._x1,this._x1=this._x2,this._x2=e,this._y0=this._y1,this._y1=this._y2,this._y2=n}};const gk=function e(n){function t(a){return new yi(a,n)}return t.tension=function(a){return e(+a)},t}(0);function _i(e,n,t){var a=e._x1,o=e._y1,i=e._x2,s=e._y2;if(e._l01_a>be){var r=2*e._l01_2a+3*e._l01_a*e._l12_a+e._l12_2a,l=3*e._l01_a*(e._l01_a+e._l12_a);a=(a*r-e._x0*e._l12_2a+e._x2*e._l01_2a)/l,o=(o*r-e._y0*e._l12_2a+e._y2*e._l01_2a)/l}if(e._l23_a>be){var c=2*e._l23_2a+3*e._l23_a*e._l12_a+e._l12_2a,d=3*e._l23_a*(e._l23_a+e._l12_a);i=(i*c+e._x1*e._l23_2a-n*e._l12_2a)/d,s=(s*c+e._y1*e._l23_2a-t*e._l12_2a)/d}e._context.bezierCurveTo(a,o,i,s,e._x2,e._y2)}function Nr(e,n){this._context=e,this._alpha=n}Nr.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN,this._l01_a=this._l12_a=this._l23_a=this._l01_2a=this._l12_2a=this._l23_2a=this._point=0},lineEnd:function(){switch(this._point){case 2:this._context.lineTo(this._x2,this._y2);break;case 3:this.point(this._x2,this._y2);break}(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){if(e=+e,n=+n,this._point){var t=this._x2-e,a=this._y2-n;this._l23_a=Math.sqrt(this._l23_2a=Math.pow(t*t+a*a,this._alpha))}switch(this._point){case 0:this._point=1,this._line?this._context.lineTo(e,n):this._context.moveTo(e,n);break;case 1:this._point=2;break;case 2:this._point=3;default:_i(this,e,n);break}this._l01_a=this._l12_a,this._l12_a=this._l23_a,this._l01_2a=this._l12_2a,this._l12_2a=this._l23_2a,this._x0=this._x1,this._x1=this._x2,this._x2=e,this._y0=this._y1,this._y1=this._y2,this._y2=n}};const mk=function e(n){function t(a){return n?new Nr(a,n):new vi(a,0)}return t.alpha=function(a){return e(+a)},t}(.5);function Er(e,n){this._context=e,this._alpha=n}Er.prototype={areaStart:nn,areaEnd:nn,lineStart:function(){this._x0=this._x1=this._x2=this._x3=this._x4=this._x5=this._y0=this._y1=this._y2=this._y3=this._y4=this._y5=NaN,this._l01_a=this._l12_a=this._l23_a=this._l01_2a=this._l12_2a=this._l23_2a=this._point=0},lineEnd:function(){switch(this._point){case 1:{this._context.moveTo(this._x3,this._y3),this._context.closePath();break}case 2:{this._context.lineTo(this._x3,this._y3),this._context.closePath();break}case 3:{this.point(this._x3,this._y3),this.point(this._x4,this._y4),this.point(this._x5,this._y5);break}}},point:function(e,n){if(e=+e,n=+n,this._point){var t=this._x2-e,a=this._y2-n;this._l23_a=Math.sqrt(this._l23_2a=Math.pow(t*t+a*a,this._alpha))}switch(this._point){case 0:this._point=1,this._x3=e,this._y3=n;break;case 1:this._point=2,this._context.moveTo(this._x4=e,this._y4=n);break;case 2:this._point=3,this._x5=e,this._y5=n;break;default:_i(this,e,n);break}this._l01_a=this._l12_a,this._l12_a=this._l23_a,this._l01_2a=this._l12_2a,this._l12_2a=this._l23_2a,this._x0=this._x1,this._x1=this._x2,this._x2=e,this._y0=this._y1,this._y1=this._y2,this._y2=n}};const fk=function e(n){function t(a){return n?new Er(a,n):new bi(a,0)}return t.alpha=function(a){return e(+a)},t}(.5);function Or(e,n){this._context=e,this._alpha=n}Or.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN,this._l01_a=this._l12_a=this._l23_a=this._l01_2a=this._l12_2a=this._l23_2a=this._point=0},lineEnd:function(){(this._line||this._line!==0&&this._point===3)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){if(e=+e,n=+n,this._point){var t=this._x2-e,a=this._y2-n;this._l23_a=Math.sqrt(this._l23_2a=Math.pow(t*t+a*a,this._alpha))}switch(this._point){case 0:this._point=1;break;case 1:this._point=2;break;case 2:this._point=3,this._line?this._context.lineTo(this._x2,this._y2):this._context.moveTo(this._x2,this._y2);break;case 3:this._point=4;default:_i(this,e,n);break}this._l01_a=this._l12_a,this._l12_a=this._l23_a,this._l01_2a=this._l12_2a,this._l12_2a=this._l23_2a,this._x0=this._x1,this._x1=this._x2,this._x2=e,this._y0=this._y1,this._y1=this._y2,this._y2=n}};const vk=function e(n){function t(a){return n?new Or(a,n):new yi(a,0)}return t.alpha=function(a){return e(+a)},t}(.5);function Rr(e){this._context=e}Rr.prototype={areaStart:nn,areaEnd:nn,lineStart:function(){this._point=0},lineEnd:function(){this._point&&this._context.closePath()},point:function(e,n){e=+e,n=+n,this._point?this._context.lineTo(e,n):(this._point=1,this._context.moveTo(e,n))}};function bk(e){return new Rr(e)}function gs(e){return e<0?-1:1}function ms(e,n,t){var a=e._x1-e._x0,o=n-e._x1,i=(e._y1-e._y0)/(a||o<0&&-0),s=(t-e._y1)/(o||a<0&&-0),r=(i*o+s*a)/(a+o);return(gs(i)+gs(s))*Math.min(Math.abs(i),Math.abs(s),.5*Math.abs(r))||0}function fs(e,n){var t=e._x1-e._x0;return t?(3*(e._y1-e._y0)/t-n)/2:n}function ma(e,n,t){var a=e._x0,o=e._y0,i=e._x1,s=e._y1,r=(i-a)/3;e._context.bezierCurveTo(a+r,o+r*n,i-r,s-r*t,i,s)}function $t(e){this._context=e}$t.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._y0=this._y1=this._t0=NaN,this._point=0},lineEnd:function(){switch(this._point){case 2:this._context.lineTo(this._x1,this._y1);break;case 3:ma(this,this._t0,fs(this,this._t0));break}(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){var t=NaN;if(e=+e,n=+n,!(e===this._x1&&n===this._y1)){switch(this._point){case 0:this._point=1,this._line?this._context.lineTo(e,n):this._context.moveTo(e,n);break;case 1:this._point=2;break;case 2:this._point=3,ma(this,fs(this,t=ms(this,e,n)),t);break;default:ma(this,this._t0,t=ms(this,e,n));break}this._x0=this._x1,this._x1=e,this._y0=this._y1,this._y1=n,this._t0=t}}};function zr(e){this._context=new qr(e)}(zr.prototype=Object.create($t.prototype)).point=function(e,n){$t.prototype.point.call(this,n,e)};function qr(e){this._context=e}qr.prototype={moveTo:function(e,n){this._context.moveTo(n,e)},closePath:function(){this._context.closePath()},lineTo:function(e,n){this._context.lineTo(n,e)},bezierCurveTo:function(e,n,t,a,o,i){this._context.bezierCurveTo(n,e,a,t,i,o)}};function yk(e){return new $t(e)}function _k(e){return new zr(e)}function Vr(e){this._context=e}Vr.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x=[],this._y=[]},lineEnd:function(){var e=this._x,n=this._y,t=e.length;if(t)if(this._line?this._context.lineTo(e[0],n[0]):this._context.moveTo(e[0],n[0]),t===2)this._context.lineTo(e[1],n[1]);else for(var a=vs(e),o=vs(n),i=0,s=1;s<t;++i,++s)this._context.bezierCurveTo(a[0][i],o[0][i],a[1][i],o[1][i],e[s],n[s]);(this._line||this._line!==0&&t===1)&&this._context.closePath(),this._line=1-this._line,this._x=this._y=null},point:function(e,n){this._x.push(+e),this._y.push(+n)}};function vs(e){var n,t=e.length-1,a,o=new Array(t),i=new Array(t),s=new Array(t);for(o[0]=0,i[0]=2,s[0]=e[0]+2*e[1],n=1;n<t-1;++n)o[n]=1,i[n]=4,s[n]=4*e[n]+2*e[n+1];for(o[t-1]=2,i[t-1]=7,s[t-1]=8*e[t-1]+e[t],n=1;n<t;++n)a=o[n]/i[n-1],i[n]-=a,s[n]-=a*s[n-1];for(o[t-1]=s[t-1]/i[t-1],n=t-2;n>=0;--n)o[n]=(s[n]-o[n+1])/i[n];for(i[t-1]=(e[t]+o[t-1])/2,n=0;n<t-1;++n)i[n]=2*e[n+1]-o[n+1];return[o,i]}function wk(e){return new Vr(e)}function Zt(e,n){this._context=e,this._t=n}Zt.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x=this._y=NaN,this._point=0},lineEnd:function(){0<this._t&&this._t<1&&this._point===2&&this._context.lineTo(this._x,this._y),(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line>=0&&(this._t=1-this._t,this._line=1-this._line)},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1,this._line?this._context.lineTo(e,n):this._context.moveTo(e,n);break;case 1:this._point=2;default:{if(this._t<=0)this._context.lineTo(this._x,n),this._context.lineTo(e,n);else{var t=this._x*(1-this._t)+e*this._t;this._context.lineTo(t,this._y),this._context.lineTo(t,n)}break}}this._x=e,this._y=n}};function kk(e){return new Zt(e,.5)}function xk(e){return new Zt(e,0)}function Ak(e){return new Zt(e,1)}function Vn(e,n,t){this.k=e,this.x=n,this.y=t}Vn.prototype={constructor:Vn,scale:function(e){return e===1?this:new Vn(this.k*e,this.x,this.y)},translate:function(e,n){return e===0&n===0?this:new Vn(this.k,this.x+this.k*e,this.y+this.k*n)},apply:function(e){return[e[0]*this.k+this.x,e[1]*this.k+this.y]},applyX:function(e){return e*this.k+this.x},applyY:function(e){return e*this.k+this.y},invert:function(e){return[(e[0]-this.x)/this.k,(e[1]-this.y)/this.k]},invertX:function(e){return(e-this.x)/this.k},invertY:function(e){return(e-this.y)/this.k},rescaleX:function(e){return e.copy().domain(e.range().map(this.invertX,this).map(e.invert,e))},rescaleY:function(e){return e.copy().domain(e.range().map(this.invertY,this).map(e.invert,e))},toString:function(){return"translate("+this.x+","+this.y+") scale("+this.k+")"}};Vn.prototype;const _2={class:"knowledge-graph-shell"},Je=720,Ue=320,me=44,w2=U({__name:"KnowledgeGraph",setup(e){const n=Je/2,t=Ue/2,a=ae(null);let o=null,i=null,s=null,r=null;const l=[{id:"agentic",label:"Agentic",size:22,group:"main"},{id:"devops",label:"DevOps",size:24,group:"main"},{id:"architecture",label:"Architecture",size:22,group:"main"},{id:"golang",label:"Go",size:14,group:"secondary"},{id:"kubernetes",label:"K8S",size:14,group:"secondary"},{id:"cloud",label:"Cloud",size:14,group:"secondary"},{id:"cicd",label:"GitOps",size:13,group:"secondary"},{id:"development",label:"Development",size:14,group:"secondary"},{id:"ddd",label:"DDD",size:13,group:"secondary"},{id:"microservices",label:"MicroServices",size:13,group:"secondary"},{id:"copilot",label:"Copilot",size:13,group:"secondary"},{id:"aws",label:"AWS",size:11,group:"leaf"},{id:"tdd",label:"TDD",size:11,group:"leaf"},{id:"kotlin",label:"Kotlin",size:11,group:"leaf"}],c=l.filter(I=>typeof I.anchorX=="number"&&typeof I.anchorY=="number"),d=c.map(I=>I.anchorX),g=c.map(I=>I.anchorY),u=Math.min(...d),h=Math.max(...d),v=Math.min(...g),b=Math.max(...g);function _(I){const V=Je-me*2;return me+(I-u)/Math.max(h-u,1)*V}function x(I){const V=Ue-me*2;return me+(I-v)/Math.max(b-v,1)*V}const A={agentic:{x:n-132,y:t-44},devops:{x:n,y:t+8},architecture:{x:n+132,y:t-44}};function D(I){var V;return I.group==="main"?((V=A[I.id])==null?void 0:V.x)??n:typeof I.anchorX=="number"?_(I.anchorX):n}function y(I){var V;return I.group==="main"?((V=A[I.id])==null?void 0:V.y)??t:typeof I.anchorY=="number"?x(I.anchorY):t}const T=l.map(I=>({...I,x:D(I),y:y(I)})),k=[{id:"golang-kubernetes",source:"golang",target:"kubernetes"},{id:"golang-development",source:"golang",target:"development"},{id:"kubernetes-devops",source:"kubernetes",target:"devops"},{id:"kubernetes-cloud",source:"kubernetes",target:"cloud"},{id:"cloud-aws",source:"cloud",target:"aws"},{id:"cicd-devops",source:"cicd",target:"devops"},{id:"development-tdd",source:"development",target:"tdd"},{id:"development-ddd",source:"development",target:"ddd"},{id:"ddd-architecture",source:"ddd",target:"architecture"},{id:"ddd-microservices",source:"ddd",target:"microservices"},{id:"microservices-architecture",source:"microservices",target:"architecture"},{id:"copilot-agentic",source:"copilot",target:"agentic"},{id:"copilot-development",source:"copilot",target:"development"},{id:"golang-kotlin",source:"golang",target:"kotlin"}],E=new Map(T.map(I=>[I.id,I]));function B(I,V){const H=getComputedStyle(document.documentElement).getPropertyValue(I).trim();if(!H)return V;if(H.startsWith("#")){const O=H.slice(1),Y=O.length===3?`${O[0]}${O[0]}${O[1]}${O[1]}${O[2]}${O[2]}`:O;if(Y.length===6){const J=parseInt(Y.slice(0,2),16),P=parseInt(Y.slice(2,4),16),oe=parseInt(Y.slice(4,6),16);return`rgb(${J}, ${P}, ${oe})`}}return H}function W(){return{mainNode:B("--color-primary","rgb(84, 95, 115)"),secondaryNode:B("--color-primary-container","rgb(216, 227, 251)"),leafNode:B("--color-surface-container-low","rgb(231, 236, 239)"),edgeColor:B("--color-outline-variant","rgb(169, 180, 185)"),activeEdge:B("--color-tertiary","rgb(58, 82, 95)"),dimColor:B("--color-surface","rgb(242, 244, 245)"),labelColor:B("--color-on-surface","rgb(42, 52, 57)"),dimLabelColor:B("--color-on-surface-variant","rgb(95, 108, 114)"),surfaceColor:B("--color-surface-container-lowest","rgb(255, 255, 255)")}}function F(I){if(I)return typeof I=="string"?E.get(I):I}function $(I){return I?typeof I=="string"?I:I.id:null}function M(I){return Math.max(I.size*.84,10)}function L(I){return Number.isFinite(I.x)?I.x:Je/2}function z(I){return Number.isFinite(I.y)?I.y:Ue/2}function te(I){const V=M(I),H=me+V,O=Je-me-V,Y=me+V,J=Ue-me-V;I.x=Math.min(O,Math.max(H,L(I))),I.y=Math.min(J,Math.max(Y,z(I)))}function ee(I,V){const H=M(I),O=me+H,Y=Je-me-H;return Math.min(Y,Math.max(O,V))}function K(I,V){const H=M(I),O=me+H,Y=Ue-me-H;return Math.min(Y,Math.max(O,V))}function re(I,V){const H=k.find(O=>O.id===I);return H?$(H.source)===V||$(H.target)===V:!1}function de(I){return o?I===o?!0:k.some(V=>re(V.id,I)&&re(V.id,o)):!1}function ue(I,V){return I==="main"?V.mainNode:I==="secondary"?V.secondaryNode:V.leafNode}function Ce(){if(!a.value)return;const I=ln(a.value).select("svg.knowledge-graph-svg");I.empty()||(I.selectAll("line.graph-edge").attr("x1",V=>L(F(V.source)??T[0])).attr("y1",V=>z(F(V.source)??T[0])).attr("x2",V=>L(F(V.target)??T[0])).attr("y2",V=>z(F(V.target)??T[0])),I.selectAll("line.graph-edge-hitbox").attr("x1",V=>L(F(V.source)??T[0])).attr("y1",V=>z(F(V.source)??T[0])).attr("x2",V=>L(F(V.target)??T[0])).attr("y2",V=>z(F(V.target)??T[0])),I.selectAll("g.graph-node").attr("transform",V=>`translate(${L(V)}, ${z(V)})`))}function _e(){if(!a.value)return;const I=W(),V=ln(a.value).select("svg.knowledge-graph-svg");V.empty()||(V.select("rect.graph-surface").attr("fill",I.surfaceColor).attr("opacity",.18),V.selectAll("line.graph-grid").attr("stroke",I.dimColor).attr("opacity",.55),V.selectAll("line.graph-edge").attr("stroke",H=>H.id===i?I.activeEdge:o&&!re(H.id,o)||i&&H.id!==i?I.dimColor:I.edgeColor).attr("stroke-width",H=>H.id===i?3.4:1.8).attr("opacity",H=>H.id===i?1:o&&!re(H.id,o)||i&&H.id!==i?.35:.9),V.selectAll("circle.graph-node-shape").attr("r",H=>{const O=M(H);return H.id===o?O*1.12:O}).attr("fill",H=>ue(H.group,I)).attr("stroke",I.surfaceColor).attr("stroke-width",H=>H.id===o?3:2).attr("opacity",H=>H.id===o?1:o&&!de(H.id)||i&&!re(i,H.id)?.4:.96),V.selectAll("text.graph-node-label").attr("fill",H=>o&&!de(H.id)||i&&!re(i,H.id)?I.dimLabelColor:I.labelColor).attr("opacity",H=>o&&!de(H.id)||i&&!re(i,H.id)?.6:1))}function le(){o=null,i=null,_e()}function Le(){if(!a.value)return;const I=ln(a.value);I.selectAll("*").remove();const V=I.append("svg").attr("viewBox",`0 0 ${Je} ${Ue}`).attr("class","knowledge-graph-svg").attr("role","img").attr("aria-label","engineering knowledge graph").on("mouseleave",()=>{le()});V.append("rect").attr("class","graph-surface").attr("x",0).attr("y",0).attr("width",Je).attr("height",Ue).attr("rx",28),V.append("g").selectAll("line.graph-grid").data([.2,.5,.8]).join("line").attr("class","graph-grid").attr("x1",me).attr("x2",Je-me).attr("y1",P=>me+P*(Ue-me*2)).attr("y2",P=>me+P*(Ue-me*2)).attr("stroke-width",1).attr("stroke-dasharray","5 8");const H=V.append("g").attr("class","edge-layer"),O=V.append("g").attr("class","node-layer"),Y=_f().on("start",(P,oe)=>{P.active||r==null||r.alphaTarget(.18).restart(),oe.fx=L(oe),oe.fy=z(oe)}).on("drag",(P,oe)=>{oe.fx=ee(oe,P.x),oe.fy=K(oe,P.y),Ce()}).on("end",(P,oe)=>{P.active||r==null||r.alphaTarget(0),oe.fx=null,oe.fy=null});H.selectAll("line.graph-edge").data(k).join("line").attr("class","graph-edge").attr("stroke-linecap","round"),H.selectAll("line.graph-edge-hitbox").data(k).join("line").attr("class","graph-edge-hitbox").attr("stroke","transparent").attr("stroke-width",14).attr("stroke-linecap","round").style("cursor","pointer").on("mouseenter",(P,oe)=>{i=oe.id,o=null,_e()});const J=O.selectAll("g.graph-node").data(T).join("g").attr("class","graph-node").style("cursor","pointer").on("mouseenter",(P,oe)=>{o=oe.id,i=null,_e()}).call(Y);J.append("circle").attr("class","graph-node-shape"),J.append("text").attr("class","graph-node-label").text(P=>P.label).attr("text-anchor","middle").attr("dominant-baseline","middle").attr("font-size",P=>Math.max(P.size*.78,10)).attr("font-weight",P=>P.group==="main"?700:600).style("pointer-events","none"),Ce(),_e()}function Te(){r==null||r.stop(),r=jv(T).force("link",Ev(k).id(I=>I.id).distance(I=>{const V=F(I.source),H=F(I.target);return(V==null?void 0:V.group)==="main"||(H==null?void 0:H.group)==="main"?104:(V==null?void 0:V.group)==="leaf"||(H==null?void 0:H.group)==="leaf"?72:88}).strength(.4)).force("charge",Uv().strength(I=>I.group==="main"?-780:I.group==="secondary"?-520:-320)).force("center",gv(n,t)).force("x",Gv(I=>D(I)).strength(I=>I.group==="main"?.24:.08)).force("y",Hv(I=>y(I)).strength(I=>I.group==="main"?.22:.06)).force("collision",$v().radius(I=>M(I)+12).iterations(3)).alpha(.9).alphaDecay(.04).velocityDecay(.3).on("tick",()=>{T.forEach(I=>{te(I)}),Ce()})}return Ee(()=>{Le(),Te(),s=new MutationObserver(()=>{_e()}),s.observe(document.documentElement,{attributes:!0,attributeFilter:["class","data-theme"]})}),Fa(()=>{s&&(s.disconnect(),s=null),r&&(r.stop(),r=null)}),(I,V)=>(f(),w("div",_2,[p("div",{ref_key:"containerRef",ref:a,class:"knowledge-graph-canvas"},null,512)]))}}),k2=X(w2,[["__scopeId","data-v-49a3d5a3"]]);function pe(e){return e.replace(/^\/+/,"").replace(/^docs\//,"")}function bs(e){return`/${pe(e)}`}function Br(e){return Object.keys(e).reduce((n,t)=>(n[pe(t)]=t,n),{})}function Fr(e,n,t){const a=pe(e),o=[bs(e),`/${a}`,a,t[a]].filter(i=>!!i);for(const i of o){const s=n[i];if(s)return{modulePath:i,raw:s}}return{modulePath:bs(e),raw:void 0}}function Nt(e){const n=pe(e);return n.split("/").pop()||n}function ys(e){return e.replace(/^['\"]|['\"]$/g,"").trim()}function x2(e){const n=e.trim();if(n.startsWith("[")&&n.endsWith("]")){const t=n.slice(1,-1).trim();return t?t.split(",").map(a=>ys(a.trim())).filter(a=>a.length>0):[]}return ys(n)}function jr(e){const n=e.match(/^---\n([\s\S]*?)\n---/);if(!n)return{};const t={};for(const a of n[1].split(`
`)){if(!a||/^\s/.test(a)||a.startsWith("#"))continue;const o=a.indexOf(":");if(o<0)continue;const i=a.slice(0,o).trim(),s=x2(a.slice(o+1));t[i]=s}return t}function Ur(e){return e.replace(/^---[\s\S]*?---\n?/,"").trim()}function Gr(e){const t=Ur(e).split(/\n\s*\n/).find(a=>a.trim().length>0);return(t==null?void 0:t.replace(/^#+\s+/,"").trim())||""}function Hr(e,n={}){const a=Ur(e).replace(/```[\s\S]*?```/g," ").replace(/`[^`]*`/g," ").replace(/!\[[^\]]*\]\([^)]*\)/g," ").replace(/\[[^\]]*\]\([^)]*\)/g," ").replace(/[#>*_~\-]/g," ").replace(/\s+/g," ").trim().length,o=Math.max(1,Math.ceil(a/500));return typeof n.formatter=="function"?n.formatter(o):n.template?n.template.replace("{minutes}",String(o)):`~ ${o} min read`}function Fn(e){return e?`/${pe(e).replace(/\.md$/,"").replace(/\/index$/,"/")}`:"#"}function Wr(e){const n=e.replace(/[.+^${}()|[\]\\]/g,"\\$&").replace(/\*\*/g,"::DOUBLE_STAR::").replace(/\*/g,"[^/]*").replace(/::DOUBLE_STAR::/g,".*");return new RegExp(`^${n}$`)}function Kr(e){const n=String(e.category||"").trim();return n&&e.categoryMeta&&e.categoryMeta[n]?e.categoryMeta[n]:{}}function wi(e){const n=Kr(e);return n.label?n.label:String(e.category||"").trim()}function ki(e){const n=Kr(e);return n.colorClass?n.colorClass:""}const A2="/assets/1644655887368.DQapbKac.jpg",C2="/assets/1644658272643.DixkFUdM.jpg",T2="/assets/wx20220212-172346.Bdr25vH2.png",S2="/assets/wx20220212-172451.BB6BU37T.png",I2="/assets/1-6zojnn4sdsd9kylfhr34-a-1640317491743-0.BT5IPXlG.png",P2="/assets/1-n1zqvw8bk-o8rwxnzs5kq-1640317547459-0.DWMxzrzx.png",M2="/assets/2022-03-13-22-37-47.FXklLsNs.jpeg",D2="/assets/dual-clutch-transmission-13-1640318081688-0.B4hokDfU.gif",L2="/assets/skills.BAnIdTNL.png",$2="/assets/wiki-type-of-architect-1640317457778-0.C3YyCdof.png",N2="/assets/wx20220320-163559.CfWPxfHG.png",E2="/assets/wx20220320-163907.B6vfIgkR.png",O2="/assets/wx20220321-104324.BgpfGzm0.png",R2="/assets/image-1653875255217-0.DLUkC6WM.png",z2="/assets/2022-05-25-10-21-15.BG964yVJ.png",q2="/assets/image-16.yUtl20qA.png",V2="/assets/image-17.hTTOmgfs.png",B2="/assets/image-18.HclV9ZG2.png",F2="/assets/1645694079239.C_nre4re.jpg",j2="/assets/achitecture-discussing-2.CIp6ic9U.jpeg",U2="/assets/achitecture-discussing._BjOxGqC.jpeg",G2="/assets/basic-diagram.k-lcOFHY.jpeg",H2="/assets/building-architecture.CVLmaHKi.jpeg",W2="/assets/image-01.9UEyGlKG.png",K2="/assets/image-02.lC5tp8JY.png",Y2="/assets/image-03.CN1AMQ2n.png",X2="/assets/image-21.GzBuHhpo.png",Q2="/assets/image-31.BCqMHRFV.png",J2="/assets/image-32.BONEHxoC.png",Z2="/assets/image-33.35tIccBN.png",e1="/assets/image-34.BI0AYe_e.png",n1="/assets/image-35.Dqw7EEZo.png",t1="/assets/image-36.B6zYBbcF.png",a1="/assets/image-37.Bug7G00R.png",o1="/assets/image-38.F3X5v5gc.png",i1="/assets/image-main.d3gkZeRb.png",s1="/assets/math-diagram.CeYjpfsa.jpeg",r1="/assets/network-topology.CSAnXw-U.webp",l1="/assets/pictograph-1.BjKnp1uA.jpeg",c1="/assets/quick-sort.DqDqTYZk.png",u1="/assets/words.BJuqccBz.webp",d1="/assets/image.v72K2I7B.png",h1="/assets/image-1.CABcO0hy.png",p1="/assets/image-2.CqDiP9_8.png",g1="/assets/image.C-NbRYb4.png",m1="/assets/langchain-ollama.BRx4KDS9.png",f1="/assets/llm-architecture.Brkjch2V.png",v1="/assets/git-graph-0.C4G_Ghqh.png",b1="/assets/git-graph-1.0NB7GhSV.png",y1="/assets/devops.D2KY2cuE.png",_1="/assets/homepage.CbpzU-qz.png",w1="/assets/mp-weixin-green.CsjjYBS_.png",k1="/assets/mp-weixin-white.CcgfmLQg.png",x1="/assets/old.BLdKa2Z6.png",A1="/assets/image-1.BZojNKVT.png",C1="/assets/image-2.DU_0Fs-4.png",T1="/assets/image-3.DFogVQnE.png",S1="/assets/image-main.QAIGTop_.png",I1="/assets/mp-weixin-green.CsjjYBS_.png",P1="/assets/mp-weixin-white.CcgfmLQg.png",M1="https://picsum.photos/800/600";function D1(e){let n=0;for(let t=0;t<e.length;t+=1)n=(n*31+e.charCodeAt(t))%1e4;return n+1}function L1(e){return e.replace(/^\/+/,"").replace(/^docs\//,"")}function $1(e){const n=L1(e||"")||"default",t=D1(n);return`${M1}?random=${t}`}const N1=new Set(["","null","undefined","none","n/a","na","-"]),E1=Object.assign({"/blogs/assets/202202-logseq-build-your-own-wiki/1644655887368.jpg":A2,"/blogs/assets/202202-logseq-build-your-own-wiki/1644658272643.jpg":C2,"/blogs/assets/202202-logseq-build-your-own-wiki/wx20220212-172346.png":T2,"/blogs/assets/202202-logseq-build-your-own-wiki/wx20220212-172451.png":S2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/1-6zojnn4sdsd9kylfhr34-a-1640317491743-0.png":I2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/1-n1zqvw8bk-o8rwxnzs5kq-1640317547459-0.png":P2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/2022-03-13-22-37-47.jpeg":M2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/dual-clutch-transmission-13-1640318081688-0.gif":D2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/skills.png":L2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/wiki-type-of-architect-1640317457778-0.png":$2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/wx20220320-163559.png":N2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/wx20220320-163907.png":E2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/wx20220321-104324.png":O2,"/blogs/assets/202203-mesh-shaped-recap/image-1653875255217-0.png":R2,"/blogs/assets/202205-router-proxy-gtw/2022-05-25-10-21-15.png":z2,"/blogs/assets/202211-cloud-native-engineering/image-16.png":q2,"/blogs/assets/202211-cloud-native-engineering/image-17.png":V2,"/blogs/assets/202211-cloud-native-engineering/image-18.png":B2,"/blogs/assets/202212-logseq-customized-with-clojure-and-css/1645694079239.jpg":F2,"/blogs/assets/202304-draw-architecture-diagram/achitecture-discussing-2.jpeg":j2,"/blogs/assets/202304-draw-architecture-diagram/achitecture-discussing.jpeg":U2,"/blogs/assets/202304-draw-architecture-diagram/basic-diagram.jpeg":G2,"/blogs/assets/202304-draw-architecture-diagram/building-architecture.jpeg":H2,"/blogs/assets/202304-draw-architecture-diagram/image-01.png":W2,"/blogs/assets/202304-draw-architecture-diagram/image-02.png":K2,"/blogs/assets/202304-draw-architecture-diagram/image-03.png":Y2,"/blogs/assets/202304-draw-architecture-diagram/image-21.png":X2,"/blogs/assets/202304-draw-architecture-diagram/image-31.png":Q2,"/blogs/assets/202304-draw-architecture-diagram/image-32.png":J2,"/blogs/assets/202304-draw-architecture-diagram/image-33.png":Z2,"/blogs/assets/202304-draw-architecture-diagram/image-34.png":e1,"/blogs/assets/202304-draw-architecture-diagram/image-35.png":n1,"/blogs/assets/202304-draw-architecture-diagram/image-36.png":t1,"/blogs/assets/202304-draw-architecture-diagram/image-37.png":a1,"/blogs/assets/202304-draw-architecture-diagram/image-38.png":o1,"/blogs/assets/202304-draw-architecture-diagram/image-main.png":i1,"/blogs/assets/202304-draw-architecture-diagram/math-diagram.jpeg":s1,"/blogs/assets/202304-draw-architecture-diagram/network-topology.webp":r1,"/blogs/assets/202304-draw-architecture-diagram/pictograph-1.jpeg":l1,"/blogs/assets/202304-draw-architecture-diagram/quick-sort.png":c1,"/blogs/assets/202304-draw-architecture-diagram/words.webp":u1,"/blogs/assets/202304-tunnel-vpn-vpc/image.png":d1,"/blogs/assets/202402-llm-application/image-1.png":h1,"/blogs/assets/202402-llm-application/image-2.png":p1,"/blogs/assets/202402-llm-application/image.png":g1,"/blogs/assets/202402-llm-application/langchain-ollama.png":m1,"/blogs/assets/202402-llm-application/llm-architecture.png":f1,"/blogs/assets/202406-fork-oss/git-graph-0.png":v1,"/blogs/assets/202406-fork-oss/git-graph-1.png":b1,"/blogs/assets/202406-k3s-blogs/devops.png":y1,"/blogs/assets/202406-k3s-blogs/homepage.png":_1,"/blogs/assets/202406-k3s-blogs/mp-weixin-green.png":w1,"/blogs/assets/202406-k3s-blogs/mp-weixin-white.png":k1,"/blogs/assets/202406-k3s-blogs/old.png":x1,"/blogs/assets/202412-ai-powered-pkm/image-1.png":A1,"/blogs/assets/202412-ai-powered-pkm/image-2.png":C1,"/blogs/assets/202412-ai-powered-pkm/image-3.png":T1,"/blogs/assets/202412-ai-powered-pkm/image-main.png":S1,"/blogs/assets/202412-ai-powered-pkm/mp-weixin-green.png":I1,"/blogs/assets/202412-ai-powered-pkm/mp-weixin-white.png":P1});function O1(e){const n=e.trim();if(!n)return[];const t=n.startsWith("/")?n:`/${n}`;return[n,t]}function R1(e){for(const n of O1(e)){const t=E1[n];if(t)return t}return e}function Kn(e,n){const t=(e||"").trim(),a=t.toLowerCase();return!t||N1.has(a)?$1(n):R1(t)}const z1={class:"bg-surface dark:bg-slate-900 text-on-surface dark:text-slate-100"},q1={class:"pt-32 pb-24"},V1={class:"max-w-7xl mx-auto px-8 mb-32"},B1={class:"grid grid-cols-1 lg:grid-cols-12 gap-12 items-start"},F1={class:"lg:col-span-6"},j1={class:"mb-6 inline-block bg-primary-container px-3 py-1 rounded text-[10px] uppercase tracking-widest font-bold text-on-primary-container"},U1={class:"text-[3.5rem] font-extrabold tracking-tight leading-[1.1] mb-8 text-on-surface dark:text-slate-100"},G1={class:"text-[1.375rem] leading-relaxed text-on-surface-variant dark:text-slate-400 font-light mb-8 max-w-2xl"},H1={class:"flex items-center gap-4 mb-12"},W1={class:"text-sm text-on-surface-variant dark:text-slate-400"},K1={class:"lg:col-span-6 relative lg:mt-12"},Y1={class:"bg-surface-container-lowest dark:bg-slate-950 p-6 rounded-lg dark:border-slate-700"},X1={class:"bg-surface-container-low dark:bg-slate-900 py-24"},Q1={class:"max-w-7xl mx-auto px-8"},J1={class:"flex justify-between items-end mb-16"},Z1={class:"label-sm text-tertiary font-bold tracking-[0.2em] uppercase text-xs mb-4 block pb-4"},e_={class:"text-[2.25rem] font-bold tracking-tight text-on-surface dark:text-slate-100"},n_={class:"grid grid-cols-1 md:grid-cols-2 gap-px bg-outline-variant/10 dark:bg-slate-700"},t_=["src","alt"],a_=["data-icon"],o_={class:"text-xl font-bold mb-4 text-on-surface dark:text-slate-100"},i_={class:"text-on-surface-variant dark:text-slate-400 leading-relaxed"},s_={class:"max-w-7xl mx-auto px-8 py-32"},r_={class:"mb-16 flex items-center justify-between gap-6"},l_={class:"text-[2.25rem] font-bold tracking-tight text-on-surface dark:text-slate-100 mb-2"},c_=["href"],u_={key:0,class:"grid grid-cols-1 md:grid-cols-12 gap-8"},d_=["href"],h_={class:"relative overflow-hidden rounded-xl mb-6 aspect-[16/9] bg-surface-container-low dark:bg-slate-900"},p_=["alt","src"],g_={class:"flex items-center gap-4 mb-4"},m_={class:"text-xs text-outline dark:text-slate-400 tracking-wider"},f_={class:"text-3xl font-bold tracking-tight mb-4 group-hover:text-tertiary transition-colors"},v_={class:"text-on-surface-variant dark:text-slate-400 line-clamp-2 max-w-2xl"},b_={class:"md:col-span-4 flex flex-col gap-12"},y_=["href"],__={class:"flex items-center gap-3 mb-3"},w_={class:"text-[10px] text-outline dark:text-slate-400"},k_={class:"text-xl font-bold tracking-tight mb-3 group-hover:text-tertiary transition-colors leading-tight"},x_={class:"text-sm text-on-surface-variant dark:text-slate-400 line-clamp-2"},A_={class:"mt-4 flex items-center gap-1 text-tertiary text-sm font-semibold opacity-0 group-hover:opacity-100 transition-opacity"},C_={key:1,class:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"},T_=["href"],S_=["src","alt"],I_={class:"p-5"},P_={class:"flex items-center justify-between gap-3 mb-3"},M_={class:"text-[10px] text-outline dark:text-slate-400"},D_={class:"text-base font-bold tracking-tight mb-2 text-on-surface dark:text-slate-100"},L_={class:"text-sm text-on-surface-variant dark:text-slate-400 line-clamp-3"},$_={key:0,class:"max-w-7xl mx-auto px-8"},N_={class:"bg-primary text-on-primary p-16 rounded-xl relative overflow-hidden"},E_={class:"relative z-10 max-w-2xl"},O_={class:"text-3xl font-bold tracking-tight mb-4"},R_={class:"text-on-primary/80 mb-8 text-lg"},z_={class:"flex flex-col sm:flex-row gap-4"},q_=["placeholder"],V_={class:"bg-on-primary text-primary font-bold px-8 py-3 rounded-lg hover:bg-primary-container transition-all active:scale-95",type:"submit"},B_=U({__name:"AboutMeLayout",setup(e){const{lang:n}=gn(),{page:t}=Ft(),{headerConfig:a,footerConfig:o,uiConfig:i}=jt(),s=R(()=>i.value.common||{}),r=R(()=>i.value.about||{}),l=R(()=>i.value.blog||{}),c=R(()=>l.value.categoryMeta||{}),d=Object.assign({"/about-me.md":Xa,"/blogs/2022/202202-logseq-build-your-own-wiki.md":Qa,"/blogs/2022/202203-mesh-shaped-cloud-native-developer.md":Ja,"/blogs/2022/202203-mesh-shaped-recap.md":Za,"/blogs/2022/202205-container-k8s-docker.md":eo,"/blogs/2022/202205-router-proxy-gtw.md":no,"/blogs/2022/202211-cloud-native-engineering.md":to,"/blogs/2022/202212-api-design-inspired-by-google-api-design.md":ao,"/blogs/2022/202212-go-monorepo-tutorial.md":oo,"/blogs/2022/202212-logseq-customized-with-clojure-and-css.md":io,"/blogs/2022/202212-logseq-pkm.md":so,"/blogs/2023/202302-iac-and-terraform.md":ro,"/blogs/2023/202304-draw-architecture-diagram.md":lo,"/blogs/2023/202304-tunnel-vpn-vpc.md":co,"/blogs/2023/202306-remote-development-in-cloud.md":uo,"/blogs/2023/202312-agile-and-lean.md":ho,"/blogs/2023/202312-cobra-cli.md":po,"/blogs/2023/202312-devcontainer-tutorial.md":go,"/blogs/2023/202312-illustrated-ai.md":mo,"/blogs/2023/202312-kubernetes-operator.md":fo,"/blogs/2023/202312-windows-workspaces.md":vo,"/blogs/2024/202401-cloud-native-practices.md":bo,"/blogs/2024/202401-eassy-2024.md":yo,"/blogs/2024/202401-illustrations.md":_o,"/blogs/2024/202402-llm-application.md":wo,"/blogs/2024/202403-ai-and-human.md":ko,"/blogs/2024/202406-fork-oss.md":xo,"/blogs/2024/202406-k3s-blogs.md":Ao,"/blogs/2024/202412-ai-powered-pkm.md":Co,"/blogs/2026/202602-domain-spec-agents.md":To,"/blogs/2026/202602-pov-agentic-engineering.md":So,"/blogs/2026/202602-pov-standard-automation-selfserve.md":Io,"/blogs/index.md":Po,"/en/about-me.md":Mo,"/en/blogs/2022/202202-logseq-build-your-own-wiki.md":Do,"/en/blogs/2022/202203-mesh-shaped-cloud-native-developer.md":Lo,"/en/blogs/2022/202205-container-k8s-docker.md":$o,"/en/blogs/2022/202205-router-proxy-gtw.md":No,"/en/blogs/2022/202211-cloud-native-engineering.md":Eo,"/en/blogs/2022/202212-logseq-customized-with-clojure-and-css.md":Oo,"/en/blogs/2022/202212-logseq-pkm.md":Ro,"/en/blogs/2023/202302-iac-and-terraform.md":zo,"/en/blogs/2023/202304-draw-architecture-diagram.md":qo,"/en/blogs/2023/202304-tunnel-vpn-vpc.md":Vo,"/en/blogs/2023/202306-remote-development-in-cloud.md":Bo,"/en/blogs/2023/202312-agile-and-lean.md":Fo,"/en/blogs/2023/202312-devcontainer-tutorial.md":jo,"/en/blogs/2024/202401-cloud-native-practices.md":Uo,"/en/blogs/2024/202401-illustrations.md":Go,"/en/blogs/2024/202402-llm-application.md":Ho,"/en/blogs/2024/202403-ai-and-human.md":Wo,"/en/blogs/2024/202412-ai-powered-pkm.md":Ko,"/en/blogs/2026/202602-domain-spec-agents.md":Yo,"/en/blogs/2026/202602-pov-agentic-engineering.md":Xo,"/en/blogs/2026/202602-pov-standard-automation-selfserve.md":Qo,"/en/blogs/index.md":Jo,"/en/index.md":Zo,"/index.md":ei}),g=Br(d);function u(k){var $,M;const{modulePath:E,raw:B}=Fr(k,d,g);if(!B)return console.warn(`[AboutMeLayout] markdown not found for path: ${k}`),console.warn(`[AboutMeLayout] attempted module key: ${E}`),null;const W=jr(B),F=W.title||W.heroTitle||((M=($=pe(k).split("/").pop())==null?void 0:$.replace(/\.md$/,""))==null?void 0:M.replace(/[-_]/g," "))||String(s.value.untitled||"Untitled");return{path:pe(k),title:F,description:W.description||W.heroDescription||W.articleLead||Gr(B),date:W.date,category:W.category,image:W.image}}const h=R(()=>{const k=t.value.featuredArticle;if(!k)return null;if(typeof k=="string")return u(k);if(typeof k=="object"&&typeof k.path=="string"){const E=u(k.path);return E?{...E,...k,path:E.path}:null}return typeof k=="object"?k:null}),v=R(()=>{var M;const k=t.value.sideArticles,E=pe(((M=h.value)==null?void 0:M.path)||"");if(Array.isArray(k))return k.filter(L=>pe(L.path||"")!==E);if(!k||typeof k!="object")return[];const B=pe(k.path||"blog/**/*.md"),W=Number(k.count||4),F=Wr(B);return Object.keys(d).map(L=>pe(L)).filter(L=>F.test(L)).sort((L,z)=>{const te=Nt(z).localeCompare(Nt(L));return te!==0?te:z.localeCompare(L)}).map(L=>u(L)).filter(L=>!!L).filter(L=>pe(L.path||"")!==E).slice(0,W)}),b=R(()=>!!h.value),_=R(()=>b.value?v.value:v.value.slice(0,4)),x=R(()=>t.value.articlesMoreHref||(n.value==="en"?"/en/blog/":"/blog/")),A=R(()=>t.value.articlesMoreText||r.value.viewMore||"View More");function D(k){return typeof k=="string"&&/^https?:\/\//.test(k)}function y(k){return wi({category:String(k||""),categoryMeta:c.value})}function T(k){return ki({category:String(k||""),categoryMeta:c.value})}return(k,E)=>{var B,W,F,$,M,L,z,te,ee;return f(),w("div",z1,[j(Vt,{"site-title":m(a).siteTitle||m(t).siteTitle,"nav-links":m(a).navLinks||m(t).navLinks||[],"show-subscribe":!!m(a).showSubscribe,"subscribe-button-text":m(a).subscribeButtonText,"nav-height-class":"h-20"},null,8,["site-title","nav-links","show-subscribe","subscribe-button-text"]),p("main",q1,[p("section",V1,[p("div",B1,[p("div",F1,[p("div",j1,S(m(t).heroEyebrow),1),p("h1",U1,S(m(t).heroTitle),1),p("p",G1,S(m(t).heroDescription),1),p("div",H1,[p("p",W1,S(m(t).heroMeta),1)])]),p("div",K1,[p("div",Y1,[E[0]||(E[0]=p("span",{class:"text-s font-bold tracking-tight text-slate-700 dark:text-slate-300 mb-6"}," Graph: Mesh Capabilities ",-1)),j(k2)])])])]),p("section",X1,[p("div",Q1,[p("div",J1,[p("div",null,[p("span",Z1,S(m(t).focusEyebrow),1),p("h2",e_,S(m(t).focusTitle),1)]),E[1]||(E[1]=p("div",{class:"hidden md:block w-1/3 h-[1px] bg-outline-variant/20 dark:bg-slate-700 mb-4"},null,-1))]),p("div",n_,[(f(!0),w(Z,null,ie(m(t).focusCards||[],K=>(f(),w("div",{key:K.title,class:"bg-surface-container-lowest dark:bg-slate-950 p-10 transition-colors"},[D(K.icon)?(f(),w("img",{key:0,src:K.icon,alt:K.title,class:"w-10 h-10 object-contain mb-6"},null,8,t_)):(f(),w("span",{key:1,class:"material-symbols-outlined text-primary mb-6 block text-4xl dark:text-tertiary","data-icon":K.icon},S(K.icon),9,a_)),p("h3",o_,S(K.title),1),p("p",i_,S(K.description),1)]))),128))])])]),p("section",s_,[p("div",r_,[p("div",null,[p("h2",l_,S(m(t).articlesTitle),1),E[2]||(E[2]=p("div",{class:"w-12 h-1 bg-primary"},null,-1))]),p("a",{href:x.value,class:"inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-outline-variant/30 dark:border-slate-700 text-sm font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors"},[Ae(S(A.value)+" ",1),E[3]||(E[3]=p("span",{class:"material-symbols-outlined text-sm"},"arrow_forward",-1))],8,c_)]),b.value?(f(),w("div",u_,[p("a",{href:m(Fn)((B=h.value)==null?void 0:B.path),class:"md:col-span-8 group cursor-pointer block"},[p("div",h_,[p("img",{alt:(W=h.value)==null?void 0:W.title,class:"w-full h-full object-cover transition-transform duration-700 group-hover:scale-105",src:m(Kn)((F=h.value)==null?void 0:F.image,($=h.value)==null?void 0:$.path)},null,8,p_),E[4]||(E[4]=p("div",{class:"absolute inset-0 bg-gradient-to-t from-black/40 to-transparent"},null,-1))]),p("div",g_,[p("span",{class:Q(["text-xs font-bold uppercase tracking-widest px-2 py-0.5 rounded",T((M=h.value)==null?void 0:M.category)])},S(y((L=h.value)==null?void 0:L.category)),3),p("span",m_,S((z=h.value)==null?void 0:z.date),1)]),p("h3",f_,S((te=h.value)==null?void 0:te.title),1),p("p",v_,S((ee=h.value)==null?void 0:ee.description),1)],8,d_),p("div",b_,[(f(!0),w(Z,null,ie(_.value,K=>(f(),w("a",{key:K.title,href:m(Fn)(K.path),class:"group cursor-pointer block"},[p("div",__,[p("span",{class:Q(["text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 rounded",T(K.category)])},S(y(K.category)),3),p("span",w_,S(K.date),1)]),p("h4",k_,S(K.title),1),p("p",x_,S(K.description),1),p("div",A_,[Ae(S(m(t).readMoreLabel)+" ",1),E[5]||(E[5]=p("span",{class:"material-symbols-outlined text-sm"},"arrow_forward",-1))])],8,y_))),128))])])):(f(),w("div",C_,[(f(!0),w(Z,null,ie(_.value,K=>(f(),w("a",{key:K.title,href:m(Fn)(K.path),class:"bg-surface-container-lowest dark:bg-slate-900 border border-outline-variant/10 dark:border-slate-700 rounded-xl overflow-hidden block"},[p("img",{src:m(Kn)(K.image,K.path),alt:K.title,class:"w-full h-40 object-cover"},null,8,S_),p("div",I_,[p("div",P_,[p("span",{class:Q(["text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 rounded",T(K.category)])},S(y(K.category)),3),p("span",M_,S(K.date),1)]),p("h4",D_,S(K.title),1),p("p",L_,S(K.description),1)])],8,T_))),128))]))]),m(t).subscribeTitle?(f(),w("section",$_,[p("div",N_,[E[6]||(E[6]=p("div",{class:"absolute top-0 right-0 w-1/3 h-full mesh-grid opacity-10"},null,-1)),p("div",E_,[p("h2",O_,S(m(t).subscribeTitle),1),p("p",R_,S(m(t).subscribeDescription),1),p("form",z_,[p("input",{class:"bg-white/10 border border-white/20 rounded-lg px-6 py-3 flex-grow focus:outline-none focus:ring-2 focus:ring-on-primary/50 text-white placeholder-white/40",placeholder:m(t).subscribePlaceholder,type:"email"},null,8,q_),p("button",V_,S(m(t).subscribeButton),1)])])])])):q("",!0)]),j(Bt,{title:m(o).title||m(t).footerTitle,description:m(o).description||m(t).footerDescription,links:m(o).links||m(t).footerLinks||[],"social-icons":m(o).socialIcons||[]},null,8,["title","description","links","social-icons"])])}}}),F_={class:"bg-surface dark:bg-slate-900 text-slate-900 dark:text-slate-100 selection:bg-primary-container selection:text-on-primary-container"},j_={class:"pt-32 pb-24 px-6 lg:px-12 max-w-7xl mx-auto bg-surface dark:bg-slate-900"},U_={class:"mb-32 relative"},G_={class:"grid grid-cols-1 lg:grid-cols-12 gap-12 items-end"},H_={class:"lg:col-span-7"},W_={class:"overflow-hidden rounded-xl bg-surface-container-low group"},K_=["src"],Y_={class:"lg:col-span-5 pb-4"},X_={class:"flex items-center gap-4 mb-6"},Q_={class:"text-[0.6875rem] font-medium text-outline"},J_={class:"text-5xl lg:text-6xl font-extrabold tracking-tighter leading-[1.12] lg:leading-[1.05] mb-8 text-slate-900 dark:text-slate-100"},Z_={class:"text-slate-700 dark:text-slate-400 text-lg leading-relaxed mb-8 max-w-md"},ew={key:0,class:"flex flex-wrap gap-2 mb-8"},nw={class:"flex items-center justify-between border-t border-outline-variant/20 pt-6"},tw={class:"text-xs font-medium text-outline uppercase tracking-widest"},aw=["href"],ow={class:"flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8"},iw={class:"max-w-xl"},sw={class:"text-3xl font-bold tracking-tight mb-6"},rw={class:"text-slate-700 dark:text-slate-400"},lw={class:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-20 gap-x-12"},cw=["href"],uw={class:"aspect-[4/3] rounded-xl overflow-hidden bg-surface-container-low mb-8"},dw=["src"],hw={class:"flex items-center gap-4 mb-4"},pw={class:"text-[0.6875rem] font-medium text-outline uppercase tracking-widest"},gw={class:"text-xl font-bold leading-tight mb-4 tracking-tight text-slate-900 dark:text-slate-100 hover:text-tertiary transition-colors"},mw={class:"text-slate-700 dark:text-slate-400 text-sm leading-relaxed mb-4"},fw={key:0,class:"flex flex-wrap gap-2 mb-6"},vw={class:"mt-auto flex items-center justify-between text-[0.6875rem] font-bold uppercase tracking-widest text-outline"},bw={class:"mt-32 pt-12 border-t border-outline-variant/20 flex justify-center items-center gap-8"},yw=["disabled"],_w={class:"flex gap-4"},ww=["onClick"],kw=["disabled"],xw=U({__name:"BlogListLayout",setup(e){const{page:n}=Ft(),{headerConfig:t,footerConfig:a,uiConfig:o}=jt(),i=R(()=>o.value.common||{}),s=R(()=>o.value.blog||{}),r=R(()=>s.value.categoryMeta||{}),l=R(()=>String(s.value.readingTimeTemplate||"")),c=Object.assign({"/about-me.md":Xa,"/blogs/2022/202202-logseq-build-your-own-wiki.md":Qa,"/blogs/2022/202203-mesh-shaped-cloud-native-developer.md":Ja,"/blogs/2022/202203-mesh-shaped-recap.md":Za,"/blogs/2022/202205-container-k8s-docker.md":eo,"/blogs/2022/202205-router-proxy-gtw.md":no,"/blogs/2022/202211-cloud-native-engineering.md":to,"/blogs/2022/202212-api-design-inspired-by-google-api-design.md":ao,"/blogs/2022/202212-go-monorepo-tutorial.md":oo,"/blogs/2022/202212-logseq-customized-with-clojure-and-css.md":io,"/blogs/2022/202212-logseq-pkm.md":so,"/blogs/2023/202302-iac-and-terraform.md":ro,"/blogs/2023/202304-draw-architecture-diagram.md":lo,"/blogs/2023/202304-tunnel-vpn-vpc.md":co,"/blogs/2023/202306-remote-development-in-cloud.md":uo,"/blogs/2023/202312-agile-and-lean.md":ho,"/blogs/2023/202312-cobra-cli.md":po,"/blogs/2023/202312-devcontainer-tutorial.md":go,"/blogs/2023/202312-illustrated-ai.md":mo,"/blogs/2023/202312-kubernetes-operator.md":fo,"/blogs/2023/202312-windows-workspaces.md":vo,"/blogs/2024/202401-cloud-native-practices.md":bo,"/blogs/2024/202401-eassy-2024.md":yo,"/blogs/2024/202401-illustrations.md":_o,"/blogs/2024/202402-llm-application.md":wo,"/blogs/2024/202403-ai-and-human.md":ko,"/blogs/2024/202406-fork-oss.md":xo,"/blogs/2024/202406-k3s-blogs.md":Ao,"/blogs/2024/202412-ai-powered-pkm.md":Co,"/blogs/2026/202602-domain-spec-agents.md":To,"/blogs/2026/202602-pov-agentic-engineering.md":So,"/blogs/2026/202602-pov-standard-automation-selfserve.md":Io,"/blogs/index.md":Po,"/en/about-me.md":Mo,"/en/blogs/2022/202202-logseq-build-your-own-wiki.md":Do,"/en/blogs/2022/202203-mesh-shaped-cloud-native-developer.md":Lo,"/en/blogs/2022/202205-container-k8s-docker.md":$o,"/en/blogs/2022/202205-router-proxy-gtw.md":No,"/en/blogs/2022/202211-cloud-native-engineering.md":Eo,"/en/blogs/2022/202212-logseq-customized-with-clojure-and-css.md":Oo,"/en/blogs/2022/202212-logseq-pkm.md":Ro,"/en/blogs/2023/202302-iac-and-terraform.md":zo,"/en/blogs/2023/202304-draw-architecture-diagram.md":qo,"/en/blogs/2023/202304-tunnel-vpn-vpc.md":Vo,"/en/blogs/2023/202306-remote-development-in-cloud.md":Bo,"/en/blogs/2023/202312-agile-and-lean.md":Fo,"/en/blogs/2023/202312-devcontainer-tutorial.md":jo,"/en/blogs/2024/202401-cloud-native-practices.md":Uo,"/en/blogs/2024/202401-illustrations.md":Go,"/en/blogs/2024/202402-llm-application.md":Ho,"/en/blogs/2024/202403-ai-and-human.md":Wo,"/en/blogs/2024/202412-ai-powered-pkm.md":Ko,"/en/blogs/2026/202602-domain-spec-agents.md":Yo,"/en/blogs/2026/202602-pov-agentic-engineering.md":Xo,"/en/blogs/2026/202602-pov-standard-automation-selfserve.md":Qo,"/en/blogs/index.md":Jo,"/en/index.md":Zo,"/index.md":ei}),d=Br(c);function g($){var ee,K;const{modulePath:M,raw:L}=Fr($,c,d);if(!L)return console.warn(`[BlogListLayout] markdown not found for path: ${$}`),console.warn(`[BlogListLayout] attempted module key: ${M}`),null;const z=jr(L),te=pe($);return{path:te,category:z.category,tags:Array.isArray(z.tags)?z.tags.map(re=>String(re)):[],date:z.date,title:z.title||((K=(ee=te.split("/").pop())==null?void 0:ee.replace(/\.md$/,""))==null?void 0:K.replace(/[-_]/g," "))||String(i.value.untitled||"Untitled"),description:z.description||z.articleLead||Gr(L)||"",readingTime:Hr(L,{template:l.value}),action:z.action,image:z.image}}const u=R(()=>{const $=n.value.featured;if(!$)return null;if(typeof $=="string")return g($);if(typeof $=="object"&&typeof $.path=="string"){const M=g($.path);return M?{...M,...$,path:M.path}:null}return typeof $=="object"?$:null}),h=R(()=>{var te;const $=n.value.posts,M=pe(((te=u.value)==null?void 0:te.path)||"");if(Array.isArray($))return $.filter(ee=>pe(ee.path||"")!==M);if(!$||typeof $!="object")return[];const L=pe($.path||"blogs/**/*.md"),z=Wr(L);return Object.keys(c).map(ee=>pe(ee)).filter(ee=>z.test(ee)).filter(ee=>!ee.endsWith("/index.md")).sort((ee,K)=>{const re=Nt(K).localeCompare(Nt(ee));return re!==0?re:K.localeCompare(ee)}).map(ee=>g(ee)).filter(ee=>!!ee).filter(ee=>pe(ee.path||"")!==M)}),v=R(()=>{const $=n.value.posts;return!$||typeof $!="object"||Array.isArray($)?h.value.length||1:Math.max(1,Number($.perPage||$.count||9))}),b=R(()=>{const $=n.value.posts;return!$||typeof $!="object"||Array.isArray($)?Math.max(1,Number(n.value.paginationCurrent||1)):Math.max(1,Number($.page||n.value.paginationCurrent||1))}),_=ae(1);De(b,$=>{_.value=$},{immediate:!0});const x=R(()=>Math.max(1,Math.ceil(h.value.length/v.value))),A=R(()=>Math.min(Math.max(1,_.value),x.value)),D=R(()=>{const $=(A.value-1)*v.value,M=$+v.value;return h.value.slice($,M)}),y=R(()=>Array.from({length:x.value},($,M)=>String(M+1)));function T($){_.value=Math.min(Math.max(1,$),x.value)}function k(){T(A.value-1)}function E(){T(A.value+1)}function B($){return wi({category:String($||""),categoryMeta:r.value})}function W($){return ki({category:String($||""),categoryMeta:r.value})}function F($){const M=String($.category||"").trim();return(Array.isArray($.tags)?$.tags:[]).filter(z=>{const te=String(z||"").trim();return!!te&&te!==M})}return($,M)=>{var L,z,te,ee,K,re,de,ue,Ce,_e;return f(),w("div",F_,[j(Vt,{"site-title":m(t).siteTitle||m(n).siteTitle,"nav-links":m(t).navLinks||m(n).navLinks||[],"show-subscribe":!!m(t).showSubscribe,"subscribe-button-text":m(t).subscribeButtonText,"nav-height-class":"h-20"},null,8,["site-title","nav-links","show-subscribe","subscribe-button-text"]),p("main",j_,[p("section",U_,[p("div",G_,[p("div",H_,[p("div",W_,[p("img",{class:"w-full aspect-[16/9] object-cover transition-all duration-700 hover:scale-105",src:m(Kn)((L=u.value)==null?void 0:L.image,(z=u.value)==null?void 0:z.path)},null,8,K_)])]),p("div",Y_,[p("div",X_,[p("span",{class:Q(["text-[0.6875rem] font-bold uppercase tracking-[0.05em] px-2 py-1 rounded",W((te=u.value)==null?void 0:te.category)])},S(B((ee=u.value)==null?void 0:ee.category)),3),p("span",Q_,S((K=u.value)==null?void 0:K.date),1)]),p("h1",J_,S((re=u.value)==null?void 0:re.title),1),p("p",Z_,S((de=u.value)==null?void 0:de.description),1),u.value&&F(u.value).length?(f(),w("div",ew,[(f(!0),w(Z,null,ie(F(u.value),le=>(f(),w("span",{key:`featured-${u.value.path||u.value.title}-${le}`,class:"px-2 py-0.5 rounded bg-surface-container-high text-[0.6875rem] font-semibold text-on-surface-variant dark:text-slate-400"}," #"+S(le),1))),128))])):q("",!0),p("div",nw,[p("span",tw,S((ue=u.value)==null?void 0:ue.readingTime),1),p("a",{class:"text-tertiary font-bold text-sm flex items-center gap-2 group",href:m(Fn)((Ce=u.value)==null?void 0:Ce.path)},[Ae(S(((_e=u.value)==null?void 0:_e.action)||s.value.readArticle||"Read Article")+" ",1),M[0]||(M[0]=p("span",{class:"material-symbols-outlined text-sm group-hover:translate-x-1 transition-transform"},"arrow_forward",-1))],8,aw)])])])]),p("header",ow,[p("div",iw,[p("h2",sw,S(m(n).listTitle||s.value.latestArticles||"Latest Articles"),1),p("p",rw,S(m(n).listDescription||s.value.latestArticlesDescription||"Displayed in reverse chronological order."),1)])]),p("div",lw,[(f(!0),w(Z,null,ie(D.value,le=>(f(),w("article",{key:le.title,class:"flex flex-col"},[p("a",{href:m(Fn)(le.path),class:"group flex flex-col h-full"},[p("div",uw,[p("img",{class:"w-full h-full object-cover grayscale-[0.8] hover:grayscale-0 transition-all duration-500 scale-100 group-hover:scale-110",src:m(Kn)(le.image,le.path)},null,8,dw)]),p("div",hw,[p("span",{class:Q(["text-[0.6875rem] font-bold uppercase tracking-[0.05em] px-2 py-0.5 rounded",W(le.category)])},S(B(le.category)),3),M[1]||(M[1]=p("span",{class:"w-1 h-1 bg-outline-variant rounded-full"},null,-1)),p("span",pw,S(le.date),1)]),p("h3",gw,S(le.title),1),p("p",mw,S(le.description),1),F(le).length?(f(),w("div",fw,[(f(!0),w(Z,null,ie(F(le),Le=>(f(),w("span",{key:`${le.path||le.title}-${Le}`,class:"px-2 py-0.5 rounded bg-surface-container-high text-[0.6875rem] font-semibold text-on-surface-variant dark:text-slate-400"}," #"+S(Le),1))),128))])):q("",!0),p("div",vw,[p("span",null,S(le.readingTime),1),M[2]||(M[2]=p("span",{class:"material-symbols-outlined text-sm"},"north_east",-1))])],8,cw)]))),128))]),p("div",bw,[p("button",{type:"button",disabled:A.value<=1,class:"text-xs font-bold uppercase tracking-widest text-outline hover:text-on-surface transition-colors flex items-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed",onClick:k},[M[3]||(M[3]=p("span",{class:"material-symbols-outlined text-sm"},"arrow_back",-1)),Ae(" "+S(m(n).paginationPrevious||s.value.paginationPrevious||"Previous"),1)],8,yw),p("div",_w,[(f(!0),w(Z,null,ie(y.value,le=>(f(),w("button",{key:le,type:"button",class:Q(le===String(A.value)?"w-8 h-8 flex items-center justify-center rounded-full bg-primary text-on-primary text-xs font-bold":"w-8 h-8 flex items-center justify-center rounded-full hover:bg-surface-container-high text-xs font-bold cursor-pointer"),onClick:Le=>T(Number(le))},S(le),11,ww))),128))]),p("button",{type:"button",disabled:A.value>=x.value,class:"text-xs font-bold uppercase tracking-widest text-on-surface hover:text-tertiary transition-colors flex items-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed",onClick:E},[Ae(S(m(n).paginationNext||s.value.paginationNext||"Next")+" ",1),M[4]||(M[4]=p("span",{class:"material-symbols-outlined text-sm"},"arrow_forward",-1))],8,kw)])]),j(Bt,{title:m(a).title||m(n).footerTitle,description:m(a).description||m(n).footerDescription,links:m(a).links||m(n).footerLinks||[],"social-icons":m(a).socialIcons||m(n).socialIcons||[]},null,8,["title","description","links","social-icons"])])}}}),Aw={class:"bg-surface dark:bg-slate-900 text-on-surface dark:text-slate-100"},Cw={class:"pt-16 pb-20 bg-surface dark:bg-slate-900"},Tw={class:"relative overflow-hidden bg-surface-container-low dark:bg-slate-950 mb-14"},Sw={class:"max-w-6xl mx-auto px-6 lg:px-10 py-14 lg:py-16 relative z-10"},Iw={class:"grid grid-cols-1 lg:grid-cols-12 gap-10 items-center"},Pw={class:"lg:col-span-7 flex flex-col justify-center gap-5"},Mw={class:"text-4xl lg:text-5xl font-black tracking-tight leading-tight"},Dw={class:"text-base lg:text-lg text-on-surface-variant dark:text-slate-400 leading-relaxed"},Lw={class:"flex flex-wrap items-center gap-4 text-sm text-on-surface-variant dark:text-slate-400"},$w={key:0,class:"flex flex-wrap gap-2 pt-1"},Nw={class:"lg:col-span-5 hidden lg:flex justify-center"},Ew={class:"relative w-full max-w-md aspect-square rounded-full bg-surface-container-lowest/90 border border-outline-variant/20 shadow-[0px_24px_48px_rgba(42,52,57,0.08)] p-7"},Ow=["src","alt"],Rw={class:"max-w-6xl mx-auto px-6 lg:px-10"},zw={class:"grid grid-cols-1 lg:grid-cols-12 gap-10"},qw={key:0,class:"lg:col-span-3 order-2 lg:order-1"},Vw={class:"lg:sticky lg:top-28 pl-1"},Bw={class:"text-s font-bold uppercase tracking-widest text-on-surface-variant dark:text-slate-400 mb-4 -ml-1"},Fw={class:"flex flex-col gap-2 pt-1 pb-4 border-b border-outline-variant/30 dark:border-slate-600"},jw=["href"],Uw={class:"lg:col-span-9 order-1 lg:order-2 vp-doc max-w-none dark:text-slate-300"},Gw=U({__name:"BlogLayout",setup(e){const{page:n}=gn(),{page:t}=Ft(),{headerConfig:a,footerConfig:o,uiConfig:i}=jt(),s=R(()=>i.value.blog||{}),r=R(()=>s.value.categoryMeta||{}),l=Object.assign({"/about-me.md":Xa,"/blogs/2022/202202-logseq-build-your-own-wiki.md":Qa,"/blogs/2022/202203-mesh-shaped-cloud-native-developer.md":Ja,"/blogs/2022/202203-mesh-shaped-recap.md":Za,"/blogs/2022/202205-container-k8s-docker.md":eo,"/blogs/2022/202205-router-proxy-gtw.md":no,"/blogs/2022/202211-cloud-native-engineering.md":to,"/blogs/2022/202212-api-design-inspired-by-google-api-design.md":ao,"/blogs/2022/202212-go-monorepo-tutorial.md":oo,"/blogs/2022/202212-logseq-customized-with-clojure-and-css.md":io,"/blogs/2022/202212-logseq-pkm.md":so,"/blogs/2023/202302-iac-and-terraform.md":ro,"/blogs/2023/202304-draw-architecture-diagram.md":lo,"/blogs/2023/202304-tunnel-vpn-vpc.md":co,"/blogs/2023/202306-remote-development-in-cloud.md":uo,"/blogs/2023/202312-agile-and-lean.md":ho,"/blogs/2023/202312-cobra-cli.md":po,"/blogs/2023/202312-devcontainer-tutorial.md":go,"/blogs/2023/202312-illustrated-ai.md":mo,"/blogs/2023/202312-kubernetes-operator.md":fo,"/blogs/2023/202312-windows-workspaces.md":vo,"/blogs/2024/202401-cloud-native-practices.md":bo,"/blogs/2024/202401-eassy-2024.md":yo,"/blogs/2024/202401-illustrations.md":_o,"/blogs/2024/202402-llm-application.md":wo,"/blogs/2024/202403-ai-and-human.md":ko,"/blogs/2024/202406-fork-oss.md":xo,"/blogs/2024/202406-k3s-blogs.md":Ao,"/blogs/2024/202412-ai-powered-pkm.md":Co,"/blogs/2026/202602-domain-spec-agents.md":To,"/blogs/2026/202602-pov-agentic-engineering.md":So,"/blogs/2026/202602-pov-standard-automation-selfserve.md":Io,"/blogs/index.md":Po,"/en/about-me.md":Mo,"/en/blogs/2022/202202-logseq-build-your-own-wiki.md":Do,"/en/blogs/2022/202203-mesh-shaped-cloud-native-developer.md":Lo,"/en/blogs/2022/202205-container-k8s-docker.md":$o,"/en/blogs/2022/202205-router-proxy-gtw.md":No,"/en/blogs/2022/202211-cloud-native-engineering.md":Eo,"/en/blogs/2022/202212-logseq-customized-with-clojure-and-css.md":Oo,"/en/blogs/2022/202212-logseq-pkm.md":Ro,"/en/blogs/2023/202302-iac-and-terraform.md":zo,"/en/blogs/2023/202304-draw-architecture-diagram.md":qo,"/en/blogs/2023/202304-tunnel-vpn-vpc.md":Vo,"/en/blogs/2023/202306-remote-development-in-cloud.md":Bo,"/en/blogs/2023/202312-agile-and-lean.md":Fo,"/en/blogs/2023/202312-devcontainer-tutorial.md":jo,"/en/blogs/2024/202401-cloud-native-practices.md":Uo,"/en/blogs/2024/202401-illustrations.md":Go,"/en/blogs/2024/202402-llm-application.md":Ho,"/en/blogs/2024/202403-ai-and-human.md":Wo,"/en/blogs/2024/202412-ai-powered-pkm.md":Ko,"/en/blogs/2026/202602-domain-spec-agents.md":Yo,"/en/blogs/2026/202602-pov-agentic-engineering.md":Xo,"/en/blogs/2026/202602-pov-standard-automation-selfserve.md":Qo,"/en/blogs/index.md":Jo,"/en/index.md":Zo,"/index.md":ei});function c(D){return`/${pe(D)}`}const d=R(()=>{const D=String(n.value.relativePath||""),y=c(D);return l[y]||""}),g=R(()=>Hr(d.value,{template:String(s.value.readingTimeTemplate||"")})),u=ae([]),h=ae("");function v(){if(typeof window>"u"||u.value.length===0){h.value="";return}const D=window.scrollY+180;let y=u.value[0].href;for(const T of u.value){const k=T.href.slice(1),E=document.getElementById(k);E&&E.offsetTop<=D&&(y=T.href)}h.value=y}function b(){if(typeof window>"u")return;const D=Array.from(document.querySelectorAll(".vp-doc h2[id]"));u.value=D.map(y=>{var T;return{text:((T=y.textContent)==null?void 0:T.trim())||"",href:`#${y.id}`}}).filter(y=>!!y.text),v()}async function _(){await Ba(),requestAnimationFrame(()=>{b()})}Ee(()=>{typeof window>"u"||(window.addEventListener("scroll",v,{passive:!0}),_())}),Fa(()=>{typeof window>"u"||window.removeEventListener("scroll",v)}),De(()=>n.value.relativePath,()=>{_()}),De(d,()=>{_()});const x=R(()=>wi({category:String(t.value.category||""),categoryMeta:r.value})),A=R(()=>ki({category:String(t.value.category||""),categoryMeta:r.value}));return(D,y)=>{const T=tn("Content");return f(),w("div",Aw,[j(Vt,{"site-title":m(a).siteTitle,"nav-links":m(a).navLinks||[],"show-subscribe":!!m(a).showSubscribe,"subscribe-button-text":m(a).subscribeButtonText,"nav-height-class":"h-20"},null,8,["site-title","nav-links","show-subscribe","subscribe-button-text"]),p("main",Cw,[p("header",Tw,[y[3]||(y[3]=p("div",{class:"absolute inset-0 mesh-gradient opacity-60"},null,-1)),y[4]||(y[4]=p("div",{class:"absolute inset-0 bg-gradient-to-br from-primary/10 to-transparent"},null,-1)),p("div",Sw,[p("div",Iw,[p("div",Pw,[p("span",{class:Q(["inline-flex w-fit px-3 py-1 rounded-full text-xs font-bold uppercase tracking-widest",A.value])},S(x.value),3),p("h1",Mw,S(m(t).title),1),p("p",Dw,S(m(t).description),1),p("div",Lw,[p("span",null,S(m(t).date),1),y[0]||(y[0]=p("span",{class:"w-1 h-1 rounded-full bg-outline"},null,-1)),p("span",null,S(g.value),1)]),(m(t).tags||[]).length?(f(),w("div",$w,[(f(!0),w(Z,null,ie(m(t).tags||[],k=>(f(),w("span",{key:k,class:"px-2.5 py-1 rounded bg-surface-container-high dark:bg-slate-700 text-xs font-semibold text-on-surface-variant dark:text-slate-400"}," #"+S(k),1))),128))])):q("",!0)]),p("div",Nw,[p("div",Ew,[y[1]||(y[1]=p("div",{class:"absolute inset-4 rounded-full border-2 border-dashed border-primary/30 animate-[spin_20s_linear_infinite]"},null,-1)),y[2]||(y[2]=p("div",{class:"absolute inset-10 rounded-full border border-primary/20"},null,-1)),p("img",{src:m(Kn)(m(t).image,m(n).relativePath),alt:m(t).title,class:"relative z-10 w-full h-full object-cover rounded-full"},null,8,Ow)])])])])]),p("section",Rw,[p("div",zw,[u.value.length?(f(),w("aside",qw,[p("div",Vw,[p("h3",Bw,S(s.value.tocTitle||"Contents"),1),p("nav",Fw,[(f(!0),w(Z,null,ie(u.value,k=>(f(),w("a",{key:k.href,href:k.href,class:Q(k.href===h.value?"relative text-sm font-semibold text-primary pl-6 before:content-[''] before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-[2px] before:h-4 before:bg-primary before:rounded dark:text-tertiary":"text-sm font-thin text-on-surface dark:text-slate-300 hover:text-primary pl-6")},S(k.text),11,jw))),128))])])])):q("",!0),p("article",Uw,[j(T)])])])]),j(Bt,{title:m(o).title,description:m(o).description,links:m(o).links||[],"social-icons":m(o).socialIcons||[]},null,8,["title","description","links","social-icons"])])}}}),Hw=U({__name:"Layout",setup(e){const{frontmatter:n,page:t}=gn(),a=R(()=>{const o=String(n.value.layout||"");if(o)return o;const i=String(t.value.relativePath||"");return i.startsWith("blogs/")||i.startsWith("en/blogs/")?"blog":""});return(o,i)=>a.value==="home"?(f(),G(ug,{key:0})):a.value==="about-me"?(f(),G(B_,{key:1})):a.value==="blog-list"?(f(),G(xw,{key:2})):a.value==="blog"?(f(),G(Gw,{key:3})):(f(),G(m($s).Layout,{key:4}))}});let Rn=null;function Ww(){let e=!1;return async()=>{if(typeof window>"u")return;const{default:n}=await xs(async()=>{const{default:o}=await import("./mermaid.core.DNjtvN0m.js").then(i=>i.bd);return{default:o}},__vite__mapDeps([2,1]));e||(n.initialize({startOnLoad:!1,securityLevel:"loose"}),e=!0);const t=document.querySelectorAll(".vp-doc div.language-mermaid pre code");for(const o of t){const i=o.closest("pre"),s=o.closest("div.language-mermaid");if(!i||!s||i.dataset.mermaidRendered==="true")continue;i.classList.remove("shiki","shiki-themes","vp-code"),i.classList.add("mermaid"),i.textContent=o.textContent||"",i.dataset.mermaidRendered="true";const r=s.querySelector("button.copy"),l=s.querySelector("span.lang");r==null||r.remove(),l==null||l.remove(),s.classList.remove("language-mermaid")}const a=Array.from(document.querySelectorAll(".vp-doc pre.mermaid"));a.length>0&&await n.run({nodes:a})}}const Ck={extends:$s,Layout:Hw,enhanceApp({router:e}){if(typeof window>"u")return;Rn=Rn||Ww();const n=()=>{requestAnimationFrame(()=>{Rn==null||Rn()})};n(),e.onAfterRouteChanged=n}};export{ck as $,Jn as A,gi as B,pi as C,wn as D,St as E,Qw as F,ne as G,kd as H,tk as I,xk as J,Ak as K,kk as L,wk as M,_k as N,yk as O,bk as P,m2 as Q,mk as R,vk as S,fk as T,hk as U,gk as V,pk as W,dk as X,rk as Y,sk as Z,uk as _,ik as a,Db as b,ok as c,ak as d,lk as e,gr as f,ek as g,fr as h,nk as i,Yw as j,Zw as k,Vb as l,Xw as m,Jw as n,vr as o,Cr as p,fi as q,Qt as r,ln as s,Ck as t,Kb as u,Wb as v,Pn as w,Hb as x,Gb as y,It as z};
