const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.oz40lzVT.js","assets/chunks/framework.CdjpmwdR.js","assets/chunks/mermaid.core.CjHOZjBY.js"])))=>i.map(i=>d[i]);
import{d as U,c as _,r as C,n as Q,o as f,a as Ae,t as S,b as G,w as N,T as Oa,e as q,_ as X,u as gn,i as tl,f as al,g as Ra,h as R,j as p,k as m,l as un,m as fa,p as ae,q as Me,s as Et,v as Ee,x as za,y as qa,z as ol,A as il,F as Z,B as ie,C as tn,D as Ot,E as j,G as Ss,H as ze,I as Is,J as mn,K as en,L as Rt,M as sl,N as Ba,O as va,P as Va,Q as Ds,R as zt,S as rl,U as ll,V as Ps,W as Ms,X as Ls,Y as cl,Z as ul,$ as Fa,a0 as dl,a1 as hl,a2 as pl}from"./framework.CdjpmwdR.js";const gl=U({__name:"VPBadge",props:{text:{},type:{default:"tip"}},setup(e){return(n,t)=>(f(),_("span",{class:Q(["VPBadge",e.type])},[C(n.$slots,"default",{},()=>[Ae(S(e.text),1)])],2))}}),ml={key:0,class:"VPBackdrop"},fl=U({__name:"VPBackdrop",props:{show:{type:Boolean}},setup(e){return(n,t)=>(f(),G(Oa,{name:"fade"},{default:N(()=>[e.show?(f(),_("div",ml)):q("",!0)]),_:1}))}}),vl=X(fl,[["__scopeId","data-v-49e9b6df"]]),ne=gn;function bl(e,n){let t,a=!1;return()=>{t&&clearTimeout(t),a?t=setTimeout(e,n):(e(),(a=!0)&&setTimeout(()=>a=!1,n))}}function ba(e){return e.startsWith("/")?e:`/${e}`}function ja(e){const{pathname:n,search:t,hash:a,protocol:o}=new URL(e,"http://a.com");if(tl(e)||e.startsWith("#")||!o.startsWith("http")||!al(n))return e;const{site:i}=ne(),s=n.endsWith("/")||n.endsWith(".html")?e:e.replace(/(?:(^\.+)\/)?.*$/,`$1${n.replace(/(\.md)?$/,i.value.cleanUrls?"":".html")}${t}${a}`);return Ra(s)}function Yn({correspondingLink:e=!1}={}){const{site:n,localeIndex:t,page:a,theme:o,hash:i}=ne(),s=R(()=>{var l,c;return{label:(l=n.value.locales[t.value])==null?void 0:l.label,link:((c=n.value.locales[t.value])==null?void 0:c.link)||(t.value==="root"?"/":`/${t.value}/`)}});return{localeLinks:R(()=>Object.entries(n.value.locales).flatMap(([l,c])=>s.value.label===c.label?[]:{text:c.label,link:yl(c.link||(l==="root"?"/":`/${l}/`),o.value.i18nRouting!==!1&&e,a.value.relativePath.slice(s.value.link.length-1),!n.value.cleanUrls)+i.value})),currentLang:s}}function yl(e,n,t,a){return n?e.replace(/\/$/,"")+ba(t.replace(/(^|\/)index\.md$/,"$1").replace(/\.md$/,a?".html":"")):e}const wl={class:"NotFound"},_l={class:"code"},kl={class:"title"},xl={class:"quote"},Al={class:"action"},Cl=["href","aria-label"],Tl=U({__name:"NotFound",setup(e){const{theme:n}=ne(),{currentLang:t}=Yn();return(a,o)=>{var i,s,r,l,c;return f(),_("div",wl,[p("p",_l,S(((i=m(n).notFound)==null?void 0:i.code)??"404"),1),p("h1",kl,S(((s=m(n).notFound)==null?void 0:s.title)??"PAGE NOT FOUND"),1),o[0]||(o[0]=p("div",{class:"divider"},null,-1)),p("blockquote",xl,S(((r=m(n).notFound)==null?void 0:r.quote)??"But if you don't change your direction, and if you keep looking, you may end up where you are heading."),1),p("div",Al,[p("a",{class:"link",href:m(Ra)(m(t).link),"aria-label":((l=m(n).notFound)==null?void 0:l.linkLabel)??"go to home"},S(((c=m(n).notFound)==null?void 0:c.linkText)??"Take me home"),9,Cl)])])}}}),Sl=X(Tl,[["__scopeId","data-v-e6e96a08"]]);function $s(e,n){if(Array.isArray(e))return st(e);if(e==null)return[];n=ba(n);const t=Object.keys(e).sort((o,i)=>i.split("/").length-o.split("/").length).find(o=>n.startsWith(ba(o))),a=t?e[t]:[];return Array.isArray(a)?st(a):st(a.items,a.base)}function Il(e){const n=[];let t=0;for(const a in e){const o=e[a];if(o.items){t=n.push(o);continue}n[t]||n.push({items:[]}),n[t].items.push(o)}return n}function Dl(e){const n=[];function t(a){for(const o of a)o.text&&o.link&&n.push({text:o.text,link:o.link,docFooterText:o.docFooterText}),o.items&&t(o.items)}return t(e),n}function ya(e,n){return Array.isArray(n)?n.some(t=>ya(e,t)):un(e,n.link)?!0:n.items?ya(e,n.items):!1}function st(e,n){return[...e].map(t=>{const a={...t},o=a.base||n;return o&&a.link&&(a.link=o+a.link),a.items&&(a.items=st(a.items,o)),a})}function Qe(){const{frontmatter:e,page:n,theme:t}=ne(),a=fa("(min-width: 960px)"),o=ae(!1),i=R(()=>{const b=t.value.sidebar,w=n.value.relativePath;return b?$s(b,w):[]}),s=ae(i.value);Me(i,(b,w)=>{JSON.stringify(b)!==JSON.stringify(w)&&(s.value=i.value)});const r=R(()=>e.value.sidebar!==!1&&s.value.length>0&&e.value.layout!=="home"),l=R(()=>c?e.value.aside==null?t.value.aside==="left":e.value.aside==="left":!1),c=R(()=>e.value.layout==="home"?!1:e.value.aside!=null?!!e.value.aside:t.value.aside!==!1),d=R(()=>r.value&&a.value),g=R(()=>r.value?Il(s.value):[]);function u(){o.value=!0}function h(){o.value=!1}function v(){o.value?h():u()}return{isOpen:o,sidebar:s,sidebarGroups:g,hasSidebar:r,hasAside:c,leftAside:l,isSidebarEnabled:d,open:u,close:h,toggle:v}}function Pl(e,n){let t;Et(()=>{t=e.value?document.activeElement:void 0}),Ee(()=>{window.addEventListener("keyup",a)}),za(()=>{window.removeEventListener("keyup",a)});function a(o){o.key==="Escape"&&e.value&&(n(),t==null||t.focus())}}function Ml(e){const{page:n,hash:t}=ne(),a=ae(!1),o=R(()=>e.value.collapsed!=null),i=R(()=>!!e.value.link),s=ae(!1),r=()=>{s.value=un(n.value.relativePath,e.value.link)};Me([n,e,t],r),Ee(r);const l=R(()=>s.value?!0:e.value.items?ya(n.value.relativePath,e.value.items):!1),c=R(()=>!!(e.value.items&&e.value.items.length));Et(()=>{a.value=!!(o.value&&e.value.collapsed)}),qa(()=>{(s.value||l.value)&&(a.value=!1)});function d(){o.value&&(a.value=!a.value)}return{collapsed:a,collapsible:o,isLink:i,isActiveLink:s,hasActiveLink:l,hasChildren:c,toggle:d}}function Ll(){const{hasSidebar:e}=Qe(),n=fa("(min-width: 960px)"),t=fa("(min-width: 1280px)");return{isAsideEnabled:R(()=>!t.value&&!n.value?!1:e.value?t.value:n.value)}}const $l=/\b(?:VPBadge|header-anchor|footnote-ref|ignore-header)\b/,wa=[];function Ns(e){return typeof e.outline=="object"&&!Array.isArray(e.outline)&&e.outline.label||e.outlineTitle||"On this page"}function Ua(e){const n=[...document.querySelectorAll(".VPDoc :where(h1,h2,h3,h4,h5,h6)")].filter(t=>t.id&&t.hasChildNodes()).map(t=>{const a=Number(t.tagName[1]);return{element:t,title:Nl(t),link:"#"+t.id,level:a}});return El(n,e)}function Nl(e){let n="";for(const t of e.childNodes)if(t.nodeType===1){if($l.test(t.className))continue;n+=t.textContent}else t.nodeType===3&&(n+=t.textContent);return n.trim()}function El(e,n){if(n===!1)return[];const t=(typeof n=="object"&&!Array.isArray(n)?n.level:n)||2,[a,o]=typeof t=="number"?[t,t]:t==="deep"?[2,6]:t;return zl(e,a,o)}function Ol(e,n){const{isAsideEnabled:t}=Ll(),a=bl(i,100);let o=null;Ee(()=>{requestAnimationFrame(i),window.addEventListener("scroll",a)}),ol(()=>{s(location.hash)}),za(()=>{window.removeEventListener("scroll",a)});function i(){if(!t.value)return;const r=window.scrollY,l=window.innerHeight,c=document.body.offsetHeight,d=Math.abs(r+l-c)<1,g=wa.map(({element:h,link:v})=>({link:v,top:Rl(h)})).filter(({top:h})=>!Number.isNaN(h)).sort((h,v)=>h.top-v.top);if(!g.length){s(null);return}if(r<1){s(null);return}if(d){s(g[g.length-1].link);return}let u=null;for(const{link:h,top:v}of g){if(v>r+il()+4)break;u=h}s(u)}function s(r){o&&o.classList.remove("active"),r==null?o=null:o=e.value.querySelector(`a[href="${decodeURIComponent(r)}"]`);const l=o;l?(l.classList.add("active"),n.value.style.top=l.offsetTop+39+"px",n.value.style.opacity="1"):(n.value.style.top="33px",n.value.style.opacity="0")}}function Rl(e){let n=0;for(;e!==document.body;){if(e===null)return NaN;n+=e.offsetTop,e=e.offsetParent}return n}function zl(e,n,t){wa.length=0;const a=[],o=[];return e.forEach(i=>{const s={...i,children:[]};let r=o[o.length-1];for(;r&&r.level>=s.level;)o.pop(),r=o[o.length-1];if(s.element.classList.contains("ignore-header")||r&&"shouldIgnore"in r){o.push({level:s.level,shouldIgnore:!0});return}s.level>t||s.level<n||(wa.push({element:s.element,link:s.link}),r?r.children.push(s):a.push(s),o.push(s))}),a}const ql=["href","title"],Bl=U({__name:"VPDocOutlineItem",props:{headers:{},root:{type:Boolean}},setup(e){function n({target:t}){const a=t.href.split("#")[1],o=document.getElementById(decodeURIComponent(a));o==null||o.focus({preventScroll:!0})}return(t,a)=>{const o=tn("VPDocOutlineItem",!0);return f(),_("ul",{class:Q(["VPDocOutlineItem",e.root?"root":"nested"])},[(f(!0),_(Z,null,ie(e.headers,({children:i,link:s,title:r})=>(f(),_("li",null,[p("a",{class:"outline-link",href:s,onClick:n,title:r},S(r),9,ql),i!=null&&i.length?(f(),G(o,{key:0,headers:i},null,8,["headers"])):q("",!0)]))),256))],2)}}}),Es=X(Bl,[["__scopeId","data-v-4034b050"]]),Vl={class:"content"},Fl={"aria-level":"2",class:"outline-title",id:"doc-outline-aria-label",role:"heading"},jl=U({__name:"VPDocAsideOutline",setup(e){const{frontmatter:n,theme:t}=ne(),a=Ss([]);Ot(()=>{a.value=Ua(n.value.outline??t.value.outline)});const o=ae(),i=ae();return Ol(o,i),(s,r)=>(f(),_("nav",{"aria-labelledby":"doc-outline-aria-label",class:Q(["VPDocAsideOutline",{"has-outline":a.value.length>0}]),ref_key:"container",ref:o},[p("div",Vl,[p("div",{class:"outline-marker",ref_key:"marker",ref:i},null,512),p("div",Fl,S(m(Ns)(m(t))),1),j(Es,{headers:a.value,root:!0},null,8,["headers"])])],2))}}),Ul=X(jl,[["__scopeId","data-v-cc53f104"]]),Gl={class:"VPDocAsideCarbonAds"},Hl=U({__name:"VPDocAsideCarbonAds",props:{carbonAds:{}},setup(e){const n=()=>null;return(t,a)=>(f(),_("div",Gl,[j(m(n),{"carbon-ads":e.carbonAds},null,8,["carbon-ads"])]))}}),Wl={class:"VPDocAside"},Kl=U({__name:"VPDocAside",setup(e){const{theme:n}=ne();return(t,a)=>(f(),_("div",Wl,[C(t.$slots,"aside-top",{},void 0,!0),C(t.$slots,"aside-outline-before",{},void 0,!0),j(Ul),C(t.$slots,"aside-outline-after",{},void 0,!0),a[0]||(a[0]=p("div",{class:"spacer"},null,-1)),C(t.$slots,"aside-ads-before",{},void 0,!0),m(n).carbonAds?(f(),G(Hl,{key:0,"carbon-ads":m(n).carbonAds},null,8,["carbon-ads"])):q("",!0),C(t.$slots,"aside-ads-after",{},void 0,!0),C(t.$slots,"aside-bottom",{},void 0,!0)]))}}),Yl=X(Kl,[["__scopeId","data-v-9516880d"]]);function Xl(){const{theme:e,page:n}=ne();return R(()=>{const{text:t="Edit this page",pattern:a=""}=e.value.editLink||{};let o;return typeof a=="function"?o=a(n.value):o=a.replace(/:path/g,n.value.filePath),{url:o,text:t}})}function Ql(){const{page:e,theme:n,frontmatter:t}=ne();return R(()=>{var c,d,g,u,h,v,b,w;const a=$s(n.value.sidebar,e.value.relativePath),o=Dl(a),i=Jl(o,x=>x.link.replace(/[?#].*$/,"")),s=i.findIndex(x=>un(e.value.relativePath,x.link)),r=((c=n.value.docFooter)==null?void 0:c.prev)===!1&&!t.value.prev||t.value.prev===!1,l=((d=n.value.docFooter)==null?void 0:d.next)===!1&&!t.value.next||t.value.next===!1;return{prev:r?void 0:{text:(typeof t.value.prev=="string"?t.value.prev:typeof t.value.prev=="object"?t.value.prev.text:void 0)??((g=i[s-1])==null?void 0:g.docFooterText)??((u=i[s-1])==null?void 0:u.text),link:(typeof t.value.prev=="object"?t.value.prev.link:void 0)??((h=i[s-1])==null?void 0:h.link)},next:l?void 0:{text:(typeof t.value.next=="string"?t.value.next:typeof t.value.next=="object"?t.value.next.text:void 0)??((v=i[s+1])==null?void 0:v.docFooterText)??((b=i[s+1])==null?void 0:b.text),link:(typeof t.value.next=="object"?t.value.next.link:void 0)??((w=i[s+1])==null?void 0:w.link)}}})}function Jl(e,n){const t=new Set;return e.filter(a=>{const o=n(a);return t.has(o)?!1:t.add(o)})}const qe=U({__name:"VPLink",props:{tag:{},href:{},noIcon:{type:Boolean},target:{},rel:{}},setup(e){const n=e,t=R(()=>n.tag??(n.href?"a":"span")),a=R(()=>n.href&&Is.test(n.href)||n.target==="_blank");return(o,i)=>(f(),G(ze(t.value),{class:Q(["VPLink",{link:e.href,"vp-external-link-icon":a.value,"no-icon":e.noIcon}]),href:e.href?m(ja)(e.href):void 0,target:e.target??(a.value?"_blank":void 0),rel:e.rel??(a.value?"noreferrer":void 0)},{default:N(()=>[C(o.$slots,"default")]),_:3},8,["class","href","target","rel"]))}}),Zl={class:"VPLastUpdated"},ec=["datetime"],nc=U({__name:"VPDocFooterLastUpdated",setup(e){const{theme:n,page:t,lang:a}=ne(),o=R(()=>new Date(t.value.lastUpdated)),i=R(()=>o.value.toISOString()),s=ae("");return Ee(()=>{Et(()=>{var r,l,c;s.value=new Intl.DateTimeFormat((l=(r=n.value.lastUpdated)==null?void 0:r.formatOptions)!=null&&l.forceLocale?a.value:void 0,((c=n.value.lastUpdated)==null?void 0:c.formatOptions)??{dateStyle:"short",timeStyle:"short"}).format(o.value)})}),(r,l)=>{var c;return f(),_("p",Zl,[Ae(S(((c=m(n).lastUpdated)==null?void 0:c.text)||m(n).lastUpdatedText||"Last updated")+": ",1),p("time",{datetime:i.value},S(s.value),9,ec)])}}}),tc=X(nc,[["__scopeId","data-v-3607c463"]]),ac={key:0,class:"VPDocFooter"},oc={key:0,class:"edit-info"},ic={key:0,class:"edit-link"},sc={key:1,class:"last-updated"},rc={key:1,class:"prev-next","aria-labelledby":"doc-footer-aria-label"},lc={class:"pager"},cc=["innerHTML"],uc=["innerHTML"],dc={class:"pager"},hc=["innerHTML"],pc=["innerHTML"],gc=U({__name:"VPDocFooter",setup(e){const{theme:n,page:t,frontmatter:a}=ne(),o=Xl(),i=Ql(),s=R(()=>n.value.editLink&&a.value.editLink!==!1),r=R(()=>t.value.lastUpdated),l=R(()=>s.value||r.value||i.value.prev||i.value.next);return(c,d)=>{var g,u,h,v;return l.value?(f(),_("footer",ac,[C(c.$slots,"doc-footer-before",{},void 0,!0),s.value||r.value?(f(),_("div",oc,[s.value?(f(),_("div",ic,[j(qe,{class:"edit-link-button",href:m(o).url,"no-icon":!0},{default:N(()=>[d[0]||(d[0]=p("span",{class:"vpi-square-pen edit-link-icon"},null,-1)),Ae(" "+S(m(o).text),1)]),_:1},8,["href"])])):q("",!0),r.value?(f(),_("div",sc,[j(tc)])):q("",!0)])):q("",!0),(g=m(i).prev)!=null&&g.link||(u=m(i).next)!=null&&u.link?(f(),_("nav",rc,[d[1]||(d[1]=p("span",{class:"visually-hidden",id:"doc-footer-aria-label"},"Pager",-1)),p("div",lc,[(h=m(i).prev)!=null&&h.link?(f(),G(qe,{key:0,class:"pager-link prev",href:m(i).prev.link},{default:N(()=>{var b;return[p("span",{class:"desc",innerHTML:((b=m(n).docFooter)==null?void 0:b.prev)||"Previous page"},null,8,cc),p("span",{class:"title",innerHTML:m(i).prev.text},null,8,uc)]}),_:1},8,["href"])):q("",!0)]),p("div",dc,[(v=m(i).next)!=null&&v.link?(f(),G(qe,{key:0,class:"pager-link next",href:m(i).next.link},{default:N(()=>{var b;return[p("span",{class:"desc",innerHTML:((b=m(n).docFooter)==null?void 0:b.next)||"Next page"},null,8,hc),p("span",{class:"title",innerHTML:m(i).next.text},null,8,pc)]}),_:1},8,["href"])):q("",!0)])])):q("",!0)])):q("",!0)}}}),mc=X(gc,[["__scopeId","data-v-cd0721dd"]]),fc={class:"container"},vc={class:"aside-container"},bc={class:"aside-content"},yc={class:"content"},wc={class:"content-container"},_c={class:"main"},kc=U({__name:"VPDoc",setup(e){const{theme:n}=ne(),t=mn(),{hasSidebar:a,hasAside:o,leftAside:i}=Qe(),s=R(()=>t.path.replace(/[./]+/g,"_").replace(/_html$/,""));return(r,l)=>{const c=tn("Content");return f(),_("div",{class:Q(["VPDoc",{"has-sidebar":m(a),"has-aside":m(o)}])},[C(r.$slots,"doc-top",{},void 0,!0),p("div",fc,[m(o)?(f(),_("div",{key:0,class:Q(["aside",{"left-aside":m(i)}])},[l[0]||(l[0]=p("div",{class:"aside-curtain"},null,-1)),p("div",vc,[p("div",bc,[j(Yl,null,{"aside-top":N(()=>[C(r.$slots,"aside-top",{},void 0,!0)]),"aside-bottom":N(()=>[C(r.$slots,"aside-bottom",{},void 0,!0)]),"aside-outline-before":N(()=>[C(r.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":N(()=>[C(r.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":N(()=>[C(r.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":N(()=>[C(r.$slots,"aside-ads-after",{},void 0,!0)]),_:3})])])],2)):q("",!0),p("div",yc,[p("div",wc,[C(r.$slots,"doc-before",{},void 0,!0),p("main",_c,[j(c,{class:Q(["vp-doc",[s.value,m(n).externalLinkIcon&&"external-link-icon-enabled"]])},null,8,["class"])]),j(mc,null,{"doc-footer-before":N(()=>[C(r.$slots,"doc-footer-before",{},void 0,!0)]),_:3}),C(r.$slots,"doc-after",{},void 0,!0)])])]),C(r.$slots,"doc-bottom",{},void 0,!0)],2)}}}),xc=X(kc,[["__scopeId","data-v-f640936e"]]),Ac=U({__name:"VPButton",props:{tag:{},size:{default:"medium"},theme:{default:"brand"},text:{},href:{},target:{},rel:{}},setup(e){const n=e,t=R(()=>n.href&&Is.test(n.href)),a=R(()=>n.tag||(n.href?"a":"button"));return(o,i)=>(f(),G(ze(a.value),{class:Q(["VPButton",[e.size,e.theme]]),href:e.href?m(ja)(e.href):void 0,target:n.target??(t.value?"_blank":void 0),rel:n.rel??(t.value?"noreferrer":void 0)},{default:N(()=>[Ae(S(e.text),1)]),_:1},8,["class","href","target","rel"]))}}),Cc=X(Ac,[["__scopeId","data-v-baf7dc9c"]]),Tc=["src","alt"],Sc=U({inheritAttrs:!1,__name:"VPImage",props:{image:{},alt:{}},setup(e){return(n,t)=>{const a=tn("VPImage",!0);return e.image?(f(),_(Z,{key:0},[typeof e.image=="string"||"src"in e.image?(f(),_("img",en({key:0,class:"VPImage"},typeof e.image=="string"?n.$attrs:{...e.image,...n.$attrs},{src:m(Ra)(typeof e.image=="string"?e.image:e.image.src),alt:e.alt??(typeof e.image=="string"?"":e.image.alt||"")}),null,16,Tc)):(f(),_(Z,{key:1},[j(a,en({class:"dark",image:e.image.dark,alt:e.image.alt},n.$attrs),null,16,["image","alt"]),j(a,en({class:"light",image:e.image.light,alt:e.image.alt},n.$attrs),null,16,["image","alt"])],64))],64)):q("",!0)}}}),pt=X(Sc,[["__scopeId","data-v-f9c85911"]]),Ic={class:"container"},Dc={class:"main"},Pc={class:"heading"},Mc=["innerHTML"],Lc=["innerHTML"],$c=["innerHTML"],Nc={key:0,class:"actions"},Ec={key:0,class:"image"},Oc={class:"image-container"},Rc=U({__name:"VPHero",props:{name:{},text:{},tagline:{},image:{},actions:{}},setup(e){const n=Rt("hero-image-slot-exists");return(t,a)=>(f(),_("div",{class:Q(["VPHero",{"has-image":e.image||m(n)}])},[p("div",Ic,[p("div",Dc,[C(t.$slots,"home-hero-info-before",{},void 0,!0),C(t.$slots,"home-hero-info",{},()=>[p("h1",Pc,[e.name?(f(),_("span",{key:0,innerHTML:e.name,class:"name clip"},null,8,Mc)):q("",!0),e.text?(f(),_("span",{key:1,innerHTML:e.text,class:"text"},null,8,Lc)):q("",!0)]),e.tagline?(f(),_("p",{key:0,innerHTML:e.tagline,class:"tagline"},null,8,$c)):q("",!0)],!0),C(t.$slots,"home-hero-info-after",{},void 0,!0),e.actions?(f(),_("div",Nc,[(f(!0),_(Z,null,ie(e.actions,o=>(f(),_("div",{key:o.link,class:"action"},[j(Cc,{tag:"a",size:"medium",theme:o.theme,text:o.text,href:o.link,target:o.target,rel:o.rel},null,8,["theme","text","href","target","rel"])]))),128))])):q("",!0),C(t.$slots,"home-hero-actions-after",{},void 0,!0)]),e.image||m(n)?(f(),_("div",Ec,[p("div",Oc,[a[0]||(a[0]=p("div",{class:"image-bg"},null,-1)),C(t.$slots,"home-hero-image",{},()=>[e.image?(f(),G(pt,{key:0,class:"image-src",image:e.image},null,8,["image"])):q("",!0)],!0)])])):q("",!0)])],2))}}),zc=X(Rc,[["__scopeId","data-v-09b6ce43"]]),qc=U({__name:"VPHomeHero",setup(e){const{frontmatter:n}=ne();return(t,a)=>m(n).hero?(f(),G(zc,{key:0,class:"VPHomeHero",name:m(n).hero.name,text:m(n).hero.text,tagline:m(n).hero.tagline,image:m(n).hero.image,actions:m(n).hero.actions},{"home-hero-info-before":N(()=>[C(t.$slots,"home-hero-info-before")]),"home-hero-info":N(()=>[C(t.$slots,"home-hero-info")]),"home-hero-info-after":N(()=>[C(t.$slots,"home-hero-info-after")]),"home-hero-actions-after":N(()=>[C(t.$slots,"home-hero-actions-after")]),"home-hero-image":N(()=>[C(t.$slots,"home-hero-image")]),_:3},8,["name","text","tagline","image","actions"])):q("",!0)}}),Bc={class:"box"},Vc={key:0,class:"icon"},Fc=["innerHTML"],jc=["innerHTML"],Uc=["innerHTML"],Gc={key:4,class:"link-text"},Hc={class:"link-text-value"},Wc=U({__name:"VPFeature",props:{icon:{},title:{},details:{},link:{},linkText:{},rel:{},target:{}},setup(e){return(n,t)=>(f(),G(qe,{class:"VPFeature",href:e.link,rel:e.rel,target:e.target,"no-icon":!0,tag:e.link?"a":"div"},{default:N(()=>[p("article",Bc,[typeof e.icon=="object"&&e.icon.wrap?(f(),_("div",Vc,[j(pt,{image:e.icon,alt:e.icon.alt,height:e.icon.height||48,width:e.icon.width||48},null,8,["image","alt","height","width"])])):typeof e.icon=="object"?(f(),G(pt,{key:1,image:e.icon,alt:e.icon.alt,height:e.icon.height||48,width:e.icon.width||48},null,8,["image","alt","height","width"])):e.icon?(f(),_("div",{key:2,class:"icon",innerHTML:e.icon},null,8,Fc)):q("",!0),p("h2",{class:"title",innerHTML:e.title},null,8,jc),e.details?(f(),_("p",{key:3,class:"details",innerHTML:e.details},null,8,Uc)):q("",!0),e.linkText?(f(),_("div",Gc,[p("p",Hc,[Ae(S(e.linkText)+" ",1),t[0]||(t[0]=p("span",{class:"vpi-arrow-right link-text-icon"},null,-1))])])):q("",!0)])]),_:1},8,["href","rel","target","tag"]))}}),Kc=X(Wc,[["__scopeId","data-v-67e0b8b6"]]),Yc={key:0,class:"VPFeatures"},Xc={class:"container"},Qc={class:"items"},Jc=U({__name:"VPFeatures",props:{features:{}},setup(e){const n=e,t=R(()=>{const a=n.features.length;if(a){if(a===2)return"grid-2";if(a===3)return"grid-3";if(a%3===0)return"grid-6";if(a>3)return"grid-4"}else return});return(a,o)=>e.features?(f(),_("div",Yc,[p("div",Xc,[p("div",Qc,[(f(!0),_(Z,null,ie(e.features,i=>(f(),_("div",{key:i.title,class:Q(["item",[t.value]])},[j(Kc,{icon:i.icon,title:i.title,details:i.details,link:i.link,"link-text":i.linkText,rel:i.rel,target:i.target},null,8,["icon","title","details","link","link-text","rel","target"])],2))),128))])])])):q("",!0)}}),Zc=X(Jc,[["__scopeId","data-v-f6b1b269"]]),eu=U({__name:"VPHomeFeatures",setup(e){const{frontmatter:n}=ne();return(t,a)=>m(n).features?(f(),G(Zc,{key:0,class:"VPHomeFeatures",features:m(n).features},null,8,["features"])):q("",!0)}}),nu=U({__name:"VPHomeContent",setup(e){const{width:n}=sl({initialWidth:0,includeScrollbar:!1});return(t,a)=>(f(),_("div",{class:"vp-doc container",style:Ba(m(n)?{"--vp-offset":`calc(50% - ${m(n)/2}px)`}:{})},[C(t.$slots,"default",{},void 0,!0)],4))}}),tu=X(nu,[["__scopeId","data-v-3be093fb"]]),au=U({__name:"VPHome",setup(e){const{frontmatter:n,theme:t}=ne();return(a,o)=>{const i=tn("Content");return f(),_("div",{class:Q(["VPHome",{"external-link-icon-enabled":m(t).externalLinkIcon}])},[C(a.$slots,"home-hero-before",{},void 0,!0),j(qc,null,{"home-hero-info-before":N(()=>[C(a.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":N(()=>[C(a.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":N(()=>[C(a.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":N(()=>[C(a.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":N(()=>[C(a.$slots,"home-hero-image",{},void 0,!0)]),_:3}),C(a.$slots,"home-hero-after",{},void 0,!0),C(a.$slots,"home-features-before",{},void 0,!0),j(eu),C(a.$slots,"home-features-after",{},void 0,!0),m(n).markdownStyles!==!1?(f(),G(tu,{key:0},{default:N(()=>[j(i)]),_:1})):(f(),G(i,{key:1}))],2)}}}),ou=X(au,[["__scopeId","data-v-6e6fdb32"]]),iu={},su={class:"VPPage"};function ru(e,n){const t=tn("Content");return f(),_("div",su,[C(e.$slots,"page-top"),j(t),C(e.$slots,"page-bottom")])}const lu=X(iu,[["render",ru]]),cu=U({__name:"VPContent",setup(e){const{page:n,frontmatter:t}=ne(),{hasSidebar:a}=Qe();return(o,i)=>(f(),_("div",{class:Q(["VPContent",{"has-sidebar":m(a),"is-home":m(t).layout==="home"}]),id:"VPContent"},[m(n).isNotFound?C(o.$slots,"not-found",{key:0},()=>[j(Sl)],!0):m(t).layout==="page"?(f(),G(lu,{key:1},{"page-top":N(()=>[C(o.$slots,"page-top",{},void 0,!0)]),"page-bottom":N(()=>[C(o.$slots,"page-bottom",{},void 0,!0)]),_:3})):m(t).layout==="home"?(f(),G(ou,{key:2},{"home-hero-before":N(()=>[C(o.$slots,"home-hero-before",{},void 0,!0)]),"home-hero-info-before":N(()=>[C(o.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":N(()=>[C(o.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":N(()=>[C(o.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":N(()=>[C(o.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":N(()=>[C(o.$slots,"home-hero-image",{},void 0,!0)]),"home-hero-after":N(()=>[C(o.$slots,"home-hero-after",{},void 0,!0)]),"home-features-before":N(()=>[C(o.$slots,"home-features-before",{},void 0,!0)]),"home-features-after":N(()=>[C(o.$slots,"home-features-after",{},void 0,!0)]),_:3})):m(t).layout&&m(t).layout!=="doc"?(f(),G(ze(m(t).layout),{key:3})):(f(),G(xc,{key:4},{"doc-top":N(()=>[C(o.$slots,"doc-top",{},void 0,!0)]),"doc-bottom":N(()=>[C(o.$slots,"doc-bottom",{},void 0,!0)]),"doc-footer-before":N(()=>[C(o.$slots,"doc-footer-before",{},void 0,!0)]),"doc-before":N(()=>[C(o.$slots,"doc-before",{},void 0,!0)]),"doc-after":N(()=>[C(o.$slots,"doc-after",{},void 0,!0)]),"aside-top":N(()=>[C(o.$slots,"aside-top",{},void 0,!0)]),"aside-outline-before":N(()=>[C(o.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":N(()=>[C(o.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":N(()=>[C(o.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":N(()=>[C(o.$slots,"aside-ads-after",{},void 0,!0)]),"aside-bottom":N(()=>[C(o.$slots,"aside-bottom",{},void 0,!0)]),_:3}))],2))}}),uu=X(cu,[["__scopeId","data-v-714062c7"]]),du={class:"container"},hu=["innerHTML"],pu=["innerHTML"],gu=U({__name:"VPFooter",setup(e){const{theme:n,frontmatter:t}=ne(),{hasSidebar:a}=Qe();return(o,i)=>m(n).footer&&m(t).footer!==!1?(f(),_("footer",{key:0,class:Q(["VPFooter",{"has-sidebar":m(a)}])},[p("div",du,[m(n).footer.message?(f(),_("p",{key:0,class:"message",innerHTML:m(n).footer.message},null,8,hu)):q("",!0),m(n).footer.copyright?(f(),_("p",{key:1,class:"copyright",innerHTML:m(n).footer.copyright},null,8,pu)):q("",!0)])],2)):q("",!0)}}),mu=X(gu,[["__scopeId","data-v-a0954f24"]]);function fu(){const{theme:e,frontmatter:n}=ne(),t=Ss([]),a=R(()=>t.value.length>0);return Ot(()=>{t.value=Ua(n.value.outline??e.value.outline)}),{headers:t,hasLocalNav:a}}const vu={class:"menu-text"},bu={class:"header"},yu={class:"outline"},wu=U({__name:"VPLocalNavOutlineDropdown",props:{headers:{},navHeight:{}},setup(e){const n=e,{theme:t}=ne(),a=ae(!1),o=ae(0),i=ae(),s=ae();function r(g){var u;(u=i.value)!=null&&u.contains(g.target)||(a.value=!1)}Me(a,g=>{if(g){document.addEventListener("click",r);return}document.removeEventListener("click",r)}),va("Escape",()=>{a.value=!1}),Ot(()=>{a.value=!1});function l(){a.value=!a.value,o.value=window.innerHeight+Math.min(window.scrollY-n.navHeight,0)}function c(g){g.target.classList.contains("outline-link")&&(s.value&&(s.value.style.transition="none"),Va(()=>{a.value=!1}))}function d(){a.value=!1,window.scrollTo({top:0,left:0,behavior:"smooth"})}return(g,u)=>(f(),_("div",{class:"VPLocalNavOutlineDropdown",style:Ba({"--vp-vh":o.value+"px"}),ref_key:"main",ref:i},[e.headers.length>0?(f(),_("button",{key:0,onClick:l,class:Q({open:a.value})},[p("span",vu,S(m(Ns)(m(t))),1),u[0]||(u[0]=p("span",{class:"vpi-chevron-right icon"},null,-1))],2)):(f(),_("button",{key:1,onClick:d},S(m(t).returnToTopLabel||"Return to top"),1)),j(Oa,{name:"flyout"},{default:N(()=>[a.value?(f(),_("div",{key:0,ref_key:"items",ref:s,class:"items",onClick:c},[p("div",bu,[p("a",{class:"top-link",href:"#",onClick:d},S(m(t).returnToTopLabel||"Return to top"),1)]),p("div",yu,[j(Es,{headers:e.headers},null,8,["headers"])])],512)):q("",!0)]),_:1})],4))}}),_u=X(wu,[["__scopeId","data-v-f210c2f8"]]),ku={class:"container"},xu=["aria-expanded"],Au={class:"menu-text"},Cu=U({__name:"VPLocalNav",props:{open:{type:Boolean}},emits:["open-menu"],setup(e){const{theme:n,frontmatter:t}=ne(),{hasSidebar:a}=Qe(),{headers:o}=fu(),{y:i}=Ds(),s=ae(0);Ee(()=>{s.value=parseInt(getComputedStyle(document.documentElement).getPropertyValue("--vp-nav-height"))}),Ot(()=>{o.value=Ua(t.value.outline??n.value.outline)});const r=R(()=>o.value.length===0),l=R(()=>r.value&&!a.value),c=R(()=>({VPLocalNav:!0,"has-sidebar":a.value,empty:r.value,fixed:l.value}));return(d,g)=>m(t).layout!=="home"&&(!l.value||m(i)>=s.value)?(f(),_("div",{key:0,class:Q(c.value)},[p("div",ku,[m(a)?(f(),_("button",{key:0,class:"menu","aria-expanded":e.open,"aria-controls":"VPSidebarNav",onClick:g[0]||(g[0]=u=>d.$emit("open-menu"))},[g[1]||(g[1]=p("span",{class:"vpi-align-left menu-icon"},null,-1)),p("span",Au,S(m(n).sidebarMenuLabel||"Menu"),1)],8,xu)):q("",!0),j(_u,{headers:m(o),navHeight:s.value},null,8,["headers","navHeight"])])],2)):q("",!0)}}),Tu=X(Cu,[["__scopeId","data-v-f8cca058"]]);function Su(){const e=ae(!1);function n(){e.value=!0,window.addEventListener("resize",o)}function t(){e.value=!1,window.removeEventListener("resize",o)}function a(){e.value?t():n()}function o(){window.outerWidth>=768&&t()}const i=mn();return Me(()=>i.path,t),{isScreenOpen:e,openScreen:n,closeScreen:t,toggleScreen:a}}const Iu={},Du={class:"VPSwitch",type:"button",role:"switch"},Pu={class:"check"},Mu={key:0,class:"icon"};function Lu(e,n){return f(),_("button",Du,[p("span",Pu,[e.$slots.default?(f(),_("span",Mu,[C(e.$slots,"default",{},void 0,!0)])):q("",!0)])])}const $u=X(Iu,[["render",Lu],["__scopeId","data-v-71e7f96a"]]),Nu=U({__name:"VPSwitchAppearance",setup(e){const{isDark:n,theme:t}=ne(),a=Rt("toggle-appearance",()=>{n.value=!n.value}),o=ae("");return qa(()=>{o.value=n.value?t.value.lightModeSwitchTitle||"Switch to light theme":t.value.darkModeSwitchTitle||"Switch to dark theme"}),(i,s)=>(f(),G($u,{title:o.value,class:"VPSwitchAppearance","aria-checked":m(n),onClick:m(a)},{default:N(()=>[...s[0]||(s[0]=[p("span",{class:"vpi-sun sun"},null,-1),p("span",{class:"vpi-moon moon"},null,-1)])]),_:1},8,["title","aria-checked","onClick"]))}}),Ga=X(Nu,[["__scopeId","data-v-40158760"]]),Eu={key:0,class:"VPNavBarAppearance"},Ou=U({__name:"VPNavBarAppearance",setup(e){const{site:n}=ne();return(t,a)=>m(n).appearance&&m(n).appearance!=="force-dark"&&m(n).appearance!=="force-auto"?(f(),_("div",Eu,[j(Ga)])):q("",!0)}}),Ru=X(Ou,[["__scopeId","data-v-e3e8a76b"]]),Ha=ae();let Os=!1,ea=0;function zu(e){const n=ae(!1);if(zt){!Os&&qu(),ea++;const t=Me(Ha,a=>{var o,i,s;a===e.el.value||(o=e.el.value)!=null&&o.contains(a)?(n.value=!0,(i=e.onFocus)==null||i.call(e)):(n.value=!1,(s=e.onBlur)==null||s.call(e))});za(()=>{t(),ea--,ea||Bu()})}return rl(n)}function qu(){document.addEventListener("focusin",Rs),Os=!0,Ha.value=document.activeElement}function Bu(){document.removeEventListener("focusin",Rs)}function Rs(){Ha.value=document.activeElement}const Vu={class:"VPMenuLink"},Fu=["innerHTML"],ju=U({__name:"VPMenuLink",props:{item:{}},setup(e){const{page:n}=ne();return(t,a)=>(f(),_("div",Vu,[j(qe,{class:Q({active:m(un)(m(n).relativePath,e.item.activeMatch||e.item.link,!!e.item.activeMatch)}),href:e.item.link,target:e.item.target,rel:e.item.rel,"no-icon":e.item.noIcon},{default:N(()=>[p("span",{innerHTML:e.item.text},null,8,Fu)]),_:1},8,["class","href","target","rel","no-icon"])]))}}),qt=X(ju,[["__scopeId","data-v-9182bc9d"]]),Uu={class:"VPMenuGroup"},Gu={key:0,class:"title"},Hu=U({__name:"VPMenuGroup",props:{text:{},items:{}},setup(e){return(n,t)=>(f(),_("div",Uu,[e.text?(f(),_("p",Gu,S(e.text),1)):q("",!0),(f(!0),_(Z,null,ie(e.items,a=>(f(),_(Z,null,["link"in a?(f(),G(qt,{key:0,item:a},null,8,["item"])):q("",!0)],64))),256))]))}}),Wu=X(Hu,[["__scopeId","data-v-a0052f3d"]]),Ku={class:"VPMenu"},Yu={key:0,class:"items"},Xu=U({__name:"VPMenu",props:{items:{}},setup(e){return(n,t)=>(f(),_("div",Ku,[e.items?(f(),_("div",Yu,[(f(!0),_(Z,null,ie(e.items,a=>(f(),_(Z,{key:JSON.stringify(a)},["link"in a?(f(),G(qt,{key:0,item:a},null,8,["item"])):"component"in a?(f(),G(ze(a.component),en({key:1,ref_for:!0},a.props),null,16)):(f(),G(Wu,{key:2,text:a.text,items:a.items},null,8,["text","items"]))],64))),128))])):q("",!0),C(n.$slots,"default",{},void 0,!0)]))}}),Qu=X(Xu,[["__scopeId","data-v-6ac81520"]]),Ju=["aria-expanded","aria-label"],Zu={key:0,class:"text"},ed=["innerHTML"],nd={key:1,class:"vpi-more-horizontal icon"},td={class:"menu"},ad=U({__name:"VPFlyout",props:{icon:{},button:{},label:{},items:{}},setup(e){const n=ae(!1),t=ae();zu({el:t,onBlur:a});function a(){n.value=!1}return(o,i)=>(f(),_("div",{class:"VPFlyout",ref_key:"el",ref:t,onMouseenter:i[1]||(i[1]=s=>n.value=!0),onMouseleave:i[2]||(i[2]=s=>n.value=!1)},[p("button",{type:"button",class:"button","aria-haspopup":"true","aria-expanded":n.value,"aria-label":e.label,onClick:i[0]||(i[0]=s=>n.value=!n.value)},[e.button||e.icon?(f(),_("span",Zu,[e.icon?(f(),_("span",{key:0,class:Q([e.icon,"option-icon"])},null,2)):q("",!0),e.button?(f(),_("span",{key:1,innerHTML:e.button},null,8,ed)):q("",!0),i[3]||(i[3]=p("span",{class:"vpi-chevron-down text-icon"},null,-1))])):(f(),_("span",nd))],8,Ju),p("div",td,[j(Qu,{items:e.items},{default:N(()=>[C(o.$slots,"default",{},void 0,!0)]),_:3},8,["items"])])],544))}}),Wa=X(ad,[["__scopeId","data-v-beb8b8d5"]]),od=["href","aria-label","innerHTML"],id=U({__name:"VPSocialLink",props:{icon:{},link:{},ariaLabel:{}},setup(e){const n=e,t=ae();Ee(async()=>{var i;await Va();const o=(i=t.value)==null?void 0:i.children[0];o instanceof HTMLElement&&o.className.startsWith("vpi-social-")&&(getComputedStyle(o).maskImage||getComputedStyle(o).webkitMaskImage)==="none"&&o.style.setProperty("--icon",`url('https://api.iconify.design/simple-icons/${n.icon}.svg')`)});const a=R(()=>typeof n.icon=="object"?n.icon.svg:`<span class="vpi-social-${n.icon}"></span>`);return(o,i)=>(f(),_("a",{ref_key:"el",ref:t,class:"VPSocialLink no-icon",href:e.link,"aria-label":e.ariaLabel??(typeof e.icon=="string"?e.icon:""),target:"_blank",rel:"noopener",innerHTML:a.value},null,8,od))}}),sd=X(id,[["__scopeId","data-v-7652e684"]]),rd={class:"VPSocialLinks"},ld=U({__name:"VPSocialLinks",props:{links:{}},setup(e){return(n,t)=>(f(),_("div",rd,[(f(!0),_(Z,null,ie(e.links,({link:a,icon:o,ariaLabel:i})=>(f(),G(sd,{key:a,icon:o,link:a,ariaLabel:i},null,8,["icon","link","ariaLabel"]))),128))]))}}),Ka=X(ld,[["__scopeId","data-v-54791c74"]]),cd={key:0,class:"group translations"},ud={class:"trans-title"},dd={key:1,class:"group"},hd={class:"item appearance"},pd={class:"label"},gd={class:"appearance-action"},md={key:2,class:"group"},fd={class:"item social-links"},vd=U({__name:"VPNavBarExtra",setup(e){const{site:n,theme:t}=ne(),{localeLinks:a,currentLang:o}=Yn({correspondingLink:!0}),i=R(()=>a.value.length&&o.value.label||n.value.appearance||t.value.socialLinks);return(s,r)=>i.value?(f(),G(Wa,{key:0,class:"VPNavBarExtra",label:"extra navigation"},{default:N(()=>[m(a).length&&m(o).label?(f(),_("div",cd,[p("p",ud,S(m(o).label),1),(f(!0),_(Z,null,ie(m(a),l=>(f(),G(qt,{key:l.link,item:l},null,8,["item"]))),128))])):q("",!0),m(n).appearance&&m(n).appearance!=="force-dark"&&m(n).appearance!=="force-auto"?(f(),_("div",dd,[p("div",hd,[p("p",pd,S(m(t).darkModeSwitchLabel||"Appearance"),1),p("div",gd,[j(Ga)])])])):q("",!0),m(t).socialLinks?(f(),_("div",md,[p("div",fd,[j(Ka,{class:"social-links-list",links:m(t).socialLinks},null,8,["links"])])])):q("",!0)]),_:1})):q("",!0)}}),bd=X(vd,[["__scopeId","data-v-ad50955e"]]),yd=["aria-expanded"],wd=U({__name:"VPNavBarHamburger",props:{active:{type:Boolean}},emits:["click"],setup(e){return(n,t)=>(f(),_("button",{type:"button",class:Q(["VPNavBarHamburger",{active:e.active}]),"aria-label":"mobile navigation","aria-expanded":e.active,"aria-controls":"VPNavScreen",onClick:t[0]||(t[0]=a=>n.$emit("click"))},[...t[1]||(t[1]=[p("span",{class:"container"},[p("span",{class:"top"}),p("span",{class:"middle"}),p("span",{class:"bottom"})],-1)])],10,yd))}}),_d=X(wd,[["__scopeId","data-v-5e4fa142"]]),kd=["innerHTML"],xd=U({__name:"VPNavBarMenuLink",props:{item:{}},setup(e){const{page:n}=ne();return(t,a)=>(f(),G(qe,{class:Q({VPNavBarMenuLink:!0,active:m(un)(m(n).relativePath,e.item.activeMatch||e.item.link,!!e.item.activeMatch)}),href:e.item.link,target:e.item.target,rel:e.item.rel,"no-icon":e.item.noIcon,tabindex:"0"},{default:N(()=>[p("span",{innerHTML:e.item.text},null,8,kd)]),_:1},8,["class","href","target","rel","no-icon"]))}}),Ad=X(xd,[["__scopeId","data-v-f75fdd7c"]]),Cd=U({__name:"VPNavBarMenuGroup",props:{item:{}},setup(e){const n=e,{page:t}=ne(),a=i=>"component"in i?!1:"link"in i?un(t.value.relativePath,i.link,!!n.item.activeMatch):i.items.some(a),o=R(()=>a(n.item));return(i,s)=>(f(),G(Wa,{class:Q({VPNavBarMenuGroup:!0,active:m(un)(m(t).relativePath,e.item.activeMatch,!!e.item.activeMatch)||o.value}),button:e.item.text,items:e.item.items},null,8,["class","button","items"]))}}),Td={key:0,"aria-labelledby":"main-nav-aria-label",class:"VPNavBarMenu"},Sd=U({__name:"VPNavBarMenu",setup(e){const{theme:n}=ne();return(t,a)=>m(n).nav?(f(),_("nav",Td,[a[0]||(a[0]=p("span",{id:"main-nav-aria-label",class:"visually-hidden"}," Main Navigation ",-1)),(f(!0),_(Z,null,ie(m(n).nav,o=>(f(),_(Z,{key:JSON.stringify(o)},["link"in o?(f(),G(Ad,{key:0,item:o},null,8,["item"])):"component"in o?(f(),G(ze(o.component),en({key:1,ref_for:!0},o.props),null,16)):(f(),G(Cd,{key:2,item:o},null,8,["item"]))],64))),128))])):q("",!0)}}),Id=X(Sd,[["__scopeId","data-v-e90f0632"]]);function Dd(e){const{localeIndex:n,theme:t}=ne();function a(o){var v,b,w;const i=o.split("."),s=(v=t.value.search)==null?void 0:v.options,r=s&&typeof s=="object",l=r&&((w=(b=s.locales)==null?void 0:b[n.value])==null?void 0:w.translations)||null,c=r&&s.translations||null;let d=l,g=c,u=e;const h=i.pop();for(const x of i){let A=null;const M=u==null?void 0:u[x];M&&(A=u=M);const y=g==null?void 0:g[x];y&&(A=g=y);const T=d==null?void 0:d[x];T&&(A=d=T),M||(u=A),y||(g=A),T||(d=A)}return(d==null?void 0:d[h])??(g==null?void 0:g[h])??(u==null?void 0:u[h])??""}return a}const Pd=["aria-label"],Md={class:"DocSearch-Button-Container"},Ld={class:"DocSearch-Button-Placeholder"},Mi=U({__name:"VPNavBarSearchButton",setup(e){const t=Dd({button:{buttonText:"Search",buttonAriaLabel:"Search"}});return(a,o)=>(f(),_("button",{type:"button",class:"DocSearch DocSearch-Button","aria-label":m(t)("button.buttonAriaLabel")},[p("span",Md,[o[0]||(o[0]=p("span",{class:"vp-icon DocSearch-Search-Icon"},null,-1)),p("span",Ld,S(m(t)("button.buttonText")),1)]),o[1]||(o[1]=p("span",{class:"DocSearch-Button-Keys"},[p("kbd",{class:"DocSearch-Button-Key"}),p("kbd",{class:"DocSearch-Button-Key"},"K")],-1))],8,Pd))}}),$d={class:"VPNavBarSearch"},Nd={id:"local-search"},Ed={key:1,id:"docsearch"},Ya=U({__name:"VPNavBarSearch",setup(e){const n=ll(()=>Ps(()=>import("./VPLocalSearchBox.oz40lzVT.js"),__vite__mapDeps([0,1]))),t=()=>null,{theme:a}=ne(),o=ae(!1),i=ae(!1);Ee(()=>{});function s(){o.value||(o.value=!0,setTimeout(r,16))}function r(){const g=new Event("keydown");g.key="k",g.metaKey=!0,window.dispatchEvent(g),setTimeout(()=>{document.querySelector(".DocSearch-Modal")||r()},16)}function l(g){const u=g.target,h=u.tagName;return u.isContentEditable||h==="INPUT"||h==="SELECT"||h==="TEXTAREA"}const c=ae(!1);va("k",g=>{(g.ctrlKey||g.metaKey)&&(g.preventDefault(),c.value=!0)}),va("/",g=>{l(g)||(g.preventDefault(),c.value=!0)});const d="local";return(g,u)=>{var h;return f(),_("div",$d,[m(d)==="local"?(f(),_(Z,{key:0},[c.value?(f(),G(m(n),{key:0,onClose:u[0]||(u[0]=v=>c.value=!1)})):q("",!0),p("div",Nd,[j(Mi,{onClick:u[1]||(u[1]=v=>c.value=!0)})])],64)):m(d)==="algolia"?(f(),_(Z,{key:1},[o.value?(f(),G(m(t),{key:0,algolia:((h=m(a).search)==null?void 0:h.options)??m(a).algolia,onVnodeBeforeMount:u[2]||(u[2]=v=>i.value=!0)},null,8,["algolia"])):q("",!0),i.value?q("",!0):(f(),_("div",Ed,[j(Mi,{onClick:s})]))],64)):q("",!0)])}}}),Od=U({__name:"VPNavBarSocialLinks",setup(e){const{theme:n}=ne();return(t,a)=>m(n).socialLinks?(f(),G(Ka,{key:0,class:"VPNavBarSocialLinks",links:m(n).socialLinks},null,8,["links"])):q("",!0)}}),Rd=X(Od,[["__scopeId","data-v-27e2b2b1"]]),zd=["href","rel","target"],qd=["innerHTML"],Bd={key:2},Vd=U({__name:"VPNavBarTitle",setup(e){const{site:n,theme:t}=ne(),{hasSidebar:a}=Qe(),{currentLang:o}=Yn(),i=R(()=>{var l;return typeof t.value.logoLink=="string"?t.value.logoLink:(l=t.value.logoLink)==null?void 0:l.link}),s=R(()=>{var l;return typeof t.value.logoLink=="string"||(l=t.value.logoLink)==null?void 0:l.rel}),r=R(()=>{var l;return typeof t.value.logoLink=="string"||(l=t.value.logoLink)==null?void 0:l.target});return(l,c)=>(f(),_("div",{class:Q(["VPNavBarTitle",{"has-sidebar":m(a)}])},[p("a",{class:"title",href:i.value??m(ja)(m(o).link),rel:s.value,target:r.value},[C(l.$slots,"nav-bar-title-before",{},void 0,!0),m(t).logo?(f(),G(pt,{key:0,class:"logo",image:m(t).logo},null,8,["image"])):q("",!0),m(t).siteTitle?(f(),_("span",{key:1,innerHTML:m(t).siteTitle},null,8,qd)):m(t).siteTitle===void 0?(f(),_("span",Bd,S(m(n).title),1)):q("",!0),C(l.$slots,"nav-bar-title-after",{},void 0,!0)],8,zd)],2))}}),Fd=X(Vd,[["__scopeId","data-v-6ec1a2fc"]]),jd={class:"items"},Ud={class:"title"},Gd=U({__name:"VPNavBarTranslations",setup(e){const{theme:n}=ne(),{localeLinks:t,currentLang:a}=Yn({correspondingLink:!0});return(o,i)=>m(t).length&&m(a).label?(f(),G(Wa,{key:0,class:"VPNavBarTranslations",icon:"vpi-languages",label:m(n).langMenuLabel||"Change language"},{default:N(()=>[p("div",jd,[p("p",Ud,S(m(a).label),1),(f(!0),_(Z,null,ie(m(t),s=>(f(),G(qt,{key:s.link,item:s},null,8,["item"]))),128))])]),_:1},8,["label"])):q("",!0)}}),zs=X(Gd,[["__scopeId","data-v-40afd59f"]]),Hd={class:"wrapper"},Wd={class:"container"},Kd={class:"title"},Yd={class:"content"},Xd={class:"content-body"},Qd=U({__name:"VPNavBar",props:{isScreenOpen:{type:Boolean}},emits:["toggle-screen"],setup(e){const n=e,{y:t}=Ds(),{hasSidebar:a}=Qe(),{frontmatter:o}=ne(),i=ae({});return qa(()=>{i.value={"has-sidebar":a.value,home:o.value.layout==="home",top:t.value===0,"screen-open":n.isScreenOpen}}),(s,r)=>(f(),_("div",{class:Q(["VPNavBar",i.value])},[p("div",Hd,[p("div",Wd,[p("div",Kd,[j(Fd,null,{"nav-bar-title-before":N(()=>[C(s.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":N(()=>[C(s.$slots,"nav-bar-title-after",{},void 0,!0)]),_:3})]),p("div",Yd,[p("div",Xd,[C(s.$slots,"nav-bar-content-before",{},void 0,!0),j(Ya,{class:"search"}),j(Id,{class:"menu"}),j(zs,{class:"translations"}),j(Ru,{class:"appearance"}),j(Rd,{class:"social-links"}),j(bd,{class:"extra"}),C(s.$slots,"nav-bar-content-after",{},void 0,!0),j(_d,{class:"hamburger",active:e.isScreenOpen,onClick:r[0]||(r[0]=l=>s.$emit("toggle-screen"))},null,8,["active"])])])])]),r[1]||(r[1]=p("div",{class:"divider"},[p("div",{class:"divider-line"})],-1))],2))}}),Jd=X(Qd,[["__scopeId","data-v-de524931"]]),Zd={key:0,class:"VPNavScreenAppearance"},eh={class:"text"},nh=U({__name:"VPNavScreenAppearance",setup(e){const{site:n,theme:t}=ne();return(a,o)=>m(n).appearance&&m(n).appearance!=="force-dark"&&m(n).appearance!=="force-auto"?(f(),_("div",Zd,[p("p",eh,S(m(t).darkModeSwitchLabel||"Appearance"),1),j(Ga)])):q("",!0)}}),th=X(nh,[["__scopeId","data-v-37559f51"]]),ah=["innerHTML"],oh=U({__name:"VPNavScreenMenuLink",props:{item:{}},setup(e){const n=Rt("close-screen");return(t,a)=>(f(),G(qe,{class:"VPNavScreenMenuLink",href:e.item.link,target:e.item.target,rel:e.item.rel,"no-icon":e.item.noIcon,onClick:m(n)},{default:N(()=>[p("span",{innerHTML:e.item.text},null,8,ah)]),_:1},8,["href","target","rel","no-icon","onClick"]))}}),ih=X(oh,[["__scopeId","data-v-80e6e6d6"]]),sh=["innerHTML"],rh=U({__name:"VPNavScreenMenuGroupLink",props:{item:{}},setup(e){const n=Rt("close-screen");return(t,a)=>(f(),G(qe,{class:"VPNavScreenMenuGroupLink",href:e.item.link,target:e.item.target,rel:e.item.rel,"no-icon":e.item.noIcon,onClick:m(n)},{default:N(()=>[p("span",{innerHTML:e.item.text},null,8,sh)]),_:1},8,["href","target","rel","no-icon","onClick"]))}}),qs=X(rh,[["__scopeId","data-v-bd01957f"]]),lh={class:"VPNavScreenMenuGroupSection"},ch={key:0,class:"title"},uh=U({__name:"VPNavScreenMenuGroupSection",props:{text:{},items:{}},setup(e){return(n,t)=>(f(),_("div",lh,[e.text?(f(),_("p",ch,S(e.text),1)):q("",!0),(f(!0),_(Z,null,ie(e.items,a=>(f(),G(qs,{key:a.text,item:a},null,8,["item"]))),128))]))}}),dh=X(uh,[["__scopeId","data-v-cd0e7558"]]),hh=["aria-controls","aria-expanded"],ph=["innerHTML"],gh=["id"],mh={key:0,class:"item"},fh={key:1,class:"item"},vh={key:2,class:"group"},bh=U({__name:"VPNavScreenMenuGroup",props:{text:{},items:{}},setup(e){const n=e,t=ae(!1),a=R(()=>`NavScreenGroup-${n.text.replace(" ","-").toLowerCase()}`);function o(){t.value=!t.value}return(i,s)=>(f(),_("div",{class:Q(["VPNavScreenMenuGroup",{open:t.value}])},[p("button",{class:"button","aria-controls":a.value,"aria-expanded":t.value,onClick:o},[p("span",{class:"button-text",innerHTML:e.text},null,8,ph),s[0]||(s[0]=p("span",{class:"vpi-plus button-icon"},null,-1))],8,hh),p("div",{id:a.value,class:"items"},[(f(!0),_(Z,null,ie(e.items,r=>(f(),_(Z,{key:JSON.stringify(r)},["link"in r?(f(),_("div",mh,[j(qs,{item:r},null,8,["item"])])):"component"in r?(f(),_("div",fh,[(f(),G(ze(r.component),en({ref_for:!0},r.props,{"screen-menu":""}),null,16))])):(f(),_("div",vh,[j(dh,{text:r.text,items:r.items},null,8,["text","items"])]))],64))),128))],8,gh)],2))}}),yh=X(bh,[["__scopeId","data-v-3d415584"]]),wh={key:0,class:"VPNavScreenMenu"},_h=U({__name:"VPNavScreenMenu",setup(e){const{theme:n}=ne();return(t,a)=>m(n).nav?(f(),_("nav",wh,[(f(!0),_(Z,null,ie(m(n).nav,o=>(f(),_(Z,{key:JSON.stringify(o)},["link"in o?(f(),G(ih,{key:0,item:o},null,8,["item"])):"component"in o?(f(),G(ze(o.component),en({key:1,ref_for:!0},o.props,{"screen-menu":""}),null,16)):(f(),G(yh,{key:2,text:o.text||"",items:o.items},null,8,["text","items"]))],64))),128))])):q("",!0)}}),kh=U({__name:"VPNavScreenSocialLinks",setup(e){const{theme:n}=ne();return(t,a)=>m(n).socialLinks?(f(),G(Ka,{key:0,class:"VPNavScreenSocialLinks",links:m(n).socialLinks},null,8,["links"])):q("",!0)}}),xh={class:"list"},Ah=U({__name:"VPNavScreenTranslations",setup(e){const{localeLinks:n,currentLang:t}=Yn({correspondingLink:!0}),a=ae(!1);function o(){a.value=!a.value}return(i,s)=>m(n).length&&m(t).label?(f(),_("div",{key:0,class:Q(["VPNavScreenTranslations",{open:a.value}])},[p("button",{class:"title",onClick:o},[s[0]||(s[0]=p("span",{class:"vpi-languages icon lang"},null,-1)),Ae(" "+S(m(t).label)+" ",1),s[1]||(s[1]=p("span",{class:"vpi-chevron-down icon chevron"},null,-1))]),p("ul",xh,[(f(!0),_(Z,null,ie(m(n),r=>(f(),_("li",{key:r.link,class:"item"},[j(qe,{class:"link",href:r.link},{default:N(()=>[Ae(S(r.text),1)]),_:2},1032,["href"])]))),128))])],2)):q("",!0)}}),Ch=X(Ah,[["__scopeId","data-v-59d95cf4"]]),Th={class:"container"},Sh=U({__name:"VPNavScreen",props:{open:{type:Boolean}},setup(e){const n=ae(null),t=Ms(zt?document.body:null);return(a,o)=>(f(),G(Oa,{name:"fade",onEnter:o[0]||(o[0]=i=>t.value=!0),onAfterLeave:o[1]||(o[1]=i=>t.value=!1)},{default:N(()=>[e.open?(f(),_("div",{key:0,class:"VPNavScreen",ref_key:"screen",ref:n,id:"VPNavScreen"},[p("div",Th,[C(a.$slots,"nav-screen-content-before",{},void 0,!0),j(_h,{class:"menu"}),j(Ch,{class:"translations"}),j(th,{class:"appearance"}),j(kh,{class:"social-links"}),C(a.$slots,"nav-screen-content-after",{},void 0,!0)])],512)):q("",!0)]),_:3}))}}),Ih=X(Sh,[["__scopeId","data-v-07baf27b"]]),Dh={key:0,class:"VPNav"},Ph=U({__name:"VPNav",setup(e){const{isScreenOpen:n,closeScreen:t,toggleScreen:a}=Su(),{frontmatter:o}=ne(),i=R(()=>o.value.navbar!==!1);return Ls("close-screen",t),Et(()=>{zt&&document.documentElement.classList.toggle("hide-nav",!i.value)}),(s,r)=>i.value?(f(),_("header",Dh,[j(Jd,{"is-screen-open":m(n),onToggleScreen:m(a)},{"nav-bar-title-before":N(()=>[C(s.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":N(()=>[C(s.$slots,"nav-bar-title-after",{},void 0,!0)]),"nav-bar-content-before":N(()=>[C(s.$slots,"nav-bar-content-before",{},void 0,!0)]),"nav-bar-content-after":N(()=>[C(s.$slots,"nav-bar-content-after",{},void 0,!0)]),_:3},8,["is-screen-open","onToggleScreen"]),j(Ih,{open:m(n)},{"nav-screen-content-before":N(()=>[C(s.$slots,"nav-screen-content-before",{},void 0,!0)]),"nav-screen-content-after":N(()=>[C(s.$slots,"nav-screen-content-after",{},void 0,!0)]),_:3},8,["open"])])):q("",!0)}}),Mh=X(Ph,[["__scopeId","data-v-717bd8c6"]]),Lh=["role","tabindex"],$h={key:1,class:"items"},Nh=U({__name:"VPSidebarItem",props:{item:{},depth:{}},setup(e){const n=e,{collapsed:t,collapsible:a,isLink:o,isActiveLink:i,hasActiveLink:s,hasChildren:r,toggle:l}=Ml(R(()=>n.item)),c=R(()=>r.value?"section":"div"),d=R(()=>o.value?"a":"div"),g=R(()=>r.value?n.depth+2===7?"p":`h${n.depth+2}`:"p"),u=R(()=>o.value?void 0:"button"),h=R(()=>[[`level-${n.depth}`],{collapsible:a.value},{collapsed:t.value},{"is-link":o.value},{"is-active":i.value},{"has-active":s.value}]);function v(w){"key"in w&&w.key!=="Enter"||!n.item.link&&l()}function b(){n.item.link&&l()}return(w,x)=>{const A=tn("VPSidebarItem",!0);return f(),G(ze(c.value),{class:Q(["VPSidebarItem",h.value])},{default:N(()=>[e.item.text?(f(),_("div",en({key:0,class:"item",role:u.value},cl(e.item.items?{click:v,keydown:v}:{},!0),{tabindex:e.item.items&&0}),[x[1]||(x[1]=p("div",{class:"indicator"},null,-1)),e.item.link?(f(),G(qe,{key:0,tag:d.value,class:"link",href:e.item.link,rel:e.item.rel,target:e.item.target},{default:N(()=>[(f(),G(ze(g.value),{class:"text",innerHTML:e.item.text},null,8,["innerHTML"]))]),_:1},8,["tag","href","rel","target"])):(f(),G(ze(g.value),{key:1,class:"text",innerHTML:e.item.text},null,8,["innerHTML"])),e.item.collapsed!=null&&e.item.items&&e.item.items.length?(f(),_("div",{key:2,class:"caret",role:"button","aria-label":"toggle section",onClick:b,onKeydown:ul(b,["enter"]),tabindex:"0"},[...x[0]||(x[0]=[p("span",{class:"vpi-chevron-right caret-icon"},null,-1)])],32)):q("",!0)],16,Lh)):q("",!0),e.item.items&&e.item.items.length?(f(),_("div",$h,[e.depth<5?(f(!0),_(Z,{key:0},ie(e.item.items,M=>(f(),G(A,{key:M.text,item:M,depth:e.depth+1},null,8,["item","depth"]))),128)):q("",!0)])):q("",!0)]),_:1},8,["class"])}}}),Eh=X(Nh,[["__scopeId","data-v-08047252"]]),Oh=U({__name:"VPSidebarGroup",props:{items:{}},setup(e){const n=ae(!0);let t=null;return Ee(()=>{t=setTimeout(()=>{t=null,n.value=!1},300)}),Fa(()=>{t!=null&&(clearTimeout(t),t=null)}),(a,o)=>(f(!0),_(Z,null,ie(e.items,i=>(f(),_("div",{key:i.text,class:Q(["group",{"no-transition":n.value}])},[j(Eh,{item:i,depth:0},null,8,["item"])],2))),128))}}),Rh=X(Oh,[["__scopeId","data-v-ba5ce4ae"]]),zh={class:"nav",id:"VPSidebarNav","aria-labelledby":"sidebar-aria-label",tabindex:"-1"},qh=U({__name:"VPSidebar",props:{open:{type:Boolean}},setup(e){const{sidebarGroups:n,hasSidebar:t}=Qe(),a=e,o=ae(null),i=Ms(zt?document.body:null);Me([a,o],()=>{var r;a.open?(i.value=!0,(r=o.value)==null||r.focus()):i.value=!1},{immediate:!0,flush:"post"});const s=ae(0);return Me(n,()=>{s.value+=1},{deep:!0}),(r,l)=>m(t)?(f(),_("aside",{key:0,class:Q(["VPSidebar",{open:e.open}]),ref_key:"navEl",ref:o,onClick:l[0]||(l[0]=dl(()=>{},["stop"]))},[l[2]||(l[2]=p("div",{class:"curtain"},null,-1)),p("nav",zh,[l[1]||(l[1]=p("span",{class:"visually-hidden",id:"sidebar-aria-label"}," Sidebar Navigation ",-1)),C(r.$slots,"sidebar-nav-before",{},void 0,!0),(f(),G(Rh,{items:m(n),key:s.value},null,8,["items"])),C(r.$slots,"sidebar-nav-after",{},void 0,!0)])],2)):q("",!0)}}),Bh=X(qh,[["__scopeId","data-v-9e9a3195"]]),Vh=U({__name:"VPSkipLink",setup(e){const{theme:n}=ne(),t=mn(),a=ae();Me(()=>t.path,()=>a.value.focus());function o({target:i}){const s=document.getElementById(decodeURIComponent(i.hash).slice(1));if(s){const r=()=>{s.removeAttribute("tabindex"),s.removeEventListener("blur",r)};s.setAttribute("tabindex","-1"),s.addEventListener("blur",r),s.focus(),window.scrollTo(0,0)}}return(i,s)=>(f(),_(Z,null,[p("span",{ref_key:"backToTop",ref:a,tabindex:"-1"},null,512),p("a",{href:"#VPContent",class:"VPSkipLink visually-hidden",onClick:o},S(m(n).skipToContentLabel||"Skip to content"),1)],64))}}),Fh=X(Vh,[["__scopeId","data-v-2f312717"]]),jh=U({__name:"Layout",setup(e){const{isOpen:n,open:t,close:a}=Qe(),o=mn();Me(()=>o.path,a),Pl(n,a);const{frontmatter:i}=ne(),s=hl(),r=R(()=>!!s["home-hero-image"]);return Ls("hero-image-slot-exists",r),(l,c)=>{const d=tn("Content");return m(i).layout!==!1?(f(),_("div",{key:0,class:Q(["Layout",m(i).pageClass])},[C(l.$slots,"layout-top",{},void 0,!0),j(Fh),j(vl,{class:"backdrop",show:m(n),onClick:m(a)},null,8,["show","onClick"]),j(Mh,null,{"nav-bar-title-before":N(()=>[C(l.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":N(()=>[C(l.$slots,"nav-bar-title-after",{},void 0,!0)]),"nav-bar-content-before":N(()=>[C(l.$slots,"nav-bar-content-before",{},void 0,!0)]),"nav-bar-content-after":N(()=>[C(l.$slots,"nav-bar-content-after",{},void 0,!0)]),"nav-screen-content-before":N(()=>[C(l.$slots,"nav-screen-content-before",{},void 0,!0)]),"nav-screen-content-after":N(()=>[C(l.$slots,"nav-screen-content-after",{},void 0,!0)]),_:3}),j(Tu,{open:m(n),onOpenMenu:m(t)},null,8,["open","onOpenMenu"]),j(Bh,{open:m(n)},{"sidebar-nav-before":N(()=>[C(l.$slots,"sidebar-nav-before",{},void 0,!0)]),"sidebar-nav-after":N(()=>[C(l.$slots,"sidebar-nav-after",{},void 0,!0)]),_:3},8,["open"]),j(uu,null,{"page-top":N(()=>[C(l.$slots,"page-top",{},void 0,!0)]),"page-bottom":N(()=>[C(l.$slots,"page-bottom",{},void 0,!0)]),"not-found":N(()=>[C(l.$slots,"not-found",{},void 0,!0)]),"home-hero-before":N(()=>[C(l.$slots,"home-hero-before",{},void 0,!0)]),"home-hero-info-before":N(()=>[C(l.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":N(()=>[C(l.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":N(()=>[C(l.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":N(()=>[C(l.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":N(()=>[C(l.$slots,"home-hero-image",{},void 0,!0)]),"home-hero-after":N(()=>[C(l.$slots,"home-hero-after",{},void 0,!0)]),"home-features-before":N(()=>[C(l.$slots,"home-features-before",{},void 0,!0)]),"home-features-after":N(()=>[C(l.$slots,"home-features-after",{},void 0,!0)]),"doc-footer-before":N(()=>[C(l.$slots,"doc-footer-before",{},void 0,!0)]),"doc-before":N(()=>[C(l.$slots,"doc-before",{},void 0,!0)]),"doc-after":N(()=>[C(l.$slots,"doc-after",{},void 0,!0)]),"doc-top":N(()=>[C(l.$slots,"doc-top",{},void 0,!0)]),"doc-bottom":N(()=>[C(l.$slots,"doc-bottom",{},void 0,!0)]),"aside-top":N(()=>[C(l.$slots,"aside-top",{},void 0,!0)]),"aside-bottom":N(()=>[C(l.$slots,"aside-bottom",{},void 0,!0)]),"aside-outline-before":N(()=>[C(l.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":N(()=>[C(l.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":N(()=>[C(l.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":N(()=>[C(l.$slots,"aside-ads-after",{},void 0,!0)]),_:3}),j(mu),C(l.$slots,"layout-bottom",{},void 0,!0)],2)):(f(),G(d,{key:1}))}}}),Uh=X(jh,[["__scopeId","data-v-3fa573af"]]),Bs={Layout:Uh,enhanceApp:({app:e})=>{e.component("Badge",gl)}},Gh={class:"flex items-center rounded-lg border border-slate-200 dark:border-slate-700 overflow-hidden"},Hh={key:1,class:"flex flex-wrap items-center gap-2"},Wh=["href"],Li=U({__name:"ThemeControls",props:{compact:{type:Boolean,default:!1},showSearch:{type:Boolean,default:!0}},setup(e){const n=ae("light"),t=mn(),{site:a}=gn(),o=R(()=>{const h=a.value.locales||{};return Object.values(h).map(v=>{const b=typeof(v==null?void 0:v.label)=="string"?v.label:"",w=typeof(v==null?void 0:v.link)=="string"?v.link:"";return{label:b,link:w}}).filter(v=>!!(v.label&&v.link))}),i=R(()=>l(t.path)),s=R(()=>o.value.map(h=>l(h.link)).filter(h=>h!=="/").sort((h,v)=>v.length-h.length)),r=R(()=>{const h=i.value;for(const v of s.value)if(h===v||h.startsWith(`${v}/`))return v;return"/"});function l(h){if(!h)return"/";const[v]=h.split(/[?#]/);return v&&v.replace(/\/+$/,"")||"/"}function c(h){return r.value===l(h)}function d(h){for(const v of s.value){if(h===v)return"/";if(h.startsWith(`${v}/`))return h.slice(v.length)||"/"}return h}function g(h){const v=l(h),b=d(i.value);return v==="/"?b:`${v}${b==="/"?"/":b}`.replace(/\/{2,}/g,"/")}function u(h){if(typeof window>"u")return;n.value=h;const v=document.documentElement;v.classList.remove("dark"),h==="dark"&&v.classList.add("dark"),v.setAttribute("data-theme",h),v.style.colorScheme=h,localStorage.setItem("vitepress-theme-appearance",h)}return Ee(()=>{const h=localStorage.getItem("vitepress-theme-appearance"),v=document.documentElement.classList.contains("dark")?"dark":"light",b=h==="dark"||h==="light"?h:v;u(b),requestAnimationFrame(()=>u(b))}),(h,v)=>(f(),_("div",{class:Q(e.compact?"flex flex-col items-start gap-3":"flex items-center gap-3")},[e.showSearch&&!e.compact?(f(),G(Ya,{key:0})):q("",!0),p("div",Gh,[p("button",{class:Q(["px-2.5 py-1.5 text-xs font-semibold transition-colors",n.value==="light"?"bg-slate-200 text-slate-900 dark:bg-slate-100":"bg-transparent text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800"]),onClick:v[0]||(v[0]=b=>u("light"))}," Light ",2),p("button",{class:Q(["px-2.5 py-1.5 text-xs font-semibold transition-colors",n.value==="dark"?"bg-slate-900 text-slate-100 dark:bg-slate-700":"bg-transparent text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800"]),onClick:v[1]||(v[1]=b=>u("dark"))}," Dark ",2)]),e.compact?(f(),_("div",Hh,[(f(!0),_(Z,null,ie(o.value,b=>(f(),_("a",{key:b.link,class:Q(c(b.link)?"rounded-md border border-slate-300 dark:border-slate-600 bg-slate-100 dark:bg-slate-800 px-2.5 py-1 text-xs font-semibold text-slate-900 dark:text-slate-100":"rounded-md border border-slate-200 dark:border-slate-700 px-2.5 py-1 text-xs font-semibold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"),href:g(b.link)},S(b.label),11,Wh))),128))])):(f(),G(zs,{key:2}))],2))}}),Kh={class:"fixed top-0 w-full z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200/15 dark:border-slate-800/15 shadow-[0px_24px_48px_rgba(42,52,57,0.06)]"},Yh={class:"flex items-center gap-3"},Xh=["href"],Qh={class:"hidden md:flex items-center space-x-8 font-inter tracking-tight"},Jh=["href"],Zh={class:"hidden md:flex items-center gap-4"},ep={key:0,class:"bg-primary text-on-primary px-5 py-2 rounded-lg font-medium text-sm transition-all active:opacity-80"},np={class:"md:hidden flex items-center gap-2"},tp={class:"mobile-search"},ap={class:"group relative"},op={class:"absolute right-0 mt-3 w-[min(20rem,calc(100vw-2rem))] rounded-xl border border-slate-200 dark:border-slate-700 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl shadow-xl p-4"},ip={class:"space-y-1"},sp=["href"],rp={class:"mt-4 border-t border-slate-200 dark:border-slate-700 pt-4"},lp={key:0,class:"mt-4 w-full bg-primary text-on-primary px-5 py-2 rounded-lg font-medium text-sm transition-all active:opacity-80"},cp=U({__name:"SiteHeader",props:{siteTitle:{default:"MeshShape"},navLinks:{default:()=>[]},showSubscribe:{type:Boolean,default:!1},subscribeButtonText:{default:"Subscribe"},navHeightClass:{default:"h-20"}},setup(e){const n=mn();function t(i){const s=a(i);return s==="/en"||s.startsWith("/en/")?"/en/":"/"}function a(i){if(!i)return"/";const[s]=i.split(/[?#]/);return s&&s.replace(/\/+$/,"")||"/"}function o(i){if(i.active)return!0;const s=a(i.href),r=a(n.path);return s==="/"?r==="/":s==="/en"?r==="/en":r===s||r.startsWith(`${s}/`)}return(i,s)=>(f(),_("nav",Kh,[p("div",{class:Q(`flex justify-between items-center ${e.navHeightClass} px-8 w-full max-w-7xl mx-auto`)},[p("div",Yh,[p("a",{class:"text-xl font-bold tracking-tighter text-slate-900 dark:text-slate-50 hover:opacity-80 transition-opacity",href:t(m(n).path)},S(e.siteTitle),9,Xh)]),p("div",Qh,[(f(!0),_(Z,null,ie(e.navLinks,r=>(f(),_("a",{key:r.text,class:Q(o(r)?"text-slate-900 dark:text-slate-50 font-semibold border-b-2 border-slate-900 dark:border-slate-50 pb-1 transition-all":"text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 transition-colors"),href:r.href||"#"},S(r.text),11,Jh))),128))]),p("div",Zh,[j(Li),e.showSubscribe?(f(),_("button",ep,S(e.subscribeButtonText),1)):q("",!0)]),p("div",np,[p("div",tp,[j(Ya)]),p("details",ap,[s[0]||(s[0]=p("summary",{class:"list-none flex items-center justify-center h-10 w-10 rounded-lg border border-slate-300/60 dark:border-slate-700/60 text-slate-700 dark:text-slate-200 cursor-pointer","aria-label":"Open mobile navigation menu"},[p("span",{class:"text-xl leading-none"},"≡")],-1)),p("div",op,[p("div",ip,[(f(!0),_(Z,null,ie(e.navLinks,r=>(f(),_("a",{key:`mobile-${r.text}`,class:Q(o(r)?"block rounded-lg px-3 py-2 text-slate-900 dark:text-slate-50 font-semibold bg-slate-100 dark:bg-slate-800/80":"block rounded-lg px-3 py-2 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800/80 transition-colors"),href:r.href||"#"},S(r.text),11,sp))),128))]),p("div",rp,[j(Li,{compact:!0,"show-search":!1})]),e.showSubscribe?(f(),_("button",lp,S(e.subscribeButtonText),1)):q("",!0)])])])],2)]))}}),Bt=X(cp,[["__scopeId","data-v-70c33c8b"]]),up={class:"w-full border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950"},dp={class:"max-w-7xl mx-auto px-8 py-12 flex flex-col md:flex-row justify-between items-center gap-8"},hp=["href"],pp={class:"text-sm font-inter tracking-wide text-slate-600 dark:text-slate-400"},gp={class:"flex flex-wrap justify-center gap-8"},mp=["href"],fp={key:0,class:"flex gap-4"},vp={class:"material-symbols-outlined text-slate-600 dark:text-slate-400"},bp={key:0,class:"border-t border-slate-200/80 dark:border-slate-800/80"},yp={class:"max-w-7xl mx-auto px-8 py-4 flex flex-wrap items-center justify-center gap-x-3 gap-y-2 text-xs tracking-[0.08em] uppercase text-slate-500 dark:text-slate-400"},wp=["href"],_p=["href"],Vt=U({__name:"SiteFooter",props:{title:{default:"MeshShape"},description:{default:""},links:{default:()=>[]},filing:{default:null},socialIcons:{default:()=>[]}},setup(e){const n=mn();function t(o){if(!o)return"/";const[i]=o.split(/[?#]/);return i&&i.replace(/\/+$/,"")||"/"}function a(o){const i=t(o);return i==="/en"||i.startsWith("/en/")?"/en/":"/"}return(o,i)=>(f(),_("footer",up,[p("div",dp,[p("div",null,[p("a",{class:"text-lg font-bold text-slate-900 dark:text-slate-50 mb-2 inline-block hover:opacity-80 transition-opacity",href:a(m(n).path)},S(e.title),9,hp),p("p",pp,S(e.description),1)]),p("div",gp,[(f(!0),_(Z,null,ie(e.links,s=>(f(),_("a",{key:s.text,class:"text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors text-sm font-inter tracking-wide",href:s.href||"#"},S(s.text),9,mp))),128))]),e.socialIcons.length?(f(),_("div",fp,[(f(!0),_(Z,null,ie(e.socialIcons,s=>(f(),_("button",{key:s,class:"w-10 h-10 flex items-center justify-center rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:scale-105 transition-transform"},[p("span",vp,S(s),1)]))),128))])):q("",!0)]),e.filing?(f(),_("div",bp,[p("div",yp,[p("a",{class:"hover:text-slate-700 dark:hover:text-slate-200 transition-colors",href:e.filing.href,rel:"noreferrer",target:"_blank"},S(e.filing.label),9,wp),i[0]||(i[0]=p("span",{class:"hidden sm:inline text-slate-300 dark:text-slate-700"},"/",-1)),p("a",{class:"font-medium tracking-[0.03em] normal-case hover:text-slate-700 dark:hover:text-slate-200 transition-colors",href:e.filing.href,rel:"noreferrer",target:"_blank"},S(e.filing.number),9,_p)])])):q("",!0)]))}});function Ft(){const{frontmatter:e}=gn(),n=R(()=>e.value);return{frontmatter:e,page:n}}function jt(){const{theme:e}=gn(),n=R(()=>e.value),t=R(()=>n.value.header||{}),a=R(()=>n.value.footer||{}),o=R(()=>n.value.ui||{});return{theme:e,themeConfig:n,headerConfig:t,footerConfig:a,uiConfig:o}}const kp="/assets/mesh-texture.CdcToYau.png",xp="/assets/mesh-architecture.BxOsXjO_.png",Ap={class:"bg-surface text-slate-900 dark:text-slate-100 antialiased selection:bg-primary-container selection:text-on-primary-container"},Cp={class:"pt-20 bg-surface"},Tp={class:"relative overflow-hidden min-h-[870px] flex items-center px-8 max-w-7xl mx-auto"},Sp={class:"grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full"},Ip={class:"lg:col-span-5 lg:order-2 relative h-[320px] sm:h-[420px] lg:h-[500px] w-full mt-8 lg:mt-0"},Dp={class:"absolute inset-0 bg-surface-container-low rounded-[2rem] overflow-hidden mesh-gradient group"},Pp={class:"lg:col-span-7 lg:order-1 z-10"},Mp={class:"inline-block label-sm text-[0.6875rem] font-bold tracking-[0.05em] uppercase text-tertiary mb-6"},Lp={class:"text-[2.25rem] sm:text-[2.9rem] lg:text-[3.5rem] font-extrabold leading-[1.18] sm:leading-[1.12] lg:leading-[1.1] tracking-[-0.02em] text-slate-900 dark:text-slate-100 mb-8"},$p={class:"text-[0.92em] sm:text-[1em] text-primary-dim"},Np={class:"text-[1.375rem] leading-relaxed text-slate-700 dark:text-slate-400 max-w-2xl font-light"},Ep={class:"mt-12 mb-8 flex flex-col w-full gap-4 sm:flex-row sm:items-center sm:space-x-6 sm:gap-0"},Op=["href"],Rp={class:"group-hover:underline"},zp={class:"py-24 bg-surface-container-low dark:bg-slate-900"},qp={class:"max-w-7xl mx-auto px-8"},Bp={class:"mb-16 text-center lg:text-left"},Vp={class:"text-[2.25rem] font-bold leading-[1.34] sm:leading-[1.2] tracking-tight text-slate-900 dark:text-slate-100 mb-8"},Fp={class:"text-slate-700 dark:text-slate-400 max-w-xl"},jp={class:"relative h-[350px] lg:h-auto lg:aspect-[21/9] w-full bg-surface-container-lowest rounded-[2rem] lg:rounded-full overflow-hidden outline outline-1 outline-outline-variant/10 group"},Up=["src"],Gp={class:"absolute bottom-6 left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] lg:w-auto lg:max-w-xs lg:left-12 lg:translate-x-0 lg:bottom-12 flex flex-col space-y-2 p-6 bg-white/40 backdrop-blur-md rounded-xl border border-white/20"},Hp={class:"text-xs font-bold text-primary uppercase tracking-widest dark:text-tertiary"},Wp={class:"text-sm text-slate-900 dark:text-slate-300"},Kp={id:"insights-section",class:"py-32 bg-surface dark:bg-slate-950"},Yp={class:"max-w-7xl mx-auto px-8"},Xp={class:"flex flex-col lg:flex-row gap-24 items-start"},Qp={class:"lg:sticky lg:top-32 lg:w-1/3 w-full text-center lg:text-left"},Jp={class:"text-[3rem] font-extrabold tracking-tighter leading-tight mb-6 flex items-baseline justify-center lg:justify-start gap-x-0"},Zp={class:"text-slate-700 dark:text-slate-400"},eg={class:"lg:w-2/3 space-y-32"},ng={class:"flex flex-col lg:flex-row lg:items-baseline items-start gap-4 lg:gap-6 mb-8"},tg={class:"text-[4rem] font-thin text-outline-variant leading-none"},ag={class:"text-3xl font-bold tracking-tight text-slate-900 dark:text-slate-100 text-left"},og={class:"pl-0 lg:pl-20"},ig={key:0,class:"space-y-5 mb-8 text-lg leading-relaxed text-slate-700 dark:text-slate-400"},sg={key:1,class:"text-lg leading-relaxed text-slate-700 dark:text-slate-400 mb-8"},rg={key:2,class:"mb-8 space-y-3 text-base leading-relaxed text-slate-700 dark:text-slate-400"},lg={key:3,class:"mt-4 px-6 py-3 bg-surface-container-high text-primary rounded-lg text-sm font-semibold hover:bg-surface-container-highest transition-colors"},cg={class:"py-24 bg-surface-container-low dark:bg-slate-900 px-8"},ug={class:"max-w-7xl mx-auto"},dg={class:"bg-primary-dim rounded-full p-16 lg:p-24 relative overflow-hidden group dark:bg-slate-900 dark:border dark:border-slate-800"},hg={class:"relative z-10 text-center lg:text-left"},pg={class:"text-[1.9rem] sm:text-[2.25rem] lg:text-[3.5rem] leading-[1.34] sm:leading-[1.28] lg:leading-[1.25] font-bold text-white mb-8 tracking-tighter"},gg={key:0,class:"flex flex-col sm:flex-row gap-6 justify-center lg:justify-start"},mg={key:0,class:"px-10 py-5 bg-white text-primary font-bold rounded-lg hover:bg-on-primary transition-transform active:scale-95"},fg={key:1,class:"px-10 py-5 bg-primary text-white border border-white/20 font-bold rounded-lg hover:bg-primary/80 transition-transform active:scale-95"},vg=U({__name:"HomeLayout",setup(e){const{page:n}=Ft(),{headerConfig:t,footerConfig:a}=jt();function o(){var i;typeof window>"u"||(i=document.getElementById("insights-section"))==null||i.scrollIntoView({behavior:"smooth",block:"start"})}return(i,s)=>(f(),_("div",Ap,[j(Bt,{"site-title":m(t).siteTitle||m(n).siteTitle,"nav-links":m(t).navLinks||m(n).navLinks||[],"show-subscribe":!!m(t).showSubscribe,"subscribe-button-text":m(t).subscribeButtonText,"nav-height-class":"h-20"},null,8,["site-title","nav-links","show-subscribe","subscribe-button-text"]),p("main",Cp,[p("section",Tp,[p("div",Sp,[p("div",Ip,[p("div",Dp,[p("div",{class:"absolute inset-0 opacity-20","data-alt":"Subtle geometric mesh pattern texture",style:Ba({backgroundImage:`url(${m(kp)})`})},null,4),s[0]||(s[0]=pl('<div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] flex items-center justify-center"><div class="relative w-full h-full"><div class="mesh-line mesh-line-h absolute top-[20%] left-[20%] w-[60%] h-[2px] bg-primary/20 dark:bg-slate-300/45 rotate-[-15deg] transition-all duration-1000 ease-out group-hover:top-[40%]"></div><div class="mesh-line mesh-line-h absolute top-[40%] left-[20%] w-[60%] h-[2px] bg-primary/40 dark:bg-slate-300/45 rotate-[-15deg] transition-all duration-1000 ease-out group-hover:top-[60%]"></div><div class="mesh-line mesh-line-v absolute top-[20%] left-[40%] w-[2px] h-[60%] bg-primary/30 dark:bg-slate-300/45 rotate-[10deg] transition-all duration-1000 ease-out"></div><div class="mesh-line mesh-line-v absolute top-[20%] left-[60%] w-[2px] h-[60%] bg-primary/50 dark:bg-slate-300/45 rotate-[10deg] transition-all duration-1000 ease-out"></div></div></div>',1))])]),p("div",Pp,[p("span",Mp,S(m(n).heroEyebrow),1),p("h1",Lp,[Ae(S(m(n).heroTitle),1),s[1]||(s[1]=p("br",null,null,-1)),p("span",$p,S(m(n).heroTitleHighlight),1)]),p("p",Np,S(m(n).heroDescription),1),p("div",Ep,[m(n).heroPrimaryButton?(f(),_("button",{key:0,class:"w-full sm:w-auto px-8 py-4 bg-primary text-on-primary rounded-lg font-medium hover:bg-primary-dim dark:bg-[#f7f9fb] dark:text-[#0f172a] dark:hover:bg-[#ffffff] transition-all hover:scale-[1.02] active:scale-95",onClick:o},S(m(n).heroPrimaryButton),1)):q("",!0),m(n).heroSecondaryButton?(f(),_("a",{key:1,class:"group w-full sm:w-auto flex items-center justify-center sm:justify-start space-x-2 text-tertiary font-medium px-8 py-4 rounded-lg",href:m(n).heroSecondaryButtonHref||"/blog/"},[p("span",Rp,S(m(n).heroSecondaryButton),1),s[2]||(s[2]=p("span",{class:"material-symbols-outlined text-sm"},"arrow_forward",-1))],8,Op)):q("",!0)])])])]),p("section",zp,[p("div",qp,[p("div",Bp,[p("h2",Vp,S(m(n).structureTitle),1),p("p",Fp,S(m(n).structureDescription),1)]),p("div",jp,[p("img",{alt:"Architectural Mesh Diagram",class:"w-full h-full object-cover opacity-90 transition-transform duration-700 group-hover:scale-105","data-alt":"Digital blue circuit mesh representing neural network topology",src:m(xp)},null,8,Up),s[3]||(s[3]=p("div",{class:"absolute inset-0 bg-gradient-to-t from-surface-container-lowest via-transparent to-transparent opacity-60"},null,-1)),p("div",Gp,[p("span",Hp,S(m(n).structureCardTitle),1),p("p",Wp,S(m(n).structureCardDescription),1)])])])]),p("section",Kp,[p("div",Yp,[p("div",Xp,[p("div",Qp,[p("h2",Jp,[p("span",null,S(m(n).insightsTitleLine1),1),p("span",null,[Ae(S(m(n).insightsTitleLine2),1),s[4]||(s[4]=p("span",{class:"text-tertiary"},".",-1))])]),p("p",Zp,S(m(n).insightsSubtitle),1)]),p("div",eg,[(f(!0),_(Z,null,ie(m(n).insights||[],r=>{var l,c;return f(),_("div",{key:r.index,class:"group"},[p("div",ng,[p("span",tg,S(r.index),1),p("h3",ag,S(r.title),1)]),p("div",og,[(l=r.paragraphs)!=null&&l.length?(f(),_("div",ig,[(f(!0),_(Z,null,ie(r.paragraphs,d=>(f(),_("p",{key:d},S(d),1))),128))])):r.description?(f(),_("p",sg,S(r.description),1)):q("",!0),(c=r.listItems)!=null&&c.length?(f(),_("ul",rg,[(f(!0),_(Z,null,ie(r.listItems,d=>(f(),_("li",{key:d,class:"flex gap-3"},[s[5]||(s[5]=p("span",{class:"mt-2 h-2 w-2 shrink-0 rounded-full bg-tertiary"},null,-1)),p("span",null,S(d),1)]))),128))])):q("",!0),r.buttonText?(f(),_("button",lg,S(r.buttonText),1)):q("",!0)])])}),128))])])])]),p("section",cg,[p("div",ug,[p("div",dg,[s[6]||(s[6]=p("div",{class:"absolute top-0 right-0 w-1/2 h-full opacity-10 pointer-events-none"},[p("svg",{class:"w-full h-full scale-150 rotate-45",viewBox:"0 0 200 200",xmlns:"http://www.w3.org/2000/svg"},[p("path",{d:"M44.7,-76.4C58.1,-69.2,70.3,-58.5,78.4,-45.3C86.5,-32.1,90.4,-16,88.4,-0.6C86.5,14.8,78.6,29.6,69.5,42.4C60.4,55.1,50.1,65.8,37.5,72.6C24.9,79.5,10,82.5,-4.1,89.5C-18.1,96.6,-31.2,107.7,-43.3,105.7C-55.3,103.7,-66.2,88.5,-73.4,73.5C-80.6,58.4,-84.1,43.5,-86.3,28.9C-88.5,14.2,-89.4,-0.2,-86.3,-13.7C-83.2,-27.2,-76.1,-39.8,-66.5,-50.2C-56.9,-60.7,-44.8,-69.1,-32.2,-76.7C-19.6,-84.4,-6.5,-91.3,7.6,-104.4C21.7,-117.5,31.3,-83.6,44.7,-76.4Z",fill:"#FFFFFF",transform:"translate(100 100)"})])],-1)),p("div",hg,[p("h2",pg,S(m(n).ctaTitle),1),m(n).ctaPrimaryButton||m(n).ctaSecondaryButton?(f(),_("div",gg,[m(n).ctaPrimaryButton?(f(),_("button",mg,S(m(n).ctaPrimaryButton),1)):q("",!0),m(n).ctaSecondaryButton?(f(),_("button",fg,S(m(n).ctaSecondaryButton),1)):q("",!0)])):q("",!0)])])])])]),j(Vt,{title:m(a).title||m(n).footerTitle,description:m(a).description||m(n).footerDescription,links:m(a).links||m(n).footerLinks||[],filing:m(a).filing||null,"social-icons":m(a).socialIcons||[]},null,8,["title","description","links","filing","social-icons"])]))}}),Xa=`---
layout: about-me
heroEyebrow: 关于我
heroTitle: 技能“网”
...
---
`;function rt(e,n){return e==null||n==null?NaN:e<n?-1:e>n?1:e>=n?0:NaN}function bg(e,n){return e==null||n==null?NaN:n<e?-1:n>e?1:n>=e?0:NaN}function li(e){let n,t,a;e.length!==2?(n=rt,t=(r,l)=>rt(e(r),l),a=(r,l)=>e(r)-l):(n=e===rt||e===bg?e:yg,t=e,a=e);function o(r,l,c=0,d=r.length){if(c<d){if(n(l,l)!==0)return d;do{const g=c+d>>>1;t(r[g],l)<0?c=g+1:d=g}while(c<d)}return c}function i(r,l,c=0,d=r.length){if(c<d){if(n(l,l)!==0)return d;do{const g=c+d>>>1;t(r[g],l)<=0?c=g+1:d=g}while(c<d)}return c}function s(r,l,c=0,d=r.length){const g=o(r,l,c,d-1);return g>c&&a(r[g-1],l)>-a(r[g],l)?g-1:g}return{left:o,center:s,right:i}}function yg(){return 0}function wg(e){return e===null?NaN:+e}const _g=li(rt),kg=_g.right;li(wg).center;class $i extends Map{constructor(n,t=Cg){if(super(),Object.defineProperties(this,{_intern:{value:new Map},_key:{value:t}}),n!=null)for(const[a,o]of n)this.set(a,o)}get(n){return super.get(Ni(this,n))}has(n){return super.has(Ni(this,n))}set(n,t){return super.set(xg(this,n),t)}delete(n){return super.delete(Ag(this,n))}}function Ni({_intern:e,_key:n},t){const a=n(t);return e.has(a)?e.get(a):t}function xg({_intern:e,_key:n},t){const a=n(t);return e.has(a)?e.get(a):(e.set(a,t),t)}function Ag({_intern:e,_key:n},t){const a=n(t);return e.has(a)&&(t=e.get(a),e.delete(a)),t}function Cg(e){return e!==null&&typeof e=="object"?e.valueOf():e}const Tg=Math.sqrt(50),Sg=Math.sqrt(10),Ig=Math.sqrt(2);function gt(e,n,t){const a=(n-e)/Math.max(0,t),o=Math.floor(Math.log10(a)),i=a/Math.pow(10,o),s=i>=Tg?10:i>=Sg?5:i>=Ig?2:1;let r,l,c;return o<0?(c=Math.pow(10,-o)/s,r=Math.round(e*c),l=Math.round(n*c),r/c<e&&++r,l/c>n&&--l,c=-c):(c=Math.pow(10,o)*s,r=Math.round(e/c),l=Math.round(n/c),r*c<e&&++r,l*c>n&&--l),l<r&&.5<=t&&t<2?gt(e,n,t*2):[r,l,c]}function Dg(e,n,t){if(n=+n,e=+e,t=+t,!(t>0))return[];if(e===n)return[e];const a=n<e,[o,i,s]=a?gt(n,e,t):gt(e,n,t);if(!(i>=o))return[];const r=i-o+1,l=new Array(r);if(a)if(s<0)for(let c=0;c<r;++c)l[c]=(i-c)/-s;else for(let c=0;c<r;++c)l[c]=(i-c)*s;else if(s<0)for(let c=0;c<r;++c)l[c]=(o+c)/-s;else for(let c=0;c<r;++c)l[c]=(o+c)*s;return l}function _a(e,n,t){return n=+n,e=+e,t=+t,gt(e,n,t)[2]}function ka(e,n,t){n=+n,e=+e,t=+t;const a=n<e,o=a?_a(n,e,t):_a(e,n,t);return(a?-1:1)*(o<0?1/-o:o)}function rk(e,n){let t;if(n===void 0)for(const a of e)a!=null&&(t<a||t===void 0&&a>=a)&&(t=a);else{let a=-1;for(let o of e)(o=n(o,++a,e))!=null&&(t<o||t===void 0&&o>=o)&&(t=o)}return t}function lk(e,n){let t;if(n===void 0)for(const a of e)a!=null&&(t>a||t===void 0&&a>=a)&&(t=a);else{let a=-1;for(let o of e)(o=n(o,++a,e))!=null&&(t>o||t===void 0&&o>=o)&&(t=o)}return t}function Pg(e,n,t){e=+e,n=+n,t=(o=arguments.length)<2?(n=e,e=0,1):o<3?1:+t;for(var a=-1,o=Math.max(0,Math.ceil((n-e)/t))|0,i=new Array(o);++a<o;)i[a]=e+a*t;return i}function Mg(e){return e}var lt=1,na=2,xa=3,Zn=4,Ei=1e-6;function Lg(e){return"translate("+e+",0)"}function $g(e){return"translate(0,"+e+")"}function Ng(e){return n=>+e(n)}function Eg(e,n){return n=Math.max(0,e.bandwidth()-n*2)/2,e.round()&&(n=Math.round(n)),t=>+e(t)+n}function Og(){return!this.__axis}function Vs(e,n){var t=[],a=null,o=null,i=6,s=6,r=3,l=typeof window<"u"&&window.devicePixelRatio>1?0:.5,c=e===lt||e===Zn?-1:1,d=e===Zn||e===na?"x":"y",g=e===lt||e===xa?Lg:$g;function u(h){var v=a??(n.ticks?n.ticks.apply(n,t):n.domain()),b=o??(n.tickFormat?n.tickFormat.apply(n,t):Mg),w=Math.max(i,0)+r,x=n.range(),A=+x[0]+l,M=+x[x.length-1]+l,y=(n.bandwidth?Eg:Ng)(n.copy(),l),T=h.selection?h.selection():h,k=T.selectAll(".domain").data([null]),E=T.selectAll(".tick").data(v,n).order(),V=E.exit(),W=E.enter().append("g").attr("class","tick"),F=E.select("line"),$=E.select("text");k=k.merge(k.enter().insert("path",".tick").attr("class","domain").attr("stroke","currentColor")),E=E.merge(W),F=F.merge(W.append("line").attr("stroke","currentColor").attr(d+"2",c*i)),$=$.merge(W.append("text").attr("fill","currentColor").attr(d,c*w).attr("dy",e===lt?"0em":e===xa?"0.71em":"0.32em")),h!==T&&(k=k.transition(h),E=E.transition(h),F=F.transition(h),$=$.transition(h),V=V.transition(h).attr("opacity",Ei).attr("transform",function(P){return isFinite(P=y(P))?g(P+l):this.getAttribute("transform")}),W.attr("opacity",Ei).attr("transform",function(P){var L=this.parentNode.__axis;return g((L&&isFinite(L=L(P))?L:y(P))+l)})),V.remove(),k.attr("d",e===Zn||e===na?s?"M"+c*s+","+A+"H"+l+"V"+M+"H"+c*s:"M"+l+","+A+"V"+M:s?"M"+A+","+c*s+"V"+l+"H"+M+"V"+c*s:"M"+A+","+l+"H"+M),E.attr("opacity",1).attr("transform",function(P){return g(y(P)+l)}),F.attr(d+"2",c*i),$.attr(d,c*w).text(b),T.filter(Og).attr("fill","none").attr("font-size",10).attr("font-family","sans-serif").attr("text-anchor",e===na?"start":e===Zn?"end":"middle"),T.each(function(){this.__axis=y})}return u.scale=function(h){return arguments.length?(n=h,u):n},u.ticks=function(){return t=Array.from(arguments),u},u.tickArguments=function(h){return arguments.length?(t=h==null?[]:Array.from(h),u):t.slice()},u.tickValues=function(h){return arguments.length?(a=h==null?null:Array.from(h),u):a&&a.slice()},u.tickFormat=function(h){return arguments.length?(o=h,u):o},u.tickSize=function(h){return arguments.length?(i=s=+h,u):i},u.tickSizeInner=function(h){return arguments.length?(i=+h,u):i},u.tickSizeOuter=function(h){return arguments.length?(s=+h,u):s},u.tickPadding=function(h){return arguments.length?(r=+h,u):r},u.offset=function(h){return arguments.length?(l=+h,u):l},u}function ck(e){return Vs(lt,e)}function uk(e){return Vs(xa,e)}var Rg={value:()=>{}};function Ut(){for(var e=0,n=arguments.length,t={},a;e<n;++e){if(!(a=arguments[e]+"")||a in t||/[\s.]/.test(a))throw new Error("illegal type: "+a);t[a]=[]}return new ct(t)}function ct(e){this._=e}function zg(e,n){return e.trim().split(/^|\s+/).map(function(t){var a="",o=t.indexOf(".");if(o>=0&&(a=t.slice(o+1),t=t.slice(0,o)),t&&!n.hasOwnProperty(t))throw new Error("unknown type: "+t);return{type:t,name:a}})}ct.prototype=Ut.prototype={constructor:ct,on:function(e,n){var t=this._,a=zg(e+"",t),o,i=-1,s=a.length;if(arguments.length<2){for(;++i<s;)if((o=(e=a[i]).type)&&(o=qg(t[o],e.name)))return o;return}if(n!=null&&typeof n!="function")throw new Error("invalid callback: "+n);for(;++i<s;)if(o=(e=a[i]).type)t[o]=Oi(t[o],e.name,n);else if(n==null)for(o in t)t[o]=Oi(t[o],e.name,null);return this},copy:function(){var e={},n=this._;for(var t in n)e[t]=n[t].slice();return new ct(e)},call:function(e,n){if((o=arguments.length-2)>0)for(var t=new Array(o),a=0,o,i;a<o;++a)t[a]=arguments[a+2];if(!this._.hasOwnProperty(e))throw new Error("unknown type: "+e);for(i=this._[e],a=0,o=i.length;a<o;++a)i[a].value.apply(n,t)},apply:function(e,n,t){if(!this._.hasOwnProperty(e))throw new Error("unknown type: "+e);for(var a=this._[e],o=0,i=a.length;o<i;++o)a[o].value.apply(n,t)}};function qg(e,n){for(var t=0,a=e.length,o;t<a;++t)if((o=e[t]).name===n)return o.value}function Oi(e,n,t){for(var a=0,o=e.length;a<o;++a)if(e[a].name===n){e[a]=Rg,e=e.slice(0,a).concat(e.slice(a+1));break}return t!=null&&e.push({name:n,value:t}),e}var Aa="http://www.w3.org/1999/xhtml";const Ri={svg:"http://www.w3.org/2000/svg",xhtml:Aa,xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"};function Gt(e){var n=e+="",t=n.indexOf(":");return t>=0&&(n=e.slice(0,t))!=="xmlns"&&(e=e.slice(t+1)),Ri.hasOwnProperty(n)?{space:Ri[n],local:e}:e}function Bg(e){return function(){var n=this.ownerDocument,t=this.namespaceURI;return t===Aa&&n.documentElement.namespaceURI===Aa?n.createElement(e):n.createElementNS(t,e)}}function Vg(e){return function(){return this.ownerDocument.createElementNS(e.space,e.local)}}function Fs(e){var n=Gt(e);return(n.local?Vg:Bg)(n)}function Fg(){}function ci(e){return e==null?Fg:function(){return this.querySelector(e)}}function jg(e){typeof e!="function"&&(e=ci(e));for(var n=this._groups,t=n.length,a=new Array(t),o=0;o<t;++o)for(var i=n[o],s=i.length,r=a[o]=new Array(s),l,c,d=0;d<s;++d)(l=i[d])&&(c=e.call(l,l.__data__,d,i))&&("__data__"in l&&(c.__data__=l.__data__),r[d]=c);return new De(a,this._parents)}function Ug(e){return e==null?[]:Array.isArray(e)?e:Array.from(e)}function Gg(){return[]}function js(e){return e==null?Gg:function(){return this.querySelectorAll(e)}}function Hg(e){return function(){return Ug(e.apply(this,arguments))}}function Wg(e){typeof e=="function"?e=Hg(e):e=js(e);for(var n=this._groups,t=n.length,a=[],o=[],i=0;i<t;++i)for(var s=n[i],r=s.length,l,c=0;c<r;++c)(l=s[c])&&(a.push(e.call(l,l.__data__,c,s)),o.push(l));return new De(a,o)}function Us(e){return function(){return this.matches(e)}}function Gs(e){return function(n){return n.matches(e)}}var Kg=Array.prototype.find;function Yg(e){return function(){return Kg.call(this.children,e)}}function Xg(){return this.firstElementChild}function Qg(e){return this.select(e==null?Xg:Yg(typeof e=="function"?e:Gs(e)))}var Jg=Array.prototype.filter;function Zg(){return Array.from(this.children)}function em(e){return function(){return Jg.call(this.children,e)}}function nm(e){return this.selectAll(e==null?Zg:em(typeof e=="function"?e:Gs(e)))}function tm(e){typeof e!="function"&&(e=Us(e));for(var n=this._groups,t=n.length,a=new Array(t),o=0;o<t;++o)for(var i=n[o],s=i.length,r=a[o]=[],l,c=0;c<s;++c)(l=i[c])&&e.call(l,l.__data__,c,i)&&r.push(l);return new De(a,this._parents)}function Hs(e){return new Array(e.length)}function am(){return new De(this._enter||this._groups.map(Hs),this._parents)}function mt(e,n){this.ownerDocument=e.ownerDocument,this.namespaceURI=e.namespaceURI,this._next=null,this._parent=e,this.__data__=n}mt.prototype={constructor:mt,appendChild:function(e){return this._parent.insertBefore(e,this._next)},insertBefore:function(e,n){return this._parent.insertBefore(e,n)},querySelector:function(e){return this._parent.querySelector(e)},querySelectorAll:function(e){return this._parent.querySelectorAll(e)}};function om(e){return function(){return e}}function im(e,n,t,a,o,i){for(var s=0,r,l=n.length,c=i.length;s<c;++s)(r=n[s])?(r.__data__=i[s],a[s]=r):t[s]=new mt(e,i[s]);for(;s<l;++s)(r=n[s])&&(o[s]=r)}function sm(e,n,t,a,o,i,s){var r,l,c=new Map,d=n.length,g=i.length,u=new Array(d),h;for(r=0;r<d;++r)(l=n[r])&&(u[r]=h=s.call(l,l.__data__,r,n)+"",c.has(h)?o[r]=l:c.set(h,l));for(r=0;r<g;++r)h=s.call(e,i[r],r,i)+"",(l=c.get(h))?(a[r]=l,l.__data__=i[r],c.delete(h)):t[r]=new mt(e,i[r]);for(r=0;r<d;++r)(l=n[r])&&c.get(u[r])===l&&(o[r]=l)}function rm(e){return e.__data__}function lm(e,n){if(!arguments.length)return Array.from(this,rm);var t=n?sm:im,a=this._parents,o=this._groups;typeof e!="function"&&(e=om(e));for(var i=o.length,s=new Array(i),r=new Array(i),l=new Array(i),c=0;c<i;++c){var d=a[c],g=o[c],u=g.length,h=cm(e.call(d,d&&d.__data__,c,a)),v=h.length,b=r[c]=new Array(v),w=s[c]=new Array(v),x=l[c]=new Array(u);t(d,g,b,w,x,h,n);for(var A=0,M=0,y,T;A<v;++A)if(y=b[A]){for(A>=M&&(M=A+1);!(T=w[M])&&++M<v;);y._next=T||null}}return s=new De(s,a),s._enter=r,s._exit=l,s}function cm(e){return typeof e=="object"&&"length"in e?e:Array.from(e)}function um(){return new De(this._exit||this._groups.map(Hs),this._parents)}function dm(e,n,t){var a=this.enter(),o=this,i=this.exit();return typeof e=="function"?(a=e(a),a&&(a=a.selection())):a=a.append(e+""),n!=null&&(o=n(o),o&&(o=o.selection())),t==null?i.remove():t(i),a&&o?a.merge(o).order():o}function hm(e){for(var n=e.selection?e.selection():e,t=this._groups,a=n._groups,o=t.length,i=a.length,s=Math.min(o,i),r=new Array(o),l=0;l<s;++l)for(var c=t[l],d=a[l],g=c.length,u=r[l]=new Array(g),h,v=0;v<g;++v)(h=c[v]||d[v])&&(u[v]=h);for(;l<o;++l)r[l]=t[l];return new De(r,this._parents)}function pm(){for(var e=this._groups,n=-1,t=e.length;++n<t;)for(var a=e[n],o=a.length-1,i=a[o],s;--o>=0;)(s=a[o])&&(i&&s.compareDocumentPosition(i)^4&&i.parentNode.insertBefore(s,i),i=s);return this}function gm(e){e||(e=mm);function n(g,u){return g&&u?e(g.__data__,u.__data__):!g-!u}for(var t=this._groups,a=t.length,o=new Array(a),i=0;i<a;++i){for(var s=t[i],r=s.length,l=o[i]=new Array(r),c,d=0;d<r;++d)(c=s[d])&&(l[d]=c);l.sort(n)}return new De(o,this._parents).order()}function mm(e,n){return e<n?-1:e>n?1:e>=n?0:NaN}function fm(){var e=arguments[0];return arguments[0]=this,e.apply(null,arguments),this}function vm(){return Array.from(this)}function bm(){for(var e=this._groups,n=0,t=e.length;n<t;++n)for(var a=e[n],o=0,i=a.length;o<i;++o){var s=a[o];if(s)return s}return null}function ym(){let e=0;for(const n of this)++e;return e}function wm(){return!this.node()}function _m(e){for(var n=this._groups,t=0,a=n.length;t<a;++t)for(var o=n[t],i=0,s=o.length,r;i<s;++i)(r=o[i])&&e.call(r,r.__data__,i,o);return this}function km(e){return function(){this.removeAttribute(e)}}function xm(e){return function(){this.removeAttributeNS(e.space,e.local)}}function Am(e,n){return function(){this.setAttribute(e,n)}}function Cm(e,n){return function(){this.setAttributeNS(e.space,e.local,n)}}function Tm(e,n){return function(){var t=n.apply(this,arguments);t==null?this.removeAttribute(e):this.setAttribute(e,t)}}function Sm(e,n){return function(){var t=n.apply(this,arguments);t==null?this.removeAttributeNS(e.space,e.local):this.setAttributeNS(e.space,e.local,t)}}function Im(e,n){var t=Gt(e);if(arguments.length<2){var a=this.node();return t.local?a.getAttributeNS(t.space,t.local):a.getAttribute(t)}return this.each((n==null?t.local?xm:km:typeof n=="function"?t.local?Sm:Tm:t.local?Cm:Am)(t,n))}function Ws(e){return e.ownerDocument&&e.ownerDocument.defaultView||e.document&&e||e.defaultView}function Dm(e){return function(){this.style.removeProperty(e)}}function Pm(e,n,t){return function(){this.style.setProperty(e,n,t)}}function Mm(e,n,t){return function(){var a=n.apply(this,arguments);a==null?this.style.removeProperty(e):this.style.setProperty(e,a,t)}}function Lm(e,n,t){return arguments.length>1?this.each((n==null?Dm:typeof n=="function"?Mm:Pm)(e,n,t??"")):Tn(this.node(),e)}function Tn(e,n){return e.style.getPropertyValue(n)||Ws(e).getComputedStyle(e,null).getPropertyValue(n)}function $m(e){return function(){delete this[e]}}function Nm(e,n){return function(){this[e]=n}}function Em(e,n){return function(){var t=n.apply(this,arguments);t==null?delete this[e]:this[e]=t}}function Om(e,n){return arguments.length>1?this.each((n==null?$m:typeof n=="function"?Em:Nm)(e,n)):this.node()[e]}function Ks(e){return e.trim().split(/^|\s+/)}function ui(e){return e.classList||new Ys(e)}function Ys(e){this._node=e,this._names=Ks(e.getAttribute("class")||"")}Ys.prototype={add:function(e){var n=this._names.indexOf(e);n<0&&(this._names.push(e),this._node.setAttribute("class",this._names.join(" ")))},remove:function(e){var n=this._names.indexOf(e);n>=0&&(this._names.splice(n,1),this._node.setAttribute("class",this._names.join(" ")))},contains:function(e){return this._names.indexOf(e)>=0}};function Xs(e,n){for(var t=ui(e),a=-1,o=n.length;++a<o;)t.add(n[a])}function Qs(e,n){for(var t=ui(e),a=-1,o=n.length;++a<o;)t.remove(n[a])}function Rm(e){return function(){Xs(this,e)}}function zm(e){return function(){Qs(this,e)}}function qm(e,n){return function(){(n.apply(this,arguments)?Xs:Qs)(this,e)}}function Bm(e,n){var t=Ks(e+"");if(arguments.length<2){for(var a=ui(this.node()),o=-1,i=t.length;++o<i;)if(!a.contains(t[o]))return!1;return!0}return this.each((typeof n=="function"?qm:n?Rm:zm)(t,n))}function Vm(){this.textContent=""}function Fm(e){return function(){this.textContent=e}}function jm(e){return function(){var n=e.apply(this,arguments);this.textContent=n??""}}function Um(e){return arguments.length?this.each(e==null?Vm:(typeof e=="function"?jm:Fm)(e)):this.node().textContent}function Gm(){this.innerHTML=""}function Hm(e){return function(){this.innerHTML=e}}function Wm(e){return function(){var n=e.apply(this,arguments);this.innerHTML=n??""}}function Km(e){return arguments.length?this.each(e==null?Gm:(typeof e=="function"?Wm:Hm)(e)):this.node().innerHTML}function Ym(){this.nextSibling&&this.parentNode.appendChild(this)}function Xm(){return this.each(Ym)}function Qm(){this.previousSibling&&this.parentNode.insertBefore(this,this.parentNode.firstChild)}function Jm(){return this.each(Qm)}function Zm(e){var n=typeof e=="function"?e:Fs(e);return this.select(function(){return this.appendChild(n.apply(this,arguments))})}function ef(){return null}function nf(e,n){var t=typeof e=="function"?e:Fs(e),a=n==null?ef:typeof n=="function"?n:ci(n);return this.select(function(){return this.insertBefore(t.apply(this,arguments),a.apply(this,arguments)||null)})}function tf(){var e=this.parentNode;e&&e.removeChild(this)}function af(){return this.each(tf)}function of(){var e=this.cloneNode(!1),n=this.parentNode;return n?n.insertBefore(e,this.nextSibling):e}function sf(){var e=this.cloneNode(!0),n=this.parentNode;return n?n.insertBefore(e,this.nextSibling):e}function rf(e){return this.select(e?sf:of)}function lf(e){return arguments.length?this.property("__data__",e):this.node().__data__}function cf(e){return function(n){e.call(this,n,this.__data__)}}function uf(e){return e.trim().split(/^|\s+/).map(function(n){var t="",a=n.indexOf(".");return a>=0&&(t=n.slice(a+1),n=n.slice(0,a)),{type:n,name:t}})}function df(e){return function(){var n=this.__on;if(n){for(var t=0,a=-1,o=n.length,i;t<o;++t)i=n[t],(!e.type||i.type===e.type)&&i.name===e.name?this.removeEventListener(i.type,i.listener,i.options):n[++a]=i;++a?n.length=a:delete this.__on}}}function hf(e,n,t){return function(){var a=this.__on,o,i=cf(n);if(a){for(var s=0,r=a.length;s<r;++s)if((o=a[s]).type===e.type&&o.name===e.name){this.removeEventListener(o.type,o.listener,o.options),this.addEventListener(o.type,o.listener=i,o.options=t),o.value=n;return}}this.addEventListener(e.type,i,t),o={type:e.type,name:e.name,value:n,listener:i,options:t},a?a.push(o):this.__on=[o]}}function pf(e,n,t){var a=uf(e+""),o,i=a.length,s;if(arguments.length<2){var r=this.node().__on;if(r){for(var l=0,c=r.length,d;l<c;++l)for(o=0,d=r[l];o<i;++o)if((s=a[o]).type===d.type&&s.name===d.name)return d.value}return}for(r=n?hf:df,o=0;o<i;++o)this.each(r(a[o],n,t));return this}function Js(e,n,t){var a=Ws(e),o=a.CustomEvent;typeof o=="function"?o=new o(n,t):(o=a.document.createEvent("Event"),t?(o.initEvent(n,t.bubbles,t.cancelable),o.detail=t.detail):o.initEvent(n,!1,!1)),e.dispatchEvent(o)}function gf(e,n){return function(){return Js(this,e,n)}}function mf(e,n){return function(){return Js(this,e,n.apply(this,arguments))}}function ff(e,n){return this.each((typeof n=="function"?mf:gf)(e,n))}function*vf(){for(var e=this._groups,n=0,t=e.length;n<t;++n)for(var a=e[n],o=0,i=a.length,s;o<i;++o)(s=a[o])&&(yield s)}var Zs=[null];function De(e,n){this._groups=e,this._parents=n}function Xn(){return new De([[document.documentElement]],Zs)}function bf(){return this}De.prototype=Xn.prototype={constructor:De,select:jg,selectAll:Wg,selectChild:Qg,selectChildren:nm,filter:tm,data:lm,enter:am,exit:um,join:dm,merge:hm,selection:bf,order:pm,sort:gm,call:fm,nodes:vm,node:bm,size:ym,empty:wm,each:_m,attr:Im,style:Lm,property:Om,classed:Bm,text:Um,html:Km,raise:Xm,lower:Jm,append:Zm,insert:nf,remove:af,clone:rf,datum:lf,on:pf,dispatch:ff,[Symbol.iterator]:vf};function ln(e){return typeof e=="string"?new De([[document.querySelector(e)]],[document.documentElement]):new De([[e]],Zs)}function yf(e){let n;for(;n=e.sourceEvent;)e=n;return e}function zi(e,n){if(e=yf(e),n===void 0&&(n=e.currentTarget),n){var t=n.ownerSVGElement||n;if(t.createSVGPoint){var a=t.createSVGPoint();return a.x=e.clientX,a.y=e.clientY,a=a.matrixTransform(n.getScreenCTM().inverse()),[a.x,a.y]}if(n.getBoundingClientRect){var o=n.getBoundingClientRect();return[e.clientX-o.left-n.clientLeft,e.clientY-o.top-n.clientTop]}}return[e.pageX,e.pageY]}const wf={passive:!1},jn={capture:!0,passive:!1};function ta(e){e.stopImmediatePropagation()}function xn(e){e.preventDefault(),e.stopImmediatePropagation()}function _f(e){var n=e.document.documentElement,t=ln(e).on("dragstart.drag",xn,jn);"onselectstart"in n?t.on("selectstart.drag",xn,jn):(n.__noselect=n.style.MozUserSelect,n.style.MozUserSelect="none")}function kf(e,n){var t=e.document.documentElement,a=ln(e).on("dragstart.drag",null);n&&(a.on("click.drag",xn,jn),setTimeout(function(){a.on("click.drag",null)},0)),"onselectstart"in t?a.on("selectstart.drag",null):(t.style.MozUserSelect=t.__noselect,delete t.__noselect)}const et=e=>()=>e;function Ca(e,{sourceEvent:n,subject:t,target:a,identifier:o,active:i,x:s,y:r,dx:l,dy:c,dispatch:d}){Object.defineProperties(this,{type:{value:e,enumerable:!0,configurable:!0},sourceEvent:{value:n,enumerable:!0,configurable:!0},subject:{value:t,enumerable:!0,configurable:!0},target:{value:a,enumerable:!0,configurable:!0},identifier:{value:o,enumerable:!0,configurable:!0},active:{value:i,enumerable:!0,configurable:!0},x:{value:s,enumerable:!0,configurable:!0},y:{value:r,enumerable:!0,configurable:!0},dx:{value:l,enumerable:!0,configurable:!0},dy:{value:c,enumerable:!0,configurable:!0},_:{value:d}})}Ca.prototype.on=function(){var e=this._.on.apply(this._,arguments);return e===this._?this:e};function xf(e){return!e.ctrlKey&&!e.button}function Af(){return this.parentNode}function Cf(e,n){return n??{x:e.x,y:e.y}}function Tf(){return navigator.maxTouchPoints||"ontouchstart"in this}function Sf(){var e=xf,n=Af,t=Cf,a=Tf,o={},i=Ut("start","drag","end"),s=0,r,l,c,d,g=0;function u(y){y.on("mousedown.drag",h).filter(a).on("touchstart.drag",w).on("touchmove.drag",x,wf).on("touchend.drag touchcancel.drag",A).style("touch-action","none").style("-webkit-tap-highlight-color","rgba(0,0,0,0)")}function h(y,T){if(!(d||!e.call(this,y,T))){var k=M(this,n.call(this,y,T),y,T,"mouse");k&&(ln(y.view).on("mousemove.drag",v,jn).on("mouseup.drag",b,jn),_f(y.view),ta(y),c=!1,r=y.clientX,l=y.clientY,k("start",y))}}function v(y){if(xn(y),!c){var T=y.clientX-r,k=y.clientY-l;c=T*T+k*k>g}o.mouse("drag",y)}function b(y){ln(y.view).on("mousemove.drag mouseup.drag",null),kf(y.view,c),xn(y),o.mouse("end",y)}function w(y,T){if(e.call(this,y,T)){var k=y.changedTouches,E=n.call(this,y,T),V=k.length,W,F;for(W=0;W<V;++W)(F=M(this,E,y,T,k[W].identifier,k[W]))&&(ta(y),F("start",y,k[W]))}}function x(y){var T=y.changedTouches,k=T.length,E,V;for(E=0;E<k;++E)(V=o[T[E].identifier])&&(xn(y),V("drag",y,T[E]))}function A(y){var T=y.changedTouches,k=T.length,E,V;for(d&&clearTimeout(d),d=setTimeout(function(){d=null},500),E=0;E<k;++E)(V=o[T[E].identifier])&&(ta(y),V("end",y,T[E]))}function M(y,T,k,E,V,W){var F=i.copy(),$=zi(W||k,T),P,L,z;if((z=t.call(y,new Ca("beforestart",{sourceEvent:k,target:u,identifier:V,active:s,x:$[0],y:$[1],dx:0,dy:0,dispatch:F}),E))!=null)return P=z.x-$[0]||0,L=z.y-$[1]||0,function te(ee,K,re){var de=$,ue;switch(ee){case"start":o[V]=te,ue=s++;break;case"end":delete o[V],--s;case"drag":$=zi(re||K,T),ue=s;break}F.call(ee,y,new Ca(ee,{sourceEvent:K,subject:z,target:u,identifier:V,active:ue,x:$[0]+P,y:$[1]+L,dx:$[0]-de[0],dy:$[1]-de[1],dispatch:F}),E)}}return u.filter=function(y){return arguments.length?(e=typeof y=="function"?y:et(!!y),u):e},u.container=function(y){return arguments.length?(n=typeof y=="function"?y:et(y),u):n},u.subject=function(y){return arguments.length?(t=typeof y=="function"?y:et(y),u):t},u.touchable=function(y){return arguments.length?(a=typeof y=="function"?y:et(!!y),u):a},u.on=function(){var y=i.on.apply(i,arguments);return y===i?u:y},u.clickDistance=function(y){return arguments.length?(g=(y=+y)*y,u):Math.sqrt(g)},u}function Qn(e,n,t){e.prototype=n.prototype=t,t.constructor=e}function Ht(e,n){var t=Object.create(e.prototype);for(var a in n)t[a]=n[a];return t}function fn(){}var Un=.7,ft=1/Un,An="\\s*([+-]?\\d+)\\s*",Gn="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*",Be="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",If=/^#([0-9a-f]{3,8})$/,Df=new RegExp(`^rgb\\(${An},${An},${An}\\)$`),Pf=new RegExp(`^rgb\\(${Be},${Be},${Be}\\)$`),Mf=new RegExp(`^rgba\\(${An},${An},${An},${Gn}\\)$`),Lf=new RegExp(`^rgba\\(${Be},${Be},${Be},${Gn}\\)$`),$f=new RegExp(`^hsl\\(${Gn},${Be},${Be}\\)$`),Nf=new RegExp(`^hsla\\(${Gn},${Be},${Be},${Gn}\\)$`),qi={aliceblue:15792383,antiquewhite:16444375,aqua:65535,aquamarine:8388564,azure:15794175,beige:16119260,bisque:16770244,black:0,blanchedalmond:16772045,blue:255,blueviolet:9055202,brown:10824234,burlywood:14596231,cadetblue:6266528,chartreuse:8388352,chocolate:13789470,coral:16744272,cornflowerblue:6591981,cornsilk:16775388,crimson:14423100,cyan:65535,darkblue:139,darkcyan:35723,darkgoldenrod:12092939,darkgray:11119017,darkgreen:25600,darkgrey:11119017,darkkhaki:12433259,darkmagenta:9109643,darkolivegreen:5597999,darkorange:16747520,darkorchid:10040012,darkred:9109504,darksalmon:15308410,darkseagreen:9419919,darkslateblue:4734347,darkslategray:3100495,darkslategrey:3100495,darkturquoise:52945,darkviolet:9699539,deeppink:16716947,deepskyblue:49151,dimgray:6908265,dimgrey:6908265,dodgerblue:2003199,firebrick:11674146,floralwhite:16775920,forestgreen:2263842,fuchsia:16711935,gainsboro:14474460,ghostwhite:16316671,gold:16766720,goldenrod:14329120,gray:8421504,green:32768,greenyellow:11403055,grey:8421504,honeydew:15794160,hotpink:16738740,indianred:13458524,indigo:4915330,ivory:16777200,khaki:15787660,lavender:15132410,lavenderblush:16773365,lawngreen:8190976,lemonchiffon:16775885,lightblue:11393254,lightcoral:15761536,lightcyan:14745599,lightgoldenrodyellow:16448210,lightgray:13882323,lightgreen:9498256,lightgrey:13882323,lightpink:16758465,lightsalmon:16752762,lightseagreen:2142890,lightskyblue:8900346,lightslategray:7833753,lightslategrey:7833753,lightsteelblue:11584734,lightyellow:16777184,lime:65280,limegreen:3329330,linen:16445670,magenta:16711935,maroon:8388608,mediumaquamarine:6737322,mediumblue:205,mediumorchid:12211667,mediumpurple:9662683,mediumseagreen:3978097,mediumslateblue:8087790,mediumspringgreen:64154,mediumturquoise:4772300,mediumvioletred:13047173,midnightblue:1644912,mintcream:16121850,mistyrose:16770273,moccasin:16770229,navajowhite:16768685,navy:128,oldlace:16643558,olive:8421376,olivedrab:7048739,orange:16753920,orangered:16729344,orchid:14315734,palegoldenrod:15657130,palegreen:10025880,paleturquoise:11529966,palevioletred:14381203,papayawhip:16773077,peachpuff:16767673,peru:13468991,pink:16761035,plum:14524637,powderblue:11591910,purple:8388736,rebeccapurple:6697881,red:16711680,rosybrown:12357519,royalblue:4286945,saddlebrown:9127187,salmon:16416882,sandybrown:16032864,seagreen:3050327,seashell:16774638,sienna:10506797,silver:12632256,skyblue:8900331,slateblue:6970061,slategray:7372944,slategrey:7372944,snow:16775930,springgreen:65407,steelblue:4620980,tan:13808780,teal:32896,thistle:14204888,tomato:16737095,turquoise:4251856,violet:15631086,wheat:16113331,white:16777215,whitesmoke:16119285,yellow:16776960,yellowgreen:10145074};Qn(fn,dn,{copy(e){return Object.assign(new this.constructor,this,e)},displayable(){return this.rgb().displayable()},hex:Bi,formatHex:Bi,formatHex8:Ef,formatHsl:Of,formatRgb:Vi,toString:Vi});function Bi(){return this.rgb().formatHex()}function Ef(){return this.rgb().formatHex8()}function Of(){return nr(this).formatHsl()}function Vi(){return this.rgb().formatRgb()}function dn(e){var n,t;return e=(e+"").trim().toLowerCase(),(n=If.exec(e))?(t=n[1].length,n=parseInt(n[1],16),t===6?Fi(n):t===3?new ye(n>>8&15|n>>4&240,n>>4&15|n&240,(n&15)<<4|n&15,1):t===8?nt(n>>24&255,n>>16&255,n>>8&255,(n&255)/255):t===4?nt(n>>12&15|n>>8&240,n>>8&15|n>>4&240,n>>4&15|n&240,((n&15)<<4|n&15)/255):null):(n=Df.exec(e))?new ye(n[1],n[2],n[3],1):(n=Pf.exec(e))?new ye(n[1]*255/100,n[2]*255/100,n[3]*255/100,1):(n=Mf.exec(e))?nt(n[1],n[2],n[3],n[4]):(n=Lf.exec(e))?nt(n[1]*255/100,n[2]*255/100,n[3]*255/100,n[4]):(n=$f.exec(e))?Gi(n[1],n[2]/100,n[3]/100,1):(n=Nf.exec(e))?Gi(n[1],n[2]/100,n[3]/100,n[4]):qi.hasOwnProperty(e)?Fi(qi[e]):e==="transparent"?new ye(NaN,NaN,NaN,0):null}function Fi(e){return new ye(e>>16&255,e>>8&255,e&255,1)}function nt(e,n,t,a){return a<=0&&(e=n=t=NaN),new ye(e,n,t,a)}function er(e){return e instanceof fn||(e=dn(e)),e?(e=e.rgb(),new ye(e.r,e.g,e.b,e.opacity)):new ye}function Ta(e,n,t,a){return arguments.length===1?er(e):new ye(e,n,t,a??1)}function ye(e,n,t,a){this.r=+e,this.g=+n,this.b=+t,this.opacity=+a}Qn(ye,Ta,Ht(fn,{brighter(e){return e=e==null?ft:Math.pow(ft,e),new ye(this.r*e,this.g*e,this.b*e,this.opacity)},darker(e){return e=e==null?Un:Math.pow(Un,e),new ye(this.r*e,this.g*e,this.b*e,this.opacity)},rgb(){return this},clamp(){return new ye(cn(this.r),cn(this.g),cn(this.b),vt(this.opacity))},displayable(){return-.5<=this.r&&this.r<255.5&&-.5<=this.g&&this.g<255.5&&-.5<=this.b&&this.b<255.5&&0<=this.opacity&&this.opacity<=1},hex:ji,formatHex:ji,formatHex8:Rf,formatRgb:Ui,toString:Ui}));function ji(){return`#${rn(this.r)}${rn(this.g)}${rn(this.b)}`}function Rf(){return`#${rn(this.r)}${rn(this.g)}${rn(this.b)}${rn((isNaN(this.opacity)?1:this.opacity)*255)}`}function Ui(){const e=vt(this.opacity);return`${e===1?"rgb(":"rgba("}${cn(this.r)}, ${cn(this.g)}, ${cn(this.b)}${e===1?")":`, ${e})`}`}function vt(e){return isNaN(e)?1:Math.max(0,Math.min(1,e))}function cn(e){return Math.max(0,Math.min(255,Math.round(e)||0))}function rn(e){return e=cn(e),(e<16?"0":"")+e.toString(16)}function Gi(e,n,t,a){return a<=0?e=n=t=NaN:t<=0||t>=1?e=n=NaN:n<=0&&(e=NaN),new Ne(e,n,t,a)}function nr(e){if(e instanceof Ne)return new Ne(e.h,e.s,e.l,e.opacity);if(e instanceof fn||(e=dn(e)),!e)return new Ne;if(e instanceof Ne)return e;e=e.rgb();var n=e.r/255,t=e.g/255,a=e.b/255,o=Math.min(n,t,a),i=Math.max(n,t,a),s=NaN,r=i-o,l=(i+o)/2;return r?(n===i?s=(t-a)/r+(t<a)*6:t===i?s=(a-n)/r+2:s=(n-t)/r+4,r/=l<.5?i+o:2-i-o,s*=60):r=l>0&&l<1?0:s,new Ne(s,r,l,e.opacity)}function zf(e,n,t,a){return arguments.length===1?nr(e):new Ne(e,n,t,a??1)}function Ne(e,n,t,a){this.h=+e,this.s=+n,this.l=+t,this.opacity=+a}Qn(Ne,zf,Ht(fn,{brighter(e){return e=e==null?ft:Math.pow(ft,e),new Ne(this.h,this.s,this.l*e,this.opacity)},darker(e){return e=e==null?Un:Math.pow(Un,e),new Ne(this.h,this.s,this.l*e,this.opacity)},rgb(){var e=this.h%360+(this.h<0)*360,n=isNaN(e)||isNaN(this.s)?0:this.s,t=this.l,a=t+(t<.5?t:1-t)*n,o=2*t-a;return new ye(aa(e>=240?e-240:e+120,o,a),aa(e,o,a),aa(e<120?e+240:e-120,o,a),this.opacity)},clamp(){return new Ne(Hi(this.h),tt(this.s),tt(this.l),vt(this.opacity))},displayable(){return(0<=this.s&&this.s<=1||isNaN(this.s))&&0<=this.l&&this.l<=1&&0<=this.opacity&&this.opacity<=1},formatHsl(){const e=vt(this.opacity);return`${e===1?"hsl(":"hsla("}${Hi(this.h)}, ${tt(this.s)*100}%, ${tt(this.l)*100}%${e===1?")":`, ${e})`}`}}));function Hi(e){return e=(e||0)%360,e<0?e+360:e}function tt(e){return Math.max(0,Math.min(1,e||0))}function aa(e,n,t){return(e<60?n+(t-n)*e/60:e<180?t:e<240?n+(t-n)*(240-e)/60:n)*255}const qf=Math.PI/180,Bf=180/Math.PI,bt=18,tr=.96422,ar=1,or=.82521,ir=4/29,Cn=6/29,sr=3*Cn*Cn,Vf=Cn*Cn*Cn;function rr(e){if(e instanceof Ve)return new Ve(e.l,e.a,e.b,e.opacity);if(e instanceof Ge)return lr(e);e instanceof ye||(e=er(e));var n=ra(e.r),t=ra(e.g),a=ra(e.b),o=oa((.2225045*n+.7168786*t+.0606169*a)/ar),i,s;return n===t&&t===a?i=s=o:(i=oa((.4360747*n+.3850649*t+.1430804*a)/tr),s=oa((.0139322*n+.0971045*t+.7141733*a)/or)),new Ve(116*o-16,500*(i-o),200*(o-s),e.opacity)}function Ff(e,n,t,a){return arguments.length===1?rr(e):new Ve(e,n,t,a??1)}function Ve(e,n,t,a){this.l=+e,this.a=+n,this.b=+t,this.opacity=+a}Qn(Ve,Ff,Ht(fn,{brighter(e){return new Ve(this.l+bt*(e??1),this.a,this.b,this.opacity)},darker(e){return new Ve(this.l-bt*(e??1),this.a,this.b,this.opacity)},rgb(){var e=(this.l+16)/116,n=isNaN(this.a)?e:e+this.a/500,t=isNaN(this.b)?e:e-this.b/200;return n=tr*ia(n),e=ar*ia(e),t=or*ia(t),new ye(sa(3.1338561*n-1.6168667*e-.4906146*t),sa(-.9787684*n+1.9161415*e+.033454*t),sa(.0719453*n-.2289914*e+1.4052427*t),this.opacity)}}));function oa(e){return e>Vf?Math.pow(e,1/3):e/sr+ir}function ia(e){return e>Cn?e*e*e:sr*(e-ir)}function sa(e){return 255*(e<=.0031308?12.92*e:1.055*Math.pow(e,1/2.4)-.055)}function ra(e){return(e/=255)<=.04045?e/12.92:Math.pow((e+.055)/1.055,2.4)}function jf(e){if(e instanceof Ge)return new Ge(e.h,e.c,e.l,e.opacity);if(e instanceof Ve||(e=rr(e)),e.a===0&&e.b===0)return new Ge(NaN,0<e.l&&e.l<100?0:NaN,e.l,e.opacity);var n=Math.atan2(e.b,e.a)*Bf;return new Ge(n<0?n+360:n,Math.sqrt(e.a*e.a+e.b*e.b),e.l,e.opacity)}function Sa(e,n,t,a){return arguments.length===1?jf(e):new Ge(e,n,t,a??1)}function Ge(e,n,t,a){this.h=+e,this.c=+n,this.l=+t,this.opacity=+a}function lr(e){if(isNaN(e.h))return new Ve(e.l,0,0,e.opacity);var n=e.h*qf;return new Ve(e.l,Math.cos(n)*e.c,Math.sin(n)*e.c,e.opacity)}Qn(Ge,Sa,Ht(fn,{brighter(e){return new Ge(this.h,this.c,this.l+bt*(e??1),this.opacity)},darker(e){return new Ge(this.h,this.c,this.l-bt*(e??1),this.opacity)},rgb(){return lr(this).rgb()}}));const Wt=e=>()=>e;function cr(e,n){return function(t){return e+t*n}}function Uf(e,n,t){return e=Math.pow(e,t),n=Math.pow(n,t)-e,t=1/t,function(a){return Math.pow(e+a*n,t)}}function Gf(e,n){var t=n-e;return t?cr(e,t>180||t<-180?t-360*Math.round(t/360):t):Wt(isNaN(e)?n:e)}function Hf(e){return(e=+e)==1?Vn:function(n,t){return t-n?Uf(n,t,e):Wt(isNaN(n)?t:n)}}function Vn(e,n){var t=n-e;return t?cr(e,t):Wt(isNaN(e)?n:e)}const yt=function e(n){var t=Hf(n);function a(o,i){var s=t((o=Ta(o)).r,(i=Ta(i)).r),r=t(o.g,i.g),l=t(o.b,i.b),c=Vn(o.opacity,i.opacity);return function(d){return o.r=s(d),o.g=r(d),o.b=l(d),o.opacity=c(d),o+""}}return a.gamma=e,a}(1);function Wf(e,n){n||(n=[]);var t=e?Math.min(n.length,e.length):0,a=n.slice(),o;return function(i){for(o=0;o<t;++o)a[o]=e[o]*(1-i)+n[o]*i;return a}}function Kf(e){return ArrayBuffer.isView(e)&&!(e instanceof DataView)}function Yf(e,n){var t=n?n.length:0,a=e?Math.min(t,e.length):0,o=new Array(a),i=new Array(t),s;for(s=0;s<a;++s)o[s]=di(e[s],n[s]);for(;s<t;++s)i[s]=n[s];return function(r){for(s=0;s<a;++s)i[s]=o[s](r);return i}}function Xf(e,n){var t=new Date;return e=+e,n=+n,function(a){return t.setTime(e*(1-a)+n*a),t}}function $e(e,n){return e=+e,n=+n,function(t){return e*(1-t)+n*t}}function Qf(e,n){var t={},a={},o;(e===null||typeof e!="object")&&(e={}),(n===null||typeof n!="object")&&(n={});for(o in n)o in e?t[o]=di(e[o],n[o]):a[o]=n[o];return function(i){for(o in t)a[o]=t[o](i);return a}}var Ia=/[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,la=new RegExp(Ia.source,"g");function Jf(e){return function(){return e}}function Zf(e){return function(n){return e(n)+""}}function ur(e,n){var t=Ia.lastIndex=la.lastIndex=0,a,o,i,s=-1,r=[],l=[];for(e=e+"",n=n+"";(a=Ia.exec(e))&&(o=la.exec(n));)(i=o.index)>t&&(i=n.slice(t,i),r[s]?r[s]+=i:r[++s]=i),(a=a[0])===(o=o[0])?r[s]?r[s]+=o:r[++s]=o:(r[++s]=null,l.push({i:s,x:$e(a,o)})),t=la.lastIndex;return t<n.length&&(i=n.slice(t),r[s]?r[s]+=i:r[++s]=i),r.length<2?l[0]?Zf(l[0].x):Jf(n):(n=l.length,function(c){for(var d=0,g;d<n;++d)r[(g=l[d]).i]=g.x(c);return r.join("")})}function di(e,n){var t=typeof n,a;return n==null||t==="boolean"?Wt(n):(t==="number"?$e:t==="string"?(a=dn(n))?(n=a,yt):ur:n instanceof dn?yt:n instanceof Date?Xf:Kf(n)?Wf:Array.isArray(n)?Yf:typeof n.valueOf!="function"&&typeof n.toString!="function"||isNaN(n)?Qf:$e)(e,n)}function ev(e,n){return e=+e,n=+n,function(t){return Math.round(e*(1-t)+n*t)}}var Wi=180/Math.PI,Da={translateX:0,translateY:0,rotate:0,skewX:0,scaleX:1,scaleY:1};function dr(e,n,t,a,o,i){var s,r,l;return(s=Math.sqrt(e*e+n*n))&&(e/=s,n/=s),(l=e*t+n*a)&&(t-=e*l,a-=n*l),(r=Math.sqrt(t*t+a*a))&&(t/=r,a/=r,l/=r),e*a<n*t&&(e=-e,n=-n,l=-l,s=-s),{translateX:o,translateY:i,rotate:Math.atan2(n,e)*Wi,skewX:Math.atan(l)*Wi,scaleX:s,scaleY:r}}var at;function nv(e){const n=new(typeof DOMMatrix=="function"?DOMMatrix:WebKitCSSMatrix)(e+"");return n.isIdentity?Da:dr(n.a,n.b,n.c,n.d,n.e,n.f)}function tv(e){return e==null||(at||(at=document.createElementNS("http://www.w3.org/2000/svg","g")),at.setAttribute("transform",e),!(e=at.transform.baseVal.consolidate()))?Da:(e=e.matrix,dr(e.a,e.b,e.c,e.d,e.e,e.f))}function hr(e,n,t,a){function o(c){return c.length?c.pop()+" ":""}function i(c,d,g,u,h,v){if(c!==g||d!==u){var b=h.push("translate(",null,n,null,t);v.push({i:b-4,x:$e(c,g)},{i:b-2,x:$e(d,u)})}else(g||u)&&h.push("translate("+g+n+u+t)}function s(c,d,g,u){c!==d?(c-d>180?d+=360:d-c>180&&(c+=360),u.push({i:g.push(o(g)+"rotate(",null,a)-2,x:$e(c,d)})):d&&g.push(o(g)+"rotate("+d+a)}function r(c,d,g,u){c!==d?u.push({i:g.push(o(g)+"skewX(",null,a)-2,x:$e(c,d)}):d&&g.push(o(g)+"skewX("+d+a)}function l(c,d,g,u,h,v){if(c!==g||d!==u){var b=h.push(o(h)+"scale(",null,",",null,")");v.push({i:b-4,x:$e(c,g)},{i:b-2,x:$e(d,u)})}else(g!==1||u!==1)&&h.push(o(h)+"scale("+g+","+u+")")}return function(c,d){var g=[],u=[];return c=e(c),d=e(d),i(c.translateX,c.translateY,d.translateX,d.translateY,g,u),s(c.rotate,d.rotate,g,u),r(c.skewX,d.skewX,g,u),l(c.scaleX,c.scaleY,d.scaleX,d.scaleY,g,u),c=d=null,function(h){for(var v=-1,b=u.length,w;++v<b;)g[(w=u[v]).i]=w.x(h);return g.join("")}}}var av=hr(nv,"px, ","px)","deg)"),ov=hr(tv,", ",")",")");function iv(e){return function(n,t){var a=e((n=Sa(n)).h,(t=Sa(t)).h),o=Vn(n.c,t.c),i=Vn(n.l,t.l),s=Vn(n.opacity,t.opacity);return function(r){return n.h=a(r),n.c=o(r),n.l=i(r),n.opacity=s(r),n+""}}}const dk=iv(Gf);var Sn=0,zn=0,Mn=0,pr=1e3,wt,qn,_t=0,hn=0,Kt=0,Hn=typeof performance=="object"&&performance.now?performance:Date,gr=typeof window=="object"&&window.requestAnimationFrame?window.requestAnimationFrame.bind(window):function(e){setTimeout(e,17)};function hi(){return hn||(gr(sv),hn=Hn.now()+Kt)}function sv(){hn=0}function kt(){this._call=this._time=this._next=null}kt.prototype=pi.prototype={constructor:kt,restart:function(e,n,t){if(typeof e!="function")throw new TypeError("callback is not a function");t=(t==null?hi():+t)+(n==null?0:+n),!this._next&&qn!==this&&(qn?qn._next=this:wt=this,qn=this),this._call=e,this._time=t,Pa()},stop:function(){this._call&&(this._call=null,this._time=1/0,Pa())}};function pi(e,n,t){var a=new kt;return a.restart(e,n,t),a}function rv(){hi(),++Sn;for(var e=wt,n;e;)(n=hn-e._time)>=0&&e._call.call(void 0,n),e=e._next;--Sn}function Ki(){hn=(_t=Hn.now())+Kt,Sn=zn=0;try{rv()}finally{Sn=0,cv(),hn=0}}function lv(){var e=Hn.now(),n=e-_t;n>pr&&(Kt-=n,_t=e)}function cv(){for(var e,n=wt,t,a=1/0;n;)n._call?(a>n._time&&(a=n._time),e=n,n=n._next):(t=n._next,n._next=null,n=e?e._next=t:wt=t);qn=e,Pa(a)}function Pa(e){if(!Sn){zn&&(zn=clearTimeout(zn));var n=e-hn;n>24?(e<1/0&&(zn=setTimeout(Ki,e-Hn.now()-Kt)),Mn&&(Mn=clearInterval(Mn))):(Mn||(_t=Hn.now(),Mn=setInterval(lv,pr)),Sn=1,gr(Ki))}}function Yi(e,n,t){var a=new kt;return n=n==null?0:+n,a.restart(o=>{a.stop(),e(o+n)},n,t),a}var uv=Ut("start","end","cancel","interrupt"),dv=[],mr=0,Xi=1,Ma=2,ut=3,Qi=4,La=5,dt=6;function Yt(e,n,t,a,o,i){var s=e.__transition;if(!s)e.__transition={};else if(t in s)return;hv(e,t,{name:n,index:a,group:o,on:uv,tween:dv,time:i.time,delay:i.delay,duration:i.duration,ease:i.ease,timer:null,state:mr})}function gi(e,n){var t=Oe(e,n);if(t.state>mr)throw new Error("too late; already scheduled");return t}function Fe(e,n){var t=Oe(e,n);if(t.state>ut)throw new Error("too late; already running");return t}function Oe(e,n){var t=e.__transition;if(!t||!(t=t[n]))throw new Error("transition not found");return t}function hv(e,n,t){var a=e.__transition,o;a[n]=t,t.timer=pi(i,0,t.time);function i(c){t.state=Xi,t.timer.restart(s,t.delay,t.time),t.delay<=c&&s(c-t.delay)}function s(c){var d,g,u,h;if(t.state!==Xi)return l();for(d in a)if(h=a[d],h.name===t.name){if(h.state===ut)return Yi(s);h.state===Qi?(h.state=dt,h.timer.stop(),h.on.call("interrupt",e,e.__data__,h.index,h.group),delete a[d]):+d<n&&(h.state=dt,h.timer.stop(),h.on.call("cancel",e,e.__data__,h.index,h.group),delete a[d])}if(Yi(function(){t.state===ut&&(t.state=Qi,t.timer.restart(r,t.delay,t.time),r(c))}),t.state=Ma,t.on.call("start",e,e.__data__,t.index,t.group),t.state===Ma){for(t.state=ut,o=new Array(u=t.tween.length),d=0,g=-1;d<u;++d)(h=t.tween[d].value.call(e,e.__data__,t.index,t.group))&&(o[++g]=h);o.length=g+1}}function r(c){for(var d=c<t.duration?t.ease.call(null,c/t.duration):(t.timer.restart(l),t.state=La,1),g=-1,u=o.length;++g<u;)o[g].call(e,d);t.state===La&&(t.on.call("end",e,e.__data__,t.index,t.group),l())}function l(){t.state=dt,t.timer.stop(),delete a[n];for(var c in a)return;delete e.__transition}}function pv(e,n){var t=e.__transition,a,o,i=!0,s;if(t){n=n==null?null:n+"";for(s in t){if((a=t[s]).name!==n){i=!1;continue}o=a.state>Ma&&a.state<La,a.state=dt,a.timer.stop(),a.on.call(o?"interrupt":"cancel",e,e.__data__,a.index,a.group),delete t[s]}i&&delete e.__transition}}function gv(e){return this.each(function(){pv(this,e)})}function mv(e,n){var t,a;return function(){var o=Fe(this,e),i=o.tween;if(i!==t){a=t=i;for(var s=0,r=a.length;s<r;++s)if(a[s].name===n){a=a.slice(),a.splice(s,1);break}}o.tween=a}}function fv(e,n,t){var a,o;if(typeof t!="function")throw new Error;return function(){var i=Fe(this,e),s=i.tween;if(s!==a){o=(a=s).slice();for(var r={name:n,value:t},l=0,c=o.length;l<c;++l)if(o[l].name===n){o[l]=r;break}l===c&&o.push(r)}i.tween=o}}function vv(e,n){var t=this._id;if(e+="",arguments.length<2){for(var a=Oe(this.node(),t).tween,o=0,i=a.length,s;o<i;++o)if((s=a[o]).name===e)return s.value;return null}return this.each((n==null?mv:fv)(t,e,n))}function mi(e,n,t){var a=e._id;return e.each(function(){var o=Fe(this,a);(o.value||(o.value={}))[n]=t.apply(this,arguments)}),function(o){return Oe(o,a).value[n]}}function fr(e,n){var t;return(typeof n=="number"?$e:n instanceof dn?yt:(t=dn(n))?(n=t,yt):ur)(e,n)}function bv(e){return function(){this.removeAttribute(e)}}function yv(e){return function(){this.removeAttributeNS(e.space,e.local)}}function wv(e,n,t){var a,o=t+"",i;return function(){var s=this.getAttribute(e);return s===o?null:s===a?i:i=n(a=s,t)}}function _v(e,n,t){var a,o=t+"",i;return function(){var s=this.getAttributeNS(e.space,e.local);return s===o?null:s===a?i:i=n(a=s,t)}}function kv(e,n,t){var a,o,i;return function(){var s,r=t(this),l;return r==null?void this.removeAttribute(e):(s=this.getAttribute(e),l=r+"",s===l?null:s===a&&l===o?i:(o=l,i=n(a=s,r)))}}function xv(e,n,t){var a,o,i;return function(){var s,r=t(this),l;return r==null?void this.removeAttributeNS(e.space,e.local):(s=this.getAttributeNS(e.space,e.local),l=r+"",s===l?null:s===a&&l===o?i:(o=l,i=n(a=s,r)))}}function Av(e,n){var t=Gt(e),a=t==="transform"?ov:fr;return this.attrTween(e,typeof n=="function"?(t.local?xv:kv)(t,a,mi(this,"attr."+e,n)):n==null?(t.local?yv:bv)(t):(t.local?_v:wv)(t,a,n))}function Cv(e,n){return function(t){this.setAttribute(e,n.call(this,t))}}function Tv(e,n){return function(t){this.setAttributeNS(e.space,e.local,n.call(this,t))}}function Sv(e,n){var t,a;function o(){var i=n.apply(this,arguments);return i!==a&&(t=(a=i)&&Tv(e,i)),t}return o._value=n,o}function Iv(e,n){var t,a;function o(){var i=n.apply(this,arguments);return i!==a&&(t=(a=i)&&Cv(e,i)),t}return o._value=n,o}function Dv(e,n){var t="attr."+e;if(arguments.length<2)return(t=this.tween(t))&&t._value;if(n==null)return this.tween(t,null);if(typeof n!="function")throw new Error;var a=Gt(e);return this.tween(t,(a.local?Sv:Iv)(a,n))}function Pv(e,n){return function(){gi(this,e).delay=+n.apply(this,arguments)}}function Mv(e,n){return n=+n,function(){gi(this,e).delay=n}}function Lv(e){var n=this._id;return arguments.length?this.each((typeof e=="function"?Pv:Mv)(n,e)):Oe(this.node(),n).delay}function $v(e,n){return function(){Fe(this,e).duration=+n.apply(this,arguments)}}function Nv(e,n){return n=+n,function(){Fe(this,e).duration=n}}function Ev(e){var n=this._id;return arguments.length?this.each((typeof e=="function"?$v:Nv)(n,e)):Oe(this.node(),n).duration}function Ov(e,n){if(typeof n!="function")throw new Error;return function(){Fe(this,e).ease=n}}function Rv(e){var n=this._id;return arguments.length?this.each(Ov(n,e)):Oe(this.node(),n).ease}function zv(e,n){return function(){var t=n.apply(this,arguments);if(typeof t!="function")throw new Error;Fe(this,e).ease=t}}function qv(e){if(typeof e!="function")throw new Error;return this.each(zv(this._id,e))}function Bv(e){typeof e!="function"&&(e=Us(e));for(var n=this._groups,t=n.length,a=new Array(t),o=0;o<t;++o)for(var i=n[o],s=i.length,r=a[o]=[],l,c=0;c<s;++c)(l=i[c])&&e.call(l,l.__data__,c,i)&&r.push(l);return new Ke(a,this._parents,this._name,this._id)}function Vv(e){if(e._id!==this._id)throw new Error;for(var n=this._groups,t=e._groups,a=n.length,o=t.length,i=Math.min(a,o),s=new Array(a),r=0;r<i;++r)for(var l=n[r],c=t[r],d=l.length,g=s[r]=new Array(d),u,h=0;h<d;++h)(u=l[h]||c[h])&&(g[h]=u);for(;r<a;++r)s[r]=n[r];return new Ke(s,this._parents,this._name,this._id)}function Fv(e){return(e+"").trim().split(/^|\s+/).every(function(n){var t=n.indexOf(".");return t>=0&&(n=n.slice(0,t)),!n||n==="start"})}function jv(e,n,t){var a,o,i=Fv(n)?gi:Fe;return function(){var s=i(this,e),r=s.on;r!==a&&(o=(a=r).copy()).on(n,t),s.on=o}}function Uv(e,n){var t=this._id;return arguments.length<2?Oe(this.node(),t).on.on(e):this.each(jv(t,e,n))}function Gv(e){return function(){var n=this.parentNode;for(var t in this.__transition)if(+t!==e)return;n&&n.removeChild(this)}}function Hv(){return this.on("end.remove",Gv(this._id))}function Wv(e){var n=this._name,t=this._id;typeof e!="function"&&(e=ci(e));for(var a=this._groups,o=a.length,i=new Array(o),s=0;s<o;++s)for(var r=a[s],l=r.length,c=i[s]=new Array(l),d,g,u=0;u<l;++u)(d=r[u])&&(g=e.call(d,d.__data__,u,r))&&("__data__"in d&&(g.__data__=d.__data__),c[u]=g,Yt(c[u],n,t,u,c,Oe(d,t)));return new Ke(i,this._parents,n,t)}function Kv(e){var n=this._name,t=this._id;typeof e!="function"&&(e=js(e));for(var a=this._groups,o=a.length,i=[],s=[],r=0;r<o;++r)for(var l=a[r],c=l.length,d,g=0;g<c;++g)if(d=l[g]){for(var u=e.call(d,d.__data__,g,l),h,v=Oe(d,t),b=0,w=u.length;b<w;++b)(h=u[b])&&Yt(h,n,t,b,u,v);i.push(u),s.push(d)}return new Ke(i,s,n,t)}var Yv=Xn.prototype.constructor;function Xv(){return new Yv(this._groups,this._parents)}function Qv(e,n){var t,a,o;return function(){var i=Tn(this,e),s=(this.style.removeProperty(e),Tn(this,e));return i===s?null:i===t&&s===a?o:o=n(t=i,a=s)}}function vr(e){return function(){this.style.removeProperty(e)}}function Jv(e,n,t){var a,o=t+"",i;return function(){var s=Tn(this,e);return s===o?null:s===a?i:i=n(a=s,t)}}function Zv(e,n,t){var a,o,i;return function(){var s=Tn(this,e),r=t(this),l=r+"";return r==null&&(l=r=(this.style.removeProperty(e),Tn(this,e))),s===l?null:s===a&&l===o?i:(o=l,i=n(a=s,r))}}function e0(e,n){var t,a,o,i="style."+n,s="end."+i,r;return function(){var l=Fe(this,e),c=l.on,d=l.value[i]==null?r||(r=vr(n)):void 0;(c!==t||o!==d)&&(a=(t=c).copy()).on(s,o=d),l.on=a}}function n0(e,n,t){var a=(e+="")=="transform"?av:fr;return n==null?this.styleTween(e,Qv(e,a)).on("end.style."+e,vr(e)):typeof n=="function"?this.styleTween(e,Zv(e,a,mi(this,"style."+e,n))).each(e0(this._id,e)):this.styleTween(e,Jv(e,a,n),t).on("end.style."+e,null)}function t0(e,n,t){return function(a){this.style.setProperty(e,n.call(this,a),t)}}function a0(e,n,t){var a,o;function i(){var s=n.apply(this,arguments);return s!==o&&(a=(o=s)&&t0(e,s,t)),a}return i._value=n,i}function o0(e,n,t){var a="style."+(e+="");if(arguments.length<2)return(a=this.tween(a))&&a._value;if(n==null)return this.tween(a,null);if(typeof n!="function")throw new Error;return this.tween(a,a0(e,n,t??""))}function i0(e){return function(){this.textContent=e}}function s0(e){return function(){var n=e(this);this.textContent=n??""}}function r0(e){return this.tween("text",typeof e=="function"?s0(mi(this,"text",e)):i0(e==null?"":e+""))}function l0(e){return function(n){this.textContent=e.call(this,n)}}function c0(e){var n,t;function a(){var o=e.apply(this,arguments);return o!==t&&(n=(t=o)&&l0(o)),n}return a._value=e,a}function u0(e){var n="text";if(arguments.length<1)return(n=this.tween(n))&&n._value;if(e==null)return this.tween(n,null);if(typeof e!="function")throw new Error;return this.tween(n,c0(e))}function d0(){for(var e=this._name,n=this._id,t=br(),a=this._groups,o=a.length,i=0;i<o;++i)for(var s=a[i],r=s.length,l,c=0;c<r;++c)if(l=s[c]){var d=Oe(l,n);Yt(l,e,t,c,s,{time:d.time+d.delay+d.duration,delay:0,duration:d.duration,ease:d.ease})}return new Ke(a,this._parents,e,t)}function h0(){var e,n,t=this,a=t._id,o=t.size();return new Promise(function(i,s){var r={value:s},l={value:function(){--o===0&&i()}};t.each(function(){var c=Fe(this,a),d=c.on;d!==e&&(n=(e=d).copy(),n._.cancel.push(r),n._.interrupt.push(r),n._.end.push(l)),c.on=n}),o===0&&i()})}var p0=0;function Ke(e,n,t,a){this._groups=e,this._parents=n,this._name=t,this._id=a}function br(){return++p0}var je=Xn.prototype;Ke.prototype={constructor:Ke,select:Wv,selectAll:Kv,selectChild:je.selectChild,selectChildren:je.selectChildren,filter:Bv,merge:Vv,selection:Xv,transition:d0,call:je.call,nodes:je.nodes,node:je.node,size:je.size,empty:je.empty,each:je.each,on:Uv,attr:Av,attrTween:Dv,style:n0,styleTween:o0,text:r0,textTween:u0,remove:Hv,tween:vv,delay:Lv,duration:Ev,ease:Rv,easeVarying:qv,end:h0,[Symbol.iterator]:je[Symbol.iterator]};function g0(e){return((e*=2)<=1?e*e*e:(e-=2)*e*e+2)/2}var m0={time:null,delay:0,duration:250,ease:g0};function f0(e,n){for(var t;!(t=e.__transition)||!(t=t[n]);)if(!(e=e.parentNode))throw new Error(`transition ${n} not found`);return t}function v0(e){var n,t;e instanceof Ke?(n=e._id,e=e._name):(n=br(),(t=m0).time=hi(),e=e==null?null:e+"");for(var a=this._groups,o=a.length,i=0;i<o;++i)for(var s=a[i],r=s.length,l,c=0;c<r;++c)(l=s[c])&&Yt(l,e,n,c,s,t||f0(l,n));return new Ke(a,this._parents,e,n)}Xn.prototype.interrupt=gv;Xn.prototype.transition=v0;const $a=Math.PI,Na=2*$a,sn=1e-6,b0=Na-sn;function yr(e){this._+=e[0];for(let n=1,t=e.length;n<t;++n)this._+=arguments[n]+e[n]}function y0(e){let n=Math.floor(e);if(!(n>=0))throw new Error(`invalid digits: ${e}`);if(n>15)return yr;const t=10**n;return function(a){this._+=a[0];for(let o=1,i=a.length;o<i;++o)this._+=Math.round(arguments[o]*t)/t+a[o]}}class w0{constructor(n){this._x0=this._y0=this._x1=this._y1=null,this._="",this._append=n==null?yr:y0(n)}moveTo(n,t){this._append`M${this._x0=this._x1=+n},${this._y0=this._y1=+t}`}closePath(){this._x1!==null&&(this._x1=this._x0,this._y1=this._y0,this._append`Z`)}lineTo(n,t){this._append`L${this._x1=+n},${this._y1=+t}`}quadraticCurveTo(n,t,a,o){this._append`Q${+n},${+t},${this._x1=+a},${this._y1=+o}`}bezierCurveTo(n,t,a,o,i,s){this._append`C${+n},${+t},${+a},${+o},${this._x1=+i},${this._y1=+s}`}arcTo(n,t,a,o,i){if(n=+n,t=+t,a=+a,o=+o,i=+i,i<0)throw new Error(`negative radius: ${i}`);let s=this._x1,r=this._y1,l=a-n,c=o-t,d=s-n,g=r-t,u=d*d+g*g;if(this._x1===null)this._append`M${this._x1=n},${this._y1=t}`;else if(u>sn)if(!(Math.abs(g*l-c*d)>sn)||!i)this._append`L${this._x1=n},${this._y1=t}`;else{let h=a-s,v=o-r,b=l*l+c*c,w=h*h+v*v,x=Math.sqrt(b),A=Math.sqrt(u),M=i*Math.tan(($a-Math.acos((b+u-w)/(2*x*A)))/2),y=M/A,T=M/x;Math.abs(y-1)>sn&&this._append`L${n+y*d},${t+y*g}`,this._append`A${i},${i},0,0,${+(g*h>d*v)},${this._x1=n+T*l},${this._y1=t+T*c}`}}arc(n,t,a,o,i,s){if(n=+n,t=+t,a=+a,s=!!s,a<0)throw new Error(`negative radius: ${a}`);let r=a*Math.cos(o),l=a*Math.sin(o),c=n+r,d=t+l,g=1^s,u=s?o-i:i-o;this._x1===null?this._append`M${c},${d}`:(Math.abs(this._x1-c)>sn||Math.abs(this._y1-d)>sn)&&this._append`L${c},${d}`,a&&(u<0&&(u=u%Na+Na),u>b0?this._append`A${a},${a},0,1,${g},${n-r},${t-l}A${a},${a},0,1,${g},${this._x1=c},${this._y1=d}`:u>sn&&this._append`A${a},${a},0,${+(u>=$a)},${g},${this._x1=n+a*Math.cos(i)},${this._y1=t+a*Math.sin(i)}`)}rect(n,t,a,o){this._append`M${this._x0=this._x1=+n},${this._y0=this._y1=+t}h${a=+a}v${+o}h${-a}Z`}toString(){return this._}}function _0(e,n){var t,a=1;e==null&&(e=0),n==null&&(n=0);function o(){var i,s=t.length,r,l=0,c=0;for(i=0;i<s;++i)r=t[i],l+=r.x,c+=r.y;for(l=(l/s-e)*a,c=(c/s-n)*a,i=0;i<s;++i)r=t[i],r.x-=l,r.y-=c}return o.initialize=function(i){t=i},o.x=function(i){return arguments.length?(e=+i,o):e},o.y=function(i){return arguments.length?(n=+i,o):n},o.strength=function(i){return arguments.length?(a=+i,o):a},o}function k0(e){const n=+this._x.call(null,e),t=+this._y.call(null,e);return wr(this.cover(n,t),n,t,e)}function wr(e,n,t,a){if(isNaN(n)||isNaN(t))return e;var o,i=e._root,s={data:a},r=e._x0,l=e._y0,c=e._x1,d=e._y1,g,u,h,v,b,w,x,A;if(!i)return e._root=s,e;for(;i.length;)if((b=n>=(g=(r+c)/2))?r=g:c=g,(w=t>=(u=(l+d)/2))?l=u:d=u,o=i,!(i=i[x=w<<1|b]))return o[x]=s,e;if(h=+e._x.call(null,i.data),v=+e._y.call(null,i.data),n===h&&t===v)return s.next=i,o?o[x]=s:e._root=s,e;do o=o?o[x]=new Array(4):e._root=new Array(4),(b=n>=(g=(r+c)/2))?r=g:c=g,(w=t>=(u=(l+d)/2))?l=u:d=u;while((x=w<<1|b)===(A=(v>=u)<<1|h>=g));return o[A]=i,o[x]=s,e}function x0(e){var n,t,a=e.length,o,i,s=new Array(a),r=new Array(a),l=1/0,c=1/0,d=-1/0,g=-1/0;for(t=0;t<a;++t)isNaN(o=+this._x.call(null,n=e[t]))||isNaN(i=+this._y.call(null,n))||(s[t]=o,r[t]=i,o<l&&(l=o),o>d&&(d=o),i<c&&(c=i),i>g&&(g=i));if(l>d||c>g)return this;for(this.cover(l,c).cover(d,g),t=0;t<a;++t)wr(this,s[t],r[t],e[t]);return this}function A0(e,n){if(isNaN(e=+e)||isNaN(n=+n))return this;var t=this._x0,a=this._y0,o=this._x1,i=this._y1;if(isNaN(t))o=(t=Math.floor(e))+1,i=(a=Math.floor(n))+1;else{for(var s=o-t||1,r=this._root,l,c;t>e||e>=o||a>n||n>=i;)switch(c=(n<a)<<1|e<t,l=new Array(4),l[c]=r,r=l,s*=2,c){case 0:o=t+s,i=a+s;break;case 1:t=o-s,i=a+s;break;case 2:o=t+s,a=i-s;break;case 3:t=o-s,a=i-s;break}this._root&&this._root.length&&(this._root=r)}return this._x0=t,this._y0=a,this._x1=o,this._y1=i,this}function C0(){var e=[];return this.visit(function(n){if(!n.length)do e.push(n.data);while(n=n.next)}),e}function T0(e){return arguments.length?this.cover(+e[0][0],+e[0][1]).cover(+e[1][0],+e[1][1]):isNaN(this._x0)?void 0:[[this._x0,this._y0],[this._x1,this._y1]]}function _e(e,n,t,a,o){this.node=e,this.x0=n,this.y0=t,this.x1=a,this.y1=o}function S0(e,n,t){var a,o=this._x0,i=this._y0,s,r,l,c,d=this._x1,g=this._y1,u=[],h=this._root,v,b;for(h&&u.push(new _e(h,o,i,d,g)),t==null?t=1/0:(o=e-t,i=n-t,d=e+t,g=n+t,t*=t);v=u.pop();)if(!(!(h=v.node)||(s=v.x0)>d||(r=v.y0)>g||(l=v.x1)<o||(c=v.y1)<i))if(h.length){var w=(s+l)/2,x=(r+c)/2;u.push(new _e(h[3],w,x,l,c),new _e(h[2],s,x,w,c),new _e(h[1],w,r,l,x),new _e(h[0],s,r,w,x)),(b=(n>=x)<<1|e>=w)&&(v=u[u.length-1],u[u.length-1]=u[u.length-1-b],u[u.length-1-b]=v)}else{var A=e-+this._x.call(null,h.data),M=n-+this._y.call(null,h.data),y=A*A+M*M;if(y<t){var T=Math.sqrt(t=y);o=e-T,i=n-T,d=e+T,g=n+T,a=h.data}}return a}function I0(e){if(isNaN(d=+this._x.call(null,e))||isNaN(g=+this._y.call(null,e)))return this;var n,t=this._root,a,o,i,s=this._x0,r=this._y0,l=this._x1,c=this._y1,d,g,u,h,v,b,w,x;if(!t)return this;if(t.length)for(;;){if((v=d>=(u=(s+l)/2))?s=u:l=u,(b=g>=(h=(r+c)/2))?r=h:c=h,n=t,!(t=t[w=b<<1|v]))return this;if(!t.length)break;(n[w+1&3]||n[w+2&3]||n[w+3&3])&&(a=n,x=w)}for(;t.data!==e;)if(o=t,!(t=t.next))return this;return(i=t.next)&&delete t.next,o?(i?o.next=i:delete o.next,this):n?(i?n[w]=i:delete n[w],(t=n[0]||n[1]||n[2]||n[3])&&t===(n[3]||n[2]||n[1]||n[0])&&!t.length&&(a?a[x]=t:this._root=t),this):(this._root=i,this)}function D0(e){for(var n=0,t=e.length;n<t;++n)this.remove(e[n]);return this}function P0(){return this._root}function M0(){var e=0;return this.visit(function(n){if(!n.length)do++e;while(n=n.next)}),e}function L0(e){var n=[],t,a=this._root,o,i,s,r,l;for(a&&n.push(new _e(a,this._x0,this._y0,this._x1,this._y1));t=n.pop();)if(!e(a=t.node,i=t.x0,s=t.y0,r=t.x1,l=t.y1)&&a.length){var c=(i+r)/2,d=(s+l)/2;(o=a[3])&&n.push(new _e(o,c,d,r,l)),(o=a[2])&&n.push(new _e(o,i,d,c,l)),(o=a[1])&&n.push(new _e(o,c,s,r,d)),(o=a[0])&&n.push(new _e(o,i,s,c,d))}return this}function $0(e){var n=[],t=[],a;for(this._root&&n.push(new _e(this._root,this._x0,this._y0,this._x1,this._y1));a=n.pop();){var o=a.node;if(o.length){var i,s=a.x0,r=a.y0,l=a.x1,c=a.y1,d=(s+l)/2,g=(r+c)/2;(i=o[0])&&n.push(new _e(i,s,r,d,g)),(i=o[1])&&n.push(new _e(i,d,r,l,g)),(i=o[2])&&n.push(new _e(i,s,g,d,c)),(i=o[3])&&n.push(new _e(i,d,g,l,c))}t.push(a)}for(;a=t.pop();)e(a.node,a.x0,a.y0,a.x1,a.y1);return this}function N0(e){return e[0]}function E0(e){return arguments.length?(this._x=e,this):this._x}function O0(e){return e[1]}function R0(e){return arguments.length?(this._y=e,this):this._y}function fi(e,n,t){var a=new vi(n??N0,t??O0,NaN,NaN,NaN,NaN);return e==null?a:a.addAll(e)}function vi(e,n,t,a,o,i){this._x=e,this._y=n,this._x0=t,this._y0=a,this._x1=o,this._y1=i,this._root=void 0}function Ji(e){for(var n={data:e.data},t=n;e=e.next;)t=t.next={data:e.data};return n}var xe=fi.prototype=vi.prototype;xe.copy=function(){var e=new vi(this._x,this._y,this._x0,this._y0,this._x1,this._y1),n=this._root,t,a;if(!n)return e;if(!n.length)return e._root=Ji(n),e;for(t=[{source:n,target:e._root=new Array(4)}];n=t.pop();)for(var o=0;o<4;++o)(a=n.source[o])&&(a.length?t.push({source:a,target:n.target[o]=new Array(4)}):n.target[o]=Ji(a));return e};xe.add=k0;xe.addAll=x0;xe.cover=A0;xe.data=C0;xe.extent=T0;xe.find=S0;xe.remove=I0;xe.removeAll=D0;xe.root=P0;xe.size=M0;xe.visit=L0;xe.visitAfter=$0;xe.x=E0;xe.y=R0;function ke(e){return function(){return e}}function Ze(e){return(e()-.5)*1e-6}function z0(e){return e.x+e.vx}function q0(e){return e.y+e.vy}function B0(e){var n,t,a,o=1,i=1;typeof e!="function"&&(e=ke(e==null?1:+e));function s(){for(var c,d=n.length,g,u,h,v,b,w,x=0;x<i;++x)for(g=fi(n,z0,q0).visitAfter(r),c=0;c<d;++c)u=n[c],b=t[u.index],w=b*b,h=u.x+u.vx,v=u.y+u.vy,g.visit(A);function A(M,y,T,k,E){var V=M.data,W=M.r,F=b+W;if(V){if(V.index>u.index){var $=h-V.x-V.vx,P=v-V.y-V.vy,L=$*$+P*P;L<F*F&&($===0&&($=Ze(a),L+=$*$),P===0&&(P=Ze(a),L+=P*P),L=(F-(L=Math.sqrt(L)))/L*o,u.vx+=($*=L)*(F=(W*=W)/(w+W)),u.vy+=(P*=L)*F,V.vx-=$*(F=1-F),V.vy-=P*F)}return}return y>h+F||k<h-F||T>v+F||E<v-F}}function r(c){if(c.data)return c.r=t[c.data.index];for(var d=c.r=0;d<4;++d)c[d]&&c[d].r>c.r&&(c.r=c[d].r)}function l(){if(n){var c,d=n.length,g;for(t=new Array(d),c=0;c<d;++c)g=n[c],t[g.index]=+e(g,c,n)}}return s.initialize=function(c,d){n=c,a=d,l()},s.iterations=function(c){return arguments.length?(i=+c,s):i},s.strength=function(c){return arguments.length?(o=+c,s):o},s.radius=function(c){return arguments.length?(e=typeof c=="function"?c:ke(+c),l(),s):e},s}function V0(e){return e.index}function Zi(e,n){var t=e.get(n);if(!t)throw new Error("node not found: "+n);return t}function F0(e){var n=V0,t=g,a,o=ke(30),i,s,r,l,c,d=1;e==null&&(e=[]);function g(w){return 1/Math.min(r[w.source.index],r[w.target.index])}function u(w){for(var x=0,A=e.length;x<d;++x)for(var M=0,y,T,k,E,V,W,F;M<A;++M)y=e[M],T=y.source,k=y.target,E=k.x+k.vx-T.x-T.vx||Ze(c),V=k.y+k.vy-T.y-T.vy||Ze(c),W=Math.sqrt(E*E+V*V),W=(W-i[M])/W*w*a[M],E*=W,V*=W,k.vx-=E*(F=l[M]),k.vy-=V*F,T.vx+=E*(F=1-F),T.vy+=V*F}function h(){if(s){var w,x=s.length,A=e.length,M=new Map(s.map((T,k)=>[n(T,k,s),T])),y;for(w=0,r=new Array(x);w<A;++w)y=e[w],y.index=w,typeof y.source!="object"&&(y.source=Zi(M,y.source)),typeof y.target!="object"&&(y.target=Zi(M,y.target)),r[y.source.index]=(r[y.source.index]||0)+1,r[y.target.index]=(r[y.target.index]||0)+1;for(w=0,l=new Array(A);w<A;++w)y=e[w],l[w]=r[y.source.index]/(r[y.source.index]+r[y.target.index]);a=new Array(A),v(),i=new Array(A),b()}}function v(){if(s)for(var w=0,x=e.length;w<x;++w)a[w]=+t(e[w],w,e)}function b(){if(s)for(var w=0,x=e.length;w<x;++w)i[w]=+o(e[w],w,e)}return u.initialize=function(w,x){s=w,c=x,h()},u.links=function(w){return arguments.length?(e=w,h(),u):e},u.id=function(w){return arguments.length?(n=w,u):n},u.iterations=function(w){return arguments.length?(d=+w,u):d},u.strength=function(w){return arguments.length?(t=typeof w=="function"?w:ke(+w),v(),u):t},u.distance=function(w){return arguments.length?(o=typeof w=="function"?w:ke(+w),b(),u):o},u}const j0=1664525,U0=1013904223,es=4294967296;function G0(){let e=1;return()=>(e=(j0*e+U0)%es)/es}function H0(e){return e.x}function W0(e){return e.y}var K0=10,Y0=Math.PI*(3-Math.sqrt(5));function X0(e){var n,t=1,a=.001,o=1-Math.pow(a,1/300),i=0,s=.6,r=new Map,l=pi(g),c=Ut("tick","end"),d=G0();e==null&&(e=[]);function g(){u(),c.call("tick",n),t<a&&(l.stop(),c.call("end",n))}function u(b){var w,x=e.length,A;b===void 0&&(b=1);for(var M=0;M<b;++M)for(t+=(i-t)*o,r.forEach(function(y){y(t)}),w=0;w<x;++w)A=e[w],A.fx==null?A.x+=A.vx*=s:(A.x=A.fx,A.vx=0),A.fy==null?A.y+=A.vy*=s:(A.y=A.fy,A.vy=0);return n}function h(){for(var b=0,w=e.length,x;b<w;++b){if(x=e[b],x.index=b,x.fx!=null&&(x.x=x.fx),x.fy!=null&&(x.y=x.fy),isNaN(x.x)||isNaN(x.y)){var A=K0*Math.sqrt(.5+b),M=b*Y0;x.x=A*Math.cos(M),x.y=A*Math.sin(M)}(isNaN(x.vx)||isNaN(x.vy))&&(x.vx=x.vy=0)}}function v(b){return b.initialize&&b.initialize(e,d),b}return h(),n={tick:u,restart:function(){return l.restart(g),n},stop:function(){return l.stop(),n},nodes:function(b){return arguments.length?(e=b,h(),r.forEach(v),n):e},alpha:function(b){return arguments.length?(t=+b,n):t},alphaMin:function(b){return arguments.length?(a=+b,n):a},alphaDecay:function(b){return arguments.length?(o=+b,n):+o},alphaTarget:function(b){return arguments.length?(i=+b,n):i},velocityDecay:function(b){return arguments.length?(s=1-b,n):1-s},randomSource:function(b){return arguments.length?(d=b,r.forEach(v),n):d},force:function(b,w){return arguments.length>1?(w==null?r.delete(b):r.set(b,v(w)),n):r.get(b)},find:function(b,w,x){var A=0,M=e.length,y,T,k,E,V;for(x==null?x=1/0:x*=x,A=0;A<M;++A)E=e[A],y=b-E.x,T=w-E.y,k=y*y+T*T,k<x&&(V=E,x=k);return V},on:function(b,w){return arguments.length>1?(c.on(b,w),n):c.on(b)}}}function Q0(){var e,n,t,a,o=ke(-30),i,s=1,r=1/0,l=.81;function c(h){var v,b=e.length,w=fi(e,H0,W0).visitAfter(g);for(a=h,v=0;v<b;++v)n=e[v],w.visit(u)}function d(){if(e){var h,v=e.length,b;for(i=new Array(v),h=0;h<v;++h)b=e[h],i[b.index]=+o(b,h,e)}}function g(h){var v=0,b,w,x=0,A,M,y;if(h.length){for(A=M=y=0;y<4;++y)(b=h[y])&&(w=Math.abs(b.value))&&(v+=b.value,x+=w,A+=w*b.x,M+=w*b.y);h.x=A/x,h.y=M/x}else{b=h,b.x=b.data.x,b.y=b.data.y;do v+=i[b.data.index];while(b=b.next)}h.value=v}function u(h,v,b,w){if(!h.value)return!0;var x=h.x-n.x,A=h.y-n.y,M=w-v,y=x*x+A*A;if(M*M/l<y)return y<r&&(x===0&&(x=Ze(t),y+=x*x),A===0&&(A=Ze(t),y+=A*A),y<s&&(y=Math.sqrt(s*y)),n.vx+=x*h.value*a/y,n.vy+=A*h.value*a/y),!0;if(h.length||y>=r)return;(h.data!==n||h.next)&&(x===0&&(x=Ze(t),y+=x*x),A===0&&(A=Ze(t),y+=A*A),y<s&&(y=Math.sqrt(s*y)));do h.data!==n&&(M=i[h.data.index]*a/y,n.vx+=x*M,n.vy+=A*M);while(h=h.next)}return c.initialize=function(h,v){e=h,t=v,d()},c.strength=function(h){return arguments.length?(o=typeof h=="function"?h:ke(+h),d(),c):o},c.distanceMin=function(h){return arguments.length?(s=h*h,c):Math.sqrt(s)},c.distanceMax=function(h){return arguments.length?(r=h*h,c):Math.sqrt(r)},c.theta=function(h){return arguments.length?(l=h*h,c):Math.sqrt(l)},c}function J0(e){var n=ke(.1),t,a,o;typeof e!="function"&&(e=ke(e==null?0:+e));function i(r){for(var l=0,c=t.length,d;l<c;++l)d=t[l],d.vx+=(o[l]-d.x)*a[l]*r}function s(){if(t){var r,l=t.length;for(a=new Array(l),o=new Array(l),r=0;r<l;++r)a[r]=isNaN(o[r]=+e(t[r],r,t))?0:+n(t[r],r,t)}}return i.initialize=function(r){t=r,s()},i.strength=function(r){return arguments.length?(n=typeof r=="function"?r:ke(+r),s(),i):n},i.x=function(r){return arguments.length?(e=typeof r=="function"?r:ke(+r),s(),i):e},i}function Z0(e){var n=ke(.1),t,a,o;typeof e!="function"&&(e=ke(e==null?0:+e));function i(r){for(var l=0,c=t.length,d;l<c;++l)d=t[l],d.vy+=(o[l]-d.y)*a[l]*r}function s(){if(t){var r,l=t.length;for(a=new Array(l),o=new Array(l),r=0;r<l;++r)a[r]=isNaN(o[r]=+e(t[r],r,t))?0:+n(t[r],r,t)}}return i.initialize=function(r){t=r,s()},i.strength=function(r){return arguments.length?(n=typeof r=="function"?r:ke(+r),s(),i):n},i.y=function(r){return arguments.length?(e=typeof r=="function"?r:ke(+r),s(),i):e},i}function eb(e){return Math.abs(e=Math.round(e))>=1e21?e.toLocaleString("en").replace(/,/g,""):e.toString(10)}function xt(e,n){if(!isFinite(e)||e===0)return null;var t=(e=n?e.toExponential(n-1):e.toExponential()).indexOf("e"),a=e.slice(0,t);return[a.length>1?a[0]+a.slice(2):a,+e.slice(t+1)]}function In(e){return e=xt(Math.abs(e)),e?e[1]:NaN}function nb(e,n){return function(t,a){for(var o=t.length,i=[],s=0,r=e[0],l=0;o>0&&r>0&&(l+r+1>a&&(r=Math.max(1,a-l)),i.push(t.substring(o-=r,o+r)),!((l+=r+1)>a));)r=e[s=(s+1)%e.length];return i.reverse().join(n)}}function tb(e){return function(n){return n.replace(/[0-9]/g,function(t){return e[+t]})}}var ab=/^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;function At(e){if(!(n=ab.exec(e)))throw new Error("invalid format: "+e);var n;return new bi({fill:n[1],align:n[2],sign:n[3],symbol:n[4],zero:n[5],width:n[6],comma:n[7],precision:n[8]&&n[8].slice(1),trim:n[9],type:n[10]})}At.prototype=bi.prototype;function bi(e){this.fill=e.fill===void 0?" ":e.fill+"",this.align=e.align===void 0?">":e.align+"",this.sign=e.sign===void 0?"-":e.sign+"",this.symbol=e.symbol===void 0?"":e.symbol+"",this.zero=!!e.zero,this.width=e.width===void 0?void 0:+e.width,this.comma=!!e.comma,this.precision=e.precision===void 0?void 0:+e.precision,this.trim=!!e.trim,this.type=e.type===void 0?"":e.type+""}bi.prototype.toString=function(){return this.fill+this.align+this.sign+this.symbol+(this.zero?"0":"")+(this.width===void 0?"":Math.max(1,this.width|0))+(this.comma?",":"")+(this.precision===void 0?"":"."+Math.max(0,this.precision|0))+(this.trim?"~":"")+this.type};function ob(e){e:for(var n=e.length,t=1,a=-1,o;t<n;++t)switch(e[t]){case".":a=o=t;break;case"0":a===0&&(a=t),o=t;break;default:if(!+e[t])break e;a>0&&(a=0);break}return a>0?e.slice(0,a)+e.slice(o+1):e}var Ct;function ib(e,n){var t=xt(e,n);if(!t)return Ct=void 0,e.toPrecision(n);var a=t[0],o=t[1],i=o-(Ct=Math.max(-8,Math.min(8,Math.floor(o/3)))*3)+1,s=a.length;return i===s?a:i>s?a+new Array(i-s+1).join("0"):i>0?a.slice(0,i)+"."+a.slice(i):"0."+new Array(1-i).join("0")+xt(e,Math.max(0,n+i-1))[0]}function ns(e,n){var t=xt(e,n);if(!t)return e+"";var a=t[0],o=t[1];return o<0?"0."+new Array(-o).join("0")+a:a.length>o+1?a.slice(0,o+1)+"."+a.slice(o+1):a+new Array(o-a.length+2).join("0")}const ts={"%":(e,n)=>(e*100).toFixed(n),b:e=>Math.round(e).toString(2),c:e=>e+"",d:eb,e:(e,n)=>e.toExponential(n),f:(e,n)=>e.toFixed(n),g:(e,n)=>e.toPrecision(n),o:e=>Math.round(e).toString(8),p:(e,n)=>ns(e*100,n),r:ns,s:ib,X:e=>Math.round(e).toString(16).toUpperCase(),x:e=>Math.round(e).toString(16)};function as(e){return e}var os=Array.prototype.map,is=["y","z","a","f","p","n","µ","m","","k","M","G","T","P","E","Z","Y"];function sb(e){var n=e.grouping===void 0||e.thousands===void 0?as:nb(os.call(e.grouping,Number),e.thousands+""),t=e.currency===void 0?"":e.currency[0]+"",a=e.currency===void 0?"":e.currency[1]+"",o=e.decimal===void 0?".":e.decimal+"",i=e.numerals===void 0?as:tb(os.call(e.numerals,String)),s=e.percent===void 0?"%":e.percent+"",r=e.minus===void 0?"−":e.minus+"",l=e.nan===void 0?"NaN":e.nan+"";function c(g,u){g=At(g);var h=g.fill,v=g.align,b=g.sign,w=g.symbol,x=g.zero,A=g.width,M=g.comma,y=g.precision,T=g.trim,k=g.type;k==="n"?(M=!0,k="g"):ts[k]||(y===void 0&&(y=12),T=!0,k="g"),(x||h==="0"&&v==="=")&&(x=!0,h="0",v="=");var E=(u&&u.prefix!==void 0?u.prefix:"")+(w==="$"?t:w==="#"&&/[boxX]/.test(k)?"0"+k.toLowerCase():""),V=(w==="$"?a:/[%p]/.test(k)?s:"")+(u&&u.suffix!==void 0?u.suffix:""),W=ts[k],F=/[defgprs%]/.test(k);y=y===void 0?6:/[gprs]/.test(k)?Math.max(1,Math.min(21,y)):Math.max(0,Math.min(20,y));function $(P){var L=E,z=V,te,ee,K;if(k==="c")z=W(P)+z,P="";else{P=+P;var re=P<0||1/P<0;if(P=isNaN(P)?l:W(Math.abs(P),y),T&&(P=ob(P)),re&&+P==0&&b!=="+"&&(re=!1),L=(re?b==="("?b:r:b==="-"||b==="("?"":b)+L,z=(k==="s"&&!isNaN(P)&&Ct!==void 0?is[8+Ct/3]:"")+z+(re&&b==="("?")":""),F){for(te=-1,ee=P.length;++te<ee;)if(K=P.charCodeAt(te),48>K||K>57){z=(K===46?o+P.slice(te+1):P.slice(te))+z,P=P.slice(0,te);break}}}M&&!x&&(P=n(P,1/0));var de=L.length+P.length+z.length,ue=de<A?new Array(A-de+1).join(h):"";switch(M&&x&&(P=n(ue+P,ue.length?A-z.length:1/0),ue=""),v){case"<":P=L+P+z+ue;break;case"=":P=L+ue+P+z;break;case"^":P=ue.slice(0,de=ue.length>>1)+L+P+z+ue.slice(de);break;default:P=ue+L+P+z;break}return i(P)}return $.toString=function(){return g+""},$}function d(g,u){var h=Math.max(-8,Math.min(8,Math.floor(In(u)/3)))*3,v=Math.pow(10,-h),b=c((g=At(g),g.type="f",g),{suffix:is[8+h/3]});return function(w){return b(v*w)}}return{format:c,formatPrefix:d}}var ot,_r,kr;rb({thousands:",",grouping:[3],currency:["$",""]});function rb(e){return ot=sb(e),_r=ot.format,kr=ot.formatPrefix,ot}function lb(e){return Math.max(0,-In(Math.abs(e)))}function cb(e,n){return Math.max(0,Math.max(-8,Math.min(8,Math.floor(In(n)/3)))*3-In(Math.abs(e)))}function ub(e,n){return e=Math.abs(e),n=Math.abs(n)-e,Math.max(0,In(n)-In(e))+1}function db(e){var n=0,t=e.children,a=t&&t.length;if(!a)n=1;else for(;--a>=0;)n+=t[a].value;e.value=n}function hb(){return this.eachAfter(db)}function pb(e,n){let t=-1;for(const a of this)e.call(n,a,++t,this);return this}function gb(e,n){for(var t=this,a=[t],o,i,s=-1;t=a.pop();)if(e.call(n,t,++s,this),o=t.children)for(i=o.length-1;i>=0;--i)a.push(o[i]);return this}function mb(e,n){for(var t=this,a=[t],o=[],i,s,r,l=-1;t=a.pop();)if(o.push(t),i=t.children)for(s=0,r=i.length;s<r;++s)a.push(i[s]);for(;t=o.pop();)e.call(n,t,++l,this);return this}function fb(e,n){let t=-1;for(const a of this)if(e.call(n,a,++t,this))return a}function vb(e){return this.eachAfter(function(n){for(var t=+e(n.data)||0,a=n.children,o=a&&a.length;--o>=0;)t+=a[o].value;n.value=t})}function bb(e){return this.eachBefore(function(n){n.children&&n.children.sort(e)})}function yb(e){for(var n=this,t=wb(n,e),a=[n];n!==t;)n=n.parent,a.push(n);for(var o=a.length;e!==t;)a.splice(o,0,e),e=e.parent;return a}function wb(e,n){if(e===n)return e;var t=e.ancestors(),a=n.ancestors(),o=null;for(e=t.pop(),n=a.pop();e===n;)o=e,e=t.pop(),n=a.pop();return o}function _b(){for(var e=this,n=[e];e=e.parent;)n.push(e);return n}function kb(){return Array.from(this)}function xb(){var e=[];return this.eachBefore(function(n){n.children||e.push(n)}),e}function Ab(){var e=this,n=[];return e.each(function(t){t!==e&&n.push({source:t.parent,target:t})}),n}function*Cb(){var e=this,n,t=[e],a,o,i;do for(n=t.reverse(),t=[];e=n.pop();)if(yield e,a=e.children)for(o=0,i=a.length;o<i;++o)t.push(a[o]);while(t.length)}function xr(e,n){e instanceof Map?(e=[void 0,e],n===void 0&&(n=Ib)):n===void 0&&(n=Sb);for(var t=new Tt(e),a,o=[t],i,s,r,l;a=o.pop();)if((s=n(a.data))&&(l=(s=Array.from(s)).length))for(a.children=s,r=l-1;r>=0;--r)o.push(i=s[r]=new Tt(s[r])),i.parent=a,i.depth=a.depth+1;return t.eachBefore(Pb)}function Tb(){return xr(this).eachBefore(Db)}function Sb(e){return e.children}function Ib(e){return Array.isArray(e)?e[1]:null}function Db(e){e.data.value!==void 0&&(e.value=e.data.value),e.data=e.data.data}function Pb(e){var n=0;do e.height=n;while((e=e.parent)&&e.height<++n)}function Tt(e){this.data=e,this.depth=this.height=0,this.parent=null}Tt.prototype=xr.prototype={constructor:Tt,count:hb,each:pb,eachAfter:mb,eachBefore:gb,find:fb,sum:vb,sort:bb,path:yb,ancestors:_b,descendants:kb,leaves:xb,links:Ab,copy:Tb,[Symbol.iterator]:Cb};function Mb(e){if(typeof e!="function")throw new Error;return e}function Ln(){return 0}function $n(e){return function(){return e}}function Lb(e){e.x0=Math.round(e.x0),e.y0=Math.round(e.y0),e.x1=Math.round(e.x1),e.y1=Math.round(e.y1)}function $b(e,n,t,a,o){for(var i=e.children,s,r=-1,l=i.length,c=e.value&&(a-n)/e.value;++r<l;)s=i[r],s.y0=t,s.y1=o,s.x0=n,s.x1=n+=s.value*c}function Nb(e,n,t,a,o){for(var i=e.children,s,r=-1,l=i.length,c=e.value&&(o-t)/e.value;++r<l;)s=i[r],s.x0=n,s.x1=a,s.y0=t,s.y1=t+=s.value*c}var Eb=(1+Math.sqrt(5))/2;function Ob(e,n,t,a,o,i){for(var s=[],r=n.children,l,c,d=0,g=0,u=r.length,h,v,b=n.value,w,x,A,M,y,T,k;d<u;){h=o-t,v=i-a;do w=r[g++].value;while(!w&&g<u);for(x=A=w,T=Math.max(v/h,h/v)/(b*e),k=w*w*T,y=Math.max(A/k,k/x);g<u;++g){if(w+=c=r[g].value,c<x&&(x=c),c>A&&(A=c),k=w*w*T,M=Math.max(A/k,k/x),M>y){w-=c;break}y=M}s.push(l={value:w,dice:h<v,children:r.slice(d,g)}),l.dice?$b(l,t,a,o,b?a+=v*w/b:i):Nb(l,t,a,b?t+=h*w/b:o,i),b-=w,d=g}return s}const Rb=function e(n){function t(a,o,i,s,r){Ob(n,a,o,i,s,r)}return t.ratio=function(a){return e((a=+a)>1?a:1)},t}(Eb);function hk(){var e=Rb,n=!1,t=1,a=1,o=[0],i=Ln,s=Ln,r=Ln,l=Ln,c=Ln;function d(u){return u.x0=u.y0=0,u.x1=t,u.y1=a,u.eachBefore(g),o=[0],n&&u.eachBefore(Lb),u}function g(u){var h=o[u.depth],v=u.x0+h,b=u.y0+h,w=u.x1-h,x=u.y1-h;w<v&&(v=w=(v+w)/2),x<b&&(b=x=(b+x)/2),u.x0=v,u.y0=b,u.x1=w,u.y1=x,u.children&&(h=o[u.depth+1]=i(u)/2,v+=c(u)-h,b+=s(u)-h,w-=r(u)-h,x-=l(u)-h,w<v&&(v=w=(v+w)/2),x<b&&(b=x=(b+x)/2),e(u,v,b,w,x))}return d.round=function(u){return arguments.length?(n=!!u,d):n},d.size=function(u){return arguments.length?(t=+u[0],a=+u[1],d):[t,a]},d.tile=function(u){return arguments.length?(e=Mb(u),d):e},d.padding=function(u){return arguments.length?d.paddingInner(u).paddingOuter(u):d.paddingInner()},d.paddingInner=function(u){return arguments.length?(i=typeof u=="function"?u:$n(+u),d):i},d.paddingOuter=function(u){return arguments.length?d.paddingTop(u).paddingRight(u).paddingBottom(u).paddingLeft(u):d.paddingTop()},d.paddingTop=function(u){return arguments.length?(s=typeof u=="function"?u:$n(+u),d):s},d.paddingRight=function(u){return arguments.length?(r=typeof u=="function"?u:$n(+u),d):r},d.paddingBottom=function(u){return arguments.length?(l=typeof u=="function"?u:$n(+u),d):l},d.paddingLeft=function(u){return arguments.length?(c=typeof u=="function"?u:$n(+u),d):c},d}function Xt(e,n){switch(arguments.length){case 0:break;case 1:this.range(e);break;default:this.range(n).domain(e);break}return this}const ss=Symbol("implicit");function Ar(){var e=new $i,n=[],t=[],a=ss;function o(i){let s=e.get(i);if(s===void 0){if(a!==ss)return a;e.set(i,s=n.push(i)-1)}return t[s%t.length]}return o.domain=function(i){if(!arguments.length)return n.slice();n=[],e=new $i;for(const s of i)e.has(s)||e.set(s,n.push(s)-1);return o},o.range=function(i){return arguments.length?(t=Array.from(i),o):t.slice()},o.unknown=function(i){return arguments.length?(a=i,o):a},o.copy=function(){return Ar(n,t).unknown(a)},Xt.apply(o,arguments),o}function zb(){var e=Ar().unknown(void 0),n=e.domain,t=e.range,a=0,o=1,i,s,r=!1,l=0,c=0,d=.5;delete e.unknown;function g(){var u=n().length,h=o<a,v=h?o:a,b=h?a:o;i=(b-v)/Math.max(1,u-l+c*2),r&&(i=Math.floor(i)),v+=(b-v-i*(u-l))*d,s=i*(1-l),r&&(v=Math.round(v),s=Math.round(s));var w=Pg(u).map(function(x){return v+i*x});return t(h?w.reverse():w)}return e.domain=function(u){return arguments.length?(n(u),g()):n()},e.range=function(u){return arguments.length?([a,o]=u,a=+a,o=+o,g()):[a,o]},e.rangeRound=function(u){return[a,o]=u,a=+a,o=+o,r=!0,g()},e.bandwidth=function(){return s},e.step=function(){return i},e.round=function(u){return arguments.length?(r=!!u,g()):r},e.padding=function(u){return arguments.length?(l=Math.min(1,c=+u),g()):l},e.paddingInner=function(u){return arguments.length?(l=Math.min(1,u),g()):l},e.paddingOuter=function(u){return arguments.length?(c=+u,g()):c},e.align=function(u){return arguments.length?(d=Math.max(0,Math.min(1,u)),g()):d},e.copy=function(){return zb(n(),[a,o]).round(r).paddingInner(l).paddingOuter(c).align(d)},Xt.apply(g(),arguments)}function qb(e){return function(){return e}}function Bb(e){return+e}var rs=[0,1];function wn(e){return e}function Ea(e,n){return(n-=e=+e)?function(t){return(t-e)/n}:qb(isNaN(n)?NaN:.5)}function Vb(e,n){var t;return e>n&&(t=e,e=n,n=t),function(a){return Math.max(e,Math.min(n,a))}}function Fb(e,n,t){var a=e[0],o=e[1],i=n[0],s=n[1];return o<a?(a=Ea(o,a),i=t(s,i)):(a=Ea(a,o),i=t(i,s)),function(r){return i(a(r))}}function jb(e,n,t){var a=Math.min(e.length,n.length)-1,o=new Array(a),i=new Array(a),s=-1;for(e[a]<e[0]&&(e=e.slice().reverse(),n=n.slice().reverse());++s<a;)o[s]=Ea(e[s],e[s+1]),i[s]=t(n[s],n[s+1]);return function(r){var l=kg(e,r,1,a)-1;return i[l](o[l](r))}}function Cr(e,n){return n.domain(e.domain()).range(e.range()).interpolate(e.interpolate()).clamp(e.clamp()).unknown(e.unknown())}function Ub(){var e=rs,n=rs,t=di,a,o,i,s=wn,r,l,c;function d(){var u=Math.min(e.length,n.length);return s!==wn&&(s=Vb(e[0],e[u-1])),r=u>2?jb:Fb,l=c=null,g}function g(u){return u==null||isNaN(u=+u)?i:(l||(l=r(e.map(a),n,t)))(a(s(u)))}return g.invert=function(u){return s(o((c||(c=r(n,e.map(a),$e)))(u)))},g.domain=function(u){return arguments.length?(e=Array.from(u,Bb),d()):e.slice()},g.range=function(u){return arguments.length?(n=Array.from(u),d()):n.slice()},g.rangeRound=function(u){return n=Array.from(u),t=ev,d()},g.clamp=function(u){return arguments.length?(s=u?!0:wn,d()):s!==wn},g.interpolate=function(u){return arguments.length?(t=u,d()):t},g.unknown=function(u){return arguments.length?(i=u,g):i},function(u,h){return a=u,o=h,d()}}function Tr(){return Ub()(wn,wn)}function Gb(e,n,t,a){var o=ka(e,n,t),i;switch(a=At(a??",f"),a.type){case"s":{var s=Math.max(Math.abs(e),Math.abs(n));return a.precision==null&&!isNaN(i=cb(o,s))&&(a.precision=i),kr(a,s)}case"":case"e":case"g":case"p":case"r":{a.precision==null&&!isNaN(i=ub(o,Math.max(Math.abs(e),Math.abs(n))))&&(a.precision=i-(a.type==="e"));break}case"f":case"%":{a.precision==null&&!isNaN(i=lb(o))&&(a.precision=i-(a.type==="%")*2);break}}return _r(a)}function Hb(e){var n=e.domain;return e.ticks=function(t){var a=n();return Dg(a[0],a[a.length-1],t??10)},e.tickFormat=function(t,a){var o=n();return Gb(o[0],o[o.length-1],t??10,a)},e.nice=function(t){t==null&&(t=10);var a=n(),o=0,i=a.length-1,s=a[o],r=a[i],l,c,d=10;for(r<s&&(c=s,s=r,r=c,c=o,o=i,i=c);d-- >0;){if(c=_a(s,r,t),c===l)return a[o]=s,a[i]=r,n(a);if(c>0)s=Math.floor(s/c)*c,r=Math.ceil(r/c)*c;else if(c<0)s=Math.ceil(s*c)/c,r=Math.floor(r*c)/c;else break;l=c}return e},e}function Wb(){var e=Tr();return e.copy=function(){return Cr(e,Wb())},Xt.apply(e,arguments),Hb(e)}function Kb(e,n){e=e.slice();var t=0,a=e.length-1,o=e[t],i=e[a],s;return i<o&&(s=t,t=a,a=s,s=o,o=i,i=s),e[t]=n.floor(o),e[a]=n.ceil(i),e}const ca=new Date,ua=new Date;function ge(e,n,t,a){function o(i){return e(i=arguments.length===0?new Date:new Date(+i)),i}return o.floor=i=>(e(i=new Date(+i)),i),o.ceil=i=>(e(i=new Date(i-1)),n(i,1),e(i),i),o.round=i=>{const s=o(i),r=o.ceil(i);return i-s<r-i?s:r},o.offset=(i,s)=>(n(i=new Date(+i),s==null?1:Math.floor(s)),i),o.range=(i,s,r)=>{const l=[];if(i=o.ceil(i),r=r==null?1:Math.floor(r),!(i<s)||!(r>0))return l;let c;do l.push(c=new Date(+i)),n(i,r),e(i);while(c<i&&i<s);return l},o.filter=i=>ge(s=>{if(s>=s)for(;e(s),!i(s);)s.setTime(s-1)},(s,r)=>{if(s>=s)if(r<0)for(;++r<=0;)for(;n(s,-1),!i(s););else for(;--r>=0;)for(;n(s,1),!i(s););}),t&&(o.count=(i,s)=>(ca.setTime(+i),ua.setTime(+s),e(ca),e(ua),Math.floor(t(ca,ua))),o.every=i=>(i=Math.floor(i),!isFinite(i)||!(i>0)?null:i>1?o.filter(a?s=>a(s)%i===0:s=>o.count(0,s)%i===0):o)),o}const St=ge(()=>{},(e,n)=>{e.setTime(+e+n)},(e,n)=>n-e);St.every=e=>(e=Math.floor(e),!isFinite(e)||!(e>0)?null:e>1?ge(n=>{n.setTime(Math.floor(n/e)*e)},(n,t)=>{n.setTime(+n+t*e)},(n,t)=>(t-n)/e):St);St.range;const He=1e3,Pe=He*60,We=Pe*60,Ye=We*24,yi=Ye*7,ls=Ye*30,da=Ye*365,_n=ge(e=>{e.setTime(e-e.getMilliseconds())},(e,n)=>{e.setTime(+e+n*He)},(e,n)=>(n-e)/He,e=>e.getUTCSeconds());_n.range;const wi=ge(e=>{e.setTime(e-e.getMilliseconds()-e.getSeconds()*He)},(e,n)=>{e.setTime(+e+n*Pe)},(e,n)=>(n-e)/Pe,e=>e.getMinutes());wi.range;const Yb=ge(e=>{e.setUTCSeconds(0,0)},(e,n)=>{e.setTime(+e+n*Pe)},(e,n)=>(n-e)/Pe,e=>e.getUTCMinutes());Yb.range;const _i=ge(e=>{e.setTime(e-e.getMilliseconds()-e.getSeconds()*He-e.getMinutes()*Pe)},(e,n)=>{e.setTime(+e+n*We)},(e,n)=>(n-e)/We,e=>e.getHours());_i.range;const Xb=ge(e=>{e.setUTCMinutes(0,0,0)},(e,n)=>{e.setTime(+e+n*We)},(e,n)=>(n-e)/We,e=>e.getUTCHours());Xb.range;const Jn=ge(e=>e.setHours(0,0,0,0),(e,n)=>e.setDate(e.getDate()+n),(e,n)=>(n-e-(n.getTimezoneOffset()-e.getTimezoneOffset())*Pe)/Ye,e=>e.getDate()-1);Jn.range;const ki=ge(e=>{e.setUTCHours(0,0,0,0)},(e,n)=>{e.setUTCDate(e.getUTCDate()+n)},(e,n)=>(n-e)/Ye,e=>e.getUTCDate()-1);ki.range;const Qb=ge(e=>{e.setUTCHours(0,0,0,0)},(e,n)=>{e.setUTCDate(e.getUTCDate()+n)},(e,n)=>(n-e)/Ye,e=>Math.floor(e/Ye));Qb.range;function vn(e){return ge(n=>{n.setDate(n.getDate()-(n.getDay()+7-e)%7),n.setHours(0,0,0,0)},(n,t)=>{n.setDate(n.getDate()+t*7)},(n,t)=>(t-n-(t.getTimezoneOffset()-n.getTimezoneOffset())*Pe)/yi)}const Qt=vn(0),It=vn(1),Jb=vn(2),Zb=vn(3),Dn=vn(4),ey=vn(5),ny=vn(6);Qt.range;It.range;Jb.range;Zb.range;Dn.range;ey.range;ny.range;function bn(e){return ge(n=>{n.setUTCDate(n.getUTCDate()-(n.getUTCDay()+7-e)%7),n.setUTCHours(0,0,0,0)},(n,t)=>{n.setUTCDate(n.getUTCDate()+t*7)},(n,t)=>(t-n)/yi)}const Sr=bn(0),Dt=bn(1),ty=bn(2),ay=bn(3),Pn=bn(4),oy=bn(5),iy=bn(6);Sr.range;Dt.range;ty.range;ay.range;Pn.range;oy.range;iy.range;const xi=ge(e=>{e.setDate(1),e.setHours(0,0,0,0)},(e,n)=>{e.setMonth(e.getMonth()+n)},(e,n)=>n.getMonth()-e.getMonth()+(n.getFullYear()-e.getFullYear())*12,e=>e.getMonth());xi.range;const sy=ge(e=>{e.setUTCDate(1),e.setUTCHours(0,0,0,0)},(e,n)=>{e.setUTCMonth(e.getUTCMonth()+n)},(e,n)=>n.getUTCMonth()-e.getUTCMonth()+(n.getUTCFullYear()-e.getUTCFullYear())*12,e=>e.getUTCMonth());sy.range;const Xe=ge(e=>{e.setMonth(0,1),e.setHours(0,0,0,0)},(e,n)=>{e.setFullYear(e.getFullYear()+n)},(e,n)=>n.getFullYear()-e.getFullYear(),e=>e.getFullYear());Xe.every=e=>!isFinite(e=Math.floor(e))||!(e>0)?null:ge(n=>{n.setFullYear(Math.floor(n.getFullYear()/e)*e),n.setMonth(0,1),n.setHours(0,0,0,0)},(n,t)=>{n.setFullYear(n.getFullYear()+t*e)});Xe.range;const pn=ge(e=>{e.setUTCMonth(0,1),e.setUTCHours(0,0,0,0)},(e,n)=>{e.setUTCFullYear(e.getUTCFullYear()+n)},(e,n)=>n.getUTCFullYear()-e.getUTCFullYear(),e=>e.getUTCFullYear());pn.every=e=>!isFinite(e=Math.floor(e))||!(e>0)?null:ge(n=>{n.setUTCFullYear(Math.floor(n.getUTCFullYear()/e)*e),n.setUTCMonth(0,1),n.setUTCHours(0,0,0,0)},(n,t)=>{n.setUTCFullYear(n.getUTCFullYear()+t*e)});pn.range;function ry(e,n,t,a,o,i){const s=[[_n,1,He],[_n,5,5*He],[_n,15,15*He],[_n,30,30*He],[i,1,Pe],[i,5,5*Pe],[i,15,15*Pe],[i,30,30*Pe],[o,1,We],[o,3,3*We],[o,6,6*We],[o,12,12*We],[a,1,Ye],[a,2,2*Ye],[t,1,yi],[n,1,ls],[n,3,3*ls],[e,1,da]];function r(c,d,g){const u=d<c;u&&([c,d]=[d,c]);const h=g&&typeof g.range=="function"?g:l(c,d,g),v=h?h.range(c,+d+1):[];return u?v.reverse():v}function l(c,d,g){const u=Math.abs(d-c)/g,h=li(([,,w])=>w).right(s,u);if(h===s.length)return e.every(ka(c/da,d/da,g));if(h===0)return St.every(Math.max(ka(c,d,g),1));const[v,b]=s[u/s[h-1][2]<s[h][2]/u?h-1:h];return v.every(b)}return[r,l]}const[ly,cy]=ry(Xe,xi,Qt,Jn,_i,wi);function ha(e){if(0<=e.y&&e.y<100){var n=new Date(-1,e.m,e.d,e.H,e.M,e.S,e.L);return n.setFullYear(e.y),n}return new Date(e.y,e.m,e.d,e.H,e.M,e.S,e.L)}function pa(e){if(0<=e.y&&e.y<100){var n=new Date(Date.UTC(-1,e.m,e.d,e.H,e.M,e.S,e.L));return n.setUTCFullYear(e.y),n}return new Date(Date.UTC(e.y,e.m,e.d,e.H,e.M,e.S,e.L))}function Nn(e,n,t){return{y:e,m:n,d:t,H:0,M:0,S:0,L:0}}function uy(e){var n=e.dateTime,t=e.date,a=e.time,o=e.periods,i=e.days,s=e.shortDays,r=e.months,l=e.shortMonths,c=En(o),d=On(o),g=En(i),u=On(i),h=En(s),v=On(s),b=En(r),w=On(r),x=En(l),A=On(l),M={a:K,A:re,b:de,B:ue,c:null,d:gs,e:gs,f:$y,g:jy,G:Gy,H:Py,I:My,j:Ly,L:Ir,m:Ny,M:Ey,p:Ce,q:we,Q:vs,s:bs,S:Oy,u:Ry,U:zy,V:qy,w:By,W:Vy,x:null,X:null,y:Fy,Y:Uy,Z:Hy,"%":fs},y={a:le,A:Le,b:Te,B:I,c:null,d:ms,e:ms,f:Xy,g:s2,G:l2,H:Wy,I:Ky,j:Yy,L:Pr,m:Qy,M:Jy,p:B,q:H,Q:vs,s:bs,S:Zy,u:e2,U:n2,V:t2,w:a2,W:o2,x:null,X:null,y:i2,Y:r2,Z:c2,"%":fs},T={a:F,A:$,b:P,B:L,c:z,d:hs,e:hs,f:Ty,g:ds,G:us,H:ps,I:ps,j:ky,L:Cy,m:_y,M:xy,p:W,q:wy,Q:Iy,s:Dy,S:Ay,u:my,U:fy,V:vy,w:gy,W:by,x:te,X:ee,y:ds,Y:us,Z:yy,"%":Sy};M.x=k(t,M),M.X=k(a,M),M.c=k(n,M),y.x=k(t,y),y.X=k(a,y),y.c=k(n,y);function k(O,Y){return function(J){var D=[],oe=-1,ce=0,Se=O.length,Ie,an,Pi;for(J instanceof Date||(J=new Date(+J));++oe<Se;)O.charCodeAt(oe)===37&&(D.push(O.slice(ce,oe)),(an=cs[Ie=O.charAt(++oe)])!=null?Ie=O.charAt(++oe):an=Ie==="e"?" ":"0",(Pi=Y[Ie])&&(Ie=Pi(J,an)),D.push(Ie),ce=oe+1);return D.push(O.slice(ce,oe)),D.join("")}}function E(O,Y){return function(J){var D=Nn(1900,void 0,1),oe=V(D,O,J+="",0),ce,Se;if(oe!=J.length)return null;if("Q"in D)return new Date(D.Q);if("s"in D)return new Date(D.s*1e3+("L"in D?D.L:0));if(Y&&!("Z"in D)&&(D.Z=0),"p"in D&&(D.H=D.H%12+D.p*12),D.m===void 0&&(D.m="q"in D?D.q:0),"V"in D){if(D.V<1||D.V>53)return null;"w"in D||(D.w=1),"Z"in D?(ce=pa(Nn(D.y,0,1)),Se=ce.getUTCDay(),ce=Se>4||Se===0?Dt.ceil(ce):Dt(ce),ce=ki.offset(ce,(D.V-1)*7),D.y=ce.getUTCFullYear(),D.m=ce.getUTCMonth(),D.d=ce.getUTCDate()+(D.w+6)%7):(ce=ha(Nn(D.y,0,1)),Se=ce.getDay(),ce=Se>4||Se===0?It.ceil(ce):It(ce),ce=Jn.offset(ce,(D.V-1)*7),D.y=ce.getFullYear(),D.m=ce.getMonth(),D.d=ce.getDate()+(D.w+6)%7)}else("W"in D||"U"in D)&&("w"in D||(D.w="u"in D?D.u%7:"W"in D?1:0),Se="Z"in D?pa(Nn(D.y,0,1)).getUTCDay():ha(Nn(D.y,0,1)).getDay(),D.m=0,D.d="W"in D?(D.w+6)%7+D.W*7-(Se+5)%7:D.w+D.U*7-(Se+6)%7);return"Z"in D?(D.H+=D.Z/100|0,D.M+=D.Z%100,pa(D)):ha(D)}}function V(O,Y,J,D){for(var oe=0,ce=Y.length,Se=J.length,Ie,an;oe<ce;){if(D>=Se)return-1;if(Ie=Y.charCodeAt(oe++),Ie===37){if(Ie=Y.charAt(oe++),an=T[Ie in cs?Y.charAt(oe++):Ie],!an||(D=an(O,J,D))<0)return-1}else if(Ie!=J.charCodeAt(D++))return-1}return D}function W(O,Y,J){var D=c.exec(Y.slice(J));return D?(O.p=d.get(D[0].toLowerCase()),J+D[0].length):-1}function F(O,Y,J){var D=h.exec(Y.slice(J));return D?(O.w=v.get(D[0].toLowerCase()),J+D[0].length):-1}function $(O,Y,J){var D=g.exec(Y.slice(J));return D?(O.w=u.get(D[0].toLowerCase()),J+D[0].length):-1}function P(O,Y,J){var D=x.exec(Y.slice(J));return D?(O.m=A.get(D[0].toLowerCase()),J+D[0].length):-1}function L(O,Y,J){var D=b.exec(Y.slice(J));return D?(O.m=w.get(D[0].toLowerCase()),J+D[0].length):-1}function z(O,Y,J){return V(O,n,Y,J)}function te(O,Y,J){return V(O,t,Y,J)}function ee(O,Y,J){return V(O,a,Y,J)}function K(O){return s[O.getDay()]}function re(O){return i[O.getDay()]}function de(O){return l[O.getMonth()]}function ue(O){return r[O.getMonth()]}function Ce(O){return o[+(O.getHours()>=12)]}function we(O){return 1+~~(O.getMonth()/3)}function le(O){return s[O.getUTCDay()]}function Le(O){return i[O.getUTCDay()]}function Te(O){return l[O.getUTCMonth()]}function I(O){return r[O.getUTCMonth()]}function B(O){return o[+(O.getUTCHours()>=12)]}function H(O){return 1+~~(O.getUTCMonth()/3)}return{format:function(O){var Y=k(O+="",M);return Y.toString=function(){return O},Y},parse:function(O){var Y=E(O+="",!1);return Y.toString=function(){return O},Y},utcFormat:function(O){var Y=k(O+="",y);return Y.toString=function(){return O},Y},utcParse:function(O){var Y=E(O+="",!0);return Y.toString=function(){return O},Y}}}var cs={"-":"",_:" ",0:"0"},fe=/^\s*\d+/,dy=/^%/,hy=/[\\^$*+?|[\]().{}]/g;function se(e,n,t){var a=e<0?"-":"",o=(a?-e:e)+"",i=o.length;return a+(i<t?new Array(t-i+1).join(n)+o:o)}function py(e){return e.replace(hy,"\\$&")}function En(e){return new RegExp("^(?:"+e.map(py).join("|")+")","i")}function On(e){return new Map(e.map((n,t)=>[n.toLowerCase(),t]))}function gy(e,n,t){var a=fe.exec(n.slice(t,t+1));return a?(e.w=+a[0],t+a[0].length):-1}function my(e,n,t){var a=fe.exec(n.slice(t,t+1));return a?(e.u=+a[0],t+a[0].length):-1}function fy(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.U=+a[0],t+a[0].length):-1}function vy(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.V=+a[0],t+a[0].length):-1}function by(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.W=+a[0],t+a[0].length):-1}function us(e,n,t){var a=fe.exec(n.slice(t,t+4));return a?(e.y=+a[0],t+a[0].length):-1}function ds(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.y=+a[0]+(+a[0]>68?1900:2e3),t+a[0].length):-1}function yy(e,n,t){var a=/^(Z)|([+-]\d\d)(?::?(\d\d))?/.exec(n.slice(t,t+6));return a?(e.Z=a[1]?0:-(a[2]+(a[3]||"00")),t+a[0].length):-1}function wy(e,n,t){var a=fe.exec(n.slice(t,t+1));return a?(e.q=a[0]*3-3,t+a[0].length):-1}function _y(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.m=a[0]-1,t+a[0].length):-1}function hs(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.d=+a[0],t+a[0].length):-1}function ky(e,n,t){var a=fe.exec(n.slice(t,t+3));return a?(e.m=0,e.d=+a[0],t+a[0].length):-1}function ps(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.H=+a[0],t+a[0].length):-1}function xy(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.M=+a[0],t+a[0].length):-1}function Ay(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.S=+a[0],t+a[0].length):-1}function Cy(e,n,t){var a=fe.exec(n.slice(t,t+3));return a?(e.L=+a[0],t+a[0].length):-1}function Ty(e,n,t){var a=fe.exec(n.slice(t,t+6));return a?(e.L=Math.floor(a[0]/1e3),t+a[0].length):-1}function Sy(e,n,t){var a=dy.exec(n.slice(t,t+1));return a?t+a[0].length:-1}function Iy(e,n,t){var a=fe.exec(n.slice(t));return a?(e.Q=+a[0],t+a[0].length):-1}function Dy(e,n,t){var a=fe.exec(n.slice(t));return a?(e.s=+a[0],t+a[0].length):-1}function gs(e,n){return se(e.getDate(),n,2)}function Py(e,n){return se(e.getHours(),n,2)}function My(e,n){return se(e.getHours()%12||12,n,2)}function Ly(e,n){return se(1+Jn.count(Xe(e),e),n,3)}function Ir(e,n){return se(e.getMilliseconds(),n,3)}function $y(e,n){return Ir(e,n)+"000"}function Ny(e,n){return se(e.getMonth()+1,n,2)}function Ey(e,n){return se(e.getMinutes(),n,2)}function Oy(e,n){return se(e.getSeconds(),n,2)}function Ry(e){var n=e.getDay();return n===0?7:n}function zy(e,n){return se(Qt.count(Xe(e)-1,e),n,2)}function Dr(e){var n=e.getDay();return n>=4||n===0?Dn(e):Dn.ceil(e)}function qy(e,n){return e=Dr(e),se(Dn.count(Xe(e),e)+(Xe(e).getDay()===4),n,2)}function By(e){return e.getDay()}function Vy(e,n){return se(It.count(Xe(e)-1,e),n,2)}function Fy(e,n){return se(e.getFullYear()%100,n,2)}function jy(e,n){return e=Dr(e),se(e.getFullYear()%100,n,2)}function Uy(e,n){return se(e.getFullYear()%1e4,n,4)}function Gy(e,n){var t=e.getDay();return e=t>=4||t===0?Dn(e):Dn.ceil(e),se(e.getFullYear()%1e4,n,4)}function Hy(e){var n=e.getTimezoneOffset();return(n>0?"-":(n*=-1,"+"))+se(n/60|0,"0",2)+se(n%60,"0",2)}function ms(e,n){return se(e.getUTCDate(),n,2)}function Wy(e,n){return se(e.getUTCHours(),n,2)}function Ky(e,n){return se(e.getUTCHours()%12||12,n,2)}function Yy(e,n){return se(1+ki.count(pn(e),e),n,3)}function Pr(e,n){return se(e.getUTCMilliseconds(),n,3)}function Xy(e,n){return Pr(e,n)+"000"}function Qy(e,n){return se(e.getUTCMonth()+1,n,2)}function Jy(e,n){return se(e.getUTCMinutes(),n,2)}function Zy(e,n){return se(e.getUTCSeconds(),n,2)}function e2(e){var n=e.getUTCDay();return n===0?7:n}function n2(e,n){return se(Sr.count(pn(e)-1,e),n,2)}function Mr(e){var n=e.getUTCDay();return n>=4||n===0?Pn(e):Pn.ceil(e)}function t2(e,n){return e=Mr(e),se(Pn.count(pn(e),e)+(pn(e).getUTCDay()===4),n,2)}function a2(e){return e.getUTCDay()}function o2(e,n){return se(Dt.count(pn(e)-1,e),n,2)}function i2(e,n){return se(e.getUTCFullYear()%100,n,2)}function s2(e,n){return e=Mr(e),se(e.getUTCFullYear()%100,n,2)}function r2(e,n){return se(e.getUTCFullYear()%1e4,n,4)}function l2(e,n){var t=e.getUTCDay();return e=t>=4||t===0?Pn(e):Pn.ceil(e),se(e.getUTCFullYear()%1e4,n,4)}function c2(){return"+0000"}function fs(){return"%"}function vs(e){return+e}function bs(e){return Math.floor(+e/1e3)}var yn,Lr;u2({dateTime:"%x, %X",date:"%-m/%-d/%Y",time:"%-I:%M:%S %p",periods:["AM","PM"],days:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],shortDays:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],months:["January","February","March","April","May","June","July","August","September","October","November","December"],shortMonths:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"]});function u2(e){return yn=uy(e),Lr=yn.format,yn.parse,yn.utcFormat,yn.utcParse,yn}function d2(e){return new Date(e)}function h2(e){return e instanceof Date?+e:+new Date(+e)}function $r(e,n,t,a,o,i,s,r,l,c){var d=Tr(),g=d.invert,u=d.domain,h=c(".%L"),v=c(":%S"),b=c("%I:%M"),w=c("%I %p"),x=c("%a %d"),A=c("%b %d"),M=c("%B"),y=c("%Y");function T(k){return(l(k)<k?h:r(k)<k?v:s(k)<k?b:i(k)<k?w:a(k)<k?o(k)<k?x:A:t(k)<k?M:y)(k)}return d.invert=function(k){return new Date(g(k))},d.domain=function(k){return arguments.length?u(Array.from(k,h2)):u().map(d2)},d.ticks=function(k){var E=u();return e(E[0],E[E.length-1],k??10)},d.tickFormat=function(k,E){return E==null?T:c(E)},d.nice=function(k){var E=u();return(!k||typeof k.range!="function")&&(k=n(E[0],E[E.length-1],k??10)),k?u(Kb(E,k)):d},d.copy=function(){return Cr(d,$r(e,n,t,a,o,i,s,r,l,c))},d}function pk(){return Xt.apply($r(ly,cy,Xe,xi,Qt,Jn,_i,wi,_n,Lr).domain([new Date(2e3,0,1),new Date(2e3,0,2)]),arguments)}function p2(e){for(var n=e.length/6|0,t=new Array(n),a=0;a<n;)t[a]="#"+e.slice(a*6,++a*6);return t}const gk=p2("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab");function he(e){return function(){return e}}const ys=Math.abs,ve=Math.atan2,on=Math.cos,g2=Math.max,ga=Math.min,Re=Math.sin,kn=Math.sqrt,be=1e-12,Wn=Math.PI,Pt=Wn/2,ht=2*Wn;function m2(e){return e>1?0:e<-1?Wn:Math.acos(e)}function ws(e){return e>=1?Pt:e<=-1?-Pt:Math.asin(e)}function Nr(e){let n=3;return e.digits=function(t){if(!arguments.length)return n;if(t==null)n=null;else{const a=Math.floor(t);if(!(a>=0))throw new RangeError(`invalid digits: ${t}`);n=a}return e},()=>new w0(n)}function f2(e){return e.innerRadius}function v2(e){return e.outerRadius}function b2(e){return e.startAngle}function y2(e){return e.endAngle}function w2(e){return e&&e.padAngle}function _2(e,n,t,a,o,i,s,r){var l=t-e,c=a-n,d=s-o,g=r-i,u=g*l-d*c;if(!(u*u<be))return u=(d*(n-i)-g*(e-o))/u,[e+u*l,n+u*c]}function it(e,n,t,a,o,i,s){var r=e-t,l=n-a,c=(s?i:-i)/kn(r*r+l*l),d=c*l,g=-c*r,u=e+d,h=n+g,v=t+d,b=a+g,w=(u+v)/2,x=(h+b)/2,A=v-u,M=b-h,y=A*A+M*M,T=o-i,k=u*b-v*h,E=(M<0?-1:1)*kn(g2(0,T*T*y-k*k)),V=(k*M-A*E)/y,W=(-k*A-M*E)/y,F=(k*M+A*E)/y,$=(-k*A+M*E)/y,P=V-w,L=W-x,z=F-w,te=$-x;return P*P+L*L>z*z+te*te&&(V=F,W=$),{cx:V,cy:W,x01:-d,y01:-g,x11:V*(o/T-1),y11:W*(o/T-1)}}function mk(){var e=f2,n=v2,t=he(0),a=null,o=b2,i=y2,s=w2,r=null,l=Nr(c);function c(){var d,g,u=+e.apply(this,arguments),h=+n.apply(this,arguments),v=o.apply(this,arguments)-Pt,b=i.apply(this,arguments)-Pt,w=ys(b-v),x=b>v;if(r||(r=d=l()),h<u&&(g=h,h=u,u=g),!(h>be))r.moveTo(0,0);else if(w>ht-be)r.moveTo(h*on(v),h*Re(v)),r.arc(0,0,h,v,b,!x),u>be&&(r.moveTo(u*on(b),u*Re(b)),r.arc(0,0,u,b,v,x));else{var A=v,M=b,y=v,T=b,k=w,E=w,V=s.apply(this,arguments)/2,W=V>be&&(a?+a.apply(this,arguments):kn(u*u+h*h)),F=ga(ys(h-u)/2,+t.apply(this,arguments)),$=F,P=F,L,z;if(W>be){var te=ws(W/u*Re(V)),ee=ws(W/h*Re(V));(k-=te*2)>be?(te*=x?1:-1,y+=te,T-=te):(k=0,y=T=(v+b)/2),(E-=ee*2)>be?(ee*=x?1:-1,A+=ee,M-=ee):(E=0,A=M=(v+b)/2)}var K=h*on(A),re=h*Re(A),de=u*on(T),ue=u*Re(T);if(F>be){var Ce=h*on(M),we=h*Re(M),le=u*on(y),Le=u*Re(y),Te;if(w<Wn)if(Te=_2(K,re,le,Le,Ce,we,de,ue)){var I=K-Te[0],B=re-Te[1],H=Ce-Te[0],O=we-Te[1],Y=1/Re(m2((I*H+B*O)/(kn(I*I+B*B)*kn(H*H+O*O)))/2),J=kn(Te[0]*Te[0]+Te[1]*Te[1]);$=ga(F,(u-J)/(Y-1)),P=ga(F,(h-J)/(Y+1))}else $=P=0}E>be?P>be?(L=it(le,Le,K,re,h,P,x),z=it(Ce,we,de,ue,h,P,x),r.moveTo(L.cx+L.x01,L.cy+L.y01),P<F?r.arc(L.cx,L.cy,P,ve(L.y01,L.x01),ve(z.y01,z.x01),!x):(r.arc(L.cx,L.cy,P,ve(L.y01,L.x01),ve(L.y11,L.x11),!x),r.arc(0,0,h,ve(L.cy+L.y11,L.cx+L.x11),ve(z.cy+z.y11,z.cx+z.x11),!x),r.arc(z.cx,z.cy,P,ve(z.y11,z.x11),ve(z.y01,z.x01),!x))):(r.moveTo(K,re),r.arc(0,0,h,A,M,!x)):r.moveTo(K,re),!(u>be)||!(k>be)?r.lineTo(de,ue):$>be?(L=it(de,ue,Ce,we,u,-$,x),z=it(K,re,le,Le,u,-$,x),r.lineTo(L.cx+L.x01,L.cy+L.y01),$<F?r.arc(L.cx,L.cy,$,ve(L.y01,L.x01),ve(z.y01,z.x01),!x):(r.arc(L.cx,L.cy,$,ve(L.y01,L.x01),ve(L.y11,L.x11),!x),r.arc(0,0,u,ve(L.cy+L.y11,L.cx+L.x11),ve(z.cy+z.y11,z.cx+z.x11),x),r.arc(z.cx,z.cy,$,ve(z.y11,z.x11),ve(z.y01,z.x01),!x))):r.arc(0,0,u,T,y,x)}if(r.closePath(),d)return r=null,d+""||null}return c.centroid=function(){var d=(+e.apply(this,arguments)+ +n.apply(this,arguments))/2,g=(+o.apply(this,arguments)+ +i.apply(this,arguments))/2-Wn/2;return[on(g)*d,Re(g)*d]},c.innerRadius=function(d){return arguments.length?(e=typeof d=="function"?d:he(+d),c):e},c.outerRadius=function(d){return arguments.length?(n=typeof d=="function"?d:he(+d),c):n},c.cornerRadius=function(d){return arguments.length?(t=typeof d=="function"?d:he(+d),c):t},c.padRadius=function(d){return arguments.length?(a=d==null?null:typeof d=="function"?d:he(+d),c):a},c.startAngle=function(d){return arguments.length?(o=typeof d=="function"?d:he(+d),c):o},c.endAngle=function(d){return arguments.length?(i=typeof d=="function"?d:he(+d),c):i},c.padAngle=function(d){return arguments.length?(s=typeof d=="function"?d:he(+d),c):s},c.context=function(d){return arguments.length?(r=d??null,c):r},c}function Er(e){return typeof e=="object"&&"length"in e?e:Array.from(e)}function Or(e){this._context=e}Or.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1,this._line?this._context.lineTo(e,n):this._context.moveTo(e,n);break;case 1:this._point=2;default:this._context.lineTo(e,n);break}}};function k2(e){return new Or(e)}function x2(e){return e[0]}function A2(e){return e[1]}function fk(e,n){var t=he(!0),a=null,o=k2,i=null,s=Nr(r);e=typeof e=="function"?e:e===void 0?x2:he(e),n=typeof n=="function"?n:n===void 0?A2:he(n);function r(l){var c,d=(l=Er(l)).length,g,u=!1,h;for(a==null&&(i=o(h=s())),c=0;c<=d;++c)!(c<d&&t(g=l[c],c,l))===u&&((u=!u)?i.lineStart():i.lineEnd()),u&&i.point(+e(g,c,l),+n(g,c,l));if(h)return i=null,h+""||null}return r.x=function(l){return arguments.length?(e=typeof l=="function"?l:he(+l),r):e},r.y=function(l){return arguments.length?(n=typeof l=="function"?l:he(+l),r):n},r.defined=function(l){return arguments.length?(t=typeof l=="function"?l:he(!!l),r):t},r.curve=function(l){return arguments.length?(o=l,a!=null&&(i=o(a)),r):o},r.context=function(l){return arguments.length?(l==null?a=i=null:i=o(a=l),r):a},r}function C2(e,n){return n<e?-1:n>e?1:n>=e?0:NaN}function T2(e){return e}function vk(){var e=T2,n=C2,t=null,a=he(0),o=he(ht),i=he(0);function s(r){var l,c=(r=Er(r)).length,d,g,u=0,h=new Array(c),v=new Array(c),b=+a.apply(this,arguments),w=Math.min(ht,Math.max(-ht,o.apply(this,arguments)-b)),x,A=Math.min(Math.abs(w)/c,i.apply(this,arguments)),M=A*(w<0?-1:1),y;for(l=0;l<c;++l)(y=v[h[l]=l]=+e(r[l],l,r))>0&&(u+=y);for(n!=null?h.sort(function(T,k){return n(v[T],v[k])}):t!=null&&h.sort(function(T,k){return t(r[T],r[k])}),l=0,g=u?(w-c*M)/u:0;l<c;++l,b=x)d=h[l],y=v[d],x=b+(y>0?y*g:0)+M,v[d]={data:r[d],index:l,value:y,startAngle:b,endAngle:x,padAngle:A};return v}return s.value=function(r){return arguments.length?(e=typeof r=="function"?r:he(+r),s):e},s.sortValues=function(r){return arguments.length?(n=r,t=null,s):n},s.sort=function(r){return arguments.length?(t=r,n=null,s):t},s.startAngle=function(r){return arguments.length?(a=typeof r=="function"?r:he(+r),s):a},s.endAngle=function(r){return arguments.length?(o=typeof r=="function"?r:he(+r),s):o},s.padAngle=function(r){return arguments.length?(i=typeof r=="function"?r:he(+r),s):i},s}class Rr{constructor(n,t){this._context=n,this._x=t}areaStart(){this._line=0}areaEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line}point(n,t){switch(n=+n,t=+t,this._point){case 0:{this._point=1,this._line?this._context.lineTo(n,t):this._context.moveTo(n,t);break}case 1:this._point=2;default:{this._x?this._context.bezierCurveTo(this._x0=(this._x0+n)/2,this._y0,this._x0,t,n,t):this._context.bezierCurveTo(this._x0,this._y0=(this._y0+t)/2,n,this._y0,n,t);break}}this._x0=n,this._y0=t}}function bk(e){return new Rr(e,!0)}function yk(e){return new Rr(e,!1)}function nn(){}function Mt(e,n,t){e._context.bezierCurveTo((2*e._x0+e._x1)/3,(2*e._y0+e._y1)/3,(e._x0+2*e._x1)/3,(e._y0+2*e._y1)/3,(e._x0+4*e._x1+n)/6,(e._y0+4*e._y1+t)/6)}function Jt(e){this._context=e}Jt.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._y0=this._y1=NaN,this._point=0},lineEnd:function(){switch(this._point){case 3:Mt(this,this._x1,this._y1);case 2:this._context.lineTo(this._x1,this._y1);break}(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1,this._line?this._context.lineTo(e,n):this._context.moveTo(e,n);break;case 1:this._point=2;break;case 2:this._point=3,this._context.lineTo((5*this._x0+this._x1)/6,(5*this._y0+this._y1)/6);default:Mt(this,e,n);break}this._x0=this._x1,this._x1=e,this._y0=this._y1,this._y1=n}};function wk(e){return new Jt(e)}function zr(e){this._context=e}zr.prototype={areaStart:nn,areaEnd:nn,lineStart:function(){this._x0=this._x1=this._x2=this._x3=this._x4=this._y0=this._y1=this._y2=this._y3=this._y4=NaN,this._point=0},lineEnd:function(){switch(this._point){case 1:{this._context.moveTo(this._x2,this._y2),this._context.closePath();break}case 2:{this._context.moveTo((this._x2+2*this._x3)/3,(this._y2+2*this._y3)/3),this._context.lineTo((this._x3+2*this._x2)/3,(this._y3+2*this._y2)/3),this._context.closePath();break}case 3:{this.point(this._x2,this._y2),this.point(this._x3,this._y3),this.point(this._x4,this._y4);break}}},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1,this._x2=e,this._y2=n;break;case 1:this._point=2,this._x3=e,this._y3=n;break;case 2:this._point=3,this._x4=e,this._y4=n,this._context.moveTo((this._x0+4*this._x1+e)/6,(this._y0+4*this._y1+n)/6);break;default:Mt(this,e,n);break}this._x0=this._x1,this._x1=e,this._y0=this._y1,this._y1=n}};function _k(e){return new zr(e)}function qr(e){this._context=e}qr.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._y0=this._y1=NaN,this._point=0},lineEnd:function(){(this._line||this._line!==0&&this._point===3)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1;break;case 1:this._point=2;break;case 2:this._point=3;var t=(this._x0+4*this._x1+e)/6,a=(this._y0+4*this._y1+n)/6;this._line?this._context.lineTo(t,a):this._context.moveTo(t,a);break;case 3:this._point=4;default:Mt(this,e,n);break}this._x0=this._x1,this._x1=e,this._y0=this._y1,this._y1=n}};function kk(e){return new qr(e)}function Br(e,n){this._basis=new Jt(e),this._beta=n}Br.prototype={lineStart:function(){this._x=[],this._y=[],this._basis.lineStart()},lineEnd:function(){var e=this._x,n=this._y,t=e.length-1;if(t>0)for(var a=e[0],o=n[0],i=e[t]-a,s=n[t]-o,r=-1,l;++r<=t;)l=r/t,this._basis.point(this._beta*e[r]+(1-this._beta)*(a+l*i),this._beta*n[r]+(1-this._beta)*(o+l*s));this._x=this._y=null,this._basis.lineEnd()},point:function(e,n){this._x.push(+e),this._y.push(+n)}};const xk=function e(n){function t(a){return n===1?new Jt(a):new Br(a,n)}return t.beta=function(a){return e(+a)},t}(.85);function Lt(e,n,t){e._context.bezierCurveTo(e._x1+e._k*(e._x2-e._x0),e._y1+e._k*(e._y2-e._y0),e._x2+e._k*(e._x1-n),e._y2+e._k*(e._y1-t),e._x2,e._y2)}function Ai(e,n){this._context=e,this._k=(1-n)/6}Ai.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN,this._point=0},lineEnd:function(){switch(this._point){case 2:this._context.lineTo(this._x2,this._y2);break;case 3:Lt(this,this._x1,this._y1);break}(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1,this._line?this._context.lineTo(e,n):this._context.moveTo(e,n);break;case 1:this._point=2,this._x1=e,this._y1=n;break;case 2:this._point=3;default:Lt(this,e,n);break}this._x0=this._x1,this._x1=this._x2,this._x2=e,this._y0=this._y1,this._y1=this._y2,this._y2=n}};const Ak=function e(n){function t(a){return new Ai(a,n)}return t.tension=function(a){return e(+a)},t}(0);function Ci(e,n){this._context=e,this._k=(1-n)/6}Ci.prototype={areaStart:nn,areaEnd:nn,lineStart:function(){this._x0=this._x1=this._x2=this._x3=this._x4=this._x5=this._y0=this._y1=this._y2=this._y3=this._y4=this._y5=NaN,this._point=0},lineEnd:function(){switch(this._point){case 1:{this._context.moveTo(this._x3,this._y3),this._context.closePath();break}case 2:{this._context.lineTo(this._x3,this._y3),this._context.closePath();break}case 3:{this.point(this._x3,this._y3),this.point(this._x4,this._y4),this.point(this._x5,this._y5);break}}},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1,this._x3=e,this._y3=n;break;case 1:this._point=2,this._context.moveTo(this._x4=e,this._y4=n);break;case 2:this._point=3,this._x5=e,this._y5=n;break;default:Lt(this,e,n);break}this._x0=this._x1,this._x1=this._x2,this._x2=e,this._y0=this._y1,this._y1=this._y2,this._y2=n}};const Ck=function e(n){function t(a){return new Ci(a,n)}return t.tension=function(a){return e(+a)},t}(0);function Ti(e,n){this._context=e,this._k=(1-n)/6}Ti.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN,this._point=0},lineEnd:function(){(this._line||this._line!==0&&this._point===3)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1;break;case 1:this._point=2;break;case 2:this._point=3,this._line?this._context.lineTo(this._x2,this._y2):this._context.moveTo(this._x2,this._y2);break;case 3:this._point=4;default:Lt(this,e,n);break}this._x0=this._x1,this._x1=this._x2,this._x2=e,this._y0=this._y1,this._y1=this._y2,this._y2=n}};const Tk=function e(n){function t(a){return new Ti(a,n)}return t.tension=function(a){return e(+a)},t}(0);function Si(e,n,t){var a=e._x1,o=e._y1,i=e._x2,s=e._y2;if(e._l01_a>be){var r=2*e._l01_2a+3*e._l01_a*e._l12_a+e._l12_2a,l=3*e._l01_a*(e._l01_a+e._l12_a);a=(a*r-e._x0*e._l12_2a+e._x2*e._l01_2a)/l,o=(o*r-e._y0*e._l12_2a+e._y2*e._l01_2a)/l}if(e._l23_a>be){var c=2*e._l23_2a+3*e._l23_a*e._l12_a+e._l12_2a,d=3*e._l23_a*(e._l23_a+e._l12_a);i=(i*c+e._x1*e._l23_2a-n*e._l12_2a)/d,s=(s*c+e._y1*e._l23_2a-t*e._l12_2a)/d}e._context.bezierCurveTo(a,o,i,s,e._x2,e._y2)}function Vr(e,n){this._context=e,this._alpha=n}Vr.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN,this._l01_a=this._l12_a=this._l23_a=this._l01_2a=this._l12_2a=this._l23_2a=this._point=0},lineEnd:function(){switch(this._point){case 2:this._context.lineTo(this._x2,this._y2);break;case 3:this.point(this._x2,this._y2);break}(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){if(e=+e,n=+n,this._point){var t=this._x2-e,a=this._y2-n;this._l23_a=Math.sqrt(this._l23_2a=Math.pow(t*t+a*a,this._alpha))}switch(this._point){case 0:this._point=1,this._line?this._context.lineTo(e,n):this._context.moveTo(e,n);break;case 1:this._point=2;break;case 2:this._point=3;default:Si(this,e,n);break}this._l01_a=this._l12_a,this._l12_a=this._l23_a,this._l01_2a=this._l12_2a,this._l12_2a=this._l23_2a,this._x0=this._x1,this._x1=this._x2,this._x2=e,this._y0=this._y1,this._y1=this._y2,this._y2=n}};const Sk=function e(n){function t(a){return n?new Vr(a,n):new Ai(a,0)}return t.alpha=function(a){return e(+a)},t}(.5);function Fr(e,n){this._context=e,this._alpha=n}Fr.prototype={areaStart:nn,areaEnd:nn,lineStart:function(){this._x0=this._x1=this._x2=this._x3=this._x4=this._x5=this._y0=this._y1=this._y2=this._y3=this._y4=this._y5=NaN,this._l01_a=this._l12_a=this._l23_a=this._l01_2a=this._l12_2a=this._l23_2a=this._point=0},lineEnd:function(){switch(this._point){case 1:{this._context.moveTo(this._x3,this._y3),this._context.closePath();break}case 2:{this._context.lineTo(this._x3,this._y3),this._context.closePath();break}case 3:{this.point(this._x3,this._y3),this.point(this._x4,this._y4),this.point(this._x5,this._y5);break}}},point:function(e,n){if(e=+e,n=+n,this._point){var t=this._x2-e,a=this._y2-n;this._l23_a=Math.sqrt(this._l23_2a=Math.pow(t*t+a*a,this._alpha))}switch(this._point){case 0:this._point=1,this._x3=e,this._y3=n;break;case 1:this._point=2,this._context.moveTo(this._x4=e,this._y4=n);break;case 2:this._point=3,this._x5=e,this._y5=n;break;default:Si(this,e,n);break}this._l01_a=this._l12_a,this._l12_a=this._l23_a,this._l01_2a=this._l12_2a,this._l12_2a=this._l23_2a,this._x0=this._x1,this._x1=this._x2,this._x2=e,this._y0=this._y1,this._y1=this._y2,this._y2=n}};const Ik=function e(n){function t(a){return n?new Fr(a,n):new Ci(a,0)}return t.alpha=function(a){return e(+a)},t}(.5);function jr(e,n){this._context=e,this._alpha=n}jr.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN,this._l01_a=this._l12_a=this._l23_a=this._l01_2a=this._l12_2a=this._l23_2a=this._point=0},lineEnd:function(){(this._line||this._line!==0&&this._point===3)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){if(e=+e,n=+n,this._point){var t=this._x2-e,a=this._y2-n;this._l23_a=Math.sqrt(this._l23_2a=Math.pow(t*t+a*a,this._alpha))}switch(this._point){case 0:this._point=1;break;case 1:this._point=2;break;case 2:this._point=3,this._line?this._context.lineTo(this._x2,this._y2):this._context.moveTo(this._x2,this._y2);break;case 3:this._point=4;default:Si(this,e,n);break}this._l01_a=this._l12_a,this._l12_a=this._l23_a,this._l01_2a=this._l12_2a,this._l12_2a=this._l23_2a,this._x0=this._x1,this._x1=this._x2,this._x2=e,this._y0=this._y1,this._y1=this._y2,this._y2=n}};const Dk=function e(n){function t(a){return n?new jr(a,n):new Ti(a,0)}return t.alpha=function(a){return e(+a)},t}(.5);function Ur(e){this._context=e}Ur.prototype={areaStart:nn,areaEnd:nn,lineStart:function(){this._point=0},lineEnd:function(){this._point&&this._context.closePath()},point:function(e,n){e=+e,n=+n,this._point?this._context.lineTo(e,n):(this._point=1,this._context.moveTo(e,n))}};function Pk(e){return new Ur(e)}function _s(e){return e<0?-1:1}function ks(e,n,t){var a=e._x1-e._x0,o=n-e._x1,i=(e._y1-e._y0)/(a||o<0&&-0),s=(t-e._y1)/(o||a<0&&-0),r=(i*o+s*a)/(a+o);return(_s(i)+_s(s))*Math.min(Math.abs(i),Math.abs(s),.5*Math.abs(r))||0}function xs(e,n){var t=e._x1-e._x0;return t?(3*(e._y1-e._y0)/t-n)/2:n}function ma(e,n,t){var a=e._x0,o=e._y0,i=e._x1,s=e._y1,r=(i-a)/3;e._context.bezierCurveTo(a+r,o+r*n,i-r,s-r*t,i,s)}function $t(e){this._context=e}$t.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._y0=this._y1=this._t0=NaN,this._point=0},lineEnd:function(){switch(this._point){case 2:this._context.lineTo(this._x1,this._y1);break;case 3:ma(this,this._t0,xs(this,this._t0));break}(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){var t=NaN;if(e=+e,n=+n,!(e===this._x1&&n===this._y1)){switch(this._point){case 0:this._point=1,this._line?this._context.lineTo(e,n):this._context.moveTo(e,n);break;case 1:this._point=2;break;case 2:this._point=3,ma(this,xs(this,t=ks(this,e,n)),t);break;default:ma(this,this._t0,t=ks(this,e,n));break}this._x0=this._x1,this._x1=e,this._y0=this._y1,this._y1=n,this._t0=t}}};function Gr(e){this._context=new Hr(e)}(Gr.prototype=Object.create($t.prototype)).point=function(e,n){$t.prototype.point.call(this,n,e)};function Hr(e){this._context=e}Hr.prototype={moveTo:function(e,n){this._context.moveTo(n,e)},closePath:function(){this._context.closePath()},lineTo:function(e,n){this._context.lineTo(n,e)},bezierCurveTo:function(e,n,t,a,o,i){this._context.bezierCurveTo(n,e,a,t,i,o)}};function Mk(e){return new $t(e)}function Lk(e){return new Gr(e)}function Wr(e){this._context=e}Wr.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x=[],this._y=[]},lineEnd:function(){var e=this._x,n=this._y,t=e.length;if(t)if(this._line?this._context.lineTo(e[0],n[0]):this._context.moveTo(e[0],n[0]),t===2)this._context.lineTo(e[1],n[1]);else for(var a=As(e),o=As(n),i=0,s=1;s<t;++i,++s)this._context.bezierCurveTo(a[0][i],o[0][i],a[1][i],o[1][i],e[s],n[s]);(this._line||this._line!==0&&t===1)&&this._context.closePath(),this._line=1-this._line,this._x=this._y=null},point:function(e,n){this._x.push(+e),this._y.push(+n)}};function As(e){var n,t=e.length-1,a,o=new Array(t),i=new Array(t),s=new Array(t);for(o[0]=0,i[0]=2,s[0]=e[0]+2*e[1],n=1;n<t-1;++n)o[n]=1,i[n]=4,s[n]=4*e[n]+2*e[n+1];for(o[t-1]=2,i[t-1]=7,s[t-1]=8*e[t-1]+e[t],n=1;n<t;++n)a=o[n]/i[n-1],i[n]-=a,s[n]-=a*s[n-1];for(o[t-1]=s[t-1]/i[t-1],n=t-2;n>=0;--n)o[n]=(s[n]-o[n+1])/i[n];for(i[t-1]=(e[t]+o[t-1])/2,n=0;n<t-1;++n)i[n]=2*e[n+1]-o[n+1];return[o,i]}function $k(e){return new Wr(e)}function Zt(e,n){this._context=e,this._t=n}Zt.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x=this._y=NaN,this._point=0},lineEnd:function(){0<this._t&&this._t<1&&this._point===2&&this._context.lineTo(this._x,this._y),(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line>=0&&(this._t=1-this._t,this._line=1-this._line)},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1,this._line?this._context.lineTo(e,n):this._context.moveTo(e,n);break;case 1:this._point=2;default:{if(this._t<=0)this._context.lineTo(this._x,n),this._context.lineTo(e,n);else{var t=this._x*(1-this._t)+e*this._t;this._context.lineTo(t,this._y),this._context.lineTo(t,n)}break}}this._x=e,this._y=n}};function Nk(e){return new Zt(e,.5)}function Ek(e){return new Zt(e,0)}function Ok(e){return new Zt(e,1)}function Bn(e,n,t){this.k=e,this.x=n,this.y=t}Bn.prototype={constructor:Bn,scale:function(e){return e===1?this:new Bn(this.k*e,this.x,this.y)},translate:function(e,n){return e===0&n===0?this:new Bn(this.k,this.x+this.k*e,this.y+this.k*n)},apply:function(e){return[e[0]*this.k+this.x,e[1]*this.k+this.y]},applyX:function(e){return e*this.k+this.x},applyY:function(e){return e*this.k+this.y},invert:function(e){return[(e[0]-this.x)/this.k,(e[1]-this.y)/this.k]},invertX:function(e){return(e-this.x)/this.k},invertY:function(e){return(e-this.y)/this.k},rescaleX:function(e){return e.copy().domain(e.range().map(this.invertX,this).map(e.invert,e))},rescaleY:function(e){return e.copy().domain(e.range().map(this.invertY,this).map(e.invert,e))},toString:function(){return"translate("+this.x+","+this.y+") scale("+this.k+")"}};Bn.prototype;const S2={class:"knowledge-graph-shell"},Je=720,Ue=320,me=44,I2=U({__name:"KnowledgeGraph",setup(e){const n=Je/2,t=Ue/2,a=ae(null);let o=null,i=null,s=null,r=null;const l=[{id:"agentic",label:"Agentic",size:22,group:"main"},{id:"devops",label:"DevOps",size:24,group:"main"},{id:"architecture",label:"Architecture",size:22,group:"main"},{id:"golang",label:"Go",size:14,group:"secondary"},{id:"kubernetes",label:"K8S",size:14,group:"secondary"},{id:"cloud",label:"Cloud",size:14,group:"secondary"},{id:"cicd",label:"GitOps",size:13,group:"secondary"},{id:"development",label:"Development",size:14,group:"secondary"},{id:"ddd",label:"DDD",size:13,group:"secondary"},{id:"microservices",label:"MicroServices",size:13,group:"secondary"},{id:"copilot",label:"Copilot",size:13,group:"secondary"},{id:"aws",label:"AWS",size:11,group:"leaf"},{id:"tdd",label:"TDD",size:11,group:"leaf"},{id:"kotlin",label:"Kotlin",size:11,group:"leaf"}],c=l.filter(I=>typeof I.anchorX=="number"&&typeof I.anchorY=="number"),d=c.map(I=>I.anchorX),g=c.map(I=>I.anchorY),u=Math.min(...d),h=Math.max(...d),v=Math.min(...g),b=Math.max(...g);function w(I){const B=Je-me*2;return me+(I-u)/Math.max(h-u,1)*B}function x(I){const B=Ue-me*2;return me+(I-v)/Math.max(b-v,1)*B}const A={agentic:{x:n-132,y:t-44},devops:{x:n,y:t+8},architecture:{x:n+132,y:t-44}};function M(I){var B;return I.group==="main"?((B=A[I.id])==null?void 0:B.x)??n:typeof I.anchorX=="number"?w(I.anchorX):n}function y(I){var B;return I.group==="main"?((B=A[I.id])==null?void 0:B.y)??t:typeof I.anchorY=="number"?x(I.anchorY):t}const T=l.map(I=>({...I,x:M(I),y:y(I)})),k=[{id:"golang-kubernetes",source:"golang",target:"kubernetes"},{id:"golang-development",source:"golang",target:"development"},{id:"kubernetes-devops",source:"kubernetes",target:"devops"},{id:"kubernetes-cloud",source:"kubernetes",target:"cloud"},{id:"cloud-aws",source:"cloud",target:"aws"},{id:"cicd-devops",source:"cicd",target:"devops"},{id:"development-tdd",source:"development",target:"tdd"},{id:"development-ddd",source:"development",target:"ddd"},{id:"ddd-architecture",source:"ddd",target:"architecture"},{id:"ddd-microservices",source:"ddd",target:"microservices"},{id:"microservices-architecture",source:"microservices",target:"architecture"},{id:"copilot-agentic",source:"copilot",target:"agentic"},{id:"copilot-development",source:"copilot",target:"development"},{id:"golang-kotlin",source:"golang",target:"kotlin"}],E=new Map(T.map(I=>[I.id,I]));function V(I,B){const H=getComputedStyle(document.documentElement).getPropertyValue(I).trim();if(!H)return B;if(H.startsWith("#")){const O=H.slice(1),Y=O.length===3?`${O[0]}${O[0]}${O[1]}${O[1]}${O[2]}${O[2]}`:O;if(Y.length===6){const J=parseInt(Y.slice(0,2),16),D=parseInt(Y.slice(2,4),16),oe=parseInt(Y.slice(4,6),16);return`rgb(${J}, ${D}, ${oe})`}}return H}function W(){return{mainNode:V("--color-primary","rgb(84, 95, 115)"),secondaryNode:V("--color-primary-container","rgb(216, 227, 251)"),leafNode:V("--color-surface-container-low","rgb(231, 236, 239)"),edgeColor:V("--color-outline-variant","rgb(169, 180, 185)"),activeEdge:V("--color-tertiary","rgb(58, 82, 95)"),dimColor:V("--color-surface","rgb(242, 244, 245)"),labelColor:V("--color-on-surface","rgb(42, 52, 57)"),dimLabelColor:V("--color-on-surface-variant","rgb(95, 108, 114)"),surfaceColor:V("--color-surface-container-lowest","rgb(255, 255, 255)")}}function F(I){if(I)return typeof I=="string"?E.get(I):I}function $(I){return I?typeof I=="string"?I:I.id:null}function P(I){return Math.max(I.size*.84,10)}function L(I){return Number.isFinite(I.x)?I.x:Je/2}function z(I){return Number.isFinite(I.y)?I.y:Ue/2}function te(I){const B=P(I),H=me+B,O=Je-me-B,Y=me+B,J=Ue-me-B;I.x=Math.min(O,Math.max(H,L(I))),I.y=Math.min(J,Math.max(Y,z(I)))}function ee(I,B){const H=P(I),O=me+H,Y=Je-me-H;return Math.min(Y,Math.max(O,B))}function K(I,B){const H=P(I),O=me+H,Y=Ue-me-H;return Math.min(Y,Math.max(O,B))}function re(I,B){const H=k.find(O=>O.id===I);return H?$(H.source)===B||$(H.target)===B:!1}function de(I){return o?I===o?!0:k.some(B=>re(B.id,I)&&re(B.id,o)):!1}function ue(I,B){return I==="main"?B.mainNode:I==="secondary"?B.secondaryNode:B.leafNode}function Ce(){if(!a.value)return;const I=ln(a.value).select("svg.knowledge-graph-svg");I.empty()||(I.selectAll("line.graph-edge").attr("x1",B=>L(F(B.source)??T[0])).attr("y1",B=>z(F(B.source)??T[0])).attr("x2",B=>L(F(B.target)??T[0])).attr("y2",B=>z(F(B.target)??T[0])),I.selectAll("line.graph-edge-hitbox").attr("x1",B=>L(F(B.source)??T[0])).attr("y1",B=>z(F(B.source)??T[0])).attr("x2",B=>L(F(B.target)??T[0])).attr("y2",B=>z(F(B.target)??T[0])),I.selectAll("g.graph-node").attr("transform",B=>`translate(${L(B)}, ${z(B)})`))}function we(){if(!a.value)return;const I=W(),B=ln(a.value).select("svg.knowledge-graph-svg");B.empty()||(B.select("rect.graph-surface").attr("fill",I.surfaceColor).attr("opacity",.18),B.selectAll("line.graph-grid").attr("stroke",I.dimColor).attr("opacity",.55),B.selectAll("line.graph-edge").attr("stroke",H=>H.id===i?I.activeEdge:o&&!re(H.id,o)||i&&H.id!==i?I.dimColor:I.edgeColor).attr("stroke-width",H=>H.id===i?3.4:1.8).attr("opacity",H=>H.id===i?1:o&&!re(H.id,o)||i&&H.id!==i?.35:.9),B.selectAll("circle.graph-node-shape").attr("r",H=>{const O=P(H);return H.id===o?O*1.12:O}).attr("fill",H=>ue(H.group,I)).attr("stroke",I.surfaceColor).attr("stroke-width",H=>H.id===o?3:2).attr("opacity",H=>H.id===o?1:o&&!de(H.id)||i&&!re(i,H.id)?.4:.96),B.selectAll("text.graph-node-label").attr("fill",H=>o&&!de(H.id)||i&&!re(i,H.id)?I.dimLabelColor:I.labelColor).attr("opacity",H=>o&&!de(H.id)||i&&!re(i,H.id)?.6:1))}function le(){o=null,i=null,we()}function Le(){if(!a.value)return;const I=ln(a.value);I.selectAll("*").remove();const B=I.append("svg").attr("viewBox",`0 0 ${Je} ${Ue}`).attr("class","knowledge-graph-svg").attr("role","img").attr("aria-label","engineering knowledge graph").on("mouseleave",()=>{le()});B.append("rect").attr("class","graph-surface").attr("x",0).attr("y",0).attr("width",Je).attr("height",Ue).attr("rx",28),B.append("g").selectAll("line.graph-grid").data([.2,.5,.8]).join("line").attr("class","graph-grid").attr("x1",me).attr("x2",Je-me).attr("y1",D=>me+D*(Ue-me*2)).attr("y2",D=>me+D*(Ue-me*2)).attr("stroke-width",1).attr("stroke-dasharray","5 8");const H=B.append("g").attr("class","edge-layer"),O=B.append("g").attr("class","node-layer"),Y=Sf().on("start",(D,oe)=>{D.active||r==null||r.alphaTarget(.18).restart(),oe.fx=L(oe),oe.fy=z(oe)}).on("drag",(D,oe)=>{oe.fx=ee(oe,D.x),oe.fy=K(oe,D.y),Ce()}).on("end",(D,oe)=>{D.active||r==null||r.alphaTarget(0),oe.fx=null,oe.fy=null});H.selectAll("line.graph-edge").data(k).join("line").attr("class","graph-edge").attr("stroke-linecap","round"),H.selectAll("line.graph-edge-hitbox").data(k).join("line").attr("class","graph-edge-hitbox").attr("stroke","transparent").attr("stroke-width",14).attr("stroke-linecap","round").style("cursor","pointer").on("mouseenter",(D,oe)=>{i=oe.id,o=null,we()});const J=O.selectAll("g.graph-node").data(T).join("g").attr("class","graph-node").style("cursor","pointer").on("mouseenter",(D,oe)=>{o=oe.id,i=null,we()}).call(Y);J.append("circle").attr("class","graph-node-shape"),J.append("text").attr("class","graph-node-label").text(D=>D.label).attr("text-anchor","middle").attr("dominant-baseline","middle").attr("font-size",D=>Math.max(D.size*.78,10)).attr("font-weight",D=>D.group==="main"?700:600).style("pointer-events","none"),Ce(),we()}function Te(){r==null||r.stop(),r=X0(T).force("link",F0(k).id(I=>I.id).distance(I=>{const B=F(I.source),H=F(I.target);return(B==null?void 0:B.group)==="main"||(H==null?void 0:H.group)==="main"?104:(B==null?void 0:B.group)==="leaf"||(H==null?void 0:H.group)==="leaf"?72:88}).strength(.4)).force("charge",Q0().strength(I=>I.group==="main"?-780:I.group==="secondary"?-520:-320)).force("center",_0(n,t)).force("x",J0(I=>M(I)).strength(I=>I.group==="main"?.24:.08)).force("y",Z0(I=>y(I)).strength(I=>I.group==="main"?.22:.06)).force("collision",B0().radius(I=>P(I)+12).iterations(3)).alpha(.9).alphaDecay(.04).velocityDecay(.3).on("tick",()=>{T.forEach(I=>{te(I)}),Ce()})}return Ee(()=>{Le(),Te(),s=new MutationObserver(()=>{we()}),s.observe(document.documentElement,{attributes:!0,attributeFilter:["class","data-theme"]})}),Fa(()=>{s&&(s.disconnect(),s=null),r&&(r.stop(),r=null)}),(I,B)=>(f(),_("div",S2,[p("div",{ref_key:"containerRef",ref:a,class:"knowledge-graph-canvas"},null,512)]))}}),D2=X(I2,[["__scopeId","data-v-49a3d5a3"]]);function pe(e){return e.replace(/^\/+/,"").replace(/^docs\//,"")}function Cs(e){return`/${pe(e)}`}function Kr(e){return Object.keys(e).reduce((n,t)=>(n[pe(t)]=t,n),{})}function Yr(e,n,t){const a=pe(e),o=[Cs(e),`/${a}`,a,t[a]].filter(i=>!!i);for(const i of o){const s=n[i];if(s)return{modulePath:i,raw:s}}return{modulePath:Cs(e),raw:void 0}}function Nt(e){const n=pe(e);return n.split("/").pop()||n}function Ts(e){return e.replace(/^['\"]|['\"]$/g,"").trim()}function P2(e){const n=e.trim();if(n.startsWith("[")&&n.endsWith("]")){const t=n.slice(1,-1).trim();return t?t.split(",").map(a=>Ts(a.trim())).filter(a=>a.length>0):[]}return Ts(n)}function Xr(e){const n=e.match(/^---\n([\s\S]*?)\n---/);if(!n)return{};const t={};for(const a of n[1].split(`
`)){if(!a||/^\s/.test(a)||a.startsWith("#"))continue;const o=a.indexOf(":");if(o<0)continue;const i=a.slice(0,o).trim(),s=P2(a.slice(o+1));t[i]=s}return t}function Qr(e){return e.replace(/^---[\s\S]*?---\n?/,"").trim()}function Jr(e){const t=Qr(e).split(/\n\s*\n/).find(a=>a.trim().length>0);return(t==null?void 0:t.replace(/^#+\s+/,"").trim())||""}function Zr(e,n={}){const a=Qr(e).replace(/```[\s\S]*?```/g," ").replace(/`[^`]*`/g," ").replace(/!\[[^\]]*\]\([^)]*\)/g," ").replace(/\[[^\]]*\]\([^)]*\)/g," ").replace(/[#>*_~\-]/g," ").replace(/\s+/g," ").trim().length,o=Math.max(1,Math.ceil(a/500));return typeof n.formatter=="function"?n.formatter(o):n.template?n.template.replace("{minutes}",String(o)):`~ ${o} min read`}function Fn(e){return e?`/${pe(e).replace(/\.md$/,"").replace(/\/index$/,"/")}`:"#"}function el(e){const n=e.replace(/[.+^${}()|[\]\\]/g,"\\$&").replace(/\*\*/g,"::DOUBLE_STAR::").replace(/\*/g,"[^/]*").replace(/::DOUBLE_STAR::/g,".*");return new RegExp(`^${n}$`)}function nl(e){const n=String(e.category||"").trim();return n&&e.categoryMeta&&e.categoryMeta[n]?e.categoryMeta[n]:{}}function Ii(e){const n=nl(e);return n.label?n.label:String(e.category||"").trim()}function Di(e){const n=nl(e);return n.colorClass?n.colorClass:""}const M2="/assets/1644655887368.DQapbKac.jpg",L2="/assets/1644658272643.DixkFUdM.jpg",$2="/assets/wx20220212-172346.Bdr25vH2.png",N2="/assets/wx20220212-172451.BB6BU37T.png",E2="/assets/1-6zojnn4sdsd9kylfhr34-a-1640317491743-0.BT5IPXlG.png",O2="/assets/1-n1zqvw8bk-o8rwxnzs5kq-1640317547459-0.DWMxzrzx.png",R2="/assets/2022-03-13-22-37-47.FXklLsNs.jpeg",z2="/assets/dual-clutch-transmission-13-1640318081688-0.B4hokDfU.gif",q2="/assets/skills.BAnIdTNL.png",B2="/assets/wiki-type-of-architect-1640317457778-0.C3YyCdof.png",V2="/assets/wx20220320-163559.CfWPxfHG.png",F2="/assets/wx20220320-163907.B6vfIgkR.png",j2="/assets/wx20220321-104324.BgpfGzm0.png",U2="/assets/image-1653875255217-0.DLUkC6WM.png",G2="/assets/2022-05-25-10-21-15.BG964yVJ.png",H2="/assets/image-16.yUtl20qA.png",W2="/assets/image-17.hTTOmgfs.png",K2="/assets/image-18.HclV9ZG2.png",Y2="/assets/1645694079239.C_nre4re.jpg",X2="/assets/achitecture-discussing-2.CIp6ic9U.jpeg",Q2="/assets/achitecture-discussing._BjOxGqC.jpeg",J2="/assets/basic-diagram.k-lcOFHY.jpeg",Z2="/assets/building-architecture.CVLmaHKi.jpeg",ew="/assets/image-01.9UEyGlKG.png",nw="/assets/image-02.lC5tp8JY.png",tw="/assets/image-03.CN1AMQ2n.png",aw="/assets/image-21.GzBuHhpo.png",ow="/assets/image-31.BCqMHRFV.png",iw="/assets/image-32.BONEHxoC.png",sw="/assets/image-33.35tIccBN.png",rw="/assets/image-34.BI0AYe_e.png",lw="/assets/image-35.Dqw7EEZo.png",cw="/assets/image-36.B6zYBbcF.png",uw="/assets/image-37.Bug7G00R.png",dw="/assets/image-38.F3X5v5gc.png",hw="/assets/image-main.d3gkZeRb.png",pw="/assets/math-diagram.CeYjpfsa.jpeg",gw="/assets/network-topology.CSAnXw-U.webp",mw="/assets/pictograph-1.BjKnp1uA.jpeg",fw="/assets/quick-sort.DqDqTYZk.png",vw="/assets/words.BJuqccBz.webp",bw="/assets/image.v72K2I7B.png",yw="/assets/image-1.CABcO0hy.png",ww="/assets/image-2.CqDiP9_8.png",_w="/assets/image.C-NbRYb4.png",kw="/assets/langchain-ollama.BRx4KDS9.png",xw="/assets/llm-architecture.Brkjch2V.png",Aw="/assets/git-graph-0.C4G_Ghqh.png",Cw="/assets/git-graph-1.0NB7GhSV.png",Tw="/assets/devops.D2KY2cuE.png",Sw="/assets/homepage.CbpzU-qz.png",Iw="/assets/mp-weixin-green.CsjjYBS_.png",Dw="/assets/mp-weixin-white.CcgfmLQg.png",Pw="/assets/old.BLdKa2Z6.png",Mw="/assets/image-1.BZojNKVT.png",Lw="/assets/image-2.DU_0Fs-4.png",$w="/assets/image-3.DFogVQnE.png",Nw="/assets/image-main.QAIGTop_.png",Ew="/assets/mp-weixin-green.CsjjYBS_.png",Ow="/assets/mp-weixin-white.CcgfmLQg.png",Rw="/assets/1776153628712.Bl4yzL5r.png",zw="/assets/1778475581203.DM2S-Q9z.png",qw="/assets/1780883130955.CndDY_6K.png",Bw="/assets/choreography.B4CU8w1K.svg",Vw="/assets/orchestration.wOY-XY5P.svg",Fw="https://picsum.photos/800/600";function jw(e){let n=0;for(let t=0;t<e.length;t+=1)n=(n*31+e.charCodeAt(t))%1e4;return n+1}function Uw(e){return e.replace(/^\/+/,"").replace(/^docs\//,"")}function Gw(e){const n=Uw(e||"")||"default",t=jw(n);return`${Fw}?random=${t}`}const Hw=new Set(["","null","undefined","none","n/a","na","-"]),Ww=Object.assign({"/blogs/assets/202202-logseq-build-your-own-wiki/1644655887368.jpg":M2,"/blogs/assets/202202-logseq-build-your-own-wiki/1644658272643.jpg":L2,"/blogs/assets/202202-logseq-build-your-own-wiki/wx20220212-172346.png":$2,"/blogs/assets/202202-logseq-build-your-own-wiki/wx20220212-172451.png":N2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/1-6zojnn4sdsd9kylfhr34-a-1640317491743-0.png":E2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/1-n1zqvw8bk-o8rwxnzs5kq-1640317547459-0.png":O2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/2022-03-13-22-37-47.jpeg":R2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/dual-clutch-transmission-13-1640318081688-0.gif":z2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/skills.png":q2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/wiki-type-of-architect-1640317457778-0.png":B2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/wx20220320-163559.png":V2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/wx20220320-163907.png":F2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/wx20220321-104324.png":j2,"/blogs/assets/202203-mesh-shaped-recap/image-1653875255217-0.png":U2,"/blogs/assets/202205-router-proxy-gtw/2022-05-25-10-21-15.png":G2,"/blogs/assets/202211-cloud-native-engineering/image-16.png":H2,"/blogs/assets/202211-cloud-native-engineering/image-17.png":W2,"/blogs/assets/202211-cloud-native-engineering/image-18.png":K2,"/blogs/assets/202212-logseq-customized-with-clojure-and-css/1645694079239.jpg":Y2,"/blogs/assets/202304-draw-architecture-diagram/achitecture-discussing-2.jpeg":X2,"/blogs/assets/202304-draw-architecture-diagram/achitecture-discussing.jpeg":Q2,"/blogs/assets/202304-draw-architecture-diagram/basic-diagram.jpeg":J2,"/blogs/assets/202304-draw-architecture-diagram/building-architecture.jpeg":Z2,"/blogs/assets/202304-draw-architecture-diagram/image-01.png":ew,"/blogs/assets/202304-draw-architecture-diagram/image-02.png":nw,"/blogs/assets/202304-draw-architecture-diagram/image-03.png":tw,"/blogs/assets/202304-draw-architecture-diagram/image-21.png":aw,"/blogs/assets/202304-draw-architecture-diagram/image-31.png":ow,"/blogs/assets/202304-draw-architecture-diagram/image-32.png":iw,"/blogs/assets/202304-draw-architecture-diagram/image-33.png":sw,"/blogs/assets/202304-draw-architecture-diagram/image-34.png":rw,"/blogs/assets/202304-draw-architecture-diagram/image-35.png":lw,"/blogs/assets/202304-draw-architecture-diagram/image-36.png":cw,"/blogs/assets/202304-draw-architecture-diagram/image-37.png":uw,"/blogs/assets/202304-draw-architecture-diagram/image-38.png":dw,"/blogs/assets/202304-draw-architecture-diagram/image-main.png":hw,"/blogs/assets/202304-draw-architecture-diagram/math-diagram.jpeg":pw,"/blogs/assets/202304-draw-architecture-diagram/network-topology.webp":gw,"/blogs/assets/202304-draw-architecture-diagram/pictograph-1.jpeg":mw,"/blogs/assets/202304-draw-architecture-diagram/quick-sort.png":fw,"/blogs/assets/202304-draw-architecture-diagram/words.webp":vw,"/blogs/assets/202304-tunnel-vpn-vpc/image.png":bw,"/blogs/assets/202402-llm-application/image-1.png":yw,"/blogs/assets/202402-llm-application/image-2.png":ww,"/blogs/assets/202402-llm-application/image.png":_w,"/blogs/assets/202402-llm-application/langchain-ollama.png":kw,"/blogs/assets/202402-llm-application/llm-architecture.png":xw,"/blogs/assets/202406-fork-oss/git-graph-0.png":Aw,"/blogs/assets/202406-fork-oss/git-graph-1.png":Cw,"/blogs/assets/202406-k3s-blogs/devops.png":Tw,"/blogs/assets/202406-k3s-blogs/homepage.png":Sw,"/blogs/assets/202406-k3s-blogs/mp-weixin-green.png":Iw,"/blogs/assets/202406-k3s-blogs/mp-weixin-white.png":Dw,"/blogs/assets/202406-k3s-blogs/old.png":Pw,"/blogs/assets/202412-ai-powered-pkm/image-1.png":Mw,"/blogs/assets/202412-ai-powered-pkm/image-2.png":Lw,"/blogs/assets/202412-ai-powered-pkm/image-3.png":$w,"/blogs/assets/202412-ai-powered-pkm/image-main.png":Nw,"/blogs/assets/202412-ai-powered-pkm/mp-weixin-green.png":Ew,"/blogs/assets/202412-ai-powered-pkm/mp-weixin-white.png":Ow,"/blogs/assets/202604-logseq-scoring-overview/1776153628712.png":Rw,"/blogs/assets/202605-multica-brains-agent-kanban/1778475581203.png":zw,"/blogs/assets/202605-spdd-agentic-refactor/1780883130955.png":qw,"/blogs/assets/202606-agent-changes-service-interconnection/choreography.svg":Bw,"/blogs/assets/202606-agent-changes-service-interconnection/orchestration.svg":Vw});function Kw(e){const n=e.trim();if(!n)return[];const t=n.startsWith("/")?n:`/${n}`;return[n,t]}function Yw(e){for(const n of Kw(e)){const t=Ww[n];if(t)return t}return e}function Kn(e,n){const t=(e||"").trim(),a=t.toLowerCase();return!t||Hw.has(a)?Gw(n):Yw(t)}const Xw={class:"bg-surface dark:bg-slate-900 text-on-surface dark:text-slate-100"},Qw={class:"pt-32 pb-24"},Jw={class:"max-w-7xl mx-auto px-8 mb-32"},Zw={class:"grid grid-cols-1 lg:grid-cols-12 gap-12 items-start"},e1={class:"lg:col-span-6"},n1={class:"mb-6 inline-block bg-primary-container px-3 py-1 rounded text-[10px] uppercase tracking-widest font-bold text-on-primary-container"},t1={class:"text-[3.5rem] font-extrabold tracking-tight leading-[1.1] mb-8 text-on-surface dark:text-slate-100"},a1={class:"text-[1.375rem] leading-relaxed text-on-surface-variant dark:text-slate-400 font-light mb-8 max-w-2xl"},o1={class:"flex items-center gap-4 mb-12"},i1={class:"text-sm text-on-surface-variant dark:text-slate-400"},s1={class:"lg:col-span-6 relative lg:mt-12"},r1={class:"bg-surface-container-lowest dark:bg-slate-950 p-6 rounded-lg dark:border-slate-700"},l1={class:"bg-surface-container-low dark:bg-slate-900 py-24"},c1={class:"max-w-7xl mx-auto px-8"},u1={class:"flex justify-between items-end mb-16"},d1={class:"label-sm text-tertiary font-bold tracking-[0.2em] uppercase text-xs mb-4 block pb-4"},h1={class:"text-[2.25rem] font-bold tracking-tight text-on-surface dark:text-slate-100"},p1={class:"grid grid-cols-1 md:grid-cols-2 gap-px bg-outline-variant/10 dark:bg-slate-700"},g1=["src","alt"],m1=["data-icon"],f1={class:"text-xl font-bold mb-4 text-on-surface dark:text-slate-100"},v1={class:"text-on-surface-variant dark:text-slate-400 leading-relaxed"},b1={class:"max-w-7xl mx-auto px-8 py-32"},y1={class:"mb-16 flex items-center justify-between gap-6"},w1={class:"text-[2.25rem] font-bold tracking-tight text-on-surface dark:text-slate-100 mb-2"},_1=["href"],k1={key:0,class:"grid grid-cols-1 md:grid-cols-12 gap-8"},x1=["href"],A1={class:"relative overflow-hidden rounded-xl mb-6 aspect-[16/9] bg-surface-container-low dark:bg-slate-900"},C1=["alt","src"],T1={class:"flex items-center gap-4 mb-4"},S1={class:"text-xs text-outline dark:text-slate-400 tracking-wider"},I1={class:"text-3xl font-bold tracking-tight mb-4 group-hover:text-tertiary transition-colors"},D1={class:"text-on-surface-variant dark:text-slate-400 line-clamp-2 max-w-2xl"},P1={class:"md:col-span-4 flex flex-col gap-12"},M1=["href"],L1={class:"flex items-center gap-3 mb-3"},$1={class:"text-[10px] text-outline dark:text-slate-400"},N1={class:"text-xl font-bold tracking-tight mb-3 group-hover:text-tertiary transition-colors leading-tight"},E1={class:"text-sm text-on-surface-variant dark:text-slate-400 line-clamp-2"},O1={class:"mt-4 flex items-center gap-1 text-tertiary text-sm font-semibold opacity-0 group-hover:opacity-100 transition-opacity"},R1={key:1,class:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"},z1=["href"],q1=["src","alt"],B1={class:"p-5"},V1={class:"flex items-center justify-between gap-3 mb-3"},F1={class:"text-[10px] text-outline dark:text-slate-400"},j1={class:"text-base font-bold tracking-tight mb-2 text-on-surface dark:text-slate-100"},U1={class:"text-sm text-on-surface-variant dark:text-slate-400 line-clamp-3"},G1={key:0,class:"max-w-7xl mx-auto px-8"},H1={class:"bg-primary text-on-primary p-16 rounded-xl relative overflow-hidden"},W1={class:"relative z-10 max-w-2xl"},K1={class:"text-3xl font-bold tracking-tight mb-4"},Y1={class:"text-on-primary/80 mb-8 text-lg"},X1={class:"flex flex-col sm:flex-row gap-4"},Q1=["placeholder"],J1={class:"bg-on-primary text-primary font-bold px-8 py-3 rounded-lg hover:bg-primary-container transition-all active:scale-95",type:"submit"},Z1=U({__name:"AboutMeLayout",setup(e){const{lang:n}=gn(),{page:t}=Ft(),{headerConfig:a,footerConfig:o,uiConfig:i}=jt(),s=R(()=>i.value.common||{}),r=R(()=>i.value.about||{}),l=R(()=>i.value.blog||{}),c=R(()=>l.value.categoryMeta||{}),d=Object.assign({"/about-me.md":Xa,"/blogs/2022/202202-logseq-build-your-own-wiki.md":Qa,"/blogs/2022/202203-mesh-shaped-cloud-native-developer.md":Ja,"/blogs/2022/202203-mesh-shaped-recap.md":Za,"/blogs/2022/202205-container-k8s-docker.md":eo,"/blogs/2022/202205-router-proxy-gtw.md":no,"/blogs/2022/202211-cloud-native-engineering.md":to,"/blogs/2022/202212-api-design-inspired-by-google-api-design.md":ao,"/blogs/2022/202212-go-monorepo-tutorial.md":oo,"/blogs/2022/202212-logseq-customized-with-clojure-and-css.md":io,"/blogs/2022/202212-logseq-pkm.md":so,"/blogs/2023/202302-iac-and-terraform.md":ro,"/blogs/2023/202304-draw-architecture-diagram.md":lo,"/blogs/2023/202304-tunnel-vpn-vpc.md":co,"/blogs/2023/202306-remote-development-in-cloud.md":uo,"/blogs/2023/202312-agile-and-lean.md":ho,"/blogs/2023/202312-cobra-cli.md":po,"/blogs/2023/202312-devcontainer-tutorial.md":go,"/blogs/2023/202312-illustrated-ai.md":mo,"/blogs/2023/202312-kubernetes-operator.md":fo,"/blogs/2023/202312-windows-workspaces.md":vo,"/blogs/2024/202401-cloud-native-practices.md":bo,"/blogs/2024/202401-eassy-2024.md":yo,"/blogs/2024/202401-illustrations.md":wo,"/blogs/2024/202402-llm-application.md":_o,"/blogs/2024/202403-ai-and-human.md":ko,"/blogs/2024/202406-fork-oss.md":xo,"/blogs/2024/202406-k3s-blogs.md":Ao,"/blogs/2024/202412-ai-powered-pkm.md":Co,"/blogs/2026/202602-domain-spec-agents.md":To,"/blogs/2026/202602-pov-agentic-engineering.md":So,"/blogs/2026/202602-pov-standard-automation-selfserve.md":Io,"/blogs/2026/202604-llm-wiki-self-evolving-brains.md":Do,"/blogs/2026/202604-logseq-scoring-overview.md":Po,"/blogs/2026/202605-multica-brains-agent-kanban.md":Mo,"/blogs/2026/202605-spdd-agentic-refactor.md":Lo,"/blogs/2026/202606-agent-changes-service-interconnection.md":$o,"/blogs/index.md":No,"/en/about-me.md":Eo,"/en/blogs/2022/202202-logseq-build-your-own-wiki.md":Oo,"/en/blogs/2022/202203-mesh-shaped-cloud-native-developer.md":Ro,"/en/blogs/2022/202205-container-k8s-docker.md":zo,"/en/blogs/2022/202205-router-proxy-gtw.md":qo,"/en/blogs/2022/202211-cloud-native-engineering.md":Bo,"/en/blogs/2022/202212-logseq-customized-with-clojure-and-css.md":Vo,"/en/blogs/2022/202212-logseq-pkm.md":Fo,"/en/blogs/2023/202302-iac-and-terraform.md":jo,"/en/blogs/2023/202304-draw-architecture-diagram.md":Uo,"/en/blogs/2023/202304-tunnel-vpn-vpc.md":Go,"/en/blogs/2023/202306-remote-development-in-cloud.md":Ho,"/en/blogs/2023/202312-agile-and-lean.md":Wo,"/en/blogs/2023/202312-devcontainer-tutorial.md":Ko,"/en/blogs/2024/202401-cloud-native-practices.md":Yo,"/en/blogs/2024/202401-illustrations.md":Xo,"/en/blogs/2024/202402-llm-application.md":Qo,"/en/blogs/2024/202403-ai-and-human.md":Jo,"/en/blogs/2024/202412-ai-powered-pkm.md":Zo,"/en/blogs/2026/202602-domain-spec-agents.md":ei,"/en/blogs/2026/202602-pov-agentic-engineering.md":ni,"/en/blogs/2026/202602-pov-standard-automation-selfserve.md":ti,"/en/blogs/2026/202604-llm-wiki-self-evolving-brains.md":ai,"/en/blogs/2026/202604-logseq-scoring-overview.md":oi,"/en/blogs/index.md":ii,"/en/index.md":si,"/index.md":ri}),g=Kr(d);function u(k){var $,P;const{modulePath:E,raw:V}=Yr(k,d,g);if(!V)return console.warn(`[AboutMeLayout] markdown not found for path: ${k}`),console.warn(`[AboutMeLayout] attempted module key: ${E}`),null;const W=Xr(V),F=W.title||W.heroTitle||((P=($=pe(k).split("/").pop())==null?void 0:$.replace(/\.md$/,""))==null?void 0:P.replace(/[-_]/g," "))||String(s.value.untitled||"Untitled");return{path:pe(k),title:F,description:W.description||W.heroDescription||W.articleLead||Jr(V),date:W.date,category:W.category,image:W.image}}const h=R(()=>{const k=t.value.featuredArticle;if(!k)return null;if(typeof k=="string")return u(k);if(typeof k=="object"&&typeof k.path=="string"){const E=u(k.path);return E?{...E,...k,path:E.path}:null}return typeof k=="object"?k:null}),v=R(()=>{var P;const k=t.value.sideArticles,E=pe(((P=h.value)==null?void 0:P.path)||"");if(Array.isArray(k))return k.filter(L=>pe(L.path||"")!==E);if(!k||typeof k!="object")return[];const V=pe(k.path||"blog/**/*.md"),W=Number(k.count||4),F=el(V);return Object.keys(d).map(L=>pe(L)).filter(L=>F.test(L)).sort((L,z)=>{const te=Nt(z).localeCompare(Nt(L));return te!==0?te:z.localeCompare(L)}).map(L=>u(L)).filter(L=>!!L).filter(L=>pe(L.path||"")!==E).slice(0,W)}),b=R(()=>!!h.value),w=R(()=>b.value?v.value:v.value.slice(0,4)),x=R(()=>t.value.articlesMoreHref||(n.value==="en"?"/en/blog/":"/blog/")),A=R(()=>t.value.articlesMoreText||r.value.viewMore||"View More");function M(k){return typeof k=="string"&&/^https?:\/\//.test(k)}function y(k){return Ii({category:String(k||""),categoryMeta:c.value})}function T(k){return Di({category:String(k||""),categoryMeta:c.value})}return(k,E)=>{var V,W,F,$,P,L,z,te,ee;return f(),_("div",Xw,[j(Bt,{"site-title":m(a).siteTitle||m(t).siteTitle,"nav-links":m(a).navLinks||m(t).navLinks||[],"show-subscribe":!!m(a).showSubscribe,"subscribe-button-text":m(a).subscribeButtonText,"nav-height-class":"h-20"},null,8,["site-title","nav-links","show-subscribe","subscribe-button-text"]),p("main",Qw,[p("section",Jw,[p("div",Zw,[p("div",e1,[p("div",n1,S(m(t).heroEyebrow),1),p("h1",t1,S(m(t).heroTitle),1),p("p",a1,S(m(t).heroDescription),1),p("div",o1,[p("p",i1,S(m(t).heroMeta),1)])]),p("div",s1,[p("div",r1,[E[0]||(E[0]=p("span",{class:"text-s font-bold tracking-tight text-slate-700 dark:text-slate-300 mb-6"}," Graph: Mesh Capabilities ",-1)),j(D2)])])])]),p("section",l1,[p("div",c1,[p("div",u1,[p("div",null,[p("span",d1,S(m(t).focusEyebrow),1),p("h2",h1,S(m(t).focusTitle),1)]),E[1]||(E[1]=p("div",{class:"hidden md:block w-1/3 h-[1px] bg-outline-variant/20 dark:bg-slate-700 mb-4"},null,-1))]),p("div",p1,[(f(!0),_(Z,null,ie(m(t).focusCards||[],K=>(f(),_("div",{key:K.title,class:"bg-surface-container-lowest dark:bg-slate-950 p-10 transition-colors"},[M(K.icon)?(f(),_("img",{key:0,src:K.icon,alt:K.title,class:"w-10 h-10 object-contain mb-6"},null,8,g1)):(f(),_("span",{key:1,class:"material-symbols-outlined text-primary mb-6 block text-4xl dark:text-tertiary","data-icon":K.icon},S(K.icon),9,m1)),p("h3",f1,S(K.title),1),p("p",v1,S(K.description),1)]))),128))])])]),p("section",b1,[p("div",y1,[p("div",null,[p("h2",w1,S(m(t).articlesTitle),1),E[2]||(E[2]=p("div",{class:"w-12 h-1 bg-primary"},null,-1))]),p("a",{href:x.value,class:"inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-outline-variant/30 dark:border-slate-700 text-sm font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors"},[Ae(S(A.value)+" ",1),E[3]||(E[3]=p("span",{class:"material-symbols-outlined text-sm"},"arrow_forward",-1))],8,_1)]),b.value?(f(),_("div",k1,[p("a",{href:m(Fn)((V=h.value)==null?void 0:V.path),class:"md:col-span-8 group cursor-pointer block"},[p("div",A1,[p("img",{alt:(W=h.value)==null?void 0:W.title,class:"w-full h-full object-cover transition-transform duration-700 group-hover:scale-105",src:m(Kn)((F=h.value)==null?void 0:F.image,($=h.value)==null?void 0:$.path)},null,8,C1),E[4]||(E[4]=p("div",{class:"absolute inset-0 bg-gradient-to-t from-black/40 to-transparent"},null,-1))]),p("div",T1,[p("span",{class:Q(["text-xs font-bold uppercase tracking-widest px-2 py-0.5 rounded",T((P=h.value)==null?void 0:P.category)])},S(y((L=h.value)==null?void 0:L.category)),3),p("span",S1,S((z=h.value)==null?void 0:z.date),1)]),p("h3",I1,S((te=h.value)==null?void 0:te.title),1),p("p",D1,S((ee=h.value)==null?void 0:ee.description),1)],8,x1),p("div",P1,[(f(!0),_(Z,null,ie(w.value,K=>(f(),_("a",{key:K.title,href:m(Fn)(K.path),class:"group cursor-pointer block"},[p("div",L1,[p("span",{class:Q(["text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 rounded",T(K.category)])},S(y(K.category)),3),p("span",$1,S(K.date),1)]),p("h4",N1,S(K.title),1),p("p",E1,S(K.description),1),p("div",O1,[Ae(S(m(t).readMoreLabel)+" ",1),E[5]||(E[5]=p("span",{class:"material-symbols-outlined text-sm"},"arrow_forward",-1))])],8,M1))),128))])])):(f(),_("div",R1,[(f(!0),_(Z,null,ie(w.value,K=>(f(),_("a",{key:K.title,href:m(Fn)(K.path),class:"bg-surface-container-lowest dark:bg-slate-900 border border-outline-variant/10 dark:border-slate-700 rounded-xl overflow-hidden block"},[p("img",{src:m(Kn)(K.image,K.path),alt:K.title,class:"w-full h-40 object-cover"},null,8,q1),p("div",B1,[p("div",V1,[p("span",{class:Q(["text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 rounded",T(K.category)])},S(y(K.category)),3),p("span",F1,S(K.date),1)]),p("h4",j1,S(K.title),1),p("p",U1,S(K.description),1)])],8,z1))),128))]))]),m(t).subscribeTitle?(f(),_("section",G1,[p("div",H1,[E[6]||(E[6]=p("div",{class:"absolute top-0 right-0 w-1/3 h-full mesh-grid opacity-10"},null,-1)),p("div",W1,[p("h2",K1,S(m(t).subscribeTitle),1),p("p",Y1,S(m(t).subscribeDescription),1),p("form",X1,[p("input",{class:"bg-white/10 border border-white/20 rounded-lg px-6 py-3 flex-grow focus:outline-none focus:ring-2 focus:ring-on-primary/50 text-white placeholder-white/40",placeholder:m(t).subscribePlaceholder,type:"email"},null,8,Q1),p("button",J1,S(m(t).subscribeButton),1)])])])])):q("",!0)]),j(Vt,{title:m(o).title||m(t).footerTitle,description:m(o).description||m(t).footerDescription,links:m(o).links||m(t).footerLinks||[],"social-icons":m(o).socialIcons||[]},null,8,["title","description","links","social-icons"])])}}}),e_={class:"bg-surface dark:bg-slate-900 text-slate-900 dark:text-slate-100 selection:bg-primary-container selection:text-on-primary-container"},n_={class:"pt-32 pb-24 px-6 lg:px-12 max-w-7xl mx-auto bg-surface dark:bg-slate-900"},t_={class:"mb-32 relative"},a_={class:"grid grid-cols-1 lg:grid-cols-12 gap-12 items-end"},o_={class:"lg:col-span-7"},i_={class:"overflow-hidden rounded-xl bg-surface-container-low group"},s_=["src"],r_={class:"lg:col-span-5 pb-4"},l_={class:"flex items-center gap-4 mb-6"},c_={class:"text-[0.6875rem] font-medium text-outline"},u_={class:"text-5xl lg:text-6xl font-extrabold tracking-tighter leading-[1.12] lg:leading-[1.05] mb-8 text-slate-900 dark:text-slate-100"},d_={class:"text-slate-700 dark:text-slate-400 text-lg leading-relaxed mb-8 max-w-md"},h_={key:0,class:"flex flex-wrap gap-2 mb-8"},p_={class:"flex items-center justify-between border-t border-outline-variant/20 pt-6"},g_={class:"text-xs font-medium text-outline uppercase tracking-widest"},m_=["href"],f_={class:"flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8"},v_={class:"max-w-xl"},b_={class:"text-3xl font-bold tracking-tight mb-6"},y_={class:"text-slate-700 dark:text-slate-400"},w_={class:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-20 gap-x-12"},__=["href"],k_={class:"aspect-[4/3] rounded-xl overflow-hidden bg-surface-container-low mb-8"},x_=["src"],A_={class:"flex items-center gap-4 mb-4"},C_={class:"text-[0.6875rem] font-medium text-outline uppercase tracking-widest"},T_={class:"text-xl font-bold leading-tight mb-4 tracking-tight text-slate-900 dark:text-slate-100 hover:text-tertiary transition-colors"},S_={class:"text-slate-700 dark:text-slate-400 text-sm leading-relaxed mb-4"},I_={key:0,class:"flex flex-wrap gap-2 mb-6"},D_={class:"mt-auto flex items-center justify-between text-[0.6875rem] font-bold uppercase tracking-widest text-outline"},P_={class:"mt-32 pt-12 border-t border-outline-variant/20 flex justify-center items-center gap-8"},M_=["disabled"],L_={class:"flex gap-4"},$_=["onClick"],N_=["disabled"],E_=U({__name:"BlogListLayout",setup(e){const{page:n}=Ft(),{headerConfig:t,footerConfig:a,uiConfig:o}=jt(),i=R(()=>o.value.common||{}),s=R(()=>o.value.blog||{}),r=R(()=>s.value.categoryMeta||{}),l=R(()=>String(s.value.readingTimeTemplate||"")),c=Object.assign({"/about-me.md":Xa,"/blogs/2022/202202-logseq-build-your-own-wiki.md":Qa,"/blogs/2022/202203-mesh-shaped-cloud-native-developer.md":Ja,"/blogs/2022/202203-mesh-shaped-recap.md":Za,"/blogs/2022/202205-container-k8s-docker.md":eo,"/blogs/2022/202205-router-proxy-gtw.md":no,"/blogs/2022/202211-cloud-native-engineering.md":to,"/blogs/2022/202212-api-design-inspired-by-google-api-design.md":ao,"/blogs/2022/202212-go-monorepo-tutorial.md":oo,"/blogs/2022/202212-logseq-customized-with-clojure-and-css.md":io,"/blogs/2022/202212-logseq-pkm.md":so,"/blogs/2023/202302-iac-and-terraform.md":ro,"/blogs/2023/202304-draw-architecture-diagram.md":lo,"/blogs/2023/202304-tunnel-vpn-vpc.md":co,"/blogs/2023/202306-remote-development-in-cloud.md":uo,"/blogs/2023/202312-agile-and-lean.md":ho,"/blogs/2023/202312-cobra-cli.md":po,"/blogs/2023/202312-devcontainer-tutorial.md":go,"/blogs/2023/202312-illustrated-ai.md":mo,"/blogs/2023/202312-kubernetes-operator.md":fo,"/blogs/2023/202312-windows-workspaces.md":vo,"/blogs/2024/202401-cloud-native-practices.md":bo,"/blogs/2024/202401-eassy-2024.md":yo,"/blogs/2024/202401-illustrations.md":wo,"/blogs/2024/202402-llm-application.md":_o,"/blogs/2024/202403-ai-and-human.md":ko,"/blogs/2024/202406-fork-oss.md":xo,"/blogs/2024/202406-k3s-blogs.md":Ao,"/blogs/2024/202412-ai-powered-pkm.md":Co,"/blogs/2026/202602-domain-spec-agents.md":To,"/blogs/2026/202602-pov-agentic-engineering.md":So,"/blogs/2026/202602-pov-standard-automation-selfserve.md":Io,"/blogs/2026/202604-llm-wiki-self-evolving-brains.md":Do,"/blogs/2026/202604-logseq-scoring-overview.md":Po,"/blogs/2026/202605-multica-brains-agent-kanban.md":Mo,"/blogs/2026/202605-spdd-agentic-refactor.md":Lo,"/blogs/2026/202606-agent-changes-service-interconnection.md":$o,"/blogs/index.md":No,"/en/about-me.md":Eo,"/en/blogs/2022/202202-logseq-build-your-own-wiki.md":Oo,"/en/blogs/2022/202203-mesh-shaped-cloud-native-developer.md":Ro,"/en/blogs/2022/202205-container-k8s-docker.md":zo,"/en/blogs/2022/202205-router-proxy-gtw.md":qo,"/en/blogs/2022/202211-cloud-native-engineering.md":Bo,"/en/blogs/2022/202212-logseq-customized-with-clojure-and-css.md":Vo,"/en/blogs/2022/202212-logseq-pkm.md":Fo,"/en/blogs/2023/202302-iac-and-terraform.md":jo,"/en/blogs/2023/202304-draw-architecture-diagram.md":Uo,"/en/blogs/2023/202304-tunnel-vpn-vpc.md":Go,"/en/blogs/2023/202306-remote-development-in-cloud.md":Ho,"/en/blogs/2023/202312-agile-and-lean.md":Wo,"/en/blogs/2023/202312-devcontainer-tutorial.md":Ko,"/en/blogs/2024/202401-cloud-native-practices.md":Yo,"/en/blogs/2024/202401-illustrations.md":Xo,"/en/blogs/2024/202402-llm-application.md":Qo,"/en/blogs/2024/202403-ai-and-human.md":Jo,"/en/blogs/2024/202412-ai-powered-pkm.md":Zo,"/en/blogs/2026/202602-domain-spec-agents.md":ei,"/en/blogs/2026/202602-pov-agentic-engineering.md":ni,"/en/blogs/2026/202602-pov-standard-automation-selfserve.md":ti,"/en/blogs/2026/202604-llm-wiki-self-evolving-brains.md":ai,"/en/blogs/2026/202604-logseq-scoring-overview.md":oi,"/en/blogs/index.md":ii,"/en/index.md":si,"/index.md":ri}),d=Kr(c);function g($){var ee,K;const{modulePath:P,raw:L}=Yr($,c,d);if(!L)return console.warn(`[BlogListLayout] markdown not found for path: ${$}`),console.warn(`[BlogListLayout] attempted module key: ${P}`),null;const z=Xr(L),te=pe($);return{path:te,category:z.category,tags:Array.isArray(z.tags)?z.tags.map(re=>String(re)):[],date:z.date,title:z.title||((K=(ee=te.split("/").pop())==null?void 0:ee.replace(/\.md$/,""))==null?void 0:K.replace(/[-_]/g," "))||String(i.value.untitled||"Untitled"),description:z.description||z.articleLead||Jr(L)||"",readingTime:Zr(L,{template:l.value}),action:z.action,image:z.image}}const u=R(()=>{const $=n.value.featured;if(!$)return null;if(typeof $=="string")return g($);if(typeof $=="object"&&typeof $.path=="string"){const P=g($.path);return P?{...P,...$,path:P.path}:null}return typeof $=="object"?$:null}),h=R(()=>{var te;const $=n.value.posts,P=pe(((te=u.value)==null?void 0:te.path)||"");if(Array.isArray($))return $.filter(ee=>pe(ee.path||"")!==P);if(!$||typeof $!="object")return[];const L=pe($.path||"blogs/**/*.md"),z=el(L);return Object.keys(c).map(ee=>pe(ee)).filter(ee=>z.test(ee)).filter(ee=>!ee.endsWith("/index.md")).sort((ee,K)=>{const re=Nt(K).localeCompare(Nt(ee));return re!==0?re:K.localeCompare(ee)}).map(ee=>g(ee)).filter(ee=>!!ee).filter(ee=>pe(ee.path||"")!==P)}),v=R(()=>{const $=n.value.posts;return!$||typeof $!="object"||Array.isArray($)?h.value.length||1:Math.max(1,Number($.perPage||$.count||9))}),b=R(()=>{const $=n.value.posts;return!$||typeof $!="object"||Array.isArray($)?Math.max(1,Number(n.value.paginationCurrent||1)):Math.max(1,Number($.page||n.value.paginationCurrent||1))}),w=ae(1);Me(b,$=>{w.value=$},{immediate:!0});const x=R(()=>Math.max(1,Math.ceil(h.value.length/v.value))),A=R(()=>Math.min(Math.max(1,w.value),x.value)),M=R(()=>{const $=(A.value-1)*v.value,P=$+v.value;return h.value.slice($,P)}),y=R(()=>Array.from({length:x.value},($,P)=>String(P+1)));function T($){w.value=Math.min(Math.max(1,$),x.value)}function k(){T(A.value-1)}function E(){T(A.value+1)}function V($){return Ii({category:String($||""),categoryMeta:r.value})}function W($){return Di({category:String($||""),categoryMeta:r.value})}function F($){const P=String($.category||"").trim();return(Array.isArray($.tags)?$.tags:[]).filter(z=>{const te=String(z||"").trim();return!!te&&te!==P})}return($,P)=>{var L,z,te,ee,K,re,de,ue,Ce,we;return f(),_("div",e_,[j(Bt,{"site-title":m(t).siteTitle||m(n).siteTitle,"nav-links":m(t).navLinks||m(n).navLinks||[],"show-subscribe":!!m(t).showSubscribe,"subscribe-button-text":m(t).subscribeButtonText,"nav-height-class":"h-20"},null,8,["site-title","nav-links","show-subscribe","subscribe-button-text"]),p("main",n_,[p("section",t_,[p("div",a_,[p("div",o_,[p("div",i_,[p("img",{class:"w-full aspect-[16/9] object-cover transition-all duration-700 hover:scale-105",src:m(Kn)((L=u.value)==null?void 0:L.image,(z=u.value)==null?void 0:z.path)},null,8,s_)])]),p("div",r_,[p("div",l_,[p("span",{class:Q(["text-[0.6875rem] font-bold uppercase tracking-[0.05em] px-2 py-1 rounded",W((te=u.value)==null?void 0:te.category)])},S(V((ee=u.value)==null?void 0:ee.category)),3),p("span",c_,S((K=u.value)==null?void 0:K.date),1)]),p("h1",u_,S((re=u.value)==null?void 0:re.title),1),p("p",d_,S((de=u.value)==null?void 0:de.description),1),u.value&&F(u.value).length?(f(),_("div",h_,[(f(!0),_(Z,null,ie(F(u.value),le=>(f(),_("span",{key:`featured-${u.value.path||u.value.title}-${le}`,class:"px-2 py-0.5 rounded bg-surface-container-high text-[0.6875rem] font-semibold text-on-surface-variant dark:text-slate-400"}," #"+S(le),1))),128))])):q("",!0),p("div",p_,[p("span",g_,S((ue=u.value)==null?void 0:ue.readingTime),1),p("a",{class:"text-tertiary font-bold text-sm flex items-center gap-2 group",href:m(Fn)((Ce=u.value)==null?void 0:Ce.path)},[Ae(S(((we=u.value)==null?void 0:we.action)||s.value.readArticle||"Read Article")+" ",1),P[0]||(P[0]=p("span",{class:"material-symbols-outlined text-sm group-hover:translate-x-1 transition-transform"},"arrow_forward",-1))],8,m_)])])])]),p("header",f_,[p("div",v_,[p("h2",b_,S(m(n).listTitle||s.value.latestArticles||"Latest Articles"),1),p("p",y_,S(m(n).listDescription||s.value.latestArticlesDescription||"Displayed in reverse chronological order."),1)])]),p("div",w_,[(f(!0),_(Z,null,ie(M.value,le=>(f(),_("article",{key:le.title,class:"flex flex-col"},[p("a",{href:m(Fn)(le.path),class:"group flex flex-col h-full"},[p("div",k_,[p("img",{class:"w-full h-full object-cover grayscale-[0.8] hover:grayscale-0 transition-all duration-500 scale-100 group-hover:scale-110",src:m(Kn)(le.image,le.path)},null,8,x_)]),p("div",A_,[p("span",{class:Q(["text-[0.6875rem] font-bold uppercase tracking-[0.05em] px-2 py-0.5 rounded",W(le.category)])},S(V(le.category)),3),P[1]||(P[1]=p("span",{class:"w-1 h-1 bg-outline-variant rounded-full"},null,-1)),p("span",C_,S(le.date),1)]),p("h3",T_,S(le.title),1),p("p",S_,S(le.description),1),F(le).length?(f(),_("div",I_,[(f(!0),_(Z,null,ie(F(le),Le=>(f(),_("span",{key:`${le.path||le.title}-${Le}`,class:"px-2 py-0.5 rounded bg-surface-container-high text-[0.6875rem] font-semibold text-on-surface-variant dark:text-slate-400"}," #"+S(Le),1))),128))])):q("",!0),p("div",D_,[p("span",null,S(le.readingTime),1),P[2]||(P[2]=p("span",{class:"material-symbols-outlined text-sm"},"north_east",-1))])],8,__)]))),128))]),p("div",P_,[p("button",{type:"button",disabled:A.value<=1,class:"text-xs font-bold uppercase tracking-widest text-outline hover:text-on-surface transition-colors flex items-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed",onClick:k},[P[3]||(P[3]=p("span",{class:"material-symbols-outlined text-sm"},"arrow_back",-1)),Ae(" "+S(m(n).paginationPrevious||s.value.paginationPrevious||"Previous"),1)],8,M_),p("div",L_,[(f(!0),_(Z,null,ie(y.value,le=>(f(),_("button",{key:le,type:"button",class:Q(le===String(A.value)?"w-8 h-8 flex items-center justify-center rounded-full bg-primary text-on-primary text-xs font-bold":"w-8 h-8 flex items-center justify-center rounded-full hover:bg-surface-container-high text-xs font-bold cursor-pointer"),onClick:Le=>T(Number(le))},S(le),11,$_))),128))]),p("button",{type:"button",disabled:A.value>=x.value,class:"text-xs font-bold uppercase tracking-widest text-on-surface hover:text-tertiary transition-colors flex items-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed",onClick:E},[Ae(S(m(n).paginationNext||s.value.paginationNext||"Next")+" ",1),P[4]||(P[4]=p("span",{class:"material-symbols-outlined text-sm"},"arrow_forward",-1))],8,N_)])]),j(Vt,{title:m(a).title||m(n).footerTitle,description:m(a).description||m(n).footerDescription,links:m(a).links||m(n).footerLinks||[],"social-icons":m(a).socialIcons||m(n).socialIcons||[]},null,8,["title","description","links","social-icons"])])}}}),O_={class:"bg-surface dark:bg-slate-900 text-on-surface dark:text-slate-100"},R_={class:"pt-16 pb-20 bg-surface dark:bg-slate-900"},z_={class:"relative overflow-hidden bg-surface-container-low dark:bg-slate-950 mb-14"},q_={class:"max-w-6xl mx-auto px-6 lg:px-10 py-14 lg:py-16 relative z-10"},B_={class:"grid grid-cols-1 lg:grid-cols-12 gap-10 items-center"},V_={class:"lg:col-span-7 flex flex-col justify-center gap-5"},F_={class:"text-4xl lg:text-5xl font-black tracking-tight leading-tight"},j_={class:"text-base lg:text-lg text-on-surface-variant dark:text-slate-400 leading-relaxed"},U_={class:"flex flex-wrap items-center gap-4 text-sm text-on-surface-variant dark:text-slate-400"},G_={key:0,class:"flex flex-wrap gap-2 pt-1"},H_={class:"lg:col-span-5 hidden lg:flex justify-center"},W_={class:"relative w-full max-w-md aspect-square rounded-full bg-surface-container-lowest/90 border border-outline-variant/20 shadow-[0px_24px_48px_rgba(42,52,57,0.08)] p-7"},K_=["src","alt"],Y_={class:"max-w-6xl mx-auto px-6 lg:px-10"},X_={class:"grid grid-cols-1 lg:grid-cols-12 gap-10"},Q_={key:0,class:"lg:col-span-3 order-2 lg:order-1"},J_={class:"lg:sticky lg:top-28 pl-1"},Z_={class:"text-s font-bold uppercase tracking-widest text-on-surface-variant dark:text-slate-400 mb-4 -ml-1"},ek={class:"flex flex-col gap-2 pt-1 pb-4 border-b border-outline-variant/30 dark:border-slate-600"},nk=["href"],tk={class:"lg:col-span-9 order-1 lg:order-2 vp-doc max-w-none dark:text-slate-300"},ak=U({__name:"BlogLayout",setup(e){const{page:n}=gn(),{page:t}=Ft(),{headerConfig:a,footerConfig:o,uiConfig:i}=jt(),s=R(()=>i.value.blog||{}),r=R(()=>s.value.categoryMeta||{}),l=Object.assign({"/about-me.md":Xa,"/blogs/2022/202202-logseq-build-your-own-wiki.md":Qa,"/blogs/2022/202203-mesh-shaped-cloud-native-developer.md":Ja,"/blogs/2022/202203-mesh-shaped-recap.md":Za,"/blogs/2022/202205-container-k8s-docker.md":eo,"/blogs/2022/202205-router-proxy-gtw.md":no,"/blogs/2022/202211-cloud-native-engineering.md":to,"/blogs/2022/202212-api-design-inspired-by-google-api-design.md":ao,"/blogs/2022/202212-go-monorepo-tutorial.md":oo,"/blogs/2022/202212-logseq-customized-with-clojure-and-css.md":io,"/blogs/2022/202212-logseq-pkm.md":so,"/blogs/2023/202302-iac-and-terraform.md":ro,"/blogs/2023/202304-draw-architecture-diagram.md":lo,"/blogs/2023/202304-tunnel-vpn-vpc.md":co,"/blogs/2023/202306-remote-development-in-cloud.md":uo,"/blogs/2023/202312-agile-and-lean.md":ho,"/blogs/2023/202312-cobra-cli.md":po,"/blogs/2023/202312-devcontainer-tutorial.md":go,"/blogs/2023/202312-illustrated-ai.md":mo,"/blogs/2023/202312-kubernetes-operator.md":fo,"/blogs/2023/202312-windows-workspaces.md":vo,"/blogs/2024/202401-cloud-native-practices.md":bo,"/blogs/2024/202401-eassy-2024.md":yo,"/blogs/2024/202401-illustrations.md":wo,"/blogs/2024/202402-llm-application.md":_o,"/blogs/2024/202403-ai-and-human.md":ko,"/blogs/2024/202406-fork-oss.md":xo,"/blogs/2024/202406-k3s-blogs.md":Ao,"/blogs/2024/202412-ai-powered-pkm.md":Co,"/blogs/2026/202602-domain-spec-agents.md":To,"/blogs/2026/202602-pov-agentic-engineering.md":So,"/blogs/2026/202602-pov-standard-automation-selfserve.md":Io,"/blogs/2026/202604-llm-wiki-self-evolving-brains.md":Do,"/blogs/2026/202604-logseq-scoring-overview.md":Po,"/blogs/2026/202605-multica-brains-agent-kanban.md":Mo,"/blogs/2026/202605-spdd-agentic-refactor.md":Lo,"/blogs/2026/202606-agent-changes-service-interconnection.md":$o,"/blogs/index.md":No,"/en/about-me.md":Eo,"/en/blogs/2022/202202-logseq-build-your-own-wiki.md":Oo,"/en/blogs/2022/202203-mesh-shaped-cloud-native-developer.md":Ro,"/en/blogs/2022/202205-container-k8s-docker.md":zo,"/en/blogs/2022/202205-router-proxy-gtw.md":qo,"/en/blogs/2022/202211-cloud-native-engineering.md":Bo,"/en/blogs/2022/202212-logseq-customized-with-clojure-and-css.md":Vo,"/en/blogs/2022/202212-logseq-pkm.md":Fo,"/en/blogs/2023/202302-iac-and-terraform.md":jo,"/en/blogs/2023/202304-draw-architecture-diagram.md":Uo,"/en/blogs/2023/202304-tunnel-vpn-vpc.md":Go,"/en/blogs/2023/202306-remote-development-in-cloud.md":Ho,"/en/blogs/2023/202312-agile-and-lean.md":Wo,"/en/blogs/2023/202312-devcontainer-tutorial.md":Ko,"/en/blogs/2024/202401-cloud-native-practices.md":Yo,"/en/blogs/2024/202401-illustrations.md":Xo,"/en/blogs/2024/202402-llm-application.md":Qo,"/en/blogs/2024/202403-ai-and-human.md":Jo,"/en/blogs/2024/202412-ai-powered-pkm.md":Zo,"/en/blogs/2026/202602-domain-spec-agents.md":ei,"/en/blogs/2026/202602-pov-agentic-engineering.md":ni,"/en/blogs/2026/202602-pov-standard-automation-selfserve.md":ti,"/en/blogs/2026/202604-llm-wiki-self-evolving-brains.md":ai,"/en/blogs/2026/202604-logseq-scoring-overview.md":oi,"/en/blogs/index.md":ii,"/en/index.md":si,"/index.md":ri});function c(M){return`/${pe(M)}`}const d=R(()=>{const M=String(n.value.relativePath||""),y=c(M);return l[y]||""}),g=R(()=>Zr(d.value,{template:String(s.value.readingTimeTemplate||"")})),u=ae([]),h=ae("");function v(){if(typeof window>"u"||u.value.length===0){h.value="";return}const M=window.scrollY+180;let y=u.value[0].href;for(const T of u.value){const k=T.href.slice(1),E=document.getElementById(k);E&&E.offsetTop<=M&&(y=T.href)}h.value=y}function b(){if(typeof window>"u")return;const M=Array.from(document.querySelectorAll(".vp-doc h2[id]"));u.value=M.map(y=>{var T;return{text:((T=y.textContent)==null?void 0:T.trim())||"",href:`#${y.id}`}}).filter(y=>!!y.text),v()}async function w(){await Va(),requestAnimationFrame(()=>{b()})}Ee(()=>{typeof window>"u"||(window.addEventListener("scroll",v,{passive:!0}),w())}),Fa(()=>{typeof window>"u"||window.removeEventListener("scroll",v)}),Me(()=>n.value.relativePath,()=>{w()}),Me(d,()=>{w()});const x=R(()=>Ii({category:String(t.value.category||""),categoryMeta:r.value})),A=R(()=>Di({category:String(t.value.category||""),categoryMeta:r.value}));return(M,y)=>{const T=tn("Content");return f(),_("div",O_,[j(Bt,{"site-title":m(a).siteTitle,"nav-links":m(a).navLinks||[],"show-subscribe":!!m(a).showSubscribe,"subscribe-button-text":m(a).subscribeButtonText,"nav-height-class":"h-20"},null,8,["site-title","nav-links","show-subscribe","subscribe-button-text"]),p("main",R_,[p("header",z_,[y[3]||(y[3]=p("div",{class:"absolute inset-0 mesh-gradient opacity-60"},null,-1)),y[4]||(y[4]=p("div",{class:"absolute inset-0 bg-gradient-to-br from-primary/10 to-transparent"},null,-1)),p("div",q_,[p("div",B_,[p("div",V_,[p("span",{class:Q(["inline-flex w-fit px-3 py-1 rounded-full text-xs font-bold uppercase tracking-widest",A.value])},S(x.value),3),p("h1",F_,S(m(t).title),1),p("p",j_,S(m(t).description),1),p("div",U_,[p("span",null,S(m(t).date),1),y[0]||(y[0]=p("span",{class:"w-1 h-1 rounded-full bg-outline"},null,-1)),p("span",null,S(g.value),1)]),(m(t).tags||[]).length?(f(),_("div",G_,[(f(!0),_(Z,null,ie(m(t).tags||[],k=>(f(),_("span",{key:k,class:"px-2.5 py-1 rounded bg-surface-container-high dark:bg-slate-700 text-xs font-semibold text-on-surface-variant dark:text-slate-400"}," #"+S(k),1))),128))])):q("",!0)]),p("div",H_,[p("div",W_,[y[1]||(y[1]=p("div",{class:"absolute inset-4 rounded-full border-2 border-dashed border-primary/30 animate-[spin_20s_linear_infinite]"},null,-1)),y[2]||(y[2]=p("div",{class:"absolute inset-10 rounded-full border border-primary/20"},null,-1)),p("img",{src:m(Kn)(m(t).image,m(n).relativePath),alt:m(t).title,class:"relative z-10 w-full h-full object-cover rounded-full"},null,8,K_)])])])])]),p("section",Y_,[p("div",X_,[u.value.length?(f(),_("aside",Q_,[p("div",J_,[p("h3",Z_,S(s.value.tocTitle||"Contents"),1),p("nav",ek,[(f(!0),_(Z,null,ie(u.value,k=>(f(),_("a",{key:k.href,href:k.href,class:Q(k.href===h.value?"relative text-sm font-semibold text-primary pl-6 before:content-[''] before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-[2px] before:h-4 before:bg-primary before:rounded dark:text-tertiary":"text-sm font-thin text-on-surface dark:text-slate-300 hover:text-primary pl-6")},S(k.text),11,nk))),128))])])])):q("",!0),p("article",tk,[j(T)])])])]),j(Vt,{title:m(o).title,description:m(o).description,links:m(o).links||[],"social-icons":m(o).socialIcons||[]},null,8,["title","description","links","social-icons"])])}}}),ok=U({__name:"Layout",setup(e){const{frontmatter:n,page:t}=gn(),a=R(()=>{const o=String(n.value.layout||"");if(o)return o;const i=String(t.value.relativePath||"");return i.startsWith("blogs/")||i.startsWith("en/blogs/")?"blog":""});return(o,i)=>a.value==="home"?(f(),G(vg,{key:0})):a.value==="about-me"?(f(),G(Z1,{key:1})):a.value==="blog-list"?(f(),G(E_,{key:2})):a.value==="blog"?(f(),G(ak,{key:3})):(f(),G(m(Bs).Layout,{key:4}))}});let Rn=null;function ik(){let e=!1;return async()=>{if(typeof window>"u")return;const{default:n}=await Ps(async()=>{const{default:o}=await import("./mermaid.core.CjHOZjBY.js").then(i=>i.bd);return{default:o}},__vite__mapDeps([2,1]));e||(n.initialize({startOnLoad:!1,securityLevel:"loose"}),e=!0);const t=document.querySelectorAll(".vp-doc div.language-mermaid pre code");for(const o of t){const i=o.closest("pre"),s=o.closest("div.language-mermaid");if(!i||!s||i.dataset.mermaidRendered==="true")continue;i.classList.remove("shiki","shiki-themes","vp-code"),i.classList.add("mermaid"),i.textContent=o.textContent||"",i.dataset.mermaidRendered="true";const r=s.querySelector("button.copy"),l=s.querySelector("span.lang");r==null||r.remove(),l==null||l.remove(),s.classList.remove("language-mermaid")}const a=Array.from(document.querySelectorAll(".vp-doc pre.mermaid"));a.length>0&&await n.run({nodes:a})}}const Rk={extends:Bs,Layout:ok,enhanceApp({router:e}){if(typeof window>"u")return;Rn=Rn||ik();const n=()=>{requestAnimationFrame(()=>{Rn==null||Rn()})};n(),e.onAfterRouteChanged=n}};export{_k as $,Jn as A,_i as B,wi as C,_n as D,St as E,ck as F,ne as G,Dd as H,gk as I,Ek as J,Ok as K,Nk as L,$k as M,Lk as N,Mk as O,Pk as P,k2 as Q,Sk as R,Dk as S,Ik as T,Ak as U,Tk as V,Ck as W,xk as X,yk as Y,bk as Z,kk as _,vk as a,zb as b,fk as c,mk as d,wk as e,_r as f,hk as g,xr as h,pk as i,rk as j,dk as k,Wb as l,lk as m,uk as n,Ar as o,Lr as p,xi as q,Qt as r,ln as s,Rk as t,ny as u,ey as v,Dn as w,Zb as x,Jb as y,It as z};
