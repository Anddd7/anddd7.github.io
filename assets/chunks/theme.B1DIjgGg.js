const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.C96znhMa.js","assets/chunks/framework.CdjpmwdR.js","assets/chunks/mermaid.core.CvgjoqUA.js"])))=>i.map(i=>d[i]);
import{d as U,c as _,r as C,n as Q,o as f,a as Ae,t as I,b as W,w as N,T as Ea,e as B,_ as X,u as pn,i as rl,f as ll,g as Ra,h as R,j as g,k as m,l as dn,m as fa,p as ae,q as Me,s as Ot,v as Oe,x as za,y as Ba,z as cl,A as dl,F as Z,B as ie,C as tn,D as Et,E as F,G as Ls,H as ze,I as $s,J as mn,K as en,L as Rt,M as ul,N as qa,O as va,P as Va,Q as Ns,R as zt,S as hl,U as gl,V as Os,W as Es,X as Rs,Y as pl,Z as ml,$ as ja,a0 as fl,a1 as vl,a2 as bl}from"./framework.CdjpmwdR.js";const yl=U({__name:"VPBadge",props:{text:{},type:{default:"tip"}},setup(e){return(n,t)=>(f(),_("span",{class:Q(["VPBadge",e.type])},[C(n.$slots,"default",{},()=>[Ae(I(e.text),1)])],2))}}),wl={key:0,class:"VPBackdrop"},_l=U({__name:"VPBackdrop",props:{show:{type:Boolean}},setup(e){return(n,t)=>(f(),W(Ea,{name:"fade"},{default:N(()=>[e.show?(f(),_("div",wl)):B("",!0)]),_:1}))}}),kl=X(_l,[["__scopeId","data-v-49e9b6df"]]),ne=pn;function xl(e,n){let t,a=!1;return()=>{t&&clearTimeout(t),a?t=setTimeout(e,n):(e(),(a=!0)&&setTimeout(()=>a=!1,n))}}function ba(e){return e.startsWith("/")?e:`/${e}`}function Fa(e){const{pathname:n,search:t,hash:a,protocol:o}=new URL(e,"http://a.com");if(rl(e)||e.startsWith("#")||!o.startsWith("http")||!ll(n))return e;const{site:i}=ne(),s=n.endsWith("/")||n.endsWith(".html")?e:e.replace(/(?:(^\.+)\/)?.*$/,`$1${n.replace(/(\.md)?$/,i.value.cleanUrls?"":".html")}${t}${a}`);return Ra(s)}function Yn({correspondingLink:e=!1}={}){const{site:n,localeIndex:t,page:a,theme:o,hash:i}=ne(),s=R(()=>{var l,c;return{label:(l=n.value.locales[t.value])==null?void 0:l.label,link:((c=n.value.locales[t.value])==null?void 0:c.link)||(t.value==="root"?"/":`/${t.value}/`)}});return{localeLinks:R(()=>Object.entries(n.value.locales).flatMap(([l,c])=>s.value.label===c.label?[]:{text:c.label,link:Al(c.link||(l==="root"?"/":`/${l}/`),o.value.i18nRouting!==!1&&e,a.value.relativePath.slice(s.value.link.length-1),!n.value.cleanUrls)+i.value})),currentLang:s}}function Al(e,n,t,a){return n?e.replace(/\/$/,"")+ba(t.replace(/(^|\/)index\.md$/,"$1").replace(/\.md$/,a?".html":"")):e}const Cl={class:"NotFound"},Tl={class:"code"},Il={class:"title"},Sl={class:"quote"},Dl={class:"action"},Pl=["href","aria-label"],Ml=U({__name:"NotFound",setup(e){const{theme:n}=ne(),{currentLang:t}=Yn();return(a,o)=>{var i,s,r,l,c;return f(),_("div",Cl,[g("p",Tl,I(((i=m(n).notFound)==null?void 0:i.code)??"404"),1),g("h1",Il,I(((s=m(n).notFound)==null?void 0:s.title)??"PAGE NOT FOUND"),1),o[0]||(o[0]=g("div",{class:"divider"},null,-1)),g("blockquote",Sl,I(((r=m(n).notFound)==null?void 0:r.quote)??"But if you don't change your direction, and if you keep looking, you may end up where you are heading."),1),g("div",Dl,[g("a",{class:"link",href:m(Ra)(m(t).link),"aria-label":((l=m(n).notFound)==null?void 0:l.linkLabel)??"go to home"},I(((c=m(n).notFound)==null?void 0:c.linkText)??"Take me home"),9,Pl)])])}}}),Ll=X(Ml,[["__scopeId","data-v-e6e96a08"]]);function zs(e,n){if(Array.isArray(e))return st(e);if(e==null)return[];n=ba(n);const t=Object.keys(e).sort((o,i)=>i.split("/").length-o.split("/").length).find(o=>n.startsWith(ba(o))),a=t?e[t]:[];return Array.isArray(a)?st(a):st(a.items,a.base)}function $l(e){const n=[];let t=0;for(const a in e){const o=e[a];if(o.items){t=n.push(o);continue}n[t]||n.push({items:[]}),n[t].items.push(o)}return n}function Nl(e){const n=[];function t(a){for(const o of a)o.text&&o.link&&n.push({text:o.text,link:o.link,docFooterText:o.docFooterText}),o.items&&t(o.items)}return t(e),n}function ya(e,n){return Array.isArray(n)?n.some(t=>ya(e,t)):dn(e,n.link)?!0:n.items?ya(e,n.items):!1}function st(e,n){return[...e].map(t=>{const a={...t},o=a.base||n;return o&&a.link&&(a.link=o+a.link),a.items&&(a.items=st(a.items,o)),a})}function Qe(){const{frontmatter:e,page:n,theme:t}=ne(),a=fa("(min-width: 960px)"),o=ae(!1),i=R(()=>{const b=t.value.sidebar,w=n.value.relativePath;return b?zs(b,w):[]}),s=ae(i.value);Me(i,(b,w)=>{JSON.stringify(b)!==JSON.stringify(w)&&(s.value=i.value)});const r=R(()=>e.value.sidebar!==!1&&s.value.length>0&&e.value.layout!=="home"),l=R(()=>c?e.value.aside==null?t.value.aside==="left":e.value.aside==="left":!1),c=R(()=>e.value.layout==="home"?!1:e.value.aside!=null?!!e.value.aside:t.value.aside!==!1),u=R(()=>r.value&&a.value),p=R(()=>r.value?$l(s.value):[]);function d(){o.value=!0}function h(){o.value=!1}function v(){o.value?h():d()}return{isOpen:o,sidebar:s,sidebarGroups:p,hasSidebar:r,hasAside:c,leftAside:l,isSidebarEnabled:u,open:d,close:h,toggle:v}}function Ol(e,n){let t;Ot(()=>{t=e.value?document.activeElement:void 0}),Oe(()=>{window.addEventListener("keyup",a)}),za(()=>{window.removeEventListener("keyup",a)});function a(o){o.key==="Escape"&&e.value&&(n(),t==null||t.focus())}}function El(e){const{page:n,hash:t}=ne(),a=ae(!1),o=R(()=>e.value.collapsed!=null),i=R(()=>!!e.value.link),s=ae(!1),r=()=>{s.value=dn(n.value.relativePath,e.value.link)};Me([n,e,t],r),Oe(r);const l=R(()=>s.value?!0:e.value.items?ya(n.value.relativePath,e.value.items):!1),c=R(()=>!!(e.value.items&&e.value.items.length));Ot(()=>{a.value=!!(o.value&&e.value.collapsed)}),Ba(()=>{(s.value||l.value)&&(a.value=!1)});function u(){o.value&&(a.value=!a.value)}return{collapsed:a,collapsible:o,isLink:i,isActiveLink:s,hasActiveLink:l,hasChildren:c,toggle:u}}function Rl(){const{hasSidebar:e}=Qe(),n=fa("(min-width: 960px)"),t=fa("(min-width: 1280px)");return{isAsideEnabled:R(()=>!t.value&&!n.value?!1:e.value?t.value:n.value)}}const zl=/\b(?:VPBadge|header-anchor|footnote-ref|ignore-header)\b/,wa=[];function Bs(e){return typeof e.outline=="object"&&!Array.isArray(e.outline)&&e.outline.label||e.outlineTitle||"On this page"}function Ua(e){const n=[...document.querySelectorAll(".VPDoc :where(h1,h2,h3,h4,h5,h6)")].filter(t=>t.id&&t.hasChildNodes()).map(t=>{const a=Number(t.tagName[1]);return{element:t,title:Bl(t),link:"#"+t.id,level:a}});return ql(n,e)}function Bl(e){let n="";for(const t of e.childNodes)if(t.nodeType===1){if(zl.test(t.className))continue;n+=t.textContent}else t.nodeType===3&&(n+=t.textContent);return n.trim()}function ql(e,n){if(n===!1)return[];const t=(typeof n=="object"&&!Array.isArray(n)?n.level:n)||2,[a,o]=typeof t=="number"?[t,t]:t==="deep"?[2,6]:t;return Fl(e,a,o)}function Vl(e,n){const{isAsideEnabled:t}=Rl(),a=xl(i,100);let o=null;Oe(()=>{requestAnimationFrame(i),window.addEventListener("scroll",a)}),cl(()=>{s(location.hash)}),za(()=>{window.removeEventListener("scroll",a)});function i(){if(!t.value)return;const r=window.scrollY,l=window.innerHeight,c=document.body.offsetHeight,u=Math.abs(r+l-c)<1,p=wa.map(({element:h,link:v})=>({link:v,top:jl(h)})).filter(({top:h})=>!Number.isNaN(h)).sort((h,v)=>h.top-v.top);if(!p.length){s(null);return}if(r<1){s(null);return}if(u){s(p[p.length-1].link);return}let d=null;for(const{link:h,top:v}of p){if(v>r+dl()+4)break;d=h}s(d)}function s(r){o&&o.classList.remove("active"),r==null?o=null:o=e.value.querySelector(`a[href="${decodeURIComponent(r)}"]`);const l=o;l?(l.classList.add("active"),n.value.style.top=l.offsetTop+39+"px",n.value.style.opacity="1"):(n.value.style.top="33px",n.value.style.opacity="0")}}function jl(e){let n=0;for(;e!==document.body;){if(e===null)return NaN;n+=e.offsetTop,e=e.offsetParent}return n}function Fl(e,n,t){wa.length=0;const a=[],o=[];return e.forEach(i=>{const s={...i,children:[]};let r=o[o.length-1];for(;r&&r.level>=s.level;)o.pop(),r=o[o.length-1];if(s.element.classList.contains("ignore-header")||r&&"shouldIgnore"in r){o.push({level:s.level,shouldIgnore:!0});return}s.level>t||s.level<n||(wa.push({element:s.element,link:s.link}),r?r.children.push(s):a.push(s),o.push(s))}),a}const Ul=["href","title"],Wl=U({__name:"VPDocOutlineItem",props:{headers:{},root:{type:Boolean}},setup(e){function n({target:t}){const a=t.href.split("#")[1],o=document.getElementById(decodeURIComponent(a));o==null||o.focus({preventScroll:!0})}return(t,a)=>{const o=tn("VPDocOutlineItem",!0);return f(),_("ul",{class:Q(["VPDocOutlineItem",e.root?"root":"nested"])},[(f(!0),_(Z,null,ie(e.headers,({children:i,link:s,title:r})=>(f(),_("li",null,[g("a",{class:"outline-link",href:s,onClick:n,title:r},I(r),9,Ul),i!=null&&i.length?(f(),W(o,{key:0,headers:i},null,8,["headers"])):B("",!0)]))),256))],2)}}}),qs=X(Wl,[["__scopeId","data-v-4034b050"]]),Gl={class:"content"},Hl={"aria-level":"2",class:"outline-title",id:"doc-outline-aria-label",role:"heading"},Kl=U({__name:"VPDocAsideOutline",setup(e){const{frontmatter:n,theme:t}=ne(),a=Ls([]);Et(()=>{a.value=Ua(n.value.outline??t.value.outline)});const o=ae(),i=ae();return Vl(o,i),(s,r)=>(f(),_("nav",{"aria-labelledby":"doc-outline-aria-label",class:Q(["VPDocAsideOutline",{"has-outline":a.value.length>0}]),ref_key:"container",ref:o},[g("div",Gl,[g("div",{class:"outline-marker",ref_key:"marker",ref:i},null,512),g("div",Hl,I(m(Bs)(m(t))),1),F(qs,{headers:a.value,root:!0},null,8,["headers"])])],2))}}),Yl=X(Kl,[["__scopeId","data-v-cc53f104"]]),Xl={class:"VPDocAsideCarbonAds"},Ql=U({__name:"VPDocAsideCarbonAds",props:{carbonAds:{}},setup(e){const n=()=>null;return(t,a)=>(f(),_("div",Xl,[F(m(n),{"carbon-ads":e.carbonAds},null,8,["carbon-ads"])]))}}),Jl={class:"VPDocAside"},Zl=U({__name:"VPDocAside",setup(e){const{theme:n}=ne();return(t,a)=>(f(),_("div",Jl,[C(t.$slots,"aside-top",{},void 0,!0),C(t.$slots,"aside-outline-before",{},void 0,!0),F(Yl),C(t.$slots,"aside-outline-after",{},void 0,!0),a[0]||(a[0]=g("div",{class:"spacer"},null,-1)),C(t.$slots,"aside-ads-before",{},void 0,!0),m(n).carbonAds?(f(),W(Ql,{key:0,"carbon-ads":m(n).carbonAds},null,8,["carbon-ads"])):B("",!0),C(t.$slots,"aside-ads-after",{},void 0,!0),C(t.$slots,"aside-bottom",{},void 0,!0)]))}}),ec=X(Zl,[["__scopeId","data-v-9516880d"]]);function nc(){const{theme:e,page:n}=ne();return R(()=>{const{text:t="Edit this page",pattern:a=""}=e.value.editLink||{};let o;return typeof a=="function"?o=a(n.value):o=a.replace(/:path/g,n.value.filePath),{url:o,text:t}})}function tc(){const{page:e,theme:n,frontmatter:t}=ne();return R(()=>{var c,u,p,d,h,v,b,w;const a=zs(n.value.sidebar,e.value.relativePath),o=Nl(a),i=ac(o,x=>x.link.replace(/[?#].*$/,"")),s=i.findIndex(x=>dn(e.value.relativePath,x.link)),r=((c=n.value.docFooter)==null?void 0:c.prev)===!1&&!t.value.prev||t.value.prev===!1,l=((u=n.value.docFooter)==null?void 0:u.next)===!1&&!t.value.next||t.value.next===!1;return{prev:r?void 0:{text:(typeof t.value.prev=="string"?t.value.prev:typeof t.value.prev=="object"?t.value.prev.text:void 0)??((p=i[s-1])==null?void 0:p.docFooterText)??((d=i[s-1])==null?void 0:d.text),link:(typeof t.value.prev=="object"?t.value.prev.link:void 0)??((h=i[s-1])==null?void 0:h.link)},next:l?void 0:{text:(typeof t.value.next=="string"?t.value.next:typeof t.value.next=="object"?t.value.next.text:void 0)??((v=i[s+1])==null?void 0:v.docFooterText)??((b=i[s+1])==null?void 0:b.text),link:(typeof t.value.next=="object"?t.value.next.link:void 0)??((w=i[s+1])==null?void 0:w.link)}}})}function ac(e,n){const t=new Set;return e.filter(a=>{const o=n(a);return t.has(o)?!1:t.add(o)})}const Be=U({__name:"VPLink",props:{tag:{},href:{},noIcon:{type:Boolean},target:{},rel:{}},setup(e){const n=e,t=R(()=>n.tag??(n.href?"a":"span")),a=R(()=>n.href&&$s.test(n.href)||n.target==="_blank");return(o,i)=>(f(),W(ze(t.value),{class:Q(["VPLink",{link:e.href,"vp-external-link-icon":a.value,"no-icon":e.noIcon}]),href:e.href?m(Fa)(e.href):void 0,target:e.target??(a.value?"_blank":void 0),rel:e.rel??(a.value?"noreferrer":void 0)},{default:N(()=>[C(o.$slots,"default")]),_:3},8,["class","href","target","rel"]))}}),oc={class:"VPLastUpdated"},ic=["datetime"],sc=U({__name:"VPDocFooterLastUpdated",setup(e){const{theme:n,page:t,lang:a}=ne(),o=R(()=>new Date(t.value.lastUpdated)),i=R(()=>o.value.toISOString()),s=ae("");return Oe(()=>{Ot(()=>{var r,l,c;s.value=new Intl.DateTimeFormat((l=(r=n.value.lastUpdated)==null?void 0:r.formatOptions)!=null&&l.forceLocale?a.value:void 0,((c=n.value.lastUpdated)==null?void 0:c.formatOptions)??{dateStyle:"short",timeStyle:"short"}).format(o.value)})}),(r,l)=>{var c;return f(),_("p",oc,[Ae(I(((c=m(n).lastUpdated)==null?void 0:c.text)||m(n).lastUpdatedText||"Last updated")+": ",1),g("time",{datetime:i.value},I(s.value),9,ic)])}}}),rc=X(sc,[["__scopeId","data-v-3607c463"]]),lc={key:0,class:"VPDocFooter"},cc={key:0,class:"edit-info"},dc={key:0,class:"edit-link"},uc={key:1,class:"last-updated"},hc={key:1,class:"prev-next","aria-labelledby":"doc-footer-aria-label"},gc={class:"pager"},pc=["innerHTML"],mc=["innerHTML"],fc={class:"pager"},vc=["innerHTML"],bc=["innerHTML"],yc=U({__name:"VPDocFooter",setup(e){const{theme:n,page:t,frontmatter:a}=ne(),o=nc(),i=tc(),s=R(()=>n.value.editLink&&a.value.editLink!==!1),r=R(()=>t.value.lastUpdated),l=R(()=>s.value||r.value||i.value.prev||i.value.next);return(c,u)=>{var p,d,h,v;return l.value?(f(),_("footer",lc,[C(c.$slots,"doc-footer-before",{},void 0,!0),s.value||r.value?(f(),_("div",cc,[s.value?(f(),_("div",dc,[F(Be,{class:"edit-link-button",href:m(o).url,"no-icon":!0},{default:N(()=>[u[0]||(u[0]=g("span",{class:"vpi-square-pen edit-link-icon"},null,-1)),Ae(" "+I(m(o).text),1)]),_:1},8,["href"])])):B("",!0),r.value?(f(),_("div",uc,[F(rc)])):B("",!0)])):B("",!0),(p=m(i).prev)!=null&&p.link||(d=m(i).next)!=null&&d.link?(f(),_("nav",hc,[u[1]||(u[1]=g("span",{class:"visually-hidden",id:"doc-footer-aria-label"},"Pager",-1)),g("div",gc,[(h=m(i).prev)!=null&&h.link?(f(),W(Be,{key:0,class:"pager-link prev",href:m(i).prev.link},{default:N(()=>{var b;return[g("span",{class:"desc",innerHTML:((b=m(n).docFooter)==null?void 0:b.prev)||"Previous page"},null,8,pc),g("span",{class:"title",innerHTML:m(i).prev.text},null,8,mc)]}),_:1},8,["href"])):B("",!0)]),g("div",fc,[(v=m(i).next)!=null&&v.link?(f(),W(Be,{key:0,class:"pager-link next",href:m(i).next.link},{default:N(()=>{var b;return[g("span",{class:"desc",innerHTML:((b=m(n).docFooter)==null?void 0:b.next)||"Next page"},null,8,vc),g("span",{class:"title",innerHTML:m(i).next.text},null,8,bc)]}),_:1},8,["href"])):B("",!0)])])):B("",!0)])):B("",!0)}}}),wc=X(yc,[["__scopeId","data-v-cd0721dd"]]),_c={class:"container"},kc={class:"aside-container"},xc={class:"aside-content"},Ac={class:"content"},Cc={class:"content-container"},Tc={class:"main"},Ic=U({__name:"VPDoc",setup(e){const{theme:n}=ne(),t=mn(),{hasSidebar:a,hasAside:o,leftAside:i}=Qe(),s=R(()=>t.path.replace(/[./]+/g,"_").replace(/_html$/,""));return(r,l)=>{const c=tn("Content");return f(),_("div",{class:Q(["VPDoc",{"has-sidebar":m(a),"has-aside":m(o)}])},[C(r.$slots,"doc-top",{},void 0,!0),g("div",_c,[m(o)?(f(),_("div",{key:0,class:Q(["aside",{"left-aside":m(i)}])},[l[0]||(l[0]=g("div",{class:"aside-curtain"},null,-1)),g("div",kc,[g("div",xc,[F(ec,null,{"aside-top":N(()=>[C(r.$slots,"aside-top",{},void 0,!0)]),"aside-bottom":N(()=>[C(r.$slots,"aside-bottom",{},void 0,!0)]),"aside-outline-before":N(()=>[C(r.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":N(()=>[C(r.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":N(()=>[C(r.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":N(()=>[C(r.$slots,"aside-ads-after",{},void 0,!0)]),_:3})])])],2)):B("",!0),g("div",Ac,[g("div",Cc,[C(r.$slots,"doc-before",{},void 0,!0),g("main",Tc,[F(c,{class:Q(["vp-doc",[s.value,m(n).externalLinkIcon&&"external-link-icon-enabled"]])},null,8,["class"])]),F(wc,null,{"doc-footer-before":N(()=>[C(r.$slots,"doc-footer-before",{},void 0,!0)]),_:3}),C(r.$slots,"doc-after",{},void 0,!0)])])]),C(r.$slots,"doc-bottom",{},void 0,!0)],2)}}}),Sc=X(Ic,[["__scopeId","data-v-f640936e"]]),Dc=U({__name:"VPButton",props:{tag:{},size:{default:"medium"},theme:{default:"brand"},text:{},href:{},target:{},rel:{}},setup(e){const n=e,t=R(()=>n.href&&$s.test(n.href)),a=R(()=>n.tag||(n.href?"a":"button"));return(o,i)=>(f(),W(ze(a.value),{class:Q(["VPButton",[e.size,e.theme]]),href:e.href?m(Fa)(e.href):void 0,target:n.target??(t.value?"_blank":void 0),rel:n.rel??(t.value?"noreferrer":void 0)},{default:N(()=>[Ae(I(e.text),1)]),_:1},8,["class","href","target","rel"]))}}),Pc=X(Dc,[["__scopeId","data-v-baf7dc9c"]]),Mc=["src","alt"],Lc=U({inheritAttrs:!1,__name:"VPImage",props:{image:{},alt:{}},setup(e){return(n,t)=>{const a=tn("VPImage",!0);return e.image?(f(),_(Z,{key:0},[typeof e.image=="string"||"src"in e.image?(f(),_("img",en({key:0,class:"VPImage"},typeof e.image=="string"?n.$attrs:{...e.image,...n.$attrs},{src:m(Ra)(typeof e.image=="string"?e.image:e.image.src),alt:e.alt??(typeof e.image=="string"?"":e.image.alt||"")}),null,16,Mc)):(f(),_(Z,{key:1},[F(a,en({class:"dark",image:e.image.dark,alt:e.image.alt},n.$attrs),null,16,["image","alt"]),F(a,en({class:"light",image:e.image.light,alt:e.image.alt},n.$attrs),null,16,["image","alt"])],64))],64)):B("",!0)}}}),gt=X(Lc,[["__scopeId","data-v-f9c85911"]]),$c={class:"container"},Nc={class:"main"},Oc={class:"heading"},Ec=["innerHTML"],Rc=["innerHTML"],zc=["innerHTML"],Bc={key:0,class:"actions"},qc={key:0,class:"image"},Vc={class:"image-container"},jc=U({__name:"VPHero",props:{name:{},text:{},tagline:{},image:{},actions:{}},setup(e){const n=Rt("hero-image-slot-exists");return(t,a)=>(f(),_("div",{class:Q(["VPHero",{"has-image":e.image||m(n)}])},[g("div",$c,[g("div",Nc,[C(t.$slots,"home-hero-info-before",{},void 0,!0),C(t.$slots,"home-hero-info",{},()=>[g("h1",Oc,[e.name?(f(),_("span",{key:0,innerHTML:e.name,class:"name clip"},null,8,Ec)):B("",!0),e.text?(f(),_("span",{key:1,innerHTML:e.text,class:"text"},null,8,Rc)):B("",!0)]),e.tagline?(f(),_("p",{key:0,innerHTML:e.tagline,class:"tagline"},null,8,zc)):B("",!0)],!0),C(t.$slots,"home-hero-info-after",{},void 0,!0),e.actions?(f(),_("div",Bc,[(f(!0),_(Z,null,ie(e.actions,o=>(f(),_("div",{key:o.link,class:"action"},[F(Pc,{tag:"a",size:"medium",theme:o.theme,text:o.text,href:o.link,target:o.target,rel:o.rel},null,8,["theme","text","href","target","rel"])]))),128))])):B("",!0),C(t.$slots,"home-hero-actions-after",{},void 0,!0)]),e.image||m(n)?(f(),_("div",qc,[g("div",Vc,[a[0]||(a[0]=g("div",{class:"image-bg"},null,-1)),C(t.$slots,"home-hero-image",{},()=>[e.image?(f(),W(gt,{key:0,class:"image-src",image:e.image},null,8,["image"])):B("",!0)],!0)])])):B("",!0)])],2))}}),Fc=X(jc,[["__scopeId","data-v-09b6ce43"]]),Uc=U({__name:"VPHomeHero",setup(e){const{frontmatter:n}=ne();return(t,a)=>m(n).hero?(f(),W(Fc,{key:0,class:"VPHomeHero",name:m(n).hero.name,text:m(n).hero.text,tagline:m(n).hero.tagline,image:m(n).hero.image,actions:m(n).hero.actions},{"home-hero-info-before":N(()=>[C(t.$slots,"home-hero-info-before")]),"home-hero-info":N(()=>[C(t.$slots,"home-hero-info")]),"home-hero-info-after":N(()=>[C(t.$slots,"home-hero-info-after")]),"home-hero-actions-after":N(()=>[C(t.$slots,"home-hero-actions-after")]),"home-hero-image":N(()=>[C(t.$slots,"home-hero-image")]),_:3},8,["name","text","tagline","image","actions"])):B("",!0)}}),Wc={class:"box"},Gc={key:0,class:"icon"},Hc=["innerHTML"],Kc=["innerHTML"],Yc=["innerHTML"],Xc={key:4,class:"link-text"},Qc={class:"link-text-value"},Jc=U({__name:"VPFeature",props:{icon:{},title:{},details:{},link:{},linkText:{},rel:{},target:{}},setup(e){return(n,t)=>(f(),W(Be,{class:"VPFeature",href:e.link,rel:e.rel,target:e.target,"no-icon":!0,tag:e.link?"a":"div"},{default:N(()=>[g("article",Wc,[typeof e.icon=="object"&&e.icon.wrap?(f(),_("div",Gc,[F(gt,{image:e.icon,alt:e.icon.alt,height:e.icon.height||48,width:e.icon.width||48},null,8,["image","alt","height","width"])])):typeof e.icon=="object"?(f(),W(gt,{key:1,image:e.icon,alt:e.icon.alt,height:e.icon.height||48,width:e.icon.width||48},null,8,["image","alt","height","width"])):e.icon?(f(),_("div",{key:2,class:"icon",innerHTML:e.icon},null,8,Hc)):B("",!0),g("h2",{class:"title",innerHTML:e.title},null,8,Kc),e.details?(f(),_("p",{key:3,class:"details",innerHTML:e.details},null,8,Yc)):B("",!0),e.linkText?(f(),_("div",Xc,[g("p",Qc,[Ae(I(e.linkText)+" ",1),t[0]||(t[0]=g("span",{class:"vpi-arrow-right link-text-icon"},null,-1))])])):B("",!0)])]),_:1},8,["href","rel","target","tag"]))}}),Zc=X(Jc,[["__scopeId","data-v-67e0b8b6"]]),ed={key:0,class:"VPFeatures"},nd={class:"container"},td={class:"items"},ad=U({__name:"VPFeatures",props:{features:{}},setup(e){const n=e,t=R(()=>{const a=n.features.length;if(a){if(a===2)return"grid-2";if(a===3)return"grid-3";if(a%3===0)return"grid-6";if(a>3)return"grid-4"}else return});return(a,o)=>e.features?(f(),_("div",ed,[g("div",nd,[g("div",td,[(f(!0),_(Z,null,ie(e.features,i=>(f(),_("div",{key:i.title,class:Q(["item",[t.value]])},[F(Zc,{icon:i.icon,title:i.title,details:i.details,link:i.link,"link-text":i.linkText,rel:i.rel,target:i.target},null,8,["icon","title","details","link","link-text","rel","target"])],2))),128))])])])):B("",!0)}}),od=X(ad,[["__scopeId","data-v-f6b1b269"]]),id=U({__name:"VPHomeFeatures",setup(e){const{frontmatter:n}=ne();return(t,a)=>m(n).features?(f(),W(od,{key:0,class:"VPHomeFeatures",features:m(n).features},null,8,["features"])):B("",!0)}}),sd=U({__name:"VPHomeContent",setup(e){const{width:n}=ul({initialWidth:0,includeScrollbar:!1});return(t,a)=>(f(),_("div",{class:"vp-doc container",style:qa(m(n)?{"--vp-offset":`calc(50% - ${m(n)/2}px)`}:{})},[C(t.$slots,"default",{},void 0,!0)],4))}}),rd=X(sd,[["__scopeId","data-v-3be093fb"]]),ld=U({__name:"VPHome",setup(e){const{frontmatter:n,theme:t}=ne();return(a,o)=>{const i=tn("Content");return f(),_("div",{class:Q(["VPHome",{"external-link-icon-enabled":m(t).externalLinkIcon}])},[C(a.$slots,"home-hero-before",{},void 0,!0),F(Uc,null,{"home-hero-info-before":N(()=>[C(a.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":N(()=>[C(a.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":N(()=>[C(a.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":N(()=>[C(a.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":N(()=>[C(a.$slots,"home-hero-image",{},void 0,!0)]),_:3}),C(a.$slots,"home-hero-after",{},void 0,!0),C(a.$slots,"home-features-before",{},void 0,!0),F(id),C(a.$slots,"home-features-after",{},void 0,!0),m(n).markdownStyles!==!1?(f(),W(rd,{key:0},{default:N(()=>[F(i)]),_:1})):(f(),W(i,{key:1}))],2)}}}),cd=X(ld,[["__scopeId","data-v-6e6fdb32"]]),dd={},ud={class:"VPPage"};function hd(e,n){const t=tn("Content");return f(),_("div",ud,[C(e.$slots,"page-top"),F(t),C(e.$slots,"page-bottom")])}const gd=X(dd,[["render",hd]]),pd=U({__name:"VPContent",setup(e){const{page:n,frontmatter:t}=ne(),{hasSidebar:a}=Qe();return(o,i)=>(f(),_("div",{class:Q(["VPContent",{"has-sidebar":m(a),"is-home":m(t).layout==="home"}]),id:"VPContent"},[m(n).isNotFound?C(o.$slots,"not-found",{key:0},()=>[F(Ll)],!0):m(t).layout==="page"?(f(),W(gd,{key:1},{"page-top":N(()=>[C(o.$slots,"page-top",{},void 0,!0)]),"page-bottom":N(()=>[C(o.$slots,"page-bottom",{},void 0,!0)]),_:3})):m(t).layout==="home"?(f(),W(cd,{key:2},{"home-hero-before":N(()=>[C(o.$slots,"home-hero-before",{},void 0,!0)]),"home-hero-info-before":N(()=>[C(o.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":N(()=>[C(o.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":N(()=>[C(o.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":N(()=>[C(o.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":N(()=>[C(o.$slots,"home-hero-image",{},void 0,!0)]),"home-hero-after":N(()=>[C(o.$slots,"home-hero-after",{},void 0,!0)]),"home-features-before":N(()=>[C(o.$slots,"home-features-before",{},void 0,!0)]),"home-features-after":N(()=>[C(o.$slots,"home-features-after",{},void 0,!0)]),_:3})):m(t).layout&&m(t).layout!=="doc"?(f(),W(ze(m(t).layout),{key:3})):(f(),W(Sc,{key:4},{"doc-top":N(()=>[C(o.$slots,"doc-top",{},void 0,!0)]),"doc-bottom":N(()=>[C(o.$slots,"doc-bottom",{},void 0,!0)]),"doc-footer-before":N(()=>[C(o.$slots,"doc-footer-before",{},void 0,!0)]),"doc-before":N(()=>[C(o.$slots,"doc-before",{},void 0,!0)]),"doc-after":N(()=>[C(o.$slots,"doc-after",{},void 0,!0)]),"aside-top":N(()=>[C(o.$slots,"aside-top",{},void 0,!0)]),"aside-outline-before":N(()=>[C(o.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":N(()=>[C(o.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":N(()=>[C(o.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":N(()=>[C(o.$slots,"aside-ads-after",{},void 0,!0)]),"aside-bottom":N(()=>[C(o.$slots,"aside-bottom",{},void 0,!0)]),_:3}))],2))}}),md=X(pd,[["__scopeId","data-v-714062c7"]]),fd={class:"container"},vd=["innerHTML"],bd=["innerHTML"],yd=U({__name:"VPFooter",setup(e){const{theme:n,frontmatter:t}=ne(),{hasSidebar:a}=Qe();return(o,i)=>m(n).footer&&m(t).footer!==!1?(f(),_("footer",{key:0,class:Q(["VPFooter",{"has-sidebar":m(a)}])},[g("div",fd,[m(n).footer.message?(f(),_("p",{key:0,class:"message",innerHTML:m(n).footer.message},null,8,vd)):B("",!0),m(n).footer.copyright?(f(),_("p",{key:1,class:"copyright",innerHTML:m(n).footer.copyright},null,8,bd)):B("",!0)])],2)):B("",!0)}}),wd=X(yd,[["__scopeId","data-v-a0954f24"]]);function _d(){const{theme:e,frontmatter:n}=ne(),t=Ls([]),a=R(()=>t.value.length>0);return Et(()=>{t.value=Ua(n.value.outline??e.value.outline)}),{headers:t,hasLocalNav:a}}const kd={class:"menu-text"},xd={class:"header"},Ad={class:"outline"},Cd=U({__name:"VPLocalNavOutlineDropdown",props:{headers:{},navHeight:{}},setup(e){const n=e,{theme:t}=ne(),a=ae(!1),o=ae(0),i=ae(),s=ae();function r(p){var d;(d=i.value)!=null&&d.contains(p.target)||(a.value=!1)}Me(a,p=>{if(p){document.addEventListener("click",r);return}document.removeEventListener("click",r)}),va("Escape",()=>{a.value=!1}),Et(()=>{a.value=!1});function l(){a.value=!a.value,o.value=window.innerHeight+Math.min(window.scrollY-n.navHeight,0)}function c(p){p.target.classList.contains("outline-link")&&(s.value&&(s.value.style.transition="none"),Va(()=>{a.value=!1}))}function u(){a.value=!1,window.scrollTo({top:0,left:0,behavior:"smooth"})}return(p,d)=>(f(),_("div",{class:"VPLocalNavOutlineDropdown",style:qa({"--vp-vh":o.value+"px"}),ref_key:"main",ref:i},[e.headers.length>0?(f(),_("button",{key:0,onClick:l,class:Q({open:a.value})},[g("span",kd,I(m(Bs)(m(t))),1),d[0]||(d[0]=g("span",{class:"vpi-chevron-right icon"},null,-1))],2)):(f(),_("button",{key:1,onClick:u},I(m(t).returnToTopLabel||"Return to top"),1)),F(Ea,{name:"flyout"},{default:N(()=>[a.value?(f(),_("div",{key:0,ref_key:"items",ref:s,class:"items",onClick:c},[g("div",xd,[g("a",{class:"top-link",href:"#",onClick:u},I(m(t).returnToTopLabel||"Return to top"),1)]),g("div",Ad,[F(qs,{headers:e.headers},null,8,["headers"])])],512)):B("",!0)]),_:1})],4))}}),Td=X(Cd,[["__scopeId","data-v-f210c2f8"]]),Id={class:"container"},Sd=["aria-expanded"],Dd={class:"menu-text"},Pd=U({__name:"VPLocalNav",props:{open:{type:Boolean}},emits:["open-menu"],setup(e){const{theme:n,frontmatter:t}=ne(),{hasSidebar:a}=Qe(),{headers:o}=_d(),{y:i}=Ns(),s=ae(0);Oe(()=>{s.value=parseInt(getComputedStyle(document.documentElement).getPropertyValue("--vp-nav-height"))}),Et(()=>{o.value=Ua(t.value.outline??n.value.outline)});const r=R(()=>o.value.length===0),l=R(()=>r.value&&!a.value),c=R(()=>({VPLocalNav:!0,"has-sidebar":a.value,empty:r.value,fixed:l.value}));return(u,p)=>m(t).layout!=="home"&&(!l.value||m(i)>=s.value)?(f(),_("div",{key:0,class:Q(c.value)},[g("div",Id,[m(a)?(f(),_("button",{key:0,class:"menu","aria-expanded":e.open,"aria-controls":"VPSidebarNav",onClick:p[0]||(p[0]=d=>u.$emit("open-menu"))},[p[1]||(p[1]=g("span",{class:"vpi-align-left menu-icon"},null,-1)),g("span",Dd,I(m(n).sidebarMenuLabel||"Menu"),1)],8,Sd)):B("",!0),F(Td,{headers:m(o),navHeight:s.value},null,8,["headers","navHeight"])])],2)):B("",!0)}}),Md=X(Pd,[["__scopeId","data-v-f8cca058"]]);function Ld(){const e=ae(!1);function n(){e.value=!0,window.addEventListener("resize",o)}function t(){e.value=!1,window.removeEventListener("resize",o)}function a(){e.value?t():n()}function o(){window.outerWidth>=768&&t()}const i=mn();return Me(()=>i.path,t),{isScreenOpen:e,openScreen:n,closeScreen:t,toggleScreen:a}}const $d={},Nd={class:"VPSwitch",type:"button",role:"switch"},Od={class:"check"},Ed={key:0,class:"icon"};function Rd(e,n){return f(),_("button",Nd,[g("span",Od,[e.$slots.default?(f(),_("span",Ed,[C(e.$slots,"default",{},void 0,!0)])):B("",!0)])])}const zd=X($d,[["render",Rd],["__scopeId","data-v-71e7f96a"]]),Bd=U({__name:"VPSwitchAppearance",setup(e){const{isDark:n,theme:t}=ne(),a=Rt("toggle-appearance",()=>{n.value=!n.value}),o=ae("");return Ba(()=>{o.value=n.value?t.value.lightModeSwitchTitle||"Switch to light theme":t.value.darkModeSwitchTitle||"Switch to dark theme"}),(i,s)=>(f(),W(zd,{title:o.value,class:"VPSwitchAppearance","aria-checked":m(n),onClick:m(a)},{default:N(()=>[...s[0]||(s[0]=[g("span",{class:"vpi-sun sun"},null,-1),g("span",{class:"vpi-moon moon"},null,-1)])]),_:1},8,["title","aria-checked","onClick"]))}}),Wa=X(Bd,[["__scopeId","data-v-40158760"]]),qd={key:0,class:"VPNavBarAppearance"},Vd=U({__name:"VPNavBarAppearance",setup(e){const{site:n}=ne();return(t,a)=>m(n).appearance&&m(n).appearance!=="force-dark"&&m(n).appearance!=="force-auto"?(f(),_("div",qd,[F(Wa)])):B("",!0)}}),jd=X(Vd,[["__scopeId","data-v-e3e8a76b"]]),Ga=ae();let Vs=!1,ea=0;function Fd(e){const n=ae(!1);if(zt){!Vs&&Ud(),ea++;const t=Me(Ga,a=>{var o,i,s;a===e.el.value||(o=e.el.value)!=null&&o.contains(a)?(n.value=!0,(i=e.onFocus)==null||i.call(e)):(n.value=!1,(s=e.onBlur)==null||s.call(e))});za(()=>{t(),ea--,ea||Wd()})}return hl(n)}function Ud(){document.addEventListener("focusin",js),Vs=!0,Ga.value=document.activeElement}function Wd(){document.removeEventListener("focusin",js)}function js(){Ga.value=document.activeElement}const Gd={class:"VPMenuLink"},Hd=["innerHTML"],Kd=U({__name:"VPMenuLink",props:{item:{}},setup(e){const{page:n}=ne();return(t,a)=>(f(),_("div",Gd,[F(Be,{class:Q({active:m(dn)(m(n).relativePath,e.item.activeMatch||e.item.link,!!e.item.activeMatch)}),href:e.item.link,target:e.item.target,rel:e.item.rel,"no-icon":e.item.noIcon},{default:N(()=>[g("span",{innerHTML:e.item.text},null,8,Hd)]),_:1},8,["class","href","target","rel","no-icon"])]))}}),Bt=X(Kd,[["__scopeId","data-v-9182bc9d"]]),Yd={class:"VPMenuGroup"},Xd={key:0,class:"title"},Qd=U({__name:"VPMenuGroup",props:{text:{},items:{}},setup(e){return(n,t)=>(f(),_("div",Yd,[e.text?(f(),_("p",Xd,I(e.text),1)):B("",!0),(f(!0),_(Z,null,ie(e.items,a=>(f(),_(Z,null,["link"in a?(f(),W(Bt,{key:0,item:a},null,8,["item"])):B("",!0)],64))),256))]))}}),Jd=X(Qd,[["__scopeId","data-v-a0052f3d"]]),Zd={class:"VPMenu"},eu={key:0,class:"items"},nu=U({__name:"VPMenu",props:{items:{}},setup(e){return(n,t)=>(f(),_("div",Zd,[e.items?(f(),_("div",eu,[(f(!0),_(Z,null,ie(e.items,a=>(f(),_(Z,{key:JSON.stringify(a)},["link"in a?(f(),W(Bt,{key:0,item:a},null,8,["item"])):"component"in a?(f(),W(ze(a.component),en({key:1,ref_for:!0},a.props),null,16)):(f(),W(Jd,{key:2,text:a.text,items:a.items},null,8,["text","items"]))],64))),128))])):B("",!0),C(n.$slots,"default",{},void 0,!0)]))}}),tu=X(nu,[["__scopeId","data-v-6ac81520"]]),au=["aria-expanded","aria-label"],ou={key:0,class:"text"},iu=["innerHTML"],su={key:1,class:"vpi-more-horizontal icon"},ru={class:"menu"},lu=U({__name:"VPFlyout",props:{icon:{},button:{},label:{},items:{}},setup(e){const n=ae(!1),t=ae();Fd({el:t,onBlur:a});function a(){n.value=!1}return(o,i)=>(f(),_("div",{class:"VPFlyout",ref_key:"el",ref:t,onMouseenter:i[1]||(i[1]=s=>n.value=!0),onMouseleave:i[2]||(i[2]=s=>n.value=!1)},[g("button",{type:"button",class:"button","aria-haspopup":"true","aria-expanded":n.value,"aria-label":e.label,onClick:i[0]||(i[0]=s=>n.value=!n.value)},[e.button||e.icon?(f(),_("span",ou,[e.icon?(f(),_("span",{key:0,class:Q([e.icon,"option-icon"])},null,2)):B("",!0),e.button?(f(),_("span",{key:1,innerHTML:e.button},null,8,iu)):B("",!0),i[3]||(i[3]=g("span",{class:"vpi-chevron-down text-icon"},null,-1))])):(f(),_("span",su))],8,au),g("div",ru,[F(tu,{items:e.items},{default:N(()=>[C(o.$slots,"default",{},void 0,!0)]),_:3},8,["items"])])],544))}}),Ha=X(lu,[["__scopeId","data-v-beb8b8d5"]]),cu=["href","aria-label","innerHTML"],du=U({__name:"VPSocialLink",props:{icon:{},link:{},ariaLabel:{}},setup(e){const n=e,t=ae();Oe(async()=>{var i;await Va();const o=(i=t.value)==null?void 0:i.children[0];o instanceof HTMLElement&&o.className.startsWith("vpi-social-")&&(getComputedStyle(o).maskImage||getComputedStyle(o).webkitMaskImage)==="none"&&o.style.setProperty("--icon",`url('https://api.iconify.design/simple-icons/${n.icon}.svg')`)});const a=R(()=>typeof n.icon=="object"?n.icon.svg:`<span class="vpi-social-${n.icon}"></span>`);return(o,i)=>(f(),_("a",{ref_key:"el",ref:t,class:"VPSocialLink no-icon",href:e.link,"aria-label":e.ariaLabel??(typeof e.icon=="string"?e.icon:""),target:"_blank",rel:"noopener",innerHTML:a.value},null,8,cu))}}),uu=X(du,[["__scopeId","data-v-7652e684"]]),hu={class:"VPSocialLinks"},gu=U({__name:"VPSocialLinks",props:{links:{}},setup(e){return(n,t)=>(f(),_("div",hu,[(f(!0),_(Z,null,ie(e.links,({link:a,icon:o,ariaLabel:i})=>(f(),W(uu,{key:a,icon:o,link:a,ariaLabel:i},null,8,["icon","link","ariaLabel"]))),128))]))}}),Ka=X(gu,[["__scopeId","data-v-54791c74"]]),pu={key:0,class:"group translations"},mu={class:"trans-title"},fu={key:1,class:"group"},vu={class:"item appearance"},bu={class:"label"},yu={class:"appearance-action"},wu={key:2,class:"group"},_u={class:"item social-links"},ku=U({__name:"VPNavBarExtra",setup(e){const{site:n,theme:t}=ne(),{localeLinks:a,currentLang:o}=Yn({correspondingLink:!0}),i=R(()=>a.value.length&&o.value.label||n.value.appearance||t.value.socialLinks);return(s,r)=>i.value?(f(),W(Ha,{key:0,class:"VPNavBarExtra",label:"extra navigation"},{default:N(()=>[m(a).length&&m(o).label?(f(),_("div",pu,[g("p",mu,I(m(o).label),1),(f(!0),_(Z,null,ie(m(a),l=>(f(),W(Bt,{key:l.link,item:l},null,8,["item"]))),128))])):B("",!0),m(n).appearance&&m(n).appearance!=="force-dark"&&m(n).appearance!=="force-auto"?(f(),_("div",fu,[g("div",vu,[g("p",bu,I(m(t).darkModeSwitchLabel||"Appearance"),1),g("div",yu,[F(Wa)])])])):B("",!0),m(t).socialLinks?(f(),_("div",wu,[g("div",_u,[F(Ka,{class:"social-links-list",links:m(t).socialLinks},null,8,["links"])])])):B("",!0)]),_:1})):B("",!0)}}),xu=X(ku,[["__scopeId","data-v-ad50955e"]]),Au=["aria-expanded"],Cu=U({__name:"VPNavBarHamburger",props:{active:{type:Boolean}},emits:["click"],setup(e){return(n,t)=>(f(),_("button",{type:"button",class:Q(["VPNavBarHamburger",{active:e.active}]),"aria-label":"mobile navigation","aria-expanded":e.active,"aria-controls":"VPNavScreen",onClick:t[0]||(t[0]=a=>n.$emit("click"))},[...t[1]||(t[1]=[g("span",{class:"container"},[g("span",{class:"top"}),g("span",{class:"middle"}),g("span",{class:"bottom"})],-1)])],10,Au))}}),Tu=X(Cu,[["__scopeId","data-v-5e4fa142"]]),Iu=["innerHTML"],Su=U({__name:"VPNavBarMenuLink",props:{item:{}},setup(e){const{page:n}=ne();return(t,a)=>(f(),W(Be,{class:Q({VPNavBarMenuLink:!0,active:m(dn)(m(n).relativePath,e.item.activeMatch||e.item.link,!!e.item.activeMatch)}),href:e.item.link,target:e.item.target,rel:e.item.rel,"no-icon":e.item.noIcon,tabindex:"0"},{default:N(()=>[g("span",{innerHTML:e.item.text},null,8,Iu)]),_:1},8,["class","href","target","rel","no-icon"]))}}),Du=X(Su,[["__scopeId","data-v-f75fdd7c"]]),Pu=U({__name:"VPNavBarMenuGroup",props:{item:{}},setup(e){const n=e,{page:t}=ne(),a=i=>"component"in i?!1:"link"in i?dn(t.value.relativePath,i.link,!!n.item.activeMatch):i.items.some(a),o=R(()=>a(n.item));return(i,s)=>(f(),W(Ha,{class:Q({VPNavBarMenuGroup:!0,active:m(dn)(m(t).relativePath,e.item.activeMatch,!!e.item.activeMatch)||o.value}),button:e.item.text,items:e.item.items},null,8,["class","button","items"]))}}),Mu={key:0,"aria-labelledby":"main-nav-aria-label",class:"VPNavBarMenu"},Lu=U({__name:"VPNavBarMenu",setup(e){const{theme:n}=ne();return(t,a)=>m(n).nav?(f(),_("nav",Mu,[a[0]||(a[0]=g("span",{id:"main-nav-aria-label",class:"visually-hidden"}," Main Navigation ",-1)),(f(!0),_(Z,null,ie(m(n).nav,o=>(f(),_(Z,{key:JSON.stringify(o)},["link"in o?(f(),W(Du,{key:0,item:o},null,8,["item"])):"component"in o?(f(),W(ze(o.component),en({key:1,ref_for:!0},o.props),null,16)):(f(),W(Pu,{key:2,item:o},null,8,["item"]))],64))),128))])):B("",!0)}}),$u=X(Lu,[["__scopeId","data-v-e90f0632"]]);function Nu(e){const{localeIndex:n,theme:t}=ne();function a(o){var v,b,w;const i=o.split("."),s=(v=t.value.search)==null?void 0:v.options,r=s&&typeof s=="object",l=r&&((w=(b=s.locales)==null?void 0:b[n.value])==null?void 0:w.translations)||null,c=r&&s.translations||null;let u=l,p=c,d=e;const h=i.pop();for(const x of i){let A=null;const M=d==null?void 0:d[x];M&&(A=d=M);const y=p==null?void 0:p[x];y&&(A=p=y);const T=u==null?void 0:u[x];T&&(A=u=T),M||(d=A),y||(p=A),T||(u=A)}return(u==null?void 0:u[h])??(p==null?void 0:p[h])??(d==null?void 0:d[h])??""}return a}const Ou=["aria-label"],Eu={class:"DocSearch-Button-Container"},Ru={class:"DocSearch-Button-Placeholder"},Ei=U({__name:"VPNavBarSearchButton",setup(e){const t=Nu({button:{buttonText:"Search",buttonAriaLabel:"Search"}});return(a,o)=>(f(),_("button",{type:"button",class:"DocSearch DocSearch-Button","aria-label":m(t)("button.buttonAriaLabel")},[g("span",Eu,[o[0]||(o[0]=g("span",{class:"vp-icon DocSearch-Search-Icon"},null,-1)),g("span",Ru,I(m(t)("button.buttonText")),1)]),o[1]||(o[1]=g("span",{class:"DocSearch-Button-Keys"},[g("kbd",{class:"DocSearch-Button-Key"}),g("kbd",{class:"DocSearch-Button-Key"},"K")],-1))],8,Ou))}}),zu={class:"VPNavBarSearch"},Bu={id:"local-search"},qu={key:1,id:"docsearch"},Ya=U({__name:"VPNavBarSearch",setup(e){const n=gl(()=>Os(()=>import("./VPLocalSearchBox.C96znhMa.js"),__vite__mapDeps([0,1]))),t=()=>null,{theme:a}=ne(),o=ae(!1),i=ae(!1);Oe(()=>{});function s(){o.value||(o.value=!0,setTimeout(r,16))}function r(){const p=new Event("keydown");p.key="k",p.metaKey=!0,window.dispatchEvent(p),setTimeout(()=>{document.querySelector(".DocSearch-Modal")||r()},16)}function l(p){const d=p.target,h=d.tagName;return d.isContentEditable||h==="INPUT"||h==="SELECT"||h==="TEXTAREA"}const c=ae(!1);va("k",p=>{(p.ctrlKey||p.metaKey)&&(p.preventDefault(),c.value=!0)}),va("/",p=>{l(p)||(p.preventDefault(),c.value=!0)});const u="local";return(p,d)=>{var h;return f(),_("div",zu,[m(u)==="local"?(f(),_(Z,{key:0},[c.value?(f(),W(m(n),{key:0,onClose:d[0]||(d[0]=v=>c.value=!1)})):B("",!0),g("div",Bu,[F(Ei,{onClick:d[1]||(d[1]=v=>c.value=!0)})])],64)):m(u)==="algolia"?(f(),_(Z,{key:1},[o.value?(f(),W(m(t),{key:0,algolia:((h=m(a).search)==null?void 0:h.options)??m(a).algolia,onVnodeBeforeMount:d[2]||(d[2]=v=>i.value=!0)},null,8,["algolia"])):B("",!0),i.value?B("",!0):(f(),_("div",qu,[F(Ei,{onClick:s})]))],64)):B("",!0)])}}}),Vu=U({__name:"VPNavBarSocialLinks",setup(e){const{theme:n}=ne();return(t,a)=>m(n).socialLinks?(f(),W(Ka,{key:0,class:"VPNavBarSocialLinks",links:m(n).socialLinks},null,8,["links"])):B("",!0)}}),ju=X(Vu,[["__scopeId","data-v-27e2b2b1"]]),Fu=["href","rel","target"],Uu=["innerHTML"],Wu={key:2},Gu=U({__name:"VPNavBarTitle",setup(e){const{site:n,theme:t}=ne(),{hasSidebar:a}=Qe(),{currentLang:o}=Yn(),i=R(()=>{var l;return typeof t.value.logoLink=="string"?t.value.logoLink:(l=t.value.logoLink)==null?void 0:l.link}),s=R(()=>{var l;return typeof t.value.logoLink=="string"||(l=t.value.logoLink)==null?void 0:l.rel}),r=R(()=>{var l;return typeof t.value.logoLink=="string"||(l=t.value.logoLink)==null?void 0:l.target});return(l,c)=>(f(),_("div",{class:Q(["VPNavBarTitle",{"has-sidebar":m(a)}])},[g("a",{class:"title",href:i.value??m(Fa)(m(o).link),rel:s.value,target:r.value},[C(l.$slots,"nav-bar-title-before",{},void 0,!0),m(t).logo?(f(),W(gt,{key:0,class:"logo",image:m(t).logo},null,8,["image"])):B("",!0),m(t).siteTitle?(f(),_("span",{key:1,innerHTML:m(t).siteTitle},null,8,Uu)):m(t).siteTitle===void 0?(f(),_("span",Wu,I(m(n).title),1)):B("",!0),C(l.$slots,"nav-bar-title-after",{},void 0,!0)],8,Fu)],2))}}),Hu=X(Gu,[["__scopeId","data-v-6ec1a2fc"]]),Ku={class:"items"},Yu={class:"title"},Xu=U({__name:"VPNavBarTranslations",setup(e){const{theme:n}=ne(),{localeLinks:t,currentLang:a}=Yn({correspondingLink:!0});return(o,i)=>m(t).length&&m(a).label?(f(),W(Ha,{key:0,class:"VPNavBarTranslations",icon:"vpi-languages",label:m(n).langMenuLabel||"Change language"},{default:N(()=>[g("div",Ku,[g("p",Yu,I(m(a).label),1),(f(!0),_(Z,null,ie(m(t),s=>(f(),W(Bt,{key:s.link,item:s},null,8,["item"]))),128))])]),_:1},8,["label"])):B("",!0)}}),Fs=X(Xu,[["__scopeId","data-v-40afd59f"]]),Qu={class:"wrapper"},Ju={class:"container"},Zu={class:"title"},eh={class:"content"},nh={class:"content-body"},th=U({__name:"VPNavBar",props:{isScreenOpen:{type:Boolean}},emits:["toggle-screen"],setup(e){const n=e,{y:t}=Ns(),{hasSidebar:a}=Qe(),{frontmatter:o}=ne(),i=ae({});return Ba(()=>{i.value={"has-sidebar":a.value,home:o.value.layout==="home",top:t.value===0,"screen-open":n.isScreenOpen}}),(s,r)=>(f(),_("div",{class:Q(["VPNavBar",i.value])},[g("div",Qu,[g("div",Ju,[g("div",Zu,[F(Hu,null,{"nav-bar-title-before":N(()=>[C(s.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":N(()=>[C(s.$slots,"nav-bar-title-after",{},void 0,!0)]),_:3})]),g("div",eh,[g("div",nh,[C(s.$slots,"nav-bar-content-before",{},void 0,!0),F(Ya,{class:"search"}),F($u,{class:"menu"}),F(Fs,{class:"translations"}),F(jd,{class:"appearance"}),F(ju,{class:"social-links"}),F(xu,{class:"extra"}),C(s.$slots,"nav-bar-content-after",{},void 0,!0),F(Tu,{class:"hamburger",active:e.isScreenOpen,onClick:r[0]||(r[0]=l=>s.$emit("toggle-screen"))},null,8,["active"])])])])]),r[1]||(r[1]=g("div",{class:"divider"},[g("div",{class:"divider-line"})],-1))],2))}}),ah=X(th,[["__scopeId","data-v-de524931"]]),oh={key:0,class:"VPNavScreenAppearance"},ih={class:"text"},sh=U({__name:"VPNavScreenAppearance",setup(e){const{site:n,theme:t}=ne();return(a,o)=>m(n).appearance&&m(n).appearance!=="force-dark"&&m(n).appearance!=="force-auto"?(f(),_("div",oh,[g("p",ih,I(m(t).darkModeSwitchLabel||"Appearance"),1),F(Wa)])):B("",!0)}}),rh=X(sh,[["__scopeId","data-v-37559f51"]]),lh=["innerHTML"],ch=U({__name:"VPNavScreenMenuLink",props:{item:{}},setup(e){const n=Rt("close-screen");return(t,a)=>(f(),W(Be,{class:"VPNavScreenMenuLink",href:e.item.link,target:e.item.target,rel:e.item.rel,"no-icon":e.item.noIcon,onClick:m(n)},{default:N(()=>[g("span",{innerHTML:e.item.text},null,8,lh)]),_:1},8,["href","target","rel","no-icon","onClick"]))}}),dh=X(ch,[["__scopeId","data-v-80e6e6d6"]]),uh=["innerHTML"],hh=U({__name:"VPNavScreenMenuGroupLink",props:{item:{}},setup(e){const n=Rt("close-screen");return(t,a)=>(f(),W(Be,{class:"VPNavScreenMenuGroupLink",href:e.item.link,target:e.item.target,rel:e.item.rel,"no-icon":e.item.noIcon,onClick:m(n)},{default:N(()=>[g("span",{innerHTML:e.item.text},null,8,uh)]),_:1},8,["href","target","rel","no-icon","onClick"]))}}),Us=X(hh,[["__scopeId","data-v-bd01957f"]]),gh={class:"VPNavScreenMenuGroupSection"},ph={key:0,class:"title"},mh=U({__name:"VPNavScreenMenuGroupSection",props:{text:{},items:{}},setup(e){return(n,t)=>(f(),_("div",gh,[e.text?(f(),_("p",ph,I(e.text),1)):B("",!0),(f(!0),_(Z,null,ie(e.items,a=>(f(),W(Us,{key:a.text,item:a},null,8,["item"]))),128))]))}}),fh=X(mh,[["__scopeId","data-v-cd0e7558"]]),vh=["aria-controls","aria-expanded"],bh=["innerHTML"],yh=["id"],wh={key:0,class:"item"},_h={key:1,class:"item"},kh={key:2,class:"group"},xh=U({__name:"VPNavScreenMenuGroup",props:{text:{},items:{}},setup(e){const n=e,t=ae(!1),a=R(()=>`NavScreenGroup-${n.text.replace(" ","-").toLowerCase()}`);function o(){t.value=!t.value}return(i,s)=>(f(),_("div",{class:Q(["VPNavScreenMenuGroup",{open:t.value}])},[g("button",{class:"button","aria-controls":a.value,"aria-expanded":t.value,onClick:o},[g("span",{class:"button-text",innerHTML:e.text},null,8,bh),s[0]||(s[0]=g("span",{class:"vpi-plus button-icon"},null,-1))],8,vh),g("div",{id:a.value,class:"items"},[(f(!0),_(Z,null,ie(e.items,r=>(f(),_(Z,{key:JSON.stringify(r)},["link"in r?(f(),_("div",wh,[F(Us,{item:r},null,8,["item"])])):"component"in r?(f(),_("div",_h,[(f(),W(ze(r.component),en({ref_for:!0},r.props,{"screen-menu":""}),null,16))])):(f(),_("div",kh,[F(fh,{text:r.text,items:r.items},null,8,["text","items"])]))],64))),128))],8,yh)],2))}}),Ah=X(xh,[["__scopeId","data-v-3d415584"]]),Ch={key:0,class:"VPNavScreenMenu"},Th=U({__name:"VPNavScreenMenu",setup(e){const{theme:n}=ne();return(t,a)=>m(n).nav?(f(),_("nav",Ch,[(f(!0),_(Z,null,ie(m(n).nav,o=>(f(),_(Z,{key:JSON.stringify(o)},["link"in o?(f(),W(dh,{key:0,item:o},null,8,["item"])):"component"in o?(f(),W(ze(o.component),en({key:1,ref_for:!0},o.props,{"screen-menu":""}),null,16)):(f(),W(Ah,{key:2,text:o.text||"",items:o.items},null,8,["text","items"]))],64))),128))])):B("",!0)}}),Ih=U({__name:"VPNavScreenSocialLinks",setup(e){const{theme:n}=ne();return(t,a)=>m(n).socialLinks?(f(),W(Ka,{key:0,class:"VPNavScreenSocialLinks",links:m(n).socialLinks},null,8,["links"])):B("",!0)}}),Sh={class:"list"},Dh=U({__name:"VPNavScreenTranslations",setup(e){const{localeLinks:n,currentLang:t}=Yn({correspondingLink:!0}),a=ae(!1);function o(){a.value=!a.value}return(i,s)=>m(n).length&&m(t).label?(f(),_("div",{key:0,class:Q(["VPNavScreenTranslations",{open:a.value}])},[g("button",{class:"title",onClick:o},[s[0]||(s[0]=g("span",{class:"vpi-languages icon lang"},null,-1)),Ae(" "+I(m(t).label)+" ",1),s[1]||(s[1]=g("span",{class:"vpi-chevron-down icon chevron"},null,-1))]),g("ul",Sh,[(f(!0),_(Z,null,ie(m(n),r=>(f(),_("li",{key:r.link,class:"item"},[F(Be,{class:"link",href:r.link},{default:N(()=>[Ae(I(r.text),1)]),_:2},1032,["href"])]))),128))])],2)):B("",!0)}}),Ph=X(Dh,[["__scopeId","data-v-59d95cf4"]]),Mh={class:"container"},Lh=U({__name:"VPNavScreen",props:{open:{type:Boolean}},setup(e){const n=ae(null),t=Es(zt?document.body:null);return(a,o)=>(f(),W(Ea,{name:"fade",onEnter:o[0]||(o[0]=i=>t.value=!0),onAfterLeave:o[1]||(o[1]=i=>t.value=!1)},{default:N(()=>[e.open?(f(),_("div",{key:0,class:"VPNavScreen",ref_key:"screen",ref:n,id:"VPNavScreen"},[g("div",Mh,[C(a.$slots,"nav-screen-content-before",{},void 0,!0),F(Th,{class:"menu"}),F(Ph,{class:"translations"}),F(rh,{class:"appearance"}),F(Ih,{class:"social-links"}),C(a.$slots,"nav-screen-content-after",{},void 0,!0)])],512)):B("",!0)]),_:3}))}}),$h=X(Lh,[["__scopeId","data-v-07baf27b"]]),Nh={key:0,class:"VPNav"},Oh=U({__name:"VPNav",setup(e){const{isScreenOpen:n,closeScreen:t,toggleScreen:a}=Ld(),{frontmatter:o}=ne(),i=R(()=>o.value.navbar!==!1);return Rs("close-screen",t),Ot(()=>{zt&&document.documentElement.classList.toggle("hide-nav",!i.value)}),(s,r)=>i.value?(f(),_("header",Nh,[F(ah,{"is-screen-open":m(n),onToggleScreen:m(a)},{"nav-bar-title-before":N(()=>[C(s.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":N(()=>[C(s.$slots,"nav-bar-title-after",{},void 0,!0)]),"nav-bar-content-before":N(()=>[C(s.$slots,"nav-bar-content-before",{},void 0,!0)]),"nav-bar-content-after":N(()=>[C(s.$slots,"nav-bar-content-after",{},void 0,!0)]),_:3},8,["is-screen-open","onToggleScreen"]),F($h,{open:m(n)},{"nav-screen-content-before":N(()=>[C(s.$slots,"nav-screen-content-before",{},void 0,!0)]),"nav-screen-content-after":N(()=>[C(s.$slots,"nav-screen-content-after",{},void 0,!0)]),_:3},8,["open"])])):B("",!0)}}),Eh=X(Oh,[["__scopeId","data-v-717bd8c6"]]),Rh=["role","tabindex"],zh={key:1,class:"items"},Bh=U({__name:"VPSidebarItem",props:{item:{},depth:{}},setup(e){const n=e,{collapsed:t,collapsible:a,isLink:o,isActiveLink:i,hasActiveLink:s,hasChildren:r,toggle:l}=El(R(()=>n.item)),c=R(()=>r.value?"section":"div"),u=R(()=>o.value?"a":"div"),p=R(()=>r.value?n.depth+2===7?"p":`h${n.depth+2}`:"p"),d=R(()=>o.value?void 0:"button"),h=R(()=>[[`level-${n.depth}`],{collapsible:a.value},{collapsed:t.value},{"is-link":o.value},{"is-active":i.value},{"has-active":s.value}]);function v(w){"key"in w&&w.key!=="Enter"||!n.item.link&&l()}function b(){n.item.link&&l()}return(w,x)=>{const A=tn("VPSidebarItem",!0);return f(),W(ze(c.value),{class:Q(["VPSidebarItem",h.value])},{default:N(()=>[e.item.text?(f(),_("div",en({key:0,class:"item",role:d.value},pl(e.item.items?{click:v,keydown:v}:{},!0),{tabindex:e.item.items&&0}),[x[1]||(x[1]=g("div",{class:"indicator"},null,-1)),e.item.link?(f(),W(Be,{key:0,tag:u.value,class:"link",href:e.item.link,rel:e.item.rel,target:e.item.target},{default:N(()=>[(f(),W(ze(p.value),{class:"text",innerHTML:e.item.text},null,8,["innerHTML"]))]),_:1},8,["tag","href","rel","target"])):(f(),W(ze(p.value),{key:1,class:"text",innerHTML:e.item.text},null,8,["innerHTML"])),e.item.collapsed!=null&&e.item.items&&e.item.items.length?(f(),_("div",{key:2,class:"caret",role:"button","aria-label":"toggle section",onClick:b,onKeydown:ml(b,["enter"]),tabindex:"0"},[...x[0]||(x[0]=[g("span",{class:"vpi-chevron-right caret-icon"},null,-1)])],32)):B("",!0)],16,Rh)):B("",!0),e.item.items&&e.item.items.length?(f(),_("div",zh,[e.depth<5?(f(!0),_(Z,{key:0},ie(e.item.items,M=>(f(),W(A,{key:M.text,item:M,depth:e.depth+1},null,8,["item","depth"]))),128)):B("",!0)])):B("",!0)]),_:1},8,["class"])}}}),qh=X(Bh,[["__scopeId","data-v-08047252"]]),Vh=U({__name:"VPSidebarGroup",props:{items:{}},setup(e){const n=ae(!0);let t=null;return Oe(()=>{t=setTimeout(()=>{t=null,n.value=!1},300)}),ja(()=>{t!=null&&(clearTimeout(t),t=null)}),(a,o)=>(f(!0),_(Z,null,ie(e.items,i=>(f(),_("div",{key:i.text,class:Q(["group",{"no-transition":n.value}])},[F(qh,{item:i,depth:0},null,8,["item"])],2))),128))}}),jh=X(Vh,[["__scopeId","data-v-ba5ce4ae"]]),Fh={class:"nav",id:"VPSidebarNav","aria-labelledby":"sidebar-aria-label",tabindex:"-1"},Uh=U({__name:"VPSidebar",props:{open:{type:Boolean}},setup(e){const{sidebarGroups:n,hasSidebar:t}=Qe(),a=e,o=ae(null),i=Es(zt?document.body:null);Me([a,o],()=>{var r;a.open?(i.value=!0,(r=o.value)==null||r.focus()):i.value=!1},{immediate:!0,flush:"post"});const s=ae(0);return Me(n,()=>{s.value+=1},{deep:!0}),(r,l)=>m(t)?(f(),_("aside",{key:0,class:Q(["VPSidebar",{open:e.open}]),ref_key:"navEl",ref:o,onClick:l[0]||(l[0]=fl(()=>{},["stop"]))},[l[2]||(l[2]=g("div",{class:"curtain"},null,-1)),g("nav",Fh,[l[1]||(l[1]=g("span",{class:"visually-hidden",id:"sidebar-aria-label"}," Sidebar Navigation ",-1)),C(r.$slots,"sidebar-nav-before",{},void 0,!0),(f(),W(jh,{items:m(n),key:s.value},null,8,["items"])),C(r.$slots,"sidebar-nav-after",{},void 0,!0)])],2)):B("",!0)}}),Wh=X(Uh,[["__scopeId","data-v-9e9a3195"]]),Gh=U({__name:"VPSkipLink",setup(e){const{theme:n}=ne(),t=mn(),a=ae();Me(()=>t.path,()=>a.value.focus());function o({target:i}){const s=document.getElementById(decodeURIComponent(i.hash).slice(1));if(s){const r=()=>{s.removeAttribute("tabindex"),s.removeEventListener("blur",r)};s.setAttribute("tabindex","-1"),s.addEventListener("blur",r),s.focus(),window.scrollTo(0,0)}}return(i,s)=>(f(),_(Z,null,[g("span",{ref_key:"backToTop",ref:a,tabindex:"-1"},null,512),g("a",{href:"#VPContent",class:"VPSkipLink visually-hidden",onClick:o},I(m(n).skipToContentLabel||"Skip to content"),1)],64))}}),Hh=X(Gh,[["__scopeId","data-v-2f312717"]]),Kh=U({__name:"Layout",setup(e){const{isOpen:n,open:t,close:a}=Qe(),o=mn();Me(()=>o.path,a),Ol(n,a);const{frontmatter:i}=ne(),s=vl(),r=R(()=>!!s["home-hero-image"]);return Rs("hero-image-slot-exists",r),(l,c)=>{const u=tn("Content");return m(i).layout!==!1?(f(),_("div",{key:0,class:Q(["Layout",m(i).pageClass])},[C(l.$slots,"layout-top",{},void 0,!0),F(Hh),F(kl,{class:"backdrop",show:m(n),onClick:m(a)},null,8,["show","onClick"]),F(Eh,null,{"nav-bar-title-before":N(()=>[C(l.$slots,"nav-bar-title-before",{},void 0,!0)]),"nav-bar-title-after":N(()=>[C(l.$slots,"nav-bar-title-after",{},void 0,!0)]),"nav-bar-content-before":N(()=>[C(l.$slots,"nav-bar-content-before",{},void 0,!0)]),"nav-bar-content-after":N(()=>[C(l.$slots,"nav-bar-content-after",{},void 0,!0)]),"nav-screen-content-before":N(()=>[C(l.$slots,"nav-screen-content-before",{},void 0,!0)]),"nav-screen-content-after":N(()=>[C(l.$slots,"nav-screen-content-after",{},void 0,!0)]),_:3}),F(Md,{open:m(n),onOpenMenu:m(t)},null,8,["open","onOpenMenu"]),F(Wh,{open:m(n)},{"sidebar-nav-before":N(()=>[C(l.$slots,"sidebar-nav-before",{},void 0,!0)]),"sidebar-nav-after":N(()=>[C(l.$slots,"sidebar-nav-after",{},void 0,!0)]),_:3},8,["open"]),F(md,null,{"page-top":N(()=>[C(l.$slots,"page-top",{},void 0,!0)]),"page-bottom":N(()=>[C(l.$slots,"page-bottom",{},void 0,!0)]),"not-found":N(()=>[C(l.$slots,"not-found",{},void 0,!0)]),"home-hero-before":N(()=>[C(l.$slots,"home-hero-before",{},void 0,!0)]),"home-hero-info-before":N(()=>[C(l.$slots,"home-hero-info-before",{},void 0,!0)]),"home-hero-info":N(()=>[C(l.$slots,"home-hero-info",{},void 0,!0)]),"home-hero-info-after":N(()=>[C(l.$slots,"home-hero-info-after",{},void 0,!0)]),"home-hero-actions-after":N(()=>[C(l.$slots,"home-hero-actions-after",{},void 0,!0)]),"home-hero-image":N(()=>[C(l.$slots,"home-hero-image",{},void 0,!0)]),"home-hero-after":N(()=>[C(l.$slots,"home-hero-after",{},void 0,!0)]),"home-features-before":N(()=>[C(l.$slots,"home-features-before",{},void 0,!0)]),"home-features-after":N(()=>[C(l.$slots,"home-features-after",{},void 0,!0)]),"doc-footer-before":N(()=>[C(l.$slots,"doc-footer-before",{},void 0,!0)]),"doc-before":N(()=>[C(l.$slots,"doc-before",{},void 0,!0)]),"doc-after":N(()=>[C(l.$slots,"doc-after",{},void 0,!0)]),"doc-top":N(()=>[C(l.$slots,"doc-top",{},void 0,!0)]),"doc-bottom":N(()=>[C(l.$slots,"doc-bottom",{},void 0,!0)]),"aside-top":N(()=>[C(l.$slots,"aside-top",{},void 0,!0)]),"aside-bottom":N(()=>[C(l.$slots,"aside-bottom",{},void 0,!0)]),"aside-outline-before":N(()=>[C(l.$slots,"aside-outline-before",{},void 0,!0)]),"aside-outline-after":N(()=>[C(l.$slots,"aside-outline-after",{},void 0,!0)]),"aside-ads-before":N(()=>[C(l.$slots,"aside-ads-before",{},void 0,!0)]),"aside-ads-after":N(()=>[C(l.$slots,"aside-ads-after",{},void 0,!0)]),_:3}),F(wd),C(l.$slots,"layout-bottom",{},void 0,!0)],2)):(f(),W(u,{key:1}))}}}),Yh=X(Kh,[["__scopeId","data-v-3fa573af"]]),Ws={Layout:Yh,enhanceApp:({app:e})=>{e.component("Badge",yl)}},Xh={class:"flex items-center rounded-lg border border-slate-200 dark:border-slate-700 overflow-hidden"},Qh={key:1,class:"flex flex-wrap items-center gap-2"},Jh=["href"],Ri=U({__name:"ThemeControls",props:{compact:{type:Boolean,default:!1},showSearch:{type:Boolean,default:!0}},setup(e){const n=ae("light"),t=mn(),{site:a}=pn(),o=R(()=>{const h=a.value.locales||{};return Object.values(h).map(v=>{const b=typeof(v==null?void 0:v.label)=="string"?v.label:"",w=typeof(v==null?void 0:v.link)=="string"?v.link:"";return{label:b,link:w}}).filter(v=>!!(v.label&&v.link))}),i=R(()=>l(t.path)),s=R(()=>o.value.map(h=>l(h.link)).filter(h=>h!=="/").sort((h,v)=>v.length-h.length)),r=R(()=>{const h=i.value;for(const v of s.value)if(h===v||h.startsWith(`${v}/`))return v;return"/"});function l(h){if(!h)return"/";const[v]=h.split(/[?#]/);return v&&v.replace(/\/+$/,"")||"/"}function c(h){return r.value===l(h)}function u(h){for(const v of s.value){if(h===v)return"/";if(h.startsWith(`${v}/`))return h.slice(v.length)||"/"}return h}function p(h){const v=l(h),b=u(i.value);return v==="/"?b:`${v}${b==="/"?"/":b}`.replace(/\/{2,}/g,"/")}function d(h){if(typeof window>"u")return;n.value=h;const v=document.documentElement;v.classList.remove("dark"),h==="dark"&&v.classList.add("dark"),v.setAttribute("data-theme",h),v.style.colorScheme=h,localStorage.setItem("vitepress-theme-appearance",h)}return Oe(()=>{const h=localStorage.getItem("vitepress-theme-appearance"),v=document.documentElement.classList.contains("dark")?"dark":"light",b=h==="dark"||h==="light"?h:v;d(b),requestAnimationFrame(()=>d(b))}),(h,v)=>(f(),_("div",{class:Q(e.compact?"flex flex-col items-start gap-3":"flex items-center gap-3")},[e.showSearch&&!e.compact?(f(),W(Ya,{key:0})):B("",!0),g("div",Xh,[g("button",{class:Q(["px-2.5 py-1.5 text-xs font-semibold transition-colors",n.value==="light"?"bg-slate-200 text-slate-900 dark:bg-slate-100":"bg-transparent text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800"]),onClick:v[0]||(v[0]=b=>d("light"))}," Light ",2),g("button",{class:Q(["px-2.5 py-1.5 text-xs font-semibold transition-colors",n.value==="dark"?"bg-slate-900 text-slate-100 dark:bg-slate-700":"bg-transparent text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800"]),onClick:v[1]||(v[1]=b=>d("dark"))}," Dark ",2)]),e.compact?(f(),_("div",Qh,[(f(!0),_(Z,null,ie(o.value,b=>(f(),_("a",{key:b.link,class:Q(c(b.link)?"rounded-md border border-slate-300 dark:border-slate-600 bg-slate-100 dark:bg-slate-800 px-2.5 py-1 text-xs font-semibold text-slate-900 dark:text-slate-100":"rounded-md border border-slate-200 dark:border-slate-700 px-2.5 py-1 text-xs font-semibold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"),href:p(b.link)},I(b.label),11,Jh))),128))])):(f(),W(Fs,{key:2}))],2))}}),Zh={class:"fixed top-0 w-full z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200/15 dark:border-slate-800/15 shadow-[0px_24px_48px_rgba(42,52,57,0.06)]"},eg={class:"flex items-center gap-3"},ng=["href"],tg={class:"hidden md:flex items-center space-x-8 font-inter tracking-tight"},ag=["href"],og={class:"hidden md:flex items-center gap-4"},ig={key:0,class:"bg-primary text-on-primary px-5 py-2 rounded-lg font-medium text-sm transition-all active:opacity-80"},sg={class:"md:hidden flex items-center gap-2"},rg={class:"mobile-search"},lg={class:"group relative"},cg={class:"absolute right-0 mt-3 w-[min(20rem,calc(100vw-2rem))] rounded-xl border border-slate-200 dark:border-slate-700 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl shadow-xl p-4"},dg={class:"space-y-1"},ug=["href"],hg={class:"mt-4 border-t border-slate-200 dark:border-slate-700 pt-4"},gg={key:0,class:"mt-4 w-full bg-primary text-on-primary px-5 py-2 rounded-lg font-medium text-sm transition-all active:opacity-80"},pg=U({__name:"SiteHeader",props:{siteTitle:{default:"MeshShape"},navLinks:{default:()=>[]},showSubscribe:{type:Boolean,default:!1},subscribeButtonText:{default:"Subscribe"},navHeightClass:{default:"h-20"}},setup(e){const n=mn();function t(i){const s=a(i);return s==="/en"||s.startsWith("/en/")?"/en/":"/"}function a(i){if(!i)return"/";const[s]=i.split(/[?#]/);return s&&s.replace(/\/+$/,"")||"/"}function o(i){if(i.active)return!0;const s=a(i.href),r=a(n.path);return s==="/"?r==="/":s==="/en"?r==="/en":r===s||r.startsWith(`${s}/`)}return(i,s)=>(f(),_("nav",Zh,[g("div",{class:Q(`flex justify-between items-center ${e.navHeightClass} px-8 w-full max-w-7xl mx-auto`)},[g("div",eg,[g("a",{class:"text-xl font-bold tracking-tighter text-slate-900 dark:text-slate-50 hover:opacity-80 transition-opacity",href:t(m(n).path)},I(e.siteTitle),9,ng)]),g("div",tg,[(f(!0),_(Z,null,ie(e.navLinks,r=>(f(),_("a",{key:r.text,class:Q(o(r)?"text-slate-900 dark:text-slate-50 font-semibold border-b-2 border-slate-900 dark:border-slate-50 pb-1 transition-all":"text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 transition-colors"),href:r.href||"#"},I(r.text),11,ag))),128))]),g("div",og,[F(Ri),e.showSubscribe?(f(),_("button",ig,I(e.subscribeButtonText),1)):B("",!0)]),g("div",sg,[g("div",rg,[F(Ya)]),g("details",lg,[s[0]||(s[0]=g("summary",{class:"list-none flex items-center justify-center h-10 w-10 rounded-lg border border-slate-300/60 dark:border-slate-700/60 text-slate-700 dark:text-slate-200 cursor-pointer","aria-label":"Open mobile navigation menu"},[g("span",{class:"text-xl leading-none"},"≡")],-1)),g("div",cg,[g("div",dg,[(f(!0),_(Z,null,ie(e.navLinks,r=>(f(),_("a",{key:`mobile-${r.text}`,class:Q(o(r)?"block rounded-lg px-3 py-2 text-slate-900 dark:text-slate-50 font-semibold bg-slate-100 dark:bg-slate-800/80":"block rounded-lg px-3 py-2 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800/80 transition-colors"),href:r.href||"#"},I(r.text),11,ug))),128))]),g("div",hg,[F(Ri,{compact:!0,"show-search":!1})]),e.showSubscribe?(f(),_("button",gg,I(e.subscribeButtonText),1)):B("",!0)])])])],2)]))}}),qt=X(pg,[["__scopeId","data-v-70c33c8b"]]),mg={class:"w-full border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950"},fg={class:"max-w-7xl mx-auto px-8 py-12 flex flex-col md:flex-row justify-between items-center gap-8"},vg=["href"],bg={class:"text-sm font-inter tracking-wide text-slate-600 dark:text-slate-400"},yg={class:"flex flex-wrap justify-center gap-8"},wg=["href"],_g={key:0,class:"flex gap-4"},kg={class:"material-symbols-outlined text-slate-600 dark:text-slate-400"},xg={key:0,class:"border-t border-slate-200/80 dark:border-slate-800/80"},Ag={class:"max-w-7xl mx-auto px-8 py-4 flex flex-wrap items-center justify-center gap-x-3 gap-y-2 text-xs tracking-[0.08em] uppercase text-slate-500 dark:text-slate-400"},Cg=["href"],Tg=["href"],Vt=U({__name:"SiteFooter",props:{title:{default:"MeshShape"},description:{default:""},links:{default:()=>[]},filing:{default:null},socialIcons:{default:()=>[]}},setup(e){const n=mn();function t(o){if(!o)return"/";const[i]=o.split(/[?#]/);return i&&i.replace(/\/+$/,"")||"/"}function a(o){const i=t(o);return i==="/en"||i.startsWith("/en/")?"/en/":"/"}return(o,i)=>(f(),_("footer",mg,[g("div",fg,[g("div",null,[g("a",{class:"text-lg font-bold text-slate-900 dark:text-slate-50 mb-2 inline-block hover:opacity-80 transition-opacity",href:a(m(n).path)},I(e.title),9,vg),g("p",bg,I(e.description),1)]),g("div",yg,[(f(!0),_(Z,null,ie(e.links,s=>(f(),_("a",{key:s.text,class:"text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors text-sm font-inter tracking-wide",href:s.href||"#"},I(s.text),9,wg))),128))]),e.socialIcons.length?(f(),_("div",_g,[(f(!0),_(Z,null,ie(e.socialIcons,s=>(f(),_("button",{key:s,class:"w-10 h-10 flex items-center justify-center rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:scale-105 transition-transform"},[g("span",kg,I(s),1)]))),128))])):B("",!0)]),e.filing?(f(),_("div",xg,[g("div",Ag,[g("a",{class:"hover:text-slate-700 dark:hover:text-slate-200 transition-colors",href:e.filing.href,rel:"noreferrer",target:"_blank"},I(e.filing.label),9,Cg),i[0]||(i[0]=g("span",{class:"hidden sm:inline text-slate-300 dark:text-slate-700"},"/",-1)),g("a",{class:"font-medium tracking-[0.03em] normal-case hover:text-slate-700 dark:hover:text-slate-200 transition-colors",href:e.filing.href,rel:"noreferrer",target:"_blank"},I(e.filing.number),9,Tg)])])):B("",!0)]))}});function jt(){const{frontmatter:e}=pn(),n=R(()=>e.value);return{frontmatter:e,page:n}}function Ft(){const{theme:e}=pn(),n=R(()=>e.value),t=R(()=>n.value.header||{}),a=R(()=>n.value.footer||{}),o=R(()=>n.value.ui||{});return{theme:e,themeConfig:n,headerConfig:t,footerConfig:a,uiConfig:o}}const Ig="/assets/mesh-texture.CdcToYau.png",Sg="/assets/mesh-architecture.BxOsXjO_.png",Dg={class:"bg-surface text-slate-900 dark:text-slate-100 antialiased selection:bg-primary-container selection:text-on-primary-container"},Pg={class:"pt-20 bg-surface"},Mg={class:"relative overflow-hidden min-h-[870px] flex items-center px-8 max-w-7xl mx-auto"},Lg={class:"grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full"},$g={class:"lg:col-span-5 lg:order-2 relative h-[320px] sm:h-[420px] lg:h-[500px] w-full mt-8 lg:mt-0"},Ng={class:"absolute inset-0 bg-surface-container-low rounded-[2rem] overflow-hidden mesh-gradient group"},Og={class:"lg:col-span-7 lg:order-1 z-10"},Eg={class:"inline-block label-sm text-[0.6875rem] font-bold tracking-[0.05em] uppercase text-tertiary mb-6"},Rg={class:"text-[2.25rem] sm:text-[2.9rem] lg:text-[3.5rem] font-extrabold leading-[1.18] sm:leading-[1.12] lg:leading-[1.1] tracking-[-0.02em] text-slate-900 dark:text-slate-100 mb-8"},zg={class:"text-[0.92em] sm:text-[1em] text-primary-dim"},Bg={class:"text-[1.375rem] leading-relaxed text-slate-700 dark:text-slate-400 max-w-2xl font-light"},qg={class:"mt-12 mb-8 flex flex-col w-full gap-4 sm:flex-row sm:items-center sm:space-x-6 sm:gap-0"},Vg=["href"],jg={class:"group-hover:underline"},Fg={class:"py-24 bg-surface-container-low dark:bg-slate-900"},Ug={class:"max-w-7xl mx-auto px-8"},Wg={class:"mb-16 text-center lg:text-left"},Gg={class:"text-[2.25rem] font-bold leading-[1.34] sm:leading-[1.2] tracking-tight text-slate-900 dark:text-slate-100 mb-8"},Hg={class:"text-slate-700 dark:text-slate-400 max-w-xl"},Kg={class:"relative h-[350px] lg:h-auto lg:aspect-[21/9] w-full bg-surface-container-lowest rounded-[2rem] lg:rounded-full overflow-hidden outline outline-1 outline-outline-variant/10 group"},Yg=["src"],Xg={class:"absolute bottom-6 left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] lg:w-auto lg:max-w-xs lg:left-12 lg:translate-x-0 lg:bottom-12 flex flex-col space-y-2 p-6 bg-white/40 backdrop-blur-md rounded-xl border border-white/20"},Qg={class:"text-xs font-bold text-primary uppercase tracking-widest dark:text-tertiary"},Jg={class:"text-sm text-slate-900 dark:text-slate-300"},Zg={id:"insights-section",class:"py-32 bg-surface dark:bg-slate-950"},ep={class:"max-w-7xl mx-auto px-8"},np={class:"flex flex-col lg:flex-row gap-24 items-start"},tp={class:"lg:sticky lg:top-32 lg:w-1/3 w-full text-center lg:text-left"},ap={class:"text-[3rem] font-extrabold tracking-tighter leading-tight mb-6 flex items-baseline justify-center lg:justify-start gap-x-0"},op={class:"text-slate-700 dark:text-slate-400"},ip={class:"lg:w-2/3 space-y-32"},sp={class:"flex flex-col lg:flex-row lg:items-baseline items-start gap-4 lg:gap-6 mb-8"},rp={class:"text-[4rem] font-thin text-outline-variant leading-none"},lp={class:"text-3xl font-bold tracking-tight text-slate-900 dark:text-slate-100 text-left"},cp={class:"pl-0 lg:pl-20"},dp={key:0,class:"space-y-5 mb-8 text-lg leading-relaxed text-slate-700 dark:text-slate-400"},up={key:1,class:"text-lg leading-relaxed text-slate-700 dark:text-slate-400 mb-8"},hp={key:2,class:"mb-8 space-y-3 text-base leading-relaxed text-slate-700 dark:text-slate-400"},gp={key:3,class:"mt-4 px-6 py-3 bg-surface-container-high text-primary rounded-lg text-sm font-semibold hover:bg-surface-container-highest transition-colors"},pp={class:"py-24 bg-surface-container-low dark:bg-slate-900 px-8"},mp={class:"max-w-7xl mx-auto"},fp={class:"bg-primary-dim rounded-full p-16 lg:p-24 relative overflow-hidden group dark:bg-slate-900 dark:border dark:border-slate-800"},vp={class:"relative z-10 text-center lg:text-left"},bp={class:"text-[1.9rem] sm:text-[2.25rem] lg:text-[3.5rem] leading-[1.34] sm:leading-[1.28] lg:leading-[1.25] font-bold text-white mb-8 tracking-tighter"},yp={key:0,class:"flex flex-col sm:flex-row gap-6 justify-center lg:justify-start"},wp={key:0,class:"px-10 py-5 bg-white text-primary font-bold rounded-lg hover:bg-on-primary transition-transform active:scale-95"},_p={key:1,class:"px-10 py-5 bg-primary text-white border border-white/20 font-bold rounded-lg hover:bg-primary/80 transition-transform active:scale-95"},kp=U({__name:"HomeLayout",setup(e){const{page:n}=jt(),{headerConfig:t,footerConfig:a}=Ft();function o(){var i;typeof window>"u"||(i=document.getElementById("insights-section"))==null||i.scrollIntoView({behavior:"smooth",block:"start"})}return(i,s)=>(f(),_("div",Dg,[F(qt,{"site-title":m(t).siteTitle||m(n).siteTitle,"nav-links":m(t).navLinks||m(n).navLinks||[],"show-subscribe":!!m(t).showSubscribe,"subscribe-button-text":m(t).subscribeButtonText,"nav-height-class":"h-20"},null,8,["site-title","nav-links","show-subscribe","subscribe-button-text"]),g("main",Pg,[g("section",Mg,[g("div",Lg,[g("div",$g,[g("div",Ng,[g("div",{class:"absolute inset-0 opacity-20","data-alt":"Subtle geometric mesh pattern texture",style:qa({backgroundImage:`url(${m(Ig)})`})},null,4),s[0]||(s[0]=bl('<div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] flex items-center justify-center"><div class="relative w-full h-full"><div class="mesh-line mesh-line-h absolute top-[20%] left-[20%] w-[60%] h-[2px] bg-primary/20 dark:bg-slate-300/45 rotate-[-15deg] transition-all duration-1000 ease-out group-hover:top-[40%]"></div><div class="mesh-line mesh-line-h absolute top-[40%] left-[20%] w-[60%] h-[2px] bg-primary/40 dark:bg-slate-300/45 rotate-[-15deg] transition-all duration-1000 ease-out group-hover:top-[60%]"></div><div class="mesh-line mesh-line-v absolute top-[20%] left-[40%] w-[2px] h-[60%] bg-primary/30 dark:bg-slate-300/45 rotate-[10deg] transition-all duration-1000 ease-out"></div><div class="mesh-line mesh-line-v absolute top-[20%] left-[60%] w-[2px] h-[60%] bg-primary/50 dark:bg-slate-300/45 rotate-[10deg] transition-all duration-1000 ease-out"></div></div></div>',1))])]),g("div",Og,[g("span",Eg,I(m(n).heroEyebrow),1),g("h1",Rg,[Ae(I(m(n).heroTitle),1),s[1]||(s[1]=g("br",null,null,-1)),g("span",zg,I(m(n).heroTitleHighlight),1)]),g("p",Bg,I(m(n).heroDescription),1),g("div",qg,[m(n).heroPrimaryButton?(f(),_("button",{key:0,class:"w-full sm:w-auto px-8 py-4 bg-primary text-on-primary rounded-lg font-medium hover:bg-primary-dim dark:bg-[#f7f9fb] dark:text-[#0f172a] dark:hover:bg-[#ffffff] transition-all hover:scale-[1.02] active:scale-95",onClick:o},I(m(n).heroPrimaryButton),1)):B("",!0),m(n).heroSecondaryButton?(f(),_("a",{key:1,class:"group w-full sm:w-auto flex items-center justify-center sm:justify-start space-x-2 text-tertiary font-medium px-8 py-4 rounded-lg",href:m(n).heroSecondaryButtonHref||"/blog/"},[g("span",jg,I(m(n).heroSecondaryButton),1),s[2]||(s[2]=g("span",{class:"material-symbols-outlined text-sm"},"arrow_forward",-1))],8,Vg)):B("",!0)])])])]),g("section",Fg,[g("div",Ug,[g("div",Wg,[g("h2",Gg,I(m(n).structureTitle),1),g("p",Hg,I(m(n).structureDescription),1)]),g("div",Kg,[g("img",{alt:"Architectural Mesh Diagram",class:"w-full h-full object-cover opacity-90 transition-transform duration-700 group-hover:scale-105","data-alt":"Digital blue circuit mesh representing neural network topology",src:m(Sg)},null,8,Yg),s[3]||(s[3]=g("div",{class:"absolute inset-0 bg-gradient-to-t from-surface-container-lowest via-transparent to-transparent opacity-60"},null,-1)),g("div",Xg,[g("span",Qg,I(m(n).structureCardTitle),1),g("p",Jg,I(m(n).structureCardDescription),1)])])])]),g("section",Zg,[g("div",ep,[g("div",np,[g("div",tp,[g("h2",ap,[g("span",null,I(m(n).insightsTitleLine1),1),g("span",null,[Ae(I(m(n).insightsTitleLine2),1),s[4]||(s[4]=g("span",{class:"text-tertiary"},".",-1))])]),g("p",op,I(m(n).insightsSubtitle),1)]),g("div",ip,[(f(!0),_(Z,null,ie(m(n).insights||[],r=>{var l,c;return f(),_("div",{key:r.index,class:"group"},[g("div",sp,[g("span",rp,I(r.index),1),g("h3",lp,I(r.title),1)]),g("div",cp,[(l=r.paragraphs)!=null&&l.length?(f(),_("div",dp,[(f(!0),_(Z,null,ie(r.paragraphs,u=>(f(),_("p",{key:u},I(u),1))),128))])):r.description?(f(),_("p",up,I(r.description),1)):B("",!0),(c=r.listItems)!=null&&c.length?(f(),_("ul",hp,[(f(!0),_(Z,null,ie(r.listItems,u=>(f(),_("li",{key:u,class:"flex gap-3"},[s[5]||(s[5]=g("span",{class:"mt-2 h-2 w-2 shrink-0 rounded-full bg-tertiary"},null,-1)),g("span",null,I(u),1)]))),128))])):B("",!0),r.buttonText?(f(),_("button",gp,I(r.buttonText),1)):B("",!0)])])}),128))])])])]),g("section",pp,[g("div",mp,[g("div",fp,[s[6]||(s[6]=g("div",{class:"absolute top-0 right-0 w-1/2 h-full opacity-10 pointer-events-none"},[g("svg",{class:"w-full h-full scale-150 rotate-45",viewBox:"0 0 200 200",xmlns:"http://www.w3.org/2000/svg"},[g("path",{d:"M44.7,-76.4C58.1,-69.2,70.3,-58.5,78.4,-45.3C86.5,-32.1,90.4,-16,88.4,-0.6C86.5,14.8,78.6,29.6,69.5,42.4C60.4,55.1,50.1,65.8,37.5,72.6C24.9,79.5,10,82.5,-4.1,89.5C-18.1,96.6,-31.2,107.7,-43.3,105.7C-55.3,103.7,-66.2,88.5,-73.4,73.5C-80.6,58.4,-84.1,43.5,-86.3,28.9C-88.5,14.2,-89.4,-0.2,-86.3,-13.7C-83.2,-27.2,-76.1,-39.8,-66.5,-50.2C-56.9,-60.7,-44.8,-69.1,-32.2,-76.7C-19.6,-84.4,-6.5,-91.3,7.6,-104.4C21.7,-117.5,31.3,-83.6,44.7,-76.4Z",fill:"#FFFFFF",transform:"translate(100 100)"})])],-1)),g("div",vp,[g("h2",bp,I(m(n).ctaTitle),1),m(n).ctaPrimaryButton||m(n).ctaSecondaryButton?(f(),_("div",yp,[m(n).ctaPrimaryButton?(f(),_("button",wp,I(m(n).ctaPrimaryButton),1)):B("",!0),m(n).ctaSecondaryButton?(f(),_("button",_p,I(m(n).ctaSecondaryButton),1)):B("",!0)])):B("",!0)])])])])]),F(Vt,{title:m(a).title||m(n).footerTitle,description:m(a).description||m(n).footerDescription,links:m(a).links||m(n).footerLinks||[],filing:m(a).filing||null,"social-icons":m(a).socialIcons||[]},null,8,["title","description","links","filing","social-icons"])]))}}),Xa=`---
layout: about-me
heroEyebrow: 关于我
heroTitle: 技能“网”
...
description: "从 Trello/Typora 迁移到 Logseq 的完整复盘与可复用采集、整理、执行工作流，帮助将碎片化信息转为可追踪的知识资产。"
tags:
    - "domain"
    - "PKM"
    - "logseq"
...
description: "从云原生技术演进与个人职业实践两条线，探讨开发者如何在快速迭代中构建可迁移且可放大的能力网络。"
tags:
    - "mesh"
    - "架构设计"
    - "工程实践"
...
description: "两个月学习实验的复盘：识别真正带来能力增量的做法、剔除制造忙碌感的行为，并讲述如何把发散探索收敛为可执行主线。"
tags:
    - "mesh"
    - "架构设计"
    - "工程实践"
...
description: "梳理从 Docker 崛起、OCI 标准化到 Kubernetes 运行时切换的容器生态关键分水岭，解释 dockerd、containerd、runc 与 CRI/OCI 的关系。"
tags:
    - "node"
    - "K8s"
...
description: "通过网络层级与职责边界拆解路由、代理与网关三个概念，提供可落地的区分方法以避免架构讨论中的术语混用。"
tags:
    - "node"
    - "api-design"
...
description: "云原生落地的核心在于建立可持续的工程体系而非采购更多工具，从标准化能力、组织协作与演进路径三方面提出实践框架。"
tags:
    - "node"
    - "IaC"
    - "DevOps"
...
description: "基于 Google API Design Guide，总结资源命名、标准方法、自定义动作、错误码与分页等关键规则，并提供可落地的设计检查项。"
tags:
    - "node"
    - "api-design"
    - "tooling"
...
description: "以价值流视角梳理 Go 微服务的端到端实践：代码库策略、构建与部署、可观测与调试与基础设施协同，帮助团队建立可复制的交付链路。"
tags:
    - "node"
    - "K8s"
    - "IaC"
...
description: "一套可复用的 Logseq GTD 查询模板，覆盖进行中、待办与优先级划分，并附带可直接拷贝的 CSS 优化样式。"
tags:
    - "domain"
    - "logseq"
...
description: '拆解在 Logseq 上落地 PKM 的完整流程：输入采集、任务循环、笔记沉淀与输出反馈，旨在把记录行为转为可持续的能力增长。'
tags:
  - 'domain'
  - 'PKM'
  - 'logseq'
...
description: "以不可变基础设施为出发点，拆解 IaC 在团队中的价值边界、分层方法与 Terraform 组织策略，帮助把基础设施代码化为可维护工程系统。"
tags:
    - "node"
    - "K8s"
    - "IaC"
...
description: "围绕“向谁传达什么信息”这一核心问题，给出可执行的架构图绘制方法：受众识别、信息分层、逻辑组织与风格统一。"
tags:
    - "mesh"
    - "架构设计"
    - "工程实践"
...
description: "从网络连接视角拆解 Tunnel、VPN、VPC 三个概念，解释它们在跨网互通、安全传输和虚拟网络抽象方面的分工与协作。"
tags:
    - "node"
    - "K8s"
...
description: "聚焦云原生场景下的调试效率问题，对比替换镜像、VPN 组网、开发容器与 Web IDE 四种方案，并分析成本、收益与适用边界。"
tags:
    - "node"
    - "K8s"
...
description: "从软件团队协作出发，对比敏捷与精益在目标、方法与组织演进上的交叉点，提供一套便于落地的理解框架。"
tags:
    - "domain"
    - "productivity"
    - "automation"
...
description: "以个人工具 adcli 为例，展示如何用 Cobra 构建分层命令结构，并将博客创建与发布流程沉淀为可复用命令行能力。"
tags:
    - "node"
    - "Go"
image:
...
description: "总结 DevContainer 在多语言项目中的落地经验，涵盖定义、构建、连接与团队分发，帮助减少本地环境漂移与版本冲突。"
tags:
    - "node"
    - "IaC"
    - "Go"
...
description: "面向工程实践者梳理 AI 关键概念：应用领域、学习策略，以及深度学习与 LLM 的关系，帮助构建可执行的学习地图。"
tags:
    - "node/agentic"
    - "LLM"
    - "Prompt"
...
description: "通过 Seller/Buyer 示例对比两种实现路径（client-go 手写 Controller 与 Operator SDK 自动生成），帮助理解 CRD 的工程化落地。"
tags:
    - "node"
    - "K8s"
    - "Go"
...
description: "可复用的 Windows 开发环境分层方案：桌面宿主机、WSL 开发层与 VirtualBox 沙盒，兼顾日常编码效率与 K8s 调试能力。"
tags:
    - "node"
    - "K8s"
image:
...
description: "聚焦云原生落地的真实阻力（工具过载、协作断层、价值难量化），并提出以 API 优先与数据驱动为核心的工程化思路。"
tags:
    - "node"
    - "DevOps"
image:
...
description: "从开发顾问到运维场景的认知迁移复盘，讨论目标收敛、能力迁移与值得在 2024 持续投入的探索方向。"
tags:
    - "mesh"
    - "架构设计"
    - "工程实践"
...
description: "把图解从表达工具扩展为思考工具，给出复现、发散、收敛、重组四步法，帮助在学习与工作中快速形成可复用认知结构。"
tags:
    - "mesh"
    - "架构设计"
    - "工程实践"
...
description: "梳理 LLM 应用从基础 Prompt 到向量检索、缓存与编排层的演进，并结合 Ollama 与 LangChain 提供本地化落地思路。"
tags:
    - "node/agentic"
    - "LLM"
    - "Prompt"
...
description: "基于一线使用场景讨论 AI 的效率提升与替代焦虑，提出把 AI 作为增幅器而非替代者的实践判断。"
tags:
    - "node/agentic"
    - "LLM"
    - "Prompt"
...
description: "从 issue、发布、构建与测试四个环节拆解 Fork 开源项目的真实成本，帮助团队在等待社区、购买支持或自行维护间做出可量化决策。"
tags:
    - "node"
    - "docker"
    - "automation"
...
description: "从 docker-compose 迁移到 k3s 的博客基础设施实战记录，涵盖 Ingress、DNS、证书自动续期与 GitHub Actions 自动部署要点。"
tags:
    - "node"
    - "K8s"
    - "DevOps"
...
description: "将 AI 引入 Mesh-Shaped PKM 的实践复盘，展示如何把知识整理转为任务驱动，并通过反馈闭环提升执行效率。"
tags:
    - "domain"
    - "PKM"
    - "logseq"
...
description: "DomainSpec 通过可传递的规格工件，把业务上下文从讨论延续到实现与验证，减少语义漂移与交付偏差。"
tags:
    - "mesh"
    - "架构设计"
    - "工程实践"
...
description: "将 Agent 开发流程拆解为模块化设计、结果驱动交付与持续演进三条主线，并给出可落地的组件映射与实践路径。"
tags:
    - "node/agentic"
    - "agentic"
    - "LLM"
...
description: "平台工程的分层演进路径：从标准化与自动化迈向 API 驱动与自助服务，强调用薄切片验证端到端交付能力。"
tags:
    - "node"
    - "K8s"
    - "IaC"
...
date: "2026-04-13"
description: "将个人知识库从单纯笔记工具演进为分层 Brains 的思路与实践，包括输入层、知识层、输出层的设计与 agent 修改边界。"
tags:
  - "domain"
  - "PKM"
  - "LLM"
...
date: "2026-04-13"
description: "基于五个维度评估旧笔记保留价值，并将笔记分入 A/B/C 三条迁移流水线，提供阈值、CSV 字段与校准步骤以便执行。"
tags:
  - "domain"
  - "logseq"
  - "migration"
...
`,Mo=`---
category: "agentic"
title: "Multica + Brains：把任务流和知识流接成闭环"
date: "2026-05-11"
description: "用 Multica 拆分并推进任务，再用 Brains 提炼可复用知识，把 agent 工作流接成可回放、可积累的闭环。"
image: "../assets/202605-multica-brains-agent-kanban/1778475581203.png"
tags:
  - "agentic"
  - "kanban"
  - "knowledge-base"
...
**我的观点是：工作流的自动化，至少要同时覆盖问题拆分、任务执行、知识管理这三个方面，而且它们之间要能形成闭环。**

起点其实是个很具体的问题：我发现单纯在 **markdown** 里做 **TODO 管理**，已经承接不了复杂任务。它适合记想法和结论，却装不下任务状态、依赖关系、协作过程和中间决策；而这些过程信息虽然对推进任务很重要，任务结束后又大多不值得直接沉淀进长期知识库。

所以我最后的判断是：要把个人工作流做成**自动化闭环**，就得把**问题拆分**、**任务执行**、**知识管理**分开设计，再重新接起来。我最近把 [Brains](202604-llm-wiki-self-evolving-brains.md) 接进 Multica 之后，这个判断变得更具体了：Multica 负责拆问题和组织协作，agent runtime 负责执行，Brains 负责提炼和回写知识，三者正好接成一条闭环链路。
...
顺着这个判断往下看，这条链路其实就分成三段：Multica 怎么理顺问题拆分，agent runtime 怎么接住执行，Brains 又怎样把经验变成可复用知识。

## Multica 先把问题拆分这件事理顺了

我对 Multica 最感兴趣的地方有两层。第一层是它作为 **kanban 工具**本身就很合适。既然我已经决定把**任务管理**从 markdown 里拆出来，就需要一个天然适合表达任务状态、依赖关系和协作过程的地方。**Multica** 在这件事上几乎不用怎么拐弯：issue、comment、project、repository，以及 parent/sub issue 这些元素，本来就是复杂任务管理需要的基本结构。

第二层才是更关键的地方：它不只是个看板工具，还把 **agent** 直接编进了**任务流**。也就是说，它不仅能管任务，还把 agent 设计成了任务系统里的正式成员，而不是挂在聊天窗口后面的隐藏能力。

这件事很关键。很多 agent 产品本质上还是“人发一句话，系统跑一段流程”。任务、责任、上下文都埋在一次次对话里，后续很难追踪，也很难复用。Multica 换了一个入口：issue、comment、assign。你可以直接把 issue assign 给某个 agent，让它开始处理；也可以在讨论过程中随手 \`@brains\`、\`@planner\` 或其他执行 agent，让不同 agent 进入同一个任务线程。

这样一来，agent 成了一个可以被分工、被协作、被追踪的角色。对复杂任务来说，这比“模型能力再强一点”更重要，因为团队真正缺的往往不是单轮回答，缺的是可持续的协作结构。

这一步首先解决的是问题拆分和任务组织：一个复杂问题怎么被创建成 issue，怎么继续拆分，怎么被分配，怎么在同一条线程里持续推进。尤其在异步、跨项目、多 agent 协作的场景里，这一点更有价值。没有这一层，所谓 agent 自动化大多只是单点能力调用，而不是完整工作流。

## Multica + agent runtime 再把任务执行自动化接上去

Multica 的第二个吸引点，是它没有试图从零发明一套新的 **agent 执行环境**，而是通过 **daemon + runtime** 把已有工具串起来。

我会把它理解成一种更实用的 **BYOA**：bring your own agent。你可以把已有的 **agent runtime** 接进 Multica，让任务分配到具体 runtime 上执行。这样做有两个直接的好处。

- 第一，执行环境天然是分布式的。任务可以落到某一台具体主机上的具体 runtime 上运行，而不是都挤在同一个中心化服务里。
- 第二，已有的 agent 工具链可以直接复用。某个 runtime 本地有什么 skills、MCPs、CLI、沙盒能力，就能在执行时直接使用，不需要为了接入平台再重写一遍。

我会觉得它更靠谱，因为它最后落到的就是两个**稳定接口**，而且这两个接口刚好能把调用关系接成一个闭环。

- **application -> daemon -> agent runtime**：任何应用如果想利用 agent 的能力，只要能通过 daemon 接上 agent runtime，就能把任务交给已有的执行环境处理。
- **agent runtime -> tool -> skill/cli**：任何 agent runtime 如果想利用外部应用的能力，只要那个应用提供了 tool、skill 或 CLI 入口，runtime 就能直接调用它。

这两个方向一旦同时成立，**Multica**、**Brains** 和 **agent runtime** 就不再是孤立的点。你可以从任何一个应用出发去调用另一个应用的能力，也可以把它们继续串成**串联**、**并联**甚至**网状结构**，慢慢长出新的产品和能力。

\`\`\`mermaid
flowchart LR
    subgraph Application
      A1[Application: Multica]
      A2[Application: Brains]
    end
...
我很喜欢这层抽象的原因，是它足够轻。只要工具本身边界还算清楚，往往不需要重做平台；补齐 **daemon**、**CLI**、**skill** 这些接口，就能把已有工具快速接进 agent 工作流。

## Brains 补上的是知识管理自动化

只有任务系统还不够。Agent 可以执行，不代表它知道该怎么执行；Agent 可以解决一次问题，不代表这次经验会以正确的形式留下来。

这也是我把 Brains 接进 Multica 的原因。

**Brains** 本质上是我自己搭建的 **llm-wiki**。我给它做了命令行入口，也就是 **Brains CLI**，把知识库的读取和写入整理成 agent 可以稳定调用的接口。

然后我在 Multica 里创建了一个 \`brains\` agent，把这套 **Brains CLI** 的调用方式、适用场景和回复结构声明清楚。这个 agent 只做两件事：\`query\` 和 \`ingest\`。这样一来，**Brains** 成了任务流里随时可以被调起的**知识角色**，而不只是一个静态文档库。

这里补上的，不是“多一个知识工具”，而是**知识管理自动化**。任务执行过程中天然会产生很多过程式知识，但其中大部分并不具备长期沉淀价值。比如：
...
这些内容对任务当下很重要，所以应该被 **issue / comment / log** 完整承接；但如果不经过筛选就直接写进 **llm-wiki**，知识库很快会失真。**Brains** 要做的，正是把这些过程材料筛成真正值得保留的结论、经验、约束和证据，再压缩成可复用的**知识页**。

这样，“问题拆分 -> 计划讨论 -> 受控执行 -> 经验编译 -> 知识沉淀”就被串成了一个闭环。
...
比如我创建一个 issue：\`why kubernetes pod crashed\`。

接下来的协作可以非常自然：

1. assign 给 \`@brains\`，先从知识库里找相关 runbook、排查经验和过去案例，列出初步建议。
2. 在 comment 里 \`@planner\`，让它把排查动作拆出来，说明哪些步骤只读、哪些步骤有风险、哪些地方需要我确认。
3. 再交给对应的执行 agent （如 \`@devops\`），在我确认以后执行需要落地的动作。
4. 最后 \`@brains\` 总结这次事件，把过程和经验写回 Brains。

这个流程最有价值的地方，是它把排查这件事变成了可协作、可回放、可筛选、可积累的过程。过去很多运维经验都死在聊天记录、终端历史和人的记忆里；现在它可以先作为任务资产被完整保留，再作为知识资产被有选择地沉淀下来。

## 从业务视角看，这其实是两个天然分开的领域

写到这里，其实也更清楚了：任务管理和知识沉淀同样重要，但不该被混成一个系统。

- **任务系统**关注推进：谁来做，做到哪一步，讨论过什么，决定了什么，执行结果是什么。它天然容纳过程信息，而且过程越完整越好。
- **知识系统**关注压缩和复用：哪些结论值得保留，证据链是什么，置信度如何，未来谁还能复用。它天然要反过程化，而且越精练越好。

如果直接把任务内容当知识，结果通常是双输：知识库被过程噪音淹没，任务系统也会因为过早压缩而失去上下文保真。

所以我更愿意把它理解成 agent 时代的 **\`jira / confluence\` 分层**：前者管理推进，后者管理知识。**Multica** 和 **Brains** 的组合，刚好把这两个领域重新接了起来，而且它们之间还能通过 agent 自动流动。

## 这套模式为什么真的改变了我的工作流

我现在越来越倾向于把 Multica + Brains 看成一个平台模式，而不是两个工具的偶然组合。原因不复杂：它把三个**自动化层次**刚好扣上了：

- **问题拆分层**：Multica 用 issue、comment、assign 组织协作关系，把复杂问题拆成可推进的任务。
- **任务执行层**：Multica 配合 daemon + runtime，把已有 agent runtime、安全边界和本地能力接进来。
- **知识管理层**：Brains 把检索、编译和沉淀接进同一条任务链路。

这三层结合以后，agent 才不再只是执行器，而会以团队成员的身份参与任务推进，并在任务结束后帮助我把经验转换成真正可复用的知识。

我尤其看重的是它的扩展性。只要接口保持稳定，这个模式就能继续复制到更多场景：

- 给任何外部系统补一层 CLI + skill，agent 就能比较低成本地学会调用它。
- 给任何 agent runtime 补一层 daemon 接入，产品就能比较低成本地拥有 agent 执行能力。
- 给任何复杂任务补一层 issue/comment 协作结构，人和 agent 就能在同一条线程里沟通，而不是来回切换工具。

从工程实现上看，这比“先设计一个超级智能的大一统平台”更靠谱，因为每一层都能独立演进，也能单独替换。对我自己来说，变化也很实际：以前**任务管理**、**agent 执行**、**知识沉淀**是三件分开的事；现在它们第一次被接成一条链，而且不再需要我手动搬运，而是可以由 agent 在明确边界内持续推动。

![example](../assets/202605-multica-brains-agent-kanban/1778475581203.png)

## 还没解决的问题

这套模式已经很有吸引力了，但还有几件事需要继续验证。

- **权限边界怎么做得更细。** \`planner\` 只读、\`devops\` 可写这种角色分层很有用，但再往下走，还需要更明确的审批、审计和回滚设计。
- **知识回写的质量怎么保证。** 不是每一次 issue 处理过程都值得进入长期知识库，Brains 还需要更清晰的筛选和编译规则。
- **跨 agent 协作怎么避免噪音。** agent 越多，comment 和 sub-issues 越容易膨胀，平台需要更好的路由、去重和收束能力。

这些都不是小问题。但它们恰好说明，这条路值得继续走：因为真正有价值的平台问题，通常都发生在“已经能跑起来”之后。

## 结尾

如果只把 agent 当成一个更聪明的聊天对象，我们得到的大多还是局部效率提升；但把它放进任务系统、运行时系统和知识系统的交叉点里，它才可能真正成为团队协作者。

对我来说，Multica 解决的是“怎么让 agent 进入任务流”，Brains 解决的是“怎么让经验留下来，并在下一次任务里继续发挥作用”。所以我会把这套组合看成一个真正的工作台，而不只是几个能调模型的工具拼盘。

## 术语表

| 术语                     | 在本文中的含义                                        |
| ------------------------ | ----------------------------------------------------- |
| Agent                    | 任务中的角色，如 \`brains\`、\`planner\`、执行 agent      |
| Agent Runtime            | 承载 agent 执行的工具或环境，如 opencode、claude code |
| Multica / Brains         | 指应用或系统本体                                      |
| Multica CLI / Brains CLI | 指它们各自的命令行入口                                |
| CLI                      | 调用入口，如 \`multica ...\`、\`brains query ...\`        |
| Daemon                   | 连接 Multica 和 agent runtime 的桥接层                |
`,Lo=`---
category: "node/agentic"
title: "从数月到一周：Agent Coding 的治理闭环"
date: "2026-05-24"
description: "复盘一次平台工具重写，说明 SPDD、TDD、ADR 和项目级治理如何把原本需要数月的重写周期压缩到一周左右。"
tags:
  - "node/agentic"
  - "SPDD"
  - "TDD"
...
我们有一个内部效率工具，是两年前做出来的。当时投入有限，后来又长期缺少稳定人力继续演进，技术债越积越多，开发和维护都变得越来越艰难。

它的上一版，花了一整个开发团队数月时间。这一次，在一个 agent engineer + 数个 agents 的协作下，大约一周就完成了主要功能重写、测试补齐和验证闭环。

一个直接的触发点，是看到 “Anthropic’s Bun Rust rewrite merged at speed of AI” 之后，对 agent 编码这件事有了新的认识：在 Agent 的帮助下，与其继续在一套债务缠身的老系统上“屎上雕花”，不如直接重写，从根源上解决问题。

重点并不在“agent 写代码有多快”，而在另一件事：**agent 最大的价值，在于把项目管理、架构决策、代码实现和结果验证压进一个连续闭环。**

如果没有这个闭环，agent 只会把已有问题放大。它能把正确路径放大，也能把错误设计、模糊需求和错误抽象更快地扩散出去。

![report](../assets/202605-spdd-agentic-refactor/1780883130955.png)

## 这次真正缩短的，不只是编码时间

这次的主力组合：模型主要用 \`gpt-5.3-codex\`，运行时主要用 OpenCode。

真正决定结果的，是项目一开始就先把治理骨架搭起来了。模型版本当然重要，但它不是这次的决定性因素。

一开始就用 [mattpocock/skills](https://github.com/mattpocock/skills) 里的 \`grill-me\`，对 plan 做了多轮拷问；又参考 [forrestchang/andrej-karpathy-skills 的 CLAUDE.md](https://github.com/forrestchang/andrej-karpathy-skills/blob/main/CLAUDE.md)，单独做了一个 coder agent，作为 coding 阶段的 init prompt。

这两个动作的作用很直接：在开始写代码之前，先把问题定义、边界、步骤、非目标、风险和验证条件钉住。这样进入实现阶段时，agent 拿到的就是一套已经收敛过的执行前提。

所以这次被缩短的，不只是编码时间，而是需求澄清、方案来回拉扯、返工和架构漂移的时间。

## Agent Coding 首先是项目治理问题

现在越来越确定，Agent Coding 在项目级别首先是“治理”问题，不只是“提效工具”问题。
...
这也是为什么这次重构里，代码并不是最先写出来的东西。先行的是 plan、ADR、instruction、skill，以及把这些内容串起来的 \`CLAUDE.md\`。

在重写和重构场景里，这些东西往往比代码本身更稳定。代码是流动的，spec 才是控制面。谁先稳定，谁就应该拥有更高优先级。

## 和 agent 协作，前提是需求清晰且结果可验证

这次经验里最值得强调的边界条件，其实很朴素：**agent 协作必须需求清晰，而且结果必须可验证。**

如果需求本身高度模糊，或者完成条件说不清楚，agent 当然也能干活，但它更可能只是更快地把模糊实现出来。速度越快，返工越大。

所以，对 agent 项目的一个基本判断是：

- 执行前，要先做好需求分析和步骤拆解
- 执行中，要强制跑 TDD loop
- 执行后，要有强约束的 verification、checkpoint 和边界追问

这不是形式主义。agent 的代码产出速度太快了，人已经不可能只靠人工 review 来承担全部兜底责任。更多信心必须前移到约束、测试和验证上。

## 为什么这次几乎没有太多 revert

实现过程中不是完全没有问题，但确实很少出现大幅 revert。

原因很直接：前面那套 harness 已经把偏航空间压小了。agent 不是神奇地一次就写对了。

实际碰到的问题，更多是这类项目和这套预配置下容易出现的偏差，例如：

- 过度设计，比如过多的 factory、interface 抽象
- package 拆得过碎，局部整齐但整体可维护性下降
- 生成大量冗余代码和重复结构

这些问题不一定具有普适性，但它们说明了一件更通用的事：**不能完全依赖，更不能直接放手给 agent。**

因为 agent 一旦跑偏，破坏力和扩散能力也是成倍增加的。一个人写错一段代码，影响可能还是局部的；agent 如果在错误约束下高速生成，错误会很快扩散到多个包、多个抽象层和多条调用链里。

更关键的是，要有能力把偏差重新收敛成稳定约束，而不是等它扩散之后再回头修补。

## 偏差要回到架构决策，不要停在局部修补

这次最有价值的一点，是把偏差处理从“代码修补”提升到“架构治理”。

当我发现某类问题反复出现时，做法不是只改当下这几个文件，而是通过 \`architecture improve + grill-me\` 把问题重新压回 ADR：哪些抽象不该有，哪些边界需要收紧，哪些职责应该重新归位。然后再由 \`CLAUDE.md\` 统一索引这些 ADR，让它们成为后续编码时的稳定前提。

这样做的价值很明显：agent 不会在同一类问题上反复犯错。约束已经升级成了项目级规则，不再只是一次性的聊天上下文。

## multi-agent 并行开发，前提不是更多 agent，而是更好的切分

很多人一谈 agent，就会自然想到 multi-agent。这里的看法更保守一点：**multi-agent 只是 plan quality 的放大器。它不是起点。**

如果总 plan 没有把 workstream、step、边界和 verification point 写清楚，多 agent 只会把混乱并行化。切片足够小、边界足够清楚时，多 agent、sub agents 和 git worktree 才会真正好用。

比较稳的方式是：

1. 先用总 plan 定义目标边界、非目标和统一验收门槛
2. 再把任务切成独立 workstream 和可执行 step
3. 每一步只交付一个小而可验证的 slice
4. 高风险任务放进独立 worktree
5. 每完成一段就回到 verification 和 checkpoint

所以 multi-agent 的前提很明确：切分越清楚越好，不是 agent 越多越好。

## TDD 是 agent coding 的必备项，不是可选项

在这次重构里，TDD 不是锦上添花，而是核心运行机制。

原因也很简单：agent 写代码的速度，已经快到人类无法只靠 review 保证细节正确性了。人更适合做需求判断、边界判断、风险判断和取舍判断。局部实现是否真的满足要求，必须更多依靠 tests 来回答。

所以在 agent coding 里，TDD 不只是“提升代码质量”的手段，它承担的是更基础的职责：

- 保证局部切片没有跑偏
- 保证分层职责没有塌掉
- 保证重构速度上来以后，正确性不会一起掉下去
- 保证最终的 verification 有可靠基础

如果说 SPDD 管的是“先定义清楚要做什么”，那 TDD 管的就是“做出来的东西到底算不算完成”。

## token cost 真正该盯的是 cache IO

这次过程数据里还有一个很有意思的观察：整个重构过程中，大约消耗了 **35M 的 I/O tokens**、**1.3B 的 cached tokens**，对话规模到了 **100+ sessions**。

但实际 token 花费反而比我预期低得多。大多数 token 都走了 cache，整个过程里的返工也不多。

这背后其实就是两件事。重写天然会反复读取已有的大量代码和文档，所以 cached context 本来就高。持续更新的 ADR 和 plan 又提供了稳定而有效的上下文，agent 不需要反复猜需求、猜边界、猜实现方向，生成代码也更容易一开始就落在正确轨道上，返工自然会少很多。

所以真正该盯的，是上下文复用效率，以及这些上下文是否真的在提升正确性。表面的 prompt 长短没有那么重要。ADR、plan、instruction、skill 写得越清楚、更新得越及时，缓存和上下文复用的收益就越大，也越有机会把 token 消耗和返工一起压下来。

## 一份可直接执行的行动清单

如果要把这次经验压成一份能直接拿去用的清单，可以按下面这套顺序执行。

### 执行前

1. 先做需求分析，不清楚的问题先澄清，不带着模糊需求进入 coding
2. 先写 plan，明确边界、非目标、步骤和 verification 条件
3. 用 \`grill-me\` 反复追问 plan，直到主要风险和缺口被暴露出来
4. 准备好 coder agent 的 init prompt，让编码阶段有稳定行为约束
5. 明确哪些规则要进 \`CLAUDE.md\`、哪些要落 ADR、哪些要进 instruction

### 执行中

1. 坚持 small, verifiable slices
2. 强制跑 TDD loop，不要让实现先于测试失控扩张
3. 需要并行时，先拆 workstream，再上 multi-agent
4. 高风险改动放进独立 worktree，减少相互污染
5. 发现偏差时，不只修代码，必要时升级成 ADR 和项目级约束

### 执行后

1. 用强约束 verification 检查结果，而不是只看“代码写完了”
2. 设 checkpoint，逐段确认目标是否真的达成
3. 持续做边界追问：哪些抽象不该存在，哪些规则还没被固化
4. 把新沉淀的约束回灌到 \`CLAUDE.md\`、ADR、plan 和 instruction

## 最后一句

这次最大的收获，不是“agent 终于能替开发写代码了”。我更确认了一件事：**当 agent 成为主要执行单元之后，工程重点会前移到需求澄清、spec 设计、执行约束和结果验证。**

从数月到一周，真正缩短的不是思考本身，而是那些原本散落在多人协作、反复沟通和返工里的损耗。前提很简单：先把项目治理这件事做好。
`,$o=`---
category: "node/agentic"
date: "2026-06-08"
title: "Agent 正在改变服务间互联方式"
description: "在 Provider 保持 OpenAPI 不变的前提下，Agent + Skill 可能接管一部分 Client 侧集成逻辑，让服务间调用更语义化。"
tags:
  - "node/agentic"
  - "OpenAPI"
  - "Skill"
  - "integration"
image: "/blogs/assets/202606-agent-changes-service-interconnection/choreography.svg"
---

在实现了 multica + brains 的共生系统后，我开始反过来想一个问题：Agent 应用之间到底该怎么调用。它们自己已经有 Agent 模块，能调用 Agent 能力；但与此同时，我又希望它们能彼此连接，甚至被 openclaw 这类前台 Agent 统一管理。这样一来，怎么标准化调用关系，怎么限制、规划和设计大大小小的 Agent 能力边界，就成了一个问题。

过去在微服务和复杂系统里，我们其实已经有一套相对成熟的互联方式：Service Provider 暴露 OpenAPI，Service Client 负责调用，再把多个接口拼成业务流程。这套方式很有效，但它缺少业务语义，调用方往往还是要写很多定制逻辑。

如果把 API 保留给 Provider，把业务规则补进 Skill，再让 Agent 充当 Client，服务间调用也许会变成另一种样子。

## 传统互联方式，问题不在 API 本身

过去的典型模式很清楚：Service Provider 暴露 OpenAPI，Service Client 基于接口定义生成或编写调用代码，再把多个接口拼成业务流程。这套模式没有问题，它解决的是标准化调用。

但它的缺口也很明显：**API 定义的是能力边界，不定义业务规则。** 即使是 HATEOAS 或 GraphQL，也更擅长处理资源访问和查询表达，不太擅长直接承载这类业务规则：当订单金额小于 100 时，先查库存，再推荐一个适合“随手加一件”的商品。

这些逻辑以前当然也能做，只是往往要写很多定制代码，把多个 API、业务规则、异常处理和流程判断缝在一起。

## Agent 让调用方开始带着业务规则工作

Agent 出现之后，我越来越觉得，应用间互联可能会多出一种新的实现方式：

- **Provider 继续暴露 API**
- **Skill 补上业务规则、用户用例、多个 API 之间的业务联系，以及调用策略**
- **Agent 作为调用端，加载 skill 后去理解并调用这些能力**

也就是说，可以把它粗略理解成：

> **OpenAPI ≈ Skill + API**

我不是想替代 OpenAPI。更像是在说：**传统 OpenAPI 主要解决“能不能调”，而 Skill 补上了“在什么业务语境下怎么调”。**

Skill 里可以放的不只是接口说明，还可以包括：
...
这样一来，Service Provider 基本不需要变化，真正变化最大的其实是 Client 侧。过去要靠代码实现的大量集成逻辑，未来可能有一部分会转成 Prompt + Skill 驱动的调用和编排。

## 两种模式：Choreography 和 Orchestration

这件事我觉得可以分别从 Choreography 和 Orchestration 两种模式来看。

![Choreography：多个 Agent Client 基于 Skill 通过 CLI/MCP 调用三个服务 API](../assets/202606-agent-changes-service-interconnection/choreography.svg)

在 **Choreography** 里，没有一个中心编排者。每个应用或服务仍然像微服务一样协作，只是 Service Client 不再只是硬编码逻辑，而可以由 Agent + Skill 来承担，因此调用会更语义化、更业务化。

![Orchestration：Supervisor Agent 基于 Skill 通过 CLI/MCP 编排多个服务 API](../assets/202606-agent-changes-service-interconnection/orchestration.svg)

在 **Orchestration** 里，我觉得更有意思：位于中心的管理者，甚至可以完全由 Agent 来实现。也就是一个 Supervisor Agent，在掌握必要上下文之后，去自主调用各个应用和服务，完成原本需要大量 Client 代码才能完成的集成流程。

说“0 代码开发”肯定是夸张了。更接近的说法是：在 Service Provider 已经提供标准 API 的前提下，**Client 侧那部分定制化集成代码，可能被 Agent + Skill 大幅替代或减少。**

## 我现在更倾向于这样理解它

这还是一个很早期的个人想法，但我现在越来越倾向于这样看：**Agent 不只是给现有应用加一个智能模块，它也可能成为下一代 Service Client。**

如果这个方向成立，未来应用间互联要开放的，可能就不只是接口，还有能力和业务规则。

## Needs Verification

- \`Skill\` 的最小可复用结构，还需要更多实践验证。
- 哪些 Client-side 集成逻辑适合被 Agent 替代，哪些仍然应该保留在代码里，需要更清晰的边界。
- Supervisor Agent 在真实生产场景下的可靠性、审计和失败处理，还需要更多样本。
`,No=`---
category: "domain"
title: "敏捷开发、Agent、ThoughtWorks"
date: "2026-06-09"
description: "从敏捷实践、Agent 协作和 ThoughtWorks 的训练方式，回看软件团队真正依赖的能力：对齐、拆解、表达与建模。"
tags:
  - "domain"
  - "agile"
  - "agent"
...
- “个体和互动 高于 流程和工具”，要求大家语言一致，理解一致，最好我说半句，你就知道后半句是什么。
- “工作的软件 高于 详尽的文档”，要求大家对代码足够熟，不然没有文档，心里就发虚。
- “客户合作 高于 合同谈判”，要求大家能理解需求，知道客户嘴上说的是什么，背后真正要的又是什么。
- “响应变化 高于 遵循计划”，要求大家既能快速执行，又能在未知领域里不乱掉。

说到底，这些话的意思都是一样的：团队成员要有比较一致的**业务能力、技术能力和协作能力**。最好你一个眼神，我就 get 到你是想创建接口、重构实现，还是准备砍需求、改设计。

这是个很高的要求。

## 敏捷工程实践

看一眼敏捷宣言的签署者名单，也确实，他们大概是有这个能力和认知的。

但现实是，你是不可能在招聘市场上找到 Martin Fowler、Kent Beck 的；你也没法克隆你自己，来组成一个共享脑电波的团队。

所以，我们才需要各种敏捷的**仪式**：Standup、IPM、Sprint Review、Retrospective、Backlog Refinement；各种技术**实践**：Pair Programming、TDD、重构、Code Review。

当然，通常被吐槽“假敏捷”的对象，也是这些“仪式”：站会过流水账，评审开成老板秀，回顾是吐槽大会，结对成了示范表演，Code Review 成了一起来找茬。

因为本质上，这些活动都是为了达成敏捷宣言里那个高要求：**同认知、同能力**。

- **降低任务复杂度的上限**。Backlog Refinement、IPM 先做需求分析、任务拆分，再靠各种会议同步信息、传递上下文，尽量别让大家各自脑补，最后做出来五个版本。
- **提升团队能力的下限**。Pair、mentor、分享、Code Review，本质上都是在做人才梯队，让新加入的同事尽快接近平均能力线，而不是全靠几个老师傅硬撑。

一上一下，把团队的能力提升到基线以上，你才能谈后面的东西：迭代式开发、估点、自由捡卡、Trunk-Based 开发、自动化测试替代一部分 Code Review。

## Agent as Colleague

**Agent 的能力**，当然还是取决于使用者的能力和技巧。你问得清不清楚，拆得好不好，约束写没写明白，差别会很大。

和人一样，你需要去训练它，培养它，甚至是管理它。你得让它知道什么样的结果是好结果，什么样的结果是坏结果；你得让它知道什么样的行为是被鼓励的，什么样的行为是被禁止的；你得让它知道什么样的目标是重要的，什么样的目标是次要的。

另外，Agent 还具备两个人类同事没有的特点：

一个是，它的能力可以**大量复制**。Multi-Agent、Sub-Agent 可以并行跑起来。你不是多了一个助手，你是多了一个可以随时拉起来的小队。

另一个是，它的能力几乎可以**即时获得**。Skills 即插即用，你不需要等新人培训。装上 Frontend Skill，马上就能帮你写 React 组件。

如果把 Agent 当成团队成员来看，你会发现它天然接近敏捷的需要：**同认知、同能力**，而且还能横向扩容、纵向升级。

- “个体和互动 高于 流程和工具” —— 某种意义上，真的就是 chat with agent。
- “工作的软件 高于 详尽的文档” —— agent 会去读你的代码，而且通常读得很认真。
- “客户合作 高于 合同谈判” —— 你不用谈判，你自己就是需求方。
- “响应变化 高于 遵循计划” —— 你随时改主意，它就跟着重跑。

## 200x??

上个月，我利用 Agent 重写了一个内部工具。**1 human + 3~5 Agents** 的团队组合，最后评估出来的**效率提升接近 200x**。

这个数字单看，确实有点夸张，像某种卖课营销号。

但如果你把这些 Agents 都当成真实可协作的同事来看，这件事就没那么玄了。无非是一个 6 人的全功能团队：1 个 PO/BA，加上 5 个 developer/tester。

这样一拆，平均下来，也就是 30x 左右。

再往下算，还有很多以前默认会消耗的时间被省掉了：会议、培训、上下文同步、等人、找人、休息、吃饭。硅基生物毕竟只吃电，不吃外卖。

再平均一下，可能也就**10x** —— 顶尖程序员可以达成的量级。

所以，Agent 不只是代码写得快。更重要的是，它是以团队的方式在工作。它的效率提升，来源于它在多个维度上放大了人的能力：**执行力、协作力、学习力**。

> 如果你对这个 rewrite 的过程感兴趣，也可以看我前面那篇 [从数月到一周：Agent Coding 的治理闭环](./202605-spdd-agentic-refactor.md)。

## ThoughtWorks

ThoughtWorks 是一家优秀的公司。很多时候，它更像一所大学。

现在回头看，在 ThoughtWorks 里的典型成长路线，是 “**Thought Worker**”：先分析，再思考，最后才是写代码。

我们那时候很看重敏捷、**Pair、TDD、DDD** 这类训练，每天讨论建模、分析、评估，各种框架和方法论。

以前有一段时间，我其实也会疑惑：为什么要花这么多时间在这些和写代码不相关的事情上？直接 CRUD 不好吗？

现在再看，这些能力恰恰决定了你能带出的**Agent 团队**的规模和质量。

作为 Tech Lead，你个人能力再强，也未必能稳定做到 10x 于别人。

能不能把问题定义清楚，能不能做好拆解，能不能识别边界和风险，能不能把模糊需求变成稳定约束，却决定了你能不能带出 10x 团队。

- Pair、TDD、DDD 分别训练沟通协作、边界识别、抽象建模，敏捷训练反馈和调整。
- 就连当初的“博客大赛”，现在回头看，锻炼的也不只是写作能力。它训练的是**表达能力**：把你脑子里的东西讲清楚。放到今天，这就是和 Agent 准确沟通的必须技能。

某种意义上，**“1 带 8”** 在另一个维度实现了。
`,Oo=`---
layout: blog-list
...
description: "Walkthrough of migrating from Trello and Typora to Logseq, showing a capture–organize–execute workflow that turns scattered notes into a trackable wiki."
tags:
    - "domain"
    - "PKM"
    - "logseq"
...
description: "Explores how developers can build a transferable, amplifiable capability network across cloud‑native evolution and career practice, rather than chasing isolated skills."
tags:
    - "mesh"
    - "架构设计"
    - "工程实践"
...
description: "Timeline of Docker's rise, OCI runtime standardization, and Kubernetes runtime shifts, clarifying relationships between dockerd, containerd, runc, CRI, and OCI."
tags:
    - "node"
    - "K8s"
image: "https://pic2.zhimg.com/v2-8eab1606a489aa28545ed7f984f80b01.jpg"
...
description: "A boundary‑first distinction between routers, proxies, and gateways by network layer and responsibility, preventing terminology mixing in architecture discussions."
tags:
    - "node"
    - "api-design"
image: "/blogs/assets/202205-router-proxy-gtw/2022-05-25-10-21-15.png"
...
description: "Frames cloud‑native adoption as building an engineering system—standardized capabilities, team responsibilities, and organizational evolution—to turn buzzwords into delivery outcomes."
tags:
    - "node"
    - "IaC"
    - "DevOps"
...
description: "Reusable Logseq GTD queries and CSS tweaks that turn scattered TODO blocks into an actionable task dashboard (doing, scheduled, next, etc.)."
tags:
    - "domain"
    - "logseq"
image: "/blogs/assets/202212-logseq-customized-with-clojure-and-css/1645694079239.jpg"
...
description: "Describes implementing a Mesh‑Shaped PKM on Logseq: input capture, task and note cycles, and feedback loops that turn recording into sustained capability growth."
tags:
    - "domain"
    - "PKM"
    - "logseq"
...
description: "Explains how IaC enables immutable infrastructure and how to structure Terraform projects—from simple stacks to layered multi-environment platforms—to reduce drift and improve reuse."
tags:
    - "domain"
    - "IaC"
    - "DevOps"
...
description: "A practical approach to drawing architecture diagrams: identify the audience and the key message, then structure information accordingly."
tags:
    - "mesh"
    - "architecture"
    - "software-design"
...
description: "Clarifies Tunnel, VPN, and VPC from a networking perspective, focusing on their roles in connectivity, security, and virtual network abstraction."
tags:
    - "node"
    - "networking"
    - "K8s"
...
description: "Compares four cloud-native debugging approaches—image swap, VPN peering, dev containers, and web IDEs—analyzing costs, benefits, and applicable boundaries."
tags:
    - "node"
    - "K8s"
    - "devx"
...
description: "A practice-driven framing of Agile and Lean overlaps in software teams—goals, methods, and organizational evolution—with a focus on executable practices."
tags:
    - "domain"
    - "productivity"
    - "automation"
...
description: "Practical guidance for DevContainer in multi-language projects—defining, building, connecting, and sharing containers to reduce local drift and version conflicts."
tags:
    - "node"
    - "IaC"
    - "Go"
...
description: "Transforms diagrams into a thinking tool with a four-step method—reproduce, diverge, converge, recombine—to build reusable cognitive structures."
tags:
    - "mesh"
    - "architecture"
...
description: "Traces LLM application evolution from prompts to vector search, caching, and orchestration, with practical local stack options using Ollama and LangChain."
tags:
    - "node/agentic"
    - "LLM"
    - "Prompt"
...
description: "Examines real-world AI use cases, balancing efficiency gains with replacement anxiety and advocating for AI as an amplifier rather than a substitute."
tags:
    - "node/agentic"
    - "LLM"
    - "Prompt"
...
description: 'Recap of integrating AI into a Mesh-Shaped PKM, shifting focus from note-taking to task-driven workflows and feedback loops that boost execution.'
tags:
    - "domain"
    - "PKM"
    - "logseq"
...
description: "DomainSpec uses transferable specification artifacts to carry business context from discussion through implementation and verification, reducing semantic drift."
tags:
    - "mesh"
    - "Architecture Design"
    - "Engineering Practice"
...
description: "Breaks Agent development into modular design, outcome‑driven delivery, and continuous evolution, mapping each to concrete components and practices."
tags:
    - "node/agentic"
    - "agentic"
    - "LLM"
...
description: "Outlines a layered platform engineering evolution from standardization to API‑driven self‑service, emphasizing thin slices that validate end‑to‑end delivery."
tags:
    - "node"
    - "K8s"
    - "IaC"
...
`,oi=`---
category: "domain"
title: "From PKM to Brains: Letting a Knowledge Base Evolve Under Rules"
date: "2026-04-13"
description: "Evolving a personal knowledge base from note storage to a layered Brains architecture, covering input, knowledge, output layers and agent edit boundaries."
tags:
  - "domain"
  - "PKM"
  - "LLM"
...
At the beginning of the year, when I switched from Logseq to VSCode + Foam, the first thought I had was: the nature of a knowledge base has changed. Storage has become cheaper; judgement has become more expensive. That's why I upgraded PKM into Agentic Brains: it's no longer merely a storage system, but a knowledge system that continuously evolves under constraints.

As Logseq updates became fewer and slower, I initially wanted a place that integrates Copilot more conveniently. I found the issue wasn't the tool itself but the whole workflow. Although VSCode + Foam is less convenient than Logseq for queries and task management, it allowed me to weave AI naturally into writing, organizing, and distillation workflows.

The shift is straightforward. In the past, knowledge management focused on storage, retrieval, and linking; now, with AI driving acquisition costs toward zero, the emphasis shifts to thinking, distillation, and decision-making. Previously I manually excerpted, organized, and built backlinks; today many raw sources can be kept as links, dialogues, or drafts — what truly requires my attention is deciding whether they deserve promotion into the knowledge layer.

Karpathy's “LLM Wiki” recently gained attention in the community and precisely filled the gap I had: explicitly making "compilation" part of the knowledge update process. Web pages scraped from around the web, AI chat logs, or content generated by agents from a single prompt are all input-layer materials; they must be compiled into knowledge-layer outputs under clear rules. That way the knowledge base becomes more accurate with use, rather than messier.

## Minimal Brains Architecture
...
flowchart TD
  ...
  subgraph R[Rules Layer]
    agents[AGENTS.md]
    soul[SOUL.md]
  end

  raws --> synth[organize / distill / select]
  journals --> synth
  synth -->|compile & promote| pages
  pages --> outputs
  agents -.boundary.-> synth
  soul -.style.-> outputs
\`\`\`

I currently split the knowledge base into four layers so responsibilities are clear:

- Input layer: \`raws/\`, \`journals/\`. Stores raw information, quick notes, and unprocessed materials. Emphasize fidelity, not structure.
- Knowledge layer: \`pages/\`, \`pages/OKR/\`. Stores long-lived knowledge that has been distilled, merged, and deduplicated. Agents are allowed to edit here only under authorized rules.
- Output layer: \`outputs/\`, \`outputs/blogs/\`. Contains outward-facing content for writing, sharing, and reuse.
- Rules layer: \`AGENTS.md\`, \`SOUL.md\`. The former defines global boundaries; the latter defines personalized preferences so agents know what they can do, cannot do, and what voice to adopt.

Following Karpathy's idea, I separate raw data from knowledge and specify that agents may only modify authorized items in the knowledge zone. The goal is to put guardrails on evolution and prevent the system from being undone by its own automation.

\`\`\`mermaid
flowchart LR
  raw[raw material: web / chats / drafts] --> compile[compile under rules]
  compile --> evidence[evidence layer]
  evidence --> page[long-lived knowledge page]
  rule[AGENTS.md / SOUL.md] -.constrain.-> compile
  agent[agent] -.write-only.-> page
\`\`\`

## How Rules Are Implemented

A directory structure alone is insufficient; the key is to encode "who may change what" as rules. My approach is simple: preserve the input layer as much as possible, allow authorized modifications within the knowledge and output layers by workflow rules, and centralize those rules in dedicated files.

To keep rules maintainable, I split the agent framework into three types:

- Role / instruction: defines role boundaries — what can and cannot be done.
- Command: defines workflows — how to do things and what the inputs/outputs are.
- Skill: defines reusable capabilities — which abilities an agent can invoke in which scenarios.

This split yields concrete benefits:

- To change input/output formats, edit a command.
- To change governance for knowledge pages, such as adding expire rules or conflict records, edit an instruction.
- To add retrieval, writing, or analysis capabilities, edit a skill.
- To update global constraints or personalized preferences, edit \`AGENTS.md\` or \`SOUL.md\`.

I also extended the framework to include OKR management and blog writing, so the knowledge base, planning system, and content production all live within the same Brains but on different surfaces. For me, this separation clarifies boundaries rather than blurring them.

## Why This Fits the AI Era Better Than Traditional PKM

Traditional PKM assumes humans do the curating and tools handle storage. Brains flips that assumption: storage and preliminary processing get cheaper, while judgement, connection, and iteration become the expensive part.

First, when AI reduces implementation cost, thinking becomes more valuable. Previously an idea required research, organizing, and prototyping before validation; now many steps can be drafted by AI. Your job is to quickly decide whether a direction is worth pursuing and how to iterate. The bottleneck is no longer "can it be done" but "what should be done." 

When a new idea appears, I usually drop it into \`journals/\` or raw notes and let AI do a first-pass filter; only when it repeatedly surfaces in OKRs, writing, or projects do I promote it into \`pages/\`. Storage actions get lighter, but judgement grows heavier.

Second, raw storage is depreciating. We used to laboriously excerpt and archive because absent retrieval meant loss; now incomplete archives can often be reconstructed through search, dialog, and context. The scarce ability is connecting seemingly unrelated items.

This is why cross-domain linking gains importance: AI won't proactively create long-term, preference-aware connections for you. It can explain "what this is" or suggest "next steps," but it won't inherently understand why I place OKRs, blog writing, and governance in the same system, nor why a raw note deserves promotion to long-lived knowledge. Humans still must define the connection rules.

That said, storage still matters for research, compliance, and archival use cases where preserving originals is crucial. My claim applies where continuous distillation, production, and iteration are required.

Ultimately, Brains clarifies one thing: AI lowers implementation cost; humans decide what to keep, what to connect, and what can be changed. Rules preserve the knowledge base's sense of direction.
`,ii=`---
category: "domain"
title: "Logseq Migration Scoring: Five Dimensions, Three Pipelines"
date: "2026-04-13"
description: "Evaluate old notes across five dimensions and route them into A/B/C migration pipelines with thresholds, CSV fields, and calibration steps for execution."
tags:
  - "domain"
  - "logseq"
  - "migration"
...
After building Brains (the LLM Wiki), the first task was to revisit my Logseq vault and extract remaining value. The hardest part of migrating old Logseq notes isn't deciding which content looks useful by feel; it's creating a repeatable, auditable process. I designed a scoring mechanism where agents rate content on five review dimensions, then classify notes into three lanes by score thresholds: ingest now, summarize later, or drop. This replaces ad-hoc judgment with a process that can be audited and calibrated.

Execution rule: high-value, strongly relevant, reusable items go to Lane A; temporarily useful but not worth immediate refinement go to Lane B; low-score, duplicate, or off-topic items go to Lane C.

## The five scoring dimensions — what each filters for

The rubric maps to five fields: \`goal_alignment\`, \`reusability\`, \`uniqueness\`, \`insight_density\`, and \`maintainability\`. They look like metrics but actually answer five personalized questions.

| Dimension        | What it checks                | Signals of high score         | Signals of low score         |
| ---------------- | ---------------------------- | ---------------------------- | --------------------------- |
| goal_alignment   | Does it serve current goals?  | Core theme, directly outputable | Off-topic, unrelated       |
| reusability      | Can it be reused across contexts? | Methods, rules, frameworks   | One-off note, strong context dependency |
| uniqueness       | Is it duplicate work?         | Unique expression, cases, structure | Repeated excerpts, variants |
| insight_density  | Does the piece contain judgement? | Conclusions, boundaries, recommendations | Only material, no distillation |
| maintainability  | Will it be easy to maintain?  | Clear boundaries, easy to reference | Diffuse theme, high maintenance cost |

\`\`\`mermaid
flowchart TD
  score[five-dimension scoring] --> check{duplicate / off-goal?}
  check -- yes --> laneC[Lane C: Drop]
  check -- no --> total{total_score >= 18?}
  total -- no --> mid{11-17?}
  total -- yes --> goal{goal_alignment >= 4?}
  goal -- yes --> laneA[Lane A: Ingest-Now]
  mid -- yes --> laneB[Lane B: Summarize-Later]
  goal -- no --> laneB
  mid -- no --> laneC
\`\`\`

### 1. goal_alignment — does this note serve current knowledge goals?

This dimension asks whether the note aligns with the migration goals. Priority goes to reusable methods, frameworks, and long-lived knowledge, so core themes naturally score higher than generic notes. A simple test: can the note reliably serve the knowledge base's goals or future outputs after migration?

Strongly relevant files (e.g., \`DDD.md\`, \`4+1 View Model.md\`, \`analysis_tools___MECE.md\`, \`architecture_governance.md\`) sit closer to top priority. Light-weight, personal, or marginal notes score lower.

### 2. reusability — can this note be reused across contexts?

Reusability checks whether the note stands on its own across contexts. How well an author wrote it matters less than whether the content describes transferable methods, frameworks, or decision rules. DDD breakdowns, architecture comparisons, and cognitive bias summaries usually fit the knowledge layer; scattered QA, ephemeral ideas, and meeting fragments belong to Lane B.

Lane B is designed as "summary bundles" to recognize: some materials have thematic value but aren’t worth refining one-by-one. They should not be dropped, but they also shouldn’t consume Lane A capacity.

### 3. uniqueness — is this note duplicate work?

Uniqueness addresses redundancy in migration. The plan creates \`duplicate-clusters.md\` to group similar notes, then determine whether an entry is canonical or a variant.

| Duplicate cluster                    | Typical problem       | Handling approach         |
| ------------------------------------ | --------------------- | ------------------------ |
| DDD family                           | multiple expansions   | Find canonical source    |
| architecture style comparisons       | repeated comparison dims | Merge into a thematic bundle |
| cognition micro-bias notes           | fragmented but similar | Aggregate then distill   |
| overlapping workshop Q&A notes       | overlapping Q&A       | Keep the most complete version |

- If a note contains expression, cases, or structure not found elsewhere, it is more unique.
- If it is a shorthand, duplicate excerpt, or partial expansion of another note, down-weight uniqueness.

Without this step, the migrated knowledge base inherits the old system's redundancy.

### 4. insight_density — does the piece contain real judgement per unit length?

Insight density measures "actionable judgement" per unit length. High-density notes contain conclusions, boundaries, or actionable recommendations; low-density notes are often just titles, concepts, or excerpts. Those belong in Lane B's thematic summaries as source material.

The migration plan follows a "synthesis → evidence → pages" path to increase insight density: merge raw materials, distill defensible judgements, and then move items into the long-lived knowledge layer.

### 5. maintainability — will it be easy to maintain once moved?

This dimension prevents the knowledge base from becoming heavier over time. Maintainable content has clear boundaries, stable structure, and is easy to merge and reference; hard-to-maintain content is diffuse, broad, and strongly context-dependent. The plan requires \`inventory.csv\` to record \`primary_category\`, \`secondary_category\`, and \`decision_reason\` to make maintenance costs explicit.

## Threshold rules — throughput control

The plan specifies thresholds:

- \`total_score >= 18\` and \`goal_alignment >= 4\` → Lane A
- \`11-17\` → Lane B
- \`<= 10\` or duplicate / off-goal → Lane C

I emphasize that Lane A additionally requires \`goal_alignment >= 4\`. This enforces the hierarchy: first, serve current goals; second, evaluate overall value.

### Lane A: ingest now

Lane A corresponds to Ingest-Now. Materials here are high-value, strongly goal-aligned, and worth immediate refinement and production line treatment.

Typical candidates include seed DDD, architecture patterns, methods, and core cognitive notes. They are staged into \`raws/*-core-synthesis.md\` and \`raws/*-core-evidence.md\` before promotion to \`pages/DDD.md\`, \`pages/architecture-patterns.md\`, or \`pages/decision-analysis-methods.md\`. Lane A means: enter the production line.

### Lane B: summarize later

Lane B corresponds to Summarize-Later. Scores in 11–17 range indicate items worth keeping but not worth immediate refinement.

These items are bundled by topic, e.g.: \`raws/DDD-extended-notes-summary.md\`, \`raws/architecture-styles-comparison-summary.md\`, \`raws/cognitive-bias-and-heuristics-summary.md\`.

The rule is practical: some items are valuable mainly in groups. Refining them individually is costlier than the benefit.

### Lane C: record and review

Lane C corresponds to Drop, but the plan treats it conservatively. Items with \`<= 10\` or duplicate/off-goal may enter Lane C, but any physical deletion must wait for a full review and explicit confirmation.

Lane C is a ledgered quarantine:

- Record why an item was deprioritized.
- Tag whether it's a duplicate, off-topic, or low-value.
- Revisit deletions only after the full classification is complete.

This prevents premature deletion when scoring rules are still being calibrated.

## Execution: thread scoring, distillation, and ingestion into one line

To make this operational, the crucial factor is whether each step leads to concrete actions: write-backs, auditable records, and human review where needed.

1. Dump all items into \`inventory.csv\`.
   - Record not only filenames, but \`filename\`, \`primary_category\`, \`secondary_category\`, \`goal_alignment\`, \`reusability\`, \`uniqueness\`, \`insight_density\`, \`maintainability\`, \`total_score\`, \`lane\`, \`duplicate_cluster\`, \`decision_reason\`, and \`status\`. That way decisions operate on data, not impressions.
2. Wrap the CSV into a CRUD interface via Python scripts.
   - I avoid letting agents directly edit the table; instead, encode interaction rules in prompts so agents read, compute, and write according to rules.
   - In short: program the rules, then let agents follow them to reduce ad-hoc deviations.
3. Score in batches of 20 items.
   - Agents analyze each batch and use the Python script to write scores, categories, lanes, and reasons back to the CSV.
   - The first round's goal is coverage: score everything, don't refine. After each batch, output grouped results and surface items needing manual confirmation, especially boundary cases, duplicate clusters, and disputed items.
4. After initial screening, perform distillation in batches of 20.
   - This round focuses on converting surviving materials into \`raws\`-level source materials that the knowledge base can accept.
   - Agents analyze, scripts persist results, and humans confirm edge cases; the outcome is not polished notes but screened and synthesis-ready raw materials.
5. Finally, after distillation completes, run \`/kn-ingest\`.
   - This step ingests curated \`raws\` into the knowledge base; only now does scoring, distillation, and ingestion form a closed loop.

At the end, I obtained ten highly distilled, well-structured, and reusable core notes (Lane A).

## Example

![Theme Wave 01](../../../blogs/assets/202604-logseq-scoring-overview/1776153628712.png)
`,si=`---
category: "agentic"
title: "Multica + Brains: Closing the Loop Between Task Flow and Knowledge Flow"
date: "2026-05-11"
description: "Use Multica to split and drive tasks, then use Brains to distill reusable knowledge and turn an agent workflow into a replayable, accumulative closed loop."
image: "../assets/202605-multica-brains-agent-kanban/1778475581203.png"
tags:
  - "agentic"
  - "kanban"
...
**My view is this: workflow automation needs to cover at least three things at the same time — problem decomposition, task execution, and knowledge management — and they need to form a closed loop.**

The starting point was actually very concrete: I found that managing **TODOs** purely in **Markdown** could no longer carry complex work. Markdown is good for ideas and conclusions, but it does not hold task state, dependencies, collaboration history, or intermediate decisions very well. That process information matters a lot while a task is moving, but most of it does not deserve to be stored directly in a long-term knowledge base after the task ends.

So my conclusion became: if I want my personal workflow to become an **automated closed loop**, I need to separate **problem decomposition**, **task execution**, and **knowledge management**, then connect them again in a deliberate way. After I connected [Brains](202604-llm-wiki-self-evolving-brains.md) to Multica, that judgement became more concrete: Multica handles decomposition and collaboration, the agent runtime handles execution, and Brains distills and writes knowledge back. Together, they form a closed chain.

\`\`\`mermaid
flowchart LR
    A[Problem / Idea] --> B[Multica\\nSplit into issue / project]
    B --> C[Agent Runtime\\nExecute task]
    C --> D[Task process\\ncomment / log / decision]
    D --> E[Brains\\nDistill / ingest]
    E --> F[Reusable knowledge]
    F -.query.-> B
\`\`\`

If you follow that line of thought, the chain really has three parts: how Multica makes problem decomposition manageable, how the agent runtime picks up execution, and how Brains turns experience into reusable knowledge.

## Multica gets problem decomposition into shape first

What interests me most about Multica has two layers. The first is simple: it is a very good **kanban tool**. Once I decided to pull **task management** out of Markdown, I needed a place that naturally expresses task status, dependencies, and collaboration history. **Multica** does that with almost no detour: issue, comment, project, repository, and parent/sub-issue are exactly the basic structures complex task management needs.

The second layer is more important: it is not just a board tool. It puts **agents** directly into the **task flow**. In other words, it does not only manage tasks. It makes agents first-class members of the task system instead of hidden capabilities behind a chat window.

That matters a lot. Many agent products are still basically “a human sends one prompt, then the system runs one flow.” Tasks, ownership, and context all get buried inside repeated conversations. That makes them hard to trace and even harder to reuse. Multica changes the entry point: issue, comment, assign. You can assign an issue directly to an agent and let it start working. You can also \`@brains\`, \`@planner\`, or other execution agents inside the discussion and pull multiple agents into the same task thread.

That turns the agent into a role that can be divided, coordinated, and tracked. For complex work, that matters more than “making the model a bit stronger,” because what teams usually lack is not one more answer in one round. They lack a collaboration structure that can last.

This step solves problem decomposition and task organization first: how a complex problem becomes an issue, how it keeps getting broken down, how it gets assigned, and how it keeps moving inside one shared thread. That is especially valuable in asynchronous, cross-project, multi-agent collaboration. Without this layer, so-called agent automation is usually just isolated capability calls, not a complete workflow.

## Multica + agent runtime then connect automation to execution

The second thing that attracts me to Multica is that it does not try to invent a brand-new **agent execution environment** from scratch. Instead, it connects existing tools through **daemon + runtime**.

I see it as a more practical version of **BYOA**: bring your own agent. You can plug your existing **agent runtime** into Multica, then let assigned tasks run on that runtime. This has two immediate benefits.

- First, the execution environment becomes naturally distributed. Tasks can run on a specific runtime on a specific host instead of being squeezed into one centralized service.
- Second, existing agent toolchains can be reused directly. Whatever skills, MCPs, CLIs, or sandbox capabilities a runtime already has locally can be used during execution. You do not need to rewrite them just to integrate with the platform.

What makes this feel solid to me is that it boils down to two **stable interfaces**, and together they close the loop.

- **application -> daemon -> agent runtime**: if any application wants to use agent capability, it only needs to connect to an agent runtime through the daemon, and it can hand tasks to an existing execution environment.
- **agent runtime -> tool -> skill/cli**: if any agent runtime wants to use an external application, that application only needs to expose a tool, skill, or CLI entry, and the runtime can call it directly.

Once both directions are true, **Multica**, **Brains**, and the **agent runtime** stop being isolated points. You can start from any one application and call another application's capability, or keep composing them into **serial**, **parallel**, or even **mesh-like** structures to grow new products and capabilities over time.
...
I like this abstraction because it is light enough. As long as the tool boundary is reasonably clear, you often do not need to rebuild the platform. You just add interfaces like **daemon**, **CLI**, and **skill**, and existing tools can join the agent workflow quickly.

## What Brains adds is automated knowledge management

Having only a task system is not enough. An agent being able to execute does not mean it knows how to execute well. An agent solving a problem once does not mean that experience will remain in the right form.

That is exactly why I connected Brains to Multica.

**Brains** is essentially my own **llm-wiki**. I added a command-line entry for it — the **Brains CLI** — and turned knowledge-base reading and writing into stable interfaces that agents can call.

Then I created a \`brains\` agent in Multica and explicitly defined the **Brains CLI** calling style, use cases, and response structure. This agent does only two things: \`query\` and \`ingest\`. That makes **Brains** a **knowledge role** that can be invoked inside the task flow at any moment, not just a static documentation repository.

What this adds is not just “one more knowledge tool.” It adds **knowledge-management automation**. Task execution naturally produces a lot of process knowledge, but most of it does not deserve long-term storage. For example:

- temporary output from one command
- one failed attempt
- back-and-forth discussion used only to confirm context
- a temporary judgement made for the current environment

All of that matters during the task, so it should be fully carried by **issue / comment / log**. But if you write it directly into an **llm-wiki** without filtering, the knowledge base will quickly drift. What **Brains** needs to do is filter those process materials into conclusions, experience, constraints, and evidence that are actually worth keeping, then compress them into reusable **knowledge pages**.

That turns “problem decomposition -> plan discussion -> controlled execution -> experience compilation -> knowledge accumulation” into a real closed loop.
...
flowchart TD
    subgraph Task[Task domain]
        I[Issue]
        C[Comments]
        L[Logs / POC / Decisions]
    end

    subgraph Knowledge[Knowledge domain]
        S[Summary / Distillation]
        P[Brains Pages]
        Q[Query]
    end
    ...
    S --> P
    P --> Q
    Q -.Back to new task.-> I
\`\`\`

## A very concrete use case

For example, I create an issue: \`why kubernetes pod crashed\`.

The collaboration that follows can be very natural:

1. Assign it to \`@brains\` first so it can look up relevant runbooks, troubleshooting experience, and past cases from the knowledge base, then provide initial suggestions.
2. In a comment, call \`@planner\` and ask it to break the troubleshooting into actions, clarify which steps are read-only, which carry risk, and where I need to confirm.
3. Then hand it to the execution agent responsible for the work, such as \`@devops\`, and let it run the required actions after my confirmation.
4. Finally, ask \`@brains\` to summarize the incident and write the process and lessons back into Brains.

The most valuable part of this flow is that it turns troubleshooting into a process that is collaborative, replayable, filterable, and accumulative. In the past, a lot of operations knowledge died in chat logs, terminal history, and human memory. Now it can first be preserved as a task asset, then selectively distilled into a knowledge asset.

## From a business perspective, these are really two naturally separate domains

At this point, the picture is clearer to me: task management and knowledge accumulation are equally important, but they should not be collapsed into the same system.

- The **task system** focuses on progress: who is doing the work, how far it has moved, what was discussed, what was decided, and what the execution result was. It naturally holds process information, and the fuller that process is, the better.
- The **knowledge system** focuses on compression and reuse: which conclusions are worth preserving, what the evidence chain is, what the confidence level is, and who can reuse it later. It naturally needs to de-process the material, and the more concise it is, the better.

If you treat task content directly as knowledge, you usually lose on both sides: the knowledge base gets drowned in process noise, and the task system loses contextual fidelity because it gets compressed too early.

So I prefer to think of this as the **\`jira / confluence\` layering** for the agent era: the former manages progress, the latter manages knowledge. The combination of **Multica** and **Brains** reconnects those two domains, and agents allow information to flow between them automatically.

## Why this model really changed my workflow

I increasingly see Multica + Brains as a platform model rather than an accidental combination of two tools. The reason is simple: it neatly covers three layers of automation:

- **Problem decomposition layer**: Multica uses issue, comment, and assign to organize collaboration and split complex problems into tasks that can move.
- **Task execution layer**: Multica combines daemon + runtime to connect existing agent runtimes, security boundaries, and local capabilities.
- **Knowledge management layer**: Brains plugs retrieval, compilation, and accumulation into the same task chain.

Once those three layers are connected, the agent stops being just an executor. It participates in task delivery as a team member, then helps convert experience into genuinely reusable knowledge after the task ends.

What I especially value is the extensibility. As long as the interfaces remain stable, this model can be replicated across more scenarios:

- Add one layer of CLI + skill to any external system, and agents can learn to call it at relatively low cost.
- Add one daemon integration layer to any agent runtime, and a product can gain agent execution capability at relatively low cost.
- Add an issue/comment collaboration structure to any complex task, and humans plus agents can communicate inside the same thread instead of switching tools constantly.

From an engineering point of view, this feels more credible than “design one giant all-in-one super-intelligent platform first,” because each layer can evolve independently and be replaced independently. For me personally, the change is also very concrete: **task management**, **agent execution**, and **knowledge accumulation** used to be three separate things. Now they are connected into one chain for the first time, and I no longer need to move information manually. Agents can keep the loop moving within explicit boundaries.

![example](../assets/202605-multica-brains-agent-kanban/1778475581203.png)

## Problems still unsolved

This model is already attractive, but a few things still need validation.

- **How to make permission boundaries finer-grained.** A role split such as \`planner\` read-only and \`devops\` writable is useful, but going further still requires clearer approval, audit, and rollback design.
- **How to guarantee the quality of knowledge write-back.** Not every issue-handling process deserves to enter the long-term knowledge base. Brains still needs clearer filtering and compilation rules.
- **How to avoid noise in cross-agent collaboration.** The more agents you add, the more comments and sub-issues can expand. The platform needs better routing, deduplication, and convergence.

None of these are small issues. But they also show why this path is worth pursuing: the platform problems that matter most usually show up only after the system already works.

## Closing

If we treat agents only as smarter chat counterparts, what we get is mostly local efficiency gains. But once we place them at the intersection of the task system, runtime system, and knowledge system, they have a chance to become real collaborators.

For me, Multica solves “how to get agents into the task flow,” while Brains solves “how to let experience remain and continue creating value in the next task.” That is why I see this combination as a real workbench rather than a pile of tools that merely happen to call models.

## Glossary

| Term                     | Meaning in this article                                      |
| ------------------------ | ------------------------------------------------------------ |
| Agent                    | A role in a task, such as \`brains\`, \`planner\`, or an execution agent |
| Agent Runtime            | The tool or environment that runs an agent, such as opencode or claude code |
| Multica / Brains         | The applications or systems themselves                       |
| Multica CLI / Brains CLI | Their respective command-line entry points                   |
| CLI                      | A call entry such as \`multica ...\` or \`brains query ...\`    |
| Daemon                   | The bridge layer between Multica and the agent runtime       |
`,ri=`---
category: "node/agentic"
title: "From Months to One Week: The Governance Loop for Agent Coding"
date: "2026-05-24"
description: "A rewrite retrospective showing how SPDD, TDD, ADRs, and project-level governance compressed what used to take months into roughly one week."
tags:
  - "node/agentic"
  - "SPDD"
  - "TDD"
...
We have an internal productivity tool that was built two years ago. At the time, resources were limited, and afterward there was no stable engineering capacity to keep evolving it. Technical debt kept piling up, and both development and maintenance became harder and harder.

The previous version took a full development team several months. This time, with one agent engineer plus several agents working together, we completed the main feature rewrite, test coverage, and validation loop in about one week.

One direct trigger was reading “Anthropic’s Bun Rust rewrite merged at speed of AI,” which pushed me to rethink agent coding. With Agent support, instead of continuing to decorate a debt-ridden old system, it made more sense to rewrite directly and solve the problem at the root.

The point is not “how fast agents can write code.” The real point is this: **the biggest value of agents is that they compress project management, architectural decisions, code implementation, and result verification into one continuous loop.**

Without that loop, agents only amplify existing problems. They can amplify the right path, but they can also spread bad design, vague requirements, and weak abstractions much faster.

![report](../assets/202605-spdd-agentic-refactor/1780883130955.png)

## What really got shorter was not just coding time

The main setup this time was: \`gpt-5.3-codex\` as the primary model and OpenCode as the main runtime.

But what actually determined the outcome was that we established the governance skeleton at the very beginning. Model version matters, of course, but it was not the decisive factor.

Right at the start, I used \`grill-me\` from [mattpocock/skills](https://github.com/mattpocock/skills) to interrogate the plan in multiple rounds. I also referenced [forrestchang/andrej-karpathy-skills' CLAUDE.md](https://github.com/forrestchang/andrej-karpathy-skills/blob/main/CLAUDE.md) and created a dedicated coder agent as the init prompt for the coding phase.

The effect of those two moves was direct: before writing code, we first pinned down the problem definition, boundaries, steps, non-goals, risks, and validation conditions. So when implementation started, the agent was already operating with a set of execution assumptions that had been forced to converge.

That is why what got shortened was not only coding time. It was also the time normally lost in requirement clarification, solution thrash, rework, and architectural drift.

## Agent Coding is first a governance problem

I am increasingly convinced that at the project level, Agent Coding is first a **governance** problem, not just a tooling-for-efficiency problem.

What governance means here is controlling a few key things:

- whether the current requirement is clear enough
- whether the goal boundary and non-goals are explicit
- whether every step has a verifiable result
- whether deviations can be pulled back quickly into stable constraints

That is why code was not the first thing we produced in this refactor. What came first were the plan, ADRs, instructions, skills, and the \`CLAUDE.md\` that connected them.

In rewrite and refactor scenarios, those artifacts are often more stable than the code itself. Code flows. Spec is the control plane. Whatever stabilizes first should get the higher priority.

## Working with agents requires clear requirements and verifiable outcomes

The boundary condition most worth emphasizing from this experience is actually very simple: **agent collaboration requires clear requirements, and the outcome must be verifiable.**

If the requirement itself is highly ambiguous, or the definition of done is unclear, agents can still work. But they are much more likely to implement ambiguity faster. The faster they move, the larger the rework becomes.

So a basic judgement for agent projects is this:

- Before execution, do requirement analysis and step decomposition.
- During execution, enforce the TDD loop.
- After execution, apply strong verification, checkpoints, and boundary questioning.

This is not formalism. Agent code generation is too fast for humans to rely on manual review alone as the full safety net. More confidence has to move forward into constraints, tests, and verification.

## Why there were almost no major reverts this time

The implementation process was not problem-free, but there were indeed very few large reverts.

The reason is straightforward: the harness in front had already narrowed the space for drifting off course. The agent did not magically get everything right on the first try.

The issues we actually hit were more like the kinds of deviations that this sort of project and this sort of preconfiguration tend to produce, for example:

- overdesign, such as too many factories and interface abstractions
- packages split too finely, making local structure tidy but overall maintainability worse
- large amounts of redundant code and repeated structures

These issues may not be universal, but they show something more general: **you cannot rely on agents completely, and you definitely cannot just let go.**

Once an agent goes off course, both the damage and the propagation speed multiply. When a human writes one piece of code incorrectly, the impact may stay local. When an agent generates rapidly under the wrong constraints, the error can spread quickly across multiple packages, abstraction layers, and call chains.

More importantly, you need the ability to pull deviations back into stable constraints instead of waiting until they spread and then patching them afterward.

## Deviations should return to architectural decisions, not stop at local fixes

One of the most valuable things in this round was that deviation handling moved from “patch the code” to “govern the architecture.”

When I saw the same kind of issue appear repeatedly, I did not just fix the current files. I used \`architecture improve + grill-me\` to push the problem back into ADRs: which abstractions should not exist, which boundaries need to be tightened, and which responsibilities need to be reassigned. Then \`CLAUDE.md\` indexed those ADRs centrally so they became stable assumptions for later coding.

The value is obvious: the agent does not keep making the same category of mistake. The constraint has been upgraded into a project-level rule instead of remaining a one-off chat context.

## Parallel multi-agent development depends on better slicing, not more agents

When people talk about agents, they naturally think of multi-agent systems. My view here is more conservative: **multi-agent is an amplifier of plan quality. It is not the starting point.**

If the overall plan does not clearly define workstreams, steps, boundaries, and verification points, multiple agents only parallelize the chaos. Only when slices are small enough and boundaries are clear enough do multi-agent setups, sub-agents, and git worktrees become truly useful.

A more reliable way to work is:

1. Use the master plan to define the goal boundary, non-goals, and shared acceptance bar.
2. Split the work into independent workstreams and executable steps.
3. Deliver only one small, verifiable slice at a time.
4. Put high-risk tasks into separate worktrees.
5. Return to verification and checkpoints after each piece.

So the precondition for multi-agent work is very clear: the better the slicing, the better. Not the more agents, the better.

## TDD is mandatory in agent coding, not optional

In this refactor, TDD was not a nice-to-have. It was a core operating mechanism.

The reason is simple: agents can write code faster than humans can guarantee correctness through review alone. Humans are better suited to judging requirements, boundaries, risks, and trade-offs. Whether a local implementation truly meets the requirement must rely more on tests.

So in agent coding, TDD is not just a way to “improve code quality.” It carries a more fundamental responsibility:

- keep local slices from drifting off course
- preserve layered responsibilities
- keep correctness from collapsing when refactoring speed increases
- provide a reliable foundation for final verification

If SPDD governs “define clearly what should be built first,” then TDD governs “does what was built actually count as done?”

## For token cost, the real thing to watch is cache I/O

One more interesting observation came from the process data: across the entire refactor, we consumed roughly **35M I/O tokens**, **1.3B cached tokens**, and the conversation volume reached **100+ sessions**.

But the actual token cost was much lower than I expected. Most tokens went through cache, and there was not much rework in the overall process.

That mainly comes from two things. Rewriting naturally requires repeatedly reading a large amount of existing code and documentation, so high cached context is expected. Continuously updated ADRs and plans also provided stable, effective context. The agent did not need to keep guessing requirements, boundaries, or implementation direction, so generated code was more likely to land on the right track from the beginning, which naturally reduced rework.

So the real thing to watch is context reuse efficiency, and whether that context is actually improving correctness. The surface length of prompts matters much less. The clearer and more up to date ADRs, plans, instructions, and skills are, the greater the benefit from caching and context reuse, and the better the chance of reducing both token consumption and rework.

## An action checklist you can use directly

If I compress this experience into a checklist that is immediately executable, I would use this order.

### Before execution

1. Do requirement analysis first. Clarify unclear questions before entering coding.
2. Write the plan first. Make boundaries, non-goals, steps, and verification conditions explicit.
3. Use \`grill-me\` to keep interrogating the plan until the major risks and gaps are exposed.
4. Prepare the coder agent's init prompt so the coding phase has stable behavioral constraints.
5. Decide which rules belong in \`CLAUDE.md\`, which belong in ADRs, and which belong in instructions.

### During execution

1. Stick to small, verifiable slices.
2. Enforce the TDD loop. Do not let implementation expand uncontrollably ahead of tests.
3. When parallelism is needed, split workstreams first, then add multi-agent.
4. Put high-risk changes into separate worktrees to reduce cross-contamination.
5. When you see a deviation, do not only fix the code. Upgrade it into ADRs and project-level constraints when necessary.

### After execution

1. Use strong verification to inspect the result instead of just checking whether “the code is written.”
2. Set checkpoints and confirm piece by piece whether the target was truly met.
3. Keep asking boundary questions: which abstractions should not exist, and which rules have not yet been solidified?
4. Feed newly accumulated constraints back into \`CLAUDE.md\`, ADRs, plans, and instructions.

## Final line

The biggest takeaway for me was not “agents can finally write code for developers.” What became clearer is this: **once agents become the primary execution unit, engineering attention moves forward into requirement clarification, spec design, execution constraints, and outcome verification.**

What shrank from months to one week was not the thinking itself. It was the waste that used to be scattered across multi-person collaboration, repeated communication, and rework. The condition is simple: get project governance right first.
`,li=`---
category: "node/agentic"
date: "2026-06-08"
title: "Agents Are Changing How Services Connect"
description: "If the Provider keeps OpenAPI unchanged, Agent + Skill may take over part of the client-side integration logic and make service-to-service calls more semantic."
tags:
  - "node/agentic"
  - "OpenAPI"
  - "Skill"
...
After building the multica + brains symbiotic system, I started asking the reverse question: how should Agent applications call one another? Each of them already has Agent modules and can use Agent capability internally. At the same time, I also want them to connect to each other, and even be managed in a unified way by a front-end Agent such as openclaw. Once you move in that direction, standardizing call relationships — and constraining, planning, and designing the boundaries of large and small Agent capabilities — becomes a real problem.

In the past, microservices and complex systems already gave us a relatively mature interconnection pattern: the Service Provider exposes OpenAPI, the Service Client makes the calls, and then stitches multiple interfaces into a business flow. That pattern works well, but it lacks business semantics. The caller still has to write a lot of custom logic.

If we leave the API with the Provider, put business rules into Skills, and let Agents act as Clients, service-to-service calls may start to look different.

## In the traditional pattern, the problem is not the API itself

The classic pattern is clear: the Service Provider exposes OpenAPI, the Service Client generates or writes call code based on that interface definition, then combines multiple interfaces into a business flow. There is nothing wrong with that model. What it solves is standardized invocation.

But the gap is equally clear: **an API defines a capability boundary. It does not define business rules.** Even HATEOAS or GraphQL are better at resource access and query expression than at directly carrying rules like this: when the order amount is below 100, check inventory first, then recommend an item that works well as an impulse add-on.

Of course, that logic could always be implemented before. It just usually required a lot of custom code to stitch together multiple APIs, business rules, exception handling, and flow decisions.

## Agents let the caller work with business rules

Since Agents appeared, I have increasingly felt that application interconnection may gain a new implementation style:

- **The Provider continues to expose APIs**
- **Skills add business rules, user use cases, the business relationship between multiple APIs, and invocation strategy**
- **Agents act as the calling side, load those skills, then understand and invoke the capabilities**

In rough terms, you can think of it like this:

> **OpenAPI ≈ Skill + API**

I am not trying to replace OpenAPI. The point is closer to this: **traditional OpenAPI mainly answers “can it be called,” while Skills add “how should it be called in a business context.”**

What a Skill can contain is not just interface descriptions. It can also include:

- user use cases
- the business meaning of one or more APIs and the relationship between them
- business-level calling rules
- technical exception-handling strategies

That means the Service Provider may barely need to change. The side that changes most is actually the Client. A large amount of integration logic that used to live in code may move into Prompt + Skill driven invocation and orchestration.

## Two modes: Choreography and Orchestration

I think this can be understood through two different modes: Choreography and Orchestration.

![Choreography: multiple Agent Clients use Skills to call three service APIs through CLI/MCP](../assets/202606-agent-changes-service-interconnection/choreography.svg)

In **Choreography**, there is no central orchestrator. Each application or service still collaborates like a microservice system, but the Service Client is no longer just hard-coded logic. Instead, Agent + Skill can take over that role, so the invocation becomes more semantic and more business-oriented.

![Orchestration: a Supervisor Agent uses Skills to orchestrate multiple service APIs through CLI/MCP](../assets/202606-agent-changes-service-interconnection/orchestration.svg)

In **Orchestration**, I find the picture even more interesting: the central coordinator could be implemented entirely by an Agent. In other words, a Supervisor Agent can take the necessary context, then autonomously call multiple applications and services to complete integration flows that used to require a large amount of Client-side code.

Calling this “zero-code development” would obviously be exaggerated. A more accurate way to say it is: once the Service Provider already exposes standard APIs, **the customized integration code on the Client side may be significantly reduced or partially replaced by Agent + Skill.**

## This is the framing I currently prefer

This is still an early personal idea, but I increasingly prefer to look at it this way: **an Agent is not just an intelligent module added to an existing application. It may also become the next generation of Service Client.**

If that direction holds, then in the future what applications expose to one another may not be only interfaces, but also capabilities and business rules.

## Needs Verification

- The minimal reusable structure of a \`Skill\` still needs more practical validation.
- We need clearer boundaries for which client-side integration logic is suitable to be replaced by Agents and which parts should still remain in code.
- The reliability, auditability, and failure-handling model of a Supervisor Agent in real production scenarios still need more samples.
`,ci=`---
category: "domain"
title: "Agile Development, Agents, and ThoughtWorks"
date: "2026-06-09"
description: "Looking back through agile practice, agent collaboration, and the training style of ThoughtWorks, the capabilities software teams really depend on are alignment, decomposition, expression, and modeling."
tags:
  - "domain"
  - "agile"
  - "agent"
...
Why do so many teams fail to achieve real agile development?

Because **agile places very high demands on people**.

- “Individuals and interactions over processes and tools” means the team needs aligned language and aligned understanding. Ideally, I only say half a sentence and you already know the other half.
- “Working software over comprehensive documentation” means the team must know the codebase well enough that the lack of documents does not make everyone nervous.
- “Customer collaboration over contract negotiation” means the team must understand the requirement, know what the customer says, and also know what they really want behind those words.
- “Responding to change over following a plan” means the team must be able to execute quickly without falling apart in an unknown space.

At bottom, all of these statements mean the same thing: team members need a relatively consistent level of **business capability, technical capability, and collaboration capability**. Ideally, one look is enough and I already know whether you want to create an interface, refactor an implementation, cut scope, or change the design.

That is a very high bar.

## Agile engineering practices

If you look at the signatories of the Agile Manifesto, that makes sense. They probably did have that level of capability and shared understanding.

But the reality is that you cannot hire Martin Fowler or Kent Beck from the open market, and you definitely cannot clone yourself to build a team that shares the same brain waves.

That is why we need all kinds of agile **ceremonies**: Standup, IPM, Sprint Review, Retrospective, Backlog Refinement. We also need technical **practices**: Pair Programming, TDD, refactoring, and Code Review.

Of course, these ceremonies are also what people often criticize when they talk about “fake agile”: standups become status recitals, reviews become management shows, retros become complaint sessions, pairing becomes staged performance, and code review turns into group nitpicking.

That is because, in essence, all of these activities exist to achieve the high requirement inside the Agile Manifesto: **shared understanding and shared capability**.

- **Lower the upper bound of task complexity.** Backlog Refinement and IPM do requirement analysis and task decomposition first. Then all kinds of meetings synchronize information and pass context around, so people do not fill the gaps with their own imagination and end up producing five different versions.
- **Raise the lower bound of team capability.** Pairing, mentoring, sharing, and Code Review are basically talent-system work. They help new teammates get close to the team's average capability faster instead of forcing a few veterans to carry everything.

Only after pulling both ends toward the middle can you talk about the next layer: iterative delivery, estimation, free card picking, Trunk-Based Development, and using automated testing to replace part of Code Review.

## Agent as colleague

The **capability of an Agent** still depends on the capability and skill of the person using it. Whether you ask clearly, decompose well, and write constraints explicitly makes a huge difference.

Just like with people, you need to train it, cultivate it, and even manage it. You need to let it know what counts as a good result and what counts as a bad result. You need to let it know which behaviors are encouraged and which are forbidden. You need to let it know which goals matter most and which matter less.

Agents also have two characteristics that human colleagues do not.

One is that their capability can be **replicated at scale**. Multi-Agent and Sub-Agent setups can run in parallel. You are not just getting one more assistant. You are getting a small squad that can be assembled on demand.

The other is that their capability can be **acquired almost instantly**. Skills are plug-and-play. You do not need to wait through onboarding. Add a Frontend Skill, and it can immediately help write React components.

If you look at Agents as team members, you start to notice that they are naturally close to what agile needs: **shared understanding and shared capability**, plus horizontal scaling and vertical upgrades.

- “Individuals and interactions over processes and tools” — in a sense, this really does become chat with agent.
- “Working software over comprehensive documentation” — the agent will read your code, and usually read it very carefully.
- “Customer collaboration over contract negotiation” — you do not need contract negotiation. You are the demand side yourself.
- “Responding to change over following a plan” — you can change your mind at any time, and it can rerun with you.

## 200x??

Last month, I used Agents to rewrite an internal tool. In the final estimate, a team composition of **1 human + 3~5 Agents** produced an **efficiency gain close to 200x**.

That number looks exaggerated in isolation. It sounds like clickbait from a course-selling account.

But if you treat those Agents as real teammates you can collaborate with, it becomes less mystical. It is basically a six-person full-function team: one PO/BA plus five developers/testers.

Once you break it down that way, the average is around 30x.

Then there is still a lot of time that used to be consumed by default and is now saved: meetings, training, context synchronization, waiting for people, finding people, rest, lunch. Silicon-based life forms only eat electricity, not takeout.

Average it again, and maybe it is closer to **10x** — a level top engineers can reach.

So Agents are not just fast code writers. More importantly, they work in a team-shaped way. Their efficiency gain comes from amplifying human capability across multiple dimensions: **execution, collaboration, and learning**.

> If you are interested in the rewrite process, you can also read my earlier post [From Months to One Week: The Governance Loop for Agent Coding](./202605-spdd-agentic-refactor.md).

## ThoughtWorks

ThoughtWorks is an excellent company. In many ways, it feels more like a university.

Looking back now, the typical growth path inside ThoughtWorks was to become a “**Thought Worker**”: analyze first, think second, and only then write code.

Back then we cared a lot about agile and the training that came with **Pair, TDD, and DDD**. Every day involved modeling, analysis, evaluation, and many frameworks and methods.

For a period of time, I also wondered: why spend so much time on things that do not look directly related to writing code? Wouldn't straightforward CRUD be enough?

Now I see it differently. Those capabilities determine the size and quality of the **Agent team** you can lead.

As a Tech Lead, even if your individual capability is very strong, that still does not mean you can stably deliver 10x more than others by yourself.

Whether you can define the problem clearly, break it down well, identify boundaries and risks, and turn fuzzy requirements into stable constraints — those things determine whether you can lead a 10x team.

- Pair, TDD, and DDD train communication and collaboration, boundary recognition, and abstraction modeling. Agile trains feedback and adjustment.
- Even the old “blog competition,” in hindsight, trained more than writing. It trained **expression**: the ability to explain what is in your head clearly. Today, that is a required skill for communicating accurately with Agents.

In a sense, **“one person leading eight”** has now been realized in a different dimension.
`,di=`---
layout: blog-list
...
---
`;function rt(e,n){return e==null||n==null?NaN:e<n?-1:e>n?1:e>=n?0:NaN}function xp(e,n){return e==null||n==null?NaN:n<e?-1:n>e?1:n>=e?0:NaN}function gi(e){let n,t,a;e.length!==2?(n=rt,t=(r,l)=>rt(e(r),l),a=(r,l)=>e(r)-l):(n=e===rt||e===xp?e:Ap,t=e,a=e);function o(r,l,c=0,u=r.length){if(c<u){if(n(l,l)!==0)return u;do{const p=c+u>>>1;t(r[p],l)<0?c=p+1:u=p}while(c<u)}return c}function i(r,l,c=0,u=r.length){if(c<u){if(n(l,l)!==0)return u;do{const p=c+u>>>1;t(r[p],l)<=0?c=p+1:u=p}while(c<u)}return c}function s(r,l,c=0,u=r.length){const p=o(r,l,c,u-1);return p>c&&a(r[p-1],l)>-a(r[p],l)?p-1:p}return{left:o,center:s,right:i}}function Ap(){return 0}function Cp(e){return e===null?NaN:+e}const Tp=gi(rt),Ip=Tp.right;gi(Cp).center;class zi extends Map{constructor(n,t=Pp){if(super(),Object.defineProperties(this,{_intern:{value:new Map},_key:{value:t}}),n!=null)for(const[a,o]of n)this.set(a,o)}get(n){return super.get(Bi(this,n))}has(n){return super.has(Bi(this,n))}set(n,t){return super.set(Sp(this,n),t)}delete(n){return super.delete(Dp(this,n))}}function Bi({_intern:e,_key:n},t){const a=n(t);return e.has(a)?e.get(a):t}function Sp({_intern:e,_key:n},t){const a=n(t);return e.has(a)?e.get(a):(e.set(a,t),t)}function Dp({_intern:e,_key:n},t){const a=n(t);return e.has(a)&&(t=e.get(a),e.delete(a)),t}function Pp(e){return e!==null&&typeof e=="object"?e.valueOf():e}const Mp=Math.sqrt(50),Lp=Math.sqrt(10),$p=Math.sqrt(2);function pt(e,n,t){const a=(n-e)/Math.max(0,t),o=Math.floor(Math.log10(a)),i=a/Math.pow(10,o),s=i>=Mp?10:i>=Lp?5:i>=$p?2:1;let r,l,c;return o<0?(c=Math.pow(10,-o)/s,r=Math.round(e*c),l=Math.round(n*c),r/c<e&&++r,l/c>n&&--l,c=-c):(c=Math.pow(10,o)*s,r=Math.round(e/c),l=Math.round(n/c),r*c<e&&++r,l*c>n&&--l),l<r&&.5<=t&&t<2?pt(e,n,t*2):[r,l,c]}function Np(e,n,t){if(n=+n,e=+e,t=+t,!(t>0))return[];if(e===n)return[e];const a=n<e,[o,i,s]=a?pt(n,e,t):pt(e,n,t);if(!(i>=o))return[];const r=i-o+1,l=new Array(r);if(a)if(s<0)for(let c=0;c<r;++c)l[c]=(i-c)/-s;else for(let c=0;c<r;++c)l[c]=(i-c)*s;else if(s<0)for(let c=0;c<r;++c)l[c]=(o+c)/-s;else for(let c=0;c<r;++c)l[c]=(o+c)*s;return l}function _a(e,n,t){return n=+n,e=+e,t=+t,pt(e,n,t)[2]}function ka(e,n,t){n=+n,e=+e,t=+t;const a=n<e,o=a?_a(n,e,t):_a(e,n,t);return(a?-1:1)*(o<0?1/-o:o)}function hk(e,n){let t;if(n===void 0)for(const a of e)a!=null&&(t<a||t===void 0&&a>=a)&&(t=a);else{let a=-1;for(let o of e)(o=n(o,++a,e))!=null&&(t<o||t===void 0&&o>=o)&&(t=o)}return t}function gk(e,n){let t;if(n===void 0)for(const a of e)a!=null&&(t>a||t===void 0&&a>=a)&&(t=a);else{let a=-1;for(let o of e)(o=n(o,++a,e))!=null&&(t>o||t===void 0&&o>=o)&&(t=o)}return t}function Op(e,n,t){e=+e,n=+n,t=(o=arguments.length)<2?(n=e,e=0,1):o<3?1:+t;for(var a=-1,o=Math.max(0,Math.ceil((n-e)/t))|0,i=new Array(o);++a<o;)i[a]=e+a*t;return i}function Ep(e){return e}var lt=1,na=2,xa=3,Zn=4,qi=1e-6;function Rp(e){return"translate("+e+",0)"}function zp(e){return"translate(0,"+e+")"}function Bp(e){return n=>+e(n)}function qp(e,n){return n=Math.max(0,e.bandwidth()-n*2)/2,e.round()&&(n=Math.round(n)),t=>+e(t)+n}function Vp(){return!this.__axis}function Gs(e,n){var t=[],a=null,o=null,i=6,s=6,r=3,l=typeof window<"u"&&window.devicePixelRatio>1?0:.5,c=e===lt||e===Zn?-1:1,u=e===Zn||e===na?"x":"y",p=e===lt||e===xa?Rp:zp;function d(h){var v=a??(n.ticks?n.ticks.apply(n,t):n.domain()),b=o??(n.tickFormat?n.tickFormat.apply(n,t):Ep),w=Math.max(i,0)+r,x=n.range(),A=+x[0]+l,M=+x[x.length-1]+l,y=(n.bandwidth?qp:Bp)(n.copy(),l),T=h.selection?h.selection():h,k=T.selectAll(".domain").data([null]),O=T.selectAll(".tick").data(v,n).order(),V=O.exit(),H=O.enter().append("g").attr("class","tick"),j=O.select("line"),$=O.select("text");k=k.merge(k.enter().insert("path",".tick").attr("class","domain").attr("stroke","currentColor")),O=O.merge(H),j=j.merge(H.append("line").attr("stroke","currentColor").attr(u+"2",c*i)),$=$.merge(H.append("text").attr("fill","currentColor").attr(u,c*w).attr("dy",e===lt?"0em":e===xa?"0.71em":"0.32em")),h!==T&&(k=k.transition(h),O=O.transition(h),j=j.transition(h),$=$.transition(h),V=V.transition(h).attr("opacity",qi).attr("transform",function(P){return isFinite(P=y(P))?p(P+l):this.getAttribute("transform")}),H.attr("opacity",qi).attr("transform",function(P){var L=this.parentNode.__axis;return p((L&&isFinite(L=L(P))?L:y(P))+l)})),V.remove(),k.attr("d",e===Zn||e===na?s?"M"+c*s+","+A+"H"+l+"V"+M+"H"+c*s:"M"+l+","+A+"V"+M:s?"M"+A+","+c*s+"V"+l+"H"+M+"V"+c*s:"M"+A+","+l+"H"+M),O.attr("opacity",1).attr("transform",function(P){return p(y(P)+l)}),j.attr(u+"2",c*i),$.attr(u,c*w).text(b),T.filter(Vp).attr("fill","none").attr("font-size",10).attr("font-family","sans-serif").attr("text-anchor",e===na?"start":e===Zn?"end":"middle"),T.each(function(){this.__axis=y})}return d.scale=function(h){return arguments.length?(n=h,d):n},d.ticks=function(){return t=Array.from(arguments),d},d.tickArguments=function(h){return arguments.length?(t=h==null?[]:Array.from(h),d):t.slice()},d.tickValues=function(h){return arguments.length?(a=h==null?null:Array.from(h),d):a&&a.slice()},d.tickFormat=function(h){return arguments.length?(o=h,d):o},d.tickSize=function(h){return arguments.length?(i=s=+h,d):i},d.tickSizeInner=function(h){return arguments.length?(i=+h,d):i},d.tickSizeOuter=function(h){return arguments.length?(s=+h,d):s},d.tickPadding=function(h){return arguments.length?(r=+h,d):r},d.offset=function(h){return arguments.length?(l=+h,d):l},d}function pk(e){return Gs(lt,e)}function mk(e){return Gs(xa,e)}var jp={value:()=>{}};function Ut(){for(var e=0,n=arguments.length,t={},a;e<n;++e){if(!(a=arguments[e]+"")||a in t||/[\s.]/.test(a))throw new Error("illegal type: "+a);t[a]=[]}return new ct(t)}function ct(e){this._=e}function Fp(e,n){return e.trim().split(/^|\s+/).map(function(t){var a="",o=t.indexOf(".");if(o>=0&&(a=t.slice(o+1),t=t.slice(0,o)),t&&!n.hasOwnProperty(t))throw new Error("unknown type: "+t);return{type:t,name:a}})}ct.prototype=Ut.prototype={constructor:ct,on:function(e,n){var t=this._,a=Fp(e+"",t),o,i=-1,s=a.length;if(arguments.length<2){for(;++i<s;)if((o=(e=a[i]).type)&&(o=Up(t[o],e.name)))return o;return}if(n!=null&&typeof n!="function")throw new Error("invalid callback: "+n);for(;++i<s;)if(o=(e=a[i]).type)t[o]=Vi(t[o],e.name,n);else if(n==null)for(o in t)t[o]=Vi(t[o],e.name,null);return this},copy:function(){var e={},n=this._;for(var t in n)e[t]=n[t].slice();return new ct(e)},call:function(e,n){if((o=arguments.length-2)>0)for(var t=new Array(o),a=0,o,i;a<o;++a)t[a]=arguments[a+2];if(!this._.hasOwnProperty(e))throw new Error("unknown type: "+e);for(i=this._[e],a=0,o=i.length;a<o;++a)i[a].value.apply(n,t)},apply:function(e,n,t){if(!this._.hasOwnProperty(e))throw new Error("unknown type: "+e);for(var a=this._[e],o=0,i=a.length;o<i;++o)a[o].value.apply(n,t)}};function Up(e,n){for(var t=0,a=e.length,o;t<a;++t)if((o=e[t]).name===n)return o.value}function Vi(e,n,t){for(var a=0,o=e.length;a<o;++a)if(e[a].name===n){e[a]=jp,e=e.slice(0,a).concat(e.slice(a+1));break}return t!=null&&e.push({name:n,value:t}),e}var Aa="http://www.w3.org/1999/xhtml";const ji={svg:"http://www.w3.org/2000/svg",xhtml:Aa,xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"};function Wt(e){var n=e+="",t=n.indexOf(":");return t>=0&&(n=e.slice(0,t))!=="xmlns"&&(e=e.slice(t+1)),ji.hasOwnProperty(n)?{space:ji[n],local:e}:e}function Wp(e){return function(){var n=this.ownerDocument,t=this.namespaceURI;return t===Aa&&n.documentElement.namespaceURI===Aa?n.createElement(e):n.createElementNS(t,e)}}function Gp(e){return function(){return this.ownerDocument.createElementNS(e.space,e.local)}}function Hs(e){var n=Wt(e);return(n.local?Gp:Wp)(n)}function Hp(){}function pi(e){return e==null?Hp:function(){return this.querySelector(e)}}function Kp(e){typeof e!="function"&&(e=pi(e));for(var n=this._groups,t=n.length,a=new Array(t),o=0;o<t;++o)for(var i=n[o],s=i.length,r=a[o]=new Array(s),l,c,u=0;u<s;++u)(l=i[u])&&(c=e.call(l,l.__data__,u,i))&&("__data__"in l&&(c.__data__=l.__data__),r[u]=c);return new De(a,this._parents)}function Yp(e){return e==null?[]:Array.isArray(e)?e:Array.from(e)}function Xp(){return[]}function Ks(e){return e==null?Xp:function(){return this.querySelectorAll(e)}}function Qp(e){return function(){return Yp(e.apply(this,arguments))}}function Jp(e){typeof e=="function"?e=Qp(e):e=Ks(e);for(var n=this._groups,t=n.length,a=[],o=[],i=0;i<t;++i)for(var s=n[i],r=s.length,l,c=0;c<r;++c)(l=s[c])&&(a.push(e.call(l,l.__data__,c,s)),o.push(l));return new De(a,o)}function Ys(e){return function(){return this.matches(e)}}function Xs(e){return function(n){return n.matches(e)}}var Zp=Array.prototype.find;function em(e){return function(){return Zp.call(this.children,e)}}function nm(){return this.firstElementChild}function tm(e){return this.select(e==null?nm:em(typeof e=="function"?e:Xs(e)))}var am=Array.prototype.filter;function om(){return Array.from(this.children)}function im(e){return function(){return am.call(this.children,e)}}function sm(e){return this.selectAll(e==null?om:im(typeof e=="function"?e:Xs(e)))}function rm(e){typeof e!="function"&&(e=Ys(e));for(var n=this._groups,t=n.length,a=new Array(t),o=0;o<t;++o)for(var i=n[o],s=i.length,r=a[o]=[],l,c=0;c<s;++c)(l=i[c])&&e.call(l,l.__data__,c,i)&&r.push(l);return new De(a,this._parents)}function Qs(e){return new Array(e.length)}function lm(){return new De(this._enter||this._groups.map(Qs),this._parents)}function mt(e,n){this.ownerDocument=e.ownerDocument,this.namespaceURI=e.namespaceURI,this._next=null,this._parent=e,this.__data__=n}mt.prototype={constructor:mt,appendChild:function(e){return this._parent.insertBefore(e,this._next)},insertBefore:function(e,n){return this._parent.insertBefore(e,n)},querySelector:function(e){return this._parent.querySelector(e)},querySelectorAll:function(e){return this._parent.querySelectorAll(e)}};function cm(e){return function(){return e}}function dm(e,n,t,a,o,i){for(var s=0,r,l=n.length,c=i.length;s<c;++s)(r=n[s])?(r.__data__=i[s],a[s]=r):t[s]=new mt(e,i[s]);for(;s<l;++s)(r=n[s])&&(o[s]=r)}function um(e,n,t,a,o,i,s){var r,l,c=new Map,u=n.length,p=i.length,d=new Array(u),h;for(r=0;r<u;++r)(l=n[r])&&(d[r]=h=s.call(l,l.__data__,r,n)+"",c.has(h)?o[r]=l:c.set(h,l));for(r=0;r<p;++r)h=s.call(e,i[r],r,i)+"",(l=c.get(h))?(a[r]=l,l.__data__=i[r],c.delete(h)):t[r]=new mt(e,i[r]);for(r=0;r<u;++r)(l=n[r])&&c.get(d[r])===l&&(o[r]=l)}function hm(e){return e.__data__}function gm(e,n){if(!arguments.length)return Array.from(this,hm);var t=n?um:dm,a=this._parents,o=this._groups;typeof e!="function"&&(e=cm(e));for(var i=o.length,s=new Array(i),r=new Array(i),l=new Array(i),c=0;c<i;++c){var u=a[c],p=o[c],d=p.length,h=pm(e.call(u,u&&u.__data__,c,a)),v=h.length,b=r[c]=new Array(v),w=s[c]=new Array(v),x=l[c]=new Array(d);t(u,p,b,w,x,h,n);for(var A=0,M=0,y,T;A<v;++A)if(y=b[A]){for(A>=M&&(M=A+1);!(T=w[M])&&++M<v;);y._next=T||null}}return s=new De(s,a),s._enter=r,s._exit=l,s}function pm(e){return typeof e=="object"&&"length"in e?e:Array.from(e)}function mm(){return new De(this._exit||this._groups.map(Qs),this._parents)}function fm(e,n,t){var a=this.enter(),o=this,i=this.exit();return typeof e=="function"?(a=e(a),a&&(a=a.selection())):a=a.append(e+""),n!=null&&(o=n(o),o&&(o=o.selection())),t==null?i.remove():t(i),a&&o?a.merge(o).order():o}function vm(e){for(var n=e.selection?e.selection():e,t=this._groups,a=n._groups,o=t.length,i=a.length,s=Math.min(o,i),r=new Array(o),l=0;l<s;++l)for(var c=t[l],u=a[l],p=c.length,d=r[l]=new Array(p),h,v=0;v<p;++v)(h=c[v]||u[v])&&(d[v]=h);for(;l<o;++l)r[l]=t[l];return new De(r,this._parents)}function bm(){for(var e=this._groups,n=-1,t=e.length;++n<t;)for(var a=e[n],o=a.length-1,i=a[o],s;--o>=0;)(s=a[o])&&(i&&s.compareDocumentPosition(i)^4&&i.parentNode.insertBefore(s,i),i=s);return this}function ym(e){e||(e=wm);function n(p,d){return p&&d?e(p.__data__,d.__data__):!p-!d}for(var t=this._groups,a=t.length,o=new Array(a),i=0;i<a;++i){for(var s=t[i],r=s.length,l=o[i]=new Array(r),c,u=0;u<r;++u)(c=s[u])&&(l[u]=c);l.sort(n)}return new De(o,this._parents).order()}function wm(e,n){return e<n?-1:e>n?1:e>=n?0:NaN}function _m(){var e=arguments[0];return arguments[0]=this,e.apply(null,arguments),this}function km(){return Array.from(this)}function xm(){for(var e=this._groups,n=0,t=e.length;n<t;++n)for(var a=e[n],o=0,i=a.length;o<i;++o){var s=a[o];if(s)return s}return null}function Am(){let e=0;for(const n of this)++e;return e}function Cm(){return!this.node()}function Tm(e){for(var n=this._groups,t=0,a=n.length;t<a;++t)for(var o=n[t],i=0,s=o.length,r;i<s;++i)(r=o[i])&&e.call(r,r.__data__,i,o);return this}function Im(e){return function(){this.removeAttribute(e)}}function Sm(e){return function(){this.removeAttributeNS(e.space,e.local)}}function Dm(e,n){return function(){this.setAttribute(e,n)}}function Pm(e,n){return function(){this.setAttributeNS(e.space,e.local,n)}}function Mm(e,n){return function(){var t=n.apply(this,arguments);t==null?this.removeAttribute(e):this.setAttribute(e,t)}}function Lm(e,n){return function(){var t=n.apply(this,arguments);t==null?this.removeAttributeNS(e.space,e.local):this.setAttributeNS(e.space,e.local,t)}}function $m(e,n){var t=Wt(e);if(arguments.length<2){var a=this.node();return t.local?a.getAttributeNS(t.space,t.local):a.getAttribute(t)}return this.each((n==null?t.local?Sm:Im:typeof n=="function"?t.local?Lm:Mm:t.local?Pm:Dm)(t,n))}function Js(e){return e.ownerDocument&&e.ownerDocument.defaultView||e.document&&e||e.defaultView}function Nm(e){return function(){this.style.removeProperty(e)}}function Om(e,n,t){return function(){this.style.setProperty(e,n,t)}}function Em(e,n,t){return function(){var a=n.apply(this,arguments);a==null?this.style.removeProperty(e):this.style.setProperty(e,a,t)}}function Rm(e,n,t){return arguments.length>1?this.each((n==null?Nm:typeof n=="function"?Em:Om)(e,n,t??"")):Tn(this.node(),e)}function Tn(e,n){return e.style.getPropertyValue(n)||Js(e).getComputedStyle(e,null).getPropertyValue(n)}function zm(e){return function(){delete this[e]}}function Bm(e,n){return function(){this[e]=n}}function qm(e,n){return function(){var t=n.apply(this,arguments);t==null?delete this[e]:this[e]=t}}function Vm(e,n){return arguments.length>1?this.each((n==null?zm:typeof n=="function"?qm:Bm)(e,n)):this.node()[e]}function Zs(e){return e.trim().split(/^|\s+/)}function mi(e){return e.classList||new er(e)}function er(e){this._node=e,this._names=Zs(e.getAttribute("class")||"")}er.prototype={add:function(e){var n=this._names.indexOf(e);n<0&&(this._names.push(e),this._node.setAttribute("class",this._names.join(" ")))},remove:function(e){var n=this._names.indexOf(e);n>=0&&(this._names.splice(n,1),this._node.setAttribute("class",this._names.join(" ")))},contains:function(e){return this._names.indexOf(e)>=0}};function nr(e,n){for(var t=mi(e),a=-1,o=n.length;++a<o;)t.add(n[a])}function tr(e,n){for(var t=mi(e),a=-1,o=n.length;++a<o;)t.remove(n[a])}function jm(e){return function(){nr(this,e)}}function Fm(e){return function(){tr(this,e)}}function Um(e,n){return function(){(n.apply(this,arguments)?nr:tr)(this,e)}}function Wm(e,n){var t=Zs(e+"");if(arguments.length<2){for(var a=mi(this.node()),o=-1,i=t.length;++o<i;)if(!a.contains(t[o]))return!1;return!0}return this.each((typeof n=="function"?Um:n?jm:Fm)(t,n))}function Gm(){this.textContent=""}function Hm(e){return function(){this.textContent=e}}function Km(e){return function(){var n=e.apply(this,arguments);this.textContent=n??""}}function Ym(e){return arguments.length?this.each(e==null?Gm:(typeof e=="function"?Km:Hm)(e)):this.node().textContent}function Xm(){this.innerHTML=""}function Qm(e){return function(){this.innerHTML=e}}function Jm(e){return function(){var n=e.apply(this,arguments);this.innerHTML=n??""}}function Zm(e){return arguments.length?this.each(e==null?Xm:(typeof e=="function"?Jm:Qm)(e)):this.node().innerHTML}function ef(){this.nextSibling&&this.parentNode.appendChild(this)}function nf(){return this.each(ef)}function tf(){this.previousSibling&&this.parentNode.insertBefore(this,this.parentNode.firstChild)}function af(){return this.each(tf)}function of(e){var n=typeof e=="function"?e:Hs(e);return this.select(function(){return this.appendChild(n.apply(this,arguments))})}function sf(){return null}function rf(e,n){var t=typeof e=="function"?e:Hs(e),a=n==null?sf:typeof n=="function"?n:pi(n);return this.select(function(){return this.insertBefore(t.apply(this,arguments),a.apply(this,arguments)||null)})}function lf(){var e=this.parentNode;e&&e.removeChild(this)}function cf(){return this.each(lf)}function df(){var e=this.cloneNode(!1),n=this.parentNode;return n?n.insertBefore(e,this.nextSibling):e}function uf(){var e=this.cloneNode(!0),n=this.parentNode;return n?n.insertBefore(e,this.nextSibling):e}function hf(e){return this.select(e?uf:df)}function gf(e){return arguments.length?this.property("__data__",e):this.node().__data__}function pf(e){return function(n){e.call(this,n,this.__data__)}}function mf(e){return e.trim().split(/^|\s+/).map(function(n){var t="",a=n.indexOf(".");return a>=0&&(t=n.slice(a+1),n=n.slice(0,a)),{type:n,name:t}})}function ff(e){return function(){var n=this.__on;if(n){for(var t=0,a=-1,o=n.length,i;t<o;++t)i=n[t],(!e.type||i.type===e.type)&&i.name===e.name?this.removeEventListener(i.type,i.listener,i.options):n[++a]=i;++a?n.length=a:delete this.__on}}}function vf(e,n,t){return function(){var a=this.__on,o,i=pf(n);if(a){for(var s=0,r=a.length;s<r;++s)if((o=a[s]).type===e.type&&o.name===e.name){this.removeEventListener(o.type,o.listener,o.options),this.addEventListener(o.type,o.listener=i,o.options=t),o.value=n;return}}this.addEventListener(e.type,i,t),o={type:e.type,name:e.name,value:n,listener:i,options:t},a?a.push(o):this.__on=[o]}}function bf(e,n,t){var a=mf(e+""),o,i=a.length,s;if(arguments.length<2){var r=this.node().__on;if(r){for(var l=0,c=r.length,u;l<c;++l)for(o=0,u=r[l];o<i;++o)if((s=a[o]).type===u.type&&s.name===u.name)return u.value}return}for(r=n?vf:ff,o=0;o<i;++o)this.each(r(a[o],n,t));return this}function ar(e,n,t){var a=Js(e),o=a.CustomEvent;typeof o=="function"?o=new o(n,t):(o=a.document.createEvent("Event"),t?(o.initEvent(n,t.bubbles,t.cancelable),o.detail=t.detail):o.initEvent(n,!1,!1)),e.dispatchEvent(o)}function yf(e,n){return function(){return ar(this,e,n)}}function wf(e,n){return function(){return ar(this,e,n.apply(this,arguments))}}function _f(e,n){return this.each((typeof n=="function"?wf:yf)(e,n))}function*kf(){for(var e=this._groups,n=0,t=e.length;n<t;++n)for(var a=e[n],o=0,i=a.length,s;o<i;++o)(s=a[o])&&(yield s)}var or=[null];function De(e,n){this._groups=e,this._parents=n}function Xn(){return new De([[document.documentElement]],or)}function xf(){return this}De.prototype=Xn.prototype={constructor:De,select:Kp,selectAll:Jp,selectChild:tm,selectChildren:sm,filter:rm,data:gm,enter:lm,exit:mm,join:fm,merge:vm,selection:xf,order:bm,sort:ym,call:_m,nodes:km,node:xm,size:Am,empty:Cm,each:Tm,attr:$m,style:Rm,property:Vm,classed:Wm,text:Ym,html:Zm,raise:nf,lower:af,append:of,insert:rf,remove:cf,clone:hf,datum:gf,on:bf,dispatch:_f,[Symbol.iterator]:kf};function ln(e){return typeof e=="string"?new De([[document.querySelector(e)]],[document.documentElement]):new De([[e]],or)}function Af(e){let n;for(;n=e.sourceEvent;)e=n;return e}function Fi(e,n){if(e=Af(e),n===void 0&&(n=e.currentTarget),n){var t=n.ownerSVGElement||n;if(t.createSVGPoint){var a=t.createSVGPoint();return a.x=e.clientX,a.y=e.clientY,a=a.matrixTransform(n.getScreenCTM().inverse()),[a.x,a.y]}if(n.getBoundingClientRect){var o=n.getBoundingClientRect();return[e.clientX-o.left-n.clientLeft,e.clientY-o.top-n.clientTop]}}return[e.pageX,e.pageY]}const Cf={passive:!1},Fn={capture:!0,passive:!1};function ta(e){e.stopImmediatePropagation()}function xn(e){e.preventDefault(),e.stopImmediatePropagation()}function Tf(e){var n=e.document.documentElement,t=ln(e).on("dragstart.drag",xn,Fn);"onselectstart"in n?t.on("selectstart.drag",xn,Fn):(n.__noselect=n.style.MozUserSelect,n.style.MozUserSelect="none")}function If(e,n){var t=e.document.documentElement,a=ln(e).on("dragstart.drag",null);n&&(a.on("click.drag",xn,Fn),setTimeout(function(){a.on("click.drag",null)},0)),"onselectstart"in t?a.on("selectstart.drag",null):(t.style.MozUserSelect=t.__noselect,delete t.__noselect)}const et=e=>()=>e;function Ca(e,{sourceEvent:n,subject:t,target:a,identifier:o,active:i,x:s,y:r,dx:l,dy:c,dispatch:u}){Object.defineProperties(this,{type:{value:e,enumerable:!0,configurable:!0},sourceEvent:{value:n,enumerable:!0,configurable:!0},subject:{value:t,enumerable:!0,configurable:!0},target:{value:a,enumerable:!0,configurable:!0},identifier:{value:o,enumerable:!0,configurable:!0},active:{value:i,enumerable:!0,configurable:!0},x:{value:s,enumerable:!0,configurable:!0},y:{value:r,enumerable:!0,configurable:!0},dx:{value:l,enumerable:!0,configurable:!0},dy:{value:c,enumerable:!0,configurable:!0},_:{value:u}})}Ca.prototype.on=function(){var e=this._.on.apply(this._,arguments);return e===this._?this:e};function Sf(e){return!e.ctrlKey&&!e.button}function Df(){return this.parentNode}function Pf(e,n){return n??{x:e.x,y:e.y}}function Mf(){return navigator.maxTouchPoints||"ontouchstart"in this}function Lf(){var e=Sf,n=Df,t=Pf,a=Mf,o={},i=Ut("start","drag","end"),s=0,r,l,c,u,p=0;function d(y){y.on("mousedown.drag",h).filter(a).on("touchstart.drag",w).on("touchmove.drag",x,Cf).on("touchend.drag touchcancel.drag",A).style("touch-action","none").style("-webkit-tap-highlight-color","rgba(0,0,0,0)")}function h(y,T){if(!(u||!e.call(this,y,T))){var k=M(this,n.call(this,y,T),y,T,"mouse");k&&(ln(y.view).on("mousemove.drag",v,Fn).on("mouseup.drag",b,Fn),Tf(y.view),ta(y),c=!1,r=y.clientX,l=y.clientY,k("start",y))}}function v(y){if(xn(y),!c){var T=y.clientX-r,k=y.clientY-l;c=T*T+k*k>p}o.mouse("drag",y)}function b(y){ln(y.view).on("mousemove.drag mouseup.drag",null),If(y.view,c),xn(y),o.mouse("end",y)}function w(y,T){if(e.call(this,y,T)){var k=y.changedTouches,O=n.call(this,y,T),V=k.length,H,j;for(H=0;H<V;++H)(j=M(this,O,y,T,k[H].identifier,k[H]))&&(ta(y),j("start",y,k[H]))}}function x(y){var T=y.changedTouches,k=T.length,O,V;for(O=0;O<k;++O)(V=o[T[O].identifier])&&(xn(y),V("drag",y,T[O]))}function A(y){var T=y.changedTouches,k=T.length,O,V;for(u&&clearTimeout(u),u=setTimeout(function(){u=null},500),O=0;O<k;++O)(V=o[T[O].identifier])&&(ta(y),V("end",y,T[O]))}function M(y,T,k,O,V,H){var j=i.copy(),$=Fi(H||k,T),P,L,z;if((z=t.call(y,new Ca("beforestart",{sourceEvent:k,target:d,identifier:V,active:s,x:$[0],y:$[1],dx:0,dy:0,dispatch:j}),O))!=null)return P=z.x-$[0]||0,L=z.y-$[1]||0,function te(ee,K,re){var ue=$,de;switch(ee){case"start":o[V]=te,de=s++;break;case"end":delete o[V],--s;case"drag":$=Fi(re||K,T),de=s;break}j.call(ee,y,new Ca(ee,{sourceEvent:K,subject:z,target:d,identifier:V,active:de,x:$[0]+P,y:$[1]+L,dx:$[0]-ue[0],dy:$[1]-ue[1],dispatch:j}),O)}}return d.filter=function(y){return arguments.length?(e=typeof y=="function"?y:et(!!y),d):e},d.container=function(y){return arguments.length?(n=typeof y=="function"?y:et(y),d):n},d.subject=function(y){return arguments.length?(t=typeof y=="function"?y:et(y),d):t},d.touchable=function(y){return arguments.length?(a=typeof y=="function"?y:et(!!y),d):a},d.on=function(){var y=i.on.apply(i,arguments);return y===i?d:y},d.clickDistance=function(y){return arguments.length?(p=(y=+y)*y,d):Math.sqrt(p)},d}function Qn(e,n,t){e.prototype=n.prototype=t,t.constructor=e}function Gt(e,n){var t=Object.create(e.prototype);for(var a in n)t[a]=n[a];return t}function fn(){}var Un=.7,ft=1/Un,An="\\s*([+-]?\\d+)\\s*",Wn="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*",qe="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",$f=/^#([0-9a-f]{3,8})$/,Nf=new RegExp(`^rgb\\(${An},${An},${An}\\)$`),Of=new RegExp(`^rgb\\(${qe},${qe},${qe}\\)$`),Ef=new RegExp(`^rgba\\(${An},${An},${An},${Wn}\\)$`),Rf=new RegExp(`^rgba\\(${qe},${qe},${qe},${Wn}\\)$`),zf=new RegExp(`^hsl\\(${Wn},${qe},${qe}\\)$`),Bf=new RegExp(`^hsla\\(${Wn},${qe},${qe},${Wn}\\)$`),Ui={aliceblue:15792383,antiquewhite:16444375,aqua:65535,aquamarine:8388564,azure:15794175,beige:16119260,bisque:16770244,black:0,blanchedalmond:16772045,blue:255,blueviolet:9055202,brown:10824234,burlywood:14596231,cadetblue:6266528,chartreuse:8388352,chocolate:13789470,coral:16744272,cornflowerblue:6591981,cornsilk:16775388,crimson:14423100,cyan:65535,darkblue:139,darkcyan:35723,darkgoldenrod:12092939,darkgray:11119017,darkgreen:25600,darkgrey:11119017,darkkhaki:12433259,darkmagenta:9109643,darkolivegreen:5597999,darkorange:16747520,darkorchid:10040012,darkred:9109504,darksalmon:15308410,darkseagreen:9419919,darkslateblue:4734347,darkslategray:3100495,darkslategrey:3100495,darkturquoise:52945,darkviolet:9699539,deeppink:16716947,deepskyblue:49151,dimgray:6908265,dimgrey:6908265,dodgerblue:2003199,firebrick:11674146,floralwhite:16775920,forestgreen:2263842,fuchsia:16711935,gainsboro:14474460,ghostwhite:16316671,gold:16766720,goldenrod:14329120,gray:8421504,green:32768,greenyellow:11403055,grey:8421504,honeydew:15794160,hotpink:16738740,indianred:13458524,indigo:4915330,ivory:16777200,khaki:15787660,lavender:15132410,lavenderblush:16773365,lawngreen:8190976,lemonchiffon:16775885,lightblue:11393254,lightcoral:15761536,lightcyan:14745599,lightgoldenrodyellow:16448210,lightgray:13882323,lightgreen:9498256,lightgrey:13882323,lightpink:16758465,lightsalmon:16752762,lightseagreen:2142890,lightskyblue:8900346,lightslategray:7833753,lightslategrey:7833753,lightsteelblue:11584734,lightyellow:16777184,lime:65280,limegreen:3329330,linen:16445670,magenta:16711935,maroon:8388608,mediumaquamarine:6737322,mediumblue:205,mediumorchid:12211667,mediumpurple:9662683,mediumseagreen:3978097,mediumslateblue:8087790,mediumspringgreen:64154,mediumturquoise:4772300,mediumvioletred:13047173,midnightblue:1644912,mintcream:16121850,mistyrose:16770273,moccasin:16770229,navajowhite:16768685,navy:128,oldlace:16643558,olive:8421376,olivedrab:7048739,orange:16753920,orangered:16729344,orchid:14315734,palegoldenrod:15657130,palegreen:10025880,paleturquoise:11529966,palevioletred:14381203,papayawhip:16773077,peachpuff:16767673,peru:13468991,pink:16761035,plum:14524637,powderblue:11591910,purple:8388736,rebeccapurple:6697881,red:16711680,rosybrown:12357519,royalblue:4286945,saddlebrown:9127187,salmon:16416882,sandybrown:16032864,seagreen:3050327,seashell:16774638,sienna:10506797,silver:12632256,skyblue:8900331,slateblue:6970061,slategray:7372944,slategrey:7372944,snow:16775930,springgreen:65407,steelblue:4620980,tan:13808780,teal:32896,thistle:14204888,tomato:16737095,turquoise:4251856,violet:15631086,wheat:16113331,white:16777215,whitesmoke:16119285,yellow:16776960,yellowgreen:10145074};Qn(fn,un,{copy(e){return Object.assign(new this.constructor,this,e)},displayable(){return this.rgb().displayable()},hex:Wi,formatHex:Wi,formatHex8:qf,formatHsl:Vf,formatRgb:Gi,toString:Gi});function Wi(){return this.rgb().formatHex()}function qf(){return this.rgb().formatHex8()}function Vf(){return sr(this).formatHsl()}function Gi(){return this.rgb().formatRgb()}function un(e){var n,t;return e=(e+"").trim().toLowerCase(),(n=$f.exec(e))?(t=n[1].length,n=parseInt(n[1],16),t===6?Hi(n):t===3?new ye(n>>8&15|n>>4&240,n>>4&15|n&240,(n&15)<<4|n&15,1):t===8?nt(n>>24&255,n>>16&255,n>>8&255,(n&255)/255):t===4?nt(n>>12&15|n>>8&240,n>>8&15|n>>4&240,n>>4&15|n&240,((n&15)<<4|n&15)/255):null):(n=Nf.exec(e))?new ye(n[1],n[2],n[3],1):(n=Of.exec(e))?new ye(n[1]*255/100,n[2]*255/100,n[3]*255/100,1):(n=Ef.exec(e))?nt(n[1],n[2],n[3],n[4]):(n=Rf.exec(e))?nt(n[1]*255/100,n[2]*255/100,n[3]*255/100,n[4]):(n=zf.exec(e))?Xi(n[1],n[2]/100,n[3]/100,1):(n=Bf.exec(e))?Xi(n[1],n[2]/100,n[3]/100,n[4]):Ui.hasOwnProperty(e)?Hi(Ui[e]):e==="transparent"?new ye(NaN,NaN,NaN,0):null}function Hi(e){return new ye(e>>16&255,e>>8&255,e&255,1)}function nt(e,n,t,a){return a<=0&&(e=n=t=NaN),new ye(e,n,t,a)}function ir(e){return e instanceof fn||(e=un(e)),e?(e=e.rgb(),new ye(e.r,e.g,e.b,e.opacity)):new ye}function Ta(e,n,t,a){return arguments.length===1?ir(e):new ye(e,n,t,a??1)}function ye(e,n,t,a){this.r=+e,this.g=+n,this.b=+t,this.opacity=+a}Qn(ye,Ta,Gt(fn,{brighter(e){return e=e==null?ft:Math.pow(ft,e),new ye(this.r*e,this.g*e,this.b*e,this.opacity)},darker(e){return e=e==null?Un:Math.pow(Un,e),new ye(this.r*e,this.g*e,this.b*e,this.opacity)},rgb(){return this},clamp(){return new ye(cn(this.r),cn(this.g),cn(this.b),vt(this.opacity))},displayable(){return-.5<=this.r&&this.r<255.5&&-.5<=this.g&&this.g<255.5&&-.5<=this.b&&this.b<255.5&&0<=this.opacity&&this.opacity<=1},hex:Ki,formatHex:Ki,formatHex8:jf,formatRgb:Yi,toString:Yi}));function Ki(){return`#${rn(this.r)}${rn(this.g)}${rn(this.b)}`}function jf(){return`#${rn(this.r)}${rn(this.g)}${rn(this.b)}${rn((isNaN(this.opacity)?1:this.opacity)*255)}`}function Yi(){const e=vt(this.opacity);return`${e===1?"rgb(":"rgba("}${cn(this.r)}, ${cn(this.g)}, ${cn(this.b)}${e===1?")":`, ${e})`}`}function vt(e){return isNaN(e)?1:Math.max(0,Math.min(1,e))}function cn(e){return Math.max(0,Math.min(255,Math.round(e)||0))}function rn(e){return e=cn(e),(e<16?"0":"")+e.toString(16)}function Xi(e,n,t,a){return a<=0?e=n=t=NaN:t<=0||t>=1?e=n=NaN:n<=0&&(e=NaN),new Ne(e,n,t,a)}function sr(e){if(e instanceof Ne)return new Ne(e.h,e.s,e.l,e.opacity);if(e instanceof fn||(e=un(e)),!e)return new Ne;if(e instanceof Ne)return e;e=e.rgb();var n=e.r/255,t=e.g/255,a=e.b/255,o=Math.min(n,t,a),i=Math.max(n,t,a),s=NaN,r=i-o,l=(i+o)/2;return r?(n===i?s=(t-a)/r+(t<a)*6:t===i?s=(a-n)/r+2:s=(n-t)/r+4,r/=l<.5?i+o:2-i-o,s*=60):r=l>0&&l<1?0:s,new Ne(s,r,l,e.opacity)}function Ff(e,n,t,a){return arguments.length===1?sr(e):new Ne(e,n,t,a??1)}function Ne(e,n,t,a){this.h=+e,this.s=+n,this.l=+t,this.opacity=+a}Qn(Ne,Ff,Gt(fn,{brighter(e){return e=e==null?ft:Math.pow(ft,e),new Ne(this.h,this.s,this.l*e,this.opacity)},darker(e){return e=e==null?Un:Math.pow(Un,e),new Ne(this.h,this.s,this.l*e,this.opacity)},rgb(){var e=this.h%360+(this.h<0)*360,n=isNaN(e)||isNaN(this.s)?0:this.s,t=this.l,a=t+(t<.5?t:1-t)*n,o=2*t-a;return new ye(aa(e>=240?e-240:e+120,o,a),aa(e,o,a),aa(e<120?e+240:e-120,o,a),this.opacity)},clamp(){return new Ne(Qi(this.h),tt(this.s),tt(this.l),vt(this.opacity))},displayable(){return(0<=this.s&&this.s<=1||isNaN(this.s))&&0<=this.l&&this.l<=1&&0<=this.opacity&&this.opacity<=1},formatHsl(){const e=vt(this.opacity);return`${e===1?"hsl(":"hsla("}${Qi(this.h)}, ${tt(this.s)*100}%, ${tt(this.l)*100}%${e===1?")":`, ${e})`}`}}));function Qi(e){return e=(e||0)%360,e<0?e+360:e}function tt(e){return Math.max(0,Math.min(1,e||0))}function aa(e,n,t){return(e<60?n+(t-n)*e/60:e<180?t:e<240?n+(t-n)*(240-e)/60:n)*255}const Uf=Math.PI/180,Wf=180/Math.PI,bt=18,rr=.96422,lr=1,cr=.82521,dr=4/29,Cn=6/29,ur=3*Cn*Cn,Gf=Cn*Cn*Cn;function hr(e){if(e instanceof Ve)return new Ve(e.l,e.a,e.b,e.opacity);if(e instanceof We)return gr(e);e instanceof ye||(e=ir(e));var n=ra(e.r),t=ra(e.g),a=ra(e.b),o=oa((.2225045*n+.7168786*t+.0606169*a)/lr),i,s;return n===t&&t===a?i=s=o:(i=oa((.4360747*n+.3850649*t+.1430804*a)/rr),s=oa((.0139322*n+.0971045*t+.7141733*a)/cr)),new Ve(116*o-16,500*(i-o),200*(o-s),e.opacity)}function Hf(e,n,t,a){return arguments.length===1?hr(e):new Ve(e,n,t,a??1)}function Ve(e,n,t,a){this.l=+e,this.a=+n,this.b=+t,this.opacity=+a}Qn(Ve,Hf,Gt(fn,{brighter(e){return new Ve(this.l+bt*(e??1),this.a,this.b,this.opacity)},darker(e){return new Ve(this.l-bt*(e??1),this.a,this.b,this.opacity)},rgb(){var e=(this.l+16)/116,n=isNaN(this.a)?e:e+this.a/500,t=isNaN(this.b)?e:e-this.b/200;return n=rr*ia(n),e=lr*ia(e),t=cr*ia(t),new ye(sa(3.1338561*n-1.6168667*e-.4906146*t),sa(-.9787684*n+1.9161415*e+.033454*t),sa(.0719453*n-.2289914*e+1.4052427*t),this.opacity)}}));function oa(e){return e>Gf?Math.pow(e,1/3):e/ur+dr}function ia(e){return e>Cn?e*e*e:ur*(e-dr)}function sa(e){return 255*(e<=.0031308?12.92*e:1.055*Math.pow(e,1/2.4)-.055)}function ra(e){return(e/=255)<=.04045?e/12.92:Math.pow((e+.055)/1.055,2.4)}function Kf(e){if(e instanceof We)return new We(e.h,e.c,e.l,e.opacity);if(e instanceof Ve||(e=hr(e)),e.a===0&&e.b===0)return new We(NaN,0<e.l&&e.l<100?0:NaN,e.l,e.opacity);var n=Math.atan2(e.b,e.a)*Wf;return new We(n<0?n+360:n,Math.sqrt(e.a*e.a+e.b*e.b),e.l,e.opacity)}function Ia(e,n,t,a){return arguments.length===1?Kf(e):new We(e,n,t,a??1)}function We(e,n,t,a){this.h=+e,this.c=+n,this.l=+t,this.opacity=+a}function gr(e){if(isNaN(e.h))return new Ve(e.l,0,0,e.opacity);var n=e.h*Uf;return new Ve(e.l,Math.cos(n)*e.c,Math.sin(n)*e.c,e.opacity)}Qn(We,Ia,Gt(fn,{brighter(e){return new We(this.h,this.c,this.l+bt*(e??1),this.opacity)},darker(e){return new We(this.h,this.c,this.l-bt*(e??1),this.opacity)},rgb(){return gr(this).rgb()}}));const Ht=e=>()=>e;function pr(e,n){return function(t){return e+t*n}}function Yf(e,n,t){return e=Math.pow(e,t),n=Math.pow(n,t)-e,t=1/t,function(a){return Math.pow(e+a*n,t)}}function Xf(e,n){var t=n-e;return t?pr(e,t>180||t<-180?t-360*Math.round(t/360):t):Ht(isNaN(e)?n:e)}function Qf(e){return(e=+e)==1?Vn:function(n,t){return t-n?Yf(n,t,e):Ht(isNaN(n)?t:n)}}function Vn(e,n){var t=n-e;return t?pr(e,t):Ht(isNaN(e)?n:e)}const yt=function e(n){var t=Qf(n);function a(o,i){var s=t((o=Ta(o)).r,(i=Ta(i)).r),r=t(o.g,i.g),l=t(o.b,i.b),c=Vn(o.opacity,i.opacity);return function(u){return o.r=s(u),o.g=r(u),o.b=l(u),o.opacity=c(u),o+""}}return a.gamma=e,a}(1);function Jf(e,n){n||(n=[]);var t=e?Math.min(n.length,e.length):0,a=n.slice(),o;return function(i){for(o=0;o<t;++o)a[o]=e[o]*(1-i)+n[o]*i;return a}}function Zf(e){return ArrayBuffer.isView(e)&&!(e instanceof DataView)}function ev(e,n){var t=n?n.length:0,a=e?Math.min(t,e.length):0,o=new Array(a),i=new Array(t),s;for(s=0;s<a;++s)o[s]=fi(e[s],n[s]);for(;s<t;++s)i[s]=n[s];return function(r){for(s=0;s<a;++s)i[s]=o[s](r);return i}}function nv(e,n){var t=new Date;return e=+e,n=+n,function(a){return t.setTime(e*(1-a)+n*a),t}}function $e(e,n){return e=+e,n=+n,function(t){return e*(1-t)+n*t}}function tv(e,n){var t={},a={},o;(e===null||typeof e!="object")&&(e={}),(n===null||typeof n!="object")&&(n={});for(o in n)o in e?t[o]=fi(e[o],n[o]):a[o]=n[o];return function(i){for(o in t)a[o]=t[o](i);return a}}var Sa=/[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,la=new RegExp(Sa.source,"g");function av(e){return function(){return e}}function ov(e){return function(n){return e(n)+""}}function mr(e,n){var t=Sa.lastIndex=la.lastIndex=0,a,o,i,s=-1,r=[],l=[];for(e=e+"",n=n+"";(a=Sa.exec(e))&&(o=la.exec(n));)(i=o.index)>t&&(i=n.slice(t,i),r[s]?r[s]+=i:r[++s]=i),(a=a[0])===(o=o[0])?r[s]?r[s]+=o:r[++s]=o:(r[++s]=null,l.push({i:s,x:$e(a,o)})),t=la.lastIndex;return t<n.length&&(i=n.slice(t),r[s]?r[s]+=i:r[++s]=i),r.length<2?l[0]?ov(l[0].x):av(n):(n=l.length,function(c){for(var u=0,p;u<n;++u)r[(p=l[u]).i]=p.x(c);return r.join("")})}function fi(e,n){var t=typeof n,a;return n==null||t==="boolean"?Ht(n):(t==="number"?$e:t==="string"?(a=un(n))?(n=a,yt):mr:n instanceof un?yt:n instanceof Date?nv:Zf(n)?Jf:Array.isArray(n)?ev:typeof n.valueOf!="function"&&typeof n.toString!="function"||isNaN(n)?tv:$e)(e,n)}function iv(e,n){return e=+e,n=+n,function(t){return Math.round(e*(1-t)+n*t)}}var Ji=180/Math.PI,Da={translateX:0,translateY:0,rotate:0,skewX:0,scaleX:1,scaleY:1};function fr(e,n,t,a,o,i){var s,r,l;return(s=Math.sqrt(e*e+n*n))&&(e/=s,n/=s),(l=e*t+n*a)&&(t-=e*l,a-=n*l),(r=Math.sqrt(t*t+a*a))&&(t/=r,a/=r,l/=r),e*a<n*t&&(e=-e,n=-n,l=-l,s=-s),{translateX:o,translateY:i,rotate:Math.atan2(n,e)*Ji,skewX:Math.atan(l)*Ji,scaleX:s,scaleY:r}}var at;function sv(e){const n=new(typeof DOMMatrix=="function"?DOMMatrix:WebKitCSSMatrix)(e+"");return n.isIdentity?Da:fr(n.a,n.b,n.c,n.d,n.e,n.f)}function rv(e){return e==null||(at||(at=document.createElementNS("http://www.w3.org/2000/svg","g")),at.setAttribute("transform",e),!(e=at.transform.baseVal.consolidate()))?Da:(e=e.matrix,fr(e.a,e.b,e.c,e.d,e.e,e.f))}function vr(e,n,t,a){function o(c){return c.length?c.pop()+" ":""}function i(c,u,p,d,h,v){if(c!==p||u!==d){var b=h.push("translate(",null,n,null,t);v.push({i:b-4,x:$e(c,p)},{i:b-2,x:$e(u,d)})}else(p||d)&&h.push("translate("+p+n+d+t)}function s(c,u,p,d){c!==u?(c-u>180?u+=360:u-c>180&&(c+=360),d.push({i:p.push(o(p)+"rotate(",null,a)-2,x:$e(c,u)})):u&&p.push(o(p)+"rotate("+u+a)}function r(c,u,p,d){c!==u?d.push({i:p.push(o(p)+"skewX(",null,a)-2,x:$e(c,u)}):u&&p.push(o(p)+"skewX("+u+a)}function l(c,u,p,d,h,v){if(c!==p||u!==d){var b=h.push(o(h)+"scale(",null,",",null,")");v.push({i:b-4,x:$e(c,p)},{i:b-2,x:$e(u,d)})}else(p!==1||d!==1)&&h.push(o(h)+"scale("+p+","+d+")")}return function(c,u){var p=[],d=[];return c=e(c),u=e(u),i(c.translateX,c.translateY,u.translateX,u.translateY,p,d),s(c.rotate,u.rotate,p,d),r(c.skewX,u.skewX,p,d),l(c.scaleX,c.scaleY,u.scaleX,u.scaleY,p,d),c=u=null,function(h){for(var v=-1,b=d.length,w;++v<b;)p[(w=d[v]).i]=w.x(h);return p.join("")}}}var lv=vr(sv,"px, ","px)","deg)"),cv=vr(rv,", ",")",")");function dv(e){return function(n,t){var a=e((n=Ia(n)).h,(t=Ia(t)).h),o=Vn(n.c,t.c),i=Vn(n.l,t.l),s=Vn(n.opacity,t.opacity);return function(r){return n.h=a(r),n.c=o(r),n.l=i(r),n.opacity=s(r),n+""}}}const fk=dv(Xf);var In=0,zn=0,Mn=0,br=1e3,wt,Bn,_t=0,hn=0,Kt=0,Gn=typeof performance=="object"&&performance.now?performance:Date,yr=typeof window=="object"&&window.requestAnimationFrame?window.requestAnimationFrame.bind(window):function(e){setTimeout(e,17)};function vi(){return hn||(yr(uv),hn=Gn.now()+Kt)}function uv(){hn=0}function kt(){this._call=this._time=this._next=null}kt.prototype=bi.prototype={constructor:kt,restart:function(e,n,t){if(typeof e!="function")throw new TypeError("callback is not a function");t=(t==null?vi():+t)+(n==null?0:+n),!this._next&&Bn!==this&&(Bn?Bn._next=this:wt=this,Bn=this),this._call=e,this._time=t,Pa()},stop:function(){this._call&&(this._call=null,this._time=1/0,Pa())}};function bi(e,n,t){var a=new kt;return a.restart(e,n,t),a}function hv(){vi(),++In;for(var e=wt,n;e;)(n=hn-e._time)>=0&&e._call.call(void 0,n),e=e._next;--In}function Zi(){hn=(_t=Gn.now())+Kt,In=zn=0;try{hv()}finally{In=0,pv(),hn=0}}function gv(){var e=Gn.now(),n=e-_t;n>br&&(Kt-=n,_t=e)}function pv(){for(var e,n=wt,t,a=1/0;n;)n._call?(a>n._time&&(a=n._time),e=n,n=n._next):(t=n._next,n._next=null,n=e?e._next=t:wt=t);Bn=e,Pa(a)}function Pa(e){if(!In){zn&&(zn=clearTimeout(zn));var n=e-hn;n>24?(e<1/0&&(zn=setTimeout(Zi,e-Gn.now()-Kt)),Mn&&(Mn=clearInterval(Mn))):(Mn||(_t=Gn.now(),Mn=setInterval(gv,br)),In=1,yr(Zi))}}function es(e,n,t){var a=new kt;return n=n==null?0:+n,a.restart(o=>{a.stop(),e(o+n)},n,t),a}var mv=Ut("start","end","cancel","interrupt"),fv=[],wr=0,ns=1,Ma=2,dt=3,ts=4,La=5,ut=6;function Yt(e,n,t,a,o,i){var s=e.__transition;if(!s)e.__transition={};else if(t in s)return;vv(e,t,{name:n,index:a,group:o,on:mv,tween:fv,time:i.time,delay:i.delay,duration:i.duration,ease:i.ease,timer:null,state:wr})}function yi(e,n){var t=Ee(e,n);if(t.state>wr)throw new Error("too late; already scheduled");return t}function je(e,n){var t=Ee(e,n);if(t.state>dt)throw new Error("too late; already running");return t}function Ee(e,n){var t=e.__transition;if(!t||!(t=t[n]))throw new Error("transition not found");return t}function vv(e,n,t){var a=e.__transition,o;a[n]=t,t.timer=bi(i,0,t.time);function i(c){t.state=ns,t.timer.restart(s,t.delay,t.time),t.delay<=c&&s(c-t.delay)}function s(c){var u,p,d,h;if(t.state!==ns)return l();for(u in a)if(h=a[u],h.name===t.name){if(h.state===dt)return es(s);h.state===ts?(h.state=ut,h.timer.stop(),h.on.call("interrupt",e,e.__data__,h.index,h.group),delete a[u]):+u<n&&(h.state=ut,h.timer.stop(),h.on.call("cancel",e,e.__data__,h.index,h.group),delete a[u])}if(es(function(){t.state===dt&&(t.state=ts,t.timer.restart(r,t.delay,t.time),r(c))}),t.state=Ma,t.on.call("start",e,e.__data__,t.index,t.group),t.state===Ma){for(t.state=dt,o=new Array(d=t.tween.length),u=0,p=-1;u<d;++u)(h=t.tween[u].value.call(e,e.__data__,t.index,t.group))&&(o[++p]=h);o.length=p+1}}function r(c){for(var u=c<t.duration?t.ease.call(null,c/t.duration):(t.timer.restart(l),t.state=La,1),p=-1,d=o.length;++p<d;)o[p].call(e,u);t.state===La&&(t.on.call("end",e,e.__data__,t.index,t.group),l())}function l(){t.state=ut,t.timer.stop(),delete a[n];for(var c in a)return;delete e.__transition}}function bv(e,n){var t=e.__transition,a,o,i=!0,s;if(t){n=n==null?null:n+"";for(s in t){if((a=t[s]).name!==n){i=!1;continue}o=a.state>Ma&&a.state<La,a.state=ut,a.timer.stop(),a.on.call(o?"interrupt":"cancel",e,e.__data__,a.index,a.group),delete t[s]}i&&delete e.__transition}}function yv(e){return this.each(function(){bv(this,e)})}function wv(e,n){var t,a;return function(){var o=je(this,e),i=o.tween;if(i!==t){a=t=i;for(var s=0,r=a.length;s<r;++s)if(a[s].name===n){a=a.slice(),a.splice(s,1);break}}o.tween=a}}function _v(e,n,t){var a,o;if(typeof t!="function")throw new Error;return function(){var i=je(this,e),s=i.tween;if(s!==a){o=(a=s).slice();for(var r={name:n,value:t},l=0,c=o.length;l<c;++l)if(o[l].name===n){o[l]=r;break}l===c&&o.push(r)}i.tween=o}}function kv(e,n){var t=this._id;if(e+="",arguments.length<2){for(var a=Ee(this.node(),t).tween,o=0,i=a.length,s;o<i;++o)if((s=a[o]).name===e)return s.value;return null}return this.each((n==null?wv:_v)(t,e,n))}function wi(e,n,t){var a=e._id;return e.each(function(){var o=je(this,a);(o.value||(o.value={}))[n]=t.apply(this,arguments)}),function(o){return Ee(o,a).value[n]}}function _r(e,n){var t;return(typeof n=="number"?$e:n instanceof un?yt:(t=un(n))?(n=t,yt):mr)(e,n)}function xv(e){return function(){this.removeAttribute(e)}}function Av(e){return function(){this.removeAttributeNS(e.space,e.local)}}function Cv(e,n,t){var a,o=t+"",i;return function(){var s=this.getAttribute(e);return s===o?null:s===a?i:i=n(a=s,t)}}function Tv(e,n,t){var a,o=t+"",i;return function(){var s=this.getAttributeNS(e.space,e.local);return s===o?null:s===a?i:i=n(a=s,t)}}function Iv(e,n,t){var a,o,i;return function(){var s,r=t(this),l;return r==null?void this.removeAttribute(e):(s=this.getAttribute(e),l=r+"",s===l?null:s===a&&l===o?i:(o=l,i=n(a=s,r)))}}function Sv(e,n,t){var a,o,i;return function(){var s,r=t(this),l;return r==null?void this.removeAttributeNS(e.space,e.local):(s=this.getAttributeNS(e.space,e.local),l=r+"",s===l?null:s===a&&l===o?i:(o=l,i=n(a=s,r)))}}function Dv(e,n){var t=Wt(e),a=t==="transform"?cv:_r;return this.attrTween(e,typeof n=="function"?(t.local?Sv:Iv)(t,a,wi(this,"attr."+e,n)):n==null?(t.local?Av:xv)(t):(t.local?Tv:Cv)(t,a,n))}function Pv(e,n){return function(t){this.setAttribute(e,n.call(this,t))}}function Mv(e,n){return function(t){this.setAttributeNS(e.space,e.local,n.call(this,t))}}function Lv(e,n){var t,a;function o(){var i=n.apply(this,arguments);return i!==a&&(t=(a=i)&&Mv(e,i)),t}return o._value=n,o}function $v(e,n){var t,a;function o(){var i=n.apply(this,arguments);return i!==a&&(t=(a=i)&&Pv(e,i)),t}return o._value=n,o}function Nv(e,n){var t="attr."+e;if(arguments.length<2)return(t=this.tween(t))&&t._value;if(n==null)return this.tween(t,null);if(typeof n!="function")throw new Error;var a=Wt(e);return this.tween(t,(a.local?Lv:$v)(a,n))}function Ov(e,n){return function(){yi(this,e).delay=+n.apply(this,arguments)}}function Ev(e,n){return n=+n,function(){yi(this,e).delay=n}}function Rv(e){var n=this._id;return arguments.length?this.each((typeof e=="function"?Ov:Ev)(n,e)):Ee(this.node(),n).delay}function zv(e,n){return function(){je(this,e).duration=+n.apply(this,arguments)}}function Bv(e,n){return n=+n,function(){je(this,e).duration=n}}function qv(e){var n=this._id;return arguments.length?this.each((typeof e=="function"?zv:Bv)(n,e)):Ee(this.node(),n).duration}function Vv(e,n){if(typeof n!="function")throw new Error;return function(){je(this,e).ease=n}}function jv(e){var n=this._id;return arguments.length?this.each(Vv(n,e)):Ee(this.node(),n).ease}function Fv(e,n){return function(){var t=n.apply(this,arguments);if(typeof t!="function")throw new Error;je(this,e).ease=t}}function Uv(e){if(typeof e!="function")throw new Error;return this.each(Fv(this._id,e))}function Wv(e){typeof e!="function"&&(e=Ys(e));for(var n=this._groups,t=n.length,a=new Array(t),o=0;o<t;++o)for(var i=n[o],s=i.length,r=a[o]=[],l,c=0;c<s;++c)(l=i[c])&&e.call(l,l.__data__,c,i)&&r.push(l);return new Ke(a,this._parents,this._name,this._id)}function Gv(e){if(e._id!==this._id)throw new Error;for(var n=this._groups,t=e._groups,a=n.length,o=t.length,i=Math.min(a,o),s=new Array(a),r=0;r<i;++r)for(var l=n[r],c=t[r],u=l.length,p=s[r]=new Array(u),d,h=0;h<u;++h)(d=l[h]||c[h])&&(p[h]=d);for(;r<a;++r)s[r]=n[r];return new Ke(s,this._parents,this._name,this._id)}function Hv(e){return(e+"").trim().split(/^|\s+/).every(function(n){var t=n.indexOf(".");return t>=0&&(n=n.slice(0,t)),!n||n==="start"})}function Kv(e,n,t){var a,o,i=Hv(n)?yi:je;return function(){var s=i(this,e),r=s.on;r!==a&&(o=(a=r).copy()).on(n,t),s.on=o}}function Yv(e,n){var t=this._id;return arguments.length<2?Ee(this.node(),t).on.on(e):this.each(Kv(t,e,n))}function Xv(e){return function(){var n=this.parentNode;for(var t in this.__transition)if(+t!==e)return;n&&n.removeChild(this)}}function Qv(){return this.on("end.remove",Xv(this._id))}function Jv(e){var n=this._name,t=this._id;typeof e!="function"&&(e=pi(e));for(var a=this._groups,o=a.length,i=new Array(o),s=0;s<o;++s)for(var r=a[s],l=r.length,c=i[s]=new Array(l),u,p,d=0;d<l;++d)(u=r[d])&&(p=e.call(u,u.__data__,d,r))&&("__data__"in u&&(p.__data__=u.__data__),c[d]=p,Yt(c[d],n,t,d,c,Ee(u,t)));return new Ke(i,this._parents,n,t)}function Zv(e){var n=this._name,t=this._id;typeof e!="function"&&(e=Ks(e));for(var a=this._groups,o=a.length,i=[],s=[],r=0;r<o;++r)for(var l=a[r],c=l.length,u,p=0;p<c;++p)if(u=l[p]){for(var d=e.call(u,u.__data__,p,l),h,v=Ee(u,t),b=0,w=d.length;b<w;++b)(h=d[b])&&Yt(h,n,t,b,d,v);i.push(d),s.push(u)}return new Ke(i,s,n,t)}var eb=Xn.prototype.constructor;function nb(){return new eb(this._groups,this._parents)}function tb(e,n){var t,a,o;return function(){var i=Tn(this,e),s=(this.style.removeProperty(e),Tn(this,e));return i===s?null:i===t&&s===a?o:o=n(t=i,a=s)}}function kr(e){return function(){this.style.removeProperty(e)}}function ab(e,n,t){var a,o=t+"",i;return function(){var s=Tn(this,e);return s===o?null:s===a?i:i=n(a=s,t)}}function ob(e,n,t){var a,o,i;return function(){var s=Tn(this,e),r=t(this),l=r+"";return r==null&&(l=r=(this.style.removeProperty(e),Tn(this,e))),s===l?null:s===a&&l===o?i:(o=l,i=n(a=s,r))}}function ib(e,n){var t,a,o,i="style."+n,s="end."+i,r;return function(){var l=je(this,e),c=l.on,u=l.value[i]==null?r||(r=kr(n)):void 0;(c!==t||o!==u)&&(a=(t=c).copy()).on(s,o=u),l.on=a}}function sb(e,n,t){var a=(e+="")=="transform"?lv:_r;return n==null?this.styleTween(e,tb(e,a)).on("end.style."+e,kr(e)):typeof n=="function"?this.styleTween(e,ob(e,a,wi(this,"style."+e,n))).each(ib(this._id,e)):this.styleTween(e,ab(e,a,n),t).on("end.style."+e,null)}function rb(e,n,t){return function(a){this.style.setProperty(e,n.call(this,a),t)}}function lb(e,n,t){var a,o;function i(){var s=n.apply(this,arguments);return s!==o&&(a=(o=s)&&rb(e,s,t)),a}return i._value=n,i}function cb(e,n,t){var a="style."+(e+="");if(arguments.length<2)return(a=this.tween(a))&&a._value;if(n==null)return this.tween(a,null);if(typeof n!="function")throw new Error;return this.tween(a,lb(e,n,t??""))}function db(e){return function(){this.textContent=e}}function ub(e){return function(){var n=e(this);this.textContent=n??""}}function hb(e){return this.tween("text",typeof e=="function"?ub(wi(this,"text",e)):db(e==null?"":e+""))}function gb(e){return function(n){this.textContent=e.call(this,n)}}function pb(e){var n,t;function a(){var o=e.apply(this,arguments);return o!==t&&(n=(t=o)&&gb(o)),n}return a._value=e,a}function mb(e){var n="text";if(arguments.length<1)return(n=this.tween(n))&&n._value;if(e==null)return this.tween(n,null);if(typeof e!="function")throw new Error;return this.tween(n,pb(e))}function fb(){for(var e=this._name,n=this._id,t=xr(),a=this._groups,o=a.length,i=0;i<o;++i)for(var s=a[i],r=s.length,l,c=0;c<r;++c)if(l=s[c]){var u=Ee(l,n);Yt(l,e,t,c,s,{time:u.time+u.delay+u.duration,delay:0,duration:u.duration,ease:u.ease})}return new Ke(a,this._parents,e,t)}function vb(){var e,n,t=this,a=t._id,o=t.size();return new Promise(function(i,s){var r={value:s},l={value:function(){--o===0&&i()}};t.each(function(){var c=je(this,a),u=c.on;u!==e&&(n=(e=u).copy(),n._.cancel.push(r),n._.interrupt.push(r),n._.end.push(l)),c.on=n}),o===0&&i()})}var bb=0;function Ke(e,n,t,a){this._groups=e,this._parents=n,this._name=t,this._id=a}function xr(){return++bb}var Fe=Xn.prototype;Ke.prototype={constructor:Ke,select:Jv,selectAll:Zv,selectChild:Fe.selectChild,selectChildren:Fe.selectChildren,filter:Wv,merge:Gv,selection:nb,transition:fb,call:Fe.call,nodes:Fe.nodes,node:Fe.node,size:Fe.size,empty:Fe.empty,each:Fe.each,on:Yv,attr:Dv,attrTween:Nv,style:sb,styleTween:cb,text:hb,textTween:mb,remove:Qv,tween:kv,delay:Rv,duration:qv,ease:jv,easeVarying:Uv,end:vb,[Symbol.iterator]:Fe[Symbol.iterator]};function yb(e){return((e*=2)<=1?e*e*e:(e-=2)*e*e+2)/2}var wb={time:null,delay:0,duration:250,ease:yb};function _b(e,n){for(var t;!(t=e.__transition)||!(t=t[n]);)if(!(e=e.parentNode))throw new Error(`transition ${n} not found`);return t}function kb(e){var n,t;e instanceof Ke?(n=e._id,e=e._name):(n=xr(),(t=wb).time=vi(),e=e==null?null:e+"");for(var a=this._groups,o=a.length,i=0;i<o;++i)for(var s=a[i],r=s.length,l,c=0;c<r;++c)(l=s[c])&&Yt(l,e,n,c,s,t||_b(l,n));return new Ke(a,this._parents,e,n)}Xn.prototype.interrupt=yv;Xn.prototype.transition=kb;const $a=Math.PI,Na=2*$a,sn=1e-6,xb=Na-sn;function Ar(e){this._+=e[0];for(let n=1,t=e.length;n<t;++n)this._+=arguments[n]+e[n]}function Ab(e){let n=Math.floor(e);if(!(n>=0))throw new Error(`invalid digits: ${e}`);if(n>15)return Ar;const t=10**n;return function(a){this._+=a[0];for(let o=1,i=a.length;o<i;++o)this._+=Math.round(arguments[o]*t)/t+a[o]}}class Cb{constructor(n){this._x0=this._y0=this._x1=this._y1=null,this._="",this._append=n==null?Ar:Ab(n)}moveTo(n,t){this._append`M${this._x0=this._x1=+n},${this._y0=this._y1=+t}`}closePath(){this._x1!==null&&(this._x1=this._x0,this._y1=this._y0,this._append`Z`)}lineTo(n,t){this._append`L${this._x1=+n},${this._y1=+t}`}quadraticCurveTo(n,t,a,o){this._append`Q${+n},${+t},${this._x1=+a},${this._y1=+o}`}bezierCurveTo(n,t,a,o,i,s){this._append`C${+n},${+t},${+a},${+o},${this._x1=+i},${this._y1=+s}`}arcTo(n,t,a,o,i){if(n=+n,t=+t,a=+a,o=+o,i=+i,i<0)throw new Error(`negative radius: ${i}`);let s=this._x1,r=this._y1,l=a-n,c=o-t,u=s-n,p=r-t,d=u*u+p*p;if(this._x1===null)this._append`M${this._x1=n},${this._y1=t}`;else if(d>sn)if(!(Math.abs(p*l-c*u)>sn)||!i)this._append`L${this._x1=n},${this._y1=t}`;else{let h=a-s,v=o-r,b=l*l+c*c,w=h*h+v*v,x=Math.sqrt(b),A=Math.sqrt(d),M=i*Math.tan(($a-Math.acos((b+d-w)/(2*x*A)))/2),y=M/A,T=M/x;Math.abs(y-1)>sn&&this._append`L${n+y*u},${t+y*p}`,this._append`A${i},${i},0,0,${+(p*h>u*v)},${this._x1=n+T*l},${this._y1=t+T*c}`}}arc(n,t,a,o,i,s){if(n=+n,t=+t,a=+a,s=!!s,a<0)throw new Error(`negative radius: ${a}`);let r=a*Math.cos(o),l=a*Math.sin(o),c=n+r,u=t+l,p=1^s,d=s?o-i:i-o;this._x1===null?this._append`M${c},${u}`:(Math.abs(this._x1-c)>sn||Math.abs(this._y1-u)>sn)&&this._append`L${c},${u}`,a&&(d<0&&(d=d%Na+Na),d>xb?this._append`A${a},${a},0,1,${p},${n-r},${t-l}A${a},${a},0,1,${p},${this._x1=c},${this._y1=u}`:d>sn&&this._append`A${a},${a},0,${+(d>=$a)},${p},${this._x1=n+a*Math.cos(i)},${this._y1=t+a*Math.sin(i)}`)}rect(n,t,a,o){this._append`M${this._x0=this._x1=+n},${this._y0=this._y1=+t}h${a=+a}v${+o}h${-a}Z`}toString(){return this._}}function Tb(e,n){var t,a=1;e==null&&(e=0),n==null&&(n=0);function o(){var i,s=t.length,r,l=0,c=0;for(i=0;i<s;++i)r=t[i],l+=r.x,c+=r.y;for(l=(l/s-e)*a,c=(c/s-n)*a,i=0;i<s;++i)r=t[i],r.x-=l,r.y-=c}return o.initialize=function(i){t=i},o.x=function(i){return arguments.length?(e=+i,o):e},o.y=function(i){return arguments.length?(n=+i,o):n},o.strength=function(i){return arguments.length?(a=+i,o):a},o}function Ib(e){const n=+this._x.call(null,e),t=+this._y.call(null,e);return Cr(this.cover(n,t),n,t,e)}function Cr(e,n,t,a){if(isNaN(n)||isNaN(t))return e;var o,i=e._root,s={data:a},r=e._x0,l=e._y0,c=e._x1,u=e._y1,p,d,h,v,b,w,x,A;if(!i)return e._root=s,e;for(;i.length;)if((b=n>=(p=(r+c)/2))?r=p:c=p,(w=t>=(d=(l+u)/2))?l=d:u=d,o=i,!(i=i[x=w<<1|b]))return o[x]=s,e;if(h=+e._x.call(null,i.data),v=+e._y.call(null,i.data),n===h&&t===v)return s.next=i,o?o[x]=s:e._root=s,e;do o=o?o[x]=new Array(4):e._root=new Array(4),(b=n>=(p=(r+c)/2))?r=p:c=p,(w=t>=(d=(l+u)/2))?l=d:u=d;while((x=w<<1|b)===(A=(v>=d)<<1|h>=p));return o[A]=i,o[x]=s,e}function Sb(e){var n,t,a=e.length,o,i,s=new Array(a),r=new Array(a),l=1/0,c=1/0,u=-1/0,p=-1/0;for(t=0;t<a;++t)isNaN(o=+this._x.call(null,n=e[t]))||isNaN(i=+this._y.call(null,n))||(s[t]=o,r[t]=i,o<l&&(l=o),o>u&&(u=o),i<c&&(c=i),i>p&&(p=i));if(l>u||c>p)return this;for(this.cover(l,c).cover(u,p),t=0;t<a;++t)Cr(this,s[t],r[t],e[t]);return this}function Db(e,n){if(isNaN(e=+e)||isNaN(n=+n))return this;var t=this._x0,a=this._y0,o=this._x1,i=this._y1;if(isNaN(t))o=(t=Math.floor(e))+1,i=(a=Math.floor(n))+1;else{for(var s=o-t||1,r=this._root,l,c;t>e||e>=o||a>n||n>=i;)switch(c=(n<a)<<1|e<t,l=new Array(4),l[c]=r,r=l,s*=2,c){case 0:o=t+s,i=a+s;break;case 1:t=o-s,i=a+s;break;case 2:o=t+s,a=i-s;break;case 3:t=o-s,a=i-s;break}this._root&&this._root.length&&(this._root=r)}return this._x0=t,this._y0=a,this._x1=o,this._y1=i,this}function Pb(){var e=[];return this.visit(function(n){if(!n.length)do e.push(n.data);while(n=n.next)}),e}function Mb(e){return arguments.length?this.cover(+e[0][0],+e[0][1]).cover(+e[1][0],+e[1][1]):isNaN(this._x0)?void 0:[[this._x0,this._y0],[this._x1,this._y1]]}function _e(e,n,t,a,o){this.node=e,this.x0=n,this.y0=t,this.x1=a,this.y1=o}function Lb(e,n,t){var a,o=this._x0,i=this._y0,s,r,l,c,u=this._x1,p=this._y1,d=[],h=this._root,v,b;for(h&&d.push(new _e(h,o,i,u,p)),t==null?t=1/0:(o=e-t,i=n-t,u=e+t,p=n+t,t*=t);v=d.pop();)if(!(!(h=v.node)||(s=v.x0)>u||(r=v.y0)>p||(l=v.x1)<o||(c=v.y1)<i))if(h.length){var w=(s+l)/2,x=(r+c)/2;d.push(new _e(h[3],w,x,l,c),new _e(h[2],s,x,w,c),new _e(h[1],w,r,l,x),new _e(h[0],s,r,w,x)),(b=(n>=x)<<1|e>=w)&&(v=d[d.length-1],d[d.length-1]=d[d.length-1-b],d[d.length-1-b]=v)}else{var A=e-+this._x.call(null,h.data),M=n-+this._y.call(null,h.data),y=A*A+M*M;if(y<t){var T=Math.sqrt(t=y);o=e-T,i=n-T,u=e+T,p=n+T,a=h.data}}return a}function $b(e){if(isNaN(u=+this._x.call(null,e))||isNaN(p=+this._y.call(null,e)))return this;var n,t=this._root,a,o,i,s=this._x0,r=this._y0,l=this._x1,c=this._y1,u,p,d,h,v,b,w,x;if(!t)return this;if(t.length)for(;;){if((v=u>=(d=(s+l)/2))?s=d:l=d,(b=p>=(h=(r+c)/2))?r=h:c=h,n=t,!(t=t[w=b<<1|v]))return this;if(!t.length)break;(n[w+1&3]||n[w+2&3]||n[w+3&3])&&(a=n,x=w)}for(;t.data!==e;)if(o=t,!(t=t.next))return this;return(i=t.next)&&delete t.next,o?(i?o.next=i:delete o.next,this):n?(i?n[w]=i:delete n[w],(t=n[0]||n[1]||n[2]||n[3])&&t===(n[3]||n[2]||n[1]||n[0])&&!t.length&&(a?a[x]=t:this._root=t),this):(this._root=i,this)}function Nb(e){for(var n=0,t=e.length;n<t;++n)this.remove(e[n]);return this}function Ob(){return this._root}function Eb(){var e=0;return this.visit(function(n){if(!n.length)do++e;while(n=n.next)}),e}function Rb(e){var n=[],t,a=this._root,o,i,s,r,l;for(a&&n.push(new _e(a,this._x0,this._y0,this._x1,this._y1));t=n.pop();)if(!e(a=t.node,i=t.x0,s=t.y0,r=t.x1,l=t.y1)&&a.length){var c=(i+r)/2,u=(s+l)/2;(o=a[3])&&n.push(new _e(o,c,u,r,l)),(o=a[2])&&n.push(new _e(o,i,u,c,l)),(o=a[1])&&n.push(new _e(o,c,s,r,u)),(o=a[0])&&n.push(new _e(o,i,s,c,u))}return this}function zb(e){var n=[],t=[],a;for(this._root&&n.push(new _e(this._root,this._x0,this._y0,this._x1,this._y1));a=n.pop();){var o=a.node;if(o.length){var i,s=a.x0,r=a.y0,l=a.x1,c=a.y1,u=(s+l)/2,p=(r+c)/2;(i=o[0])&&n.push(new _e(i,s,r,u,p)),(i=o[1])&&n.push(new _e(i,u,r,l,p)),(i=o[2])&&n.push(new _e(i,s,p,u,c)),(i=o[3])&&n.push(new _e(i,u,p,l,c))}t.push(a)}for(;a=t.pop();)e(a.node,a.x0,a.y0,a.x1,a.y1);return this}function Bb(e){return e[0]}function qb(e){return arguments.length?(this._x=e,this):this._x}function Vb(e){return e[1]}function jb(e){return arguments.length?(this._y=e,this):this._y}function _i(e,n,t){var a=new ki(n??Bb,t??Vb,NaN,NaN,NaN,NaN);return e==null?a:a.addAll(e)}function ki(e,n,t,a,o,i){this._x=e,this._y=n,this._x0=t,this._y0=a,this._x1=o,this._y1=i,this._root=void 0}function as(e){for(var n={data:e.data},t=n;e=e.next;)t=t.next={data:e.data};return n}var xe=_i.prototype=ki.prototype;xe.copy=function(){var e=new ki(this._x,this._y,this._x0,this._y0,this._x1,this._y1),n=this._root,t,a;if(!n)return e;if(!n.length)return e._root=as(n),e;for(t=[{source:n,target:e._root=new Array(4)}];n=t.pop();)for(var o=0;o<4;++o)(a=n.source[o])&&(a.length?t.push({source:a,target:n.target[o]=new Array(4)}):n.target[o]=as(a));return e};xe.add=Ib;xe.addAll=Sb;xe.cover=Db;xe.data=Pb;xe.extent=Mb;xe.find=Lb;xe.remove=$b;xe.removeAll=Nb;xe.root=Ob;xe.size=Eb;xe.visit=Rb;xe.visitAfter=zb;xe.x=qb;xe.y=jb;function ke(e){return function(){return e}}function Ze(e){return(e()-.5)*1e-6}function Fb(e){return e.x+e.vx}function Ub(e){return e.y+e.vy}function Wb(e){var n,t,a,o=1,i=1;typeof e!="function"&&(e=ke(e==null?1:+e));function s(){for(var c,u=n.length,p,d,h,v,b,w,x=0;x<i;++x)for(p=_i(n,Fb,Ub).visitAfter(r),c=0;c<u;++c)d=n[c],b=t[d.index],w=b*b,h=d.x+d.vx,v=d.y+d.vy,p.visit(A);function A(M,y,T,k,O){var V=M.data,H=M.r,j=b+H;if(V){if(V.index>d.index){var $=h-V.x-V.vx,P=v-V.y-V.vy,L=$*$+P*P;L<j*j&&($===0&&($=Ze(a),L+=$*$),P===0&&(P=Ze(a),L+=P*P),L=(j-(L=Math.sqrt(L)))/L*o,d.vx+=($*=L)*(j=(H*=H)/(w+H)),d.vy+=(P*=L)*j,V.vx-=$*(j=1-j),V.vy-=P*j)}return}return y>h+j||k<h-j||T>v+j||O<v-j}}function r(c){if(c.data)return c.r=t[c.data.index];for(var u=c.r=0;u<4;++u)c[u]&&c[u].r>c.r&&(c.r=c[u].r)}function l(){if(n){var c,u=n.length,p;for(t=new Array(u),c=0;c<u;++c)p=n[c],t[p.index]=+e(p,c,n)}}return s.initialize=function(c,u){n=c,a=u,l()},s.iterations=function(c){return arguments.length?(i=+c,s):i},s.strength=function(c){return arguments.length?(o=+c,s):o},s.radius=function(c){return arguments.length?(e=typeof c=="function"?c:ke(+c),l(),s):e},s}function Gb(e){return e.index}function os(e,n){var t=e.get(n);if(!t)throw new Error("node not found: "+n);return t}function Hb(e){var n=Gb,t=p,a,o=ke(30),i,s,r,l,c,u=1;e==null&&(e=[]);function p(w){return 1/Math.min(r[w.source.index],r[w.target.index])}function d(w){for(var x=0,A=e.length;x<u;++x)for(var M=0,y,T,k,O,V,H,j;M<A;++M)y=e[M],T=y.source,k=y.target,O=k.x+k.vx-T.x-T.vx||Ze(c),V=k.y+k.vy-T.y-T.vy||Ze(c),H=Math.sqrt(O*O+V*V),H=(H-i[M])/H*w*a[M],O*=H,V*=H,k.vx-=O*(j=l[M]),k.vy-=V*j,T.vx+=O*(j=1-j),T.vy+=V*j}function h(){if(s){var w,x=s.length,A=e.length,M=new Map(s.map((T,k)=>[n(T,k,s),T])),y;for(w=0,r=new Array(x);w<A;++w)y=e[w],y.index=w,typeof y.source!="object"&&(y.source=os(M,y.source)),typeof y.target!="object"&&(y.target=os(M,y.target)),r[y.source.index]=(r[y.source.index]||0)+1,r[y.target.index]=(r[y.target.index]||0)+1;for(w=0,l=new Array(A);w<A;++w)y=e[w],l[w]=r[y.source.index]/(r[y.source.index]+r[y.target.index]);a=new Array(A),v(),i=new Array(A),b()}}function v(){if(s)for(var w=0,x=e.length;w<x;++w)a[w]=+t(e[w],w,e)}function b(){if(s)for(var w=0,x=e.length;w<x;++w)i[w]=+o(e[w],w,e)}return d.initialize=function(w,x){s=w,c=x,h()},d.links=function(w){return arguments.length?(e=w,h(),d):e},d.id=function(w){return arguments.length?(n=w,d):n},d.iterations=function(w){return arguments.length?(u=+w,d):u},d.strength=function(w){return arguments.length?(t=typeof w=="function"?w:ke(+w),v(),d):t},d.distance=function(w){return arguments.length?(o=typeof w=="function"?w:ke(+w),b(),d):o},d}const Kb=1664525,Yb=1013904223,is=4294967296;function Xb(){let e=1;return()=>(e=(Kb*e+Yb)%is)/is}function Qb(e){return e.x}function Jb(e){return e.y}var Zb=10,e0=Math.PI*(3-Math.sqrt(5));function n0(e){var n,t=1,a=.001,o=1-Math.pow(a,1/300),i=0,s=.6,r=new Map,l=bi(p),c=Ut("tick","end"),u=Xb();e==null&&(e=[]);function p(){d(),c.call("tick",n),t<a&&(l.stop(),c.call("end",n))}function d(b){var w,x=e.length,A;b===void 0&&(b=1);for(var M=0;M<b;++M)for(t+=(i-t)*o,r.forEach(function(y){y(t)}),w=0;w<x;++w)A=e[w],A.fx==null?A.x+=A.vx*=s:(A.x=A.fx,A.vx=0),A.fy==null?A.y+=A.vy*=s:(A.y=A.fy,A.vy=0);return n}function h(){for(var b=0,w=e.length,x;b<w;++b){if(x=e[b],x.index=b,x.fx!=null&&(x.x=x.fx),x.fy!=null&&(x.y=x.fy),isNaN(x.x)||isNaN(x.y)){var A=Zb*Math.sqrt(.5+b),M=b*e0;x.x=A*Math.cos(M),x.y=A*Math.sin(M)}(isNaN(x.vx)||isNaN(x.vy))&&(x.vx=x.vy=0)}}function v(b){return b.initialize&&b.initialize(e,u),b}return h(),n={tick:d,restart:function(){return l.restart(p),n},stop:function(){return l.stop(),n},nodes:function(b){return arguments.length?(e=b,h(),r.forEach(v),n):e},alpha:function(b){return arguments.length?(t=+b,n):t},alphaMin:function(b){return arguments.length?(a=+b,n):a},alphaDecay:function(b){return arguments.length?(o=+b,n):+o},alphaTarget:function(b){return arguments.length?(i=+b,n):i},velocityDecay:function(b){return arguments.length?(s=1-b,n):1-s},randomSource:function(b){return arguments.length?(u=b,r.forEach(v),n):u},force:function(b,w){return arguments.length>1?(w==null?r.delete(b):r.set(b,v(w)),n):r.get(b)},find:function(b,w,x){var A=0,M=e.length,y,T,k,O,V;for(x==null?x=1/0:x*=x,A=0;A<M;++A)O=e[A],y=b-O.x,T=w-O.y,k=y*y+T*T,k<x&&(V=O,x=k);return V},on:function(b,w){return arguments.length>1?(c.on(b,w),n):c.on(b)}}}function t0(){var e,n,t,a,o=ke(-30),i,s=1,r=1/0,l=.81;function c(h){var v,b=e.length,w=_i(e,Qb,Jb).visitAfter(p);for(a=h,v=0;v<b;++v)n=e[v],w.visit(d)}function u(){if(e){var h,v=e.length,b;for(i=new Array(v),h=0;h<v;++h)b=e[h],i[b.index]=+o(b,h,e)}}function p(h){var v=0,b,w,x=0,A,M,y;if(h.length){for(A=M=y=0;y<4;++y)(b=h[y])&&(w=Math.abs(b.value))&&(v+=b.value,x+=w,A+=w*b.x,M+=w*b.y);h.x=A/x,h.y=M/x}else{b=h,b.x=b.data.x,b.y=b.data.y;do v+=i[b.data.index];while(b=b.next)}h.value=v}function d(h,v,b,w){if(!h.value)return!0;var x=h.x-n.x,A=h.y-n.y,M=w-v,y=x*x+A*A;if(M*M/l<y)return y<r&&(x===0&&(x=Ze(t),y+=x*x),A===0&&(A=Ze(t),y+=A*A),y<s&&(y=Math.sqrt(s*y)),n.vx+=x*h.value*a/y,n.vy+=A*h.value*a/y),!0;if(h.length||y>=r)return;(h.data!==n||h.next)&&(x===0&&(x=Ze(t),y+=x*x),A===0&&(A=Ze(t),y+=A*A),y<s&&(y=Math.sqrt(s*y)));do h.data!==n&&(M=i[h.data.index]*a/y,n.vx+=x*M,n.vy+=A*M);while(h=h.next)}return c.initialize=function(h,v){e=h,t=v,u()},c.strength=function(h){return arguments.length?(o=typeof h=="function"?h:ke(+h),u(),c):o},c.distanceMin=function(h){return arguments.length?(s=h*h,c):Math.sqrt(s)},c.distanceMax=function(h){return arguments.length?(r=h*h,c):Math.sqrt(r)},c.theta=function(h){return arguments.length?(l=h*h,c):Math.sqrt(l)},c}function a0(e){var n=ke(.1),t,a,o;typeof e!="function"&&(e=ke(e==null?0:+e));function i(r){for(var l=0,c=t.length,u;l<c;++l)u=t[l],u.vx+=(o[l]-u.x)*a[l]*r}function s(){if(t){var r,l=t.length;for(a=new Array(l),o=new Array(l),r=0;r<l;++r)a[r]=isNaN(o[r]=+e(t[r],r,t))?0:+n(t[r],r,t)}}return i.initialize=function(r){t=r,s()},i.strength=function(r){return arguments.length?(n=typeof r=="function"?r:ke(+r),s(),i):n},i.x=function(r){return arguments.length?(e=typeof r=="function"?r:ke(+r),s(),i):e},i}function o0(e){var n=ke(.1),t,a,o;typeof e!="function"&&(e=ke(e==null?0:+e));function i(r){for(var l=0,c=t.length,u;l<c;++l)u=t[l],u.vy+=(o[l]-u.y)*a[l]*r}function s(){if(t){var r,l=t.length;for(a=new Array(l),o=new Array(l),r=0;r<l;++r)a[r]=isNaN(o[r]=+e(t[r],r,t))?0:+n(t[r],r,t)}}return i.initialize=function(r){t=r,s()},i.strength=function(r){return arguments.length?(n=typeof r=="function"?r:ke(+r),s(),i):n},i.y=function(r){return arguments.length?(e=typeof r=="function"?r:ke(+r),s(),i):e},i}function i0(e){return Math.abs(e=Math.round(e))>=1e21?e.toLocaleString("en").replace(/,/g,""):e.toString(10)}function xt(e,n){if(!isFinite(e)||e===0)return null;var t=(e=n?e.toExponential(n-1):e.toExponential()).indexOf("e"),a=e.slice(0,t);return[a.length>1?a[0]+a.slice(2):a,+e.slice(t+1)]}function Sn(e){return e=xt(Math.abs(e)),e?e[1]:NaN}function s0(e,n){return function(t,a){for(var o=t.length,i=[],s=0,r=e[0],l=0;o>0&&r>0&&(l+r+1>a&&(r=Math.max(1,a-l)),i.push(t.substring(o-=r,o+r)),!((l+=r+1)>a));)r=e[s=(s+1)%e.length];return i.reverse().join(n)}}function r0(e){return function(n){return n.replace(/[0-9]/g,function(t){return e[+t]})}}var l0=/^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;function At(e){if(!(n=l0.exec(e)))throw new Error("invalid format: "+e);var n;return new xi({fill:n[1],align:n[2],sign:n[3],symbol:n[4],zero:n[5],width:n[6],comma:n[7],precision:n[8]&&n[8].slice(1),trim:n[9],type:n[10]})}At.prototype=xi.prototype;function xi(e){this.fill=e.fill===void 0?" ":e.fill+"",this.align=e.align===void 0?">":e.align+"",this.sign=e.sign===void 0?"-":e.sign+"",this.symbol=e.symbol===void 0?"":e.symbol+"",this.zero=!!e.zero,this.width=e.width===void 0?void 0:+e.width,this.comma=!!e.comma,this.precision=e.precision===void 0?void 0:+e.precision,this.trim=!!e.trim,this.type=e.type===void 0?"":e.type+""}xi.prototype.toString=function(){return this.fill+this.align+this.sign+this.symbol+(this.zero?"0":"")+(this.width===void 0?"":Math.max(1,this.width|0))+(this.comma?",":"")+(this.precision===void 0?"":"."+Math.max(0,this.precision|0))+(this.trim?"~":"")+this.type};function c0(e){e:for(var n=e.length,t=1,a=-1,o;t<n;++t)switch(e[t]){case".":a=o=t;break;case"0":a===0&&(a=t),o=t;break;default:if(!+e[t])break e;a>0&&(a=0);break}return a>0?e.slice(0,a)+e.slice(o+1):e}var Ct;function d0(e,n){var t=xt(e,n);if(!t)return Ct=void 0,e.toPrecision(n);var a=t[0],o=t[1],i=o-(Ct=Math.max(-8,Math.min(8,Math.floor(o/3)))*3)+1,s=a.length;return i===s?a:i>s?a+new Array(i-s+1).join("0"):i>0?a.slice(0,i)+"."+a.slice(i):"0."+new Array(1-i).join("0")+xt(e,Math.max(0,n+i-1))[0]}function ss(e,n){var t=xt(e,n);if(!t)return e+"";var a=t[0],o=t[1];return o<0?"0."+new Array(-o).join("0")+a:a.length>o+1?a.slice(0,o+1)+"."+a.slice(o+1):a+new Array(o-a.length+2).join("0")}const rs={"%":(e,n)=>(e*100).toFixed(n),b:e=>Math.round(e).toString(2),c:e=>e+"",d:i0,e:(e,n)=>e.toExponential(n),f:(e,n)=>e.toFixed(n),g:(e,n)=>e.toPrecision(n),o:e=>Math.round(e).toString(8),p:(e,n)=>ss(e*100,n),r:ss,s:d0,X:e=>Math.round(e).toString(16).toUpperCase(),x:e=>Math.round(e).toString(16)};function ls(e){return e}var cs=Array.prototype.map,ds=["y","z","a","f","p","n","µ","m","","k","M","G","T","P","E","Z","Y"];function u0(e){var n=e.grouping===void 0||e.thousands===void 0?ls:s0(cs.call(e.grouping,Number),e.thousands+""),t=e.currency===void 0?"":e.currency[0]+"",a=e.currency===void 0?"":e.currency[1]+"",o=e.decimal===void 0?".":e.decimal+"",i=e.numerals===void 0?ls:r0(cs.call(e.numerals,String)),s=e.percent===void 0?"%":e.percent+"",r=e.minus===void 0?"−":e.minus+"",l=e.nan===void 0?"NaN":e.nan+"";function c(p,d){p=At(p);var h=p.fill,v=p.align,b=p.sign,w=p.symbol,x=p.zero,A=p.width,M=p.comma,y=p.precision,T=p.trim,k=p.type;k==="n"?(M=!0,k="g"):rs[k]||(y===void 0&&(y=12),T=!0,k="g"),(x||h==="0"&&v==="=")&&(x=!0,h="0",v="=");var O=(d&&d.prefix!==void 0?d.prefix:"")+(w==="$"?t:w==="#"&&/[boxX]/.test(k)?"0"+k.toLowerCase():""),V=(w==="$"?a:/[%p]/.test(k)?s:"")+(d&&d.suffix!==void 0?d.suffix:""),H=rs[k],j=/[defgprs%]/.test(k);y=y===void 0?6:/[gprs]/.test(k)?Math.max(1,Math.min(21,y)):Math.max(0,Math.min(20,y));function $(P){var L=O,z=V,te,ee,K;if(k==="c")z=H(P)+z,P="";else{P=+P;var re=P<0||1/P<0;if(P=isNaN(P)?l:H(Math.abs(P),y),T&&(P=c0(P)),re&&+P==0&&b!=="+"&&(re=!1),L=(re?b==="("?b:r:b==="-"||b==="("?"":b)+L,z=(k==="s"&&!isNaN(P)&&Ct!==void 0?ds[8+Ct/3]:"")+z+(re&&b==="("?")":""),j){for(te=-1,ee=P.length;++te<ee;)if(K=P.charCodeAt(te),48>K||K>57){z=(K===46?o+P.slice(te+1):P.slice(te))+z,P=P.slice(0,te);break}}}M&&!x&&(P=n(P,1/0));var ue=L.length+P.length+z.length,de=ue<A?new Array(A-ue+1).join(h):"";switch(M&&x&&(P=n(de+P,de.length?A-z.length:1/0),de=""),v){case"<":P=L+P+z+de;break;case"=":P=L+de+P+z;break;case"^":P=de.slice(0,ue=de.length>>1)+L+P+z+de.slice(ue);break;default:P=de+L+P+z;break}return i(P)}return $.toString=function(){return p+""},$}function u(p,d){var h=Math.max(-8,Math.min(8,Math.floor(Sn(d)/3)))*3,v=Math.pow(10,-h),b=c((p=At(p),p.type="f",p),{suffix:ds[8+h/3]});return function(w){return b(v*w)}}return{format:c,formatPrefix:u}}var ot,Tr,Ir;h0({thousands:",",grouping:[3],currency:["$",""]});function h0(e){return ot=u0(e),Tr=ot.format,Ir=ot.formatPrefix,ot}function g0(e){return Math.max(0,-Sn(Math.abs(e)))}function p0(e,n){return Math.max(0,Math.max(-8,Math.min(8,Math.floor(Sn(n)/3)))*3-Sn(Math.abs(e)))}function m0(e,n){return e=Math.abs(e),n=Math.abs(n)-e,Math.max(0,Sn(n)-Sn(e))+1}function f0(e){var n=0,t=e.children,a=t&&t.length;if(!a)n=1;else for(;--a>=0;)n+=t[a].value;e.value=n}function v0(){return this.eachAfter(f0)}function b0(e,n){let t=-1;for(const a of this)e.call(n,a,++t,this);return this}function y0(e,n){for(var t=this,a=[t],o,i,s=-1;t=a.pop();)if(e.call(n,t,++s,this),o=t.children)for(i=o.length-1;i>=0;--i)a.push(o[i]);return this}function w0(e,n){for(var t=this,a=[t],o=[],i,s,r,l=-1;t=a.pop();)if(o.push(t),i=t.children)for(s=0,r=i.length;s<r;++s)a.push(i[s]);for(;t=o.pop();)e.call(n,t,++l,this);return this}function _0(e,n){let t=-1;for(const a of this)if(e.call(n,a,++t,this))return a}function k0(e){return this.eachAfter(function(n){for(var t=+e(n.data)||0,a=n.children,o=a&&a.length;--o>=0;)t+=a[o].value;n.value=t})}function x0(e){return this.eachBefore(function(n){n.children&&n.children.sort(e)})}function A0(e){for(var n=this,t=C0(n,e),a=[n];n!==t;)n=n.parent,a.push(n);for(var o=a.length;e!==t;)a.splice(o,0,e),e=e.parent;return a}function C0(e,n){if(e===n)return e;var t=e.ancestors(),a=n.ancestors(),o=null;for(e=t.pop(),n=a.pop();e===n;)o=e,e=t.pop(),n=a.pop();return o}function T0(){for(var e=this,n=[e];e=e.parent;)n.push(e);return n}function I0(){return Array.from(this)}function S0(){var e=[];return this.eachBefore(function(n){n.children||e.push(n)}),e}function D0(){var e=this,n=[];return e.each(function(t){t!==e&&n.push({source:t.parent,target:t})}),n}function*P0(){var e=this,n,t=[e],a,o,i;do for(n=t.reverse(),t=[];e=n.pop();)if(yield e,a=e.children)for(o=0,i=a.length;o<i;++o)t.push(a[o]);while(t.length)}function Sr(e,n){e instanceof Map?(e=[void 0,e],n===void 0&&(n=$0)):n===void 0&&(n=L0);for(var t=new Tt(e),a,o=[t],i,s,r,l;a=o.pop();)if((s=n(a.data))&&(l=(s=Array.from(s)).length))for(a.children=s,r=l-1;r>=0;--r)o.push(i=s[r]=new Tt(s[r])),i.parent=a,i.depth=a.depth+1;return t.eachBefore(O0)}function M0(){return Sr(this).eachBefore(N0)}function L0(e){return e.children}function $0(e){return Array.isArray(e)?e[1]:null}function N0(e){e.data.value!==void 0&&(e.value=e.data.value),e.data=e.data.data}function O0(e){var n=0;do e.height=n;while((e=e.parent)&&e.height<++n)}function Tt(e){this.data=e,this.depth=this.height=0,this.parent=null}Tt.prototype=Sr.prototype={constructor:Tt,count:v0,each:b0,eachAfter:w0,eachBefore:y0,find:_0,sum:k0,sort:x0,path:A0,ancestors:T0,descendants:I0,leaves:S0,links:D0,copy:M0,[Symbol.iterator]:P0};function E0(e){if(typeof e!="function")throw new Error;return e}function Ln(){return 0}function $n(e){return function(){return e}}function R0(e){e.x0=Math.round(e.x0),e.y0=Math.round(e.y0),e.x1=Math.round(e.x1),e.y1=Math.round(e.y1)}function z0(e,n,t,a,o){for(var i=e.children,s,r=-1,l=i.length,c=e.value&&(a-n)/e.value;++r<l;)s=i[r],s.y0=t,s.y1=o,s.x0=n,s.x1=n+=s.value*c}function B0(e,n,t,a,o){for(var i=e.children,s,r=-1,l=i.length,c=e.value&&(o-t)/e.value;++r<l;)s=i[r],s.x0=n,s.x1=a,s.y0=t,s.y1=t+=s.value*c}var q0=(1+Math.sqrt(5))/2;function V0(e,n,t,a,o,i){for(var s=[],r=n.children,l,c,u=0,p=0,d=r.length,h,v,b=n.value,w,x,A,M,y,T,k;u<d;){h=o-t,v=i-a;do w=r[p++].value;while(!w&&p<d);for(x=A=w,T=Math.max(v/h,h/v)/(b*e),k=w*w*T,y=Math.max(A/k,k/x);p<d;++p){if(w+=c=r[p].value,c<x&&(x=c),c>A&&(A=c),k=w*w*T,M=Math.max(A/k,k/x),M>y){w-=c;break}y=M}s.push(l={value:w,dice:h<v,children:r.slice(u,p)}),l.dice?z0(l,t,a,o,b?a+=v*w/b:i):B0(l,t,a,b?t+=h*w/b:o,i),b-=w,u=p}return s}const j0=function e(n){function t(a,o,i,s,r){V0(n,a,o,i,s,r)}return t.ratio=function(a){return e((a=+a)>1?a:1)},t}(q0);function vk(){var e=j0,n=!1,t=1,a=1,o=[0],i=Ln,s=Ln,r=Ln,l=Ln,c=Ln;function u(d){return d.x0=d.y0=0,d.x1=t,d.y1=a,d.eachBefore(p),o=[0],n&&d.eachBefore(R0),d}function p(d){var h=o[d.depth],v=d.x0+h,b=d.y0+h,w=d.x1-h,x=d.y1-h;w<v&&(v=w=(v+w)/2),x<b&&(b=x=(b+x)/2),d.x0=v,d.y0=b,d.x1=w,d.y1=x,d.children&&(h=o[d.depth+1]=i(d)/2,v+=c(d)-h,b+=s(d)-h,w-=r(d)-h,x-=l(d)-h,w<v&&(v=w=(v+w)/2),x<b&&(b=x=(b+x)/2),e(d,v,b,w,x))}return u.round=function(d){return arguments.length?(n=!!d,u):n},u.size=function(d){return arguments.length?(t=+d[0],a=+d[1],u):[t,a]},u.tile=function(d){return arguments.length?(e=E0(d),u):e},u.padding=function(d){return arguments.length?u.paddingInner(d).paddingOuter(d):u.paddingInner()},u.paddingInner=function(d){return arguments.length?(i=typeof d=="function"?d:$n(+d),u):i},u.paddingOuter=function(d){return arguments.length?u.paddingTop(d).paddingRight(d).paddingBottom(d).paddingLeft(d):u.paddingTop()},u.paddingTop=function(d){return arguments.length?(s=typeof d=="function"?d:$n(+d),u):s},u.paddingRight=function(d){return arguments.length?(r=typeof d=="function"?d:$n(+d),u):r},u.paddingBottom=function(d){return arguments.length?(l=typeof d=="function"?d:$n(+d),u):l},u.paddingLeft=function(d){return arguments.length?(c=typeof d=="function"?d:$n(+d),u):c},u}function Xt(e,n){switch(arguments.length){case 0:break;case 1:this.range(e);break;default:this.range(n).domain(e);break}return this}const us=Symbol("implicit");function Dr(){var e=new zi,n=[],t=[],a=us;function o(i){let s=e.get(i);if(s===void 0){if(a!==us)return a;e.set(i,s=n.push(i)-1)}return t[s%t.length]}return o.domain=function(i){if(!arguments.length)return n.slice();n=[],e=new zi;for(const s of i)e.has(s)||e.set(s,n.push(s)-1);return o},o.range=function(i){return arguments.length?(t=Array.from(i),o):t.slice()},o.unknown=function(i){return arguments.length?(a=i,o):a},o.copy=function(){return Dr(n,t).unknown(a)},Xt.apply(o,arguments),o}function F0(){var e=Dr().unknown(void 0),n=e.domain,t=e.range,a=0,o=1,i,s,r=!1,l=0,c=0,u=.5;delete e.unknown;function p(){var d=n().length,h=o<a,v=h?o:a,b=h?a:o;i=(b-v)/Math.max(1,d-l+c*2),r&&(i=Math.floor(i)),v+=(b-v-i*(d-l))*u,s=i*(1-l),r&&(v=Math.round(v),s=Math.round(s));var w=Op(d).map(function(x){return v+i*x});return t(h?w.reverse():w)}return e.domain=function(d){return arguments.length?(n(d),p()):n()},e.range=function(d){return arguments.length?([a,o]=d,a=+a,o=+o,p()):[a,o]},e.rangeRound=function(d){return[a,o]=d,a=+a,o=+o,r=!0,p()},e.bandwidth=function(){return s},e.step=function(){return i},e.round=function(d){return arguments.length?(r=!!d,p()):r},e.padding=function(d){return arguments.length?(l=Math.min(1,c=+d),p()):l},e.paddingInner=function(d){return arguments.length?(l=Math.min(1,d),p()):l},e.paddingOuter=function(d){return arguments.length?(c=+d,p()):c},e.align=function(d){return arguments.length?(u=Math.max(0,Math.min(1,d)),p()):u},e.copy=function(){return F0(n(),[a,o]).round(r).paddingInner(l).paddingOuter(c).align(u)},Xt.apply(p(),arguments)}function U0(e){return function(){return e}}function W0(e){return+e}var hs=[0,1];function wn(e){return e}function Oa(e,n){return(n-=e=+e)?function(t){return(t-e)/n}:U0(isNaN(n)?NaN:.5)}function G0(e,n){var t;return e>n&&(t=e,e=n,n=t),function(a){return Math.max(e,Math.min(n,a))}}function H0(e,n,t){var a=e[0],o=e[1],i=n[0],s=n[1];return o<a?(a=Oa(o,a),i=t(s,i)):(a=Oa(a,o),i=t(i,s)),function(r){return i(a(r))}}function K0(e,n,t){var a=Math.min(e.length,n.length)-1,o=new Array(a),i=new Array(a),s=-1;for(e[a]<e[0]&&(e=e.slice().reverse(),n=n.slice().reverse());++s<a;)o[s]=Oa(e[s],e[s+1]),i[s]=t(n[s],n[s+1]);return function(r){var l=Ip(e,r,1,a)-1;return i[l](o[l](r))}}function Pr(e,n){return n.domain(e.domain()).range(e.range()).interpolate(e.interpolate()).clamp(e.clamp()).unknown(e.unknown())}function Y0(){var e=hs,n=hs,t=fi,a,o,i,s=wn,r,l,c;function u(){var d=Math.min(e.length,n.length);return s!==wn&&(s=G0(e[0],e[d-1])),r=d>2?K0:H0,l=c=null,p}function p(d){return d==null||isNaN(d=+d)?i:(l||(l=r(e.map(a),n,t)))(a(s(d)))}return p.invert=function(d){return s(o((c||(c=r(n,e.map(a),$e)))(d)))},p.domain=function(d){return arguments.length?(e=Array.from(d,W0),u()):e.slice()},p.range=function(d){return arguments.length?(n=Array.from(d),u()):n.slice()},p.rangeRound=function(d){return n=Array.from(d),t=iv,u()},p.clamp=function(d){return arguments.length?(s=d?!0:wn,u()):s!==wn},p.interpolate=function(d){return arguments.length?(t=d,u()):t},p.unknown=function(d){return arguments.length?(i=d,p):i},function(d,h){return a=d,o=h,u()}}function Mr(){return Y0()(wn,wn)}function X0(e,n,t,a){var o=ka(e,n,t),i;switch(a=At(a??",f"),a.type){case"s":{var s=Math.max(Math.abs(e),Math.abs(n));return a.precision==null&&!isNaN(i=p0(o,s))&&(a.precision=i),Ir(a,s)}case"":case"e":case"g":case"p":case"r":{a.precision==null&&!isNaN(i=m0(o,Math.max(Math.abs(e),Math.abs(n))))&&(a.precision=i-(a.type==="e"));break}case"f":case"%":{a.precision==null&&!isNaN(i=g0(o))&&(a.precision=i-(a.type==="%")*2);break}}return Tr(a)}function Q0(e){var n=e.domain;return e.ticks=function(t){var a=n();return Np(a[0],a[a.length-1],t??10)},e.tickFormat=function(t,a){var o=n();return X0(o[0],o[o.length-1],t??10,a)},e.nice=function(t){t==null&&(t=10);var a=n(),o=0,i=a.length-1,s=a[o],r=a[i],l,c,u=10;for(r<s&&(c=s,s=r,r=c,c=o,o=i,i=c);u-- >0;){if(c=_a(s,r,t),c===l)return a[o]=s,a[i]=r,n(a);if(c>0)s=Math.floor(s/c)*c,r=Math.ceil(r/c)*c;else if(c<0)s=Math.ceil(s*c)/c,r=Math.floor(r*c)/c;else break;l=c}return e},e}function J0(){var e=Mr();return e.copy=function(){return Pr(e,J0())},Xt.apply(e,arguments),Q0(e)}function Z0(e,n){e=e.slice();var t=0,a=e.length-1,o=e[t],i=e[a],s;return i<o&&(s=t,t=a,a=s,s=o,o=i,i=s),e[t]=n.floor(o),e[a]=n.ceil(i),e}const ca=new Date,da=new Date;function pe(e,n,t,a){function o(i){return e(i=arguments.length===0?new Date:new Date(+i)),i}return o.floor=i=>(e(i=new Date(+i)),i),o.ceil=i=>(e(i=new Date(i-1)),n(i,1),e(i),i),o.round=i=>{const s=o(i),r=o.ceil(i);return i-s<r-i?s:r},o.offset=(i,s)=>(n(i=new Date(+i),s==null?1:Math.floor(s)),i),o.range=(i,s,r)=>{const l=[];if(i=o.ceil(i),r=r==null?1:Math.floor(r),!(i<s)||!(r>0))return l;let c;do l.push(c=new Date(+i)),n(i,r),e(i);while(c<i&&i<s);return l},o.filter=i=>pe(s=>{if(s>=s)for(;e(s),!i(s);)s.setTime(s-1)},(s,r)=>{if(s>=s)if(r<0)for(;++r<=0;)for(;n(s,-1),!i(s););else for(;--r>=0;)for(;n(s,1),!i(s););}),t&&(o.count=(i,s)=>(ca.setTime(+i),da.setTime(+s),e(ca),e(da),Math.floor(t(ca,da))),o.every=i=>(i=Math.floor(i),!isFinite(i)||!(i>0)?null:i>1?o.filter(a?s=>a(s)%i===0:s=>o.count(0,s)%i===0):o)),o}const It=pe(()=>{},(e,n)=>{e.setTime(+e+n)},(e,n)=>n-e);It.every=e=>(e=Math.floor(e),!isFinite(e)||!(e>0)?null:e>1?pe(n=>{n.setTime(Math.floor(n/e)*e)},(n,t)=>{n.setTime(+n+t*e)},(n,t)=>(t-n)/e):It);It.range;const Ge=1e3,Pe=Ge*60,He=Pe*60,Ye=He*24,Ai=Ye*7,gs=Ye*30,ua=Ye*365,_n=pe(e=>{e.setTime(e-e.getMilliseconds())},(e,n)=>{e.setTime(+e+n*Ge)},(e,n)=>(n-e)/Ge,e=>e.getUTCSeconds());_n.range;const Ci=pe(e=>{e.setTime(e-e.getMilliseconds()-e.getSeconds()*Ge)},(e,n)=>{e.setTime(+e+n*Pe)},(e,n)=>(n-e)/Pe,e=>e.getMinutes());Ci.range;const ey=pe(e=>{e.setUTCSeconds(0,0)},(e,n)=>{e.setTime(+e+n*Pe)},(e,n)=>(n-e)/Pe,e=>e.getUTCMinutes());ey.range;const Ti=pe(e=>{e.setTime(e-e.getMilliseconds()-e.getSeconds()*Ge-e.getMinutes()*Pe)},(e,n)=>{e.setTime(+e+n*He)},(e,n)=>(n-e)/He,e=>e.getHours());Ti.range;const ny=pe(e=>{e.setUTCMinutes(0,0,0)},(e,n)=>{e.setTime(+e+n*He)},(e,n)=>(n-e)/He,e=>e.getUTCHours());ny.range;const Jn=pe(e=>e.setHours(0,0,0,0),(e,n)=>e.setDate(e.getDate()+n),(e,n)=>(n-e-(n.getTimezoneOffset()-e.getTimezoneOffset())*Pe)/Ye,e=>e.getDate()-1);Jn.range;const Ii=pe(e=>{e.setUTCHours(0,0,0,0)},(e,n)=>{e.setUTCDate(e.getUTCDate()+n)},(e,n)=>(n-e)/Ye,e=>e.getUTCDate()-1);Ii.range;const ty=pe(e=>{e.setUTCHours(0,0,0,0)},(e,n)=>{e.setUTCDate(e.getUTCDate()+n)},(e,n)=>(n-e)/Ye,e=>Math.floor(e/Ye));ty.range;function vn(e){return pe(n=>{n.setDate(n.getDate()-(n.getDay()+7-e)%7),n.setHours(0,0,0,0)},(n,t)=>{n.setDate(n.getDate()+t*7)},(n,t)=>(t-n-(t.getTimezoneOffset()-n.getTimezoneOffset())*Pe)/Ai)}const Qt=vn(0),St=vn(1),ay=vn(2),oy=vn(3),Dn=vn(4),iy=vn(5),sy=vn(6);Qt.range;St.range;ay.range;oy.range;Dn.range;iy.range;sy.range;function bn(e){return pe(n=>{n.setUTCDate(n.getUTCDate()-(n.getUTCDay()+7-e)%7),n.setUTCHours(0,0,0,0)},(n,t)=>{n.setUTCDate(n.getUTCDate()+t*7)},(n,t)=>(t-n)/Ai)}const Lr=bn(0),Dt=bn(1),ry=bn(2),ly=bn(3),Pn=bn(4),cy=bn(5),dy=bn(6);Lr.range;Dt.range;ry.range;ly.range;Pn.range;cy.range;dy.range;const Si=pe(e=>{e.setDate(1),e.setHours(0,0,0,0)},(e,n)=>{e.setMonth(e.getMonth()+n)},(e,n)=>n.getMonth()-e.getMonth()+(n.getFullYear()-e.getFullYear())*12,e=>e.getMonth());Si.range;const uy=pe(e=>{e.setUTCDate(1),e.setUTCHours(0,0,0,0)},(e,n)=>{e.setUTCMonth(e.getUTCMonth()+n)},(e,n)=>n.getUTCMonth()-e.getUTCMonth()+(n.getUTCFullYear()-e.getUTCFullYear())*12,e=>e.getUTCMonth());uy.range;const Xe=pe(e=>{e.setMonth(0,1),e.setHours(0,0,0,0)},(e,n)=>{e.setFullYear(e.getFullYear()+n)},(e,n)=>n.getFullYear()-e.getFullYear(),e=>e.getFullYear());Xe.every=e=>!isFinite(e=Math.floor(e))||!(e>0)?null:pe(n=>{n.setFullYear(Math.floor(n.getFullYear()/e)*e),n.setMonth(0,1),n.setHours(0,0,0,0)},(n,t)=>{n.setFullYear(n.getFullYear()+t*e)});Xe.range;const gn=pe(e=>{e.setUTCMonth(0,1),e.setUTCHours(0,0,0,0)},(e,n)=>{e.setUTCFullYear(e.getUTCFullYear()+n)},(e,n)=>n.getUTCFullYear()-e.getUTCFullYear(),e=>e.getUTCFullYear());gn.every=e=>!isFinite(e=Math.floor(e))||!(e>0)?null:pe(n=>{n.setUTCFullYear(Math.floor(n.getUTCFullYear()/e)*e),n.setUTCMonth(0,1),n.setUTCHours(0,0,0,0)},(n,t)=>{n.setUTCFullYear(n.getUTCFullYear()+t*e)});gn.range;function hy(e,n,t,a,o,i){const s=[[_n,1,Ge],[_n,5,5*Ge],[_n,15,15*Ge],[_n,30,30*Ge],[i,1,Pe],[i,5,5*Pe],[i,15,15*Pe],[i,30,30*Pe],[o,1,He],[o,3,3*He],[o,6,6*He],[o,12,12*He],[a,1,Ye],[a,2,2*Ye],[t,1,Ai],[n,1,gs],[n,3,3*gs],[e,1,ua]];function r(c,u,p){const d=u<c;d&&([c,u]=[u,c]);const h=p&&typeof p.range=="function"?p:l(c,u,p),v=h?h.range(c,+u+1):[];return d?v.reverse():v}function l(c,u,p){const d=Math.abs(u-c)/p,h=gi(([,,w])=>w).right(s,d);if(h===s.length)return e.every(ka(c/ua,u/ua,p));if(h===0)return It.every(Math.max(ka(c,u,p),1));const[v,b]=s[d/s[h-1][2]<s[h][2]/d?h-1:h];return v.every(b)}return[r,l]}const[gy,py]=hy(Xe,Si,Qt,Jn,Ti,Ci);function ha(e){if(0<=e.y&&e.y<100){var n=new Date(-1,e.m,e.d,e.H,e.M,e.S,e.L);return n.setFullYear(e.y),n}return new Date(e.y,e.m,e.d,e.H,e.M,e.S,e.L)}function ga(e){if(0<=e.y&&e.y<100){var n=new Date(Date.UTC(-1,e.m,e.d,e.H,e.M,e.S,e.L));return n.setUTCFullYear(e.y),n}return new Date(Date.UTC(e.y,e.m,e.d,e.H,e.M,e.S,e.L))}function Nn(e,n,t){return{y:e,m:n,d:t,H:0,M:0,S:0,L:0}}function my(e){var n=e.dateTime,t=e.date,a=e.time,o=e.periods,i=e.days,s=e.shortDays,r=e.months,l=e.shortMonths,c=On(o),u=En(o),p=On(i),d=En(i),h=On(s),v=En(s),b=On(r),w=En(r),x=On(l),A=En(l),M={a:K,A:re,b:ue,B:de,c:null,d:ys,e:ys,f:zy,g:Ky,G:Xy,H:Oy,I:Ey,j:Ry,L:$r,m:By,M:qy,p:Ce,q:we,Q:ks,s:xs,S:Vy,u:jy,U:Fy,V:Uy,w:Wy,W:Gy,x:null,X:null,y:Hy,Y:Yy,Z:Qy,"%":_s},y={a:le,A:Le,b:Te,B:S,c:null,d:ws,e:ws,f:n2,g:u2,G:g2,H:Jy,I:Zy,j:e2,L:Or,m:t2,M:a2,p:q,q:G,Q:ks,s:xs,S:o2,u:i2,U:s2,V:r2,w:l2,W:c2,x:null,X:null,y:d2,Y:h2,Z:p2,"%":_s},T={a:j,A:$,b:P,B:L,c:z,d:vs,e:vs,f:My,g:fs,G:ms,H:bs,I:bs,j:Iy,L:Py,m:Ty,M:Sy,p:H,q:Cy,Q:$y,s:Ny,S:Dy,u:wy,U:_y,V:ky,w:yy,W:xy,x:te,X:ee,y:fs,Y:ms,Z:Ay,"%":Ly};M.x=k(t,M),M.X=k(a,M),M.c=k(n,M),y.x=k(t,y),y.X=k(a,y),y.c=k(n,y);function k(E,Y){return function(J){var D=[],oe=-1,ce=0,Ie=E.length,Se,an,Oi;for(J instanceof Date||(J=new Date(+J));++oe<Ie;)E.charCodeAt(oe)===37&&(D.push(E.slice(ce,oe)),(an=ps[Se=E.charAt(++oe)])!=null?Se=E.charAt(++oe):an=Se==="e"?" ":"0",(Oi=Y[Se])&&(Se=Oi(J,an)),D.push(Se),ce=oe+1);return D.push(E.slice(ce,oe)),D.join("")}}function O(E,Y){return function(J){var D=Nn(1900,void 0,1),oe=V(D,E,J+="",0),ce,Ie;if(oe!=J.length)return null;if("Q"in D)return new Date(D.Q);if("s"in D)return new Date(D.s*1e3+("L"in D?D.L:0));if(Y&&!("Z"in D)&&(D.Z=0),"p"in D&&(D.H=D.H%12+D.p*12),D.m===void 0&&(D.m="q"in D?D.q:0),"V"in D){if(D.V<1||D.V>53)return null;"w"in D||(D.w=1),"Z"in D?(ce=ga(Nn(D.y,0,1)),Ie=ce.getUTCDay(),ce=Ie>4||Ie===0?Dt.ceil(ce):Dt(ce),ce=Ii.offset(ce,(D.V-1)*7),D.y=ce.getUTCFullYear(),D.m=ce.getUTCMonth(),D.d=ce.getUTCDate()+(D.w+6)%7):(ce=ha(Nn(D.y,0,1)),Ie=ce.getDay(),ce=Ie>4||Ie===0?St.ceil(ce):St(ce),ce=Jn.offset(ce,(D.V-1)*7),D.y=ce.getFullYear(),D.m=ce.getMonth(),D.d=ce.getDate()+(D.w+6)%7)}else("W"in D||"U"in D)&&("w"in D||(D.w="u"in D?D.u%7:"W"in D?1:0),Ie="Z"in D?ga(Nn(D.y,0,1)).getUTCDay():ha(Nn(D.y,0,1)).getDay(),D.m=0,D.d="W"in D?(D.w+6)%7+D.W*7-(Ie+5)%7:D.w+D.U*7-(Ie+6)%7);return"Z"in D?(D.H+=D.Z/100|0,D.M+=D.Z%100,ga(D)):ha(D)}}function V(E,Y,J,D){for(var oe=0,ce=Y.length,Ie=J.length,Se,an;oe<ce;){if(D>=Ie)return-1;if(Se=Y.charCodeAt(oe++),Se===37){if(Se=Y.charAt(oe++),an=T[Se in ps?Y.charAt(oe++):Se],!an||(D=an(E,J,D))<0)return-1}else if(Se!=J.charCodeAt(D++))return-1}return D}function H(E,Y,J){var D=c.exec(Y.slice(J));return D?(E.p=u.get(D[0].toLowerCase()),J+D[0].length):-1}function j(E,Y,J){var D=h.exec(Y.slice(J));return D?(E.w=v.get(D[0].toLowerCase()),J+D[0].length):-1}function $(E,Y,J){var D=p.exec(Y.slice(J));return D?(E.w=d.get(D[0].toLowerCase()),J+D[0].length):-1}function P(E,Y,J){var D=x.exec(Y.slice(J));return D?(E.m=A.get(D[0].toLowerCase()),J+D[0].length):-1}function L(E,Y,J){var D=b.exec(Y.slice(J));return D?(E.m=w.get(D[0].toLowerCase()),J+D[0].length):-1}function z(E,Y,J){return V(E,n,Y,J)}function te(E,Y,J){return V(E,t,Y,J)}function ee(E,Y,J){return V(E,a,Y,J)}function K(E){return s[E.getDay()]}function re(E){return i[E.getDay()]}function ue(E){return l[E.getMonth()]}function de(E){return r[E.getMonth()]}function Ce(E){return o[+(E.getHours()>=12)]}function we(E){return 1+~~(E.getMonth()/3)}function le(E){return s[E.getUTCDay()]}function Le(E){return i[E.getUTCDay()]}function Te(E){return l[E.getUTCMonth()]}function S(E){return r[E.getUTCMonth()]}function q(E){return o[+(E.getUTCHours()>=12)]}function G(E){return 1+~~(E.getUTCMonth()/3)}return{format:function(E){var Y=k(E+="",M);return Y.toString=function(){return E},Y},parse:function(E){var Y=O(E+="",!1);return Y.toString=function(){return E},Y},utcFormat:function(E){var Y=k(E+="",y);return Y.toString=function(){return E},Y},utcParse:function(E){var Y=O(E+="",!0);return Y.toString=function(){return E},Y}}}var ps={"-":"",_:" ",0:"0"},fe=/^\s*\d+/,fy=/^%/,vy=/[\\^$*+?|[\]().{}]/g;function se(e,n,t){var a=e<0?"-":"",o=(a?-e:e)+"",i=o.length;return a+(i<t?new Array(t-i+1).join(n)+o:o)}function by(e){return e.replace(vy,"\\$&")}function On(e){return new RegExp("^(?:"+e.map(by).join("|")+")","i")}function En(e){return new Map(e.map((n,t)=>[n.toLowerCase(),t]))}function yy(e,n,t){var a=fe.exec(n.slice(t,t+1));return a?(e.w=+a[0],t+a[0].length):-1}function wy(e,n,t){var a=fe.exec(n.slice(t,t+1));return a?(e.u=+a[0],t+a[0].length):-1}function _y(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.U=+a[0],t+a[0].length):-1}function ky(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.V=+a[0],t+a[0].length):-1}function xy(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.W=+a[0],t+a[0].length):-1}function ms(e,n,t){var a=fe.exec(n.slice(t,t+4));return a?(e.y=+a[0],t+a[0].length):-1}function fs(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.y=+a[0]+(+a[0]>68?1900:2e3),t+a[0].length):-1}function Ay(e,n,t){var a=/^(Z)|([+-]\d\d)(?::?(\d\d))?/.exec(n.slice(t,t+6));return a?(e.Z=a[1]?0:-(a[2]+(a[3]||"00")),t+a[0].length):-1}function Cy(e,n,t){var a=fe.exec(n.slice(t,t+1));return a?(e.q=a[0]*3-3,t+a[0].length):-1}function Ty(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.m=a[0]-1,t+a[0].length):-1}function vs(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.d=+a[0],t+a[0].length):-1}function Iy(e,n,t){var a=fe.exec(n.slice(t,t+3));return a?(e.m=0,e.d=+a[0],t+a[0].length):-1}function bs(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.H=+a[0],t+a[0].length):-1}function Sy(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.M=+a[0],t+a[0].length):-1}function Dy(e,n,t){var a=fe.exec(n.slice(t,t+2));return a?(e.S=+a[0],t+a[0].length):-1}function Py(e,n,t){var a=fe.exec(n.slice(t,t+3));return a?(e.L=+a[0],t+a[0].length):-1}function My(e,n,t){var a=fe.exec(n.slice(t,t+6));return a?(e.L=Math.floor(a[0]/1e3),t+a[0].length):-1}function Ly(e,n,t){var a=fy.exec(n.slice(t,t+1));return a?t+a[0].length:-1}function $y(e,n,t){var a=fe.exec(n.slice(t));return a?(e.Q=+a[0],t+a[0].length):-1}function Ny(e,n,t){var a=fe.exec(n.slice(t));return a?(e.s=+a[0],t+a[0].length):-1}function ys(e,n){return se(e.getDate(),n,2)}function Oy(e,n){return se(e.getHours(),n,2)}function Ey(e,n){return se(e.getHours()%12||12,n,2)}function Ry(e,n){return se(1+Jn.count(Xe(e),e),n,3)}function $r(e,n){return se(e.getMilliseconds(),n,3)}function zy(e,n){return $r(e,n)+"000"}function By(e,n){return se(e.getMonth()+1,n,2)}function qy(e,n){return se(e.getMinutes(),n,2)}function Vy(e,n){return se(e.getSeconds(),n,2)}function jy(e){var n=e.getDay();return n===0?7:n}function Fy(e,n){return se(Qt.count(Xe(e)-1,e),n,2)}function Nr(e){var n=e.getDay();return n>=4||n===0?Dn(e):Dn.ceil(e)}function Uy(e,n){return e=Nr(e),se(Dn.count(Xe(e),e)+(Xe(e).getDay()===4),n,2)}function Wy(e){return e.getDay()}function Gy(e,n){return se(St.count(Xe(e)-1,e),n,2)}function Hy(e,n){return se(e.getFullYear()%100,n,2)}function Ky(e,n){return e=Nr(e),se(e.getFullYear()%100,n,2)}function Yy(e,n){return se(e.getFullYear()%1e4,n,4)}function Xy(e,n){var t=e.getDay();return e=t>=4||t===0?Dn(e):Dn.ceil(e),se(e.getFullYear()%1e4,n,4)}function Qy(e){var n=e.getTimezoneOffset();return(n>0?"-":(n*=-1,"+"))+se(n/60|0,"0",2)+se(n%60,"0",2)}function ws(e,n){return se(e.getUTCDate(),n,2)}function Jy(e,n){return se(e.getUTCHours(),n,2)}function Zy(e,n){return se(e.getUTCHours()%12||12,n,2)}function e2(e,n){return se(1+Ii.count(gn(e),e),n,3)}function Or(e,n){return se(e.getUTCMilliseconds(),n,3)}function n2(e,n){return Or(e,n)+"000"}function t2(e,n){return se(e.getUTCMonth()+1,n,2)}function a2(e,n){return se(e.getUTCMinutes(),n,2)}function o2(e,n){return se(e.getUTCSeconds(),n,2)}function i2(e){var n=e.getUTCDay();return n===0?7:n}function s2(e,n){return se(Lr.count(gn(e)-1,e),n,2)}function Er(e){var n=e.getUTCDay();return n>=4||n===0?Pn(e):Pn.ceil(e)}function r2(e,n){return e=Er(e),se(Pn.count(gn(e),e)+(gn(e).getUTCDay()===4),n,2)}function l2(e){return e.getUTCDay()}function c2(e,n){return se(Dt.count(gn(e)-1,e),n,2)}function d2(e,n){return se(e.getUTCFullYear()%100,n,2)}function u2(e,n){return e=Er(e),se(e.getUTCFullYear()%100,n,2)}function h2(e,n){return se(e.getUTCFullYear()%1e4,n,4)}function g2(e,n){var t=e.getUTCDay();return e=t>=4||t===0?Pn(e):Pn.ceil(e),se(e.getUTCFullYear()%1e4,n,4)}function p2(){return"+0000"}function _s(){return"%"}function ks(e){return+e}function xs(e){return Math.floor(+e/1e3)}var yn,Rr;m2({dateTime:"%x, %X",date:"%-m/%-d/%Y",time:"%-I:%M:%S %p",periods:["AM","PM"],days:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],shortDays:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],months:["January","February","March","April","May","June","July","August","September","October","November","December"],shortMonths:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"]});function m2(e){return yn=my(e),Rr=yn.format,yn.parse,yn.utcFormat,yn.utcParse,yn}function f2(e){return new Date(e)}function v2(e){return e instanceof Date?+e:+new Date(+e)}function zr(e,n,t,a,o,i,s,r,l,c){var u=Mr(),p=u.invert,d=u.domain,h=c(".%L"),v=c(":%S"),b=c("%I:%M"),w=c("%I %p"),x=c("%a %d"),A=c("%b %d"),M=c("%B"),y=c("%Y");function T(k){return(l(k)<k?h:r(k)<k?v:s(k)<k?b:i(k)<k?w:a(k)<k?o(k)<k?x:A:t(k)<k?M:y)(k)}return u.invert=function(k){return new Date(p(k))},u.domain=function(k){return arguments.length?d(Array.from(k,v2)):d().map(f2)},u.ticks=function(k){var O=d();return e(O[0],O[O.length-1],k??10)},u.tickFormat=function(k,O){return O==null?T:c(O)},u.nice=function(k){var O=d();return(!k||typeof k.range!="function")&&(k=n(O[0],O[O.length-1],k??10)),k?d(Z0(O,k)):u},u.copy=function(){return Pr(u,zr(e,n,t,a,o,i,s,r,l,c))},u}function bk(){return Xt.apply(zr(gy,py,Xe,Si,Qt,Jn,Ti,Ci,_n,Rr).domain([new Date(2e3,0,1),new Date(2e3,0,2)]),arguments)}function b2(e){for(var n=e.length/6|0,t=new Array(n),a=0;a<n;)t[a]="#"+e.slice(a*6,++a*6);return t}const yk=b2("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab");function he(e){return function(){return e}}const As=Math.abs,ve=Math.atan2,on=Math.cos,y2=Math.max,pa=Math.min,Re=Math.sin,kn=Math.sqrt,be=1e-12,Hn=Math.PI,Pt=Hn/2,ht=2*Hn;function w2(e){return e>1?0:e<-1?Hn:Math.acos(e)}function Cs(e){return e>=1?Pt:e<=-1?-Pt:Math.asin(e)}function Br(e){let n=3;return e.digits=function(t){if(!arguments.length)return n;if(t==null)n=null;else{const a=Math.floor(t);if(!(a>=0))throw new RangeError(`invalid digits: ${t}`);n=a}return e},()=>new Cb(n)}function _2(e){return e.innerRadius}function k2(e){return e.outerRadius}function x2(e){return e.startAngle}function A2(e){return e.endAngle}function C2(e){return e&&e.padAngle}function T2(e,n,t,a,o,i,s,r){var l=t-e,c=a-n,u=s-o,p=r-i,d=p*l-u*c;if(!(d*d<be))return d=(u*(n-i)-p*(e-o))/d,[e+d*l,n+d*c]}function it(e,n,t,a,o,i,s){var r=e-t,l=n-a,c=(s?i:-i)/kn(r*r+l*l),u=c*l,p=-c*r,d=e+u,h=n+p,v=t+u,b=a+p,w=(d+v)/2,x=(h+b)/2,A=v-d,M=b-h,y=A*A+M*M,T=o-i,k=d*b-v*h,O=(M<0?-1:1)*kn(y2(0,T*T*y-k*k)),V=(k*M-A*O)/y,H=(-k*A-M*O)/y,j=(k*M+A*O)/y,$=(-k*A+M*O)/y,P=V-w,L=H-x,z=j-w,te=$-x;return P*P+L*L>z*z+te*te&&(V=j,H=$),{cx:V,cy:H,x01:-u,y01:-p,x11:V*(o/T-1),y11:H*(o/T-1)}}function wk(){var e=_2,n=k2,t=he(0),a=null,o=x2,i=A2,s=C2,r=null,l=Br(c);function c(){var u,p,d=+e.apply(this,arguments),h=+n.apply(this,arguments),v=o.apply(this,arguments)-Pt,b=i.apply(this,arguments)-Pt,w=As(b-v),x=b>v;if(r||(r=u=l()),h<d&&(p=h,h=d,d=p),!(h>be))r.moveTo(0,0);else if(w>ht-be)r.moveTo(h*on(v),h*Re(v)),r.arc(0,0,h,v,b,!x),d>be&&(r.moveTo(d*on(b),d*Re(b)),r.arc(0,0,d,b,v,x));else{var A=v,M=b,y=v,T=b,k=w,O=w,V=s.apply(this,arguments)/2,H=V>be&&(a?+a.apply(this,arguments):kn(d*d+h*h)),j=pa(As(h-d)/2,+t.apply(this,arguments)),$=j,P=j,L,z;if(H>be){var te=Cs(H/d*Re(V)),ee=Cs(H/h*Re(V));(k-=te*2)>be?(te*=x?1:-1,y+=te,T-=te):(k=0,y=T=(v+b)/2),(O-=ee*2)>be?(ee*=x?1:-1,A+=ee,M-=ee):(O=0,A=M=(v+b)/2)}var K=h*on(A),re=h*Re(A),ue=d*on(T),de=d*Re(T);if(j>be){var Ce=h*on(M),we=h*Re(M),le=d*on(y),Le=d*Re(y),Te;if(w<Hn)if(Te=T2(K,re,le,Le,Ce,we,ue,de)){var S=K-Te[0],q=re-Te[1],G=Ce-Te[0],E=we-Te[1],Y=1/Re(w2((S*G+q*E)/(kn(S*S+q*q)*kn(G*G+E*E)))/2),J=kn(Te[0]*Te[0]+Te[1]*Te[1]);$=pa(j,(d-J)/(Y-1)),P=pa(j,(h-J)/(Y+1))}else $=P=0}O>be?P>be?(L=it(le,Le,K,re,h,P,x),z=it(Ce,we,ue,de,h,P,x),r.moveTo(L.cx+L.x01,L.cy+L.y01),P<j?r.arc(L.cx,L.cy,P,ve(L.y01,L.x01),ve(z.y01,z.x01),!x):(r.arc(L.cx,L.cy,P,ve(L.y01,L.x01),ve(L.y11,L.x11),!x),r.arc(0,0,h,ve(L.cy+L.y11,L.cx+L.x11),ve(z.cy+z.y11,z.cx+z.x11),!x),r.arc(z.cx,z.cy,P,ve(z.y11,z.x11),ve(z.y01,z.x01),!x))):(r.moveTo(K,re),r.arc(0,0,h,A,M,!x)):r.moveTo(K,re),!(d>be)||!(k>be)?r.lineTo(ue,de):$>be?(L=it(ue,de,Ce,we,d,-$,x),z=it(K,re,le,Le,d,-$,x),r.lineTo(L.cx+L.x01,L.cy+L.y01),$<j?r.arc(L.cx,L.cy,$,ve(L.y01,L.x01),ve(z.y01,z.x01),!x):(r.arc(L.cx,L.cy,$,ve(L.y01,L.x01),ve(L.y11,L.x11),!x),r.arc(0,0,d,ve(L.cy+L.y11,L.cx+L.x11),ve(z.cy+z.y11,z.cx+z.x11),x),r.arc(z.cx,z.cy,$,ve(z.y11,z.x11),ve(z.y01,z.x01),!x))):r.arc(0,0,d,T,y,x)}if(r.closePath(),u)return r=null,u+""||null}return c.centroid=function(){var u=(+e.apply(this,arguments)+ +n.apply(this,arguments))/2,p=(+o.apply(this,arguments)+ +i.apply(this,arguments))/2-Hn/2;return[on(p)*u,Re(p)*u]},c.innerRadius=function(u){return arguments.length?(e=typeof u=="function"?u:he(+u),c):e},c.outerRadius=function(u){return arguments.length?(n=typeof u=="function"?u:he(+u),c):n},c.cornerRadius=function(u){return arguments.length?(t=typeof u=="function"?u:he(+u),c):t},c.padRadius=function(u){return arguments.length?(a=u==null?null:typeof u=="function"?u:he(+u),c):a},c.startAngle=function(u){return arguments.length?(o=typeof u=="function"?u:he(+u),c):o},c.endAngle=function(u){return arguments.length?(i=typeof u=="function"?u:he(+u),c):i},c.padAngle=function(u){return arguments.length?(s=typeof u=="function"?u:he(+u),c):s},c.context=function(u){return arguments.length?(r=u??null,c):r},c}function qr(e){return typeof e=="object"&&"length"in e?e:Array.from(e)}function Vr(e){this._context=e}Vr.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1,this._line?this._context.lineTo(e,n):this._context.moveTo(e,n);break;case 1:this._point=2;default:this._context.lineTo(e,n);break}}};function I2(e){return new Vr(e)}function S2(e){return e[0]}function D2(e){return e[1]}function _k(e,n){var t=he(!0),a=null,o=I2,i=null,s=Br(r);e=typeof e=="function"?e:e===void 0?S2:he(e),n=typeof n=="function"?n:n===void 0?D2:he(n);function r(l){var c,u=(l=qr(l)).length,p,d=!1,h;for(a==null&&(i=o(h=s())),c=0;c<=u;++c)!(c<u&&t(p=l[c],c,l))===d&&((d=!d)?i.lineStart():i.lineEnd()),d&&i.point(+e(p,c,l),+n(p,c,l));if(h)return i=null,h+""||null}return r.x=function(l){return arguments.length?(e=typeof l=="function"?l:he(+l),r):e},r.y=function(l){return arguments.length?(n=typeof l=="function"?l:he(+l),r):n},r.defined=function(l){return arguments.length?(t=typeof l=="function"?l:he(!!l),r):t},r.curve=function(l){return arguments.length?(o=l,a!=null&&(i=o(a)),r):o},r.context=function(l){return arguments.length?(l==null?a=i=null:i=o(a=l),r):a},r}function P2(e,n){return n<e?-1:n>e?1:n>=e?0:NaN}function M2(e){return e}function kk(){var e=M2,n=P2,t=null,a=he(0),o=he(ht),i=he(0);function s(r){var l,c=(r=qr(r)).length,u,p,d=0,h=new Array(c),v=new Array(c),b=+a.apply(this,arguments),w=Math.min(ht,Math.max(-ht,o.apply(this,arguments)-b)),x,A=Math.min(Math.abs(w)/c,i.apply(this,arguments)),M=A*(w<0?-1:1),y;for(l=0;l<c;++l)(y=v[h[l]=l]=+e(r[l],l,r))>0&&(d+=y);for(n!=null?h.sort(function(T,k){return n(v[T],v[k])}):t!=null&&h.sort(function(T,k){return t(r[T],r[k])}),l=0,p=d?(w-c*M)/d:0;l<c;++l,b=x)u=h[l],y=v[u],x=b+(y>0?y*p:0)+M,v[u]={data:r[u],index:l,value:y,startAngle:b,endAngle:x,padAngle:A};return v}return s.value=function(r){return arguments.length?(e=typeof r=="function"?r:he(+r),s):e},s.sortValues=function(r){return arguments.length?(n=r,t=null,s):n},s.sort=function(r){return arguments.length?(t=r,n=null,s):t},s.startAngle=function(r){return arguments.length?(a=typeof r=="function"?r:he(+r),s):a},s.endAngle=function(r){return arguments.length?(o=typeof r=="function"?r:he(+r),s):o},s.padAngle=function(r){return arguments.length?(i=typeof r=="function"?r:he(+r),s):i},s}class jr{constructor(n,t){this._context=n,this._x=t}areaStart(){this._line=0}areaEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line}point(n,t){switch(n=+n,t=+t,this._point){case 0:{this._point=1,this._line?this._context.lineTo(n,t):this._context.moveTo(n,t);break}case 1:this._point=2;default:{this._x?this._context.bezierCurveTo(this._x0=(this._x0+n)/2,this._y0,this._x0,t,n,t):this._context.bezierCurveTo(this._x0,this._y0=(this._y0+t)/2,n,this._y0,n,t);break}}this._x0=n,this._y0=t}}function xk(e){return new jr(e,!0)}function Ak(e){return new jr(e,!1)}function nn(){}function Mt(e,n,t){e._context.bezierCurveTo((2*e._x0+e._x1)/3,(2*e._y0+e._y1)/3,(e._x0+2*e._x1)/3,(e._y0+2*e._y1)/3,(e._x0+4*e._x1+n)/6,(e._y0+4*e._y1+t)/6)}function Jt(e){this._context=e}Jt.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._y0=this._y1=NaN,this._point=0},lineEnd:function(){switch(this._point){case 3:Mt(this,this._x1,this._y1);case 2:this._context.lineTo(this._x1,this._y1);break}(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1,this._line?this._context.lineTo(e,n):this._context.moveTo(e,n);break;case 1:this._point=2;break;case 2:this._point=3,this._context.lineTo((5*this._x0+this._x1)/6,(5*this._y0+this._y1)/6);default:Mt(this,e,n);break}this._x0=this._x1,this._x1=e,this._y0=this._y1,this._y1=n}};function Ck(e){return new Jt(e)}function Fr(e){this._context=e}Fr.prototype={areaStart:nn,areaEnd:nn,lineStart:function(){this._x0=this._x1=this._x2=this._x3=this._x4=this._y0=this._y1=this._y2=this._y3=this._y4=NaN,this._point=0},lineEnd:function(){switch(this._point){case 1:{this._context.moveTo(this._x2,this._y2),this._context.closePath();break}case 2:{this._context.moveTo((this._x2+2*this._x3)/3,(this._y2+2*this._y3)/3),this._context.lineTo((this._x3+2*this._x2)/3,(this._y3+2*this._y2)/3),this._context.closePath();break}case 3:{this.point(this._x2,this._y2),this.point(this._x3,this._y3),this.point(this._x4,this._y4);break}}},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1,this._x2=e,this._y2=n;break;case 1:this._point=2,this._x3=e,this._y3=n;break;case 2:this._point=3,this._x4=e,this._y4=n,this._context.moveTo((this._x0+4*this._x1+e)/6,(this._y0+4*this._y1+n)/6);break;default:Mt(this,e,n);break}this._x0=this._x1,this._x1=e,this._y0=this._y1,this._y1=n}};function Tk(e){return new Fr(e)}function Ur(e){this._context=e}Ur.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._y0=this._y1=NaN,this._point=0},lineEnd:function(){(this._line||this._line!==0&&this._point===3)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1;break;case 1:this._point=2;break;case 2:this._point=3;var t=(this._x0+4*this._x1+e)/6,a=(this._y0+4*this._y1+n)/6;this._line?this._context.lineTo(t,a):this._context.moveTo(t,a);break;case 3:this._point=4;default:Mt(this,e,n);break}this._x0=this._x1,this._x1=e,this._y0=this._y1,this._y1=n}};function Ik(e){return new Ur(e)}function Wr(e,n){this._basis=new Jt(e),this._beta=n}Wr.prototype={lineStart:function(){this._x=[],this._y=[],this._basis.lineStart()},lineEnd:function(){var e=this._x,n=this._y,t=e.length-1;if(t>0)for(var a=e[0],o=n[0],i=e[t]-a,s=n[t]-o,r=-1,l;++r<=t;)l=r/t,this._basis.point(this._beta*e[r]+(1-this._beta)*(a+l*i),this._beta*n[r]+(1-this._beta)*(o+l*s));this._x=this._y=null,this._basis.lineEnd()},point:function(e,n){this._x.push(+e),this._y.push(+n)}};const Sk=function e(n){function t(a){return n===1?new Jt(a):new Wr(a,n)}return t.beta=function(a){return e(+a)},t}(.85);function Lt(e,n,t){e._context.bezierCurveTo(e._x1+e._k*(e._x2-e._x0),e._y1+e._k*(e._y2-e._y0),e._x2+e._k*(e._x1-n),e._y2+e._k*(e._y1-t),e._x2,e._y2)}function Di(e,n){this._context=e,this._k=(1-n)/6}Di.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN,this._point=0},lineEnd:function(){switch(this._point){case 2:this._context.lineTo(this._x2,this._y2);break;case 3:Lt(this,this._x1,this._y1);break}(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1,this._line?this._context.lineTo(e,n):this._context.moveTo(e,n);break;case 1:this._point=2,this._x1=e,this._y1=n;break;case 2:this._point=3;default:Lt(this,e,n);break}this._x0=this._x1,this._x1=this._x2,this._x2=e,this._y0=this._y1,this._y1=this._y2,this._y2=n}};const Dk=function e(n){function t(a){return new Di(a,n)}return t.tension=function(a){return e(+a)},t}(0);function Pi(e,n){this._context=e,this._k=(1-n)/6}Pi.prototype={areaStart:nn,areaEnd:nn,lineStart:function(){this._x0=this._x1=this._x2=this._x3=this._x4=this._x5=this._y0=this._y1=this._y2=this._y3=this._y4=this._y5=NaN,this._point=0},lineEnd:function(){switch(this._point){case 1:{this._context.moveTo(this._x3,this._y3),this._context.closePath();break}case 2:{this._context.lineTo(this._x3,this._y3),this._context.closePath();break}case 3:{this.point(this._x3,this._y3),this.point(this._x4,this._y4),this.point(this._x5,this._y5);break}}},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1,this._x3=e,this._y3=n;break;case 1:this._point=2,this._context.moveTo(this._x4=e,this._y4=n);break;case 2:this._point=3,this._x5=e,this._y5=n;break;default:Lt(this,e,n);break}this._x0=this._x1,this._x1=this._x2,this._x2=e,this._y0=this._y1,this._y1=this._y2,this._y2=n}};const Pk=function e(n){function t(a){return new Pi(a,n)}return t.tension=function(a){return e(+a)},t}(0);function Mi(e,n){this._context=e,this._k=(1-n)/6}Mi.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN,this._point=0},lineEnd:function(){(this._line||this._line!==0&&this._point===3)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1;break;case 1:this._point=2;break;case 2:this._point=3,this._line?this._context.lineTo(this._x2,this._y2):this._context.moveTo(this._x2,this._y2);break;case 3:this._point=4;default:Lt(this,e,n);break}this._x0=this._x1,this._x1=this._x2,this._x2=e,this._y0=this._y1,this._y1=this._y2,this._y2=n}};const Mk=function e(n){function t(a){return new Mi(a,n)}return t.tension=function(a){return e(+a)},t}(0);function Li(e,n,t){var a=e._x1,o=e._y1,i=e._x2,s=e._y2;if(e._l01_a>be){var r=2*e._l01_2a+3*e._l01_a*e._l12_a+e._l12_2a,l=3*e._l01_a*(e._l01_a+e._l12_a);a=(a*r-e._x0*e._l12_2a+e._x2*e._l01_2a)/l,o=(o*r-e._y0*e._l12_2a+e._y2*e._l01_2a)/l}if(e._l23_a>be){var c=2*e._l23_2a+3*e._l23_a*e._l12_a+e._l12_2a,u=3*e._l23_a*(e._l23_a+e._l12_a);i=(i*c+e._x1*e._l23_2a-n*e._l12_2a)/u,s=(s*c+e._y1*e._l23_2a-t*e._l12_2a)/u}e._context.bezierCurveTo(a,o,i,s,e._x2,e._y2)}function Gr(e,n){this._context=e,this._alpha=n}Gr.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN,this._l01_a=this._l12_a=this._l23_a=this._l01_2a=this._l12_2a=this._l23_2a=this._point=0},lineEnd:function(){switch(this._point){case 2:this._context.lineTo(this._x2,this._y2);break;case 3:this.point(this._x2,this._y2);break}(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){if(e=+e,n=+n,this._point){var t=this._x2-e,a=this._y2-n;this._l23_a=Math.sqrt(this._l23_2a=Math.pow(t*t+a*a,this._alpha))}switch(this._point){case 0:this._point=1,this._line?this._context.lineTo(e,n):this._context.moveTo(e,n);break;case 1:this._point=2;break;case 2:this._point=3;default:Li(this,e,n);break}this._l01_a=this._l12_a,this._l12_a=this._l23_a,this._l01_2a=this._l12_2a,this._l12_2a=this._l23_2a,this._x0=this._x1,this._x1=this._x2,this._x2=e,this._y0=this._y1,this._y1=this._y2,this._y2=n}};const Lk=function e(n){function t(a){return n?new Gr(a,n):new Di(a,0)}return t.alpha=function(a){return e(+a)},t}(.5);function Hr(e,n){this._context=e,this._alpha=n}Hr.prototype={areaStart:nn,areaEnd:nn,lineStart:function(){this._x0=this._x1=this._x2=this._x3=this._x4=this._x5=this._y0=this._y1=this._y2=this._y3=this._y4=this._y5=NaN,this._l01_a=this._l12_a=this._l23_a=this._l01_2a=this._l12_2a=this._l23_2a=this._point=0},lineEnd:function(){switch(this._point){case 1:{this._context.moveTo(this._x3,this._y3),this._context.closePath();break}case 2:{this._context.lineTo(this._x3,this._y3),this._context.closePath();break}case 3:{this.point(this._x3,this._y3),this.point(this._x4,this._y4),this.point(this._x5,this._y5);break}}},point:function(e,n){if(e=+e,n=+n,this._point){var t=this._x2-e,a=this._y2-n;this._l23_a=Math.sqrt(this._l23_2a=Math.pow(t*t+a*a,this._alpha))}switch(this._point){case 0:this._point=1,this._x3=e,this._y3=n;break;case 1:this._point=2,this._context.moveTo(this._x4=e,this._y4=n);break;case 2:this._point=3,this._x5=e,this._y5=n;break;default:Li(this,e,n);break}this._l01_a=this._l12_a,this._l12_a=this._l23_a,this._l01_2a=this._l12_2a,this._l12_2a=this._l23_2a,this._x0=this._x1,this._x1=this._x2,this._x2=e,this._y0=this._y1,this._y1=this._y2,this._y2=n}};const $k=function e(n){function t(a){return n?new Hr(a,n):new Pi(a,0)}return t.alpha=function(a){return e(+a)},t}(.5);function Kr(e,n){this._context=e,this._alpha=n}Kr.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN,this._l01_a=this._l12_a=this._l23_a=this._l01_2a=this._l12_2a=this._l23_2a=this._point=0},lineEnd:function(){(this._line||this._line!==0&&this._point===3)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){if(e=+e,n=+n,this._point){var t=this._x2-e,a=this._y2-n;this._l23_a=Math.sqrt(this._l23_2a=Math.pow(t*t+a*a,this._alpha))}switch(this._point){case 0:this._point=1;break;case 1:this._point=2;break;case 2:this._point=3,this._line?this._context.lineTo(this._x2,this._y2):this._context.moveTo(this._x2,this._y2);break;case 3:this._point=4;default:Li(this,e,n);break}this._l01_a=this._l12_a,this._l12_a=this._l23_a,this._l01_2a=this._l12_2a,this._l12_2a=this._l23_2a,this._x0=this._x1,this._x1=this._x2,this._x2=e,this._y0=this._y1,this._y1=this._y2,this._y2=n}};const Nk=function e(n){function t(a){return n?new Kr(a,n):new Mi(a,0)}return t.alpha=function(a){return e(+a)},t}(.5);function Yr(e){this._context=e}Yr.prototype={areaStart:nn,areaEnd:nn,lineStart:function(){this._point=0},lineEnd:function(){this._point&&this._context.closePath()},point:function(e,n){e=+e,n=+n,this._point?this._context.lineTo(e,n):(this._point=1,this._context.moveTo(e,n))}};function Ok(e){return new Yr(e)}function Ts(e){return e<0?-1:1}function Is(e,n,t){var a=e._x1-e._x0,o=n-e._x1,i=(e._y1-e._y0)/(a||o<0&&-0),s=(t-e._y1)/(o||a<0&&-0),r=(i*o+s*a)/(a+o);return(Ts(i)+Ts(s))*Math.min(Math.abs(i),Math.abs(s),.5*Math.abs(r))||0}function Ss(e,n){var t=e._x1-e._x0;return t?(3*(e._y1-e._y0)/t-n)/2:n}function ma(e,n,t){var a=e._x0,o=e._y0,i=e._x1,s=e._y1,r=(i-a)/3;e._context.bezierCurveTo(a+r,o+r*n,i-r,s-r*t,i,s)}function $t(e){this._context=e}$t.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._y0=this._y1=this._t0=NaN,this._point=0},lineEnd:function(){switch(this._point){case 2:this._context.lineTo(this._x1,this._y1);break;case 3:ma(this,this._t0,Ss(this,this._t0));break}(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(e,n){var t=NaN;if(e=+e,n=+n,!(e===this._x1&&n===this._y1)){switch(this._point){case 0:this._point=1,this._line?this._context.lineTo(e,n):this._context.moveTo(e,n);break;case 1:this._point=2;break;case 2:this._point=3,ma(this,Ss(this,t=Is(this,e,n)),t);break;default:ma(this,this._t0,t=Is(this,e,n));break}this._x0=this._x1,this._x1=e,this._y0=this._y1,this._y1=n,this._t0=t}}};function Xr(e){this._context=new Qr(e)}(Xr.prototype=Object.create($t.prototype)).point=function(e,n){$t.prototype.point.call(this,n,e)};function Qr(e){this._context=e}Qr.prototype={moveTo:function(e,n){this._context.moveTo(n,e)},closePath:function(){this._context.closePath()},lineTo:function(e,n){this._context.lineTo(n,e)},bezierCurveTo:function(e,n,t,a,o,i){this._context.bezierCurveTo(n,e,a,t,i,o)}};function Ek(e){return new $t(e)}function Rk(e){return new Xr(e)}function Jr(e){this._context=e}Jr.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x=[],this._y=[]},lineEnd:function(){var e=this._x,n=this._y,t=e.length;if(t)if(this._line?this._context.lineTo(e[0],n[0]):this._context.moveTo(e[0],n[0]),t===2)this._context.lineTo(e[1],n[1]);else for(var a=Ds(e),o=Ds(n),i=0,s=1;s<t;++i,++s)this._context.bezierCurveTo(a[0][i],o[0][i],a[1][i],o[1][i],e[s],n[s]);(this._line||this._line!==0&&t===1)&&this._context.closePath(),this._line=1-this._line,this._x=this._y=null},point:function(e,n){this._x.push(+e),this._y.push(+n)}};function Ds(e){var n,t=e.length-1,a,o=new Array(t),i=new Array(t),s=new Array(t);for(o[0]=0,i[0]=2,s[0]=e[0]+2*e[1],n=1;n<t-1;++n)o[n]=1,i[n]=4,s[n]=4*e[n]+2*e[n+1];for(o[t-1]=2,i[t-1]=7,s[t-1]=8*e[t-1]+e[t],n=1;n<t;++n)a=o[n]/i[n-1],i[n]-=a,s[n]-=a*s[n-1];for(o[t-1]=s[t-1]/i[t-1],n=t-2;n>=0;--n)o[n]=(s[n]-o[n+1])/i[n];for(i[t-1]=(e[t]+o[t-1])/2,n=0;n<t-1;++n)i[n]=2*e[n+1]-o[n+1];return[o,i]}function zk(e){return new Jr(e)}function Zt(e,n){this._context=e,this._t=n}Zt.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x=this._y=NaN,this._point=0},lineEnd:function(){0<this._t&&this._t<1&&this._point===2&&this._context.lineTo(this._x,this._y),(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line>=0&&(this._t=1-this._t,this._line=1-this._line)},point:function(e,n){switch(e=+e,n=+n,this._point){case 0:this._point=1,this._line?this._context.lineTo(e,n):this._context.moveTo(e,n);break;case 1:this._point=2;default:{if(this._t<=0)this._context.lineTo(this._x,n),this._context.lineTo(e,n);else{var t=this._x*(1-this._t)+e*this._t;this._context.lineTo(t,this._y),this._context.lineTo(t,n)}break}}this._x=e,this._y=n}};function Bk(e){return new Zt(e,.5)}function qk(e){return new Zt(e,0)}function Vk(e){return new Zt(e,1)}function qn(e,n,t){this.k=e,this.x=n,this.y=t}qn.prototype={constructor:qn,scale:function(e){return e===1?this:new qn(this.k*e,this.x,this.y)},translate:function(e,n){return e===0&n===0?this:new qn(this.k,this.x+this.k*e,this.y+this.k*n)},apply:function(e){return[e[0]*this.k+this.x,e[1]*this.k+this.y]},applyX:function(e){return e*this.k+this.x},applyY:function(e){return e*this.k+this.y},invert:function(e){return[(e[0]-this.x)/this.k,(e[1]-this.y)/this.k]},invertX:function(e){return(e-this.x)/this.k},invertY:function(e){return(e-this.y)/this.k},rescaleX:function(e){return e.copy().domain(e.range().map(this.invertX,this).map(e.invert,e))},rescaleY:function(e){return e.copy().domain(e.range().map(this.invertY,this).map(e.invert,e))},toString:function(){return"translate("+this.x+","+this.y+") scale("+this.k+")"}};qn.prototype;const L2={class:"knowledge-graph-shell"},Je=720,Ue=320,me=44,$2=U({__name:"KnowledgeGraph",setup(e){const n=Je/2,t=Ue/2,a=ae(null);let o=null,i=null,s=null,r=null;const l=[{id:"agentic",label:"Agentic",size:22,group:"main"},{id:"devops",label:"DevOps",size:24,group:"main"},{id:"architecture",label:"Architecture",size:22,group:"main"},{id:"golang",label:"Go",size:14,group:"secondary"},{id:"kubernetes",label:"K8S",size:14,group:"secondary"},{id:"cloud",label:"Cloud",size:14,group:"secondary"},{id:"cicd",label:"GitOps",size:13,group:"secondary"},{id:"development",label:"Development",size:14,group:"secondary"},{id:"ddd",label:"DDD",size:13,group:"secondary"},{id:"microservices",label:"MicroServices",size:13,group:"secondary"},{id:"copilot",label:"Copilot",size:13,group:"secondary"},{id:"aws",label:"AWS",size:11,group:"leaf"},{id:"tdd",label:"TDD",size:11,group:"leaf"},{id:"kotlin",label:"Kotlin",size:11,group:"leaf"}],c=l.filter(S=>typeof S.anchorX=="number"&&typeof S.anchorY=="number"),u=c.map(S=>S.anchorX),p=c.map(S=>S.anchorY),d=Math.min(...u),h=Math.max(...u),v=Math.min(...p),b=Math.max(...p);function w(S){const q=Je-me*2;return me+(S-d)/Math.max(h-d,1)*q}function x(S){const q=Ue-me*2;return me+(S-v)/Math.max(b-v,1)*q}const A={agentic:{x:n-132,y:t-44},devops:{x:n,y:t+8},architecture:{x:n+132,y:t-44}};function M(S){var q;return S.group==="main"?((q=A[S.id])==null?void 0:q.x)??n:typeof S.anchorX=="number"?w(S.anchorX):n}function y(S){var q;return S.group==="main"?((q=A[S.id])==null?void 0:q.y)??t:typeof S.anchorY=="number"?x(S.anchorY):t}const T=l.map(S=>({...S,x:M(S),y:y(S)})),k=[{id:"golang-kubernetes",source:"golang",target:"kubernetes"},{id:"golang-development",source:"golang",target:"development"},{id:"kubernetes-devops",source:"kubernetes",target:"devops"},{id:"kubernetes-cloud",source:"kubernetes",target:"cloud"},{id:"cloud-aws",source:"cloud",target:"aws"},{id:"cicd-devops",source:"cicd",target:"devops"},{id:"development-tdd",source:"development",target:"tdd"},{id:"development-ddd",source:"development",target:"ddd"},{id:"ddd-architecture",source:"ddd",target:"architecture"},{id:"ddd-microservices",source:"ddd",target:"microservices"},{id:"microservices-architecture",source:"microservices",target:"architecture"},{id:"copilot-agentic",source:"copilot",target:"agentic"},{id:"copilot-development",source:"copilot",target:"development"},{id:"golang-kotlin",source:"golang",target:"kotlin"}],O=new Map(T.map(S=>[S.id,S]));function V(S,q){const G=getComputedStyle(document.documentElement).getPropertyValue(S).trim();if(!G)return q;if(G.startsWith("#")){const E=G.slice(1),Y=E.length===3?`${E[0]}${E[0]}${E[1]}${E[1]}${E[2]}${E[2]}`:E;if(Y.length===6){const J=parseInt(Y.slice(0,2),16),D=parseInt(Y.slice(2,4),16),oe=parseInt(Y.slice(4,6),16);return`rgb(${J}, ${D}, ${oe})`}}return G}function H(){return{mainNode:V("--color-primary","rgb(84, 95, 115)"),secondaryNode:V("--color-primary-container","rgb(216, 227, 251)"),leafNode:V("--color-surface-container-low","rgb(231, 236, 239)"),edgeColor:V("--color-outline-variant","rgb(169, 180, 185)"),activeEdge:V("--color-tertiary","rgb(58, 82, 95)"),dimColor:V("--color-surface","rgb(242, 244, 245)"),labelColor:V("--color-on-surface","rgb(42, 52, 57)"),dimLabelColor:V("--color-on-surface-variant","rgb(95, 108, 114)"),surfaceColor:V("--color-surface-container-lowest","rgb(255, 255, 255)")}}function j(S){if(S)return typeof S=="string"?O.get(S):S}function $(S){return S?typeof S=="string"?S:S.id:null}function P(S){return Math.max(S.size*.84,10)}function L(S){return Number.isFinite(S.x)?S.x:Je/2}function z(S){return Number.isFinite(S.y)?S.y:Ue/2}function te(S){const q=P(S),G=me+q,E=Je-me-q,Y=me+q,J=Ue-me-q;S.x=Math.min(E,Math.max(G,L(S))),S.y=Math.min(J,Math.max(Y,z(S)))}function ee(S,q){const G=P(S),E=me+G,Y=Je-me-G;return Math.min(Y,Math.max(E,q))}function K(S,q){const G=P(S),E=me+G,Y=Ue-me-G;return Math.min(Y,Math.max(E,q))}function re(S,q){const G=k.find(E=>E.id===S);return G?$(G.source)===q||$(G.target)===q:!1}function ue(S){return o?S===o?!0:k.some(q=>re(q.id,S)&&re(q.id,o)):!1}function de(S,q){return S==="main"?q.mainNode:S==="secondary"?q.secondaryNode:q.leafNode}function Ce(){if(!a.value)return;const S=ln(a.value).select("svg.knowledge-graph-svg");S.empty()||(S.selectAll("line.graph-edge").attr("x1",q=>L(j(q.source)??T[0])).attr("y1",q=>z(j(q.source)??T[0])).attr("x2",q=>L(j(q.target)??T[0])).attr("y2",q=>z(j(q.target)??T[0])),S.selectAll("line.graph-edge-hitbox").attr("x1",q=>L(j(q.source)??T[0])).attr("y1",q=>z(j(q.source)??T[0])).attr("x2",q=>L(j(q.target)??T[0])).attr("y2",q=>z(j(q.target)??T[0])),S.selectAll("g.graph-node").attr("transform",q=>`translate(${L(q)}, ${z(q)})`))}function we(){if(!a.value)return;const S=H(),q=ln(a.value).select("svg.knowledge-graph-svg");q.empty()||(q.select("rect.graph-surface").attr("fill",S.surfaceColor).attr("opacity",.18),q.selectAll("line.graph-grid").attr("stroke",S.dimColor).attr("opacity",.55),q.selectAll("line.graph-edge").attr("stroke",G=>G.id===i?S.activeEdge:o&&!re(G.id,o)||i&&G.id!==i?S.dimColor:S.edgeColor).attr("stroke-width",G=>G.id===i?3.4:1.8).attr("opacity",G=>G.id===i?1:o&&!re(G.id,o)||i&&G.id!==i?.35:.9),q.selectAll("circle.graph-node-shape").attr("r",G=>{const E=P(G);return G.id===o?E*1.12:E}).attr("fill",G=>de(G.group,S)).attr("stroke",S.surfaceColor).attr("stroke-width",G=>G.id===o?3:2).attr("opacity",G=>G.id===o?1:o&&!ue(G.id)||i&&!re(i,G.id)?.4:.96),q.selectAll("text.graph-node-label").attr("fill",G=>o&&!ue(G.id)||i&&!re(i,G.id)?S.dimLabelColor:S.labelColor).attr("opacity",G=>o&&!ue(G.id)||i&&!re(i,G.id)?.6:1))}function le(){o=null,i=null,we()}function Le(){if(!a.value)return;const S=ln(a.value);S.selectAll("*").remove();const q=S.append("svg").attr("viewBox",`0 0 ${Je} ${Ue}`).attr("class","knowledge-graph-svg").attr("role","img").attr("aria-label","engineering knowledge graph").on("mouseleave",()=>{le()});q.append("rect").attr("class","graph-surface").attr("x",0).attr("y",0).attr("width",Je).attr("height",Ue).attr("rx",28),q.append("g").selectAll("line.graph-grid").data([.2,.5,.8]).join("line").attr("class","graph-grid").attr("x1",me).attr("x2",Je-me).attr("y1",D=>me+D*(Ue-me*2)).attr("y2",D=>me+D*(Ue-me*2)).attr("stroke-width",1).attr("stroke-dasharray","5 8");const G=q.append("g").attr("class","edge-layer"),E=q.append("g").attr("class","node-layer"),Y=Lf().on("start",(D,oe)=>{D.active||r==null||r.alphaTarget(.18).restart(),oe.fx=L(oe),oe.fy=z(oe)}).on("drag",(D,oe)=>{oe.fx=ee(oe,D.x),oe.fy=K(oe,D.y),Ce()}).on("end",(D,oe)=>{D.active||r==null||r.alphaTarget(0),oe.fx=null,oe.fy=null});G.selectAll("line.graph-edge").data(k).join("line").attr("class","graph-edge").attr("stroke-linecap","round"),G.selectAll("line.graph-edge-hitbox").data(k).join("line").attr("class","graph-edge-hitbox").attr("stroke","transparent").attr("stroke-width",14).attr("stroke-linecap","round").style("cursor","pointer").on("mouseenter",(D,oe)=>{i=oe.id,o=null,we()});const J=E.selectAll("g.graph-node").data(T).join("g").attr("class","graph-node").style("cursor","pointer").on("mouseenter",(D,oe)=>{o=oe.id,i=null,we()}).call(Y);J.append("circle").attr("class","graph-node-shape"),J.append("text").attr("class","graph-node-label").text(D=>D.label).attr("text-anchor","middle").attr("dominant-baseline","middle").attr("font-size",D=>Math.max(D.size*.78,10)).attr("font-weight",D=>D.group==="main"?700:600).style("pointer-events","none"),Ce(),we()}function Te(){r==null||r.stop(),r=n0(T).force("link",Hb(k).id(S=>S.id).distance(S=>{const q=j(S.source),G=j(S.target);return(q==null?void 0:q.group)==="main"||(G==null?void 0:G.group)==="main"?104:(q==null?void 0:q.group)==="leaf"||(G==null?void 0:G.group)==="leaf"?72:88}).strength(.4)).force("charge",t0().strength(S=>S.group==="main"?-780:S.group==="secondary"?-520:-320)).force("center",Tb(n,t)).force("x",a0(S=>M(S)).strength(S=>S.group==="main"?.24:.08)).force("y",o0(S=>y(S)).strength(S=>S.group==="main"?.22:.06)).force("collision",Wb().radius(S=>P(S)+12).iterations(3)).alpha(.9).alphaDecay(.04).velocityDecay(.3).on("tick",()=>{T.forEach(S=>{te(S)}),Ce()})}return Oe(()=>{Le(),Te(),s=new MutationObserver(()=>{we()}),s.observe(document.documentElement,{attributes:!0,attributeFilter:["class","data-theme"]})}),ja(()=>{s&&(s.disconnect(),s=null),r&&(r.stop(),r=null)}),(S,q)=>(f(),_("div",L2,[g("div",{ref_key:"containerRef",ref:a,class:"knowledge-graph-canvas"},null,512)]))}}),N2=X($2,[["__scopeId","data-v-49a3d5a3"]]);function ge(e){return e.replace(/^\/+/,"").replace(/^docs\//,"")}function Ps(e){return`/${ge(e)}`}function Zr(e){return Object.keys(e).reduce((n,t)=>(n[ge(t)]=t,n),{})}function el(e,n,t){const a=ge(e),o=[Ps(e),`/${a}`,a,t[a]].filter(i=>!!i);for(const i of o){const s=n[i];if(s)return{modulePath:i,raw:s}}return{modulePath:Ps(e),raw:void 0}}function Nt(e){const n=ge(e);return n.split("/").pop()||n}function Ms(e){return e.replace(/^['\"]|['\"]$/g,"").trim()}function O2(e){const n=e.trim();if(n.startsWith("[")&&n.endsWith("]")){const t=n.slice(1,-1).trim();return t?t.split(",").map(a=>Ms(a.trim())).filter(a=>a.length>0):[]}return Ms(n)}function nl(e){const n=e.match(/^---\n([\s\S]*?)\n---/);if(!n)return{};const t={};for(const a of n[1].split(`
`)){if(!a||/^\s/.test(a)||a.startsWith("#"))continue;const o=a.indexOf(":");if(o<0)continue;const i=a.slice(0,o).trim(),s=O2(a.slice(o+1));t[i]=s}return t}function tl(e){return e.replace(/^---[\s\S]*?---\n?/,"").trim()}function al(e){const t=tl(e).split(/\n\s*\n/).find(a=>a.trim().length>0);return(t==null?void 0:t.replace(/^#+\s+/,"").trim())||""}function ol(e,n={}){const a=tl(e).replace(/```[\s\S]*?```/g," ").replace(/`[^`]*`/g," ").replace(/!\[[^\]]*\]\([^)]*\)/g," ").replace(/\[[^\]]*\]\([^)]*\)/g," ").replace(/[#>*_~\-]/g," ").replace(/\s+/g," ").trim().length,o=Math.max(1,Math.ceil(a/500));return typeof n.formatter=="function"?n.formatter(o):n.template?n.template.replace("{minutes}",String(o)):`~ ${o} min read`}function jn(e){return e?`/${ge(e).replace(/\.md$/,"").replace(/\/index$/,"/")}`:"#"}function il(e){const n=e.replace(/[.+^${}()|[\]\\]/g,"\\$&").replace(/\*\*/g,"::DOUBLE_STAR::").replace(/\*/g,"[^/]*").replace(/::DOUBLE_STAR::/g,".*");return new RegExp(`^${n}$`)}function sl(e){const n=String(e.category||"").trim();return n&&e.categoryMeta&&e.categoryMeta[n]?e.categoryMeta[n]:{}}function $i(e){const n=sl(e);return n.label?n.label:String(e.category||"").trim()}function Ni(e){const n=sl(e);return n.colorClass?n.colorClass:""}const E2="/assets/1644655887368.DQapbKac.jpg",R2="/assets/1644658272643.DixkFUdM.jpg",z2="/assets/wx20220212-172346.Bdr25vH2.png",B2="/assets/wx20220212-172451.BB6BU37T.png",q2="/assets/1-6zojnn4sdsd9kylfhr34-a-1640317491743-0.BT5IPXlG.png",V2="/assets/1-n1zqvw8bk-o8rwxnzs5kq-1640317547459-0.DWMxzrzx.png",j2="/assets/2022-03-13-22-37-47.FXklLsNs.jpeg",F2="/assets/dual-clutch-transmission-13-1640318081688-0.B4hokDfU.gif",U2="/assets/skills.BAnIdTNL.png",W2="/assets/wiki-type-of-architect-1640317457778-0.C3YyCdof.png",G2="/assets/wx20220320-163559.CfWPxfHG.png",H2="/assets/wx20220320-163907.B6vfIgkR.png",K2="/assets/wx20220321-104324.BgpfGzm0.png",Y2="/assets/image-1653875255217-0.DLUkC6WM.png",X2="/assets/2022-05-25-10-21-15.BG964yVJ.png",Q2="/assets/image-16.yUtl20qA.png",J2="/assets/image-17.hTTOmgfs.png",Z2="/assets/image-18.HclV9ZG2.png",ew="/assets/1645694079239.C_nre4re.jpg",nw="/assets/achitecture-discussing-2.CIp6ic9U.jpeg",tw="/assets/achitecture-discussing._BjOxGqC.jpeg",aw="/assets/basic-diagram.k-lcOFHY.jpeg",ow="/assets/building-architecture.CVLmaHKi.jpeg",iw="/assets/image-01.9UEyGlKG.png",sw="/assets/image-02.lC5tp8JY.png",rw="/assets/image-03.CN1AMQ2n.png",lw="/assets/image-21.GzBuHhpo.png",cw="/assets/image-31.BCqMHRFV.png",dw="/assets/image-32.BONEHxoC.png",uw="/assets/image-33.35tIccBN.png",hw="/assets/image-34.BI0AYe_e.png",gw="/assets/image-35.Dqw7EEZo.png",pw="/assets/image-36.B6zYBbcF.png",mw="/assets/image-37.Bug7G00R.png",fw="/assets/image-38.F3X5v5gc.png",vw="/assets/image-main.d3gkZeRb.png",bw="/assets/math-diagram.CeYjpfsa.jpeg",yw="/assets/network-topology.CSAnXw-U.webp",ww="/assets/pictograph-1.BjKnp1uA.jpeg",_w="/assets/quick-sort.DqDqTYZk.png",kw="/assets/words.BJuqccBz.webp",xw="/assets/image.v72K2I7B.png",Aw="/assets/image-1.CABcO0hy.png",Cw="/assets/image-2.CqDiP9_8.png",Tw="/assets/image.C-NbRYb4.png",Iw="/assets/langchain-ollama.BRx4KDS9.png",Sw="/assets/llm-architecture.Brkjch2V.png",Dw="/assets/git-graph-0.C4G_Ghqh.png",Pw="/assets/git-graph-1.0NB7GhSV.png",Mw="/assets/devops.D2KY2cuE.png",Lw="/assets/homepage.CbpzU-qz.png",$w="/assets/mp-weixin-green.CsjjYBS_.png",Nw="/assets/mp-weixin-white.CcgfmLQg.png",Ow="/assets/old.BLdKa2Z6.png",Ew="/assets/image-1.BZojNKVT.png",Rw="/assets/image-2.DU_0Fs-4.png",zw="/assets/image-3.DFogVQnE.png",Bw="/assets/image-main.QAIGTop_.png",qw="/assets/mp-weixin-green.CsjjYBS_.png",Vw="/assets/mp-weixin-white.CcgfmLQg.png",jw="/assets/1776153628712.Bl4yzL5r.png",Fw="/assets/1778475581203.DM2S-Q9z.png",Uw="/assets/1780883130955.CndDY_6K.png",Ww="/assets/choreography.B4CU8w1K.svg",Gw="/assets/orchestration.wOY-XY5P.svg",Hw="https://picsum.photos/800/600";function Kw(e){let n=0;for(let t=0;t<e.length;t+=1)n=(n*31+e.charCodeAt(t))%1e4;return n+1}function Yw(e){return e.replace(/^\/+/,"").replace(/^docs\//,"")}function Xw(e){const n=Yw(e||"")||"default",t=Kw(n);return`${Hw}?random=${t}`}const Qw=new Set(["","null","undefined","none","n/a","na","-"]),Jw=Object.assign({"/blogs/assets/202202-logseq-build-your-own-wiki/1644655887368.jpg":E2,"/blogs/assets/202202-logseq-build-your-own-wiki/1644658272643.jpg":R2,"/blogs/assets/202202-logseq-build-your-own-wiki/wx20220212-172346.png":z2,"/blogs/assets/202202-logseq-build-your-own-wiki/wx20220212-172451.png":B2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/1-6zojnn4sdsd9kylfhr34-a-1640317491743-0.png":q2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/1-n1zqvw8bk-o8rwxnzs5kq-1640317547459-0.png":V2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/2022-03-13-22-37-47.jpeg":j2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/dual-clutch-transmission-13-1640318081688-0.gif":F2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/skills.png":U2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/wiki-type-of-architect-1640317457778-0.png":W2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/wx20220320-163559.png":G2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/wx20220320-163907.png":H2,"/blogs/assets/202203-mesh-shaped-cloud-native-developer/wx20220321-104324.png":K2,"/blogs/assets/202203-mesh-shaped-recap/image-1653875255217-0.png":Y2,"/blogs/assets/202205-router-proxy-gtw/2022-05-25-10-21-15.png":X2,"/blogs/assets/202211-cloud-native-engineering/image-16.png":Q2,"/blogs/assets/202211-cloud-native-engineering/image-17.png":J2,"/blogs/assets/202211-cloud-native-engineering/image-18.png":Z2,"/blogs/assets/202212-logseq-customized-with-clojure-and-css/1645694079239.jpg":ew,"/blogs/assets/202304-draw-architecture-diagram/achitecture-discussing-2.jpeg":nw,"/blogs/assets/202304-draw-architecture-diagram/achitecture-discussing.jpeg":tw,"/blogs/assets/202304-draw-architecture-diagram/basic-diagram.jpeg":aw,"/blogs/assets/202304-draw-architecture-diagram/building-architecture.jpeg":ow,"/blogs/assets/202304-draw-architecture-diagram/image-01.png":iw,"/blogs/assets/202304-draw-architecture-diagram/image-02.png":sw,"/blogs/assets/202304-draw-architecture-diagram/image-03.png":rw,"/blogs/assets/202304-draw-architecture-diagram/image-21.png":lw,"/blogs/assets/202304-draw-architecture-diagram/image-31.png":cw,"/blogs/assets/202304-draw-architecture-diagram/image-32.png":dw,"/blogs/assets/202304-draw-architecture-diagram/image-33.png":uw,"/blogs/assets/202304-draw-architecture-diagram/image-34.png":hw,"/blogs/assets/202304-draw-architecture-diagram/image-35.png":gw,"/blogs/assets/202304-draw-architecture-diagram/image-36.png":pw,"/blogs/assets/202304-draw-architecture-diagram/image-37.png":mw,"/blogs/assets/202304-draw-architecture-diagram/image-38.png":fw,"/blogs/assets/202304-draw-architecture-diagram/image-main.png":vw,"/blogs/assets/202304-draw-architecture-diagram/math-diagram.jpeg":bw,"/blogs/assets/202304-draw-architecture-diagram/network-topology.webp":yw,"/blogs/assets/202304-draw-architecture-diagram/pictograph-1.jpeg":ww,"/blogs/assets/202304-draw-architecture-diagram/quick-sort.png":_w,"/blogs/assets/202304-draw-architecture-diagram/words.webp":kw,"/blogs/assets/202304-tunnel-vpn-vpc/image.png":xw,"/blogs/assets/202402-llm-application/image-1.png":Aw,"/blogs/assets/202402-llm-application/image-2.png":Cw,"/blogs/assets/202402-llm-application/image.png":Tw,"/blogs/assets/202402-llm-application/langchain-ollama.png":Iw,"/blogs/assets/202402-llm-application/llm-architecture.png":Sw,"/blogs/assets/202406-fork-oss/git-graph-0.png":Dw,"/blogs/assets/202406-fork-oss/git-graph-1.png":Pw,"/blogs/assets/202406-k3s-blogs/devops.png":Mw,"/blogs/assets/202406-k3s-blogs/homepage.png":Lw,"/blogs/assets/202406-k3s-blogs/mp-weixin-green.png":$w,"/blogs/assets/202406-k3s-blogs/mp-weixin-white.png":Nw,"/blogs/assets/202406-k3s-blogs/old.png":Ow,"/blogs/assets/202412-ai-powered-pkm/image-1.png":Ew,"/blogs/assets/202412-ai-powered-pkm/image-2.png":Rw,"/blogs/assets/202412-ai-powered-pkm/image-3.png":zw,"/blogs/assets/202412-ai-powered-pkm/image-main.png":Bw,"/blogs/assets/202412-ai-powered-pkm/mp-weixin-green.png":qw,"/blogs/assets/202412-ai-powered-pkm/mp-weixin-white.png":Vw,"/blogs/assets/202604-logseq-scoring-overview/1776153628712.png":jw,"/blogs/assets/202605-multica-brains-agent-kanban/1778475581203.png":Fw,"/blogs/assets/202605-spdd-agentic-refactor/1780883130955.png":Uw,"/blogs/assets/202606-agent-changes-service-interconnection/choreography.svg":Ww,"/blogs/assets/202606-agent-changes-service-interconnection/orchestration.svg":Gw});function Zw(e){const n=e.trim();if(!n)return[];const t=n.startsWith("/")?n:`/${n}`;return[n,t]}function e1(e){for(const n of Zw(e)){const t=Jw[n];if(t)return t}return e}function Kn(e,n){const t=(e||"").trim(),a=t.toLowerCase();return!t||Qw.has(a)?Xw(n):e1(t)}const n1={class:"bg-surface dark:bg-slate-900 text-on-surface dark:text-slate-100"},t1={class:"pt-32 pb-24"},a1={class:"max-w-7xl mx-auto px-8 mb-32"},o1={class:"grid grid-cols-1 lg:grid-cols-12 gap-12 items-start"},i1={class:"lg:col-span-6"},s1={class:"mb-6 inline-block bg-primary-container px-3 py-1 rounded text-[10px] uppercase tracking-widest font-bold text-on-primary-container"},r1={class:"text-[3.5rem] font-extrabold tracking-tight leading-[1.1] mb-8 text-on-surface dark:text-slate-100"},l1={class:"text-[1.375rem] leading-relaxed text-on-surface-variant dark:text-slate-400 font-light mb-8 max-w-2xl"},c1={class:"flex items-center gap-4 mb-12"},d1={class:"text-sm text-on-surface-variant dark:text-slate-400"},u1={class:"lg:col-span-6 relative lg:mt-12"},h1={class:"bg-surface-container-lowest dark:bg-slate-950 p-6 rounded-lg dark:border-slate-700"},g1={class:"bg-surface-container-low dark:bg-slate-900 py-24"},p1={class:"max-w-7xl mx-auto px-8"},m1={class:"flex justify-between items-end mb-16"},f1={class:"label-sm text-tertiary font-bold tracking-[0.2em] uppercase text-xs mb-4 block pb-4"},v1={class:"text-[2.25rem] font-bold tracking-tight text-on-surface dark:text-slate-100"},b1={class:"grid grid-cols-1 md:grid-cols-2 gap-px bg-outline-variant/10 dark:bg-slate-700"},y1=["src","alt"],w1=["data-icon"],_1={class:"text-xl font-bold mb-4 text-on-surface dark:text-slate-100"},k1={class:"text-on-surface-variant dark:text-slate-400 leading-relaxed"},x1={class:"max-w-7xl mx-auto px-8 py-32"},A1={class:"mb-16 flex items-center justify-between gap-6"},C1={class:"text-[2.25rem] font-bold tracking-tight text-on-surface dark:text-slate-100 mb-2"},T1=["href"],I1={key:0,class:"grid grid-cols-1 md:grid-cols-12 gap-8"},S1=["href"],D1={class:"relative overflow-hidden rounded-xl mb-6 aspect-[16/9] bg-surface-container-low dark:bg-slate-900"},P1=["alt","src"],M1={class:"flex items-center gap-4 mb-4"},L1={class:"text-xs text-outline dark:text-slate-400 tracking-wider"},$1={class:"text-3xl font-bold tracking-tight mb-4 group-hover:text-tertiary transition-colors"},N1={class:"text-on-surface-variant dark:text-slate-400 line-clamp-2 max-w-2xl"},O1={class:"md:col-span-4 flex flex-col gap-12"},E1=["href"],R1={class:"flex items-center gap-3 mb-3"},z1={class:"text-[10px] text-outline dark:text-slate-400"},B1={class:"text-xl font-bold tracking-tight mb-3 group-hover:text-tertiary transition-colors leading-tight"},q1={class:"text-sm text-on-surface-variant dark:text-slate-400 line-clamp-2"},V1={class:"mt-4 flex items-center gap-1 text-tertiary text-sm font-semibold opacity-0 group-hover:opacity-100 transition-opacity"},j1={key:1,class:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"},F1=["href"],U1=["src","alt"],W1={class:"p-5"},G1={class:"flex items-center justify-between gap-3 mb-3"},H1={class:"text-[10px] text-outline dark:text-slate-400"},K1={class:"text-base font-bold tracking-tight mb-2 text-on-surface dark:text-slate-100"},Y1={class:"text-sm text-on-surface-variant dark:text-slate-400 line-clamp-3"},X1={key:0,class:"max-w-7xl mx-auto px-8"},Q1={class:"bg-primary text-on-primary p-16 rounded-xl relative overflow-hidden"},J1={class:"relative z-10 max-w-2xl"},Z1={class:"text-3xl font-bold tracking-tight mb-4"},e_={class:"text-on-primary/80 mb-8 text-lg"},n_={class:"flex flex-col sm:flex-row gap-4"},t_=["placeholder"],a_={class:"bg-on-primary text-primary font-bold px-8 py-3 rounded-lg hover:bg-primary-container transition-all active:scale-95",type:"submit"},o_=U({__name:"AboutMeLayout",setup(e){const{lang:n}=pn(),{page:t}=jt(),{headerConfig:a,footerConfig:o,uiConfig:i}=Ft(),s=R(()=>i.value.common||{}),r=R(()=>i.value.about||{}),l=R(()=>i.value.blog||{}),c=R(()=>l.value.categoryMeta||{}),u=Object.assign({"/about-me.md":Xa,"/blogs/2022/202202-logseq-build-your-own-wiki.md":Qa,"/blogs/2022/202203-mesh-shaped-cloud-native-developer.md":Ja,"/blogs/2022/202203-mesh-shaped-recap.md":Za,"/blogs/2022/202205-container-k8s-docker.md":eo,"/blogs/2022/202205-router-proxy-gtw.md":no,"/blogs/2022/202211-cloud-native-engineering.md":to,"/blogs/2022/202212-api-design-inspired-by-google-api-design.md":ao,"/blogs/2022/202212-go-monorepo-tutorial.md":oo,"/blogs/2022/202212-logseq-customized-with-clojure-and-css.md":io,"/blogs/2022/202212-logseq-pkm.md":so,"/blogs/2023/202302-iac-and-terraform.md":ro,"/blogs/2023/202304-draw-architecture-diagram.md":lo,"/blogs/2023/202304-tunnel-vpn-vpc.md":co,"/blogs/2023/202306-remote-development-in-cloud.md":uo,"/blogs/2023/202312-agile-and-lean.md":ho,"/blogs/2023/202312-cobra-cli.md":go,"/blogs/2023/202312-devcontainer-tutorial.md":po,"/blogs/2023/202312-illustrated-ai.md":mo,"/blogs/2023/202312-kubernetes-operator.md":fo,"/blogs/2023/202312-windows-workspaces.md":vo,"/blogs/2024/202401-cloud-native-practices.md":bo,"/blogs/2024/202401-eassy-2024.md":yo,"/blogs/2024/202401-illustrations.md":wo,"/blogs/2024/202402-llm-application.md":_o,"/blogs/2024/202403-ai-and-human.md":ko,"/blogs/2024/202406-fork-oss.md":xo,"/blogs/2024/202406-k3s-blogs.md":Ao,"/blogs/2024/202412-ai-powered-pkm.md":Co,"/blogs/2026/202602-domain-spec-agents.md":To,"/blogs/2026/202602-pov-agentic-engineering.md":Io,"/blogs/2026/202602-pov-standard-automation-selfserve.md":So,"/blogs/2026/202604-llm-wiki-self-evolving-brains.md":Do,"/blogs/2026/202604-logseq-scoring-overview.md":Po,"/blogs/2026/202605-multica-brains-agent-kanban.md":Mo,"/blogs/2026/202605-spdd-agentic-refactor.md":Lo,"/blogs/2026/202606-agent-changes-service-interconnection.md":$o,"/blogs/2026/202606-agile-agent-thoughtworks.md":No,"/blogs/index.md":Oo,"/en/about-me.md":Eo,"/en/blogs/2022/202202-logseq-build-your-own-wiki.md":Ro,"/en/blogs/2022/202203-mesh-shaped-cloud-native-developer.md":zo,"/en/blogs/2022/202205-container-k8s-docker.md":Bo,"/en/blogs/2022/202205-router-proxy-gtw.md":qo,"/en/blogs/2022/202211-cloud-native-engineering.md":Vo,"/en/blogs/2022/202212-logseq-customized-with-clojure-and-css.md":jo,"/en/blogs/2022/202212-logseq-pkm.md":Fo,"/en/blogs/2023/202302-iac-and-terraform.md":Uo,"/en/blogs/2023/202304-draw-architecture-diagram.md":Wo,"/en/blogs/2023/202304-tunnel-vpn-vpc.md":Go,"/en/blogs/2023/202306-remote-development-in-cloud.md":Ho,"/en/blogs/2023/202312-agile-and-lean.md":Ko,"/en/blogs/2023/202312-devcontainer-tutorial.md":Yo,"/en/blogs/2024/202401-cloud-native-practices.md":Xo,"/en/blogs/2024/202401-illustrations.md":Qo,"/en/blogs/2024/202402-llm-application.md":Jo,"/en/blogs/2024/202403-ai-and-human.md":Zo,"/en/blogs/2024/202412-ai-powered-pkm.md":ei,"/en/blogs/2026/202602-domain-spec-agents.md":ni,"/en/blogs/2026/202602-pov-agentic-engineering.md":ti,"/en/blogs/2026/202602-pov-standard-automation-selfserve.md":ai,"/en/blogs/2026/202604-llm-wiki-self-evolving-brains.md":oi,"/en/blogs/2026/202604-logseq-scoring-overview.md":ii,"/en/blogs/2026/202605-multica-brains-agent-kanban.md":si,"/en/blogs/2026/202605-spdd-agentic-refactor.md":ri,"/en/blogs/2026/202606-agent-changes-service-interconnection.md":li,"/en/blogs/2026/202606-agile-agent-thoughtworks.md":ci,"/en/blogs/index.md":di,"/en/index.md":ui,"/index.md":hi}),p=Zr(u);function d(k){var $,P;const{modulePath:O,raw:V}=el(k,u,p);if(!V)return console.warn(`[AboutMeLayout] markdown not found for path: ${k}`),console.warn(`[AboutMeLayout] attempted module key: ${O}`),null;const H=nl(V),j=H.title||H.heroTitle||((P=($=ge(k).split("/").pop())==null?void 0:$.replace(/\.md$/,""))==null?void 0:P.replace(/[-_]/g," "))||String(s.value.untitled||"Untitled");return{path:ge(k),title:j,description:H.description||H.heroDescription||H.articleLead||al(V),date:H.date,category:H.category,image:H.image}}const h=R(()=>{const k=t.value.featuredArticle;if(!k)return null;if(typeof k=="string")return d(k);if(typeof k=="object"&&typeof k.path=="string"){const O=d(k.path);return O?{...O,...k,path:O.path}:null}return typeof k=="object"?k:null}),v=R(()=>{var P;const k=t.value.sideArticles,O=ge(((P=h.value)==null?void 0:P.path)||"");if(Array.isArray(k))return k.filter(L=>ge(L.path||"")!==O);if(!k||typeof k!="object")return[];const V=ge(k.path||"blog/**/*.md"),H=Number(k.count||4),j=il(V);return Object.keys(u).map(L=>ge(L)).filter(L=>j.test(L)).sort((L,z)=>{const te=Nt(z).localeCompare(Nt(L));return te!==0?te:z.localeCompare(L)}).map(L=>d(L)).filter(L=>!!L).filter(L=>ge(L.path||"")!==O).slice(0,H)}),b=R(()=>!!h.value),w=R(()=>b.value?v.value:v.value.slice(0,4)),x=R(()=>t.value.articlesMoreHref||(n.value==="en"?"/en/blog/":"/blog/")),A=R(()=>t.value.articlesMoreText||r.value.viewMore||"View More");function M(k){return typeof k=="string"&&/^https?:\/\//.test(k)}function y(k){return $i({category:String(k||""),categoryMeta:c.value})}function T(k){return Ni({category:String(k||""),categoryMeta:c.value})}return(k,O)=>{var V,H,j,$,P,L,z,te,ee;return f(),_("div",n1,[F(qt,{"site-title":m(a).siteTitle||m(t).siteTitle,"nav-links":m(a).navLinks||m(t).navLinks||[],"show-subscribe":!!m(a).showSubscribe,"subscribe-button-text":m(a).subscribeButtonText,"nav-height-class":"h-20"},null,8,["site-title","nav-links","show-subscribe","subscribe-button-text"]),g("main",t1,[g("section",a1,[g("div",o1,[g("div",i1,[g("div",s1,I(m(t).heroEyebrow),1),g("h1",r1,I(m(t).heroTitle),1),g("p",l1,I(m(t).heroDescription),1),g("div",c1,[g("p",d1,I(m(t).heroMeta),1)])]),g("div",u1,[g("div",h1,[O[0]||(O[0]=g("span",{class:"text-s font-bold tracking-tight text-slate-700 dark:text-slate-300 mb-6"}," Graph: Mesh Capabilities ",-1)),F(N2)])])])]),g("section",g1,[g("div",p1,[g("div",m1,[g("div",null,[g("span",f1,I(m(t).focusEyebrow),1),g("h2",v1,I(m(t).focusTitle),1)]),O[1]||(O[1]=g("div",{class:"hidden md:block w-1/3 h-[1px] bg-outline-variant/20 dark:bg-slate-700 mb-4"},null,-1))]),g("div",b1,[(f(!0),_(Z,null,ie(m(t).focusCards||[],K=>(f(),_("div",{key:K.title,class:"bg-surface-container-lowest dark:bg-slate-950 p-10 transition-colors"},[M(K.icon)?(f(),_("img",{key:0,src:K.icon,alt:K.title,class:"w-10 h-10 object-contain mb-6"},null,8,y1)):(f(),_("span",{key:1,class:"material-symbols-outlined text-primary mb-6 block text-4xl dark:text-tertiary","data-icon":K.icon},I(K.icon),9,w1)),g("h3",_1,I(K.title),1),g("p",k1,I(K.description),1)]))),128))])])]),g("section",x1,[g("div",A1,[g("div",null,[g("h2",C1,I(m(t).articlesTitle),1),O[2]||(O[2]=g("div",{class:"w-12 h-1 bg-primary"},null,-1))]),g("a",{href:x.value,class:"inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-outline-variant/30 dark:border-slate-700 text-sm font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors"},[Ae(I(A.value)+" ",1),O[3]||(O[3]=g("span",{class:"material-symbols-outlined text-sm"},"arrow_forward",-1))],8,T1)]),b.value?(f(),_("div",I1,[g("a",{href:m(jn)((V=h.value)==null?void 0:V.path),class:"md:col-span-8 group cursor-pointer block"},[g("div",D1,[g("img",{alt:(H=h.value)==null?void 0:H.title,class:"w-full h-full object-cover transition-transform duration-700 group-hover:scale-105",src:m(Kn)((j=h.value)==null?void 0:j.image,($=h.value)==null?void 0:$.path)},null,8,P1),O[4]||(O[4]=g("div",{class:"absolute inset-0 bg-gradient-to-t from-black/40 to-transparent"},null,-1))]),g("div",M1,[g("span",{class:Q(["text-xs font-bold uppercase tracking-widest px-2 py-0.5 rounded",T((P=h.value)==null?void 0:P.category)])},I(y((L=h.value)==null?void 0:L.category)),3),g("span",L1,I((z=h.value)==null?void 0:z.date),1)]),g("h3",$1,I((te=h.value)==null?void 0:te.title),1),g("p",N1,I((ee=h.value)==null?void 0:ee.description),1)],8,S1),g("div",O1,[(f(!0),_(Z,null,ie(w.value,K=>(f(),_("a",{key:K.title,href:m(jn)(K.path),class:"group cursor-pointer block"},[g("div",R1,[g("span",{class:Q(["text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 rounded",T(K.category)])},I(y(K.category)),3),g("span",z1,I(K.date),1)]),g("h4",B1,I(K.title),1),g("p",q1,I(K.description),1),g("div",V1,[Ae(I(m(t).readMoreLabel)+" ",1),O[5]||(O[5]=g("span",{class:"material-symbols-outlined text-sm"},"arrow_forward",-1))])],8,E1))),128))])])):(f(),_("div",j1,[(f(!0),_(Z,null,ie(w.value,K=>(f(),_("a",{key:K.title,href:m(jn)(K.path),class:"bg-surface-container-lowest dark:bg-slate-900 border border-outline-variant/10 dark:border-slate-700 rounded-xl overflow-hidden block"},[g("img",{src:m(Kn)(K.image,K.path),alt:K.title,class:"w-full h-40 object-cover"},null,8,U1),g("div",W1,[g("div",G1,[g("span",{class:Q(["text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 rounded",T(K.category)])},I(y(K.category)),3),g("span",H1,I(K.date),1)]),g("h4",K1,I(K.title),1),g("p",Y1,I(K.description),1)])],8,F1))),128))]))]),m(t).subscribeTitle?(f(),_("section",X1,[g("div",Q1,[O[6]||(O[6]=g("div",{class:"absolute top-0 right-0 w-1/3 h-full mesh-grid opacity-10"},null,-1)),g("div",J1,[g("h2",Z1,I(m(t).subscribeTitle),1),g("p",e_,I(m(t).subscribeDescription),1),g("form",n_,[g("input",{class:"bg-white/10 border border-white/20 rounded-lg px-6 py-3 flex-grow focus:outline-none focus:ring-2 focus:ring-on-primary/50 text-white placeholder-white/40",placeholder:m(t).subscribePlaceholder,type:"email"},null,8,t_),g("button",a_,I(m(t).subscribeButton),1)])])])])):B("",!0)]),F(Vt,{title:m(o).title||m(t).footerTitle,description:m(o).description||m(t).footerDescription,links:m(o).links||m(t).footerLinks||[],"social-icons":m(o).socialIcons||[]},null,8,["title","description","links","social-icons"])])}}}),i_={class:"bg-surface dark:bg-slate-900 text-slate-900 dark:text-slate-100 selection:bg-primary-container selection:text-on-primary-container"},s_={class:"pt-32 pb-24 px-6 lg:px-12 max-w-7xl mx-auto bg-surface dark:bg-slate-900"},r_={class:"mb-32 relative"},l_={class:"grid grid-cols-1 lg:grid-cols-12 gap-12 items-end"},c_={class:"lg:col-span-7"},d_={class:"overflow-hidden rounded-xl bg-surface-container-low group"},u_=["src"],h_={class:"lg:col-span-5 pb-4"},g_={class:"flex items-center gap-4 mb-6"},p_={class:"text-[0.6875rem] font-medium text-outline"},m_={class:"text-5xl lg:text-6xl font-extrabold tracking-tighter leading-[1.12] lg:leading-[1.05] mb-8 text-slate-900 dark:text-slate-100"},f_={class:"text-slate-700 dark:text-slate-400 text-lg leading-relaxed mb-8 max-w-md"},v_={key:0,class:"flex flex-wrap gap-2 mb-8"},b_={class:"flex items-center justify-between border-t border-outline-variant/20 pt-6"},y_={class:"text-xs font-medium text-outline uppercase tracking-widest"},w_=["href"],__={class:"flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8"},k_={class:"max-w-xl"},x_={class:"text-3xl font-bold tracking-tight mb-6"},A_={class:"text-slate-700 dark:text-slate-400"},C_={class:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-20 gap-x-12"},T_=["href"],I_={class:"aspect-[4/3] rounded-xl overflow-hidden bg-surface-container-low mb-8"},S_=["src"],D_={class:"flex items-center gap-4 mb-4"},P_={class:"text-[0.6875rem] font-medium text-outline uppercase tracking-widest"},M_={class:"text-xl font-bold leading-tight mb-4 tracking-tight text-slate-900 dark:text-slate-100 hover:text-tertiary transition-colors"},L_={class:"text-slate-700 dark:text-slate-400 text-sm leading-relaxed mb-4"},$_={key:0,class:"flex flex-wrap gap-2 mb-6"},N_={class:"mt-auto flex items-center justify-between text-[0.6875rem] font-bold uppercase tracking-widest text-outline"},O_={class:"mt-32 pt-12 border-t border-outline-variant/20 flex justify-center items-center gap-8"},E_=["disabled"],R_={class:"flex gap-4"},z_=["onClick"],B_=["disabled"],q_=U({__name:"BlogListLayout",setup(e){const{page:n}=jt(),{headerConfig:t,footerConfig:a,uiConfig:o}=Ft(),i=R(()=>o.value.common||{}),s=R(()=>o.value.blog||{}),r=R(()=>s.value.categoryMeta||{}),l=R(()=>String(s.value.readingTimeTemplate||"")),c=Object.assign({"/about-me.md":Xa,"/blogs/2022/202202-logseq-build-your-own-wiki.md":Qa,"/blogs/2022/202203-mesh-shaped-cloud-native-developer.md":Ja,"/blogs/2022/202203-mesh-shaped-recap.md":Za,"/blogs/2022/202205-container-k8s-docker.md":eo,"/blogs/2022/202205-router-proxy-gtw.md":no,"/blogs/2022/202211-cloud-native-engineering.md":to,"/blogs/2022/202212-api-design-inspired-by-google-api-design.md":ao,"/blogs/2022/202212-go-monorepo-tutorial.md":oo,"/blogs/2022/202212-logseq-customized-with-clojure-and-css.md":io,"/blogs/2022/202212-logseq-pkm.md":so,"/blogs/2023/202302-iac-and-terraform.md":ro,"/blogs/2023/202304-draw-architecture-diagram.md":lo,"/blogs/2023/202304-tunnel-vpn-vpc.md":co,"/blogs/2023/202306-remote-development-in-cloud.md":uo,"/blogs/2023/202312-agile-and-lean.md":ho,"/blogs/2023/202312-cobra-cli.md":go,"/blogs/2023/202312-devcontainer-tutorial.md":po,"/blogs/2023/202312-illustrated-ai.md":mo,"/blogs/2023/202312-kubernetes-operator.md":fo,"/blogs/2023/202312-windows-workspaces.md":vo,"/blogs/2024/202401-cloud-native-practices.md":bo,"/blogs/2024/202401-eassy-2024.md":yo,"/blogs/2024/202401-illustrations.md":wo,"/blogs/2024/202402-llm-application.md":_o,"/blogs/2024/202403-ai-and-human.md":ko,"/blogs/2024/202406-fork-oss.md":xo,"/blogs/2024/202406-k3s-blogs.md":Ao,"/blogs/2024/202412-ai-powered-pkm.md":Co,"/blogs/2026/202602-domain-spec-agents.md":To,"/blogs/2026/202602-pov-agentic-engineering.md":Io,"/blogs/2026/202602-pov-standard-automation-selfserve.md":So,"/blogs/2026/202604-llm-wiki-self-evolving-brains.md":Do,"/blogs/2026/202604-logseq-scoring-overview.md":Po,"/blogs/2026/202605-multica-brains-agent-kanban.md":Mo,"/blogs/2026/202605-spdd-agentic-refactor.md":Lo,"/blogs/2026/202606-agent-changes-service-interconnection.md":$o,"/blogs/2026/202606-agile-agent-thoughtworks.md":No,"/blogs/index.md":Oo,"/en/about-me.md":Eo,"/en/blogs/2022/202202-logseq-build-your-own-wiki.md":Ro,"/en/blogs/2022/202203-mesh-shaped-cloud-native-developer.md":zo,"/en/blogs/2022/202205-container-k8s-docker.md":Bo,"/en/blogs/2022/202205-router-proxy-gtw.md":qo,"/en/blogs/2022/202211-cloud-native-engineering.md":Vo,"/en/blogs/2022/202212-logseq-customized-with-clojure-and-css.md":jo,"/en/blogs/2022/202212-logseq-pkm.md":Fo,"/en/blogs/2023/202302-iac-and-terraform.md":Uo,"/en/blogs/2023/202304-draw-architecture-diagram.md":Wo,"/en/blogs/2023/202304-tunnel-vpn-vpc.md":Go,"/en/blogs/2023/202306-remote-development-in-cloud.md":Ho,"/en/blogs/2023/202312-agile-and-lean.md":Ko,"/en/blogs/2023/202312-devcontainer-tutorial.md":Yo,"/en/blogs/2024/202401-cloud-native-practices.md":Xo,"/en/blogs/2024/202401-illustrations.md":Qo,"/en/blogs/2024/202402-llm-application.md":Jo,"/en/blogs/2024/202403-ai-and-human.md":Zo,"/en/blogs/2024/202412-ai-powered-pkm.md":ei,"/en/blogs/2026/202602-domain-spec-agents.md":ni,"/en/blogs/2026/202602-pov-agentic-engineering.md":ti,"/en/blogs/2026/202602-pov-standard-automation-selfserve.md":ai,"/en/blogs/2026/202604-llm-wiki-self-evolving-brains.md":oi,"/en/blogs/2026/202604-logseq-scoring-overview.md":ii,"/en/blogs/2026/202605-multica-brains-agent-kanban.md":si,"/en/blogs/2026/202605-spdd-agentic-refactor.md":ri,"/en/blogs/2026/202606-agent-changes-service-interconnection.md":li,"/en/blogs/2026/202606-agile-agent-thoughtworks.md":ci,"/en/blogs/index.md":di,"/en/index.md":ui,"/index.md":hi}),u=Zr(c);function p($){var ee,K;const{modulePath:P,raw:L}=el($,c,u);if(!L)return console.warn(`[BlogListLayout] markdown not found for path: ${$}`),console.warn(`[BlogListLayout] attempted module key: ${P}`),null;const z=nl(L),te=ge($);return{path:te,category:z.category,tags:Array.isArray(z.tags)?z.tags.map(re=>String(re)):[],date:z.date,title:z.title||((K=(ee=te.split("/").pop())==null?void 0:ee.replace(/\.md$/,""))==null?void 0:K.replace(/[-_]/g," "))||String(i.value.untitled||"Untitled"),description:z.description||z.articleLead||al(L)||"",readingTime:ol(L,{template:l.value}),action:z.action,image:z.image}}const d=R(()=>{const $=n.value.featured;if(!$)return null;if(typeof $=="string")return p($);if(typeof $=="object"&&typeof $.path=="string"){const P=p($.path);return P?{...P,...$,path:P.path}:null}return typeof $=="object"?$:null}),h=R(()=>{var te;const $=n.value.posts,P=ge(((te=d.value)==null?void 0:te.path)||"");if(Array.isArray($))return $.filter(ee=>ge(ee.path||"")!==P);if(!$||typeof $!="object")return[];const L=ge($.path||"blogs/**/*.md"),z=il(L);return Object.keys(c).map(ee=>ge(ee)).filter(ee=>z.test(ee)).filter(ee=>!ee.endsWith("/index.md")).sort((ee,K)=>{const re=Nt(K).localeCompare(Nt(ee));return re!==0?re:K.localeCompare(ee)}).map(ee=>p(ee)).filter(ee=>!!ee).filter(ee=>ge(ee.path||"")!==P)}),v=R(()=>{const $=n.value.posts;return!$||typeof $!="object"||Array.isArray($)?h.value.length||1:Math.max(1,Number($.perPage||$.count||9))}),b=R(()=>{const $=n.value.posts;return!$||typeof $!="object"||Array.isArray($)?Math.max(1,Number(n.value.paginationCurrent||1)):Math.max(1,Number($.page||n.value.paginationCurrent||1))}),w=ae(1);Me(b,$=>{w.value=$},{immediate:!0});const x=R(()=>Math.max(1,Math.ceil(h.value.length/v.value))),A=R(()=>Math.min(Math.max(1,w.value),x.value)),M=R(()=>{const $=(A.value-1)*v.value,P=$+v.value;return h.value.slice($,P)}),y=R(()=>Array.from({length:x.value},($,P)=>String(P+1)));function T($){w.value=Math.min(Math.max(1,$),x.value)}function k(){T(A.value-1)}function O(){T(A.value+1)}function V($){return $i({category:String($||""),categoryMeta:r.value})}function H($){return Ni({category:String($||""),categoryMeta:r.value})}function j($){const P=String($.category||"").trim();return(Array.isArray($.tags)?$.tags:[]).filter(z=>{const te=String(z||"").trim();return!!te&&te!==P})}return($,P)=>{var L,z,te,ee,K,re,ue,de,Ce,we;return f(),_("div",i_,[F(qt,{"site-title":m(t).siteTitle||m(n).siteTitle,"nav-links":m(t).navLinks||m(n).navLinks||[],"show-subscribe":!!m(t).showSubscribe,"subscribe-button-text":m(t).subscribeButtonText,"nav-height-class":"h-20"},null,8,["site-title","nav-links","show-subscribe","subscribe-button-text"]),g("main",s_,[g("section",r_,[g("div",l_,[g("div",c_,[g("div",d_,[g("img",{class:"w-full aspect-[16/9] object-cover transition-all duration-700 hover:scale-105",src:m(Kn)((L=d.value)==null?void 0:L.image,(z=d.value)==null?void 0:z.path)},null,8,u_)])]),g("div",h_,[g("div",g_,[g("span",{class:Q(["text-[0.6875rem] font-bold uppercase tracking-[0.05em] px-2 py-1 rounded",H((te=d.value)==null?void 0:te.category)])},I(V((ee=d.value)==null?void 0:ee.category)),3),g("span",p_,I((K=d.value)==null?void 0:K.date),1)]),g("h1",m_,I((re=d.value)==null?void 0:re.title),1),g("p",f_,I((ue=d.value)==null?void 0:ue.description),1),d.value&&j(d.value).length?(f(),_("div",v_,[(f(!0),_(Z,null,ie(j(d.value),le=>(f(),_("span",{key:`featured-${d.value.path||d.value.title}-${le}`,class:"px-2 py-0.5 rounded bg-surface-container-high text-[0.6875rem] font-semibold text-on-surface-variant dark:text-slate-400"}," #"+I(le),1))),128))])):B("",!0),g("div",b_,[g("span",y_,I((de=d.value)==null?void 0:de.readingTime),1),g("a",{class:"text-tertiary font-bold text-sm flex items-center gap-2 group",href:m(jn)((Ce=d.value)==null?void 0:Ce.path)},[Ae(I(((we=d.value)==null?void 0:we.action)||s.value.readArticle||"Read Article")+" ",1),P[0]||(P[0]=g("span",{class:"material-symbols-outlined text-sm group-hover:translate-x-1 transition-transform"},"arrow_forward",-1))],8,w_)])])])]),g("header",__,[g("div",k_,[g("h2",x_,I(m(n).listTitle||s.value.latestArticles||"Latest Articles"),1),g("p",A_,I(m(n).listDescription||s.value.latestArticlesDescription||"Displayed in reverse chronological order."),1)])]),g("div",C_,[(f(!0),_(Z,null,ie(M.value,le=>(f(),_("article",{key:le.title,class:"flex flex-col"},[g("a",{href:m(jn)(le.path),class:"group flex flex-col h-full"},[g("div",I_,[g("img",{class:"w-full h-full object-cover grayscale-[0.8] hover:grayscale-0 transition-all duration-500 scale-100 group-hover:scale-110",src:m(Kn)(le.image,le.path)},null,8,S_)]),g("div",D_,[g("span",{class:Q(["text-[0.6875rem] font-bold uppercase tracking-[0.05em] px-2 py-0.5 rounded",H(le.category)])},I(V(le.category)),3),P[1]||(P[1]=g("span",{class:"w-1 h-1 bg-outline-variant rounded-full"},null,-1)),g("span",P_,I(le.date),1)]),g("h3",M_,I(le.title),1),g("p",L_,I(le.description),1),j(le).length?(f(),_("div",$_,[(f(!0),_(Z,null,ie(j(le),Le=>(f(),_("span",{key:`${le.path||le.title}-${Le}`,class:"px-2 py-0.5 rounded bg-surface-container-high text-[0.6875rem] font-semibold text-on-surface-variant dark:text-slate-400"}," #"+I(Le),1))),128))])):B("",!0),g("div",N_,[g("span",null,I(le.readingTime),1),P[2]||(P[2]=g("span",{class:"material-symbols-outlined text-sm"},"north_east",-1))])],8,T_)]))),128))]),g("div",O_,[g("button",{type:"button",disabled:A.value<=1,class:"text-xs font-bold uppercase tracking-widest text-outline hover:text-on-surface transition-colors flex items-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed",onClick:k},[P[3]||(P[3]=g("span",{class:"material-symbols-outlined text-sm"},"arrow_back",-1)),Ae(" "+I(m(n).paginationPrevious||s.value.paginationPrevious||"Previous"),1)],8,E_),g("div",R_,[(f(!0),_(Z,null,ie(y.value,le=>(f(),_("button",{key:le,type:"button",class:Q(le===String(A.value)?"w-8 h-8 flex items-center justify-center rounded-full bg-primary text-on-primary text-xs font-bold":"w-8 h-8 flex items-center justify-center rounded-full hover:bg-surface-container-high text-xs font-bold cursor-pointer"),onClick:Le=>T(Number(le))},I(le),11,z_))),128))]),g("button",{type:"button",disabled:A.value>=x.value,class:"text-xs font-bold uppercase tracking-widest text-on-surface hover:text-tertiary transition-colors flex items-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed",onClick:O},[Ae(I(m(n).paginationNext||s.value.paginationNext||"Next")+" ",1),P[4]||(P[4]=g("span",{class:"material-symbols-outlined text-sm"},"arrow_forward",-1))],8,B_)])]),F(Vt,{title:m(a).title||m(n).footerTitle,description:m(a).description||m(n).footerDescription,links:m(a).links||m(n).footerLinks||[],"social-icons":m(a).socialIcons||m(n).socialIcons||[]},null,8,["title","description","links","social-icons"])])}}}),V_={class:"bg-surface dark:bg-slate-900 text-on-surface dark:text-slate-100"},j_={class:"pt-16 pb-20 bg-surface dark:bg-slate-900"},F_={class:"relative overflow-hidden bg-surface-container-low dark:bg-slate-950 mb-14"},U_={class:"max-w-6xl mx-auto px-6 lg:px-10 py-14 lg:py-16 relative z-10"},W_={class:"grid grid-cols-1 lg:grid-cols-12 gap-10 items-center"},G_={class:"lg:col-span-7 flex flex-col justify-center gap-5"},H_={class:"text-4xl lg:text-5xl font-black tracking-tight leading-tight"},K_={class:"text-base lg:text-lg text-on-surface-variant dark:text-slate-400 leading-relaxed"},Y_={class:"flex flex-wrap items-center gap-4 text-sm text-on-surface-variant dark:text-slate-400"},X_={key:0,class:"flex flex-wrap gap-2 pt-1"},Q_={class:"lg:col-span-5 hidden lg:flex justify-center"},J_={class:"relative w-full max-w-md aspect-square rounded-full bg-surface-container-lowest/90 border border-outline-variant/20 shadow-[0px_24px_48px_rgba(42,52,57,0.08)] p-7"},Z_=["src","alt"],ek={class:"max-w-6xl mx-auto px-6 lg:px-10"},nk={class:"grid grid-cols-1 lg:grid-cols-12 gap-10"},tk={key:0,class:"lg:col-span-3 order-2 lg:order-1"},ak={class:"lg:sticky lg:top-28 pl-1"},ok={class:"text-s font-bold uppercase tracking-widest text-on-surface-variant dark:text-slate-400 mb-4 -ml-1"},ik={class:"flex flex-col gap-2 pt-1 pb-4 border-b border-outline-variant/30 dark:border-slate-600"},sk=["href"],rk={class:"lg:col-span-9 order-1 lg:order-2 vp-doc max-w-none dark:text-slate-300"},lk=U({__name:"BlogLayout",setup(e){const{page:n}=pn(),{page:t}=jt(),{headerConfig:a,footerConfig:o,uiConfig:i}=Ft(),s=R(()=>i.value.blog||{}),r=R(()=>s.value.categoryMeta||{}),l=Object.assign({"/about-me.md":Xa,"/blogs/2022/202202-logseq-build-your-own-wiki.md":Qa,"/blogs/2022/202203-mesh-shaped-cloud-native-developer.md":Ja,"/blogs/2022/202203-mesh-shaped-recap.md":Za,"/blogs/2022/202205-container-k8s-docker.md":eo,"/blogs/2022/202205-router-proxy-gtw.md":no,"/blogs/2022/202211-cloud-native-engineering.md":to,"/blogs/2022/202212-api-design-inspired-by-google-api-design.md":ao,"/blogs/2022/202212-go-monorepo-tutorial.md":oo,"/blogs/2022/202212-logseq-customized-with-clojure-and-css.md":io,"/blogs/2022/202212-logseq-pkm.md":so,"/blogs/2023/202302-iac-and-terraform.md":ro,"/blogs/2023/202304-draw-architecture-diagram.md":lo,"/blogs/2023/202304-tunnel-vpn-vpc.md":co,"/blogs/2023/202306-remote-development-in-cloud.md":uo,"/blogs/2023/202312-agile-and-lean.md":ho,"/blogs/2023/202312-cobra-cli.md":go,"/blogs/2023/202312-devcontainer-tutorial.md":po,"/blogs/2023/202312-illustrated-ai.md":mo,"/blogs/2023/202312-kubernetes-operator.md":fo,"/blogs/2023/202312-windows-workspaces.md":vo,"/blogs/2024/202401-cloud-native-practices.md":bo,"/blogs/2024/202401-eassy-2024.md":yo,"/blogs/2024/202401-illustrations.md":wo,"/blogs/2024/202402-llm-application.md":_o,"/blogs/2024/202403-ai-and-human.md":ko,"/blogs/2024/202406-fork-oss.md":xo,"/blogs/2024/202406-k3s-blogs.md":Ao,"/blogs/2024/202412-ai-powered-pkm.md":Co,"/blogs/2026/202602-domain-spec-agents.md":To,"/blogs/2026/202602-pov-agentic-engineering.md":Io,"/blogs/2026/202602-pov-standard-automation-selfserve.md":So,"/blogs/2026/202604-llm-wiki-self-evolving-brains.md":Do,"/blogs/2026/202604-logseq-scoring-overview.md":Po,"/blogs/2026/202605-multica-brains-agent-kanban.md":Mo,"/blogs/2026/202605-spdd-agentic-refactor.md":Lo,"/blogs/2026/202606-agent-changes-service-interconnection.md":$o,"/blogs/2026/202606-agile-agent-thoughtworks.md":No,"/blogs/index.md":Oo,"/en/about-me.md":Eo,"/en/blogs/2022/202202-logseq-build-your-own-wiki.md":Ro,"/en/blogs/2022/202203-mesh-shaped-cloud-native-developer.md":zo,"/en/blogs/2022/202205-container-k8s-docker.md":Bo,"/en/blogs/2022/202205-router-proxy-gtw.md":qo,"/en/blogs/2022/202211-cloud-native-engineering.md":Vo,"/en/blogs/2022/202212-logseq-customized-with-clojure-and-css.md":jo,"/en/blogs/2022/202212-logseq-pkm.md":Fo,"/en/blogs/2023/202302-iac-and-terraform.md":Uo,"/en/blogs/2023/202304-draw-architecture-diagram.md":Wo,"/en/blogs/2023/202304-tunnel-vpn-vpc.md":Go,"/en/blogs/2023/202306-remote-development-in-cloud.md":Ho,"/en/blogs/2023/202312-agile-and-lean.md":Ko,"/en/blogs/2023/202312-devcontainer-tutorial.md":Yo,"/en/blogs/2024/202401-cloud-native-practices.md":Xo,"/en/blogs/2024/202401-illustrations.md":Qo,"/en/blogs/2024/202402-llm-application.md":Jo,"/en/blogs/2024/202403-ai-and-human.md":Zo,"/en/blogs/2024/202412-ai-powered-pkm.md":ei,"/en/blogs/2026/202602-domain-spec-agents.md":ni,"/en/blogs/2026/202602-pov-agentic-engineering.md":ti,"/en/blogs/2026/202602-pov-standard-automation-selfserve.md":ai,"/en/blogs/2026/202604-llm-wiki-self-evolving-brains.md":oi,"/en/blogs/2026/202604-logseq-scoring-overview.md":ii,"/en/blogs/2026/202605-multica-brains-agent-kanban.md":si,"/en/blogs/2026/202605-spdd-agentic-refactor.md":ri,"/en/blogs/2026/202606-agent-changes-service-interconnection.md":li,"/en/blogs/2026/202606-agile-agent-thoughtworks.md":ci,"/en/blogs/index.md":di,"/en/index.md":ui,"/index.md":hi});function c(M){return`/${ge(M)}`}const u=R(()=>{const M=String(n.value.relativePath||""),y=c(M);return l[y]||""}),p=R(()=>ol(u.value,{template:String(s.value.readingTimeTemplate||"")})),d=ae([]),h=ae("");function v(){if(typeof window>"u"||d.value.length===0){h.value="";return}const M=window.scrollY+180;let y=d.value[0].href;for(const T of d.value){const k=T.href.slice(1),O=document.getElementById(k);O&&O.offsetTop<=M&&(y=T.href)}h.value=y}function b(){if(typeof window>"u")return;const M=Array.from(document.querySelectorAll(".vp-doc h2[id]"));d.value=M.map(y=>{var T;return{text:((T=y.textContent)==null?void 0:T.trim())||"",href:`#${y.id}`}}).filter(y=>!!y.text),v()}async function w(){await Va(),requestAnimationFrame(()=>{b()})}Oe(()=>{typeof window>"u"||(window.addEventListener("scroll",v,{passive:!0}),w())}),ja(()=>{typeof window>"u"||window.removeEventListener("scroll",v)}),Me(()=>n.value.relativePath,()=>{w()}),Me(u,()=>{w()});const x=R(()=>$i({category:String(t.value.category||""),categoryMeta:r.value})),A=R(()=>Ni({category:String(t.value.category||""),categoryMeta:r.value}));return(M,y)=>{const T=tn("Content");return f(),_("div",V_,[F(qt,{"site-title":m(a).siteTitle,"nav-links":m(a).navLinks||[],"show-subscribe":!!m(a).showSubscribe,"subscribe-button-text":m(a).subscribeButtonText,"nav-height-class":"h-20"},null,8,["site-title","nav-links","show-subscribe","subscribe-button-text"]),g("main",j_,[g("header",F_,[y[3]||(y[3]=g("div",{class:"absolute inset-0 mesh-gradient opacity-60"},null,-1)),y[4]||(y[4]=g("div",{class:"absolute inset-0 bg-gradient-to-br from-primary/10 to-transparent"},null,-1)),g("div",U_,[g("div",W_,[g("div",G_,[g("span",{class:Q(["inline-flex w-fit px-3 py-1 rounded-full text-xs font-bold uppercase tracking-widest",A.value])},I(x.value),3),g("h1",H_,I(m(t).title),1),g("p",K_,I(m(t).description),1),g("div",Y_,[g("span",null,I(m(t).date),1),y[0]||(y[0]=g("span",{class:"w-1 h-1 rounded-full bg-outline"},null,-1)),g("span",null,I(p.value),1)]),(m(t).tags||[]).length?(f(),_("div",X_,[(f(!0),_(Z,null,ie(m(t).tags||[],k=>(f(),_("span",{key:k,class:"px-2.5 py-1 rounded bg-surface-container-high dark:bg-slate-700 text-xs font-semibold text-on-surface-variant dark:text-slate-400"}," #"+I(k),1))),128))])):B("",!0)]),g("div",Q_,[g("div",J_,[y[1]||(y[1]=g("div",{class:"absolute inset-4 rounded-full border-2 border-dashed border-primary/30 animate-[spin_20s_linear_infinite]"},null,-1)),y[2]||(y[2]=g("div",{class:"absolute inset-10 rounded-full border border-primary/20"},null,-1)),g("img",{src:m(Kn)(m(t).image,m(n).relativePath),alt:m(t).title,class:"relative z-10 w-full h-full object-cover rounded-full"},null,8,Z_)])])])])]),g("section",ek,[g("div",nk,[d.value.length?(f(),_("aside",tk,[g("div",ak,[g("h3",ok,I(s.value.tocTitle||"Contents"),1),g("nav",ik,[(f(!0),_(Z,null,ie(d.value,k=>(f(),_("a",{key:k.href,href:k.href,class:Q(k.href===h.value?"relative text-sm font-semibold text-primary pl-6 before:content-[''] before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-[2px] before:h-4 before:bg-primary before:rounded dark:text-tertiary":"text-sm font-thin text-on-surface dark:text-slate-300 hover:text-primary pl-6")},I(k.text),11,sk))),128))])])])):B("",!0),g("article",rk,[F(T)])])])]),F(Vt,{title:m(o).title,description:m(o).description,links:m(o).links||[],"social-icons":m(o).socialIcons||[]},null,8,["title","description","links","social-icons"])])}}}),ck=U({__name:"Layout",setup(e){const{frontmatter:n,page:t}=pn(),a=R(()=>{const o=String(n.value.layout||"");if(o)return o;const i=String(t.value.relativePath||"");return i.startsWith("blogs/")||i.startsWith("en/blogs/")?"blog":""});return(o,i)=>a.value==="home"?(f(),W(kp,{key:0})):a.value==="about-me"?(f(),W(o_,{key:1})):a.value==="blog-list"?(f(),W(q_,{key:2})):a.value==="blog"?(f(),W(lk,{key:3})):(f(),W(m(Ws).Layout,{key:4}))}});let Rn=null;function dk(){let e=!1;return async()=>{if(typeof window>"u")return;const{default:n}=await Os(async()=>{const{default:o}=await import("./mermaid.core.CvgjoqUA.js").then(i=>i.bd);return{default:o}},__vite__mapDeps([2,1]));e||(n.initialize({startOnLoad:!1,securityLevel:"loose"}),e=!0);const t=document.querySelectorAll(".vp-doc div.language-mermaid pre code");for(const o of t){const i=o.closest("pre"),s=o.closest("div.language-mermaid");if(!i||!s||i.dataset.mermaidRendered==="true")continue;i.classList.remove("shiki","shiki-themes","vp-code"),i.classList.add("mermaid"),i.textContent=o.textContent||"",i.dataset.mermaidRendered="true";const r=s.querySelector("button.copy"),l=s.querySelector("span.lang");r==null||r.remove(),l==null||l.remove(),s.classList.remove("language-mermaid")}const a=Array.from(document.querySelectorAll(".vp-doc pre.mermaid"));a.length>0&&await n.run({nodes:a})}}const jk={extends:Ws,Layout:ck,enhanceApp({router:e}){if(typeof window>"u")return;Rn=Rn||dk();const n=()=>{requestAnimationFrame(()=>{Rn==null||Rn()})};n(),e.onAfterRouteChanged=n}};export{Tk as $,Jn as A,Ti as B,Ci as C,_n as D,It as E,pk as F,ne as G,Nu as H,yk as I,qk as J,Vk as K,Bk as L,zk as M,Rk as N,Ek as O,Ok as P,I2 as Q,Lk as R,Nk as S,$k as T,Dk as U,Mk as V,Pk as W,Sk as X,Ak as Y,xk as Z,Ik as _,kk as a,F0 as b,_k as c,wk as d,Ck as e,Tr as f,vk as g,Sr as h,bk as i,hk as j,fk as k,J0 as l,gk as m,mk as n,Dr as o,Rr as p,Si as q,Qt as r,ln as s,jk as t,sy as u,iy as v,Dn as w,oy as x,ay as y,St as z};
