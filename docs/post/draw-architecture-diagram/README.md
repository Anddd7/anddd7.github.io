...
- 概念视图
  - 概念图的作者 Joseph D. Novak 对于概念的定义是：用一个特定的符号表示的感知到的关于对象或事件或其记录的规律或模式。
  - 核心要素
    - 焦点 —— 我们要解决什么问题？
    - 概念
    - 关系 —— 由指向性的箭头 + 文字标注来表示。
...
- 模块视图
  - [[系统支撑图]]/矩阵：描述系统如何承载概念视图中的业务领域和用例
   background-color:: #497d46
    - CTO Architect
  - [[C4-System]]：描述人、系统，理清系统的使用方
   background-color:: #497d46
    - CTO Architect
  - [[C4-Container]]：进程间架构，协议、交互方式（核心）
   background-color:: #497d46
    - Architect Dev

- 执行视图
  - [[部署架构图]]：部署形态，包括网络拓扑、CICD、CR 流程、运维特征
   background-color:: #497d46
    - Architect DevOps
  - [[Data-flow diagram]]：系统、进程间的数据流向
   background-color:: #497d46
    - Architect Dev

- 实现视图
  - [[C4-Component]]：进程内架构、技术栈、核心 feature 的设计
   background-color:: #497d46
    - Dev
